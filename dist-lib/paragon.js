...
import { useEditorState as ul, NodeViewWrapper as Jr, ReactNodeViewRenderer as fl, useEditor as Fu, EditorContent as Uu, NodeViewContent as Yu } from "@tiptap/react";
import * as T from "react";
import X, { useState as j, useRef as Y, useEffect as q, useLayoutEffect as po, memo as bt, useCallback as F, useImperativeHandle as ju, createContext as pl, useContext as hl, useMemo as St, Component as Vu, useReducer as Ku, lazy as Gu, forwardRef as qu, Suspense as za } from "react";
import Xu from "@tiptap/extension-code-block-lowlight";
import { createLowlight as Zu } from "lowlight";
import { Image as Hs, X as mt, Link2 as Bs, Type as ho, Undo as Qu, Redo as Ju, Bold as Ws, Italic as zs, Underline as Fs, Strikethrough as Us, Code as ml, Highlighter as gl, Link as Ys, ChevronDown as Jn, List as js, ListOrdered as Vs, CheckSquare as Ks, Quote as Gs, Code2 as yl, IndentIncrease as ef, IndentDecrease as tf, Table as ms, Minus as vl, Info as gs, BookOpen as bl, PenLine as nf, Library as rf, ListTodo as wl, Columns as Fa, Trash2 as dn, Rows as Ua, ToggleLeft as Ya, ArrowUpDown as of, Sparkles as mo, Copy as bn, Search as sf, ChevronUp as af, MousePointerClick as lf, CaseSensitive as cf, WholeWord as df, Regex as uf, Replace as ys, ReplaceAll as ff, Plus as qs, ChevronLeftIcon as pf, ChevronRightIcon as hf, ChevronDownIcon as mf, Calendar as xl, Hash as ja, Cloud as gf, Loader2 as kl, Check as wn, CloudOff as yf, AlertCircle as vf, RotateCcw as Xs, Activity as bf, Maximize2 as Cl, Minimize2 as El, AlertTriangle as wf, ChevronRight as xf, CheckCircle2 as kf, Eye as Cf, FileText as Zs, FileCode as Ef, ExternalLink as Mf, Pencil as Tf, Unlink as Sf, Heading1 as Nf, Heading2 as Df, Heading3 as Lf, Heading4 as Af, Heading5 as If, StickyNote as Rf, MessageSquareText as Pf, ImagePlus as Of, MessageSquare as Ml, RefreshCw as _f, SpellCheck as $f, PanelRightClose as Hf, PanelRightOpen as Bf } from "lucide-react";
import * as Tl from "react-dom";
import Wf, { createPortal as zf } from "react-dom";
import { TextSelection as Ve, Plugin as Ne, PluginKey as De, NodeSelection as Ff, AllSelection as Uf } from "@tiptap/pm/state";
import { Fragment as Sl, Slice as Yo, DOMSerializer as Yf } from "@tiptap/pm/model";
import jf from "@tiptap/starter-kit";
import Vf from "@tiptap/extension-placeholder";
import Kf from "@tiptap/extension-text-align";
import Gf from "@tiptap/extension-highlight";
import qf from "@tiptap/extension-link";
import { Table as Xf } from "@tiptap/extension-table";
import Zf from "@tiptap/extension-table-row";
import Qf from "@tiptap/extension-table-cell";
import Jf from "@tiptap/extension-table-header";
import { Extension as Oe, Node as go, mergeAttributes as xn, InputRule as Pe, Mark as Nl } from "@tiptap/core";
import { DecorationSet as je, Decoration as Ze } from "@tiptap/pm/view";
import ep from "@tiptap/extension-bullet-list";
import tp from "@tiptap/extension-ordered-list";
import np from "@tiptap/extension-list-item";
import rp from "@tiptap/extension-task-list";
import op from "@tiptap/extension-task-item";
import { findWrapping as Va, canJoin as sp } from "@tiptap/pm/transform";
import ap from "@tiptap/extension-underline";
import ip from "@tiptap/extension-subscript";
import lp from "@tiptap/extension-superscript";
import cp from "@tiptap/extension-typography";
import dp from "@tiptap/extension-image";
import { createRoot as up } from "react-dom/client";
import { liftListItem as Ka, sinkListItem as Ga } from "@tiptap/pm/schema-list";
import { undo as fp, redo as pp } from "@tiptap/pm/history";
import hp from "@tiptap/extension-horizontal-rule";
import mp from "@tiptap/extension-code";
import gp from "@tiptap/extension-bold";
import yp from "@tiptap/extension-italic";
import vp from "@tiptap/extension-strike";
const We = Zu(), Dl = {
  ...
  if (!qa)
    return In || (In = (async () => {
      try {
        ...
        for (const [n, r] of Object.entries(Ll))
          if (!We.registered(n)) {
...
async function Xa(e) {
  ...
  if (Dl[e] || Ll[e])
    return await bp(), We.registered(e);
  const t = Al[e];
  if (!t) return !1;
...
], wp = ["M20 6 9 17l-5-5"], xp = ["m6 9 6 6 6-6"];
function kp() {
  const e = We.listLanguages();
  return Array.from(/* @__PURE__ */ new Set([...e, ...Object.keys(Al)])).sort();
}
class Cp {
  constructor(t, n, r) {
    ...
    const a = Ar(xp, 12, "code-block-language-chevron");
    i.appendChild(this.selectEl), i.appendChild(this.labelEl), i.appendChild(a), this.copyBtn = document.createElement("button"), this.copyBtn.type = "button", this.copyBtn.className = "code-block-copy-btn", this.copyBtn.title = "Copy code", this.copyBtn.appendChild(Ar(Qa, 14)), this.copyBtn.addEventListener("click", this.handleCopy), s.appendChild(i), s.appendChild(this.copyBtn), this.preEl = document.createElement("pre"), this.preEl.className = "code-block-pre code-block-deferred", this.codeEl = document.createElement("code"), this.codeEl.className = "language-plaintext", this.preEl.appendChild(this.codeEl), this.contentDOM = this.codeEl, this.dom.appendChild(s), this.dom.appendChild(this.preEl), this.setupVisibilityObserver();
  }
  // ── Language select ──
  ...
  update(t) {
    ...
    return this.node = t, n !== r && (this.labelEl.textContent = this.formatLanguageLabel(r), this.selectEl.value = r, r === "plaintext" ? this.setLanguageReady(!0) : We.registered(r) ? this.setLanguageReady(!0) : this.isVisible && (this.setLanguageReady(!1), Xa(r).then((o) => {
...
const Ep = Xu.configure({
  ...
  addNodeView() {
    return ({ node: e, view: t, getPos: n }) => new Cp(e, t, n);
  },
...
function Il({ isOpen: e, onClose: t, onInsert: n, position: r }) {
      ...
      children: [
        /* @__PURE__ */ I("div", { className: "image-url-dialog-header", children: [
          /* @__PURE__ */ I("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ h(Hs, { size: 16, className: "text-primary" }),
...
}, Tp = T[" useInsertionEffect ".trim().toString()] || Dt;
function Js({
  prop: e,
  defaultProp: t,
  onChange: n = () => {
...
// @__NO_SIDE_EFFECTS__
function jn(e) {
  const t = /* @__PURE__ */ Lp(e), n = T.forwardRef((r, o) => {
    const { children: s, ...i } = r, a = T.Children.toArray(s), l = a.find(Ip);
    if (l) {
...
var Dp = /* @__PURE__ */ jn("Slot");
// @__NO_SIDE_EFFECTS__
function Lp(e) {
  const t = T.forwardRef((n, r) => {
    const { children: o, ...s } = n;
    if (T.isValidElement(o)) {
      const i = Pp(o), a = Rp(s, o.props);
...
var _p = T.createContext(void 0);
function _l(e) {
  const t = T.useContext(_p);
  return e || t || "ltr";
}
function gt(e) {
  const t = T.useRef(e);
...
var Hp = "DismissableLayer", vs = "dismissableLayer.update", Bp = "dismissableLayer.pointerDownOutside", Wp = "dismissableLayer.focusOutside", ei, $l = T.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: a,
      ...l
    } = e, c = T.useContext($l), [d, u] = T.useState(null), f = d?.ownerDocument ?? globalThis?.document, [, p] = T.useState({}), g = Ie(t, (S) => u(S)), m = Array.from(c.layers), [y] = [...c.layersWithOutsidePointerEventsDisabled].slice(-1), v = m.indexOf(y), b = d ? m.indexOf(d) : -1, x = c.layersWithOutsidePointerEventsDisabled.size > 0, M = b >= v, w = Up((S) => {
...
ea.displayName = Hp;
var zp = "DismissableLayerBranch", Fp = T.forwardRef((e, t) => {
  const n = T.useContext($l), r = T.useRef(null), o = Ie(t, r);
  return T.useEffect(() => {
    const s = r.current;
    if (s)
...
Fp.displayName = zp;
function Up(e, t = globalThis?.document) {
...
function Yp(e, t = globalThis?.document) {
  ...
  return T.useEffect(() => {
    const o = (s) => {
      s.target && !r.current && Hl(Wp, n, { originalEvent: s }, {
        discrete: !1
      });
    };
...
var Vo = "focusScope.autoFocusOnMount", Ko = "focusScope.autoFocusOnUnmount", ri = { bubbles: !1, cancelable: !0 }, Vp = "FocusScope", Bl = T.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: o,
  ...
  T.useEffect(() => {
    ...
    if (a) {
      ...
      if (!a.contains(m)) {
        ...
        a.addEventListener(Vo, c), a.dispatchEvent(v), v.defaultPrevented || (Kp(Qp(Wl(a)), { select: !0 }), document.activeElement === m && Tt(a));
      }
      return () => {
  ...
  const g = T.useCallback(
    (m) => {
      ...
      if (y && v) {
        const b = m.currentTarget, [x, M] = Gp(b);
...
Bl.displayName = Vp;
function Kp(e, { select: t = !1 } = {}) {
  const n = document.activeElement;
  for (const r of e)
    if (Tt(r, { select: t }), document.activeElement !== n) return;
}
function Gp(e) {
  const t = Wl(e), n = oi(t, e), r = oi(t.reverse(), e);
  return [n, r];
}
function Wl(e) {
...
var Jp = T[" useId ".trim().toString()] || (() => {
}), eh = 0;
function eo(e) {
  const [t, n] = T.useState(Jp());
  return Dt(() => {
    n((r) => r ?? String(eh++));
  }, [e]), e || (t ? `radix-${t}` : "");
}
const th = ["top", "right", "bottom", "left"], Lt = Math.min, Be = Math.max, to = Math.round, Ir = Math.floor, ot = (e) => ({
  x: e,
  y: e
}), nh = {
  left: "right",
...
const ii = ["left", "right"], li = ["right", "left"], ih = ["top", "bottom"], lh = ["bottom", "top"];
function ch(e, t, n) {
  switch (e) {
    case "top":
    case "bottom":
...
function dh(e, t, n, r) {
  const o = Cn(e);
  let s = ch(vt(e), n === "start", r);
  return o && (s = s.map((i) => i + "-" + o), t && (s = s.concat(s.map(ws)))), s;
}
function no(e) {
  return e.replace(/left|right|bottom|top/g, (t) => nh[t]);
}
function uh(e) {
  return {
    top: 0,
...
function ci(e, t, n) {
  ...
  const s = nt(t), i = ra(t), a = na(i), l = vt(t), c = s === "y", d = r.x + r.width / 2 - o.width / 2, u = r.y + r.height / 2 - o.height / 2, f = r[a] / 2 - o[a] / 2;
  let p;
  switch (l) {
    case "top":
      p = {
...
async function Vn(e, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: p = 0
  } = yt(t, e), g = zl(p), y = a[f ? u === "floating" ? "reference" : "floating" : u], v = ro(await s.getClippingRect({
...
const ph = (e) => ({
  ...
  async fn(t) {
    ...
    const u = zl(d), f = {
      x: n,
      y: r
    }, p = ra(o), g = na(p), m = await i.getDimensions(c), y = p === "y", v = y ? "top" : "left", b = y ? "bottom" : "right", x = y ? "clientHeight" : "clientWidth", M = s.reference[g] + s.reference[p] - f[p] - s.floating[g], w = f[p] - s.reference[p], E = await (i.getOffsetParent == null ? void 0 : i.getOffsetParent(c));
    let S = E ? E[x] : 0;
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const v = vt(o), b = nt(a), x = vt(a) === a, M = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), w = f || (x || !m ? [no(a)] : ah(a)), E = g !== "none";
      !f && E && w.push(...dh(a, m, g, M));
...
async function gh(e, t) {
  const {
    ...
    platform: r,
    elements: o
  } = e, s = await (r.isRTL == null ? void 0 : r.isRTL(o.floating)), i = vt(n), a = Cn(n), l = nt(n) === "y", c = Fl.has(i) ? -1 : 1, d = s && l ? -1 : 1, u = yt(t, e);
  let {
    mainAxis: f,
    crossAxis: p,
    alignmentAxis: g
...
const yh = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: n,
        y: r
      }, d = await Vn(t, l), u = nt(vt(o)), f = ta(u);
      let p = c[f], g = c[u];
      if (s) {
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (c) {
        var v, b;
        const x = f === "y" ? "width" : "height", M = Fl.has(vt(o)), w = s.reference[u] - s.floating[x] + (M && ((v = i.offset) == null ? void 0 : v[u]) || 0) + (M ? 0 : y.crossAxis), E = s.reference[u] + s.reference[x] + (M ? 0 : ((b = i.offset) == null ? void 0 : b[u]) || 0) - (M ? y.crossAxis : 0);
        g < w ? g = w : g > E && (g = E);
      }
      return {
        [f]: p,
...
const Mh = ["transform", "translate", "scale", "rotate", "perspective"], Th = ["transform", "translate", "scale", "rotate", "perspective", "filter"], Sh = ["paint", "layout", "strict", "content"];
function oa(e) {
  const t = sa(), n = Qe(e) ? Je(e) : e;
  return Mh.some((r) => n[r] ? n[r] !== "none" : !1) || (n.containerType ? n.containerType !== "normal" : !1) || !t && (n.backdropFilter ? n.backdropFilter !== "none" : !1) || !t && (n.filter ? n.filter !== "none" : !1) || Th.some((r) => (n.willChange || "").includes(r)) || Sh.some((r) => (n.contain || "").includes(r));
}
function Nh(e) {
  let t = At(e);
  for (; st(t) && !gn(t); ) {
...
const Dh = /* @__PURE__ */ new Set(["html", "body", "#document"]);
function gn(e) {
  return Dh.has(En(e));
}
function Je(e) {
...
function Yl(e) {
  const t = At(e);
  return gn(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : st(t) && er(t) ? t : Yl(t);
}
function Kn(e, t, n) {
  var r;
  t === void 0 && (t = []), n === void 0 && (n = !0);
  const o = Yl(e), s = o === ((r = e.ownerDocument) == null ? void 0 : r.body), i = ze(o);
  if (s) {
    const a = xs(i);
...
const Lh = /* @__PURE__ */ ot(0);
function Vl(e) {
  const t = ze(e);
  return !sa() || !t.visualViewport ? Lh : {
...
function Ih(e) {
  ...
  const s = o === "fixed", i = at(r), a = t ? bo(t.floating) : !1;
  if (r === i || a && s)
    return n;
  let l = {
    scrollLeft: 0,
  ...
  const d = ot(0), u = st(r);
  if ((u || !u && !s) && ((En(r) !== "body" || er(i)) && (l = wo(r)), st(r))) {
    const p = jt(r);
    c = un(r), d.x = p.x + r.clientLeft, d.y = p.y + r.clientTop;
  }
  const f = i && !u && !s ? Kl(i, l) : ot(0);
  return {
    width: n.width * c.x,
    height: n.height * c.y,
...
function Ph(e) {
  const t = at(e), n = wo(e), r = e.ownerDocument.body, o = Be(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth), s = Be(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight);
...
const _h = /* @__PURE__ */ new Set(["absolute", "fixed"]);
function $h(e, t) {
...
function Hh(e, t) {
  ...
  for (; Qe(i) && !gn(i); ) {
    const a = Je(i), l = oa(i);
    !l && a.position === "fixed" && (o = null), (s ? !l && !o : !l && a.position === "static" && !!o && _h.has(o.position) || er(i) && !l && Gl(e, i)) ? r = r.filter((d) => d !== i) : o = a, i = At(i);
  }
  return t.set(e, r), r;
}
function Bh(e) {
  ...
  const i = [...n === "clippingAncestors" ? bo(t) ? [] : Hh(t, this._c) : [].concat(n), r], a = i[0], l = i.reduce((c, d) => {
    const u = hi(t, d, o);
...
function zh(e, t, n) {
  ...
  if (r || !r && !s)
    if ((En(t) !== "body" || er(o)) && (a = wo(t)), r) {
      const p = jt(t, !0, s, t);
      l.x = p.x + t.clientLeft, l.y = p.y + t.clientTop;
    } else o && c();
  s && !r && o && c();
  const d = o && !r && !s ? Kl(o, a) : ot(0), u = i.left + a.scrollLeft - l.x - d.x, f = i.top + a.scrollTop - l.y - d.y;
  return {
    x: u,
    y: f,
    width: i.width,
...
function ql(e, t) {
  ...
  for (; r && Ch(r) && Go(r); )
    r = mi(r, t);
  return r && gn(r) && Go(r) && !oa(r) ? n : r || Nh(e) || n;
}
...
function jh(e, t) {
  ...
  function i(a, l) {
    ...
    function w(E) {
      ...
      S === 1 && !Xl(c, e.getBoundingClientRect()) && i(), M = !1;
    }
    try {
...
function Vh(e, t, n, r) {
  ...
  const {
    ...
    animationFrame: l = !1
  } = r, c = aa(e), d = o || s ? [...c ? Kn(c) : [], ...Kn(t)] : [];
  d.forEach((v) => {
    o && v.addEventListener("scroll", n, {
      passive: !0
    }), s && v.addEventListener("resize", n);
  });
  const u = c && a ? jh(c, n) : null;
  let f = -1, p = null;
  ...
  function y() {
    const v = jt(e);
    m && !Xl(m, v) && n(), m = v, g = requestAnimationFrame(y);
  }
  return n(), () => {
    var v;
    d.forEach((b) => {
...
const Kh = yh, Gh = vh, qh = hh, Xh = wh, Zh = mh, gi = ph, Qh = bh, Jh = (e, t, n) => {
...
function nm(e) {
  ...
  const [g, m] = T.useState(null), [y, v] = T.useState(null), b = T.useCallback((R) => {
  ...
  }, []), M = s || g, w = i || y, E = T.useRef(null), S = T.useRef(null), k = T.useRef(d), D = l != null, C = qo(l), N = qo(o), L = qo(c), P = T.useCallback(() => {
    ...
    N.current && (R.platform = N.current), Jh(E.current, S.current, R).then((A) => {
      const H = {
        ...A,
      ...
      O.current && !oo(k.current, H) && (k.current = H, Tl.flushSync(() => {
        u(H);
      }));
    });
  }, [f, t, n, N, L]);
...
var um = "Arrow", Ql = T.forwardRef((e, t) => {
...
var ia = "Popper", [Jl, ko] = kn(ia), [hm, ec] = Jl(ia), tc = (e) => {
  const { __scopePopper: t, children: n } = e, [r, o] = T.useState(null);
  return /* @__PURE__ */ h(hm, { scope: t, anchor: r, onAnchorChange: o, children: n });
};
tc.displayName = ia;
var nc = "PopperAnchor", rc = T.forwardRef(
  (e, t) => {
    const { __scopePopper: n, virtualRef: r, ...o } = e, s = ec(nc, n), i = T.useRef(null), a = Ie(t, i), l = T.useRef(null);
    return T.useEffect(() => {
      const c = l.current;
...
rc.displayName = nc;
var la = "PopperContent", [mm, gm] = Jl(la), oc = T.forwardRef(
  (e, t) => {
    const {
      __scopePopper: n,
      side: r = "bottom",
      ...
      onPlaced: g,
      ...m
    } = e, y = ec(la, n), [v, b] = T.useState(null), x = Ie(t, (_) => b(_)), [M, w] = T.useState(null), E = pm(M), S = E?.width ?? 0, k = E?.height ?? 0, D = r + (s !== "center" ? "-" + s : ""), C = typeof d == "number" ? d : { top: 0, right: 0, bottom: 0, left: 0, ...d }, N = Array.isArray(c) ? c : [c], L = N.length > 0, P = {
      padding: C,
      boundary: N.filter(vm),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: L
    }, { refs: O, floatingStyles: $, placement: W, isPositioned: V, middlewareData: R } = nm({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: D,
      whileElementsMounted: (..._) => Vh(..._, {
      ...
      middleware: [
        om({ mainAxis: o + k, alignmentAxis: i }),
        l && sm({
          mainAxis: !0,
          crossAxis: !1,
          limiter: u === "partial" ? am() : void 0,
          ...P
        }),
        l && im({ ...P }),
        lm({
        ...
        M && dm({ element: M, padding: a }),
        bm({ arrowWidth: S, arrowHeight: k }),
        f && cm({ strategy: "referenceHidden", ...P })
      ]
    }), [A, H] = ic(W), G = gt(g);
    Dt(() => {
      V && G?.();
...
oc.displayName = la;
var sc = "PopperArrow", ym = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, ac = T.forwardRef(function(t, n) {
  const { __scopePopper: r, ...o } = t, s = gm(sc, r), i = ym[s.placedSide];
  return (
...
var bm = (e) => ({
  ...
  options: e,
  fn(t) {
    const { placement: n, rects: r, middlewareData: o } = t, i = o.arrow?.centerOffset !== 0, a = i ? 0 : e.arrowWidth, l = i ? 0 : e.arrowHeight, [c, d] = ic(n), u = { start: "0%", center: "50%", end: "100%" }[d], f = (o.arrow?.x ?? 0) + a / 2, p = (o.arrow?.y ?? 0) + l / 2;
    let g = "", m = "";
...
var lc = tc, cc = rc, dc = oc, uc = ac, wm = "Portal", ca = T.forwardRef((e, t) => {
  const { container: n, ...r } = e, [o, s] = T.useState(!1);
  Dt(() => s(!0), []);
  const i = n || o && globalThis?.document?.body;
  return i ? Wf.createPortal(/* @__PURE__ */ h(Le.div, { ...r, ref: t }), i) : null;
});
ca.displayName = wm;
function xm(e, t) {
...
var Vt = (e) => {
  const { present: t, children: n } = e, r = km(t), o = typeof n == "function" ? n({ present: r.isPresent }) : T.Children.only(n), s = Ie(r.ref, Cm(o));
  return typeof n == "function" || r.isPresent ? T.cloneElement(o, { ref: s }) : null;
};
Vt.displayName = "Presence";
function km(e) {
  const [t, n] = T.useState(), r = T.useRef(null), o = T.useRef(e), s = T.useRef("none"), i = e ? "mounted" : "unmounted", [a, l] = xm(i, {
    mounted: {
      UNMOUNT: "unmounted",
...
var Xo = "rovingFocusGroup.onEntryFocus", Em = { bubbles: !1, cancelable: !0 }, tr = "RovingFocusGroup", [ks, fc, Mm] = Ol(tr), [Tm, pc] = kn(
  tr,
  [Mm]
), [Sm, Nm] = Tm(tr), hc = T.forwardRef(
  (e, t) => /* @__PURE__ */ h(ks.Provider, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ h(ks.Slot, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ h(Dm, { ...e, ref: t }) }) })
);
hc.displayName = tr;
var Dm = T.forwardRef((e, t) => {
  const {
    ...
    ...u
  } = e, f = T.useRef(null), p = Ie(t, f), g = _l(s), [m, y] = Js({
    prop: i,
    defaultProp: a ?? null,
    onChange: l,
    caller: tr
  }), [v, b] = T.useState(!1), x = gt(c), M = fc(n), w = T.useRef(!1), [E, S] = T.useState(0);
  return T.useEffect(() => {
    const k = f.current;
    if (k)
...
}), mc = "RovingFocusGroupItem", gc = T.forwardRef(
  (e, t) => {
    const {
      __scopeRovingFocusGroup: n,
      focusable: r = !0,
      ...
      children: i,
      ...a
    } = e, l = eo(), c = s || l, d = Nm(mc, n), u = d.currentTabStopId === c, f = fc(n), { onFocusableItemAdd: p, onFocusableItemRemove: g, currentTabStopId: m } = d;
    return T.useEffect(() => {
      if (r)
        return p(), () => g();
    }, [r, p, g]), /* @__PURE__ */ h(
        ...
        children: /* @__PURE__ */ h(
          Le.span,
          {
            ...
            onKeyDown: le(e.onKeyDown, (y) => {
              ...
              const v = Im(y, d.orientation, d.dir);
              if (v !== void 0) {
...
var Pm = hc, Om = gc, _m = function(e) {
  if (typeof document > "u")
    return null;
  var t = Array.isArray(e) ? e[0] : e;
  return t.ownerDocument.body;
}, en = /* @__PURE__ */ new WeakMap(), Pr = /* @__PURE__ */ new WeakMap(), Or = {}, Zo = 0, vc = function(e) {
  ...
  return d(t), a.clear(), Zo++, function() {
    ...
    }), Zo--, Zo || (en = /* @__PURE__ */ new WeakMap(), en = /* @__PURE__ */ new WeakMap(), Pr = /* @__PURE__ */ new WeakMap(), Or = {});
  };
}, Bm = function(e, t, n) {
  n === void 0 && (n = "data-aria-hidden");
  var r = Array.from(Array.isArray(e) ? e : [e]), o = _m(e);
...
var qr = "right-scroll-bar-position", Xr = "width-before-scroll-bar", zm = "with-scroll-bars-hidden", Fm = "--removed-body-scroll-bar-size";
function Qo(e, t) {
...
var Ym = typeof window < "u" ? T.useLayoutEffect : T.useEffect, vi = /* @__PURE__ */ new WeakMap();
function jm(e, t) {
...
var xc = Gm(), Jo = function() {
}, Co = T.forwardRef(function(e, t) {
  var n = T.useRef(null), r = T.useState({
    onScrollCapture: Jo,
    onWheelCapture: Jo,
    onTouchMoveCapture: Jo
  }), o = r[0], s = r[1], i = e.forwardProps, a = e.children, l = e.className, c = e.removeScrollBar, d = e.enabled, u = e.shards, f = e.sideCar, p = e.noRelative, g = e.noIsolation, m = e.inert, y = e.allowPinchZoom, v = e.as, b = v === void 0 ? "div" : v, x = e.gapMode, M = bc(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), w = f, E = jm([n, t]), S = tt(tt({}, M), o);
  return T.createElement(
    T.Fragment,
    null,
    d && T.createElement(w, { sideCar: xc, removeScrollBar: c, shards: u, noRelative: p, noIsolation: g, inert: m, setCallbacks: s, allowPinchZoom: !!y, lockRef: n, gapMode: x }),
...
var eg = function() {
  ...
  if (e === void 0 && (e = "margin"), typeof window > "u")
    return ng;
  var t = rg(e), n = document.documentElement.clientWidth, r = window.innerWidth;
  return {
    left: t[0],
    top: t[1],
    right: t[2],
...
}, sg = kc(), fn = "data-scroll-locked", ag = function(e, t, n, r) {
...
`);
  ...
  return T.createElement(sg, { styles: ag(s, !t, o, n ? "" : "!important") });
}, Cs = !1;
if (typeof window < "u")
  try {
...
var tn = Cs ? { passive: !1 } : !1, cg = function(e) {
  ...
  return (
    ...
    !(n.overflowY === n.overflowX && !cg(e) && n[t] === "visible")
  );
}, dg = function(e) {
  ...
  return e === "v" ? dg(t) : ug(t);
}, Mc = function(e, t) {
  return e === "v" ? fg(t) : pg(t);
}, hg = function(e, t) {
  return e === "h" && t === "rtl" ? -1 : 1;
}, mg = function(e, t, n, r, o) {
  var s = hg(e, window.getComputedStyle(t).direction), i = s * r, a = n.target, l = t.contains(a), c = !1, d = i > 0, u = 0, f = 0;
  do {
    if (!a)
      break;
    var p = Mc(e, a), g = p[0], m = p[1], y = p[2], v = m - y - s * g;
    (g || v) && Ec(e, a) && (u += v, f += g);
    var b = a.parentNode;
...
function bg(e) {
  var t = T.useRef([]), n = T.useRef([0, 0]), r = T.useRef(), o = T.useState(vg++)[0], s = T.useState(kc)[0], i = T.useRef(e);
  T.useEffect(function() {
    i.current = e;
  }, [e]), T.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(o));
      var m = Wm([e.lockRef.current], (e.shards || []).map(ki), !0).filter(Boolean);
  ...
  var a = T.useCallback(function(m, y) {
    ...
    if (!r.current && "changedTouches" in m && (x || M) && (r.current = w), !w)
      return !0;
    var D = r.current || w;
    return mg(D, y, m, D === "h" ? x : M);
  }, []), l = T.useCallback(function(m) {
    var y = m;
    if (!(!nn.length || nn[nn.length - 1] !== s)) {
      var v = "deltaY" in y ? xi(y) : $r(y), b = t.current.filter(function(w) {
        return w.name === y.type && (w.target === y.target || y.target === w.shadowParent) && gg(w.delta, v);
      })[0];
      if (b && b.should) {
    ...
    var x = { name: m, delta: y, target: v, should: b, shadowParent: wg(v) };
  ...
  return T.createElement(
    T.Fragment,
    null,
    g ? T.createElement(s, { styles: yg(o) }) : null,
    p ? T.createElement(lg, { noRelative: e.noRelative, gapMode: e.gapMode }) : null
  );
}
function wg(e) {
...
var Tc = T.forwardRef(function(e, t) {
  return T.createElement(Co, tt({}, e, { ref: t, sideCar: xg }));
});
Tc.classNames = Co.classNames;
var Es = ["Enter", " "], kg = ["ArrowDown", "PageUp", "Home"], Sc = ["ArrowUp", "PageDown", "End"], Cg = [...kg, ...Sc], Eg = {
  ltr: [...Es, "ArrowRight"],
  rtl: [...Es, "ArrowLeft"]
}, Mg = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, nr = "Menu", [Gn, Tg, Sg] = Ol(nr), [Kt, Nc] = kn(nr, [
  Sg,
  ko,
  pc
]), Eo = ko(), Dc = pc(), [Ng, Gt] = Kt(nr), [Dg, rr] = Kt(nr), Lc = (e) => {
  const { __scopeMenu: t, open: n = !1, children: r, dir: o, onOpenChange: s, modal: i = !0 } = e, a = Eo(t), [l, c] = T.useState(null), d = T.useRef(!1), u = gt(s), f = _l(o);
  return T.useEffect(() => {
    const p = () => {
  ...
  }, []), /* @__PURE__ */ h(lc, { ...a, children: /* @__PURE__ */ h(
    Ng,
    {
      scope: t,
      open: n,
...
Lc.displayName = nr;
var Lg = "MenuAnchor", da = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e, o = Eo(n);
    return /* @__PURE__ */ h(cc, { ...o, ...r, ref: t });
  }
);
da.displayName = Lg;
var ua = "MenuPortal", [Ag, Ac] = Kt(ua, {
  forceMount: void 0
}), Ic = (e) => {
  const { __scopeMenu: t, forceMount: n, children: r, container: o } = e, s = Gt(ua, t);
  return /* @__PURE__ */ h(Ag, { scope: t, forceMount: n, children: /* @__PURE__ */ h(Vt, { present: n || s.open, children: /* @__PURE__ */ h(ca, { asChild: !0, container: o, children: r }) }) });
};
Ic.displayName = ua;
var Ke = "MenuContent", [Ig, fa] = Kt(Ke), Rc = T.forwardRef(
  (e, t) => {
    const n = Ac(Ke, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, s = Gt(Ke, e.__scopeMenu), i = rr(Ke, e.__scopeMenu);
    return /* @__PURE__ */ h(Gn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ h(Vt, { present: r || s.open, children: /* @__PURE__ */ h(Gn.Slot, { scope: e.__scopeMenu, children: i.modal ? /* @__PURE__ */ h(Rg, { ...o, ref: t }) : /* @__PURE__ */ h(Pg, { ...o, ref: t }) }) }) });
  }
), Rg = T.forwardRef(
  (e, t) => {
...
}), Og = /* @__PURE__ */ jn("MenuContent.ScrollLock"), pa = T.forwardRef(
  (e, t) => {
    const {
      __scopeMenu: n,
      loop: r = !1,
      ...
      ...m
    } = e, y = Gt(Ke, n), v = rr(Ke, n), b = Eo(n), x = Dc(n), M = Tg(n), [w, E] = T.useState(null), S = T.useRef(null), k = Ie(t, S, y.onContentChange), D = T.useRef(0), C = T.useRef(""), N = T.useRef(0), L = T.useRef(null), P = T.useRef("right"), O = T.useRef(0), $ = g ? Tc : T.Fragment, W = g ? { as: Og, allowPinchZoom: !0 } : void 0, V = (A) => {
      const H = C.current + A, G = M().filter((_) => !_.disabled), z = document.activeElement, U = G.find((_) => _.ref.current === z)?.textValue, K = G.map((_) => _.textValue), B = Kg(K, H, U), J = G.find((_) => _.textValue === B)?.ref.current;
      (function _(ee) {
        C.current = ee, window.clearTimeout(D.current), ee !== "" && (D.current = window.setTimeout(() => _(""), 1e3));
      })(H), J && setTimeout(() => J.focus());
    };
    T.useEffect(() => () => window.clearTimeout(D.current), []), jp();
    const R = T.useCallback((A) => P.current === L.current?.side && qg(A, L.current?.area), []);
    return /* @__PURE__ */ h(
      Ig,
      {
        scope: n,
                    ...
                    children: /* @__PURE__ */ h(
                      dc,
                      {
                        ...
                        onKeyDown: le(m.onKeyDown, (A) => {
                          ...
                          const K = S.current;
                          if (A.target !== K || !Cg.includes(A.key)) return;
                          A.preventDefault();
                          const J = M().filter((_) => !_.disabled).map((_) => _.ref.current);
                          Sc.includes(A.key) && J.reverse(), jg(J);
                        }),
...
Rc.displayName = Ke;
var _g = "MenuGroup", ha = T.forwardRef(
  (e, t) => {
...
ha.displayName = _g;
var $g = "MenuLabel", Pc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
...
Pc.displayName = $g;
var so = "MenuItem", Ci = "menu.itemSelect", Mo = T.forwardRef(
  (e, t) => {
    const { disabled: n = !1, onSelect: r, ...o } = e, s = T.useRef(null), i = rr(so, e.__scopeMenu), a = fa(so, e.__scopeMenu), l = Ie(t, s), c = T.useRef(!1), d = () => {
      const u = s.current;
      if (!n && u) {
        const f = new CustomEvent(Ci, { bubbles: !0, cancelable: !0 });
        u.addEventListener(Ci, (p) => r?.(p), { once: !0 }), Pl(u, f), f.defaultPrevented ? c.current = !1 : i.onClose();
      }
    };
    return /* @__PURE__ */ h(
      Oc,
...
var Oc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, disabled: r = !1, textValue: o, ...s } = e, i = fa(so, n), a = Dc(n), l = T.useRef(null), c = Ie(t, l), [d, u] = T.useState(!1), [f, p] = T.useState("");
    return T.useEffect(() => {
      const g = l.current;
      ...
      Gn.ItemSlot,
      {
        ...
        disabled: r,
        textValue: o ?? f,
        children: /* @__PURE__ */ h(Om, { asChild: !0, ...a, focusable: !r, children: /* @__PURE__ */ h(
          Le.div,
          {
            role: "menuitem",
...
), Hg = "MenuCheckboxItem", _c = T.forwardRef(
  (e, t) => {
    const { checked: n = !1, onCheckedChange: r, ...o } = e;
    return /* @__PURE__ */ h(zc, { scope: e.__scopeMenu, checked: n, children: /* @__PURE__ */ h(
      Mo,
      {
...
var $c = "MenuRadioGroup", [Bg, Wg] = Kt(
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ h(Bg, { scope: e.__scopeMenu, value: n, onValueChange: s, children: /* @__PURE__ */ h(ha, { ...o, ref: t }) });
  }
);
Hc.displayName = $c;
var Bc = "MenuRadioItem", Wc = T.forwardRef(
  (e, t) => {
    const { value: n, ...r } = e, o = Wg(Bc, e.__scopeMenu), s = n === o.value;
    return /* @__PURE__ */ h(zc, { scope: e.__scopeMenu, checked: s, children: /* @__PURE__ */ h(
      Mo,
      {
        role: "menuitemradio",
        "aria-checked": s,
...
Wc.displayName = Bc;
var ma = "MenuItemIndicator", [zc, zg] = Kt(
  ma,
  { checked: !1 }
), Fc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, forceMount: r, ...o } = e, s = zg(ma, n);
    return /* @__PURE__ */ h(
      Vt,
      {
...
Fc.displayName = ma;
var Fg = "MenuSeparator", Uc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
    return /* @__PURE__ */ h(
      Le.div,
...
Uc.displayName = Fg;
var Ug = "MenuArrow", Yc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e, o = Eo(n);
    return /* @__PURE__ */ h(uc, { ...o, ...r, ref: t });
  }
);
Yc.displayName = Ug;
var Yg = "MenuSub", [X1, jc] = Kt(Yg), $n = "MenuSubTrigger", Vc = T.forwardRef(
  (e, t) => {
    const n = Gt($n, e.__scopeMenu), r = rr($n, e.__scopeMenu), o = jc($n, e.__scopeMenu), s = fa($n, e.__scopeMenu), i = T.useRef(null), { pointerGraceTimerRef: a, onPointerGraceIntentChange: l } = s, c = { __scopeMenu: e.__scopeMenu }, d = T.useCallback(() => {
    ...
    }, [a, l]), /* @__PURE__ */ h(da, { asChild: !0, ...c, children: /* @__PURE__ */ h(
      Oc,
      {
        id: o.triggerId,
        "aria-haspopup": "menu",
        ...
        onKeyDown: le(e.onKeyDown, (u) => {
          ...
          e.disabled || f && u.key === " " || Eg[r.dir].includes(u.key) && (n.onOpenChange(!0), n.content?.focus(), u.preventDefault());
        })
      }
    ) });
  }
...
var Kc = "MenuSubContent", Gc = T.forwardRef(
  (e, t) => {
    const n = Ac(Ke, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, s = Gt(Ke, e.__scopeMenu), i = rr(Ke, e.__scopeMenu), a = jc(Kc, e.__scopeMenu), l = T.useRef(null), c = Ie(t, l);
    return /* @__PURE__ */ h(Gn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ h(Vt, { present: r || s.open, children: /* @__PURE__ */ h(Gn.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ h(
      pa,
      {
        ...
        onKeyDown: le(e.onKeyDown, (d) => {
          const u = d.currentTarget.contains(d.target), f = Mg[i.dir].includes(d.key);
...
var Xg = Lc, Zg = da, Qg = Ic, Jg = Rc, ey = ha, ty = Pc, ny = Mo, ry = _c, oy = Hc, sy = Wc, ay = Fc, iy = Uc, ly = Yc, cy = Vc, dy = Gc, To = "DropdownMenu", [uy] = kn(
  To,
  [Nc]
), Re = Nc(), [fy, Xc] = uy(To), Zc = (e) => {
  const {
    ...
    onOpenChange: i,
    modal: a = !0
  } = e, l = Re(t), c = T.useRef(null), [d, u] = Js({
    prop: o,
    defaultProp: s ?? !1,
    onChange: i,
    caller: To
  ...
  return /* @__PURE__ */ h(
    fy,
    {
      ...
      modal: a,
      children: /* @__PURE__ */ h(Xg, { ...l, open: d, onOpenChange: u, dir: r, modal: a, children: n })
    }
  );
};
Zc.displayName = To;
var Qc = "DropdownMenuTrigger", Jc = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, disabled: r = !1, ...o } = e, s = Xc(Qc, n), i = Re(n);
    return /* @__PURE__ */ h(Zg, { asChild: !0, ...i, children: /* @__PURE__ */ h(
      Le.button,
      {
        type: "button",
        id: s.triggerId,
...
Jc.displayName = Qc;
var py = "DropdownMenuPortal", ed = (e) => {
  const { __scopeDropdownMenu: t, ...n } = e, r = Re(t);
  return /* @__PURE__ */ h(Qg, { ...r, ...n });
};
ed.displayName = py;
var td = "DropdownMenuContent", nd = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Xc(td, n), s = Re(n), i = T.useRef(!1);
    return /* @__PURE__ */ h(
      Jg,
      {
        id: o.contentId,
...
nd.displayName = td;
var hy = "DropdownMenuGroup", my = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Re(n);
    return /* @__PURE__ */ h(ey, { ...o, ...r, ref: t });
  }
);
my.displayName = hy;
var gy = "DropdownMenuLabel", yy = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Re(n);
    return /* @__PURE__ */ h(ty, { ...o, ...r, ref: t });
  }
);
yy.displayName = gy;
var vy = "DropdownMenuItem", rd = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Re(n);
...
rd.displayName = vy;
var by = "DropdownMenuCheckboxItem", wy = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Re(n);
  return /* @__PURE__ */ h(ry, { ...o, ...r, ref: t });
});
wy.displayName = by;
var xy = "DropdownMenuRadioGroup", ky = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Re(n);
  return /* @__PURE__ */ h(oy, { ...o, ...r, ref: t });
});
ky.displayName = xy;
var Cy = "DropdownMenuRadioItem", Ey = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Re(n);
  return /* @__PURE__ */ h(sy, { ...o, ...r, ref: t });
});
Ey.displayName = Cy;
var My = "DropdownMenuItemIndicator", Ty = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Re(n);
  return /* @__PURE__ */ h(ay, { ...o, ...r, ref: t });
});
Ty.displayName = My;
var Sy = "DropdownMenuSeparator", od = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Re(n);
  return /* @__PURE__ */ h(iy, { ...o, ...r, ref: t });
});
od.displayName = Sy;
var Ny = "DropdownMenuArrow", Dy = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Re(n);
...
Dy.displayName = Ny;
var Ly = "DropdownMenuSubTrigger", Ay = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Re(n);
  return /* @__PURE__ */ h(cy, { ...o, ...r, ref: t });
});
Ay.displayName = Ly;
var Iy = "DropdownMenuSubContent", Ry = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Re(n);
  return /* @__PURE__ */ h(
    dy,
    {
...
Ry.displayName = Iy;
var Py = Zc, Oy = Jc, _y = ed, $y = nd, Hy = rd, By = od;
function sd(e) {
  var t, n, r = "";
  if (typeof e == "string" || typeof e == "number") r += e;
  else if (typeof e == "object") if (Array.isArray(e)) {
    var o = e.length;
    for (t = 0; t < o; t++) e[t] && (n = sd(e[t])) && (r && (r += " "), r += n);
  } else for (n in e) e[n] && (r && (r += " "), r += n);
  return r;
}
function ad() {
  for (var e, t, n = 0, r = "", o = arguments.length; n < o; n++) (e = arguments[n]) && (t = sd(e)) && (r && (r += " "), r += t);
  return r;
}
const ya = "-", Wy = (e) => {
  const t = Fy(e), {
  ...
  return {
    getClassGroupId: (i) => {
      const a = i.split(ya);
      return a[0] === "" && a.length !== 1 && a.shift(), id(a, t) || zy(i);
    },
  ...
  const n = e[0], r = t.nextPart.get(n), o = r ? id(e.slice(1), r) : void 0;
  if (o)
    return o;
  ...
  let r = (o) => {
    ...
    const d = s.length === 0 ? o : o.substring(l), u = Ky(d), f = u !== d, p = c && c > l ? c - l : void 0;
    return {
      modifiers: s,
  ...
  return r;
}, Ky = (e) => e.endsWith(Ts) ? e.substring(0, e.length - 1) : e.startsWith(Ts) ? e.substring(1) : e, Gy = (e) => {
...
function Jy(e, ...t) {
  ...
  function i(l) {
    ...
    return n = qy(c), r = n.cache.get, o = n.cache.set, s = a, a(l);
  }
  function a(l) {
    const c = r(l);
    if (c)
...
const Ee = (e) => {
...
}, cd = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, dd = /^\((?:(\w[\w-]*):)?(.+)\)$/i, ev = /^\d+\/\d+$/, tv = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, nv = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, rv = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, ov = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, sv = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, rn = (e) => ev.test(e), ce = (e) => !!e && !Number.isNaN(Number(e)), Ct = (e) => !!e && Number.isInteger(Number(e)), ts = (e) => e.endsWith("%") && ce(e.slice(0, -1)), ct = (e) => tv.test(e), av = () => !0, iv = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  nv.test(e) && !rv.test(e)
), ud = () => !1, lv = (e) => ov.test(e), cv = (e) => sv.test(e), dv = (e) => !Z(e) && !Q(e), uv = (e) => Mn(e, hd, ud), Z = (e) => cd.test(e), Ht = (e) => Mn(e, md, iv), ns = (e) => Mn(e, gv, ce), Ti = (e) => Mn(e, fd, ud), fv = (e) => Mn(e, pd, cv), Hr = (e) => Mn(e, gd, lv), Q = (e) => dd.test(e), Rn = (e) => Tn(e, md), pv = (e) => Tn(e, yv), Si = (e) => Tn(e, fd), hv = (e) => Tn(e, hd), mv = (e) => Tn(e, pd), Br = (e) => Tn(e, gd, !0), Mn = (e, t, n) => {
  const r = cd.exec(e);
  return r ? r[1] ? t(r[1]) : n(r[2]) : !1;
}, Tn = (e, t, n = !1) => {
  const r = dd.exec(e);
  return r ? r[1] ? t(r[1]) : n : !1;
}, fd = (e) => e === "position" || e === "percentage", pd = (e) => e === "image" || e === "url", hd = (e) => e === "length" || e === "size" || e === "bg-size", md = (e) => e === "length", gv = (e) => e === "number", yv = (e) => e === "family-name", gd = (e) => e === "shadow", vv = () => {
  const e = Ee("color"), t = Ee("font"), n = Ee("text"), r = Ee("font-weight"), o = Ee("tracking"), s = Ee("leading"), i = Ee("breakpoint"), a = Ee("container"), l = Ee("spacing"), c = Ee("radius"), d = Ee("shadow"), u = Ee("inset-shadow"), f = Ee("text-shadow"), p = Ee("drop-shadow"), g = Ee("blur"), m = Ee("perspective"), y = Ee("aspect"), v = Ee("ease"), b = Ee("animate"), x = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], M = () => [
    ...
    span: ["full", Ct, Q, Z]
  }, Ct, Q, Z], L = () => [Ct, "auto", Q, Z], P = () => ["auto", "min", "max", "fr", Q, Z], O = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], $ = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], W = () => ["auto", ...k()], V = () => [rn, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...k()], R = () => [e, Q, Z], A = () => [...M(), Si, Ti, {
    position: [Q, Z]
  }], H = () => ["no-repeat", {
    repeat: ["", "x", "y", "space", "round"]
  }], G = () => ["auto", "cover", "contain", hv, uv, {
    size: [Q, Z]
  }], z = () => [ts, Rn, Ht], U = () => [
    ...
    Q,
    Z
  ], K = () => ["", ce, Rn, Ht], B = () => ["solid", "dashed", "dotted", "double"], J = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], _ = () => [ce, ts, Si, Ti], ee = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    g,
...
function rs({
  ...
  return /* @__PURE__ */ h(Py, { "data-slot": "dropdown-menu", ...e });
}
function os({
  ...e
}) {
...
function ss({
  ...
  return /* @__PURE__ */ h(_y, { children: /* @__PURE__ */ h(
    $y,
    {
...
const Ni = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, Di = ad, wv = (e, t) => (n) => {
  var r;
  if (t?.variants == null) return Di(e, n?.class, n?.className);
  ...
  return Di(e, i, l, n?.class, n?.className);
}, Ns = wv(
...
var xv = Object.freeze({
  ...
  whiteSpace: "nowrap",
  wordWrap: "normal"
}), kv = "VisuallyHidden", yd = T.forwardRef(
  (e, t) => /* @__PURE__ */ h(
    Le.span,
    {
      ...e,
...
yd.displayName = kv;
var Cv = yd, [So] = kn("Tooltip", [
  ko
]), No = ko(), vd = "TooltipProvider", Ev = 700, Ds = "tooltip.open", [Mv, va] = So(vd), bd = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = Ev,
...
bd.displayName = vd;
var Xn = "Tooltip", [Tv, or] = So(Xn), wd = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: r,
    ...
    delayDuration: a
  } = e, l = va(Xn, e.__scopeTooltip), c = No(t), [d, u] = T.useState(null), f = eo(), p = T.useRef(0), g = i ?? l.disableHoverableContent, m = a ?? l.delayDuration, y = T.useRef(!1), [v, b] = Js({
    prop: r,
    defaultProp: o ?? !1,
    onChange: (S) => {
  ...
  }, []), /* @__PURE__ */ h(lc, { ...c, children: /* @__PURE__ */ h(
    Tv,
    {
      scope: t,
      contentId: f,
...
wd.displayName = Xn;
var Ls = "TooltipTrigger", xd = T.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...r } = e, o = or(Ls, n), s = va(Ls, n), i = No(n), a = T.useRef(null), l = Ie(t, a, o.onTriggerChange), c = T.useRef(!1), d = T.useRef(!1), u = T.useCallback(() => c.current = !1, []);
    return T.useEffect(() => () => document.removeEventListener("pointerup", u), [u]), /* @__PURE__ */ h(cc, { asChild: !0, ...i, children: /* @__PURE__ */ h(
      Le.button,
      {
...
xd.displayName = Ls;
var ba = "TooltipPortal", [Sv, Nv] = So(ba, {
  forceMount: void 0
}), kd = (e) => {
  const { __scopeTooltip: t, forceMount: n, children: r, container: o } = e, s = or(ba, t);
  return /* @__PURE__ */ h(Sv, { scope: t, forceMount: n, children: /* @__PURE__ */ h(Vt, { present: n || s.open, children: /* @__PURE__ */ h(ca, { asChild: !0, container: o, children: r }) }) });
};
kd.displayName = ba;
var yn = "TooltipContent", Cd = T.forwardRef(
  (e, t) => {
    const n = Nv(yn, e.__scopeTooltip), { forceMount: r = n.forceMount, side: o = "top", ...s } = e, i = or(yn, e.__scopeTooltip);
    return /* @__PURE__ */ h(Vt, { present: r || i.open, children: i.disableHoverableContent ? /* @__PURE__ */ h(Ed, { side: o, ...s, ref: t }) : /* @__PURE__ */ h(Dv, { side: o, ...s, ref: t }) });
  }
), Dv = T.forwardRef((e, t) => {
  const n = or(yn, e.__scopeTooltip), r = va(yn, e.__scopeTooltip), o = T.useRef(null), s = Ie(t, o), [i, a] = T.useState(null), { trigger: l, onClose: c } = n, d = o.current, { onPointerInTransitChange: u } = r, f = T.useCallback(() => {
    a(null), u(!1);
  }, [u]), p = T.useCallback(
    (g, m) => {
      const y = g.currentTarget, v = { x: g.clientX, y: g.clientY }, b = Rv(v, y.getBoundingClientRect()), x = Pv(v, b), M = Ov(m.getBoundingClientRect()), w = $v([...x, ...M]);
      a(w), u(!0);
    },
    [u]
  );
  return T.useEffect(() => () => f(), [f]), T.useEffect(() => {
    ...
    if (i) {
      const g = (m) => {
        const y = m.target, v = { x: m.clientX, y: m.clientY }, b = l?.contains(y) || d?.contains(y), x = !_v(v, i);
        b ? f() : x && (f(), c());
      };
      return document.addEventListener("pointermove", g), () => document.removeEventListener("pointermove", g);
    }
  }, [l, d, i, c, f]), /* @__PURE__ */ h(Ed, { ...e, ref: s });
}), [Lv, Av] = So(Xn, { isInside: !1 }), Iv = /* @__PURE__ */ Ap("TooltipContent"), Ed = T.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: r,
      ...
      ...a
    } = e, l = or(yn, n), c = No(n), { onClose: d } = l;
      ...
      ea,
      {
        ...
        children: /* @__PURE__ */ I(
          dc,
          {
            ...
            children: [
              /* @__PURE__ */ h(Iv, { children: r }),
              /* @__PURE__ */ h(Lv, { scope: n, isInside: !0, children: /* @__PURE__ */ h(Cv, { id: l.contentId, role: "tooltip", children: o || r }) })
            ]
          }
        )
      }
...
Cd.displayName = yn;
var Md = "TooltipArrow", Td = T.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...r } = e, o = No(n);
    return Av(
      Md,
      n
    ).isInside ? null : /* @__PURE__ */ h(uc, { ...o, ...r, ref: t });
  }
);
Td.displayName = Md;
function Rv(e, t) {
...
var Bv = bd, Wv = wd, zv = xd, Fv = kd, Uv = Cd, Yv = Td;
function jv({
  delayDuration: e = 0,
  ...t
}) {
...
function As({
  ...
  return /* @__PURE__ */ h(jv, { children: /* @__PURE__ */ h(Wv, { "data-slot": "tooltip", ...e }) });
}
function Is({
  ...e
}) {
...
function Rs({
  ...
  return /* @__PURE__ */ h(Fv, { children: /* @__PURE__ */ I(
    Uv,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ h(Yv, { className: "bg-foreground fill-foreground z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" })
      ]
    }
  ) });
}
...
}, on = () => /* @__PURE__ */ h("div", { className: "w-px h-5 bg-border mx-0.5 shrink-0" }), Vv = bt(function({ editor: t, onCopyMarkdown: n, onOpenLinkPopover: r, className: o = "", autoReorderChecklist: s = !1, aiEnabled: i = !1, onAISparklesClick: a }) {
  const l = Y(null), [c, d] = j(!1), [u, f] = j(void 0), p = ul({
    editor: t,
    selector: ({ editor: E }) => ({
      canUndo: E.can().undo(),
      canRedo: E.can().redo(),
  ...
  return /* @__PURE__ */ I("div", { className: `flex items-center gap-0.5 px-2 py-1.5 border-b border-border/30 bg-muted/30 overflow-x-auto scrollbar-hide editor-toolbar ${o}`, children: [
    /* @__PURE__ */ h(
      xe,
      {
        ...
        disabled: !p?.canUndo,
        tooltip: "Undo (Ctrl+Z)",
        children: /* @__PURE__ */ h(Qu, { size: 16 })
      }
    ),
    /* @__PURE__ */ h(
      xe,
      {
        ...
        children: /* @__PURE__ */ h(Ju, { size: 16 })
      }
    ),
    /* @__PURE__ */ h(on, {}),
    /* @__PURE__ */ h(
    ...
    /* @__PURE__ */ h(
      xe,
      {
        ...
        children: /* @__PURE__ */ h(ml, { size: 16 })
      }
    ),
    /* @__PURE__ */ h(
      xe,
    ...
    /* @__PURE__ */ h(
      xe,
      {
        ...
        children: /* @__PURE__ */ h(Hs, { size: 16 })
      }
    ),
    /* @__PURE__ */ h(
      xe,
    ...
    /* @__PURE__ */ I(rs, { children: [
      ...
      /* @__PURE__ */ I(ss, { align: "start", children: [
        ...
        /* @__PURE__ */ I(we, { onClick: () => v("note"), children: [
          /* @__PURE__ */ h(bl, { size: 16, className: "mr-2", style: { color: "#FF8200" } }),
          " Note"
        ] }),
        /* @__PURE__ */ I(we, { onClick: () => v("prompt"), children: [
          /* @__PURE__ */ h(nf, { size: 16, className: "mr-2", style: { color: "#B244B3" } }),
          " Prompt"
        ] }),
        /* @__PURE__ */ I(we, { onClick: () => v("resources"), children: [
          /* @__PURE__ */ h(rf, { size: 16, className: "mr-2", style: { color: "#63B148" } }),
          " Resources"
        ] }),
        /* @__PURE__ */ I(we, { onClick: () => v("todo"), children: [
          /* @__PURE__ */ h(wl, { size: 16, className: "mr-2", style: { color: "#4479B3" } }),
          " Todo"
        ] })
      ] })
    ] }),
...
function Kv({ editor: e, isOpen: t, onClose: n, focusTrigger: r = 0, initialSearchQuery: o, editorMode: s = "wysiwyg", rawMarkdown: i = "", onRawMarkdownChange: a, onMatchesChange: l }) {
      ...
      children: [
        /* @__PURE__ */ I("div", { className: "find-replace-row", children: [
          /* @__PURE__ */ I("div", { className: "find-replace-input-wrapper", children: [
            /* @__PURE__ */ h(sf, { size: 14, className: "find-replace-icon" }),
            /* @__PURE__ */ h(
              "input",
              {
                ref: $,
...
const Gv = typeof navigator < "u" && /Mac|iPod|iPhone|iPad/.test(navigator.platform), dt = Gv ? "⌘" : "Ctrl", qv = ({ editor: e }) => {
      ...
      p && r < s && /* @__PURE__ */ I(ye, { children: [
        /* @__PURE__ */ h(
          "button",
          {
            ...
            children: /* @__PURE__ */ h(qs, { size: 14 })
          }
        ),
        /* @__PURE__ */ h(
          "button",
      ...
      handleDOMEvents: {
        contextmenu(t, n) {
          ...
          if (o && o.closest(".ProseMirror")) {
            ...
            return e.chain().focus().setTextSelection(s).run(), nb(n, e, s), !0;
          }
          return !1;
        }
      }
...
function nb(e, t, n) {
  ...
  const m = [
    ...
    { label: "divider" },
    { label: "Copy Table", icon: "copy", action: () => rb(t) }
  ], y = {
...
}), sb = Jf.extend({}), Fn = new De("tableSorting");
let Ft = null, Hn = null;
function ab(e) {
...
function lb(e, t, n) {
  ...
  if (c.length < 2) {
    Li(n, i), o.dispatch(r.tr.setMeta(Fn, { updated: !0 }));
    return;
  }
  const d = c.map((g) => {
    let m = "", y = 0;
  ...
  d.sort((g, m) => ib(g.sortValue, m.sortValue, i));
...
function cb(e, t, n, r) {
  ...
  return s.style.cssText = "display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;padding:0;font-size:10px;color:" + (e ? a : l) + ";background:transparent;border:none;border-radius:3px;cursor:pointer;user-select:none;transition:all 0.15s ease;opacity:" + (e ? "1" : "0.5") + ";pointer-events:auto;vertical-align:middle;", s.addEventListener("mouseenter", () => {
    ...
    d.preventDefault(), d.stopPropagation(), lb(r, t, n);
  ...
  return new Ne({
    ...
    state: {
      ...
      apply(t, n, r, o) {
        ...
        return !t.docChanged && !s?.updated && Hn ? Hn.map(t.mapping, t.doc) : (Hn = ub(o.doc, e), Hn);
      }
    },
    props: {
      decorations(t) {
        ...
        if (i.type.name === "tableRow") {
          ...
          i.forEach((d, u) => {
            if (d.type.name === "tableHeader") {
              ...
              const m = Ft?.tablePos === s && Ft?.columnIndex === l ? Ft.direction : null, y = l, v = s, b = Ze.widget(p, () => cb(m, v, y, t), { side: 1, key: "sort-" + s + "-" + y });
              n.push(b);
            }
            c += d.nodeSize, l++;
          });
    ...
    return {
      toggleTaskList: () => ({ editor: e, commands: t, state: n, tr: r, dispatch: o, chain: s, can: i }) => {
        ...
        if (M) {
          ...
          return E >= 0 && wa(r, E, u, f, y, { checked: !1 }), o(r), !0;
        }
      ...
      new Ne({
        ...
        state: {
          ...
          apply(r, o, s, i) {
            ...
            } : r.docChanged ? bb(s.doc, i.doc, t.listItemTypes) ? {
              collapsedItems: new Set(e.collapsedItems),
              decorations: zr(i.doc, e, t, n),
              docVersion: o.docVersion + 1
            } : {
...
const xb = [
  ...
  info: { iconElements: xb, label: "Info", color: "var(--callout-info)", borderColor: "var(--callout-info-border)" },
  note: { iconElements: kb, label: "Note", color: "var(--callout-note)", borderColor: "var(--callout-note-border)" },
  prompt: { iconElements: Cb, label: "Prompt", color: "var(--callout-prompt)", borderColor: "var(--callout-prompt-border)" },
  resources: { iconElements: Eb, label: "Resources", color: "var(--callout-resources)", borderColor: "var(--callout-resources-border)" },
  todo: { iconElements: Mb, label: "Todo", color: "var(--callout-todo)", borderColor: "var(--callout-todo-border)" },
  summary: { iconElements: Tb, label: "Summary", color: "var(--callout-summary)", borderColor: "var(--callout-summary-border)" }
}, Nb = Object.keys(ln);
class Db {
  constructor(t, n, r) {
  ...
  toggleCollapse() {
    this.collapsed = !this.collapsed, this.collapsed ? (this.dom.classList.add("callout-collapsed"), this.contentWrapper.classList.add("callout-content-hidden"), this.headerEl.title = "Click to expand") : (this.dom.classList.remove("callout-collapsed"), this.contentWrapper.classList.remove("callout-content-hidden"), this.headerEl.title = "Click to collapse"), this.collapseIndicator.innerHTML = "", this.collapseIndicator.appendChild(
      this.collapsed ? Bt(Sb, 16) : Bt(is, 16)
    );
  }
  // ── Dropdown Portal ──
  toggleDropdown() {
...
const Lb = go.create({
  ...
  addNodeView() {
    return ({ node: e, view: t, getPos: n }) => new Db(e, t, n);
  },
  addCommands() {
    return {
      ...
      new Ne({
        ...
        props: {
          handleDOMEvents: {
            copy(e, t) {
              const { state: n } = e;
              if (!(n.selection instanceof Ff)) return !1;
...
function Ut(e, t) {
  try {
    const r = (Rb[e] ||= new Intl.DateTimeFormat("en-US", {
      timeZone: e,
...
class rt extends Date {
  //#region static
  constructor(...t) {
    super(), t.length > 1 && typeof t[t.length - 1] == "string" && (this.timeZone = t.pop()), this.internal = /* @__PURE__ */ new Date(), isNaN(Ut(this.timeZone, this)) ? this.setTime(NaN) : t.length ? typeof t[0] == "number" && (t.length === 1 || t.length === 2 && typeof t[1] != "number") ? this.setTime(t[0]) : typeof t[0] == "string" ? this.setTime(+new Date(t[0])) : t[0] instanceof Date ? this.setTime(+t[0]) : (this.setTime(+new Date(...t)), Sd(this), Os(this)) : this.setTime(Date.now());
  }
  static tz(t, ...n) {
...
const Nd = 6048e5, _b = 864e5, _i = Symbol.for("constructDateFrom");
function ke(e, t) {
...
function Id(e, t, n) {
  ...
  return Math.round((a - l) / _b);
}
function Hb(e, t) {
  const n = Ad(e, t), r = ke(e, 0);
...
function Yb(e) {
  return !(!Rd(e) && typeof e != "number" || isNaN(+he(e)));
}
function jb(e, t, n) {
  const [r, o] = Sn(
    n?.in,
...
function On(e) {
  return (t, n = {}) => {
    ...
    if (!s)
      return null;
    const i = s[0], a = r && e.parsePatterns[r] || e.parsePatterns[e.defaultParseWidth], l = Array.isArray(a) ? mw(a, (u) => u.test(i)) : (
...
const yw = /^(\d+)(th|st|nd|rd)?/i, vw = /\d+/i, bw = {
  narrow: /^(b|a)/i,
...
function $d(e, t) {
  const n = he(e, t?.in), r = +Zn(n) - +Hb(n);
  return Math.round(r / Nd) + 1;
}
function Hd(e, t) {
...
function Aw(e, t) {
  const n = sr(), r = t?.firstWeekContainsDate ?? t?.locale?.options?.firstWeekContainsDate ?? n.firstWeekContainsDate ?? n.locale?.options?.firstWeekContainsDate ?? 1, o = Hd(e, t), s = ke(t?.in || e, 0);
  return s.setFullYear(o, 0, r), s.setHours(0, 0, 0, 0), vn(s, t);
}
function Bd(e, t) {
  const n = he(e, t?.in), r = +vn(n, t) - +Aw(n, t);
  return Math.round(r / Nd) + 1;
}
function pe(e, t) {
...
const zi = (e, t) => {
  ...
  return s.replace("{{date}}", zi(r, t)).replace("{{time}}", Wd(o, t));
}, Rw = {
  p: Wd,
  P: Iw
}, Pw = /^D+$/, Ow = /^Y+$/, _w = ["D", "DD", "YY", "YYYY"];
function $w(e) {
  return Pw.test(e);
}
function Hw(e) {
...
function Bw(e, t, n) {
  const r = Ww(e, t, n);
  if (console.warn(r), _w.includes(e)) throw new RangeError(r);
}
function Ww(e, t, n) {
  const r = e[0] === "Y" ? "years" : "days of the month";
  return `Use \`${e.toLowerCase()}\` instead of \`${e}\` (in \`${t}\`) for formatting ${r} to the input \`${n}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`;
}
const zw = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g, Fw = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g, Uw = /^'([^]*?)'?$/, Yw = /''/g, jw = /[a-zA-Z]/;
function Vw(e, t, n) {
  const r = sr(), o = n?.locale ?? r.locale ?? xa, s = n?.firstWeekContainsDate ?? n?.locale?.options?.firstWeekContainsDate ?? r.firstWeekContainsDate ?? r.locale?.options?.firstWeekContainsDate ?? 1, i = n?.weekStartsOn ?? n?.locale?.options?.weekStartsOn ?? r.weekStartsOn ?? r.locale?.options?.weekStartsOn ?? 0, a = he(e, n?.in);
  if (!Yb(a))
    throw new RangeError("Invalid time value");
  let l = t.match(Fw).map((d) => {
    const u = d[0];
    if (u === "p" || u === "P") {
      const f = Rw[u];
  ...
  return l.map((d) => {
    ...
    const u = d.value;
    (!n?.useAdditionalWeekYearTokens && Hw(u) || !n?.useAdditionalDayOfYearTokens && $w(u)) && Bw(u, t, String(e));
    const f = Hi[u[0]];
...
function o0(e, t) {
  ...
  return t.getMonth(e) === t.getMonth(s) ? Fi : r0;
}
function zd(e, t) {
...
class Fe {
   ...
   */
  constructor(t, n) {
    this.Date = Date, this.today = () => this.overrides?.today ? this.overrides.today() : this.options.timeZone ? Ae.tz(this.options.timeZone) : new this.Date(), this.newDate = (r, o, s) => this.overrides?.newDate ? this.overrides.newDate(r, o, s) : this.options.timeZone ? new Ae(r, o, s, this.options.timeZone) : new Date(r, o, s), this.addDays = (r, o) => this.overrides?.addDays ? this.overrides.addDays(r, o) : Dd(r, o), this.addMonths = (r, o) => this.overrides?.addMonths ? this.overrides.addMonths(r, o) : Ld(r, o), this.addWeeks = (r, o) => this.overrides?.addWeeks ? this.overrides.addWeeks(r, o) : Bb(r, o), this.addYears = (r, o) => this.overrides?.addYears ? this.overrides.addYears(r, o) : Wb(r, o), this.differenceInCalendarDays = (r, o) => this.overrides?.differenceInCalendarDays ? this.overrides.differenceInCalendarDays(r, o) : Id(r, o), this.differenceInCalendarMonths = (r, o) => this.overrides?.differenceInCalendarMonths ? this.overrides.differenceInCalendarMonths(r, o) : jb(r, o), this.eachMonthOfInterval = (r) => this.overrides?.eachMonthOfInterval ? this.overrides.eachMonthOfInterval(r) : Kb(r), this.eachYearOfInterval = (r) => {
    ...
    }, this.endOfBroadcastWeek = (r) => this.overrides?.endOfBroadcastWeek ? this.overrides.endOfBroadcastWeek(r) : s0(r, this), this.endOfISOWeek = (r) => this.overrides?.endOfISOWeek ? this.overrides.endOfISOWeek(r) : Zb(r), this.endOfMonth = (r) => this.overrides?.endOfMonth ? this.overrides.endOfMonth(r) : Vb(r), this.endOfWeek = (r, o) => this.overrides?.endOfWeek ? this.overrides.endOfWeek(r, o) : _d(r, this.options), this.endOfYear = (r) => this.overrides?.endOfYear ? this.overrides.endOfYear(r) : qb(r), this.format = (r, o, s) => {
      const i = this.overrides?.format ? this.overrides.format(r, o, this.options) : Vw(r, o, this.options);
      return this.options.numerals && this.options.numerals !== "latn" ? this.replaceDigits(i) : i;
    }, this.getISOWeek = (r) => this.overrides?.getISOWeek ? this.overrides.getISOWeek(r) : $d(r), this.getMonth = (r, o) => this.overrides?.getMonth ? this.overrides.getMonth(r, this.options) : qw(r, this.options), this.getYear = (r, o) => this.overrides?.getYear ? this.overrides.getYear(r, this.options) : Xw(r, this.options), this.getWeek = (r, o) => this.overrides?.getWeek ? this.overrides.getWeek(r, this.options) : Bd(r, this.options), this.isAfter = (r, o) => this.overrides?.isAfter ? this.overrides.isAfter(r, o) : Zw(r, o), this.isBefore = (r, o) => this.overrides?.isBefore ? this.overrides.isBefore(r, o) : Qw(r, o), this.isDate = (r) => this.overrides?.isDate ? this.overrides.isDate(r) : Rd(r), this.isSameDay = (r, o) => this.overrides?.isSameDay ? this.overrides.isSameDay(r, o) : Ub(r, o), this.isSameMonth = (r, o) => this.overrides?.isSameMonth ? this.overrides.isSameMonth(r, o) : Jw(r, o), this.isSameYear = (r, o) => this.overrides?.isSameYear ? this.overrides.isSameYear(r, o) : e0(r, o), this.max = (r) => this.overrides?.max ? this.overrides.max(r) : zb(r), this.min = (r) => this.overrides?.min ? this.overrides.min(r) : Fb(r), this.setMonth = (r, o) => this.overrides?.setMonth ? this.overrides.setMonth(r, o) : t0(r, o), this.setYear = (r, o) => this.overrides?.setYear ? this.overrides.setYear(r, o) : n0(r, o), this.startOfBroadcastWeek = (r, o) => this.overrides?.startOfBroadcastWeek ? this.overrides.startOfBroadcastWeek(r, this) : zd(r, this), this.startOfDay = (r) => this.overrides?.startOfDay ? this.overrides.startOfDay(r) : Qn(r), this.startOfISOWeek = (r) => this.overrides?.startOfISOWeek ? this.overrides.startOfISOWeek(r) : Zn(r), this.startOfMonth = (r) => this.overrides?.startOfMonth ? this.overrides.startOfMonth(r) : Gb(r), this.startOfWeek = (r, o) => this.overrides?.startOfWeek ? this.overrides.startOfWeek(r, this.options) : vn(r, this.options), this.startOfYear = (r) => this.overrides?.startOfYear ? this.overrides.startOfYear(r) : Od(r), this.options = { locale: xa, ...t }, this.overrides = n;
  }
  /**
...
function pt(e, t, n = it) {
  ...
  return r.some((a) => {
    ...
    return jd(a) ? s(e, a.after) > 0 : Vd(a) ? s(a.before, e) > 0 : typeof a == "function" ? a(e) : !1;
  });
}
...
const j0 = Xd, V0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  formatCaption: qd,
  formatDay: W0,
  ...
  formatWeekNumber: U0,
  formatWeekNumberHeader: Y0,
  formatWeekdayName: F0,
  formatYearCaption: j0,
...
const cx = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  labelGrid: Qd,
  labelGridcell: ex,
  labelMonthDropdown: tx,
  labelNav: nx,
  labelNext: rx,
  labelPrevious: ox,
  labelWeekNumber: ax,
  labelWeekNumberHeader: ix,
  labelWeekday: sx,
  labelYearDropdown: lx
}, Symbol.toStringTag, { value: "Module" })), ir = (e) => e instanceof HTMLElement ? e : null, cs = (e) => [
  ...e.querySelectorAll("[data-animated-month]") ?? []
], dx = (e) => ir(e.querySelector("[data-animated-month]")), ds = (e) => ir(e.querySelector("[data-animated-caption]")), us = (e) => ir(e.querySelector("[data-animated-weeks]")), ux = (e) => ir(e.querySelector("[data-animated-nav]")), fx = (e) => ir(e.querySelector("[data-animated-weekdays]"));
function px(e, t, { classNames: n, months: r, focused: o, dateLib: s }) {
...
function yx(e, t, n, r) {
  const { addDays: o, endOfBroadcastWeek: s, endOfISOWeek: i, endOfMonth: a, endOfWeek: l, getISOWeek: c, getWeek: d, startOfBroadcastWeek: u, startOfISOWeek: f, startOfWeek: p } = r, g = e.reduce((m, y) => {
    ...
    const w = x.reduce((S, k) => {
      const D = n.ISOWeek ? c(k) : d(k), C = S.find((L) => L.weekNumber === D), N = new Fd(k, y, r);
      return C ? C.days.push(N) : S.push(new i0(D, [N])), S;
    }, []), E = new a0(y, w);
    return m.push(E), m;
  }, []);
...
function kx(e, t) {
  const [n, r] = vx(e, t), { startOfMonth: o, endOfMonth: s } = t, i = Ui(e, n, r, t), [a, l] = Do(
    i,
  ...
  const c = gx(a, r, e, t), d = hx(c, e.endMonth ? s(e.endMonth) : void 0, e, t), u = yx(c, d, e, t), f = xx(u), p = mx(u), g = wx(a, n, e, t), m = bx(a, r, e, t), { disableNavigation: y, onMonthChange: v } = e, b = (E) => f.some((S) => S.days.some((k) => k.isEqualTo(E))), x = (E) => {
    if (y)
      return;
    let S = o(E);
...
function Jd(e, t, n, r, o, s, i, a = 0) {
  if (a > 365)
    return;
  const l = Ex(e, t, n.date, r, o, s, i), c = !!(s.disabled && pt(l, s.disabled, i)), d = !!(s.hidden && pt(l, s.hidden, i)), u = l, f = new Fd(l, u, i);
  return !c && !d ? f : Jd(e, t, f, r, o, s, i, a + 1);
}
function Mx(e, t, n, r, o) {
  const { autoFocus: s } = e, [i, a] = j(), l = Cx(t.days, n, r || (() => !1), i), [c, d] = j(s ? l : void 0);
  return {
    ...
    moveFocus: (m, y) => {
      if (!c)
        return;
      const v = Jd(m, y, c, t.navStart, t.navEnd, e, o);
      v && (e.disableNavigation && !t.days.some((x) => x.isEqualTo(v)) || (t.goToDay(v), d(v)));
    }
  };
}
function Tx(e, t) {
  const { selected: n, required: r, onSelect: o } = e, [s, i] = Do(n, o ? n : void 0), a = o ? n : s, { isSameDay: l } = t, c = (p) => a?.some((g) => l(g, p)) ?? !1, { min: d, max: u } = e;
  return {
    selected: a,
    select: (p, g, m) => {
      let y = [...a ?? []];
...
function Dx(e, t, n = it) {
  const r = Array.isArray(t) ? t : [t];
  if (r.filter((a) => typeof a != "function").some((a) => typeof a == "boolean" ? a : n.isDate(a) ? ft(e, a, !1, n) : Gd(a, n) ? a.some((l) => ft(e, l, !1, n)) : ka(a) ? a.from && a.to ? ji(e, { from: a.from, to: a.to }, n) : !1 : Kd(a) ? Nx(e, a.dayOfWeek, n) : Yd(a) ? n.isAfter(a.before, a.after) ? ji(e, {
    from: n.addDays(a.after, 1),
    to: n.addDays(a.before, -1)
  }, n) : pt(e.from, a, n) || pt(e.to, a, n) : jd(a) || Vd(a) ? pt(e.from, a, n) || pt(e.to, a, n) : !1))
    return !0;
...
function Lx(e, t) {
  const { disabled: n, excludeDisabled: r, selected: o, required: s, onSelect: i } = e, [a, l] = Do(o, i ? o : void 0), c = i ? o : a;
  return {
    selected: c,
    select: (f, p, g) => {
      const { min: m, max: y } = e, v = f ? Sx(f, c, m, y, s, t) : void 0;
      return r && n && v?.from && v.to && Dx({ from: v.from, to: v.to }, n, t) && (v.from = f, v.to = void 0), i || l(v), i?.(v, f, p, g), v;
    },
...
function Ix(e, t) {
  const n = Ax(e, t), r = Tx(e, t), o = Lx(e, t);
  switch (e.mode) {
    case "single":
      return n;
    case "multiple":
...
function Rx(e) {
  ...
  return X.createElement(
    ...
    X.createElement(
      n.Root,
      { rootRef: t.animate ? yr : void 0, className: Oo, style: gr, dir: t.dir, id: t.id, lang: t.lang, nonce: t.nonce, title: t.title, role: t.role, "aria-label": t["aria-label"], "aria-labelledby": t["aria-labelledby"], ..._o },
      X.createElement(
        n.Months,
          ...
          X.createElement(
            ...
            X.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: a[te.Weeks], style: w?.[te.Weeks] }, ae.weeks.map((re) => X.createElement(
              ...
              re.days.map((fe) => {
                ...
                if (ue[ge.focused] = !ue.hidden && !!J?.isEqualTo(fe), ue[Xe.selected] = z?.(Te) || ue.selected, ka(K)) {
                ...
                const Xt = q0(ue, w, t.modifiersStyles), Zt = _0(ue, a, t.modifiersClassNames), Ho = !Ln && !ue.hidden ? be(Te, ue, s.options, s) : void 0;
                return (
                  // biome-ignore lint/a11y/useSemanticElements: react component
                  X.createElement(n.Day, { key: `${s.format(Te, "yyyy-MM-dd")}_${s.format(fe.displayMonth, "yyyy-MM")}`, day: fe, modifiers: ue, className: Zt.join(" "), style: Xt, role: "gridcell", "aria-selected": ue.selected || void 0, "aria-label": Ho, "data-day": s.format(Te, "yyyy-MM-dd"), "data-month": fe.outside ? s.format(Te, "yyyy-MM") : void 0, "data-selected": ue.selected || void 0, "data-disabled": ue.disabled || void 0, "data-hidden": ue.hidden || void 0, "data-outside": fe.outside || void 0, "data-focused": ue.focused || void 0, "data-today": ue.today || void 0 }, !ue.hidden && Ln ? X.createElement(n.DayButton, { className: a[te.DayButton], style: w?.[te.DayButton], type: "button", day: fe, modifiers: ue, disabled: ue.disabled || void 0, tabIndex: _(fe) ? 0 : -1, "aria-label": de(Te, ue, s.options, s), onClick: fr(fe, ue), onBlur: hr(fe, ue), onFocus: pr(fe, ue), onKeyDown: mr(fe, ue), onMouseEnter: Ao(fe, ue), onMouseLeave: Io(fe, ue) }, S(Te, s.options, s)) : !ue.hidden && S(fe.date, s.options, s))
                );
              })
            )))
          )
  ...
  return /* @__PURE__ */ h(
    Rx,
    {
      ...
      components: {
        ...
        Chevron: ({ className: c, orientation: d, ...u }) => d === "left" ? /* @__PURE__ */ h(pf, { className: ie("size-4", c), ...u }) : d === "right" ? /* @__PURE__ */ h(
          hf,
          {
            className: ie("size-4", c),
            ...u
          }
        ) : /* @__PURE__ */ h(mf, { className: ie("size-4", c), ...u }),
        DayButton: Ox,
...
let pn = null;
const eu = /* @__PURE__ */ new Map(), _x = /* @__PURE__ */ new Map();
function Qr() {
  if (!pn) return;
  const e = pn;
  pn = null, setTimeout(() => {
...
function Wx({ node: e, updateAttributes: t, selected: n }) {
  const r = Y(null), o = e.attrs.date || hn(), s = tu(o), i = Ea(o), a = F(() => {
    if (!r.current) return "";
  ...
  return q(() => (eu.set(o, (l) => {
    ...
    "span",
    {
      ...
      "data-date": o,
      children: [
        /* @__PURE__ */ h(xl, { size: 14, className: "date-icon" }),
...
const Fx = new De("datePillPaste"), Ux = go.create({
  name: "datePill",
  group: "inline",
  inline: !0,
  atom: !0,
  ...
  renderHTML({ node: e, HTMLAttributes: t }) {
    const n = e.attrs.date, r = tu(n), o = Ea(n);
    return [
      "span",
      xn(this.options.HTMLAttributes, t, {
        "data-type": "date-pill",
...
function Yx({ node: e, selected: t, editor: n, getPos: r, deleteNode: o }) {
...
const jx = new De("tagPillPaste"), Vx = go.create({
  name: "tagPill",
  group: "inline",
  inline: !0,
  atom: !0,
...
function Qx(e, t) {
  const { alt: n, align: r, width: o } = Zx(e), s = {
    left: "margin-right: auto;",
    center: "margin-left: auto; margin-right: auto;",
    right: "margin-left: auto;"
...
function Vi(e) {
  ...
  for (const s of r) {
    const i = s.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
    i ? o.push(Qx(i[1], i[2])) : o.push(`<p>${lo(s.trim())}</p>`);
  }
  return o.join("");
}
function nu(e) {
...
const sk = Oe.create({
        ...
        state: {
          ...
          apply(r, o, s, i) {
            return r.getMeta("collapsibleHeading") ? {
              ...
              docVersion: o.docVersion + 1
            } : r.docChanged ? (rk(s.doc, i.doc, e, t.levels), ok(s.doc, i.doc, t.levels) ? {
              collapsedHeadings: new Set(e.collapsedHeadings),
              decorations: Fr(i.doc, e, t, n),
              docVersion: o.docVersion + 1
            } : {
...
}), ak = /\[([^\]]+)\]\(([^)]+)\)$/, ik = /^(https?:\/\/|www\.)[^\s]+$/i, lk = Oe.create({
...
}), Ur = new De("searchHighlight"), dk = Oe.create({
  ...
  name: "tabIndent"
  // No plugins — logic moved to InputDispatcher
}), fk = new De("inputDispatcher"), pk = ["info", "note", "prompt", "resources", "todo"];
function hk(e) {
        ...
        props: {
          ...
          handleTextInput(t, n, r, o) {
            ...
            if (m.wrap(v, b), p > 1) {
              ...
              x && x.type === u && sp(m.doc, p - 1) && m.join(p - 1);
            }
          ...
          handleKeyDown(t, n) {
            if (n.key === "Tab") {
              const { state: r, dispatch: o } = t, s = hk(r);
              if (!s)
                return n.preventDefault(), !0;
              n.preventDefault();
            ...
            if (n.key === "Enter") {
              ...
              for (const c of pk)
                if (a === `\`\`\`${c}`) {
                  ...
                  if (f && p) {
                    const g = p.create(), m = f.create({ type: c }, Sl.from(g));
                    d.insert(u, m);
...
function Nk(e, t, n) {
  let r = !1;
  return e.nodesBetween(t, n, (o) => ou.has(o.type.name) ? (r = !0, !1) : !0), r;
}
function Dk(e, t, n) {
  const r = [];
  let o = t, s = n;
  const i = (l) => l && (l.from < o || l.to > s) ? (r.push(l), o = l.from, s = l.to, !0) : !1;
  i(wk(e, o, s)), Sk(e, t) && (i(xk(e, o, s)), i(kk(e, o, s))), i(Ek(e, o, s)), i(Ck(e, o, s));
  const a = Mk(e);
  if (a.length > 0) {
    const l = Tk(a, o, s);
    for (const c of l)
  ...
  addKeyboardShortcuts() {
    return {
      ...
      "Mod-a": ({ editor: e }) => {
        ...
        if (t.expansionDepth > 0 && o === t.lastExpandedFrom && s === t.lastExpandedTo || (t.expansionDepth = 0), r instanceof Uf || o === 0 && s === n.content.size)
          return !0;
        const a = Dk(n, o, s);
        let l = null;
        for (const c of a)
...
}), Ak = /#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})\b/g;
function Ik(e) {
  let t = e.replace("#", "");
...
function su(e, t, n) {
  ...
  return e.nodesBetween(t, n, (o, s) => {
    ...
    const i = o.text || "";
    let a;
    const l = new RegExp(Ak.source, "g");
    for (; (a = l.exec(i)) !== null; ) {
          ...
          handleKeyDown(t, n) {
            ...
            if ((n.metaKey || n.ctrlKey) && n.key === "z" && !n.shiftKey) {
              if (n.preventDefault(), e.isTypingReplace && e.undoStack.length > 0) {
                ...
                return e.typedBuffer = o, o === "" && (e.isTypingReplace = !1), fp(t.state, t.dispatch), setTimeout(() => {
                  const s = Mt(t);
            ...
            if ((n.metaKey || n.ctrlKey) && (n.key === "z" && n.shiftKey || n.key === "y")) {
              if (n.preventDefault(), e.redoStack.length > 0) {
                ...
                return e.typedBuffer = o, e.isTypingReplace = !0, pp(t.state, t.dispatch), setTimeout(() => {
                  const s = Mt(t);
                  e.ranges = s, s.length === 0 && Me(e);
                }, 10), !0;
              }
...
}), Hk = new De("linkBoundary"), Bk = Oe.create({
  name: "linkBoundary",
  addProseMirrorPlugins() {
    return [
      new Ne({
...
}), Wk = new De("smartCopyPaste"), au = /* @__PURE__ */ new Set(["codeBlock", "callout"]);
function Zi(e) {
  const { state: t } = e, { selection: n } = t, { $from: r, $to: o } = n;
  for (let s = r.depth; s > 0; s--) {
    const i = r.node(s);
    if (!au.has(i.type.name)) continue;
...
`);
              ...
              const p = f.map((m) => m === "" ? d.create() : d.create(null, c.text(m))), g = Sl.from(p);
              return new Yo(g, 0, 0);
            } else {
...
async function Kk(e, t, n) {
  return new Promise((r, o) => {
    ...
    i.onload = (a) => {
      ...
      const u = e.type === "image/png" || e.type === "image/gif", f = u ? "image/png" : "image/jpeg", p = u ? void 0 : n, g = c.toDataURL(f, p), m = Yk(g, e.name);
...
function Xk({
  ...
  return St(() => {
    const g = [
      ...
      gp.configure({ HTMLAttributes: { class: "font-bold" } }).extend({ keepOnSplit: !1 }),
      yp.configure({ HTMLAttributes: { class: "italic" } }).extend({ keepOnSplit: !1 }),
      vp.configure({}).extend({ keepOnSplit: !1 }),
    ...
    ), s.codeBlocks || g.push(Ep), s.callouts || g.push(Lb, ck), a && !s.collapsibleHeadings && !u && g.push(
      sk.configure({
        levels: o
      })
    ), s.images || g.push(
    ...
    ), i && g.push(Lk), d && !u && g.push(Ok), s.markdownPaste || g.push(
      tk.configure({
        enableMarkdownPaste: !0
      })
    ), g;
...
function Qk() {
  return Zk(), {
    ...
    async ready() {
      ht || (uo ? await uo : await iu());
    }
  };
}
function Jk() {
  const e = Y(null);
  return e.current || (e.current = Qk()), e.current;
}
const eC = 2e3;
function tC(e) {
  const {
    ...
    isLightweightRef: k
  } = e, D = n && n.length > eC, C = Y(D ? n : null), N = D ? "" : n, L = Y(null), P = Y(null), O = Y(c), $ = Y(d), W = Y(u), V = Y(f), R = Y(null);
...
function el(e) {
  if (/<img\s/i.test(e)) {
    const t = /(<img\s[^>]*\/?>)/gi;
    return e.split(t).filter((r) => r.trim()).map((r) => /^<img\s/i.test(r) ? aC(r) : r.trim() ? `<p>${fo(r.trim())}</p>` : "").join("");
  }
  if (/^!\[/.test(e)) {
    const t = e.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
    if (t)
...
function uC(e) {
  ...
  ), t = nC(t), t = oC(t), t = sC(t), t = cC(t), t = t.replace(
    /(<pre[^>]*>\s*<code[^>]*>)([\s\S]*?)(<\/code>\s*<\/pre>)/g,
    (n, r, o, s) => r + o.replace(/\n+$/, "") + s
  ), t;
}
function fC(e, t, n = {}) {
  const r = dC(e, t, n), o = t(r);
  return uC(o);
}
function pC(e, t, n) {
  q(() => {
...
function yC(e, t = {}) {
  const {
    ...
    const v = Math.max(1, Math.ceil(f / gC));
    return {
      words: f,
      characters: p,
...
function vC({ status: e, lastSaved: t, className: n = "" }) {
  const r = (o) => {
    if (!o) return "";
    ...
    "div",
    {
      ...
      children: [
        e === "idle" && t && /* @__PURE__ */ I(ye, { children: [
          /* @__PURE__ */ h(gf, { className: "w-3.5 h-3.5 text-muted-foreground" }),
        ...
        e === "saving" && /* @__PURE__ */ I(ye, { children: [
          /* @__PURE__ */ h(kl, { className: "w-3.5 h-3.5 text-cyan-500 animate-spin" }),
        ...
        e === "error" && /* @__PURE__ */ I(ye, { children: [
          /* @__PURE__ */ h(yf, { className: "w-3.5 h-3.5 text-red-500" }),
...
function bC({ onRecover: e, onDismiss: t, className: n = "" }) {
  return /* @__PURE__ */ I(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ I("div", { className: "flex items-center gap-3 min-w-0", children: [
          /* @__PURE__ */ h(vf, { className: "w-5 h-5 recovery-banner-icon flex-shrink-0" }),
        ...
        /* @__PURE__ */ I("div", { className: "flex items-center gap-3 flex-shrink-0", children: [
          /* @__PURE__ */ I(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ h(Xs, { className: "w-4 h-4" }),
                "Recover"
              ]
            }
          ),
...
`);
  ...
  if (!n || n.length === 0) {
    for (let l = 0; l < s.length; l++) {
      ...
      let f = i;
      for (const p of u)
        p.start > f && (o += Yt(e.substring(f, p.start))), o += `<span class="${tl(p.type)}">${Yt(p.content)}</span>`, f = p.end;
...
`), i = d + 1;
  ...
  for (let l = 0; l < s.length; l++) {
    ...
    let f = i;
    for (const p of u)
      p.start > f && (o += ps(e, f, p.start, null, a)), o += ps(e, p.start, p.end, tl(p.type), a), f = p.end;
  ...
  q(() => {
    ...
    const C = (N) => {
      ...
      if (c.current = N, l.current.push({ time: N, duration: L }), l.current.length > 120 && (l.current = l.current.slice(-120)), L > 16.67 && u.current++, S++, N - k >= 1e3) {
        D = S, S = 0, k = N;
        const P = l.current.slice(-60), O = P.length > 0 ? P.reduce((z, U) => z + U.duration, 0) / P.length : 0, $ = P.length > 0 ? Math.max(...P.map((z) => z.duration)) : 0, W = performance.memory, V = W ? W.usedJSHeapSize / (1024 * 1024) : 0, R = W ? W.jsHeapSizeLimit / (1024 * 1024) : 0, A = document.querySelectorAll("*").length, H = nl - f.current, G = _s - p.current;
        f.current = nl, p.current = _s, a({
          fps: D,
          ...
          renderCount: H,
          transactionCount: G,
          lastTransactionTime: Math.round(lu * 100) / 100,
          domNodes: A,
  ...
  return /* @__PURE__ */ I("div", { className: "perf-profiler-overlay", children: [
    /* @__PURE__ */ I("div", { className: "perf-profiler-header", children: [
      /* @__PURE__ */ I("div", { className: "perf-profiler-title", children: [
        /* @__PURE__ */ h(bf, { size: 14 }),
        /* @__PURE__ */ h("span", { children: "Performance" })
      ] }),
      /* @__PURE__ */ I("div", { className: "perf-profiler-actions", children: [
        /* @__PURE__ */ h("button", { onClick: x, title: o ? "Expand" : "Minimize", children: o ? /* @__PURE__ */ h(Cl, { size: 12 }) : /* @__PURE__ */ h(El, { size: 12 }) }),
  ...
  render() {
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ h("div", { className: ie("flex-1 flex items-center justify-center p-6", this.props.className), children: /* @__PURE__ */ I("div", { className: "flex flex-col items-center max-w-md w-full text-center gap-4", children: [
        /* @__PURE__ */ h("div", { className: "w-12 h-12 rounded-full bg-destructive/10 flex items-center justify-center", children: /* @__PURE__ */ h(wf, { className: "w-6 h-6 text-destructive" }) }),
        ...
        t && /* @__PURE__ */ I("div", { className: "w-full max-w-xs", children: [
          /* @__PURE__ */ I(
            "button",
            {
              ...
              children: [
                n ? /* @__PURE__ */ h(Jn, { className: "w-3 h-3" }) : /* @__PURE__ */ h(xf, { className: "w-3 h-3" }),
                "Error details"
              ]
            }
          ),
              ...
              /* @__PURE__ */ h(
                "button",
                {
                  ...
                  children: o ? /* @__PURE__ */ I(ye, { children: [
                    /* @__PURE__ */ h(kf, { className: "w-3 h-3 text-green-500" }),
...
function MC({ editorMode: e, onModeSwitch: t }) {
...
), hs = () => /* @__PURE__ */ h("div", { className: "w-px h-5 bg-border mx-0.5 flex-shrink-0" }), rl = [
...
], TC = bt(function({ editor: t, isH1: n, isH2: r, isH3: o, isH4: s, isH5: i, executeCommand: a }) {
...
}), SC = bt(function({ onCopy: t, iconSize: n }) {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ h(
          $e,
          {
            onMouseDown: (C) => E(C, () => Qs(t)),
            isActive: l?.isCodeBlock,
            title: "Code Block",
            children: /* @__PURE__ */ h(Ef, { size: k })
          }
        ),
        i && /* @__PURE__ */ I(ye, { children: [
          /* @__PURE__ */ h(hs, {}),
          /* @__PURE__ */ h(SC, { onCopy: i, iconSize: k })
        ] }),
...
function DC({ editor: e, isOpen: t, onClose: n }) {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ I("form", { onSubmit: c, className: "link-popover-form", children: [
        /* @__PURE__ */ I("div", { className: "link-popover-input-wrapper", children: [
          /* @__PURE__ */ h(Bs, { className: "link-popover-icon", size: 16 }),
          /* @__PURE__ */ h(
            "input",
            {
              ref: s,
...
function AC({ editor: e, onEditLink: t }) {
  const [n, r] = j({
    isVisible: !1,
    url: "",
    ...
    if (!(!e || e.isDestroyed)) {
      ...
      try {
        const E = w.getAttribute("href") || "", S = w.getBoundingClientRect(), k = S.bottom + 8, D = Math.max(16, Math.min(S.left, window.innerWidth - 340));
        i.current = w, r({
          isVisible: !0,
          url: E,
      ...
      children: /* @__PURE__ */ I("div", { className: "link-hover-tooltip-content", children: [
        /* @__PURE__ */ I(
          "button",
          {
            ...
            title: n.url,
            children: [
              /* @__PURE__ */ h(Mf, { size: 13, className: "link-hover-tooltip-link-icon" }),
        ...
        /* @__PURE__ */ I("div", { className: "link-hover-tooltip-actions", children: [
          /* @__PURE__ */ h(
            "button",
            {
              ...
              title: "Edit link",
              children: /* @__PURE__ */ h(Tf, { size: 14 })
            }
          ),
          /* @__PURE__ */ h(
            "button",
...
const IC = [
  ...
  {
    title: "Wiki Link",
    icon: /* @__PURE__ */ h(Bs, { size: 16, className: "text-cyan-400" }),
    command: (e) => {
...
], RC = 32, PC = 8, OC = 320, _C = 210, Vr = 12;
function ol(e) {
  try {
...
const HC = 340, BC = 36, WC = 8, zC = 240, Kr = 8;
function sl(e) {
  try {
    const t = window.getSelection();
    if (t && t.rangeCount > 0) {
...
function FC({ editor: e, onSearch: t, onCreateItem: n }) {
      ...
      children: [
        ...
        a.map((N, L) => /* @__PURE__ */ I(
          "div",
          {
            ...
            onMouseEnter: () => d(L),
            children: [
              /* @__PURE__ */ h("span", { className: "wikilink-icon", children: /* @__PURE__ */ h(Zs, { size: 14 }) }),
...
function YC({ containerRef: e, enabled: t = !0 }) {
  ...
  return q(() => {
    ...
    /* @__PURE__ */ h("div", { className: "image-drop-zone-icon", children: /* @__PURE__ */ h(Of, { className: "w-12 h-12" }) }),
...
function VC({ actions: e, scope: t, onAction: n, onClose: r, position: o }) {
        ...
        `,
          children: [
            /* @__PURE__ */ h("div", { className: "px-2 py-1.5", children: /* @__PURE__ */ I("div", { className: "flex items-center gap-2 bg-secondary/50 rounded-md px-2.5 py-1.5 border border-border/50", children: [
              /* @__PURE__ */ h(Ml, { size: 14, className: "text-muted-foreground shrink-0" }),
              /* @__PURE__ */ h(
                "input",
                {
                  ref: d,
          ...
          children: [
            /* @__PURE__ */ I("div", { className: "flex items-center justify-between px-3 py-2 border-b border-border bg-secondary/30", children: [
              /* @__PURE__ */ I("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
                m && /* @__PURE__ */ h(kl, { size: 12, className: "animate-spin" }),
...
function GC({
  ...
  return /* @__PURE__ */ I(ye, { children: [
    !n.images && !n.dragAndDrop && /* @__PURE__ */ h(YC, { containerRef: r, enabled: o }),
    !t && s && /* @__PURE__ */ h(
      NC,
      {
        editor: e,
    ...
    !n.slashCommands && /* @__PURE__ */ h($C, { editor: e, disabledFeatures: n }),
    !n.wikiLinks && S && /* @__PURE__ */ h(FC, { editor: e, onSearch: S }),
    /* @__PURE__ */ h(
      DC,
      {
        editor: e,
    ...
    /* @__PURE__ */ h(AC, { editor: e, onEditLink: E }),
...
function ZC(e) {
  const [t, n] = Ku(XC, { status: "idle" }), r = Y(null), o = F(async (a, l, c, d, u) => {
    if (e) {
      n({
...
const al = Gu(
  ...
  const [Xt] = j(() => QC()), [Zt, Ho] = j(N), [Qt, Pt] = j(""), vr = Y(N), br = Y(""), An = Y(null), [hu, Ma] = j(0), wr = !!(re && re.length > 0 && fe), { state: Ye, executeAction: xr, abort: mu, reset: xt } = ZC(fe), [gu, Bo] = j(null), [yu, vu] = j({ selectionTop: 0, selectionBottom: 0, selectionCenterX: 0 }), bu = Y(fe);
  bu.current = fe;
  const Ta = Y(Te);
  Ta.current = Te;
  const [wu, xu] = j([]), [ku, Cu] = j(0), Eu = F((se, Ce) => {
    xu(se), Cu(Ce);
  }, []), Sa = Y(w), Na = Y(E), Da = Y(S), La = Y(k), Aa = Y(D), Ia = Y(H), Ra = Y(G), Pa = Y(z);
  Sa.current = w, Na.current = E, Da.current = S, La.current = k, Aa.current = D, Ia.current = H, Ra.current = G, Pa.current = z;
  const Oa = 2e3, [Wo, Mu] = j(() => ae === "lightweight" ? !0 : ae === "full" ? !1 : t && typeof t == "string" ? Math.ceil(t.length / 80) > Oa : !1), Tu = Y(0), _a = Y(Wo);
  _a.current = Wo;
  const [zo, kr] = j(null), Su = Xk({
    placeholder: i,
    isMobile: Xt,
    maxImageSize: M,
    headingLevels: ve,
  ...
  }), { editor: oe, turndownService: Cr } = tC({
    extensions: Su,
    content: t,
    editable: a,
    autofocus: l,
    ...
    setRawMarkdown: Pt,
    setIsLightweight: Mu,
    lightweightCheckCounterRef: Tu,
    isLightweightRef: _a
  }), [Nu, Er] = j(!1), [Du, Lu] = j(!1), Au = K !== void 0 ? K : Du, Ot = F((se) => {
    Lu(se), B?.(se);
  }, [B]), [Iu, Mr] = j(0), [Ru, Pu] = j(""), _t = Qv(oe, {
    storageKey: y,
    debounceMs: v,
    enabled: m,
    onSave: (se) => {
  ...
  const Ha = F((se, Ce) => {
    ...
    Bo({ scope: se, position: Ge });
  }, [wr, oe]), _u = F((se, Ce) => {
    if (!oe || !re) return;
    const Ge = re.find((Uo) => Uo.id === se);
    if (!Ge) return;
...
`) : "", Jt = Ge.scope === "document" || !$t ? oe.getText() : $t, Sr = oe.view.coordsAtPos(_e), Nr = oe.view.coordsAtPos(kt);
    ...
    }), Bo(null), xr(se, Ge.label, Jt, { from: _e, to: kt }, Ce);
  }, [oe, re, xr]), $u = F(() => {
...
` + Ce).run(), xt();
    ...
    if (Ge) return;
    const _e = oe.state.doc.slice(se, Ce), kt = Yf.fromSchema(oe.schema), $t = document.createElement("div"), Jt = kt.serializeFragment(_e.content);
    $t.appendChild(Jt);
...
`);
  ...
  if (!oe)
    return /* @__PURE__ */ h(EC, { className: c, theme: p });
  const Ba = /* @__PURE__ */ h(
    Vv,
    {
      editor: oe,
  ...
  return /* @__PURE__ */ I("div", { className: `markdown-editor-container ${g === "neutral" ? "color-theme-neutral" : ""} ${c}`, "data-theme": p, children: [
    ...
    d && /* @__PURE__ */ I("div", { className: "flex items-center bg-card/50 editor-toolbar-wrapper", children: [
      J ? J(oe, Ba) : Ba,
      C && /* @__PURE__ */ h(MC, { editorMode: Zt, onModeSwitch: Fo })
    ] }),
    !Xt && /* @__PURE__ */ h(
      Kv,
      {
    ...
    /* @__PURE__ */ h(Xv, { editor: oe }),
    /* @__PURE__ */ I("div", { className: `editor-main-area ${lt ? "editor-with-toc" : ""}`, children: [
      lt && wt === "left" && /* @__PURE__ */ h(za, { fallback: null, children: /* @__PURE__ */ h(
        al,
        {
          editor: oe,
          visible: Rt,
      ...
      /* @__PURE__ */ I(
        CC,
        {
          ...
          onRetry: () => Ma((se) => se + 1),
          onClearContent: () => {
            oe && oe.commands.clearContent(), n?.(""), r?.(""), o?.(""), Ma((se) => se + 1);
          },
          onError: me,
          children: [
            /* @__PURE__ */ h("div", { className: "editor-content-wrapper", ref: An, style: zu, children: Zt === "wysiwyg" ? /* @__PURE__ */ I(ye, { children: [
              /* @__PURE__ */ h(Uu, { editor: oe, className: "editor-content" }),
              /* @__PURE__ */ h(
                GC,
                {
                  editor: oe,
                  ...
                  isLinkPopoverOpen: Nu,
                  aiEnabled: wr,
                  onAISetupRequired: Te,
                  onAISparklesClick: (se) => Ha("selection", se),
                  onCopySelectionAsMarkdown: Wu,
                  aiDropdown: gu,
                  aiActions: re,
                  onAIActionSelect: _u,
                  onAIDropdownClose: () => Bo(null),
                  aiState: Ye,
                  aiPopoverPosition: yu,
                  onAIReplace: $u,
                  onAIInsert: Hu,
                  onAIRetry: Bu,
                  onAIDiscard: () => {
                  ...
                  imageEditState: zo,
                  onImageSave: (se, Ce) => {
                    oe.chain().focus().setNodeSelection(zo.pos).updateAttributes("resizableImage", {
                      src: se,
                      alt: Ce
                    }).run(), kr(null);
                  },
                  onImageDelete: () => {
                    oe.chain().focus().setNodeSelection(zo.pos).deleteSelection().run(), kr(null);
                  },
              ...
              wC,
              {
                ...
                autofocus: !0,
                searchMatches: wu,
                currentMatchIndex: ku,
                autoClosePairs: Ao
              }
            ) }),
            /* @__PURE__ */ h(qC, { scrollContainerRef: An })
          ]
        }
      ),
      lt && wt === "right" && /* @__PURE__ */ h(za, { fallback: null, children: /* @__PURE__ */ h(
        al,
        {
          editor: oe,
          visible: Rt,
    ...
    /* @__PURE__ */ h(kC, { visible: Io, onClose: Ro, editor: oe })
  ] });
}), Q1 = go.create({
  name: "callout",
  addOptions() {
...
function eE({
  ...
  return /* @__PURE__ */ h(du.Provider, { value: a, children: e });
}
function tE() {
  const e = hl(du);
  if (!e)
...
function nE({ node: e, updateAttributes: t }) {
  const [n, r] = j(!1), o = e.attrs.language || "plaintext";
  il.find((i) => i.value === o)?.label;
  const s = F(() => {
  ...
  return /* @__PURE__ */ I(Jr, { className: "code-block-wrapper", children: [
      ...
      /* @__PURE__ */ I("div", { className: "code-block-language-wrapper", children: [
        /* @__PURE__ */ h(
          "select",
          {
            ...
            children: il.map(({ value: i, label: a }) => /* @__PURE__ */ h("option", { value: i, children: a }, i))
          }
        ),
    ...
    /* @__PURE__ */ h("pre", { className: "code-block-pre", children: /* @__PURE__ */ h("code", { children: /* @__PURE__ */ h(Yu, {}) }) })
  ] });
}
const uu = "paragon-editor-toc-width", r1 = 280, fu = 200, pu = 500, _n = 30, ll = 5;
function cl() {
  try {
    const e = localStorage.getItem(uu);
    if (e) {
      const t = parseInt(e, 10);
      if (!isNaN(t) && t >= fu && t <= pu)
        return t;
    }
  } catch {
  }
...
function o1(e) {
  try {
    localStorage.setItem(uu, String(e));
  } catch {
  }
}
function s1(e, t, n) {
...
const $s = bt(function({
  ...
  }, []), p = t.length * _n, g = Math.max(0, Math.floor(l / _n) - ll), m = Math.min(
    t.length,
    Math.ceil((l + d) / _n) + ll
  ), y = St(() => {
    const v = [];
  ...
  q(() => {
    const _ = (ne) => {
      if (!O.current) return;
      const de = f === "right" ? $.current - ne.clientX : ne.clientX - $.current, be = Math.min(pu, Math.max(fu, W.current + de));
      N(be);
    }, ee = () => {
      O.current && (O.current = !1, document.body.style.cursor = "", document.body.style.userSelect = "", N((ne) => (o1(ne), ne)));
    };
  ...
  return /* @__PURE__ */ I(ye, { children: [
    y && /* @__PURE__ */ h(
      "button",
      {
        ...
        children: E ? /* @__PURE__ */ h(Hf, { size: 16 }) : /* @__PURE__ */ h(Bf, { size: 16 })
      }
    ),
    /* @__PURE__ */ I(
      "div",
...
export {
  ...
  Q1 as Callout,
  ck as CalloutInputRule,
  nE as CodeBlockComponent,
  sk as CollapsibleHeading,
  wb as CollapsibleList,
  Ux as DatePill,
  eE as EditorThemeProvider,
  Vv as EditorToolbar,
  Kv as FindReplace,
  NC as FloatingToolbar,
  YC as ImageDropZone,
  qk as ImageUpload,
  Z1 as MarkdownEditor,
  lk as MarkdownLinkInputRule,
  tk as MarkdownPasteSafe,
  pb as MixedBulletList,
  yb as MixedListItem,
  hb as MixedOrderedList,
  gb as MixedTaskItem,
  mb as MixedTaskList,
  bC as RecoveryBanner,
