import { jsxDEV as d, Fragment as Be } from "react/jsx-dev-runtime";
  ...
  return e.descendants((o, r) => {
    if (o.type.name === "tableCell" || o.type.name === "tableHeader") {
      const s = st.widget(r + 1, (a) => {
        ...
        const c = document.documentElement.classList.contains("dark"), u = c ? "rgba(30,30,30,0.95)" : "rgba(255,255,255,0.95)", m = c ? "rgba(60,60,60,0.5)" : "rgba(200,200,200,0.5)", f = c ? "#999" : "#666", h = c ? "#2a2a2a" : "#f5f5f5";
        return l.style.cssText = "width:18px;height:18px;display:flex;align-items:center;justify-content:center;background:" + u + ";border:1px solid " + m + ";border-radius:4px;cursor:pointer;opacity:0;transition:opacity 0.15s ease,background-color 0.15s ease,transform 0.1s ease;color:" + f + ";pointer-events:auto;padding:0;", l.addEventListener("mouseenter", () => {
...
function Nf(e, t, n, o) {
  ...
  const a = 170, i = 280;
  let l = Math.max(0, Math.min(o.top, window.innerHeight)), c = Math.max(0, Math.min(o.bottom, window.innerHeight)), u = Math.max(0, Math.min(o.left, window.innerWidth)), m = c + 4, f = u - a + o.width + 8;
  f + a > window.innerWidth - 12 && (f = window.innerWidth - a - 12), f < 12 && (f = 12), m + i > window.innerHeight - 12 && (m = l - i - 4), m < 12 && (m = 12), m + i > window.innerHeight - 12 && (m = window.innerHeight - i - 12);
  const h = document.documentElement.classList.contains("dark"), p = h ? "#1f1f1f" : "#ffffff", g = h ? "#3a3a3a" : "#e5e5e5", b = h ? "#e5e5e5" : "#333333";
  s.style.cssText = "position:fixed;top:" + m + "px;left:" + f + "px;z-index:99999;display:flex;flex-direction:column;gap:2px;min-width:170px;max-width:220px;width:auto;padding:6px;background:" + p + ";border:1px solid " + g + ";border-radius:8px;box-shadow:0 8px 24px rgba(0,0,0,0.15),0 2px 6px rgba(0,0,0,0.1);color:" + b + ";font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,sans-serif;pointer-events:auto;";
  ...
  }, y = h ? "#2a2a2a" : "#f5f5f5", x = h ? "#ff6b6b" : "#dc2626", S = h ? "#999999" : "#666666", k = h ? "#333333" : "#e5e5e5";
  N.forEach((D) => {
    if (D.label === "divider") {
      ...
      const L = C[D.icon || ""] || "", $ = D.destructive ? x : S;
...
function Ti(e, t, n, o, r, s = {}) {
  ...
  for (let c = l.length - 1; c >= 0; c--) {
    const u = l[c], m = e.doc.nodeAt(u);
    m && m.type === r && e.setNodeMarkup(u, o, s);
  }
  return !0;
}
const Pf = om.extend({
  ...
  addCommands() {
    return {
      toggleTaskList: () => ({ editor: e, commands: t, state: n, tr: o, dispatch: r, chain: s, can: a }) => {
        ...
        if (!u)
          return !1;
        const m = n.schema.nodes.taskList, f = n.schema.nodes.taskItem;
        let h = !1;
        ...
        if (w) {
          if (!r) return !0;
          const y = v, x = o.doc.nodeAt(y);
          if (!x) return !1;
          o.setNodeMarkup(y, m, x.attrs);
          const S = o.doc.nodeAt(y);
          if (!S) return !1;
          const k = [];
          S.forEach((T, M) => {
            T.type === b && k.push(y + 1 + M);
          });
          for (let T = k.length - 1; T >= 0; T--) {
            const M = k[T], D = o.doc.nodeAt(M);
        ...
        if (C) {
          ...
          return x >= 0 && Ti(o, x, m, f, b, { checked: !1 }), r(o), !0;
        }
  ...
  addKeyboardShortcuts() {
    return {
      ...
      Enter: () => {
        ...
        let s = -1;
        for (let m = o.depth; m >= 1; m--)
          if (o.node(m).type.name === "taskItem") {
            s = m;
            break;
          }
        if (s === -1)
        ...
        if (!c || !c.isTextblock)
          return t.commands.splitListItem(this.name);
        if (o.pos - l <= 1) {
          const m = o.before(s), { tr: f } = n, h = n.schema.nodes.taskItem, p = n.schema.nodes.paragraph, g = h.create(
            { checked: !1 },
            p.create()
          );
          f.insert(m, g);
      ...
      new je({
        ...
        props: {
          handleTextInput(n, o, r, s) {
            ...
            if (!u) return !1;
            const m = u[2] === "x", f = i.start() + (u.index || 0), h = o, p = a.tr;
            p.delete(f, h);
            const b = p.doc.resolve(f).blockRange();
            if (!b || !t || !e) return !1;
            const w = [
              { type: t, attrs: {} },
              { type: e, attrs: { checked: m } }
            ];
            if (p.wrap(b, w), f > 1) {
  ...
  return e.descendants((r, s) => {
    ...
    if (l && l.type.name === "paragraph") {
      const c = s + 1 + l.nodeSize - 1, u = st.widget(
        c,
        () => {
          const m = CSS.escape(a), f = document.querySelector(
            `button.collapsible-list-chevron[data-list-item-id="${m}"]`
          );
          if (f) {
    ...
    if (i && _f(r, s)) {
      let u = s + 1;
      r.forEach((m) => {
        ["bulletList", "orderedList", "taskList"].includes(m.type.name) && o.push(
          st.node(u, u + m.nodeSize, {
...
De.register("javascript", xi);
De.register("js", xi);
De.register("jsx", xi);
De.register("typescript", Ci);
De.register("ts", Ci);
De.register("tsx", Ci);
De.register("python", Wl);
De.register("py", Wl);
De.register("xml", Ei);
De.register("html", Ei);
De.register("svg", Ei);
...
async function Bf(e) {
  ...
  try {
    ...
    for (const s of r)
      if (s.includes(e))
        for (const a of s)
          a !== e && !De.registered(a) && (De.register(a, o), Zo.add(a));
    return !0;
  } catch (n) {
...
function Hf({ node: e, updateAttributes: t, extension: n }) {
  ...
  return /* @__PURE__ */ d(Wn, { className: "code-block-wrapper", ref: c, children: [
    /* @__PURE__ */ d("div", { className: "code-block-controls", contentEditable: !1, children: [
      /* @__PURE__ */ d("div", { className: "code-block-language-wrapper", children: [
        /* @__PURE__ */ d(
          "select",
          {
            value: u,
            ...
            children: [
              /* @__PURE__ */ d("option", { value: "plaintext", children: "Plain Text" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CodeBlockWithFeatures.tsx",
                lineNumber: 265,
                columnNumber: 13
              }, this),
              h.map((g) => /* @__PURE__ */ d("option", { value: g, children: g.charAt(0).toUpperCase() + g.slice(1) }, g, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CodeBlockWithFeatures.tsx",
                lineNumber: 267,
                columnNumber: 15
              }, this))
        ...
        /* @__PURE__ */ d("span", { className: "code-block-language-label", children: p }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CodeBlockWithFeatures.tsx",
          lineNumber: 272,
          columnNumber: 11
        }, this),
        /* @__PURE__ */ d(Qt, { size: 12, className: "code-block-language-chevron" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CodeBlockWithFeatures.tsx",
          lineNumber: 273,
          columnNumber: 11
        }, this)
      ...
      /* @__PURE__ */ d(
        "button",
        {
          ...
          children: o ? /* @__PURE__ */ d(Kn, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CodeBlockWithFeatures.tsx",
            lineNumber: 281,
            columnNumber: 21
          }, this) : /* @__PURE__ */ d(Vn, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CodeBlockWithFeatures.tsx",
            lineNumber: 281,
            columnNumber: 43
          }, this)
    ...
    /* @__PURE__ */ d("pre", { className: `code-block-pre ${!s || !i ? "code-block-deferred" : ""}`, children: /* @__PURE__ */ d(ii, { className: s && i ? `language-${u}` : "language-plaintext" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CodeBlockWithFeatures.tsx",
      lineNumber: 288,
      columnNumber: 9
    }, this) }, void 0, !1, {
...
function Ff({ editor: e, isOpen: t, onClose: n }) {
  ...
  if (!t) return null;
  const f = (e.view.dom.closest(".markdown-editor-container") || e.view.dom.closest("[data-theme]"))?.getAttribute("data-theme") || "", h = /* @__PURE__ */ d(
    "div",
    {
      ref: a,
      ...
      children: /* @__PURE__ */ d("form", { onSubmit: c, className: "link-popover-form", children: [
        /* @__PURE__ */ d("div", { className: "link-popover-input-wrapper", children: [
          /* @__PURE__ */ d(ai, { className: "link-popover-icon", size: 16 }, void 0, !1, {
        ...
        /* @__PURE__ */ d("div", { className: "link-popover-hint", children: "Press Enter to save · Escape to cancel" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkPopover.tsx",
          lineNumber: 153,
          columnNumber: 9
        }, this)
  ...
  return /* @__PURE__ */ d(Ht, { children: h }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkPopover.tsx",
    lineNumber: 161,
    columnNumber: 10
  }, this);
...
function zf({ editor: e, onEditLink: t }) {
  const [n, o] = K({
    ...
    if (!(!e || e.isDestroyed)) {
      ...
      try {
        const C = N.getAttribute("href") || "", y = N.getBoundingClientRect(), x = y.bottom + 8, S = Math.max(16, Math.min(y.left, window.innerWidth - 340));
        o({
          isVisible: !0,
          url: C,
          position: { top: x, left: S },
          linkElement: N
        });
      } catch (C) {
  ...
  Q(() => {
    ...
    if (!N) return;
    const C = (x) => {
      const k = x.target.closest("a");
      k && N.contains(k) && a(k);
    }, y = (x) => {
      const S = x.target, k = x.relatedTarget;
      if (S.closest("a")) {
      ...
      C.descendants((S, k) => {
        if (S.isText && S.marks.some((T) => T.type.name === "link")) {
          ...
          if (T && (T === n.linkElement || T.parentElement === n.linkElement))
            return y = k, x = k + S.nodeSize, !1;
        }
        return !0;
      }), y !== null && x !== null ? e.chain().focus().setTextSelection({ from: y, to: x }).unsetLink().run() : e.chain().focus().unsetLink().run();
    }
    o((N) => ({ ...N, isVisible: !1 }));
  }, [e, n.linkElement]), p = U(() => {
    if (n.linkElement) {
      ...
      C.descendants((y, x) => {
        if (y.isText && y.marks.some((S) => S.type.name === "link")) {
          ...
          if (S && (S === n.linkElement || S.parentElement === n.linkElement))
            return e.chain().focus().setTextSelection({ from: x, to: x + y.nodeSize }).run(), !1;
        }
        return !0;
      });
    }
  ...
  const g = n.url.length > 40 ? n.url.substring(0, 40) + "..." : n.url, w = (e.view.dom.closest(".markdown-editor-container") || e.view.dom.closest("[data-theme]"))?.getAttribute("data-theme") || "", v = /* @__PURE__ */ d(
    "div",
    {
      ref: r,
      ...
      onMouseEnter: l,
      onMouseLeave: i,
      children: /* @__PURE__ */ d("div", { className: "link-hover-tooltip-content", children: [
        /* @__PURE__ */ d(
          "button",
          {
            onClick: f,
            ...
            title: n.url,
            children: [
              /* @__PURE__ */ d(wm, { size: 13, className: "link-hover-tooltip-link-icon" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkHoverTooltip.tsx",
                lineNumber: 247,
                columnNumber: 11
              }, this),
              /* @__PURE__ */ d("span", { className: "link-hover-tooltip-url", children: g || "No URL" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkHoverTooltip.tsx",
                lineNumber: 248,
                columnNumber: 11
              }, this)
        ...
        /* @__PURE__ */ d("div", { className: "link-hover-tooltip-actions", children: [
          /* @__PURE__ */ d(
            "button",
            {
              onClick: p,
              ...
              title: "Edit link",
              children: /* @__PURE__ */ d(Nm, { size: 14 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkHoverTooltip.tsx",
                lineNumber: 259,
                columnNumber: 13
              }, this)
          ...
          /* @__PURE__ */ d(
            "button",
            {
              ...
              className: "link-hover-tooltip-btn",
              title: "Copy link",
              children: c ? /* @__PURE__ */ d(Kn, { size: 14, style: { color: "var(--primary)" } }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkHoverTooltip.tsx",
                lineNumber: 268,
                columnNumber: 23
              }, this) : /* @__PURE__ */ d(Vn, { size: 14 }, void 0, !1, {
          ...
          /* @__PURE__ */ d(
            "button",
            {
              ...
              title: "Remove link",
              children: /* @__PURE__ */ d(ym, { size: 14 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkHoverTooltip.tsx",
                lineNumber: 277,
                columnNumber: 13
              }, this)
  ...
  return /* @__PURE__ */ d(Ht, { children: v }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkHoverTooltip.tsx",
    lineNumber: 285,
    columnNumber: 10
  }, this);
}
const rt = ({ onMouseDown: e, isActive: t, disabled: n, children: o, title: r }) => /* @__PURE__ */ d(
  "button",
  {
    onMouseDown: e,
    disabled: n,
  ...
  void 0
), wa = () => /* @__PURE__ */ d("div", { className: "w-px h-5 bg-border mx-0.5 flex-shrink-0" }, void 0, !1, {
  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
  lineNumber: 69,
  columnNumber: 3
}, void 0), Na = [
  ...
  const [l, c] = K(!1), u = V(null), m = n ? "h1" : o ? "h2" : r ? "h3" : s ? "h4" : a ? "h5" : "paragraph", f = Na.find((p) => p.value === m)?.shortLabel || "P";
  Q(() => {
    if (!l) return;
    const p = (g) => {
  ...
  return /* @__PURE__ */ d("div", { ref: u, className: "relative flex-shrink-0", children: [
    /* @__PURE__ */ d(
      "button",
      {
        onMouseDown: (p) => {
        ...
        className: `
          ...
          ${m !== "paragraph" ? "bg-primary text-primary-foreground" : "bg-transparent text-foreground hover:bg-secondary active:bg-secondary/80"}
        `,
        children: [
          /* @__PURE__ */ d("span", { className: "min-w-[18px] text-center", children: f }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
            lineNumber: 143,
            columnNumber: 9
          }, this),
          /* @__PURE__ */ d(Qt, { size: 12, strokeWidth: 2.5, className: `flex-shrink-0 transition-transform duration-150 ${l ? "rotate-180" : ""}` }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
            lineNumber: 144,
            columnNumber: 9
          }, this)
          ...
          return /* @__PURE__ */ d(
            "button",
            {
              ...
              className: `
                ...
                `,
              children: [
                /* @__PURE__ */ d("span", { className: "w-6 text-xs font-normal text-muted-foreground", children: p.shortLabel }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
                  lineNumber: 172,
                  columnNumber: 17
                }, this),
                /* @__PURE__ */ d("span", { children: p.label }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
                  lineNumber: 173,
                  columnNumber: 17
                }, this)
  ...
  }), [l, c] = K(!1), [u, m] = K(""), [f, h] = K(!1), [p, g] = K({ top: 0, left: 0 }), b = V(null), w = V(null), v = V(null), N = U(() => {
    if (u) {
      let T = u.trim();
  ...
  const S = 15, k = l ? /* @__PURE__ */ d(
    "div",
    {
      ...
      onMouseDown: x,
      children: /* @__PURE__ */ d("div", { className: "flex flex-col sm:flex-row items-stretch sm:items-center gap-2 px-2 w-[280px] sm:w-auto", children: [
        /* @__PURE__ */ d(
          "input",
          {
            type: "url",
            ...
            onKeyDown: (T) => {
              T.key === "Enter" && (T.preventDefault(), N()), T.key === "Escape" && (c(!1), m(""));
            },
            className: `
      ...
      children: [
        /* @__PURE__ */ d(
          rt,
          {
            ...
            isActive: i?.isBold,
            title: "Bold (Ctrl+B)",
            children: /* @__PURE__ */ d(li, { size: S }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 455,
              columnNumber: 9
            }, this)
        ...
        /* @__PURE__ */ d(
          rt,
          {
            ...
            isActive: i?.isItalic,
            title: "Italic (Ctrl+I)",
            children: /* @__PURE__ */ d(ci, { size: S }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 462,
              columnNumber: 9
            }, this)
        ...
        /* @__PURE__ */ d(
          rt,
          {
            ...
            children: /* @__PURE__ */ d(ui, { size: S }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 469,
              columnNumber: 9
            }, this)
        ...
        /* @__PURE__ */ d(
          rt,
          {
            ...
            isActive: i?.isStrike,
            title: "Strikethrough",
            children: /* @__PURE__ */ d(di, { size: S }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 476,
              columnNumber: 9
            }, this)
        ...
        /* @__PURE__ */ d(
          rt,
          {
            ...
            children: /* @__PURE__ */ d(Sl, { size: S }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 483,
              columnNumber: 9
            }, this)
        ...
        /* @__PURE__ */ d(
          rt,
          {
            ...
            title: "Highlight",
            children: /* @__PURE__ */ d(Dl, { size: S }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 490,
              columnNumber: 9
            }, this)
        ...
        /* @__PURE__ */ d(
          rt,
          {
            ...
            isActive: i?.isLink,
            title: "Link (Ctrl+K)",
            children: /* @__PURE__ */ d(mi, { size: S }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 498,
              columnNumber: 9
            }, this)
        ...
        /* @__PURE__ */ d(
          rt,
          {
            ...
            title: "Quote",
            children: /* @__PURE__ */ d(fi, { size: S }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 518,
              columnNumber: 9
            }, this)
        ...
        /* @__PURE__ */ d(
          rt,
          {
            ...
            title: "Bullet List",
            children: /* @__PURE__ */ d(hi, { size: S }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 525,
              columnNumber: 9
            }, this)
        ...
        /* @__PURE__ */ d(
          rt,
          {
            ...
            title: "Numbered List",
            children: /* @__PURE__ */ d(pi, { size: S }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 532,
              columnNumber: 9
            }, this)
        ...
        /* @__PURE__ */ d(
          rt,
          {
            ...
            title: "Task List",
            children: /* @__PURE__ */ d(gi, { size: S }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 539,
              columnNumber: 9
            }, this)
        ...
        /* @__PURE__ */ d(
          rt,
          {
            ...
            title: "Code Block",
            children: /* @__PURE__ */ d(km, { size: S }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 546,
              columnNumber: 9
            }, this)
        ...
        r && /* @__PURE__ */ d(Be, { children: [
          ...
          /* @__PURE__ */ d(
            ...
            `,
              children: /* @__PURE__ */ d(Rr, { size: S }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
                lineNumber: 570,
                columnNumber: 13
              }, this)
  ...
  return /* @__PURE__ */ d(Ht, { onMouseDown: x, children: k }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
    lineNumber: 578,
    columnNumber: 5
  }, this);
...
function jf({ node: e, updateAttributes: t, editor: n }) {
  const [o, r] = K(!1), [s, a] = K(!1), [i, l] = K(null), c = V(null), u = V(null), m = e.attrs.type || "info", f = Qo[m] || Qo.info, h = f.icon, p = U(() => {
    if (u.current) {
  ...
  return /* @__PURE__ */ d(Wn, { className: `callout callout-${m}${s ? " callout-collapsed" : ""}`, "data-callout": "", "data-type": m, children: [
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ d(
            "button",
            {
              ...
              contentEditable: !1,
              children: [
                /* @__PURE__ */ d(h, { size: 18 }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CalloutWithMenu.tsx",
                  lineNumber: 126,
                  columnNumber: 11
                }, this),
                /* @__PURE__ */ d("span", { className: "callout-label", children: f.label }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CalloutWithMenu.tsx",
                  lineNumber: 127,
                  columnNumber: 11
                }, this),
                n.isEditable && /* @__PURE__ */ d(Qt, { size: 12, className: "callout-type-chevron" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CalloutWithMenu.tsx",
                  lineNumber: 128,
                  columnNumber: 33
                }, this)
          ...
          /* @__PURE__ */ d(
            "div",
            {
              ...
              style: { color: f.borderColor },
              children: s ? /* @__PURE__ */ d(Rl, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CalloutWithMenu.tsx",
                lineNumber: 134,
                columnNumber: 24
              }, this) : /* @__PURE__ */ d(Qt, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CalloutWithMenu.tsx",
                lineNumber: 134,
                columnNumber: 53
              }, this)
          ...
          o && n.isEditable && i && /* @__PURE__ */ d(Ht, { children: /* @__PURE__ */ d(
            "div",
            {
              ref: c,
              ...
              children: Object.keys(Qo).map((v) => {
                ...
                return /* @__PURE__ */ d(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ d(C, { size: 16, style: { color: N.borderColor } }, void 0, !1, {
                        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CalloutWithMenu.tsx",
                        lineNumber: 163,
                        columnNumber: 19
                      }, this),
                      /* @__PURE__ */ d("span", { children: N.label }, void 0, !1, {
                        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CalloutWithMenu.tsx",
                        lineNumber: 164,
                        columnNumber: 19
                      }, this)
    ...
    /* @__PURE__ */ d("div", { className: `callout-content${s ? " callout-content-hidden" : ""}`, children: /* @__PURE__ */ d(ii, {}, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CalloutWithMenu.tsx",
      lineNumber: 175,
      columnNumber: 9
    }, this) }, void 0, !1, {
    ...
    return ({ node: t, editor: n, getPos: o }) => {
      ...
      m.addEventListener("click", (P) => {
        if (P.preventDefault(), P.stopPropagation(), T)
          ...
          const z = m.getBoundingClientRect(), X = 200, G = f.closest('[role="dialog"]');
          let Z = 0, te = 0;
          if (G) {
          ...
          z.bottom + 4 + ge > j && (_ = z.top - ge - 4 - te), H + Z < 8 && (H = 8 - Z), H + X + Z > ee - 8 && (H = ee - X - 8 - Z), f.style.top = `${_}px`, f.style.left = `${H}px`, f.style.display = "flex", T = !0, k();
        }
      });
      const M = (P) => {
        !f.contains(P.target) && !m.contains(P.target) && (f.style.display = "none", T = !1);
      };
      ...
      }), s.appendChild(i), s.appendChild(D), s.appendChild(u), s.appendChild(m);
      const A = s.closest('[role="dialog"]');
      A ? A.appendChild(f) : document.body.appendChild(f), s.addEventListener("mouseenter", () => {
        u.style.opacity = "1", m.style.opacity = "1", D.style.opacity = "1";
      }), s.addEventListener("mouseleave", () => {
        u.style.opacity = "0", D.style.opacity = "0", T || (m.style.opacity = "0");
...
function zl(e) {
  ...
  c.setUTCSeconds(0);
  const u = r > 0 ? c.getSeconds() : (c.getSeconds() - 60) % 60, m = Math.round(-(dn(e.timeZone, e) * 60)) % 60;
...
function uo(e) {
  return (t, n = {}) => {
    ...
    if (!s)
      return null;
    const a = s[0], i = o && e.parsePatterns[o] || e.parsePatterns[e.defaultParseWidth], l = Array.isArray(i) ? Ph(i, (m) => m.test(a)) : (
...
function lp(e, t, n) {
  ...
  return l.map((u) => {
    ...
    const m = u.value;
    (!n?.useAdditionalWeekYearTokens && ep(m) || !n?.useAdditionalDayOfYearTokens && Jh(m)) && tp(m, t, String(e));
    const f = Ea[m[0]];
    return f(i, m, r.localize, c);
  }).join("");
}
function cp(e) {
  const t = e.match(sp);
...
function $p(e) {
  ...
  return J.createElement(
    ...
    J.createElement(
      ...
      { type: "button", className: i[re.PreviousMonthButton], tabIndex: o ? void 0 : -1, "aria-disabled": o ? void 0 : !0, "aria-label": l(o), onClick: m },
...
function It(e, t, n = Nt) {
  ...
  return o.some((i) => {
    ...
    if (sc(i)) {
      const l = s(i.before, e), c = s(i.after, e), u = l > 0, m = c < 0;
      return a(i.before, i.after) ? m && u : u || m;
    }
    return ic(i) ? s(e, i.after) > 0 : ac(i) ? s(i.before, e) > 0 : typeof i == "function" ? i(e) : !1;
  });
}
function Zp(e, t, n, o, r) {
  const { disabled: s, hidden: a, modifiers: i, showOutsideDays: l, broadcastCalendar: c, today: u } = t, { isSameDay: m, isSameMonth: f, startOfMonth: h, isBefore: p, endOfMonth: g, isAfter: b } = r, w = n && h(n), v = o && g(o), N = {
    [Se.focused]: [],
    [Se.outside]: [],
    [Se.disabled]: [],
    [Se.hidden]: [],
  ...
  for (const y of e) {
    const { date: x, displayMonth: S } = y, k = !!(S && !f(x, S)), T = !!(w && p(x, w)), M = !!(v && b(x, v)), D = !!(s && It(x, s, r)), A = !!(a && It(x, a, r)) || T || M || // Broadcast calendar will show outside days as default
    !c && !l && k || c && l === !1 && k, I = m(x, u ?? r.today());
    k && N.outside.push(y), D && N.disabled.push(y), A && N.hidden.push(y), I && N.today.push(y), i && Object.keys(i).forEach((L) => {
      const $ = i?.[L];
      $ && It(x, $, r) && (C[L] ? C[L].push(y) : C[L] = [y]);
    });
  }
  return (y) => {
    const x = {
...
function Qp(e, t, n = {}) {
  return Object.entries(e).filter(([, r]) => r === !0).reduce((r, [s]) => (n[s] ? r.push(n[s]) : t[Se[s]] ? r.push(t[Se[s]]) : t[lt[s]] && r.push(t[lt[s]]), r), [t[re.Day]]);
}
function Jp(e) {
  return {
    ...Xp,
...
function fg(e, t, n, o, r = !1) {
  if (!e || !t)
    return;
  const { startOfYear: s, endOfYear: a, eachYearOfInterval: i, getYear: l } = o, c = s(e), u = a(t), m = i({ start: c, end: u });
  return r && m.reverse(), m.map((f) => {
...
function Dg(e, t, { classNames: n, months: o, focused: r, dateLib: s }) {
  ...
  Pr(() => {
    ...
    o.length === 0 || c.length === 0 || o.length !== c.length)
      return;
    const u = s.isSameMonth(o[0].date, c[0].date), m = s.isAfter(o[0].date, c[0].date), f = m ? n[Je.caption_after_enter] : n[Je.caption_before_enter], h = m ? n[Je.weeks_after_enter] : n[Je.weeks_before_enter], p = a.current, g = e.current.cloneNode(!0);
    ...
    if (w?.every((v) => v instanceof HTMLElement) && b && b.every((v) => v instanceof HTMLElement)) {
      ...
      v && (v.style.zIndex = "1"), w.forEach((N, C) => {
        ...
        S && S.classList.add(h);
        const k = () => {
          l.current = !1, e.current && (e.current.style.isolation = ""), v && (v.style.zIndex = ""), x && x.classList.remove(f), S && S.classList.remove(h), N.style.position = "", N.style.overflow = "", N.contains(y) && N.removeChild(y);
        };
        y.style.pointerEvents = "none", y.style.position = "absolute", y.style.overflow = "hidden", y.setAttribute("aria-hidden", "true");
        const T = Sg(y);
        T && (T.style.opacity = "0");
        const M = gs(y);
        M && (M.classList.add(m ? n[Je.caption_before_exit] : n[Je.caption_after_exit]), M.addEventListener("animationend", k));
        const D = bs(y);
        D && D.classList.add(m ? n[Je.weeks_before_exit] : n[Je.weeks_after_exit]), N.insertBefore(y, N.firstChild);
      });
    }
  });
}
function Ag(e, t, n, o) {
  const r = e[0], s = e[e.length - 1], { ISOWeek: a, fixedWeeks: i, broadcastCalendar: l } = n ?? {}, { addDays: c, differenceInCalendarDays: u, differenceInCalendarMonths: m, endOfBroadcastWeek: f, endOfISOWeek: h, endOfMonth: p, endOfWeek: g, isAfter: b, startOfBroadcastWeek: w, startOfISOWeek: v, startOfWeek: N } = o, C = l ? w(r, o) : a ? v(r) : N(r), y = l ? f(s) : a ? h(p(s)) : g(p(s)), x = u(y, C), S = m(s, r) + 1, k = [];
  for (let D = 0; D <= x; D++) {
    const A = c(C, D);
    if (t && b(A, t))
      break;
...
function Aa(e, t, n, o) {
  ...
  let l = r || s || a;
  const { differenceInCalendarMonths: c, addMonths: u, startOfMonth: m } = o;
  if (n && c(n, l) < i - 1) {
    const f = -1 * (i - 1);
    l = u(n, f);
  }
...
function Ig(e, t, n, o) {
  const { addDays: r, endOfBroadcastWeek: s, endOfISOWeek: a, endOfMonth: i, endOfWeek: l, getISOWeek: c, getWeek: u, startOfBroadcastWeek: m, startOfISOWeek: f, startOfWeek: h } = o, p = e.reduce((g, b) => {
    const w = n.broadcastCalendar ? m(b, o) : n.ISOWeek ? f(b) : h(b), v = n.broadcastCalendar ? s(b) : n.ISOWeek ? a(i(b)) : l(i(b)), N = t.filter((S) => S >= w && S <= v), C = n.broadcastCalendar ? 35 : 42;
    ...
    const y = N.reduce((S, k) => {
      const T = n.ISOWeek ? c(k) : u(k), M = S.find((A) => A.weekNumber === T), D = new oc(k, b, o);
...
function Lg(e, t) {
  ...
  const { startOfYear: r, startOfDay: s, startOfMonth: a, endOfMonth: i, addYears: l, endOfYear: c, newDate: u, today: m } = t, { fromYear: f, toYear: h, fromMonth: p, toMonth: g } = e;
  !n && p && (n = p), !n && f && (n = t.newDate(f, 0, 1)), !o && g && (o = g), !o && h && (o = u(h, 11, 31));
  const b = e.captionLayout === "dropdown" || e.captionLayout === "dropdown-years";
  return n ? n = a(n) : f ? n = u(f, 0, 1) : !n && b && (n = r(l(e.today ?? m(), -100))), o ? o = i(o) : h ? o = u(h, 11, 31) : !o && b && (o = c(e.today ?? m())), [
    n && s(n),
    o && s(o)
  ];
}
...
function Bg(e, t) {
  ...
  const c = Rg(i, o, e, t), u = Ag(c, e.endMonth ? s(e.endMonth) : void 0, e, t), m = Ig(c, u, e, t), f = $g(m), h = Pg(m), p = _g(i, n, e, t), g = Og(i, o, e, t), { disableNavigation: b, onMonthChange: w } = e, v = (x) => f.some((S) => S.days.some((k) => k.isEqualTo(x))), N = (x) => {
    if (b)
      return;
    let S = r(x);
...
function Hg(e, t, n, o) {
  ...
  for (const a of e) {
    const i = t(a);
    Pa(i) && (i[Se.focused] && s < ht.FocusedModifier ? (r = a, s = ht.FocusedModifier) : o?.isEqualTo(a) && s < ht.LastFocused ? (r = a, s = ht.LastFocused) : n(a.date) && s < ht.Selected ? (r = a, s = ht.Selected) : i[Se.today] && s < ht.Today && (r = a, s = ht.Today));
  }
  return r || (r = e.find((a) => Pa(t(a)))), r;
}
function Wg(e, t, n, o, r, s, a) {
  const { ISOWeek: i, broadcastCalendar: l } = s, { addDays: c, addMonths: u, addWeeks: m, addYears: f, endOfBroadcastWeek: h, endOfISOWeek: p, endOfWeek: g, max: b, min: w, startOfBroadcastWeek: v, startOfISOWeek: N, startOfWeek: C } = a;
  let x = {
    day: c,
    week: m,
    month: u,
...
function hc(e, t, n, o, r, s, a, i = 0) {
  if (i > 365)
    return;
  const l = Wg(e, t, n.date, o, r, s, a), c = !!(s.disabled && It(l, s.disabled, a)), u = !!(s.hidden && It(l, s.hidden, a)), m = l, f = new oc(l, m, a);
...
function zg(e, t) {
  const { selected: n, required: o, onSelect: r } = e, [s, a] = Or(n, r ? n : void 0), i = r ? n : s, { isSameDay: l } = t, c = (h) => i?.some((p) => l(p, h)) ?? !1, { min: u, max: m } = e;
  return {
    selected: i,
    select: (h, p, g) => {
      let b = [...i ?? []];
...
function Ug(e, t, n = 0, o = 0, r = !1, s = Nt) {
  ...
  if (!a && !i)
    ...
    l(a, e) ? n === 0 ? m = { from: a, to: e } : r ? m = { from: a, to: void 0 } : m = void 0 : u(e, a) ? m = { from: e, to: a } : m = { from: a, to: e };
  else if (a && i)
    if (l(a, e) && l(i, e))
      r ? m = { from: a, to: i } : m = void 0;
    else if (l(a, e))
  ...
  if (m?.from && m?.to) {
    ...
    o > 0 && f > o ? m = { from: e, to: void 0 } : n > 1 && f < n && (m = { from: e, to: void 0 });
  }
  return m;
}
...
function Vg(e, t) {
  ...
  return {
    ...
    select: (m, f, h) => {
      let p = m;
      return !o && i && i && l(m, i) && (p = void 0), r || a(p), r?.(p, m, f, h), p;
    },
...
function qg(e) {
  ...
  const { components: n, formatters: o, labels: r, dateLib: s, locale: a, classNames: i } = Pn(() => {
    ...
    t.labels,
    t.classNames
  ]), { captionLayout: l, mode: c, navLayout: u, numberOfMonths: m = 1, onDayBlur: f, onDayClick: h, onDayFocus: p, onDayKeyDown: g, onDayMouseEnter: b, onDayMouseLeave: w, onNextClick: v, onPrevClick: N, showWeekNumber: C, styles: y } = t, { formatCaption: x, formatDay: S, formatMonthDropdown: k, formatWeekNumber: T, formatWeekNumberHeader: M, formatWeekdayName: D, formatYearDropdown: A } = o, I = Bg(t, s), { days: L, months: $, navStart: W, navEnd: q, previousMonth: R, nextMonth: P, goToMonth: z } = I, X = Zp(L, t, W, q, s), { isSelected: G, select: Z, selected: te } = Gg(t, s) ?? {}, { blur: _, focused: H, isFocusTarget: j, moveFocus: ee, setFocused: ge } = Fg(t, I, X, G ?? (() => !1), s), { labelDayButton: be, labelGridcell: Ae, labelGrid: He, labelMonthDropdown: ot, labelNav: Wt, labelPrevious: eo, labelNext: to, labelWeekday: _o, labelWeekNumber: $o, labelWeekNumberHeader: Bo, labelYearDropdown: Ho } = r, vn = Pn(() => mg(s, t.ISOWeek), [s, t.ISOWeek]), no = c !== void 0 || h !== void 0, wn = U(() => {
    R && (z(R), N?.(R));
  }, [R, z, N]), Nn = U(() => {
    P && (z(P), v?.(P));
  }, [z, P, v]), Wo = U((ce, Ce) => (ie) => {
      ...
      J.createElement(
        ...
        $.map((ce, Ce) => J.createElement(
          ...
          J.createElement(n.MonthCaption, { "data-animated-caption": t.animate ? "true" : void 0, className: i[re.MonthCaption], style: y?.[re.MonthCaption], calendarMonth: ce, displayIndex: Ce }, l?.startsWith("dropdown") ? J.createElement(
            ...
            (() => {
              const ie = l === "dropdown" || l === "dropdown-months" ? J.createElement(n.MonthsDropdown, { key: "month", className: i[re.MonthsDropdown], "aria-label": ot(), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: zo(ce.date), options: ug(ce.date, W, q, o, s), style: y?.[re.Dropdown], value: s.getMonth(ce.date) }) : J.createElement("span", { key: "month" }, k(ce.date, s)), we = l === "dropdown" || l === "dropdown-years" ? J.createElement(n.YearsDropdown, { key: "year", className: i[re.YearsDropdown], "aria-label": Ho(s.options), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: Jr(ce.date), options: fg(W, q, o, s, !!t.reverseYears), style: y?.[re.Dropdown], value: s.getYear(ce.date) }) : J.createElement("span", { key: "year" }, A(ce.date, s));
            ...
            J.createElement("span", { role: "status", "aria-live": "polite", style: {
              ...
              whiteSpace: "nowrap",
              wordWrap: "normal"
            } }, x(ce.date, s.options, s))
          ) : (
            // biome-ignore lint/a11y/useSemanticElements: breaking change
            J.createElement(n.CaptionLabel, { className: i[re.CaptionLabel], role: "status", "aria-live": "polite" }, x(ce.date, s.options, s))
          )),
          u === "around" && !t.hideNavigation && Ce === m - 1 && J.createElement(
            n.NextMonthButton,
          ...
          Ce === m - 1 && u === "after" && !t.hideNavigation && J.createElement(n.Nav, { "data-animated-nav": t.animate ? "true" : void 0, className: i[re.Nav], style: y?.[re.Nav], "aria-label": Wt(), onPreviousClick: wn, onNextClick: Nn, previousMonth: R, nextMonth: P }),
          J.createElement(
            n.MonthGrid,
            ...
            J.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: i[re.Weeks], style: y?.[re.Weeks] }, ce.weeks.map((ie) => J.createElement(
              ...
              ie.days.map((we) => {
                ...
                if (ve[Se.focused] = !ve.hidden && !!H?.isEqualTo(we), ve[lt.selected] = G?.(Ve) || ve.selected, Si(te)) {
                ...
                const ro = dg(ve, y, t.modifiersStyles), qe = Qp(ve, i, t.modifiersClassNames), kt = !no && !ve.hidden ? Ae(Ve, ve, s.options, s) : void 0;
                return (
...
const Ai = "-", Xg = (e) => {
  ...
  let o = (r) => {
    ...
    const u = s.length === 0 ? r : r.substring(l), m = ob(u), f = m !== u, h = c && c > l ? c - l : void 0;
    return {
      modifiers: s,
...
const _e = (e) => {
  ...
  const e = _e("color"), t = _e("font"), n = _e("text"), o = _e("font-weight"), r = _e("tracking"), s = _e("leading"), a = _e("breakpoint"), i = _e("container"), l = _e("spacing"), c = _e("radius"), u = _e("shadow"), m = _e("inset-shadow"), f = _e("text-shadow"), h = _e("drop-shadow"), p = _e("blur"), g = _e("perspective"), b = _e("aspect"), w = _e("ease"), v = _e("animate"), N = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], C = () => [
    "center",
    "top",
    "bottom",
    "left",
    ...
    // Deprecated since Tailwind CSS v4.1.0, see https://github.com/tailwindlabs/tailwindcss/pull/17378
    "left-bottom"
  ], y = () => [...C(), oe, ne], x = () => ["auto", "hidden", "clip", "visible", "scroll"], S = () => ["auto", "contain", "none"], k = () => [oe, ne, l], T = () => [Cn, "full", "auto", ...k()], M = () => [Gt, "none", "subgrid", oe, ne], D = () => ["auto", {
    span: ["full", Gt, oe, ne]
  }, Gt, oe, ne], A = () => [Gt, "auto", oe, ne], I = () => ["auto", "min", "max", "fr", oe, ne], L = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], $ = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], W = () => ["auto", ...k()], q = () => [Cn, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...k()], R = () => [e, oe, ne], P = () => [...C(), _a, Oa, {
    position: [oe, ne]
  }], z = () => ["no-repeat", {
    ...
    oe,
    ne
  ], ge = () => ["none", he, oe, ne], be = () => ["none", he, oe, ne], Ae = () => [he, oe, ne], He = () => [Cn, "full", ...k()];
  return {
    cacheSize: 500,
    theme: {
...
function ko(e) {
  const t = /* @__PURE__ */ Pb(e), n = E.forwardRef((o, r) => {
    ...
    if (l) {
      const c = l.props.children, u = i.map((m) => m === l ? E.Children.count(c) > 1 ? E.Children.only(null) : E.isValidElement(c) ? c.props.children : null : m);
...
function $b({
  ...
  return /* @__PURE__ */ d(
    qg,
    {
      ...
      components: {
        Root: ({ className: c, rootRef: u, ...m }) => /* @__PURE__ */ d(
          "div",
          {
            "data-slot": "calendar",
            ref: u,
        ...
        Chevron: ({ className: c, orientation: u, ...m }) => u === "left" ? /* @__PURE__ */ d(xm, { className: de("size-4", c), ...m }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/calendar.tsx",
          lineNumber: 139,
          columnNumber: 15
        }, this) : u === "right" ? /* @__PURE__ */ d(
          Cm,
          {
          ...
          this
        ) : /* @__PURE__ */ d(Em, { className: de("size-4", c), ...m }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/calendar.tsx",
          lineNumber: 153,
          columnNumber: 13
        }, this),
        DayButton: Bb,
        WeekNumber: ({ children: c, ...u }) => /* @__PURE__ */ d("td", { ...u, children: /* @__PURE__ */ d("div", { className: "flex size-(--cell-size) items-center justify-center text-center", children: c }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/calendar.tsx",
          lineNumber: 160,
          columnNumber: 15
        }, this) }, void 0, !1, {
...
function Fb({
  ...
  }, [o, r]), u = /* @__PURE__ */ new Date(), m = u.toDateString(), f = new Date(u);
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ d("div", { className: "date-picker-popup bg-popover text-popover-foreground border border-border rounded-lg shadow-xl overflow-hidden", children: /* @__PURE__ */ d("div", { className: "flex flex-col", children: [
          /* @__PURE__ */ d("div", { className: "flex justify-center p-1", children: /* @__PURE__ */ d(
            $b,
            {
              mode: "single",
              selected: a,
          ...
          /* @__PURE__ */ d("div", { className: "border-t border-border" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/DatePillComponent.tsx",
            lineNumber: 203,
            columnNumber: 11
          }, this),
          /* @__PURE__ */ d("div", { className: "flex items-center justify-center gap-2 px-3 py-3", children: [
            /* @__PURE__ */ d(
              Zt,
              {
                variant: "outline",
                ...
                className: de(
                  ...
                  a.toDateString() === m && "ring-2 ring-primary"
                ),
                onClick: () => l(0),
                children: "Today"
              },
...
function zb(e, t, n) {
  ...
  hr();
  const o = e.getBoundingClientRect(), r = window.innerWidth, s = window.innerHeight, a = 320, i = 420, l = 10, c = 16, u = s - o.bottom - l - c, m = o.top - l - c, f = u >= i ? "below" : m >= i ? "above" : u >= m ? "below" : "above";
  let h;
...
function Ub({ node: e, updateAttributes: t, selected: n }) {
  ...
  return Q(() => (Sc.set(r, (l) => {
    ...
    const c = (u) => {
      ...
      const m = l.getAttribute("data-date") || On(), f = i();
      zb(l, m, f);
    };
  ...
  }, []), /* @__PURE__ */ d(Wn, { as: "span", className: "inline", children: /* @__PURE__ */ d(
    "span",
    {
      ref: o,
      ...
      "data-date": r,
      children: [
        /* @__PURE__ */ d(Il, { size: 14, className: "date-icon" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/DatePillComponent.tsx",
          lineNumber: 410,
          columnNumber: 9
        }, this),
        /* @__PURE__ */ d("span", { className: "date-text", children: s }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/DatePillComponent.tsx",
          lineNumber: 411,
          columnNumber: 9
        }, this)
...
const jb = new Ke("datePillPaste"), Kb = Ar.create({
  ...
  addInputRules() {
    const e = new Qe({
      find: /@today\s$/,
      handler: ({ range: u, chain: m }) => {
        m().deleteRange(u).insertDatePill(On()).run();
      }
    }), t = new Qe({
      find: /@tomorrow\s$/,
      handler: ({ range: u, chain: m }) => {
        m().deleteRange(u).insertDatePill(vo(1)).run();
      }
    }), n = new Qe({
      find: /@yesterday\s$/,
      handler: ({ range: u, chain: m }) => {
      ...
      find: /@(\d{4}-\d{2}-\d{2})\s$/,
      handler: ({ range: u, chain: m, match: f }) => {
        m().deleteRange(u).insertDatePill(f[1]).run();
      }
    }), r = new Qe({
      ...
      handler: ({ range: u, chain: m, match: f }) => {
        ...
        if (p !== void 0) {
          ...
          m().deleteRange(u).insertDatePill(_n(b)).run();
        }
      }
    }), s = new Qe({
      ...
      handler: ({ range: u, chain: m, match: f }) => {
        const h = cn(f[1]);
        h && m().deleteRange(u).insertDatePill(h).run();
      }
    }), a = new Qe({
      ...
      new je({
        ...
        props: {
          handlePaste(t, n) {
            ...
            if (!i) return !1;
            const { state: u } = t, { tr: m, schema: f } = u, h = [];
            let p = 0;
            ...
            for (; (b = g.exec(r)) !== null; ) {
              const C = b[1], y = cn(C);
              if (y) {
                const x = r.slice(p, b.index);
                x && h.push(f.text(x)), h.push(e.create({ date: y })), p = b.index + b[0].length;
              }
            }
            const w = r.slice(p);
...
function Vb({ node: e, selected: t, editor: n, getPos: o, deleteNode: r }) {
  const s = V(null), a = V(null), i = e.attrs.tag || "", l = V(!1), [c, u] = K(() => at.has(i)), [m, f] = K(() => at.get(i)?.value ?? i);
  Q(() => {
    c || f(i);
  }, [i, c]), Q(() => {
    if (c) {
  ...
  const h = U((v) => {
    ...
    if (at.delete(i), C && at.delete(C), !C || !An(C))
      ...
      if (typeof y == "number" && n) {
        ...
        x.delete(y, y + S), x.insert(y, n.schema.nodes.tagPill.create({ tag: C })), n.view.dispatch(x);
      }
    } else
      at.delete(i);
  ...
  const g = U((v) => {
    v.key === "Enter" ? (v.preventDefault(), h(m)) : v.key === "Escape" && (v.preventDefault(), at.delete(i), u(!1), l.current = !0, n?.commands.focus());
  }, [h, m, i, n]), b = U(() => {
  ...
  return c ? /* @__PURE__ */ d(Wn, { as: "span", className: "inline", children: /* @__PURE__ */ d(
    "span",
    {
      ref: s,
      ...
      "data-tag": i,
      children: [
        /* @__PURE__ */ d(ua, { size: 14, className: "tag-icon", strokeWidth: 2.5 }, void 0, !1, {
    ...
    lineNumber: 170,
    columnNumber: 7
  }, this) : /* @__PURE__ */ d(Wn, { as: "span", className: "inline", children: /* @__PURE__ */ d(
    "span",
    {
      ref: s,
      ...
      children: [
        ...
        /* @__PURE__ */ d("span", { className: "tag-text", children: i }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TagPillComponent.tsx",
          lineNumber: 204,
          columnNumber: 9
        }, this)
...
`) ? 1 : 0, x = r.slice(p, b.index + y);
                x && h.push(f.text(x)), h.push(e.create({ tag: N })), p = b.index + C.length;
              }
            }
            const w = r.slice(p);
            if (w && h.push(f.text(w)), h.length === 0) return !1;
            ...
            if (v.parent.type.name === "paragraph") {
              ...
              m.replaceSelectionWith(N), t.dispatch(m);
            }
            return n.preventDefault(), !0;
          }
        }
...
function Ac({ isOpen: e, onClose: t, onInsert: n, position: o }) {
  const [r, s] = K(""), [a, i] = K(""), [l, c] = K(""), [u, m] = K(!1), f = V(null), h = V(null);
  Q(() => {
    e && (s(""), i(""), c(""), setTimeout(() => {
      f.current?.focus();
    }, 100));
  ...
  const p = (v) => {
    ...
    v.onload = () => {
      m(!1), n(r.trim(), a.trim()), t();
    }, v.onerror = () => {
      m(!1), n(r.trim(), a.trim()), t();
    }, setTimeout(() => {
      u && (m(!1), n(r.trim(), a.trim()), t());
    }, 3e3), v.src = r.trim();
  }, b = (v) => {
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "image-url-dialog-header", children: [
          /* @__PURE__ */ d("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ d(wi, { size: 16, className: "text-primary" }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageURLDialog.tsx",
              lineNumber: 148,
              columnNumber: 11
            }, this),
            /* @__PURE__ */ d("span", { className: "font-medium text-sm", children: "Insert Image from URL" }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageURLDialog.tsx",
              lineNumber: 149,
              columnNumber: 11
            }, this)
          ...
          /* @__PURE__ */ d(
            "button",
            {
              ...
              "aria-label": "Close",
              children: /* @__PURE__ */ d(Ot, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageURLDialog.tsx",
                lineNumber: 156,
                columnNumber: 11
              }, this)
        ...
        /* @__PURE__ */ d("div", { className: "image-url-dialog-content", children: [
          /* @__PURE__ */ d("div", { className: "image-url-dialog-field", children: [
            /* @__PURE__ */ d("label", { className: "image-url-dialog-label", children: [
              /* @__PURE__ */ d(ai, { size: 12 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageURLDialog.tsx",
                lineNumber: 165,
                columnNumber: 13
              }, this),
            ...
            l && /* @__PURE__ */ d("span", { className: "image-url-dialog-error", children: l }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageURLDialog.tsx",
              lineNumber: 181,
              columnNumber: 13
            }, this)
          ...
          /* @__PURE__ */ d("div", { className: "image-url-dialog-field", children: [
            /* @__PURE__ */ d("label", { className: "image-url-dialog-label", children: [
              /* @__PURE__ */ d(Ir, { size: 12 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageURLDialog.tsx",
                lineNumber: 188,
                columnNumber: 13
              }, this),
          ...
          /* @__PURE__ */ d("div", { className: "image-url-dialog-actions", children: [
            /* @__PURE__ */ d(
              "button",
              {
                onClick: t,
...
const Xb = [
  {
    title: "Paragraph",
    icon: /* @__PURE__ */ d(Ir, { size: 16 }, void 0, !1, {
  ...
  {
    title: "Heading 1",
    icon: /* @__PURE__ */ d(Tm, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 70,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Heading 2",
    icon: /* @__PURE__ */ d(Mm, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 76,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Heading 3",
    icon: /* @__PURE__ */ d(Sm, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 82,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Heading 4",
    icon: /* @__PURE__ */ d(Dm, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 88,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Heading 5",
    icon: /* @__PURE__ */ d(Am, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 94,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Bullet List",
    icon: /* @__PURE__ */ d(hi, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 100,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Numbered List",
    icon: /* @__PURE__ */ d(pi, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 106,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Task List",
    icon: /* @__PURE__ */ d(gi, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 112,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Quote",
    icon: /* @__PURE__ */ d(fi, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 118,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Code Block",
    icon: /* @__PURE__ */ d(Ll, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 124,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Table",
    icon: /* @__PURE__ */ d($s, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 130,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Image",
    icon: /* @__PURE__ */ d(wi, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 136,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Divider",
    icon: /* @__PURE__ */ d(Ol, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 143,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Info Callout",
    icon: /* @__PURE__ */ d(vr, { size: 16, className: "text-blue-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 149,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Note Callout",
    icon: /* @__PURE__ */ d(Pl, { size: 16, className: "text-purple-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 155,
      columnNumber: 11
    }, void 0),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ d(Al, { size: 16, className: "text-amber-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 161,
      columnNumber: 11
    }, void 0),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ d(vi, { size: 16, className: "text-green-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 167,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "To-Do Callout",
    icon: /* @__PURE__ */ d(bi, { size: 16, className: "text-cyan-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 173,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Date",
    icon: /* @__PURE__ */ d(Il, { size: 16, className: "text-cyan-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 179,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Wiki Link",
    icon: /* @__PURE__ */ d(ai, { size: 16, className: "text-cyan-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 185,
      columnNumber: 11
    }, void 0),
...
function tv({ editor: e }) {
  const [t, n] = K(!1), [o, r] = K(""), [s, a] = K(0), [i, l] = K(null), [c, u] = K(!1), [m, f] = K({ top: 0, left: 0 }), [h, p] = K("below"), g = V(null), b = V(-1), w = V(!1);
  Q(() => {
    w.current = t;
  }, [t]);
  const v = Xb.filter((T) => {
...
`) return;
    ...
    const T = e.view.dom, M = (D) => {
      w.current && (D.key === "ArrowDown" ? (D.preventDefault(), D.stopPropagation(), a((A) => (A + 1) % v.length)) : D.key === "ArrowUp" ? (D.preventDefault(), D.stopPropagation(), a((A) => (A - 1 + v.length) % v.length)) : D.key === "Enter" ? (D.preventDefault(), D.stopPropagation(), x(s)) : D.key === "Escape" && (D.preventDefault(), D.stopPropagation(), y()));
    };
...
`)) {
    ...
    this
  ) : !t || v.length === 0 ? null : /* @__PURE__ */ d(Ht, { children: /* @__PURE__ */ d(
    "div",
    {
      ref: g,
      ...
      children: v.map((T, M) => /* @__PURE__ */ d(
        "div",
        {
          className: `slash-item ${M === s ? "is-selected" : ""}`,
          onClick: (D) => {
            D.preventDefault(), D.stopPropagation(), x(M);
          },
          onMouseEnter: () => a(M),
          children: [
            /* @__PURE__ */ d("span", { className: "slash-icon", children: T.icon }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
              lineNumber: 569,
              columnNumber: 11
            }, this),
            /* @__PURE__ */ d("span", { className: "slash-label", children: T.title }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
              lineNumber: 570,
              columnNumber: 11
            }, this)
...
function iv({ editor: e, onSearch: t, onCreateItem: n }) {
  const [o, r] = K(!1), [s, a] = K(""), [i, l] = K([]), [c, u] = K(0), [m, f] = K(null), [h, p] = K("below"), [g, b] = K(!1), w = V(!1), v = V(null), N = V(-1), C = V(null);
  Q(() => {
    w.current = o;
  }, [o]);
  const y = U(() => {
    ...
    const D = e.view.dom, A = (I) => {
      if (w.current) {
        ...
        if (I.key === "Enter" || I.key === "Tab") {
          I.preventDefault(), I.stopPropagation(), c < i.length ? x(i[c].title) : s.trim() && n ? (n(s.trim()), y()) : s.trim() && x(s.trim());
          return;
        }
        if (I.key === "Escape") {
          I.preventDefault(), y();
...
`) || $.includes("]]")) {
  ...
  if (Pr(() => {
    if (!o || !m) return;
    const { top: D, bottom: A, left: I } = m, L = window.innerHeight, $ = window.innerWidth, W = L - A - nr, q = D - nr;
    let R;
    if (W >= k ? R = "below" : q >= k ? R = "above" : R = W >= q ? "below" : "above", p(R), v.current) {
      const P = Math.max(
        nr,
        Math.min(I, $ - nv - nr)
      ), z = R === "below" ? A + 4 : D - k - 4;
  ...
  return /* @__PURE__ */ d(Ht, { children: /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        g && i.length === 0 && /* @__PURE__ */ d("div", { className: "wikilink-item wikilink-loading", children: /* @__PURE__ */ d("span", { className: "wikilink-label", style: { color: "var(--muted-foreground)" }, children: "Searching..." }, void 0, !1, {
        ...
        i.map((D, A) => /* @__PURE__ */ d(
          "div",
          {
            className: `wikilink-item ${A === c ? "is-selected" : ""}`,
            onMouseDown: (I) => {
              I.preventDefault(), x(D.title);
            },
            onMouseEnter: () => u(A),
            children: [
              /* @__PURE__ */ d("span", { className: "wikilink-icon", children: /* @__PURE__ */ d(Ni, { size: 14 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/WikiLinkAutocomplete.tsx",
                lineNumber: 380,
                columnNumber: 13
              }, this) }, void 0, !1, {
              ...
              /* @__PURE__ */ d("span", { className: "wikilink-label", children: D.title }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/WikiLinkAutocomplete.tsx",
                lineNumber: 382,
                columnNumber: 11
              }, this),
              /* @__PURE__ */ d("span", { className: "wikilink-type", children: D.type }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/WikiLinkAutocomplete.tsx",
                lineNumber: 383,
                columnNumber: 11
              }, this)
        ...
        T && /* @__PURE__ */ d(
          "div",
          {
            ...
            onMouseDown: (D) => {
              D.preventDefault(), n ? (n(s.trim()), y()) : x(s.trim());
            },
            onMouseEnter: () => u(i.length),
            children: [
              /* @__PURE__ */ d("span", { className: "wikilink-icon", children: /* @__PURE__ */ d(yi, { size: 14 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/WikiLinkAutocomplete.tsx",
                lineNumber: 401,
                columnNumber: 13
              }, this) }, void 0, !1, {
              ...
              /* @__PURE__ */ d("span", { className: "wikilink-label", children: [
                "Create “",
                s.trim(),
                "”"
              ] }, void 0, !0, {
        ...
        !g && i.length === 0 && !s.trim() && /* @__PURE__ */ d("div", { className: "wikilink-item wikilink-loading", children: /* @__PURE__ */ d("span", { className: "wikilink-label", style: { color: "var(--muted-foreground)" }, children: "Type to search items..." }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/WikiLinkAutocomplete.tsx",
          lineNumber: 408,
          columnNumber: 11
        }, this) }, void 0, !1, {
...
function Zn(e, t = []) {
  ...
  function o(s, a) {
    ...
    n = [...n, a];
    const c = (m) => {
      const { scope: f, children: h, ...p } = m, g = f?.[e]?.[l] || i, b = E.useMemo(() => p, Object.values(p));
...
function Rc(e) {
  ...
  c.displayName = i;
  const u = e + "CollectionItemSlot", m = "data-radix-collection-item", f = /* @__PURE__ */ ko(u), h = J.forwardRef(
    (g, b) => {
      const { scope: w, children: v, ...N } = g, C = J.useRef(null), y = Ye(b, C), x = s(u, w);
      return J.useEffect(() => (x.itemMap.set(C, { ref: C, ...N }), () => void x.itemMap.delete(C))), /* @__PURE__ */ Y(f, { [m]: "", ref: y, children: v });
    }
  );
  h.displayName = u;
  function p(g) {
    ...
    return J.useCallback(() => {
      ...
      if (!v) return [];
      const N = Array.from(v.querySelectorAll(`[${m}]`));
      return Array.from(b.itemMap.values()).sort(
        (x, S) => N.indexOf(x.ref.current) - N.indexOf(S.ref.current)
      );
...
var hv = "DismissableLayer", Vs = "dismissableLayer.update", pv = "dismissableLayer.pointerDownOutside", gv = "dismissableLayer.focusOutside", za, Lc = E.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: i,
      ...l
    } = e, c = E.useContext(Lc), [u, m] = E.useState(null), f = u?.ownerDocument ?? globalThis?.document, [, h] = E.useState({}), p = Ye(t, (S) => m(S)), g = Array.from(c.layers), [b] = [...c.layersWithOutsidePointerEventsDisabled].slice(-1), w = g.indexOf(b), v = u ? g.indexOf(u) : -1, N = c.layersWithOutsidePointerEventsDisabled.size > 0, C = v >= w, y = wv((S) => {
      const k = S.target, T = [...c.branches].some((M) => M.contains(k));
      !C || T || (r?.(S), a?.(S), S.defaultPrevented || i?.());
    }, f), x = Nv((S) => {
      const k = S.target;
      [...c.branches].some((M) => M.contains(k)) || (s?.(S), a?.(S), S.defaultPrevented || i?.());
    }, f);
    return fv((S) => {
      ...
      ze.div,
      {
        ...
        onFocusCapture: fe(e.onFocusCapture, x.onFocusCapture),
        onBlurCapture: fe(e.onBlurCapture, x.onBlurCapture),
...
var ys = "focusScope.autoFocusOnMount", ks = "focusScope.autoFocusOnUnmount", ja = { bubbles: !1, cancelable: !0 }, kv = "FocusScope", _c = E.forwardRef((e, t) => {
  const {
    ...
    ...a
  } = e, [i, l] = E.useState(null), c = _t(r), u = _t(s), m = E.useRef(null), f = Ye(t, (g) => l(g)), h = E.useRef({
    paused: !1,
    pause() {
      this.paused = !0;
    },
  ...
  E.useEffect(() => {
    if (o) {
      let g = function(N) {
        ...
        const C = N.target;
        i.contains(C) ? m.current = C : Xt(m.current, { select: !0 });
      }, b = function(N) {
        if (h.paused || !i) return;
        const C = N.relatedTarget;
        C !== null && (i.contains(C) || Xt(m.current, { select: !0 }));
      }, w = function(N) {
...
function Za(e, t, n) {
  ...
  const s = bt(t), a = _i(t), i = Oi(a), l = Bt(t), c = s === "y", u = o.x + o.width / 2 - r.width / 2, m = o.y + o.height / 2 - r.height / 2, f = o[i] / 2 - r[i] / 2;
  let h;
  switch (l) {
    case "top":
      h = {
...
async function xo(e, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: h = 0
  } = $t(t, e), p = Bc(h), b = i[f ? m === "floating" ? "reference" : "floating" : m], w = kr(await s.getClippingRect({
...
const Uv = (e) => ({
  ...
  async fn(t) {
    ...
    const m = Bc(u), f = {
      x: n,
      y: o
    }, h = _i(r), p = Oi(h), g = await a.getDimensions(c), b = h === "y", w = b ? "top" : "left", v = b ? "bottom" : "right", N = b ? "clientHeight" : "clientWidth", C = s.reference[p] + s.reference[h] - f[h] - s.floating[p], y = f[h] - s.reference[h], x = await (a.getOffsetParent == null ? void 0 : a.getOffsetParent(c));
    let S = x ? x[N] : 0;
    (!S || !await (a.isElement == null ? void 0 : a.isElement(x))) && (S = i.floating[N] || s.floating[p]);
    const k = C / 2 - y / 2, T = S / 2 - g[p] / 2 - 1, M = en(m[w], T), D = en(m[v], T), A = M, I = S - g[p] - D, L = S / 2 - g[p] / 2 + k, $ = Gs(A, L, I), W = !l.arrow && Qn(r) != null && L !== $ && s.reference[p] / 2 - (L < A ? M : D) - g[p] / 2 < 0, q = W ? L < A ? L - A : L - I : 0;
    return {
      [h]: f[h] + q,
      data: {
        [h]: $,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const w = Bt(r), v = bt(i), N = Bt(i) === i, C = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), y = f || (N || !g ? [yr(i)] : _v(i)), x = p !== "none";
      !f && x && y.push(...Wv(i, g, p, C));
      const S = [i, ...y], k = await xo(t, b), T = [];
      ...
      if (M = [...M, {
        ...
        if ($ && (!(m === "alignment" ? v !== bt($) : !1) || // We leave the current main axis only if every placement on that axis
...
async function Kv(e, t) {
  const {
    ...
    platform: o,
    elements: r
  } = e, s = await (o.isRTL == null ? void 0 : o.isRTL(r.floating)), a = Bt(n), i = Qn(n), l = bt(n) === "y", c = Hc.has(a) ? -1 : 1, u = s && l ? -1 : 1, m = $t(t, e);
  let {
    mainAxis: f,
    crossAxis: h,
    alignmentAxis: p
...
const Vv = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: n,
        y: o
      }, u = await xo(t, l), m = bt(Bt(r)), f = Li(m);
      let h = c[f], p = c[m];
      if (s) {
      ...
      if (a) {
        const b = m === "y" ? "top" : "left", w = m === "y" ? "bottom" : "right", v = p + u[b], N = p - u[w];
        p = Gs(v, p, N);
      }
      const g = i.fn({
        ...t,
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (c) {
        var w, v;
        const N = f === "y" ? "width" : "height", C = Hc.has(Bt(r)), y = s.reference[m] - s.floating[N] + (C && ((w = a.offset) == null ? void 0 : w[m]) || 0) + (C ? 0 : b.crossAxis), x = s.reference[m] + s.reference[N] + (C ? 0 : ((v = a.offset) == null ? void 0 : v[m]) || 0) - (C ? b.crossAxis : 0);
        p < y ? p = y : p > x && (p = x);
      }
      return {
        [f]: h,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      const {
        ...
        ...c
      } = $t(e, t), u = await xo(t, c), m = Bt(r), f = Qn(r), h = bt(r) === "y", {
        width: p,
        height: g
      } = s.floating;
      let b, w;
      m === "top" || m === "bottom" ? (b = m, w = f === (await (a.isRTL == null ? void 0 : a.isRTL(i.floating)) ? "start" : "end") ? "left" : "right") : (w = m, b = f === "end" ? "top" : "bottom");
      const v = g - u.top - u.bottom, N = p - u.left - u.right, C = en(g - u[b], v), y = en(p - u[w], N), x = !t.middlewareData.shift;
      let S = C, k = y;
      if ((n = t.middlewareData.shift) != null && n.enabled.x && (k = N), (o = t.middlewareData.shift) != null && o.enabled.y && (S = v), x && !f) {
        const M = et(u.left, 0), D = et(u.right, 0), A = et(u.top, 0), I = et(u.bottom, 0);
        h ? k = p - 2 * (M !== 0 || D !== 0 ? M + D : et(u.left, u.right)) : S = g - 2 * (A !== 0 || I !== 0 ? A + I : et(u.top, u.bottom));
      }
      await l({
        ...t,
        availableWidth: k,
...
function hn(e, t, n, o) {
  ...
  let l = (r.left + i.x) / a.x, c = (r.top + i.y) / a.y, u = r.width / a.x, m = r.height / a.y;
  if (s) {
    ...
    for (; g && o && h !== p; ) {
      ...
      l *= b.x, c *= b.y, u *= b.x, m *= b.y, l += N, c += C, p = tt(g), g = Xs(p);
    }
  }
  return kr({
    width: u,
...
function lw(e) {
  ...
  const u = vt(0), m = wt(o);
  if ((m || !m && !s) && ((Jn(o) !== "body" || Po(a)) && (l = Wr(o)), wt(o))) {
    const h = hn(o);
    c = $n(o), u.x = h.x + o.clientLeft, u.y = h.y + o.clientTop;
  }
  const f = a && !m && !s ? Yc(a, l) : vt(0);
  return {
    width: n.width * c.x,
    height: n.height * c.y,
...
function dw(e, t) {
  ...
  const c = Fr(o);
  if (c <= 0) {
    const u = o.ownerDocument, m = u.body, f = getComputedStyle(m), h = u.compatMode === "CSS1Compat" && parseFloat(f.marginLeft) + parseFloat(f.marginRight) || 0, p = Math.abs(o.clientWidth - m.clientWidth - h);
    p <= tl && (s -= p);
  } else c <= tl && (s += c);
  return {
    width: s,
...
function pw(e) {
  ...
  const a = [...n === "clippingAncestors" ? Hr(t) ? [] : hw(t, this._c) : [].concat(n), o], i = a[0], l = a.reduce((c, u) => {
    const m = nl(t, u, r);
    return c.top = et(m.top, c.top), c.right = en(m.right, c.right), c.bottom = en(m.bottom, c.bottom), c.left = et(m.left, c.left), c;
  }, nl(t, i, r));
  return {
...
function bw(e, t, n) {
  ...
  s && !o && r && c();
  const u = r && !o && !s ? Yc(r, i) : vt(0), m = a.left + i.scrollLeft - l.x - u.x, f = a.top + i.scrollTop - l.y - u.y;
  return {
    x: m,
    y: f,
    width: a.width,
...
function yw(e, t) {
  ...
  function a(i, l) {
    ...
    if (i || t(), !f || !h)
      return;
    const p = or(m), g = or(r.clientWidth - (u + f)), b = or(r.clientHeight - (m + h)), w = or(u), N = {
...
function kw(e, t, n, o) {
  ...
  return n(), () => {
    ...
    }), m?.(), (w = h) == null || w.disconnect(), h = null, l && cancelAnimationFrame(p);
  };
}
...
function Rw(e) {
  ...
  const [p, g] = E.useState(null), [b, w] = E.useState(null), v = E.useCallback((R) => {
  ...
  }, []), C = s || p, y = a || b, x = E.useRef(null), S = E.useRef(null), k = E.useRef(u), T = l != null, M = Cs(l), D = Cs(r), A = Cs(c), I = E.useCallback(() => {
    ...
    D.current && (R.platform = D.current), Dw(x.current, S.current, R).then((P) => {
      const z = {
        ...P,
      ...
      L.current && !xr(k.current, z) && (k.current = z, Fl.flushSync(() => {
        m(z);
      }));
    });
  }, [f, t, n, D, A]);
  pr(() => {
    c === !1 && k.current.isPositioned && (k.current.isPositioned = !1, m((R) => ({
      ...R,
      isPositioned: !1
    })));
  }, [c]);
  ...
  pr(() => (L.current = !0, () => {
    ...
    if (C && (x.current = C), y && (S.current = y), C && y) {
      if (M.current)
...
var Fi = "PopperContent", [jw, Kw] = Xc(Fi), tu = E.forwardRef(
  (e, t) => {
    const {
      ...
      onPlaced: p,
      ...g
    } = e, b = Zc(Fi, n), [w, v] = E.useState(null), N = Ye(t, (j) => v(j)), [C, y] = E.useState(null), x = Uw(C), S = x?.width ?? 0, k = x?.height ?? 0, T = o + (s !== "center" ? "-" + s : ""), M = typeof u == "number" ? u : { top: 0, right: 0, bottom: 0, left: 0, ...u }, D = Array.isArray(c) ? c : [c], A = D.length > 0, I = {
      padding: M,
      ...
      middleware: [
        Lw({ mainAxis: r + k, alignmentAxis: a }),
        l && Ow({
          mainAxis: !0,
          crossAxis: !1,
          limiter: m === "partial" ? _w() : void 0,
          ...I
        }),
        l && $w({ ...I }),
        Bw({
          ...
          apply: ({ elements: j, rects: ee, availableWidth: ge, availableHeight: be }) => {
            const { width: Ae, height: He } = ee.reference, ot = j.floating.style;
            ot.setProperty("--radix-popper-available-width", `${ge}px`), ot.setProperty("--radix-popper-available-height", `${be}px`), ot.setProperty("--radix-popper-anchor-width", `${Ae}px`), ot.setProperty("--radix-popper-anchor-height", `${He}px`);
          }
        }),
        C && Ww({ element: C, padding: i }),
        qw({ arrowWidth: S, arrowHeight: k }),
...
var qw = (e) => ({
  ...
  options: e,
  fn(t) {
    const { placement: n, rects: o, middlewareData: r } = t, a = r.arrow?.centerOffset !== 0, i = a ? 0 : e.arrowWidth, l = a ? 0 : e.arrowHeight, [c, u] = ru(n), m = { start: "0%", center: "50%", end: "100%" }[u], f = (r.arrow?.x ?? 0) + i / 2, h = (r.arrow?.y ?? 0) + l / 2;
    let p = "", g = "";
    return c === "bottom" ? (p = a ? m : `${f}px`, g = `${-l}px`) : c === "top" ? (p = a ? m : `${f}px`, g = `${o.floating.height + l}px`) : c === "right" ? (p = `${-l}px`, g = a ? m : `${h}px`) : c === "left" && (p = `${o.floating.width + l}px`, g = a ? m : `${h}px`), { data: { x: p, y: g } };
  }
});
function ru(e) {
  ...
  return E.useEffect(() => {
    ...
    if (t) {
      ...
      return t.addEventListener("animationstart", f), t.addEventListener("animationcancel", m), t.addEventListener("animationend", m), () => {
        u.clearTimeout(c), t.removeEventListener("animationstart", f), t.removeEventListener("animationcancel", m), t.removeEventListener("animationend", m);
      };
    } else
      l("ANIMATION_END");
  }, [t, l]), {
...
var Es = "rovingFocusGroup.onEntryFocus", e0 = { bubbles: !1, cancelable: !0 }, Ro = "RovingFocusGroup", [Zs, cu, t0] = Rc(Ro), [n0, uu] = Zn(
  Ro,
  [t0]
), [o0, r0] = n0(Ro), du = E.forwardRef(
  (e, t) => /* @__PURE__ */ Y(Zs.Provider, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ Y(Zs.Slot, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ Y(s0, { ...e, ref: t }) }) })
);
du.displayName = Ro;
var s0 = E.forwardRef((e, t) => {
  const {
    ...
    onChange: l,
    caller: Ro
  }), [w, v] = E.useState(!1), N = _t(c), C = cu(n), y = E.useRef(!1), [x, S] = E.useState(0);
  return E.useEffect(() => {
    const k = f.current;
    if (k)
      return k.addEventListener(Es, N), () => k.removeEventListener(Es, N);
  }, [N]), /* @__PURE__ */ Y(
    o0,
    {
      scope: n,
      ...
      children: /* @__PURE__ */ Y(
        ze.div,
        {
          ...
          onFocus: fe(e.onFocus, (k) => {
            const T = !y.current;
            if (k.target === k.currentTarget && T && !w) {
              const M = new CustomEvent(Es, e0);
  ...
  (e, t) => {
    const {
      ...
      children: a,
      ...i
    } = e, l = wr(), c = s || l, u = r0(mu, n), m = u.currentTabStopId === c, f = cu(n), { onFocusableItemAdd: h, onFocusableItemRemove: p, currentTabStopId: g } = u;
    return E.useEffect(() => {
      if (o)
        return h(), () => p();
    }, [o, h, p]), /* @__PURE__ */ Y(
        ...
        children: /* @__PURE__ */ Y(
          ze.span,
          {
            ...
            onKeyDown: fe(e.onKeyDown, (b) => {
              ...
              const w = l0(b, u.orientation, u.dir);
              if (w !== void 0) {
...
var u0 = du, d0 = fu, m0 = function(e) {
  ...
  var s = ir[n], a = [], i = /* @__PURE__ */ new Set(), l = new Set(r), c = function(m) {
  ...
  return u(t), i.clear(), Ts++, function() {
    a.forEach(function(m) {
      var f = En.get(m) - 1, h = s.get(m) - 1;
      En.set(m, f), s.set(m, h), f || (sr.has(m) || m.removeAttribute(o), sr.delete(m)), h || m.removeAttribute(n);
    }), Ts--, Ts || (En = /* @__PURE__ */ new WeakMap(), En = /* @__PURE__ */ new WeakMap(), sr = /* @__PURE__ */ new WeakMap(), ir = {});
  };
}, p0 = function(e, t, n) {
  n === void 0 && (n = "data-aria-hidden");
  var o = Array.from(Array.isArray(e) ? e : [e]), r = m0(e);
  return r ? (o.push.apply(o, Array.from(r.querySelectorAll("[aria-live], script"))), h0(o, r, n, "aria-hidden")) : function() {
    return null;
  };
}, pt = function() {
...
var gr = "right-scroll-bar-position", br = "width-before-scroll-bar", b0 = "with-scroll-bars-hidden", v0 = "--removed-body-scroll-bar-size";
function Ms(e, t) {
...
var N0 = typeof window < "u" ? E.useLayoutEffect : E.useEffect, il = /* @__PURE__ */ new WeakMap();
function y0(e, t) {
  var n = w0(null, function(o) {
...
var vu = C0(), Ss = function() {
}, Ur = E.forwardRef(function(e, t) {
  var n = E.useRef(null), o = E.useState({
    onScrollCapture: Ss,
    onWheelCapture: Ss,
    onTouchMoveCapture: Ss
  }), r = o[0], s = o[1], a = e.forwardProps, i = e.children, l = e.className, c = e.removeScrollBar, u = e.enabled, m = e.shards, f = e.sideCar, h = e.noRelative, p = e.noIsolation, g = e.inert, b = e.allowPinchZoom, w = e.as, v = w === void 0 ? "div" : w, N = e.gapMode, C = gu(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), y = f, x = y0([n, t]), S = pt(pt({}, C), r);
  return E.createElement(
    E.Fragment,
    null,
    u && E.createElement(y, { sideCar: vu, removeScrollBar: c, shards: m, noRelative: h, noIsolation: p, inert: g, setCallbacks: s, allowPinchZoom: !!b, lockRef: n, gapMode: N }),
    a ? E.cloneElement(E.Children.only(i), pt(pt({}, S), { ref: x })) : E.createElement(v, pt({}, S, { className: l, ref: x }), i)
  );
});
Ur.defaultProps = {
  enabled: !0,
...
var A0 = function() {
  ...
  if (e === void 0 && (e = "margin"), typeof window > "u")
    return R0;
  var t = I0(e), n = document.documentElement.clientWidth, o = window.innerWidth;
  return {
    left: t[0],
    top: t[1],
    right: t[2],
...
}, O0 = wu(), Bn = "data-scroll-locked", _0 = function(e, t, n, o) {
...
`);
  ...
  return E.createElement(O0, { styles: _0(s, !t, r, n ? "" : "!important") });
}, Qs = !1;
if (typeof window < "u")
  try {
...
var Tn = Qs ? { passive: !1 } : !1, H0 = function(e) {
  ...
  return (
    ...
    !(n.overflowY === n.overflowX && !H0(e) && n[t] === "visible")
  );
}, W0 = function(e) {
  ...
  return e === "v" ? W0(t) : F0(t);
}, ku = function(e, t) {
  return e === "v" ? z0(t) : U0(t);
}, Y0 = function(e, t) {
  return e === "h" && t === "rtl" ? -1 : 1;
}, j0 = function(e, t, n, o, r) {
  var s = Y0(e, window.getComputedStyle(t).direction), a = s * o, i = n.target, l = t.contains(i), c = !1, u = a > 0, m = 0, f = 0;
  do {
    if (!i)
      break;
  ...
  return (u && Math.abs(m) < 1 || !u && Math.abs(f) < 1) && (c = !0), c;
}, lr = function(e) {
...
function q0(e) {
  var t = E.useRef([]), n = E.useRef([0, 0]), o = E.useRef(), r = E.useState(G0++)[0], s = E.useState(wu)[0], a = E.useRef(e);
  E.useEffect(function() {
    a.current = e;
  }, [e]), E.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(r));
      var g = g0([e.lockRef.current], (e.shards || []).map(ul), !0).filter(Boolean);
  ...
  var i = E.useCallback(function(g, b) {
    ...
    var w = lr(g), v = n.current, N = "deltaX" in g ? g.deltaX : v[0] - w[0], C = "deltaY" in g ? g.deltaY : v[1] - w[1], y, x = g.target, S = Math.abs(N) > Math.abs(C) ? "h" : "v";
    if ("touches" in g && S === "h" && x.type === "range")
      return !1;
    var k = ll(S, x);
    if (!k)
      return !0;
    if (k ? y = S : (y = S === "v" ? "h" : "v", k = ll(S, x)), !k)
      return !1;
    if (!o.current && "changedTouches" in g && (N || C) && (o.current = y), !y)
      return !0;
    var T = o.current || y;
    return j0(T, b, g, T === "h" ? N : C);
  }, []), l = E.useCallback(function(g) {
    var b = g;
    if (!(!Mn.length || Mn[Mn.length - 1] !== s)) {
      var w = "deltaY" in b ? cl(b) : lr(b), v = t.current.filter(function(y) {
        return y.name === b.type && (y.target === b.target || b.target === y.shadowParent) && K0(y.delta, w);
      })[0];
      if (v && v.should) {
    ...
    var N = { name: g, delta: b, target: w, should: v, shadowParent: X0(w) };
  ...
  return E.createElement(
    E.Fragment,
    null,
    p ? E.createElement(s, { styles: V0(r) }) : null,
    h ? E.createElement(B0, { noRelative: e.noRelative, gapMode: e.gapMode }) : null
  );
}
function X0(e) {
...
var xu = E.forwardRef(function(e, t) {
  return E.createElement(Ur, pt({}, e, { ref: t, sideCar: Z0 }));
});
xu.classNames = Ur.classNames;
var Js = ["Enter", " "], Q0 = ["ArrowDown", "PageUp", "Home"], Cu = ["ArrowUp", "PageDown", "End"], J0 = [...Q0, ...Cu], eN = {
  ltr: [...Js, "ArrowRight"],
  rtl: [...Js, "ArrowLeft"]
}, tN = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, Io = "Menu", [Eo, nN, oN] = Rc(Io), [gn, Eu] = Zn(Io, [
  oN,
  zr,
  uu
]), Yr = zr(), Tu = uu(), [rN, bn] = gn(Io), [sN, Lo] = gn(Io), Mu = (e) => {
  const { __scopeMenu: t, open: n = !1, children: o, dir: r, onOpenChange: s, modal: a = !0 } = e, i = Yr(t), [l, c] = E.useState(null), u = E.useRef(!1), m = _t(s), f = Ic(r);
  return E.useEffect(() => {
    const h = () => {
...
Mu.displayName = Io;
var iN = "MenuAnchor", Ui = E.forwardRef(
  (e, t) => {
...
Ui.displayName = iN;
var Yi = "MenuPortal", [aN, Su] = gn(Yi, {
  forceMount: void 0
}), Du = (e) => {
  const { __scopeMenu: t, forceMount: n, children: o, container: r } = e, s = bn(Yi, t);
  return /* @__PURE__ */ Y(aN, { scope: t, forceMount: n, children: /* @__PURE__ */ Y(pn, { present: n || s.open, children: /* @__PURE__ */ Y(zi, { asChild: !0, container: r, children: o }) }) });
};
Du.displayName = Yi;
var it = "MenuContent", [lN, ji] = gn(it), Au = E.forwardRef(
  (e, t) => {
    const n = Su(it, e.__scopeMenu), { forceMount: o = n.forceMount, ...r } = e, s = bn(it, e.__scopeMenu), a = Lo(it, e.__scopeMenu);
    return /* @__PURE__ */ Y(Eo.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ Y(pn, { present: o || s.open, children: /* @__PURE__ */ Y(Eo.Slot, { scope: e.__scopeMenu, children: a.modal ? /* @__PURE__ */ Y(cN, { ...r, ref: t }) : /* @__PURE__ */ Y(uN, { ...r, ref: t }) }) }) });
  }
), cN = E.forwardRef(
  (e, t) => {
...
}), dN = /* @__PURE__ */ ko("MenuContent.ScrollLock"), Ki = E.forwardRef(
  (e, t) => {
    const {
      __scopeMenu: n,
      loop: o = !1,
      ...
      ...g
    } = e, b = bn(it, n), w = Lo(it, n), v = Yr(n), N = Tu(n), C = nN(n), [y, x] = E.useState(null), S = E.useRef(null), k = Ye(t, S, b.onContentChange), T = E.useRef(0), M = E.useRef(""), D = E.useRef(0), A = E.useRef(null), I = E.useRef("right"), L = E.useRef(0), $ = p ? xu : E.Fragment, W = p ? { as: dN, allowPinchZoom: !0 } : void 0, q = (P) => {
      const z = M.current + P, X = C().filter((j) => !j.disabled), G = document.activeElement, Z = X.find((j) => j.ref.current === G)?.textValue, te = X.map((j) => j.textValue), _ = xN(te, z, Z), H = X.find((j) => j.textValue === _)?.ref.current;
      (function j(ee) {
    ...
    const R = E.useCallback((P) => I.current === A.current?.side && EN(P, A.current?.area), []);
    return /* @__PURE__ */ Y(
      lN,
      {
        scope: n,
                    ...
                    children: /* @__PURE__ */ Y(
                      au,
                      {
                        ...
                        onKeyDown: fe(g.onKeyDown, (P) => {
                          ...
                          const te = S.current;
                          if (P.target !== te || !J0.includes(P.key)) return;
                          P.preventDefault();
                          const H = C().filter((j) => !j.disabled).map((j) => j.ref.current);
                          Cu.includes(P.key) && H.reverse(), yN(H);
                        }),
...
Au.displayName = it;
var mN = "MenuGroup", Vi = E.forwardRef(
  (e, t) => {
...
Vi.displayName = mN;
var fN = "MenuLabel", Pu = E.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e;
  ...
  (e, t) => {
    const { disabled: n = !1, onSelect: o, ...r } = e, s = E.useRef(null), a = Lo(Cr, e.__scopeMenu), i = ji(Cr, e.__scopeMenu), l = Ye(t, s), c = E.useRef(!1), u = () => {
      ...
      if (!n && m) {
        ...
        m.addEventListener(dl, (h) => o?.(h), { once: !0 }), Pc(m, f), f.defaultPrevented ? c.current = !1 : a.onClose();
      }
    };
    return /* @__PURE__ */ Y(
      Ru,
      {
        ...
        onPointerDown: (m) => {
          e.onPointerDown?.(m), c.current = !0;
        },
        onPointerUp: fe(e.onPointerUp, (m) => {
          c.current || m.currentTarget?.click();
        }),
        onKeyDown: fe(e.onKeyDown, (m) => {
          const f = i.searchRef.current !== "";
          n || f && m.key === " " || Js.includes(m.key) && (m.currentTarget.click(), m.preventDefault());
        })
      }
    );
  }
...
var Ru = E.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, disabled: o = !1, textValue: r, ...s } = e, a = ji(Cr, n), i = Tu(n), l = E.useRef(null), c = Ye(t, l), [u, m] = E.useState(!1), [f, h] = E.useState("");
    return E.useEffect(() => {
      const p = l.current;
      ...
      Eo.ItemSlot,
      {
        ...
        disabled: o,
        textValue: r ?? f,
        children: /* @__PURE__ */ Y(d0, { asChild: !0, ...i, focusable: !o, children: /* @__PURE__ */ Y(
          ze.div,
          {
            role: "menuitem",
...
), hN = "MenuCheckboxItem", Iu = E.forwardRef(
  (e, t) => {
...
Iu.displayName = hN;
var Lu = "MenuRadioGroup", [pN, gN] = gn(
  Lu,
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ Y(pN, { scope: e.__scopeMenu, value: n, onValueChange: s, children: /* @__PURE__ */ Y(Vi, { ...r, ref: t }) });
  }
);
Ou.displayName = Lu;
var _u = "MenuRadioItem", $u = E.forwardRef(
  (e, t) => {
    const { value: n, ...o } = e, r = gN(_u, e.__scopeMenu), s = n === r.value;
...
$u.displayName = _u;
var Gi = "MenuItemIndicator", [Bu, bN] = gn(
  Gi,
  { checked: !1 }
), Hu = E.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, forceMount: o, ...r } = e, s = bN(Gi, n);
    return /* @__PURE__ */ Y(
      pn,
      {
...
Hu.displayName = Gi;
var vN = "MenuSeparator", Wu = E.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e;
    return /* @__PURE__ */ Y(
      ze.div,
...
Wu.displayName = vN;
var wN = "MenuArrow", Fu = E.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e, r = Yr(n);
...
Fu.displayName = wN;
var NN = "MenuSub", [c1, zu] = gn(NN), po = "MenuSubTrigger", Uu = E.forwardRef(
  (e, t) => {
    ...
    return E.useEffect(() => u, [u]), E.useEffect(() => {
      ...
      Ru,
      {
        ...
        onKeyDown: fe(e.onKeyDown, (m) => {
          ...
          e.disabled || f && m.key === " " || eN[o.dir].includes(m.key) && (n.onOpenChange(!0), n.content?.focus(), m.preventDefault());
        })
      }
    ) });
  }
    ...
    return /* @__PURE__ */ Y(Eo.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ Y(pn, { present: o || s.open, children: /* @__PURE__ */ Y(Eo.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ Y(
      Ki,
      {
        ...
        onKeyDown: fe(e.onKeyDown, (u) => {
          const m = u.currentTarget.contains(u.target), f = tN[a.dir].includes(u.key);
          m && f && (s.onOpenChange(!1), i.trigger?.focus(), u.preventDefault());
        })
      }
    ) }) }) });
  }
...
function CN(e, t) {
  ...
  for (let s = 0, a = t.length - 1; s < t.length; a = s++) {
    const i = t[s], l = t[a], c = i.x, u = i.y, m = l.x, f = l.y;
    u > o != f > o && n < (m - c) * (o - u) / (f - u) + c && (r = !r);
  }
  return r;
}
function EN(e, t) {
...
var TN = Mu, MN = Ui, SN = Du, DN = Au, AN = Vi, PN = Pu, RN = jr, IN = Iu, LN = Ou, ON = $u, _N = Hu, $N = Wu, BN = Fu, HN = Uu, WN = ju, Kr = "DropdownMenu", [FN] = Zn(
  Kr,
  [Eu]
), Ge = Eu(), [zN, Vu] = FN(Kr), Gu = (e) => {
  const {
    ...
    onOpenChange: a,
    modal: i = !0
  } = e, l = Ge(t), c = E.useRef(null), [u, m] = Ri({
    prop: r,
    defaultProp: s ?? !1,
    onChange: a,
    caller: Kr
  ...
  return /* @__PURE__ */ Y(
    zN,
    {
      ...
      open: u,
      onOpenChange: m,
      onOpenToggle: E.useCallback(() => m((f) => !f), [m]),
      modal: i,
      children: /* @__PURE__ */ Y(TN, { ...l, open: u, onOpenChange: m, dir: o, modal: i, children: n })
    }
  );
};
Gu.displayName = Kr;
var qu = "DropdownMenuTrigger", Xu = E.forwardRef(
  (e, t) => {
    ...
    return /* @__PURE__ */ Y(MN, { asChild: !0, ...a, children: /* @__PURE__ */ Y(
      ze.button,
      {
        type: "button",
        id: s.triggerId,
...
Xu.displayName = qu;
var UN = "DropdownMenuPortal", Zu = (e) => {
  const { __scopeDropdownMenu: t, ...n } = e, o = Ge(t);
  return /* @__PURE__ */ Y(SN, { ...o, ...n });
};
Zu.displayName = UN;
...
Ju.displayName = Qu;
var YN = "DropdownMenuGroup", jN = E.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Ge(n);
    return /* @__PURE__ */ Y(AN, { ...r, ...o, ref: t });
  }
);
jN.displayName = YN;
var KN = "DropdownMenuLabel", VN = E.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Ge(n);
    return /* @__PURE__ */ Y(PN, { ...r, ...o, ref: t });
  }
);
VN.displayName = KN;
var GN = "DropdownMenuItem", ed = E.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Ge(n);
    return /* @__PURE__ */ Y(RN, { ...r, ...o, ref: t });
  }
);
ed.displayName = GN;
var qN = "DropdownMenuCheckboxItem", XN = E.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ge(n);
  return /* @__PURE__ */ Y(IN, { ...r, ...o, ref: t });
});
XN.displayName = qN;
var ZN = "DropdownMenuRadioGroup", QN = E.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ge(n);
  return /* @__PURE__ */ Y(LN, { ...r, ...o, ref: t });
});
QN.displayName = ZN;
var JN = "DropdownMenuRadioItem", ey = E.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ge(n);
  return /* @__PURE__ */ Y(ON, { ...r, ...o, ref: t });
});
ey.displayName = JN;
var ty = "DropdownMenuItemIndicator", ny = E.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ge(n);
  return /* @__PURE__ */ Y(_N, { ...r, ...o, ref: t });
});
ny.displayName = ty;
var oy = "DropdownMenuSeparator", td = E.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ge(n);
  return /* @__PURE__ */ Y($N, { ...r, ...o, ref: t });
});
td.displayName = oy;
var ry = "DropdownMenuArrow", sy = E.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Ge(n);
    return /* @__PURE__ */ Y(BN, { ...r, ...o, ref: t });
  }
);
sy.displayName = ry;
var iy = "DropdownMenuSubTrigger", ay = E.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ge(n);
  return /* @__PURE__ */ Y(HN, { ...r, ...o, ref: t });
});
ay.displayName = iy;
...
function As({
  ...
  return /* @__PURE__ */ d(uy, { "data-slot": "dropdown-menu", ...e }, void 0, !1, {
...
function Rs({
  ...
  return /* @__PURE__ */ d(my, { children: /* @__PURE__ */ d(
    fy,
    {
...
var Mo = "Tooltip", [yy, Oo] = Vr(Mo), sd = (e) => {
  const {
    ...
    delayDuration: i
  } = e, l = Xi(Mo, e.__scopeTooltip), c = Gr(t), [u, m] = E.useState(null), f = wr(), h = E.useRef(0), p = a ?? l.disableHoverableContent, g = i ?? l.delayDuration, b = E.useRef(!1), [w, v] = Ri({
    prop: o,
    defaultProp: r ?? !1,
    onChange: (S) => {
...
var ti = "TooltipTrigger", id = E.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...o } = e, r = Oo(ti, n), s = Xi(ti, n), a = Gr(n), i = E.useRef(null), l = Ye(t, i, r.onTriggerChange), c = E.useRef(!1), u = E.useRef(!1), m = E.useCallback(() => c.current = !1, []);
    return E.useEffect(() => () => document.removeEventListener("pointerup", m), [m]), /* @__PURE__ */ Y(iu, { asChild: !0, ...a, children: /* @__PURE__ */ Y(
      ze.button,
      {
        ...
        onPointerDown: fe(e.onPointerDown, () => {
          r.open && r.onClose(), c.current = !0, document.addEventListener("pointerup", m, { once: !0 });
        }),
...
var Un = "TooltipContent", ld = E.forwardRef(
  ...
  const n = Oo(Un, e.__scopeTooltip), o = Xi(Un, e.__scopeTooltip), r = E.useRef(null), s = Ye(t, r), [a, i] = E.useState(null), { trigger: l, onClose: c } = n, u = r.current, { onPointerInTransitChange: m } = o, f = E.useCallback(() => {
    i(null), m(!1);
  }, [m]), h = E.useCallback(
    (p, g) => {
...
function ni({
  ...
  return /* @__PURE__ */ d(Wy, { children: /* @__PURE__ */ d(Oy, { "data-slot": "tooltip", ...e }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/tooltip.tsx",
    lineNumber: 24,
    columnNumber: 7
  }, this) }, void 0, !1, {
...
function oi({
  ...
  return /* @__PURE__ */ d(_y, { "data-slot": "tooltip-trigger", ...e }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/tooltip.tsx",
    lineNumber: 32,
    columnNumber: 10
  }, this);
...
function ri({
  ...
  return /* @__PURE__ */ d($y, { children: /* @__PURE__ */ d(
    By,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ d(Hy, { className: "bg-foreground fill-foreground z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/tooltip.tsx",
          lineNumber: 53,
          columnNumber: 9
        }, this)
...
const Le = ({ onClick: e, isActive: t, disabled: n, children: o, tooltip: r }) => {
  ...
  return r ? /* @__PURE__ */ d(ni, { children: [
    /* @__PURE__ */ d(oi, { asChild: !0, children: s }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
      lineNumber: 120,
      columnNumber: 9
    }, void 0),
    /* @__PURE__ */ d(ri, { side: "bottom", className: "text-xs", children: r }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
      lineNumber: 121,
      columnNumber: 9
    }, void 0)
...
}, Sn = () => /* @__PURE__ */ d("div", { className: "w-px h-5 bg-border mx-0.5 shrink-0" }, void 0, !1, {
  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
  lineNumber: 132,
  columnNumber: 3
  ...
  const l = V(null), [c, u] = K(!1), [m, f] = K(void 0), h = Cl({
    editor: t,
    selector: ({ editor: x }) => ({
      canUndo: x.can().undo(),
      canRedo: x.can().redo(),
  ...
  }, [t]), v = V(/* @__PURE__ */ new Map()), N = V(/* @__PURE__ */ new Map()), C = U((x) => {
    const { doc: S, tr: k } = x.state;
    let T = !1;
    const M = /* @__PURE__ */ new Set(["taskList", "bulletList", "orderedList"]), D = x.view.dom.querySelectorAll('ul[data-type="taskList"], ul:not([data-type]), ol');
    ...
    T && (x.view.dispatch(k), requestAnimationFrame(() => {
  ...
  Q(() => {
    ...
    t.state.doc.descendants((k, T) => (k.type.name === "taskItem" && x.set(T, k.attrs.checked === !0), !0)), N.current = x;
  ...
  return /* @__PURE__ */ d("div", { className: `flex items-center gap-0.5 px-2 py-1.5 border-b border-border/30 bg-muted/30 overflow-x-auto scrollbar-hide editor-toolbar ${r}`, children: [
    /* @__PURE__ */ d(
      Le,
      {
        ...
        disabled: !h?.canUndo,
        tooltip: "Undo (Ctrl+Z)",
        children: /* @__PURE__ */ d(Pm, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 384,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        children: /* @__PURE__ */ d(Rm, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 391,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        isActive: h?.isBold,
        tooltip: "Bold (Ctrl+B)",
        children: /* @__PURE__ */ d(li, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 402,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        children: /* @__PURE__ */ d(ci, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 409,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        children: /* @__PURE__ */ d(ui, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 416,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        children: /* @__PURE__ */ d(di, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 423,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        children: /* @__PURE__ */ d(Sl, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 430,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        tooltip: "Highlight",
        children: /* @__PURE__ */ d(Dl, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 437,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        isActive: h?.isLink,
        tooltip: "Link (Ctrl+K)",
        children: /* @__PURE__ */ d(mi, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 444,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(As, { children: [
      /* @__PURE__ */ d(Ps, { asChild: !0, children: /* @__PURE__ */ d(
        "button",
        {
          className: `
            ...
            `,
          children: [
            /* @__PURE__ */ d("span", { className: "min-w-[18px] text-center", children: h?.isH1 ? "H1" : h?.isH2 ? "H2" : h?.isH3 ? "H3" : h?.isH4 ? "H4" : h?.isH5 ? "H5" : "P" }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
              lineNumber: 463,
              columnNumber: 13
            }, this),
            /* @__PURE__ */ d(Qt, { size: 12, strokeWidth: 2.5, className: "flex-shrink-0" }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
              lineNumber: 466,
              columnNumber: 13
            }, this)
      ...
      /* @__PURE__ */ d(Rs, { align: "start", className: "min-w-[130px]", children: [
        /* @__PURE__ */ d(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ d("span", { className: "w-6 text-xs font-semibold text-muted-foreground", children: "P" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 474,
                columnNumber: 13
              }, this),
        ...
        /* @__PURE__ */ d(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ d("span", { className: "w-6 text-xs font-semibold text-muted-foreground", children: "H1" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 481,
                columnNumber: 13
              }, this),
              /* @__PURE__ */ d("span", { className: "font-semibold", children: "Heading 1" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 482,
                columnNumber: 13
              }, this)
        ...
        /* @__PURE__ */ d(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ d("span", { className: "w-6 text-xs font-semibold text-muted-foreground", children: "H2" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 488,
                columnNumber: 13
              }, this),
              /* @__PURE__ */ d("span", { className: "font-semibold", children: "Heading 2" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 489,
                columnNumber: 13
              }, this)
        ...
        /* @__PURE__ */ d(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ d("span", { className: "w-6 text-xs font-semibold text-muted-foreground", children: "H3" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 495,
                columnNumber: 13
              }, this),
              /* @__PURE__ */ d("span", { className: "font-semibold", children: "Heading 3" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 496,
                columnNumber: 13
              }, this)
        ...
        /* @__PURE__ */ d(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ d("span", { className: "w-6 text-xs font-semibold text-muted-foreground", children: "H4" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 502,
                columnNumber: 13
              }, this),
              /* @__PURE__ */ d("span", { className: "font-semibold", children: "Heading 4" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 503,
                columnNumber: 13
              }, this)
        ...
        /* @__PURE__ */ d(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ d("span", { className: "w-6 text-xs font-semibold text-muted-foreground", children: "H5" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 509,
                columnNumber: 13
              }, this),
              /* @__PURE__ */ d("span", { className: "font-semibold", children: "Heading 5" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 510,
                columnNumber: 13
              }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        tooltip: "Bullet List",
        children: /* @__PURE__ */ d(hi, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 523,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        children: /* @__PURE__ */ d(pi, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 530,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        tooltip: "Task List",
        children: /* @__PURE__ */ d(gi, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 537,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        tooltip: "Quote",
        children: /* @__PURE__ */ d(fi, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 544,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        tooltip: "Code Block",
        children: /* @__PURE__ */ d(Ll, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 551,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        tooltip: "Indent (Tab)",
        children: /* @__PURE__ */ d(Im, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 564,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        children: /* @__PURE__ */ d(Lm, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 577,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        children: /* @__PURE__ */ d($s, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 587,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        children: /* @__PURE__ */ d(wi, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 593,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        children: /* @__PURE__ */ d(Ol, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 599,
          columnNumber: 9
        }, this)
    ...
    /* @__PURE__ */ d(As, { children: [
      /* @__PURE__ */ d(Ps, { asChild: !0, children: /* @__PURE__ */ d(
        "button",
        {
          ...
          children: /* @__PURE__ */ d(vr, { size: 16 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 608,
            columnNumber: 13
          }, this)
      ...
      /* @__PURE__ */ d(Rs, { align: "start", children: [
        /* @__PURE__ */ d(Ie, { onClick: () => w("info"), children: [
          /* @__PURE__ */ d(vr, { size: 16, className: "mr-2", style: { color: "#3F78BB" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 613,
            columnNumber: 13
          }, this),
        ...
        /* @__PURE__ */ d(Ie, { onClick: () => w("note"), children: [
          /* @__PURE__ */ d(vi, { size: 16, className: "mr-2", style: { color: "#FF8200" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 616,
            columnNumber: 13
          }, this),
        ...
        /* @__PURE__ */ d(Ie, { onClick: () => w("prompt"), children: [
          /* @__PURE__ */ d(Om, { size: 16, className: "mr-2", style: { color: "#B244B3" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 619,
            columnNumber: 13
          }, this),
        ...
        /* @__PURE__ */ d(Ie, { onClick: () => w("resources"), children: [
          /* @__PURE__ */ d(_m, { size: 16, className: "mr-2", style: { color: "#63B148" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 622,
            columnNumber: 13
          }, this),
        ...
        /* @__PURE__ */ d(Ie, { onClick: () => w("todo"), children: [
          /* @__PURE__ */ d(bi, { size: 16, className: "mr-2", style: { color: "#4479B3" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 625,
            columnNumber: 13
          }, this),
    ...
    t.isActive("table") && /* @__PURE__ */ d(As, { children: [
      /* @__PURE__ */ d(Ps, { asChild: !0, children: /* @__PURE__ */ d(
        Zt,
        {
          variant: "ghost",
          ...
          children: [
            /* @__PURE__ */ d($s, { size: 16 }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
              lineNumber: 639,
              columnNumber: 15
            }, this),
            /* @__PURE__ */ d("span", { className: "text-xs hidden sm:inline", children: "Table" }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
              lineNumber: 640,
              columnNumber: 15
            }, this)
      ...
      /* @__PURE__ */ d(Rs, { align: "start", className: "w-56", children: [
        /* @__PURE__ */ d(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ d(da, { size: 16, className: "mr-2" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 648,
                columnNumber: 15
              }, this),
        ...
        /* @__PURE__ */ d(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ d(Rn, { size: 16, className: "mr-2 text-destructive" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 660,
                columnNumber: 15
              }, this),
        ...
        /* @__PURE__ */ d(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ d(ma, { size: 16, className: "mr-2" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 667,
                columnNumber: 15
              }, this),
        ...
        /* @__PURE__ */ d(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ d(fa, { size: 16, className: "mr-2" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 686,
                columnNumber: 15
              }, this),
        ...
        /* @__PURE__ */ d(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ d(Rn, { size: 16, className: "mr-2" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 701,
                columnNumber: 15
              }, this),
    ...
    /* @__PURE__ */ d(
      Le,
      {
        ...
        children: /* @__PURE__ */ d($m, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 721,
          columnNumber: 9
        }, this)
    ...
    a && /* @__PURE__ */ d(Be, { children: [
      ...
      /* @__PURE__ */ d(ni, { children: [
        /* @__PURE__ */ d(oi, { asChild: !0, children: /* @__PURE__ */ d(
          "button",
          {
            ref: l,
            onClick: () => {
            ...
            className: `
                  ...
                  hover:text-foreground
                `,
            children: /* @__PURE__ */ d(Rr, { size: 16 }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
              lineNumber: 744,
              columnNumber: 17
            }, this)
        ...
        /* @__PURE__ */ d(ri, { side: "bottom", className: "text-xs", children: "AI Writing Assistant" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 747,
          columnNumber: 13
        }, this)
    ...
    /* @__PURE__ */ d("div", { className: "flex-1 min-w-2" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
      lineNumber: 755,
      columnNumber: 7
    }, this),
    n && /* @__PURE__ */ d(ni, { children: [
      /* @__PURE__ */ d(oi, { asChild: !0, children: /* @__PURE__ */ d(
        Zt,
        {
          variant: "ghost",
          ...
          onClick: n,
          children: [
            /* @__PURE__ */ d(Vn, { size: 16 }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
              lineNumber: 767,
              columnNumber: 15
            }, this),
            /* @__PURE__ */ d("span", { className: "text-xs hidden md:inline", children: "Copy MD" }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
              lineNumber: 768,
              columnNumber: 15
            }, this)
      ...
      /* @__PURE__ */ d(ri, { side: "bottom", className: "text-xs", children: "Copy content as Markdown" }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
        lineNumber: 771,
        columnNumber: 11
      }, this)
...
function zy({ editor: e, isOpen: t, onClose: n, focusTrigger: o = 0, initialSearchQuery: r, editorMode: s = "wysiwyg", rawMarkdown: a = "", onRawMarkdownChange: i, onMatchesChange: l }) {
  const c = s === "markdown", [u, m] = K(""), [f, h] = K(""), [p, g] = K(!1), [b, w] = K(!1), [v, N] = K(!1), [C, y] = K(!1), [x, S] = K([]), [k, T] = K(0), [M, D] = K(null), [A, I] = K(!1), L = V(!1), $ = V(null), W = V(null), q = V(!1);
  Q(() => {
    t && r && r.trim() && m(r);
  }, [t, r, o]);
  const R = U(() => {
...
`).length;
  ...
  const P = U(() => {
    x.length !== 0 && (q.current = !0, T((_) => (_ + 1) % x.length));
  }, [x.length]), z = U(() => {
    x.length !== 0 && (q.current = !0, T((_) => (_ - 1 + x.length) % x.length));
  }, [x.length]), X = U(() => {
    ...
    if (c && i) {
      const H = [...x].sort((ee, ge) => ge.from - ee.from);
      let j = a;
      H.forEach((ee) => {
    ...
    const _ = [...x].sort((H, j) => j.from - H.from);
  ...
  return t ? /* @__PURE__ */ d(
    "div",
    {
      ...
      onKeyDown: te,
      children: [
        /* @__PURE__ */ d("div", { className: "find-replace-row", children: [
          /* @__PURE__ */ d("div", { className: "find-replace-input-wrapper", children: [
            /* @__PURE__ */ d(Bm, { size: 14, className: "find-replace-icon" }, void 0, !1, {
            ...
            M && /* @__PURE__ */ d("span", { className: "find-replace-error", title: M, children: "!" }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
              lineNumber: 391,
              columnNumber: 13
            }, this)
          ...
          /* @__PURE__ */ d("span", { className: "find-replace-count", children: x.length > 0 ? `${k + 1} of ${x.length}` : u ? "No results" : "" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
            lineNumber: 396,
            columnNumber: 9
          }, this),
          /* @__PURE__ */ d(
            "button",
            {
              ...
              children: /* @__PURE__ */ d(Hm, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
                lineNumber: 410,
                columnNumber: 11
              }, this)
          ...
          /* @__PURE__ */ d(
            "button",
            {
              ...
              children: /* @__PURE__ */ d(Qt, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
                lineNumber: 418,
                columnNumber: 11
              }, this)
          ...
          /* @__PURE__ */ d(
            "button",
            {
              ...
              children: /* @__PURE__ */ d(Wm, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
                lineNumber: 428,
                columnNumber: 11
              }, this)
          ...
          /* @__PURE__ */ d("div", { className: "find-replace-separator" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
            lineNumber: 432,
            columnNumber: 9
          }, this),
          /* @__PURE__ */ d(
            "button",
            {
              ...
              title: "Match case",
              children: /* @__PURE__ */ d(Fm, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
                lineNumber: 440,
                columnNumber: 11
              }, this)
          ...
          /* @__PURE__ */ d(
            "button",
            {
              ...
              children: /* @__PURE__ */ d(zm, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
                lineNumber: 447,
                columnNumber: 11
              }, this)
          ...
          /* @__PURE__ */ d(
            "button",
            {
              ...
              title: "Use regex",
              children: /* @__PURE__ */ d(Um, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
                lineNumber: 454,
                columnNumber: 11
              }, this)
          ...
          /* @__PURE__ */ d(
            "button",
            {
              ...
              children: /* @__PURE__ */ d(Bs, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
                lineNumber: 463,
                columnNumber: 11
              }, this)
        ...
        C && /* @__PURE__ */ d("div", { className: "find-replace-row", children: [
          /* @__PURE__ */ d("div", { className: "find-replace-input-wrapper", children: [
            /* @__PURE__ */ d(Bs, { size: 14, className: "find-replace-icon" }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
              lineNumber: 480,
              columnNumber: 13
            }, this),
          ...
          /* @__PURE__ */ d(
            "button",
            {
              ...
              title: "Replace all",
              children: [
                /* @__PURE__ */ d(Ym, { size: 14 }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
                  lineNumber: 505,
                  columnNumber: 13
                }, this),
...
const Uy = typeof navigator < "u" && /Mac|iPod|iPhone|iPad/.test(navigator.platform), At = Uy ? "⌘" : "Ctrl", Yy = ({ editor: e }) => {
  const [t, n] = K(!1), [o, r] = K(0), [s, a] = K(0), [i, l] = K(""), [c, u] = K(""), [m, f] = K(!1), [h, p] = K(!1);
  Q(() => {
    if (!e) return;
    const S = () => {
  ...
  return !t || o === 0 ? null : /* @__PURE__ */ d("div", { className: "select-all-action-bar", children: [
    /* @__PURE__ */ d("div", { className: "select-all-action-bar-inner", children: [
      /* @__PURE__ */ d("div", { className: "select-all-action-bar-count", children: [
        /* @__PURE__ */ d("span", { className: "select-all-action-bar-count-number", children: h && s > 0 ? `${o}/${s}` : o }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
          lineNumber: 131,
          columnNumber: 11
        }, void 0),
        /* @__PURE__ */ d("span", { className: "select-all-action-bar-count-label", children: "selected" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
          lineNumber: 134,
          columnNumber: 11
        }, void 0)
      ...
      /* @__PURE__ */ d("div", { className: "select-all-action-bar-preview", children: m ? /* @__PURE__ */ d(Be, { children: [
        /* @__PURE__ */ d(Ir, { size: 12, className: "select-all-action-bar-preview-icon" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
          lineNumber: 141,
          columnNumber: 15
        }, void 0),
        /* @__PURE__ */ d("span", { className: "select-all-action-bar-preview-old", children: i }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
          lineNumber: 142,
          columnNumber: 15
        }, void 0),
        /* @__PURE__ */ d("span", { className: "select-all-action-bar-preview-arrow", children: "→" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
          lineNumber: 143,
          columnNumber: 15
        }, void 0),
        /* @__PURE__ */ d("span", { className: "select-all-action-bar-preview-new", children: c || "∅" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
          lineNumber: 144,
          columnNumber: 15
        }, void 0)
        ...
        lineNumber: 140,
        columnNumber: 13
      }, void 0) : /* @__PURE__ */ d(Be, { children: /* @__PURE__ */ d("span", { className: "select-all-action-bar-preview-term", children: [
        '"',
        i,
        '"'
      ] }, void 0, !0, {
      ...
      /* @__PURE__ */ d("div", { className: "select-all-action-bar-separator" }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
        lineNumber: 154,
        columnNumber: 9
      }, void 0),
      h && o < s && /* @__PURE__ */ d(Be, { children: [
        /* @__PURE__ */ d(
          "button",
          {
            onClick: y,
            ...
            children: /* @__PURE__ */ d(yi, { size: 14 }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
              lineNumber: 164,
              columnNumber: 15
            }, void 0)
      ...
      /* @__PURE__ */ d(
        "button",
        {
          ...
          children: /* @__PURE__ */ d(li, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
            lineNumber: 183,
            columnNumber: 11
          }, void 0)
      ...
      /* @__PURE__ */ d(
        "button",
        {
          ...
          children: /* @__PURE__ */ d(ci, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
            lineNumber: 190,
            columnNumber: 11
          }, void 0)
      ...
      /* @__PURE__ */ d(
        "button",
        {
          ...
          children: /* @__PURE__ */ d(ui, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
            lineNumber: 197,
            columnNumber: 11
          }, void 0)
      ...
      /* @__PURE__ */ d(
        "button",
        {
          ...
          children: /* @__PURE__ */ d(di, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
            lineNumber: 204,
            columnNumber: 11
          }, void 0)
      ...
      /* @__PURE__ */ d(
        "button",
        {
          ...
          children: /* @__PURE__ */ d(Rn, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
            lineNumber: 216,
            columnNumber: 11
          }, void 0)
      ...
      /* @__PURE__ */ d(
        "button",
        {
          ...
          children: /* @__PURE__ */ d(Ot, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
            lineNumber: 225,
            columnNumber: 11
          }, void 0)
    ...
    /* @__PURE__ */ d("div", { className: "select-all-action-bar-hint", children: h && o < s ? /* @__PURE__ */ d(Be, { children: [
      /* @__PURE__ */ d("kbd", { children: [
        At,
        "+D"
      ] }, void 0, !0, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
      ...
      " all · Type to replace · ",
      /* @__PURE__ */ d("kbd", { children: "Esc" }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
        lineNumber: 233,
        columnNumber: 94
      }, void 0),
      ...
      " to exit · ",
      /* @__PURE__ */ d("kbd", { children: "Backspace" }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
        lineNumber: 237,
        columnNumber: 60
      }, void 0),
  ...
  const f = U(() => {
    if (!(!e || !r || e.isDestroyed))
      try {
        ...
        if (v === m.current && w.length === u.current.length) {
          l((N) => ({ ...N, status: "saved" }));
          return;
        }
        if (w.length < 20)
          return;
        l((N) => ({ ...N, status: "saving" })), localStorage.setItem(n, w), localStorage.setItem(n + "-timestamp", (/* @__PURE__ */ new Date()).toISOString()), u.current = w, m.current = v, l((N) => ({
          ...N,
          status: "saved",
...
function qy(e, t = {}) {
  const {
    ...
    const m = u.trim(), f = m.length > 0 ? m.split(/\s+/).filter((v) => v.length > 0).length : 0, h = m.replace(/\s/g, "").length, p = u.length;
    let g = 0, b = 0;
    o && (g = m.length > 0 ? m.split(/\n\s*\n/).filter((v) => v.trim().length > 0).length : 0, b = m.length > 0 ? (m.match(/[.!?]+/g) || []).length : 0);
  ...
  return Q(() => {
    if (!e || !r) return;
    const u = () => {
      i.current && clearTimeout(i.current), a((m) => ({ ...m, isCalculating: !0 })), i.current = setTimeout(() => {
        try {
          const m = e.getText();
          if (m === l.current) {
          ...
          console.warn("useWordCount: Error calculating word count", m), a((f) => ({ ...f, isCalculating: !1 }));
        }
      }, n);
    };
...
function Xy({ status: e, lastSaved: t, className: n = "" }) {
  ...
  return /* @__PURE__ */ d(
    "div",
    {
      ...
      children: [
        e === "idle" && t && /* @__PURE__ */ d(Be, { children: [
          /* @__PURE__ */ d(jm, { className: "w-3.5 h-3.5 text-muted-foreground" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/AutoSaveIndicator.tsx",
            lineNumber: 40,
            columnNumber: 11
          }, this),
          /* @__PURE__ */ d("span", { className: "text-muted-foreground", children: [
            "Saved ",
            o(t)
          ] }, void 0, !0, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/AutoSaveIndicator.tsx",
        ...
        e === "saving" && /* @__PURE__ */ d(Be, { children: [
          /* @__PURE__ */ d(_l, { className: "w-3.5 h-3.5 text-cyan-500 animate-spin" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/AutoSaveIndicator.tsx",
            lineNumber: 47,
            columnNumber: 11
          }, this),
          /* @__PURE__ */ d("span", { className: "text-cyan-500", children: "Saving..." }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/AutoSaveIndicator.tsx",
            lineNumber: 48,
            columnNumber: 11
          }, this)
        ...
        e === "saved" && /* @__PURE__ */ d(Be, { children: [
          /* @__PURE__ */ d(Kn, { className: "w-3.5 h-3.5 text-emerald-500" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/AutoSaveIndicator.tsx",
            lineNumber: 54,
            columnNumber: 11
          }, this),
          /* @__PURE__ */ d("span", { className: "text-emerald-500", children: "Saved" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/AutoSaveIndicator.tsx",
            lineNumber: 55,
            columnNumber: 11
          }, this)
        ...
        e === "error" && /* @__PURE__ */ d(Be, { children: [
          /* @__PURE__ */ d(Km, { className: "w-3.5 h-3.5 text-red-500" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/AutoSaveIndicator.tsx",
            lineNumber: 61,
            columnNumber: 11
          }, this),
          /* @__PURE__ */ d("span", { className: "text-red-500", children: "Save failed" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/AutoSaveIndicator.tsx",
            lineNumber: 62,
            columnNumber: 11
          }, this)
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "flex items-center gap-3 min-w-0", children: [
          /* @__PURE__ */ d(Vm, { className: "w-5 h-5 recovery-banner-icon flex-shrink-0" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/RecoveryBanner.tsx",
            lineNumber: 22,
            columnNumber: 9
          }, this),
          /* @__PURE__ */ d("span", { className: "text-sm recovery-banner-text", children: "We found unsaved content from your last session." }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/RecoveryBanner.tsx",
            lineNumber: 23,
            columnNumber: 9
          }, this)
        ...
        /* @__PURE__ */ d("div", { className: "flex items-center gap-3 flex-shrink-0", children: [
          /* @__PURE__ */ d(
            "button",
            {
              onClick: e,
              ...
              children: [
                /* @__PURE__ */ d(ki, { className: "w-4 h-4" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/RecoveryBanner.tsx",
                  lineNumber: 33,
                  columnNumber: 11
                }, this),
          ...
          /* @__PURE__ */ d(
            "button",
            {
              ...
              children: /* @__PURE__ */ d(Ot, { className: "w-5 h-5" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/RecoveryBanner.tsx",
                lineNumber: 43,
                columnNumber: 11
              }, this)
...
function fd(e) {
  ...
  const t = (r, s) => {
    let a = "", i = r;
    const l = e[i]?.type || "ul", c = l === "task", u = c ? '<ul data-type="taskList">' : `<${l === "ol" ? "ol" : "ul"}>`, m = c ? "</ul>" : `</${l === "ol" ? "ol" : "ul"}>`;
...
`);
  ...
  for (const i of s) {
    ...
    for (let u = 0; u < l.length; u++) {
      const m = l[u].trim();
      u === 0 && m === "" && i.trim().startsWith("|") || u === l.length - 1 && m === "" && i.trim().endsWith("|") || c.push(m);
    }
    if (c.length !== 0) {
      a += "<tr>";
...
`);
  ...
  t = t.replace(/```(ad-\w+)\s*\n([\s\S]*?)```/g, (m, f, h) => {
    ...
    t = t.replace(f, (h, p) => {
      ...
      const b = `MANUSCODEPLACEHOLDER${r.length}END`;
      return r.push(`<div data-callout="" data-type="${m}" class="callout callout-${m}">${g}</div>`), b;
    });
  }), t = t.replace(/```([\w-]*)\n([\s\S]*?)```/g, (m, f, h) => {
...
`).map((m) => {
    const f = m.trim();
    return f ? /^<[a-z]/.test(f) || /^<\//.test(f) || f.startsWith("MANUSTABLEPLACEHOLDER") || f.startsWith("MANUSCODEPLACEHOLDER") ? m : `<p>${f}</p>` : "";
  }).join(`
`), t = t.replace(/<p>\s*<\/p>/g, "");
  for (let m = 0; m < o.length; m++)
    t = t.replace(`MANUSTABLEPLACEHOLDER${m}END`, o[m]);
  for (let m = 0; m < r.length; m++)
    t = t.replace(`MANUSCODEPLACEHOLDER${m}END`, r[m]);
  return t;
}
const ik = dt.create({
...
function Ls(e, t, n) {
  ...
  e.descendants((c, u) => {
    if (c.type.name === "heading" && n.levels.includes(c.attrs.level)) {
      ...
      s.push({
        ...
        level: c.attrs.level,
        id: m,
        isCollapsed: t.collapsedHeadings.has(m),
        nodeSize: c.nodeSize
      });
    }
  });
  ...
  return e.descendants((c, u) => {
    if (c.type.name === "heading" && n.levels.includes(c.attrs.level)) {
      const m = r.get(u) ?? "", f = t.collapsedHeadings.has(m), h = l(u);
      o.push(
      ...
      const p = st.widget(u + c.nodeSize - 1, () => {
        const g = document.querySelector(`button.collapsible-heading-chevron[data-heading-id="${m}"]`);
        if (g) {
      ...
      new je({
        ...
        props: {
          handlePaste(t, n) {
            ...
            let m = s;
            if (!m.startsWith("http://") && !m.startsWith("https://") && (m.startsWith("www."), m = "https://" + m), !u && a.doc.textBetween(l, c))
              return e.chain().focus().extendMarkRange("link").setLink({ href: m }).run(), !0;
            const f = a.schema.marks.link.create({ href: m }), h = a.tr;
            return h.insertText(m, l, c), h.addMark(l, l + m.length, f), t.dispatch(h), !0;
          }
        }
      })
    ];
      ...
      if (u >= t && c <= n) {
        ...
        o.push(
          st.inline(c, u, {
            ...
            style: `background-color: ${m}; color: ${f ? "#1a1a1a" : "#ffffff"}; padding: 1px 4px; border-radius: 3px; font-family: var(--font-mono, monospace); font-size: 0.9em;`
          })
        );
      }
    }
        ...
        state: {
          ...
          apply(e, t) {
            ...
            if (e.mapping.maps.forEach((s, a) => {
              s.forEach((i, l, c, u) => {
                const m = Math.max(0, c - 10), f = Math.min(e.doc.content.size, u + 10);
                o.push({ from: m, to: f });
              });
            }), o.length === 0)
              return n;
      ...
      selectNextOccurrence: () => ({ editor: e, tr: t, dispatch: n }) => {
        ...
        if (!o.isActive) {
          ...
          if (s !== a)
            ...
            const m = r.doc.resolve(s), f = m.parent;
            if (f.isTextblock) {
              const h = f.textContent, p = m.parentOffset;
              let g = p, b = p;
          ...
          return o.isActive = !0, o.ranges = [u], o.searchTerm = i, o.caseSensitive = !1, o.useRegex = !1, o.wholeWord = !1, o.typedBuffer = "", o.isTypingReplace = !1, o.originalTermLength = i.length, o.allMatches = l, o.nextMatchIndex = (c + 1) % l.length, o.isIncremental = !0, o.undoStack = [], o.redoStack = [], n && n(t.setMeta(Fe, { activate: !0 })), setTimeout(() => {
            try {
              const m = e.view.domAtPos(u.from);
...
function dr(e, t, n) {
  ...
  if (c < r.doc.content.size) {
    ...
    const m = o.schema.nodes.paragraph.create();
    r.insert(c, m), r.setSelection(fn.create(r.doc, c + 1));
  }
...
async function Kk(e, t, n) {
  return new Promise((o, r) => {
    ...
    a.onload = (i) => {
      ...
      const m = e.type === "image/png" || e.type === "image/gif", f = m ? "image/png" : "image/jpeg", h = m ? void 0 : n, p = c.toDataURL(f, h), g = Uk(p, e.name);
...
async function gl(e, t, n) {
  ...
  try {
    ...
    if (n.enableCompression && i) {
      ...
      r = m.dataUrl, a = m.file, s = Math.min(m.width, 600);
    } else {
      r = await zk(e), a = e;
      const m = await jk(r);
    ...
    try {
      const m = await n.onImageUpload(a, {
        fileName: e.name,
        mimeType: a.type,
        fileSize: a.size,
        uploadId: o
      ...
      return t.view.state.doc.descendants((h, p) => {
        ...
        if (h.type.name === "resizableImage" && h.attrs.src === m) {
      ...
      return console.warn("Image upload failed, removing placeholder:", m), Vk(t, r, e.name), n.onUploadError?.(`Upload failed: ${m instanceof Error ? m.message : "Unknown error"}`), n.onUploadComplete?.(), !1;
    }
  } catch (r) {
...
function qk({ containerRef: e, enabled: t = !0 }) {
  const [n, o] = K(!1), [r, s] = K(0), a = U((u) => {
    u.preventDefault(), u.stopPropagation(), u.dataTransfer?.types.includes("Files") && (s((m) => m + 1), o(!0));
  }, []), i = U((u) => {
    u.preventDefault(), u.stopPropagation(), s((m) => {
      const f = m - 1;
      return f === 0 && o(!1), f;
    });
  }, []), l = U((u) => {
  ...
  return Q(() => {
  ...
  }, [t, e, a, i, l, c]), n ? /* @__PURE__ */ d("div", { className: "image-drop-zone", children: /* @__PURE__ */ d("div", { className: "image-drop-zone-content", children: [
    /* @__PURE__ */ d("div", { className: "image-drop-zone-icon", children: /* @__PURE__ */ d(Gm, { className: "w-12 h-12" }, void 0, !1, {
    ...
    /* @__PURE__ */ d("div", { className: "image-drop-zone-text", children: [
      /* @__PURE__ */ d("span", { className: "image-drop-zone-title", children: "Drop image here" }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageDropZone.tsx",
        lineNumber: 87,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ d("span", { className: "image-drop-zone-subtitle", children: "Release to insert image into the editor" }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageDropZone.tsx",
        lineNumber: 88,
        columnNumber: 11
      }, this)
...
function Xk({
  ...
  const [a, i] = K(e), [l, c] = K(t), u = V(null), m = V(null);
  Q(() => {
  ...
  const f = () => {
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ d("div", { className: "image-edit-popover-header", children: [
          /* @__PURE__ */ d("span", { className: "image-edit-popover-title", children: "Edit Image" }, void 0, !1, {
          ...
          /* @__PURE__ */ d(
            "button",
            {
              ...
              "aria-label": "Close",
              children: /* @__PURE__ */ d(Ot, { className: "w-4 h-4" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
                lineNumber: 146,
                columnNumber: 11
              }, this)
        ...
        /* @__PURE__ */ d("div", { className: "image-edit-popover-content", children: [
          /* @__PURE__ */ d("div", { className: "image-edit-popover-field", children: [
            /* @__PURE__ */ d("label", { className: "image-edit-popover-label", children: [
              /* @__PURE__ */ d(mi, { className: "w-3.5 h-3.5" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
                lineNumber: 155,
                columnNumber: 13
              }, this),
              /* @__PURE__ */ d("span", { children: "Image URL" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
                lineNumber: 156,
                columnNumber: 13
              }, this)
          ...
          /* @__PURE__ */ d("div", { className: "image-edit-popover-field", children: [
            /* @__PURE__ */ d("label", { className: "image-edit-popover-label", children: [
              /* @__PURE__ */ d(Ir, { className: "w-3.5 h-3.5" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
                lineNumber: 171,
                columnNumber: 13
              }, this),
              /* @__PURE__ */ d("span", { children: "Alt Text" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
                lineNumber: 172,
                columnNumber: 13
              }, this)
        ...
        /* @__PURE__ */ d("div", { className: "image-edit-popover-footer", children: [
          /* @__PURE__ */ d(
            "button",
            {
              onClick: r,
              ...
              title: "Delete image",
              children: /* @__PURE__ */ d(Rn, { className: "w-4 h-4" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
                lineNumber: 191,
                columnNumber: 11
              }, this)
          ...
          /* @__PURE__ */ d("div", { className: "image-edit-popover-actions", children: [
            /* @__PURE__ */ d(
              "button",
              {
                onClick: s,
            ...
            /* @__PURE__ */ d(
              "button",
              {
                ...
                disabled: !a.trim(),
                children: [
                  /* @__PURE__ */ d(Kn, { className: "w-4 h-4" }, void 0, !1, {
                    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
                    lineNumber: 205,
                    columnNumber: 13
                  }, this),
  ...
  return /* @__PURE__ */ d(Ht, { children: g }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
    lineNumber: 213,
    columnNumber: 10
  }, this);
...
`);
  ...
  if (!n || n.length === 0) {
    for (let l = 0; l < s.length; l++) {
      const c = s[l], u = a + c.length, m = t.filter((h) => h.start >= a && h.start < u);
      let f = a;
      for (const h of m)
...
function Zk({
  ...
  const c = V(null), u = V(null), m = V(null), f = V(null), h = 5e3, p = 80, [g, b] = K(() => {
    const k = mr(e);
    return fr(e, k, a, i);
  }), w = V(null), v = Pn(() => {
    if (e.length <= h) {
      const k = mr(e), T = fr(e, k, a, i);
  ...
  Q(() => {
    ...
    return w.current && clearTimeout(w.current), w.current = setTimeout(() => {
      const k = mr(e);
      b(fr(e, k, a, i)), w.current = null;
    }, p), () => {
      w.current && clearTimeout(w.current);
    };
  }, [e, a, i]);
  const N = v ?? g, C = U(() => {
    const k = c.current, T = u.current, M = m.current;
    if (k) {
  ...
  Q(() => {
    ...
    if (f.current && c.current) {
      const { start: k, end: T } = f.current;
      c.current.selectionStart = k, c.current.selectionEnd = T, f.current = null;
    }
  }, [e]);
  const x = U((k) => {
    const T = k.target;
    ...
    const T = k.currentTarget, M = T.selectionStart, D = T.selectionEnd, A = T.value, I = M !== D;
    if (l) {
      ...
      if (k.key === "*" && !k.ctrlKey && !k.metaKey) {
        ...
        if (A[M] === "*") {
          k.preventDefault(), f.current = { start: M + 1, end: M + 1 }, t(A.substring(0, M) + A.substring(M));
          return;
        }
        k.preventDefault();
      ...
      if (k.key === "]" && !k.ctrlKey && !k.metaKey && A[M] === "]") {
        k.preventDefault(), f.current = { start: M + 1, end: M + 1 }, t(A.substring(0, M) + A.substring(M));
        return;
      }
      if (k.key === ")" && !k.ctrlKey && !k.metaKey && A[M] === ")") {
...
`) + W;
  ...
  return /* @__PURE__ */ d("div", { ref: m, className: `syntax-highlighted-editor ${s}`, children: [
    /* @__PURE__ */ d(
      "div",
      {
        ref: u,
...
const Jk = jn(function({
  ...
  const [r, s] = K(!1), [a, i] = K({
    ...
    domNodes: 0,
    longFrames: 0
  }), l = V([]), c = V(performance.now()), u = V(0), m = V(0), f = V(0), h = V(0), [p, g] = K(new Array(60).fill(0)), [b, w] = K(new Array(60).fill(0));
  Q(() => {
    if (!t || !o) return;
    const S = () => {
    ...
    if (!t) return;
    let S = 0, k = performance.now(), T = 0;
    const M = (D) => {
      const A = D - c.current;
      if (c.current = D, l.current.push({ time: D, duration: A }), l.current.length > 120 && (l.current = l.current.slice(-120)), A > 16.67 && m.current++, S++, D - k >= 1e3) {
        T = S, S = 0, k = D;
        ...
        }), g((G) => [...G.slice(1), T]), w((G) => [...G.slice(1), L]), m.current = 0;
      }
  ...
  if (!t) return null;
  const C = (S) => S >= 55 ? "#4ade80" : S >= 30 ? "#fbbf24" : "#f87171", y = (S) => S <= 16.67 ? "#4ade80" : S <= 33.33 ? "#fbbf24" : "#f87171", x = (S, k, T) => {
    const A = S.map((I, L) => {
      const $ = L / (S.length - 1) * 120, W = 24 - Math.min(I, k) / k * 24;
      return `${$},${W}`;
    }).join(" ");
    return /* @__PURE__ */ d("svg", { width: 120, height: 24, className: "perf-sparkline", children: /* @__PURE__ */ d(
      "polyline",
      {
        points: A,
        fill: "none",
  ...
  return /* @__PURE__ */ d("div", { className: "perf-profiler-overlay", children: [
    /* @__PURE__ */ d("div", { className: "perf-profiler-header", children: [
      /* @__PURE__ */ d("div", { className: "perf-profiler-title", children: [
        /* @__PURE__ */ d(qm, { size: 14 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 241,
          columnNumber: 11
        }, this),
        /* @__PURE__ */ d("span", { children: "Performance" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 242,
          columnNumber: 11
        }, this)
      ...
      /* @__PURE__ */ d("div", { className: "perf-profiler-actions", children: [
        /* @__PURE__ */ d("button", { onClick: N, title: r ? "Expand" : "Minimize", children: r ? /* @__PURE__ */ d($l, { size: 12 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 246,
          columnNumber: 28
        }, this) : /* @__PURE__ */ d(Bl, { size: 12 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 246,
          columnNumber: 54
        }, this) }, void 0, !1, {
        ...
        /* @__PURE__ */ d("button", { onClick: v, title: "Close profiler", children: /* @__PURE__ */ d(Ot, { size: 12 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 249,
          columnNumber: 13
        }, this) }, void 0, !1, {
    ...
    !r && /* @__PURE__ */ d("div", { className: "perf-profiler-body", children: [
      /* @__PURE__ */ d("div", { className: "perf-section", children: [
        /* @__PURE__ */ d("div", { className: "perf-row", children: [
          /* @__PURE__ */ d("span", { className: "perf-label", children: "FPS" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
            lineNumber: 259,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ d("span", { className: "perf-value", style: { color: C(a.fps) }, children: a.fps }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
            lineNumber: 260,
            columnNumber: 15
          }, this)
      ...
      /* @__PURE__ */ d("div", { className: "perf-section", children: [
        /* @__PURE__ */ d("div", { className: "perf-row", children: [
          /* @__PURE__ */ d("span", { className: "perf-label", children: "Frame Time" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
            lineNumber: 270,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ d("span", { className: "perf-value", style: { color: y(a.frameTime) }, children: [
            a.frameTime,
            "ms"
          ] }, void 0, !0, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
        ...
        /* @__PURE__ */ d("div", { className: "perf-row perf-row-sub", children: [
          /* @__PURE__ */ d("span", { className: "perf-label-sub", children: "Max" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
            lineNumber: 276,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ d("span", { className: "perf-value-sub", style: { color: y(a.frameTimeMax) }, children: [
            a.frameTimeMax,
            "ms"
          ] }, void 0, !0, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
        ...
        /* @__PURE__ */ d("div", { className: "perf-row perf-row-sub", children: [
          /* @__PURE__ */ d("span", { className: "perf-label-sub", children: [
            "Jank (",
            ">",
            " 16.7ms)"
          ] }, void 0, !0, {
          ...
          /* @__PURE__ */ d("span", { className: "perf-value-sub", style: { color: a.longFrames > 3 ? "#f87171" : "#4ade80" }, children: [
            a.longFrames,
            "/s"
          ] }, void 0, !0, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
      ...
      /* @__PURE__ */ d("div", { className: "perf-section", children: [
        /* @__PURE__ */ d("div", { className: "perf-row", children: [
          /* @__PURE__ */ d("span", { className: "perf-label", children: "Renders/s" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
            lineNumber: 293,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ d("span", { className: "perf-value", children: a.renderCount }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
            lineNumber: 294,
            columnNumber: 15
          }, this)
        ...
        /* @__PURE__ */ d("div", { className: "perf-row", children: [
          /* @__PURE__ */ d("span", { className: "perf-label", children: "Transactions/s" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
            lineNumber: 297,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ d("span", { className: "perf-value", children: a.transactionCount }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
            lineNumber: 298,
            columnNumber: 15
          }, this)
        ...
        /* @__PURE__ */ d("div", { className: "perf-row perf-row-sub", children: [
          /* @__PURE__ */ d("span", { className: "perf-label-sub", children: "Last TX time" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
            lineNumber: 301,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ d("span", { className: "perf-value-sub", children: [
      ...
      /* @__PURE__ */ d("div", { className: "perf-section", children: [
        /* @__PURE__ */ d("div", { className: "perf-row", children: [
          /* @__PURE__ */ d("span", { className: "perf-label", children: "DOM Nodes" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
            lineNumber: 309,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ d("span", { className: "perf-value", children: a.domNodes.toLocaleString() }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
            lineNumber: 310,
            columnNumber: 15
          }, this)
        ...
        a.memoryTotal > 0 && /* @__PURE__ */ d("div", { className: "perf-row", children: [
          /* @__PURE__ */ d("span", { className: "perf-label", children: "Memory" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
            lineNumber: 314,
            columnNumber: 17
          }, this),
          /* @__PURE__ */ d("span", { className: "perf-value", children: [
            a.memoryUsed,
            "MB / ",
            a.memoryTotal,
            "MB"
...
`);
  ...
  render() {
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ d("div", { className: de("flex-1 flex items-center justify-center p-6", this.props.className), children: /* @__PURE__ */ d("div", { className: "flex flex-col items-center max-w-md w-full text-center gap-4", children: [
        /* @__PURE__ */ d("div", { className: "w-12 h-12 rounded-full bg-destructive/10 flex items-center justify-center", children: /* @__PURE__ */ d(Xm, { className: "w-6 h-6 text-destructive" }, void 0, !1, {
        ...
        /* @__PURE__ */ d("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ d("h3", { className: "text-base font-semibold text-foreground", children: "Editor encountered an error" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
            lineNumber: 145,
            columnNumber: 15
          }, this),
          /* @__PURE__ */ d("p", { className: "text-sm text-muted-foreground leading-relaxed", children: s ? "The editor keeps crashing. The content may be malformed — try clearing it to recover." : "Something went wrong while rendering the editor. Your content is safe — try one of the recovery options below." }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
            lineNumber: 148,
            columnNumber: 15
          }, this)
        ...
        /* @__PURE__ */ d("div", { className: "flex flex-col gap-2 w-full max-w-xs", children: [
          /* @__PURE__ */ d(
            Zt,
            {
              variant: "default",
          ...
          s && this.props.onClearContent && /* @__PURE__ */ d(
            Zt,
            {
              variant: "ghost",
              size: "sm",
              ...
              children: [
                /* @__PURE__ */ d(Rn, { className: "w-4 h-4" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                  lineNumber: 176,
                  columnNumber: 19
                }, this),
        ...
        t && /* @__PURE__ */ d("div", { className: "w-full max-w-xs", children: [
          /* @__PURE__ */ d(
            "button",
            {
              ...
              children: [
                n ? /* @__PURE__ */ d(Qt, { className: "w-3 h-3" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                  lineNumber: 193,
                  columnNumber: 21
                }, this) : /* @__PURE__ */ d(Rl, { className: "w-3 h-3" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                  lineNumber: 195,
                  columnNumber: 21
                }, this),
          ...
          n && /* @__PURE__ */ d("div", { className: "mt-2 p-3 rounded-md bg-muted/50 border border-border text-left overflow-auto max-h-40", children: [
            /* @__PURE__ */ d("div", { className: "flex items-center justify-between mb-2", children: [
              /* @__PURE__ */ d("span", { className: "text-[10px] uppercase tracking-wider text-muted-foreground/60 font-medium", children: "Error" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                lineNumber: 203,
                columnNumber: 23
              }, this),
              /* @__PURE__ */ d(
                "button",
                {
                  ...
                  children: r ? /* @__PURE__ */ d(Be, { children: [
                    /* @__PURE__ */ d(Zm, { className: "w-3 h-3 text-green-500" }, void 0, !1, {
                      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                      lineNumber: 210,
                      columnNumber: 29
                    }, this),
                    /* @__PURE__ */ d("span", { className: "text-green-500", children: "Copied" }, void 0, !1, {
                      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                      lineNumber: 211,
                      columnNumber: 29
                    }, this)
                    ...
                    lineNumber: 209,
                    columnNumber: 27
                  }, this) : /* @__PURE__ */ d(Be, { children: [
                    /* @__PURE__ */ d(Vn, { className: "w-3 h-3" }, void 0, !1, {
                      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                      lineNumber: 215,
                      columnNumber: 29
                    }, this),
                    /* @__PURE__ */ d("span", { children: "Copy" }, void 0, !1, {
                      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                      lineNumber: 216,
                      columnNumber: 29
                    }, this)
            ...
            /* @__PURE__ */ d("p", { className: "text-xs font-mono text-muted-foreground break-all", children: t.message }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
              lineNumber: 221,
              columnNumber: 21
            }, this),
            t.stack && /* @__PURE__ */ d("pre", { className: "text-[10px] font-mono text-muted-foreground/70 mt-2 whitespace-pre-wrap break-all", children: t.stack.split(`
`).slice(1, 6).join(`
`) }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
              lineNumber: 225,
...
function ox(e) {
  const [t, n] = gm(nx, { status: "idle" }), o = V(null), r = U(async (i, l, c, u, m) => {
    if (e) {
      n({
...
function sx({ actions: e, scope: t, onAction: n, onClose: o, position: r }) {
  const [s, a] = K(""), [i, l] = K(!1), c = V(null), u = V(null), m = e.filter((b) => b.scope === t || b.scope === "both");
  Q(() => {
    const b = (v) => {
  ...
  const h = U(() => {
    const w = m.length * 40 + (i ? 56 : 0) + 16, v = window.innerWidth, N = window.innerHeight;
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ d(
        ...
        `,
          children: [
            /* @__PURE__ */ d("div", { className: "px-2 py-1.5", children: /* @__PURE__ */ d("div", { className: "flex items-center gap-2 bg-secondary/50 rounded-md px-2.5 py-1.5 border border-border/50", children: [
              /* @__PURE__ */ d(Hl, { size: 14, className: "text-muted-foreground shrink-0" }, void 0, !1, {
            ...
            /* @__PURE__ */ d("div", { className: "h-px bg-border mx-2 my-0.5" }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIDropdownMenu.tsx",
              lineNumber: 167,
              columnNumber: 9
            }, this),
            m.filter((b) => !b.showCustomPrompt).map((b) => {
              ...
              return /* @__PURE__ */ d(
                ...
                `,
                  ...
                  children: [
                    w && /* @__PURE__ */ d(w, { size: 15, className: "text-muted-foreground shrink-0" }, void 0, !1, {
                      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIDropdownMenu.tsx",
                      lineNumber: 187,
                      columnNumber: 35
                    }, this),
                    /* @__PURE__ */ d("span", { children: b.label }, void 0, !1, {
                      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIDropdownMenu.tsx",
                      lineNumber: 188,
                      columnNumber: 17
                    }, this)
  ...
  return /* @__PURE__ */ d(Ht, { onMouseDown: (b) => b.preventDefault(), children: g }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIDropdownMenu.tsx",
    lineNumber: 197,
    columnNumber: 5
  }, this);
...
function ix({
  ...
  const a = V(null), i = V(null), [l, c] = K(!1), [u, m] = K(0);
  Q(() => {
    if (a.current) {
      const y = new ResizeObserver((x) => {
        for (const S of x)
          m(S.contentRect.height);
      });
  ...
  const N = f.placedAbove ? "animate-in fade-in-0 slide-in-from-bottom-2 duration-150" : "animate-in fade-in-0 slide-in-from-top-2 duration-150", C = /* @__PURE__ */ d(
    "div",
    {
      ref: a,
      ...
      children: /* @__PURE__ */ d(
        ...
        `,
          children: [
            /* @__PURE__ */ d("div", { className: "flex items-center justify-between px-3 py-2 border-b border-border bg-secondary/30", children: [
              /* @__PURE__ */ d("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
                g && /* @__PURE__ */ d(_l, { size: 12, className: "animate-spin" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
                  lineNumber: 173,
                  columnNumber: 29
                }, this),
                /* @__PURE__ */ d("span", { className: "font-medium", children: w ? "Error" : p }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
                  lineNumber: 174,
                  columnNumber: 13
                }, this),
                g && /* @__PURE__ */ d("span", { className: "opacity-60", children: "Generating…" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
                  lineNumber: 177,
                  columnNumber: 29
                }, this)
              ...
              /* @__PURE__ */ d(
                "button",
                {
                  ...
                  title: "Discard",
                  children: /* @__PURE__ */ d(Ot, { size: 14, className: "text-muted-foreground" }, void 0, !1, {
                    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
                    lineNumber: 184,
                    columnNumber: 13
                  }, this)
            ...
            /* @__PURE__ */ d(
              "div",
              {
                ...
                children: w ? /* @__PURE__ */ d("div", { className: "text-destructive", children: e.message }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
                  lineNumber: 194,
                  columnNumber: 13
                }, this) : /* @__PURE__ */ d("div", { className: "whitespace-pre-wrap", children: [
                  h,
                  g && /* @__PURE__ */ d("span", { className: "inline-block w-0.5 h-4 bg-primary animate-pulse ml-0.5 align-text-bottom" }, void 0, !1, {
                    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
                    lineNumber: 201,
                    columnNumber: 17
                  }, this)
            ...
            /* @__PURE__ */ d("div", { className: "flex items-center gap-1.5 px-3 py-2 border-t border-border bg-secondary/20", children: [
              (b || w) && /* @__PURE__ */ d(Be, { children: [
                b && /* @__PURE__ */ d(Be, { children: [
                  /* @__PURE__ */ d(
                    Dn,
                    {
                      icon: Bs,
                ...
                /* @__PURE__ */ d("div", { className: "flex-1" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
                  lineNumber: 236,
                  columnNumber: 15
                }, this),
  ...
  return /* @__PURE__ */ d(Ht, { onMouseDown: (y) => y.preventDefault(), children: C }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
    lineNumber: 260,
    columnNumber: 5
  }, this);
...
function Dn({
  ...
  return /* @__PURE__ */ d(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ d(e, { size: 12 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
          lineNumber: 291,
          columnNumber: 7
        }, this),
        /* @__PURE__ */ d("span", { children: t }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
          lineNumber: 292,
          columnNumber: 7
        }, this)
...
const kl = jn(function({
  ...
  const [v, N] = K([]), [C, y] = K(null), [x, S] = K(n), [k, T] = K(/* @__PURE__ */ new Set()), [M, D] = K(() => {
    if (m) {
  ...
  const P = U((H) => {
    ...
    if (g)
      return g(H, j, () => P(H));
    const ge = (H.level - s) * 14, be = c && H.children && H.children.length > 0, Ae = k.has(H.id);
    return /* @__PURE__ */ d(
      "div",
      {
            ...
            children: [
              be && /* @__PURE__ */ d(
                "span",
                {
                  ...
                  children: /* @__PURE__ */ d("svg", { width: "10", height: "10", viewBox: "0 0 10 10", fill: "none", children: Ae ? /* @__PURE__ */ d("path", { d: "M3.5 2L7 5L3.5 8", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }, void 0, !1, {
                    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
                    lineNumber: 340,
                    columnNumber: 21
                  }, this) : /* @__PURE__ */ d("path", { d: "M2 3.5L5 7L8 3.5", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" }, void 0, !1, {
                    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
                    lineNumber: 341,
                    columnNumber: 21
                  }, this) }, void 0, !1, {
              ...
              i && /* @__PURE__ */ d("span", { className: "toc-level-indicator", children: [
                "H",
                H.level
              ] }, void 0, !0, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
              ...
              /* @__PURE__ */ d("span", { className: "toc-item-text", children: H.text }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
                lineNumber: 349,
                columnNumber: 11
              }, this)
  ...
  }, [g, P, c, s, i, k, X]), Z = U((H, j = 0) => H.map((ee) => {
    const ge = C === ee.id, be = k.has(ee.id), Ae = ee.children && ee.children.length > 0;
    return /* @__PURE__ */ d("div", { children: [
      G(ee, ge, j),
      Ae && !be && /* @__PURE__ */ d("div", { className: "toc-children", children: Z(ee.children, j + 1) }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
        lineNumber: 364,
        columnNumber: 13
      }, this)
  ...
  return /* @__PURE__ */ d(Be, { children: [
    b && /* @__PURE__ */ d(
      "button",
      {
        ...
        children: x ? /* @__PURE__ */ d(ef, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
          lineNumber: 393,
          columnNumber: 24
        }, this) : /* @__PURE__ */ d(tf, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
          lineNumber: 393,
          columnNumber: 56
        }, this)
    ...
    /* @__PURE__ */ d(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ d("div", { className: "toc-inner", children: [
            r && /* @__PURE__ */ d("div", { className: "toc-header", children: /* @__PURE__ */ d("span", { className: "toc-title", children: r }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
              lineNumber: 415,
              columnNumber: 15
            }, this) }, void 0, !1, {
            ...
            /* @__PURE__ */ d("div", { className: "toc-content toc-content-with-toggle", children: v.length === 0 ? /* @__PURE__ */ d("div", { className: "toc-empty", children: [
              /* @__PURE__ */ d("p", { children: "No headings yet" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
                lineNumber: 423,
                columnNumber: 17
              }, this),
              /* @__PURE__ */ d("p", { className: "toc-empty-hint", children: "Add headings to see the outline." }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
                lineNumber: 424,
                columnNumber: 17
              }, this)
              ...
              lineNumber: 422,
              columnNumber: 15
            }, this) : /* @__PURE__ */ d("div", { className: "toc-list", children: c ? Z(_) : te() }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
              lineNumber: 427,
              columnNumber: 15
            }, this) }, void 0, !1, {
...
` : ""
  ...
  n.use(t), n.addRule("highlight", {
    ...
    filter: "img",
    replacement: (l, c) => {
      const u = c, m = u.getAttribute("src") || "", h = (u.getAttribute("alt") || "").replace(/\s*\|\s*(?:left|center|right)?\s*(?:\|\s*\d+)?\s*$/, "").trim(), p = u.getAttribute("width"), g = p ? parseInt(p, 10) : null, b = u.getAttribute("data-align") || "left", w = [h], v = b !== "left", N = g && g > 0;
      return (v || N) && w.push(v ? b : "left"), N && w.push(String(g)), `![${w.join(" | ")}](${m})`;
    }
  }), n.addRule("taskListItem", {
    filter: (l) => l.nodeName === "LI" && l.getAttribute("data-type") === "taskItem",
    replacement: (l, c) => {
      const u = c, m = u.querySelector('input[type="checkbox"]'), f = m?.hasAttribute("checked") || m?.checked || u.getAttribute("data-checked") === "true";
      return l = l.replace(/^\n+/, "").replace(/\n+$/, "").replace(/\n\n+/g, `
...
`
  ...
  function o(l) {
    const c = l.getAttribute("src") || "", m = (l.getAttribute("alt") || "").replace(/\s*\|\s*(?:left|center|right)?\s*(?:\|\s*\d+)?\s*$/, "").trim(), f = l.getAttribute("width"), h = f ? parseInt(f, 10) : null, p = l.getAttribute("data-align") || "left", g = [m], b = p !== "left", w = h && h > 0;
  ...
  function a(l, c, u = 0) {
    ...
    Array.from(l.childNodes).filter(
      ...
      b ? c.push(`${m}- [${w ? "x" : " "}] ${v}`) : f === "OL" ? c.push(`${m}${g + 1}. ${v}`) : c.push(`${m}- ${v}`);
  ...
  return n.addRule("table", {
    ...
    replacement: function(l, c) {
      const u = c, m = Array.from(u.querySelectorAll("tr"));
...
`;
    ...
    replacement: (l, c) => {
      const u = c.getAttribute("data-type") || "info", m = l.trim().replace(/\n{3,}/g, `
      ...
      if (h) {
        ...
        if (w.forEach((C) => {
          if (C.nodeType === Node.ELEMENT_NODE) {
            const y = C;
            y.tagName === "UL" || y.tagName === "OL" || y.tagName === "P" ? N.push(C) : v.push(C);
          } else
            v.push(C);
...
const px = () => {
  ...
  const [ie] = K(() => px()), [we, Ve] = K(k), [ve, ro] = K(""), qe = V(k), kt = V(""), xt = V(null), [so, Qi] = K(0), Yo = !!(mt && mt.length > 0 && yn), { state: Ze, executeAction: jo, abort: kd, reset: Ft } = ox(yn), [ts, ns] = K(null), [xd, Cd] = K({ selectionTop: 0, selectionBottom: 0, selectionCenterX: 0 }), Ed = V(yn);
  Ed.current = yn;
  const Ji = V(ce);
  Ji.current = ce;
  const [Td, Md] = K([]), [Sd, Dd] = K(0), Ad = U((B, F) => {
    Md(B), Dd(F);
  }, []), os = V(v), rs = V(N), ss = V(C), is = V(y), as = V(x), ea = V(q), ls = V(R), cs = V(P);
  os.current = v, rs.current = N, ss.current = C, is.current = y, as.current = x, ea.current = q, ls.current = R, cs.current = P;
  ...
  const ra = V(!1);
  Q(() => {
    if (!ra.current && k === "markdown" && O && !O.isDestroyed && Ut) {
    ...
    if (O) {
      if (B === "markdown" && qe.current === "wysiwyg") {
        ...
        pe.forEach((ae) => {
          ...
          const Me = Re ? ` width="${Re}" style="width: ${Re}px"` : "", jt = ` data-align="${We}"`;
          return `<img src="${Ne.trim()}" alt="${Te}"${jt}${Me} />`;
        ...
        let Pe = F.parse(me, { async: !1 });
        Pe = hx(Pe), Pe = Pe.replace(/(<table>[\s\S]*<\/table>)\s*<!--\s*header-column\s*-->/gi, (ae, se) => se.replace(/(<tbody>[\s\S]*?<\/tbody>)/gi, (Ne) => Ne.replace(/<tr>([\s\S]*?)<\/tr>/gi, (ue, Te) => `<tr>${Te.replace(/^([\s\S]*?)<td>([\s\S]*?)<\/td>/i, "$1<th>$2</th>")}</tr>`)));
        const le = (ae) => {
          let se = ae;
          ...
          const Me = Te.match(/^(\d+)\.\s+(.+)$/);
          return Me ? { type: "ol", depth: ue, text: Me[2].trim(), index: parseInt(Me[1], 10) } : null;
        }, Go = (ae) => {
          if (ae.length === 0) return "";
          const se = (Te, We) => {
            let Re = "", Me = Te;
            const jt = ae[Me]?.type || "ul", Mt = jt === "task", Kt = Mt ? '<ul data-type="taskList">' : `<${jt === "ol" ? "ol" : "ul"}>`, lo = Mt ? "</ul>" : `</${jt === "ol" ? "ol" : "ul"}>`;
            for (Re += Kt; Me < ae.length && ae[Me].depth >= We; ) {
              const St = ae[Me];
              if (St.depth === We) {
                if (Mt ? Re += `<li data-type="taskItem" data-checked="${St.checked || !1}"><p>${le(St.text)}</p>` : Re += `<li><p>${le(St.text)}</p>`, Me + 1 < ae.length && ae[Me + 1].depth > We) {
                  const sn = se(Me + 1, ae[Me + 1].depth);
                  Re += sn.html, Me = sn.nextIdx;
                } else
                  Me++;
                Re += "</li>";
              } else
            ...
            return Re += lo, { html: Re, nextIdx: Me };
        ...
        Pe = Pe.replace(
          ...
          (ae, se, Ne, ue) => {
            ...
            let Me = Ne.trim();
            Me = Me.replace(/^<p>([\s\S]*)<\/p>$/i, "$1").trim();
            const jt = Me.split(/<br\s*\/?>/i).filter((St) => St.trim());
            if (jt.length <= 1 && !Re)
              return Te ? `${se}${Yt(Me)}${ue}` : ae;
            const Mt = [];
            let Kt = [];
            const lo = () => {
          ...
          O.isDestroyed || O.commands.setContent(Pe);
        });
      }
      ...
      if (!(!(F.metaKey || F.ctrlKey) && pe !== " ")) {
        ...
        if (!ie && (F.metaKey || F.ctrlKey) && F.key === "f") {
          if (F.preventDefault(), O) {
            const { state: ke } = O, { from: Pe, to: le } = ke.selection;
            if (Pe !== le) {
              const Ee = ke.doc.textBetween(Pe, le, " ");
              Ee.trim() && Bd(Ee.trim());
            }
          }
          zt(!0), ms((ke) => ke + 1);
        ...
        if (F.key === " ")
          try {
            const { state: ke } = O, { selection: Pe } = ke, { $from: le } = Pe, Ee = le.nodeBefore?.textContent || "";
            if (Ee === "#####") {
  ...
  const ia = U((B, F) => {
    ...
    if (F) {
      ...
      const { from: me, to: ke } = O.state.selection, Pe = O.view.coordsAtPos(me), le = O.view.coordsAtPos(ke);
      pe = { top: le.bottom + 8, left: (Pe.left + le.left) / 2 };
    }
    ...
    if (!pe) return;
    const { from: me, to: ke } = O.state.selection, Pe = me !== ke ? O.state.doc.textBetween(me, ke, `
`) : "", le = pe.scope === "document" || !Pe ? O.getText() : Pe, Ee = O.view.coordsAtPos(me), Yt = O.view.coordsAtPos(ke);
    Cd({
      selectionTop: Ee.top,
...
` + F).run(), Ft();
  ...
  if (!O)
    return /* @__PURE__ */ d("div", { className: `markdown-editor-container ${l}`, "data-theme": m, children: /* @__PURE__ */ d("div", { className: "editor-loading", style: { padding: "1.5rem", display: "flex", flexDirection: "column", gap: "0.75rem" }, children: [
      /* @__PURE__ */ d("div", { style: { height: "1rem", width: "100%", borderRadius: "0.25rem", background: "var(--color-muted, #e5e7eb)", opacity: 0.5, animation: "pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite" } }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
        lineNumber: 2047,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ d("div", { style: { height: "1rem", width: "83%", borderRadius: "0.25rem", background: "var(--color-muted, #e5e7eb)", opacity: 0.5, animation: "pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite" } }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
        lineNumber: 2048,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ d("div", { style: { height: "1rem", width: "66%", borderRadius: "0.25rem", background: "var(--color-muted, #e5e7eb)", opacity: 0.5, animation: "pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite" } }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
        lineNumber: 2049,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ d("div", { style: { height: "0.75rem" } }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
        lineNumber: 2050,
        columnNumber: 11
      }, this),
      ...
      /* @__PURE__ */ d("div", { style: { height: "1rem", width: "75%", borderRadius: "0.25rem", background: "var(--color-muted, #e5e7eb)", opacity: 0.5, animation: "pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite" } }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
        lineNumber: 2052,
        columnNumber: 11
      }, this)
  ...
  const aa = /* @__PURE__ */ d(
    ...
    this
  ), la = /* @__PURE__ */ d("div", { className: "editor-footer", children: [
    f && /* @__PURE__ */ d(
      Xy,
      {
        status: Tt.status,
    ...
    /* @__PURE__ */ d("div", { className: "word-count", children: /* @__PURE__ */ d("span", { children: [
      rn.words,
      " words"
    ] }, void 0, !0, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
  ...
  return /* @__PURE__ */ d("div", { className: `markdown-editor-container ${l}`, "data-theme": m, children: [
    f && g && Tt.hasRecoverableContent && /* @__PURE__ */ d(
      Zy,
      {
        onRecover: () => {
          Tt.recover();
    ...
    c && /* @__PURE__ */ d("div", { className: "flex items-center bg-card/50 editor-toolbar-wrapper", children: [
      Z ? Z(O, aa) : aa,
      S && /* @__PURE__ */ d("div", { className: "editor-mode-toggle mr-2 sm:mr-3", children: [
        /* @__PURE__ */ d(
          "button",
          {
            onClick: () => ft("wysiwyg"),
            ...
            title: "Visual Editor",
            children: /* @__PURE__ */ d(nf, {}, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
              lineNumber: 2119,
              columnNumber: 17
            }, this)
        ...
        /* @__PURE__ */ d(
          "button",
          {
            ...
            title: "Raw Markdown",
            children: /* @__PURE__ */ d(Ni, {}, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
              lineNumber: 2126,
              columnNumber: 17
            }, this)
    ...
    /* @__PURE__ */ d(jy, { editor: O }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
      lineNumber: 2149,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ d("div", { className: `editor-main-area ${Ae ? "editor-with-toc" : ""}`, children: [
      Ae && vn === "left" && /* @__PURE__ */ d(
        kl,
        {
          editor: O,
          visible: He,
      ...
      /* @__PURE__ */ d(
        ex,
        {
          ...
          onError: es,
          children: [
            /* @__PURE__ */ d("div", { className: "editor-content-wrapper", ref: xt, style: Ud, children: we === "wysiwyg" ? /* @__PURE__ */ d(Be, { children: [
              /* @__PURE__ */ d(Kd, { editor: O, className: "editor-content" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
                lineNumber: 2192,
                columnNumber: 13
              }, this),
              !_.images && !_.dragAndDrop && /* @__PURE__ */ d(qk, { containerRef: xt, enabled: a }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
                lineNumber: 2196,
                columnNumber: 15
              }, this),
              !ie && b && /* @__PURE__ */ d(Yf, { editor: O, suppressWhenLinkPopoverOpen: oa, aiEnabled: Yo || !!ce, onAISparklesClick: (B) => ia("selection", B) }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
                lineNumber: 2202,
                columnNumber: 50
              }, this),
              ...
              !_.slashCommands && /* @__PURE__ */ d(tv, { editor: O, disabledFeatures: _ }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
                lineNumber: 2228,
                columnNumber: 49
              }, this),
              !_.wikiLinks && cs.current && /* @__PURE__ */ d(
                iv,
                {
                  editor: O,
                  onSearch: cs.current
            ...
            /* @__PURE__ */ d(tx, { scrollContainerRef: xt }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
              lineNumber: 2289,
              columnNumber: 7
            }, this)
    ...
    /* @__PURE__ */ d(Jk, { visible: Xr, onClose: Zr, editor: O }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
      lineNumber: 2326,
      columnNumber: 7
    }, this)
...
function f1({
  ...
  return /* @__PURE__ */ d(yd.Provider, { value: i, children: e }, void 0, !1, {
...
function p1({ node: e, updateAttributes: t }) {
  ...
  return /* @__PURE__ */ d(Wn, { className: "code-block-wrapper", children: [
    /* @__PURE__ */ d("div", { className: "code-block-controls", contentEditable: !1, children: [
      /* @__PURE__ */ d("div", { className: "code-block-language-wrapper", children: [
        /* @__PURE__ */ d(
          "select",
          {
            ...
            className: "code-block-language-select",
            children: xl.map(({ value: a, label: i }) => /* @__PURE__ */ d("option", { value: a, children: i }, a, !1, {
      ...
      /* @__PURE__ */ d(
        "button",
        {
          ...
          children: n ? /* @__PURE__ */ d(Kn, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/CodeBlockComponent.tsx",
            lineNumber: 76,
            columnNumber: 21
          }, this) : /* @__PURE__ */ d(Vn, { size: 14 }, void 0, !1, {
    ...
    /* @__PURE__ */ d("pre", { className: "code-block-pre", children: /* @__PURE__ */ d("code", { children: /* @__PURE__ */ d(ii, {}, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/CodeBlockComponent.tsx",
      lineNumber: 83,
      columnNumber: 11
    }, this) }, void 0, !1, {
