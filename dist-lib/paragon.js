...
import { Image as Ds, X as ht, Link2 as As, Type as ir, Undo as Rd, Redo as Ld, Bold as Ps, Italic as Is, Underline as Rs, Strikethrough as Ls, Code as rl, Highlighter as sl, Link as Os, ChevronDown as Dt, List as _s, ListOrdered as $s, CheckSquare as Ws, Quote as Bs, Code2 as il, IndentIncrease as Od, IndentDecrease as _d, Table as ss, Minus as al, Info as Vo, BookOpen as Hs, PenLine as $d, Library as Wd, ListTodo as Fs, Columns as Bi, Trash2 as sn, Rows as Hi, ToggleLeft as Fi, ArrowUpDown as Bd, Sparkles as ar, Copy as Nn, Search as Hd, ChevronUp as Fd, MousePointerClick as zd, CaseSensitive as Ud, WholeWord as Yd, Regex as jd, Replace as is, ReplaceAll as Vd, Plus as zs, Check as yn, ClipboardList as Kd, MessageSquareText as ll, StickyNote as cl, ChevronRight as ul, ChevronLeftIcon as Gd, ChevronRightIcon as qd, ChevronDownIcon as Xd, Calendar as dl, Hash as zi, Cloud as Zd, Loader2 as ml, CloudOff as Qd, AlertCircle as Jd, RotateCcw as Us, Activity as em, Maximize2 as fl, Minimize2 as pl, AlertTriangle as tm, CheckCircle2 as nm, Eye as om, FileText as Ys, FileCode as rm, ExternalLink as sm, Pencil as im, Unlink as am, Heading1 as lm, Heading2 as cm, Heading3 as um, Heading4 as dm, Heading5 as mm, ImagePlus as fm, MessageSquare as hl, RefreshCw as pm, SpellCheck as hm, PanelRightClose as gm, PanelRightOpen as bm } from "lucide-react";
import { jsx as F, Fragment as vm, jsxs as Nm } from "react/jsx-runtime";
import * as gl from "react-dom";
import ym, { createPortal as xm } from "react-dom";
import { TextSelection as nt, Plugin as Ie, PluginKey as Re, AllSelection as wm } from "@tiptap/pm/state";
import km from "@tiptap/starter-kit";
import Cm from "@tiptap/extension-placeholder";
import Em from "@tiptap/extension-text-align";
import Tm from "@tiptap/extension-highlight";
import Sm from "@tiptap/extension-link";
import { Table as Mm } from "@tiptap/extension-table";
import Dm from "@tiptap/extension-table-row";
import Am from "@tiptap/extension-table-cell";
import Pm from "@tiptap/extension-table-header";
...
import Im from "@tiptap/extension-bullet-list";
import Rm from "@tiptap/extension-ordered-list";
import Lm from "@tiptap/extension-list-item";
import Om from "@tiptap/extension-task-list";
import _m from "@tiptap/extension-task-item";
import { findWrapping as Ui, canJoin as $m } from "@tiptap/pm/transform";
import Wm from "@tiptap/extension-underline";
import Bm from "@tiptap/extension-subscript";
import Hm from "@tiptap/extension-superscript";
import Fm from "@tiptap/extension-typography";
import zm from "@tiptap/extension-code-block-lowlight";
import { createLowlight as Um } from "lowlight";
...
import Ym from "highlight.js/lib/languages/css";
import jm from "highlight.js/lib/languages/json";
import cr from "highlight.js/lib/languages/bash";
import Vm from "@tiptap/extension-image";
import { createRoot as Km } from "react-dom/client";
import { Fragment as Gm } from "@tiptap/pm/model";
import { liftListItem as Yi, sinkListItem as ji } from "@tiptap/pm/schema-list";
import { undo as qm, redo as Xm } from "@tiptap/pm/history";
import Zm from "@tiptap/extension-horizontal-rule";
function Nl({ isOpen: e, onClose: t, onInsert: n, position: o }) {
  ...
  const g = (N) => {
    ...
    N.key === "Enter" && !N.shiftKey && (N.preventDefault(), h());
  };
  if (!e) return null;
  const v = o ? {
    top: o.top,
...
function wn(e, t = []) {
  ...
  function o(s, a) {
    ...
    const c = (d) => {
      ...
      return /* @__PURE__ */ F(h.Provider, { value: b, children: p });
    };
...
}, Jm = T[" useInsertionEffect ".trim().toString()] || At;
function Gs({
  prop: e,
  defaultProp: t,
  onChange: n = () => {
...
// @__NO_SIDE_EFFECTS__
function zn(e) {
  const t = /* @__PURE__ */ of(e), n = T.forwardRef((o, r) => {
...
var nf = /* @__PURE__ */ zn("Slot");
// @__NO_SIDE_EFFECTS__
function of(e) {
  const t = T.forwardRef((n, o) => {
    const { children: r, ...s } = n;
    if (T.isValidElement(r)) {
      const a = lf(r), i = af(s, r.props);
...
// @__NO_SIDE_EFFECTS__
function rf(e) {
  const t = ({ children: n }) => /* @__PURE__ */ F(vm, { children: n });
...
function wl(e) {
  const t = e + "CollectionProvider", [n, o] = wn(t), [r, s] = n(
    ...
    const { scope: b, children: v } = h, N = X.useRef(null), y = X.useRef(/* @__PURE__ */ new Map()).current;
    return /* @__PURE__ */ F(r, { scope: b, itemMap: y, collectionRef: N, children: v });
  };
  a.displayName = t;
  const i = e + "CollectionSlot", l = /* @__PURE__ */ zn(i), c = X.forwardRef(
    (h, b) => {
      const { scope: v, children: N } = h, y = s(i, v), E = Pe(b, y.collectionRef);
  ...
  const u = e + "CollectionItemSlot", d = "data-radix-collection-item", f = /* @__PURE__ */ zn(u), p = X.forwardRef(
    (h, b) => {
      const { scope: v, children: N, ...y } = h, E = X.useRef(null), x = Pe(b, E), w = s(u, v);
...
var uf = T.createContext(void 0);
function kl(e) {
  const t = T.useContext(uf);
  return e || t || "ltr";
}
function gt(e) {
  const t = T.useRef(e);
...
var mf = "DismissableLayer", as = "dismissableLayer.update", ff = "dismissableLayer.pointerDownOutside", pf = "dismissableLayer.focusOutside", Ki, Cl = T.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: i,
      ...l
    } = e, c = T.useContext(Cl), [u, d] = T.useState(null), f = u?.ownerDocument ?? globalThis?.document, [, p] = T.useState({}), g = Pe(t, (M) => d(M)), h = Array.from(c.layers), [b] = [...c.layersWithOutsidePointerEventsDisabled].slice(-1), v = h.indexOf(b), N = u ? h.indexOf(u) : -1, y = c.layersWithOutsidePointerEventsDisabled.size > 0, E = N >= v, x = bf((M) => {
...
qs.displayName = mf;
var hf = "DismissableLayerBranch", gf = T.forwardRef((e, t) => {
...
function vf(e, t = globalThis?.document) {
  ...
  return T.useEffect(() => {
    const r = (s) => {
      s.target && !o.current && El(pf, n, { originalEvent: s }, {
        discrete: !1
      });
    };
...
var _r = "focusScope.autoFocusOnMount", $r = "focusScope.autoFocusOnUnmount", Xi = { bubbles: !1, cancelable: !0 }, yf = "FocusScope", Tl = T.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: o = !1,
    onMountAutoFocus: r,
    ...
    ...a
  } = e, [i, l] = T.useState(null), c = gt(r), u = gt(s), d = T.useRef(null), f = Pe(t, (h) => l(h)), p = T.useRef({
    paused: !1,
    pause() {
      this.paused = !0;
    },
  ...
  T.useEffect(() => {
    if (o) {
      ...
      return i && N.observe(i, { childList: !0, subtree: !0 }), () => {
        document.removeEventListener("focusin", h), document.removeEventListener("focusout", b), N.disconnect();
      };
    }
    ...
    if (i) {
      ...
      if (!i.contains(h)) {
        ...
        i.addEventListener(_r, c), i.dispatchEvent(v), v.defaultPrevented || (xf(Tf(Sl(i)), { select: !0 }), document.activeElement === h && St(i));
      }
      return () => {
        i.removeEventListener(_r, c), setTimeout(() => {
          const v = new CustomEvent($r, Xi);
          i.addEventListener($r, u), i.dispatchEvent(v), v.defaultPrevented || St(h ?? document.body, { select: !0 }), i.removeEventListener($r, u), Qi.remove(p);
        }, 0);
      };
    }
  }, [i, c, u, p]);
  const g = T.useCallback(
    (h) => {
      ...
      if (b && v) {
        const N = h.currentTarget, [y, E] = wf(N);
        y && E ? !h.shiftKey && v === E ? (h.preventDefault(), n && St(y, { select: !0 })) : h.shiftKey && v === y && (h.preventDefault(), n && St(E, { select: !0 })) : v === N && h.preventDefault();
      }
    },
    [n, o, p.paused]
  );
...
function Zi(e, t) {
  for (const n of e)
    if (!kf(n, { upTo: t })) return n;
}
function kf(e, { upTo: t }) {
...
var Sf = T[" useId ".trim().toString()] || (() => {
}), Mf = 0;
function Ko(e) {
  const [t, n] = T.useState(Sf());
  return At(() => {
    n((o) => o ?? String(Mf++));
  }, [e]), e || (t ? `radix-${t}` : "");
}
const Df = ["top", "right", "bottom", "left"], Pt = Math.min, We = Math.max, Go = Math.round, ko = Math.floor, ot = (e) => ({
  x: e,
  y: e
}), Af = {
  left: "right",
...
const If = /* @__PURE__ */ new Set(["top", "bottom"]);
function et(e) {
  return If.has(vt(e)) ? "y" : "x";
}
function Qs(e) {
  return Xs(et(e));
}
...
const ea = ["left", "right"], ta = ["right", "left"], Of = ["top", "bottom"], _f = ["bottom", "top"];
function $f(e, t, n) {
  switch (e) {
    case "top":
    case "bottom":
...
const Hf = async (e, t, n) => {
  ...
  for (let h = 0; h < i.length; h++) {
    ...
    }, x && g <= 50 && (g++, typeof x == "object" && (x.placement && (f = x.placement), x.rects && (c = x.rects === !0 ? await a.getElementRects({
      reference: e,
      floating: t,
      strategy: r
    }) : x.rects), {
...
async function Un(e, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: p = 0
  } = bt(t, e), g = Ml(p), b = i[f ? d === "floating" ? "reference" : "floating" : d], v = Xo(await s.getClippingRect({
  ...
  return {
    top: (v.top - x.top + g.top) / E.y,
    bottom: (x.bottom - v.bottom + g.bottom) / E.y,
    left: (v.left - x.left + g.left) / E.x,
    right: (x.right - v.right + g.right) / E.x
  };
}
const Ff = (e) => ({
  name: "arrow",
  ...
  async fn(t) {
    ...
    const d = Ml(u), f = {
      x: n,
      y: o
    }, p = Qs(r), g = Zs(p), h = await a.getDimensions(c), b = p === "y", v = b ? "top" : "left", N = b ? "bottom" : "right", y = b ? "clientHeight" : "clientWidth", E = s.reference[g] + s.reference[p] - f[p] - s.floating[g], x = f[p] - s.reference[p], w = await (a.getOffsetParent == null ? void 0 : a.getOffsetParent(c));
    let M = w ? w[y] : 0;
    (!M || !await (a.isElement == null ? void 0 : a.isElement(w))) && (M = i.floating[y] || s.floating[g]);
    const k = E / 2 - x / 2, C = M / 2 - h[g] / 2 - 1, S = Pt(d[v], C), D = Pt(d[N], C), A = S, R = M - h[g] - D, L = M / 2 - h[g] / 2 + k, _ = ls(A, L, R), O = !l.arrow && kn(r) != null && L !== _ && s.reference[g] / 2 - (L < A ? S : D) - h[g] / 2 < 0, U = O ? L < A ? L - A : L - R : 0;
    return {
      [p]: f[p] + U,
      data: {
        [p]: _,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const v = vt(r), N = et(i), y = vt(i) === i, E = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), x = f || (y || !h ? [qo(i)] : Lf(i)), w = g !== "none";
      !f && w && x.push(...Wf(i, h, g, E));
...
const jf = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      const N = h - u.top - u.bottom, y = g - u.left - u.right, E = Pt(h - u[b], N), x = Pt(g - u[v], y), w = !t.middlewareData.shift;
      let M = E, k = x;
      if ((n = t.middlewareData.shift) != null && n.enabled.x && (k = y), (o = t.middlewareData.shift) != null && o.enabled.y && (M = N), w && !f) {
        ...
        p ? k = g - 2 * (S !== 0 || D !== 0 ? S + D : We(u.left, u.right)) : M = h - 2 * (A !== 0 || R !== 0 ? A + R : We(u.top, u.bottom));
      }
      await l({
        ...t,
        availableWidth: k,
...
const qf = /* @__PURE__ */ new Set(["inline", "contents"]);
function Xn(e) {
  const {
    overflow: t,
    overflowX: n,
  ...
  return /auto|scroll|overlay|hidden|clip/.test(t + o + n) && !qf.has(r);
}
const Xf = /* @__PURE__ */ new Set(["table", "td", "th"]);
function Zf(e) {
  return Xf.has(Cn(e));
}
...
const Jf = ["transform", "translate", "scale", "rotate", "perspective"], ep = ["transform", "translate", "scale", "rotate", "perspective", "filter"], tp = ["paint", "layout", "strict", "content"];
function Js(e) {
  const t = ei(), n = qe(e) ? Xe(e) : e;
  return Jf.some((o) => n[o] ? n[o] !== "none" : !1) || (n.containerType ? n.containerType !== "normal" : !1) || !t && (n.backdropFilter ? n.backdropFilter !== "none" : !1) || !t && (n.filter ? n.filter !== "none" : !1) || ep.some((o) => (n.willChange || "").includes(o)) || tp.some((o) => (n.contain || "").includes(o));
}
function np(e) {
  let t = It(e);
  for (; rt(t) && !hn(t); ) {
...
const rp = /* @__PURE__ */ ot(0);
function Rl(e) {
  const t = Be(e);
  return !ei() || !t.visualViewport ? rp : {
...
function Ut(e, t, n, o) {
  ...
  const i = sp(s, n, o) ? Rl(s) : ot(0);
  let l = (r.left + i.x) / a.x, c = (r.top + i.y) / a.y, u = r.width / a.x, d = r.height / a.y;
  if (s) {
    const f = Be(s), p = o && qe(o) ? Be(o) : o;
    let g = f, h = us(g);
    for (; h && o && p !== g; ) {
      const b = an(h), v = h.getBoundingClientRect(), N = Xe(h), y = v.left + (h.clientLeft + parseFloat(N.paddingLeft)) * b.x, E = v.top + (h.clientTop + parseFloat(N.paddingTop)) * b.y;
      l *= b.x, c *= b.y, u *= b.x, d *= b.y, l += y, c += E, g = Be(h), h = us(g);
    }
  }
  return Xo({
    width: u,
...
function mp(e, t) {
  ...
  for (; qe(a) && !hn(a); ) {
    const i = Xe(a), l = Js(a);
    !l && i.position === "fixed" && (r = null), (s ? !l && !r : !l && i.position === "static" && !!r && up.has(r.position) || Xn(a) && !l && Ol(e, a)) ? o = o.filter((u) => u !== a) : r = i, a = It(a);
  }
  return t.set(e, o), o;
}
function fp(e) {
  ...
  const a = [...n === "clippingAncestors" ? mr(t) ? [] : mp(t, this._c) : [].concat(n), o], i = a[0], l = a.reduce((c, u) => {
    const d = aa(t, u, r);
...
function _l(e, t) {
  ...
  for (; o && Zf(o) && Wr(o); )
    o = la(o, t);
  return o && hn(o) && Wr(o) && !Js(o) ? n : o || np(e) || n;
}
...
function Np(e, t) {
  ...
  function a(i, l) {
    ...
    if (i || t(), !f || !p)
      return;
    const g = ko(d), h = ko(r.clientWidth - (u + f)), b = ko(r.clientHeight - (d + p)), v = ko(u), y = {
...
function yp(e, t, n, o) {
  ...
  function b() {
    const v = Ut(e);
    h && !$l(h, v) && n(), h = v, g = requestAnimationFrame(b);
  }
  return n(), () => {
    var v;
    u.forEach((N) => {
...
const xp = jf, wp = Vf, kp = zf, Cp = Gf, Ep = Uf, ca = Ff, Tp = Kf, Sp = (e, t, n) => {
...
var Mp = typeof document < "u", Dp = function() {
}, Fo = Mp ? sr : Dp;
function Zo(e, t) {
  if (e === t)
    return !0;
...
function Ap(e) {
  ...
  Zo(f, o) || p(o);
  const [g, h] = T.useState(null), [b, v] = T.useState(null), N = T.useCallback((I) => {
    I !== w.current && (w.current = I, h(I));
  }, []), y = T.useCallback((I) => {
    I !== M.current && (M.current = I, v(I));
  }, []), E = s || g, x = a || b, w = T.useRef(null), M = T.useRef(null), k = T.useRef(u), C = l != null, S = Br(l), D = Br(r), A = Br(c), R = T.useCallback(() => {
    ...
    D.current && (I.platform = D.current), Sp(w.current, M.current, I).then((P) => {
      const W = {
        ...P,
...
var Bp = "Arrow", Bl = T.forwardRef((e, t) => {
...
var ni = "Popper", [Hl, hr] = wn(ni), [zp, Fl] = Hl(ni), zl = (e) => {
  const { __scopePopper: t, children: n } = e, [o, r] = T.useState(null);
  return /* @__PURE__ */ F(zp, { scope: t, anchor: o, onAnchorChange: r, children: n });
};
zl.displayName = ni;
...
Yl.displayName = Ul;
var oi = "PopperContent", [Up, Yp] = Hl(oi), jl = T.forwardRef(
  (e, t) => {
    const {
      __scopePopper: n,
      side: o = "bottom",
      ...
      onPlaced: g,
      ...h
    } = e, b = Fl(oi, n), [v, N] = T.useState(null), y = Pe(t, (z) => N(z)), [E, x] = T.useState(null), w = Fp(E), M = w?.width ?? 0, k = w?.height ?? 0, C = o + (s !== "center" ? "-" + s : ""), S = typeof u == "number" ? u : { top: 0, right: 0, bottom: 0, left: 0, ...u }, D = Array.isArray(c) ? c : [c], A = D.length > 0, R = {
      padding: S,
      boundary: D.filter(Vp),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: A
    }, { refs: L, floatingStyles: _, placement: O, isPositioned: U, middlewareData: I } = Ap({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: C,
      whileElementsMounted: (...z) => yp(...z, {
      ...
      middleware: [
        ...
        E && Wp({ element: E, padding: i }),
        Kp({ arrowWidth: M, arrowHeight: k }),
        f && $p({ strategy: "referenceHidden", ...R })
      ]
    }), [P, W] = Gl(O), K = gt(g);
    At(() => {
      U && K?.();
...
jl.displayName = oi;
var Vl = "PopperArrow", jp = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, Kl = T.forwardRef(function(t, n) {
  const { __scopePopper: o, ...r } = t, s = Yp(Vl, o), a = jp[s.placedSide];
  return (
...
var ql = zl, Xl = Yl, Zl = jl, Ql = Kl, Gp = "Portal", ri = T.forwardRef((e, t) => {
  const { container: n, ...o } = e, [r, s] = T.useState(!1);
  At(() => s(!0), []);
  const a = n || r && globalThis?.document?.body;
  return a ? ym.createPortal(/* @__PURE__ */ F(Me.div, { ...o, ref: t }), a) : null;
});
ri.displayName = Gp;
function qp(e, t) {
...
var Yt = (e) => {
  const { present: t, children: n } = e, o = Xp(t), r = typeof n == "function" ? n({ present: o.isPresent }) : T.Children.only(n), s = Pe(o.ref, Zp(r));
  return typeof n == "function" || o.isPresent ? T.cloneElement(r, { ref: s }) : null;
};
Yt.displayName = "Presence";
function Xp(e) {
  const [t, n] = T.useState(), o = T.useRef(null), r = T.useRef(e), s = T.useRef("none"), a = e ? "mounted" : "unmounted", [i, l] = qp(a, {
    mounted: {
      UNMOUNT: "unmounted",
  ...
  return T.useEffect(() => {
    ...
    if (t) {
      ...
      const u = t.ownerDocument.defaultView ?? window, d = (p) => {
        const h = Co(o.current).includes(CSS.escape(p.animationName));
...
var Hr = "rovingFocusGroup.onEntryFocus", Qp = { bubbles: !1, cancelable: !0 }, Zn = "RovingFocusGroup", [ds, Jl, Jp] = wl(Zn), [eh, ec] = wn(
  Zn,
  [Jp]
), [th, nh] = eh(Zn), tc = T.forwardRef(
  (e, t) => /* @__PURE__ */ F(ds.Provider, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ F(ds.Slot, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ F(oh, { ...e, ref: t }) }) })
);
tc.displayName = Zn;
var oh = T.forwardRef((e, t) => {
  const {
    ...
    ...d
  } = e, f = T.useRef(null), p = Pe(t, f), g = kl(s), [h, b] = Gs({
    prop: a,
    defaultProp: i ?? null,
    onChange: l,
    caller: Zn
        ...
        Me.div,
        {
          ...
          onFocus: se(e.onFocus, (k) => {
            ...
            if (k.target === k.currentTarget && C && !v) {
              const S = new CustomEvent(Hr, Qp);
              if (k.currentTarget.dispatchEvent(S), !S.defaultPrevented) {
                const D = E().filter((O) => O.focusable), A = D.find((O) => O.active), R = D.find((O) => O.id === h), _ = [A, R, ...D].filter(
                  Boolean
                ).map((O) => O.ref.current);
                rc(_, u);
              }
  ...
  (e, t) => {
    const {
      ...
      children: a,
      ...i
    } = e, l = Ko(), c = s || l, u = nh(nc, n), d = u.currentTabStopId === c, f = Jl(n), { onFocusableItemAdd: p, onFocusableItemRemove: g, currentTabStopId: h } = u;
    return T.useEffect(() => {
      if (o)
        return p(), () => g();
    }, [o, p, g]), /* @__PURE__ */ F(
        ...
        children: /* @__PURE__ */ F(
          Me.span,
          {
            ...
            onKeyDown: se(e.onKeyDown, (b) => {
              ...
              const v = ih(b, u.orientation, u.dir);
              if (v !== void 0) {
...
var lh = tc, ch = oc, uh = function(e) {
  ...
  var r = dh(t, Array.isArray(e) ? e : [e]);
  ...
  var u = function(d) {
    !d || l.has(d) || Array.prototype.forEach.call(d.children, function(f) {
      if (i.has(f))
        ...
        try {
          var p = f.getAttribute(o), g = p !== null && p !== "false", h = (Zt.get(f) || 0) + 1, b = (s.get(f) || 0) + 1;
          Zt.set(f, h), s.set(f, b), a.push(f), h === 1 && g && Eo.set(f, !0), b === 1 && f.setAttribute(n, "true"), g || f.setAttribute(o, "true");
        } catch (v) {
  ...
  var o = Array.from(Array.isArray(e) ? e : [e]), r = uh(e);
  return r ? (o.push.apply(o, Array.from(r.querySelectorAll("[aria-live], script"))), mh(o, r, n, "aria-hidden")) : function() {
    return null;
  };
}, Je = function() {
...
var zo = "right-scroll-bar-position", Uo = "width-before-scroll-bar", hh = "with-scroll-bars-hidden", gh = "--removed-body-scroll-bar-size";
function zr(e, t) {
...
var vh = typeof window < "u" ? T.useLayoutEffect : T.useEffect, da = /* @__PURE__ */ new WeakMap();
function Nh(e, t) {
  var n = bh(null, function(o) {
...
var lc = wh(), Ur = function() {
}, gr = T.forwardRef(function(e, t) {
  var n = T.useRef(null), o = T.useState({
    onScrollCapture: Ur,
    onWheelCapture: Ur,
    onTouchMoveCapture: Ur
  }), r = o[0], s = o[1], a = e.forwardProps, i = e.children, l = e.className, c = e.removeScrollBar, u = e.enabled, d = e.shards, f = e.sideCar, p = e.noRelative, g = e.noIsolation, h = e.inert, b = e.allowPinchZoom, v = e.as, N = v === void 0 ? "div" : v, y = e.gapMode, E = ic(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), x = f, w = Nh([n, t]), M = Je(Je({}, E), r);
  return T.createElement(
    T.Fragment,
    null,
    u && T.createElement(x, { sideCar: lc, removeScrollBar: c, shards: d, noRelative: p, noIsolation: g, inert: h, setCallbacks: s, allowPinchZoom: !!b, lockRef: n, gapMode: y }),
...
var Mh = function() {
  ...
  if (e === void 0 && (e = "margin"), typeof window > "u")
    return Ah;
  var t = Ph(e), n = document.documentElement.clientWidth, o = window.innerWidth;
  return {
    left: t[0],
    top: t[1],
    right: t[2],
...
}, Rh = cc(), ln = "data-scroll-locked", Lh = function(e, t, n, o) {
...
`);
  ...
  return T.createElement(Rh, { styles: Lh(s, !t, r, n ? "" : "!important") });
}, ms = !1;
if (typeof window < "u")
  try {
...
var Qt = ms ? { passive: !1 } : !1, $h = function(e) {
  ...
  return e === "v" ? Hh(t) : Fh(t);
}, zh = function(e, t) {
  return e === "h" && t === "rtl" ? -1 : 1;
}, Uh = function(e, t, n, o, r) {
  var s = zh(e, window.getComputedStyle(t).direction), a = s * o, i = n.target, l = t.contains(i), c = !1, u = a > 0, d = 0, f = 0;
  do {
    if (!i)
      break;
    var p = mc(e, i), g = p[0], h = p[1], b = p[2], v = h - b - s * g;
    (g || v) && dc(e, i) && (d += v, f += g);
    var N = i.parentNode;
...
function Kh(e) {
  var t = T.useRef([]), n = T.useRef([0, 0]), o = T.useRef(), r = T.useState(Vh++)[0], s = T.useState(cc)[0], a = T.useRef(e);
  T.useEffect(function() {
    a.current = e;
  }, [e]), T.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(r));
      var h = ph([e.lockRef.current], (e.shards || []).map(ha), !0).filter(Boolean);
  ...
  var i = T.useCallback(function(h, b) {
    ...
    var v = Mo(h), N = n.current, y = "deltaX" in h ? h.deltaX : N[0] - v[0], E = "deltaY" in h ? h.deltaY : N[1] - v[1], x, w = h.target, M = Math.abs(y) > Math.abs(E) ? "h" : "v";
    if ("touches" in h && M === "h" && w.type === "range")
      return !1;
    var k = fa(M, w);
    if (!k)
      return !0;
    if (k ? x = M : (x = M === "v" ? "h" : "v", k = fa(M, w)), !k)
      return !1;
    if (!o.current && "changedTouches" in h && (y || E) && (o.current = x), !x)
      return !0;
    var C = o.current || x;
    return Uh(C, b, h, C === "h" ? y : E);
  }, []), l = T.useCallback(function(h) {
    var b = h;
    if (!(!Jt.length || Jt[Jt.length - 1] !== s)) {
      var v = "deltaY" in b ? pa(b) : Mo(b), N = t.current.filter(function(x) {
        return x.name === b.type && (x.target === b.target || b.target === x.shadowParent) && Yh(x.delta, v);
      })[0];
      if (N && N.should) {
  ...
  }, []), c = T.useCallback(function(h, b, v, N) {
    var y = { name: h, delta: b, target: v, should: N, shadowParent: Gh(v) };
    ...
    n.current = Mo(h), o.current = void 0;
  }, []), d = T.useCallback(function(h) {
    c(h.type, pa(h), h.target, i(h, e.lockRef.current));
  }, []), f = T.useCallback(function(h) {
    c(h.type, Mo(h), h.target, i(h, e.lockRef.current));
  }, []);
  T.useEffect(function() {
  ...
  return T.createElement(
    T.Fragment,
    null,
    g ? T.createElement(s, { styles: jh(r) }) : null,
...
var fc = T.forwardRef(function(e, t) {
  return T.createElement(gr, Je({}, e, { ref: t, sideCar: qh }));
});
fc.classNames = gr.classNames;
var fs = ["Enter", " "], Xh = ["ArrowDown", "PageUp", "Home"], pc = ["ArrowUp", "PageDown", "End"], Zh = [...Xh, ...pc], Qh = {
  ltr: [...fs, "ArrowRight"],
  rtl: [...fs, "ArrowLeft"]
}, Jh = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, Qn = "Menu", [jn, eg, tg] = wl(Qn), [jt, hc] = wn(Qn, [
  tg,
  hr,
  ec
]), br = hr(), gc = ec(), [ng, Vt] = jt(Qn), [og, Jn] = jt(Qn), bc = (e) => {
...
bc.displayName = Qn;
var rg = "MenuAnchor", si = T.forwardRef(
  (e, t) => {
...
si.displayName = rg;
var ii = "MenuPortal", [sg, vc] = jt(ii, {
  forceMount: void 0
}), Nc = (e) => {
  const { __scopeMenu: t, forceMount: n, children: o, container: r } = e, s = Vt(ii, t);
  return /* @__PURE__ */ F(sg, { scope: t, forceMount: n, children: /* @__PURE__ */ F(Yt, { present: n || s.open, children: /* @__PURE__ */ F(ri, { asChild: !0, container: r, children: o }) }) });
};
Nc.displayName = ii;
var je = "MenuContent", [ig, ai] = jt(je), yc = T.forwardRef(
  (e, t) => {
    const n = vc(je, e.__scopeMenu), { forceMount: o = n.forceMount, ...r } = e, s = Vt(je, e.__scopeMenu), a = Jn(je, e.__scopeMenu);
    return /* @__PURE__ */ F(jn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ F(Yt, { present: o || s.open, children: /* @__PURE__ */ F(jn.Slot, { scope: e.__scopeMenu, children: a.modal ? /* @__PURE__ */ F(ag, { ...r, ref: t }) : /* @__PURE__ */ F(lg, { ...r, ref: t }) }) }) });
  }
), ag = T.forwardRef(
  (e, t) => {
...
}), cg = /* @__PURE__ */ zn("MenuContent.ScrollLock"), li = T.forwardRef(
  (e, t) => {
    const {
      __scopeMenu: n,
      loop: o = !1,
      ...
      ...h
    } = e, b = Vt(je, n), v = Jn(je, n), N = br(n), y = gc(n), E = eg(n), [x, w] = T.useState(null), M = T.useRef(null), k = Pe(t, M, b.onContentChange), C = T.useRef(0), S = T.useRef(""), D = T.useRef(0), A = T.useRef(null), R = T.useRef("right"), L = T.useRef(0), _ = g ? fc : T.Fragment, O = g ? { as: cg, allowPinchZoom: !0 } : void 0, U = (P) => {
      const W = S.current + P, K = E().filter((z) => !z.disabled), V = document.activeElement, G = K.find((z) => z.ref.current === V)?.textValue, Q = K.map((z) => z.textValue), B = xg(Q, W, G), $ = K.find((z) => z.textValue === B)?.ref.current;
      (function z(Z) {
        S.current = Z, window.clearTimeout(C.current), Z !== "" && (C.current = window.setTimeout(() => z(""), 1e3));
      })(W), $ && setTimeout(() => $.focus());
    };
    T.useEffect(() => () => window.clearTimeout(C.current), []), Nf();
    const I = T.useCallback((P) => R.current === A.current?.side && kg(P, A.current?.area), []);
    return /* @__PURE__ */ F(
      ig,
      {
        scope: n,
                    ...
                    children: /* @__PURE__ */ F(
                      Zl,
                      {
                        ...
                        onKeyDown: se(h.onKeyDown, (P) => {
                          ...
                          const Q = M.current;
                          if (P.target !== Q || !Zh.includes(P.key)) return;
                          P.preventDefault();
                          const $ = E().filter((z) => !z.disabled).map((z) => z.ref.current);
                          pc.includes(P.key) && $.reverse(), Ng($);
                        }),
...
yc.displayName = je;
var ug = "MenuGroup", ci = T.forwardRef(
  (e, t) => {
...
ci.displayName = ug;
var dg = "MenuLabel", xc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e;
  ...
  (e, t) => {
    ...
    return T.useEffect(() => {
      ...
      jn.ItemSlot,
      {
        ...
        disabled: o,
        textValue: r ?? f,
        children: /* @__PURE__ */ F(ch, { asChild: !0, ...i, focusable: !o, children: /* @__PURE__ */ F(
          Me.div,
          {
            role: "menuitem",
...
), mg = "MenuCheckboxItem", kc = T.forwardRef(
  (e, t) => {
...
kc.displayName = mg;
var Cc = "MenuRadioGroup", [fg, pg] = jt(
  Cc,
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ F(fg, { scope: e.__scopeMenu, value: n, onValueChange: s, children: /* @__PURE__ */ F(ci, { ...r, ref: t }) });
  }
);
Ec.displayName = Cc;
var Tc = "MenuRadioItem", Sc = T.forwardRef(
  (e, t) => {
    const { value: n, ...o } = e, r = pg(Tc, e.__scopeMenu), s = n === r.value;
...
Sc.displayName = Tc;
var ui = "MenuItemIndicator", [Mc, hg] = jt(
  ui,
  { checked: !1 }
), Dc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, forceMount: o, ...r } = e, s = hg(ui, n);
    return /* @__PURE__ */ F(
      Yt,
      {
...
Dc.displayName = ui;
var gg = "MenuSeparator", Ac = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e;
    return /* @__PURE__ */ F(
      Me.div,
...
Ac.displayName = gg;
var bg = "MenuArrow", Pc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e, r = br(n);
...
Pc.displayName = bg;
var vg = "MenuSub", [dk, Ic] = jt(vg), On = "MenuSubTrigger", Rc = T.forwardRef(
  (e, t) => {
    ...
    return T.useEffect(() => u, [u]), T.useEffect(() => {
      ...
      wc,
      {
        ...
        onKeyDown: se(e.onKeyDown, (d) => {
          ...
          e.disabled || f && d.key === " " || Qh[o.dir].includes(d.key) && (n.onOpenChange(!0), n.content?.focus(), d.preventDefault());
        })
      }
    ) });
  }
    ...
    return /* @__PURE__ */ F(jn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ F(Yt, { present: o || s.open, children: /* @__PURE__ */ F(jn.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ F(
      li,
      {
        ...
        onKeyDown: se(e.onKeyDown, (u) => {
          const d = u.currentTarget.contains(u.target), f = Jh[a.dir].includes(u.key);
...
var Cg = bc, Eg = si, Tg = Nc, Sg = yc, Mg = ci, Dg = xc, Ag = vr, Pg = kc, Ig = Ec, Rg = Sc, Lg = Dc, Og = Ac, _g = Pc, $g = Rc, Wg = Oc, Nr = "DropdownMenu", [Bg] = wn(
  Nr,
  [hc]
), Le = hc(), [Hg, $c] = Bg(Nr), Wc = (e) => {
  const {
  ...
  return /* @__PURE__ */ F(
    Hg,
    {
      ...
      modal: i,
      children: /* @__PURE__ */ F(Cg, { ...l, open: u, onOpenChange: d, dir: o, modal: i, children: n })
    }
  );
};
Wc.displayName = Nr;
var Bc = "DropdownMenuTrigger", Hc = T.forwardRef(
  (e, t) => {
    ...
    return /* @__PURE__ */ F(Eg, { asChild: !0, ...a, children: /* @__PURE__ */ F(
      Me.button,
      {
        type: "button",
        id: s.triggerId,
...
Hc.displayName = Bc;
var Fg = "DropdownMenuPortal", Fc = (e) => {
  const { __scopeDropdownMenu: t, ...n } = e, o = Le(t);
  return /* @__PURE__ */ F(Tg, { ...o, ...n });
};
Fc.displayName = Fg;
...
Uc.displayName = zc;
var zg = "DropdownMenuGroup", Ug = T.forwardRef(
  (e, t) => {
...
jg.displayName = Yg;
var Vg = "DropdownMenuItem", Yc = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
...
Qg.displayName = Zg;
var Jg = "DropdownMenuItemIndicator", eb = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
  return /* @__PURE__ */ F(Lg, { ...r, ...o, ref: t });
});
eb.displayName = Jg;
var tb = "DropdownMenuSeparator", jc = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
  return /* @__PURE__ */ F(Og, { ...r, ...o, ref: t });
});
jc.displayName = tb;
var nb = "DropdownMenuArrow", ob = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
...
ob.displayName = nb;
var rb = "DropdownMenuSubTrigger", sb = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
  return /* @__PURE__ */ F($g, { ...r, ...o, ref: t });
});
sb.displayName = rb;
var ib = "DropdownMenuSubContent", ab = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
  return /* @__PURE__ */ F(
    Wg,
    {
...
ab.displayName = ib;
var lb = Wc, cb = Hc, ub = Fc, db = Uc, mb = Yc, fb = jc;
function Vc(e) {
  var t, n, o = "";
...
const mi = "-", pb = (e) => {
  ...
  return {
    getClassGroupId: (a) => {
      const i = a.split(mi);
      return i[0] === "" && i.length !== 1 && i.shift(), Gc(i, t) || hb(a);
    },
  ...
  let o = (r) => {
    ...
    const u = s.length === 0 ? r : r.substring(l), d = xb(u), f = d !== u, p = c && c > l ? c - l : void 0;
    return {
      modifiers: s,
  ...
  return o;
}, xb = (e) => e.endsWith(hs) ? e.substring(0, e.length - 1) : e.startsWith(hs) ? e.substring(1) : e, wb = (e) => {
...
function Sb(e, ...t) {
  ...
  function a(l) {
    ...
    return n = kb(c), o = n.cache.get, r = n.cache.set, s = i, i(l);
  }
  function i(l) {
    const c = o(l);
    if (c)
...
}, Xc = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, Zc = /^\((?:(\w[\w-]*):)?(.+)\)$/i, Mb = /^\d+\/\d+$/, Db = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, Ab = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, Pb = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, Ib = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, Rb = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, en = (e) => Mb.test(e), ae = (e) => !!e && !Number.isNaN(Number(e)), Ct = (e) => !!e && Number.isInteger(Number(e)), jr = (e) => e.endsWith("%") && ae(e.slice(0, -1)), ct = (e) => Db.test(e), Lb = () => !0, Ob = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  Ab.test(e) && !Pb.test(e)
), Qc = () => !1, _b = (e) => Ib.test(e), $b = (e) => Rb.test(e), Wb = (e) => !J(e) && !ee(e), Bb = (e) => En(e, tu, Qc), J = (e) => Xc.test(e), _t = (e) => En(e, nu, Ob), Vr = (e) => En(e, Yb, ae), Na = (e) => En(e, Jc, Qc), Hb = (e) => En(e, eu, $b), Do = (e) => En(e, ou, _b), ee = (e) => Zc.test(e), In = (e) => Tn(e, nu), Fb = (e) => Tn(e, jb), ya = (e) => Tn(e, Jc), zb = (e) => Tn(e, tu), Ub = (e) => Tn(e, eu), Ao = (e) => Tn(e, ou, !0), En = (e, t, n) => {
  const o = Xc.exec(e);
  return o ? o[1] ? t(o[1]) : n(o[2]) : !1;
}, Tn = (e, t, n = !1) => {
  const o = Zc.exec(e);
  return o ? o[1] ? t(o[1]) : n : !1;
}, Jc = (e) => e === "position" || e === "percentage", eu = (e) => e === "image" || e === "url", tu = (e) => e === "length" || e === "size" || e === "bg-size", nu = (e) => e === "length", Yb = (e) => e === "number", jb = (e) => e === "family-name", ou = (e) => e === "shadow", Vb = () => {
  const e = we("color"), t = we("font"), n = we("text"), o = we("font-weight"), r = we("tracking"), s = we("leading"), a = we("breakpoint"), i = we("container"), l = we("spacing"), c = we("radius"), u = we("shadow"), d = we("inset-shadow"), f = we("text-shadow"), p = we("drop-shadow"), g = we("blur"), h = we("perspective"), b = we("aspect"), v = we("ease"), N = we("animate"), y = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], E = () => [
    "center",
    "top",
    "bottom",
    "left",
...
function Kr({
  ...
  return /* @__PURE__ */ m(lb, { "data-slot": "dropdown-menu", ...e }, void 0, !1, {
...
function qr({
  ...
  return /* @__PURE__ */ m(ub, { children: /* @__PURE__ */ m(
    db,
    {
...
const xa = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, wa = Kc, Gb = (e, t) => (n) => {
  var o;
...
var qb = Object.freeze({
  ...
  whiteSpace: "nowrap",
  wordWrap: "normal"
}), Xb = "VisuallyHidden", ru = T.forwardRef(
  (e, t) => /* @__PURE__ */ F(
    Me.span,
    {
      ...e,
...
ru.displayName = Xb;
var Zb = ru, [yr] = wn("Tooltip", [
  hr
]), xr = hr(), su = "TooltipProvider", Qb = 700, vs = "tooltip.open", [Jb, fi] = yr(su), iu = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = Qb,
...
iu.displayName = su;
var Kn = "Tooltip", [ev, eo] = yr(Kn), au = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: o,
    ...
    delayDuration: i
  } = e, l = fi(Kn, e.__scopeTooltip), c = xr(t), [u, d] = T.useState(null), f = Ko(), p = T.useRef(0), g = a ?? l.disableHoverableContent, h = i ?? l.delayDuration, b = T.useRef(!1), [v, N] = Gs({
    prop: o,
    defaultProp: r ?? !1,
    onChange: (M) => {
...
lu.displayName = Ns;
var pi = "TooltipPortal", [tv, nv] = yr(pi, {
  forceMount: void 0
}), cu = (e) => {
  const { __scopeTooltip: t, forceMount: n, children: o, container: r } = e, s = eo(pi, t);
  return /* @__PURE__ */ F(tv, { scope: t, forceMount: n, children: /* @__PURE__ */ F(Yt, { present: n || s.open, children: /* @__PURE__ */ F(ri, { asChild: !0, container: r, children: o }) }) });
};
cu.displayName = pi;
var gn = "TooltipContent", uu = T.forwardRef(
  (e, t) => {
    const n = nv(gn, e.__scopeTooltip), { forceMount: o = n.forceMount, side: r = "top", ...s } = e, a = eo(gn, e.__scopeTooltip);
    return /* @__PURE__ */ F(Yt, { present: o || a.open, children: a.disableHoverableContent ? /* @__PURE__ */ F(du, { side: r, ...s, ref: t }) : /* @__PURE__ */ F(ov, { side: r, ...s, ref: t }) });
  }
), ov = T.forwardRef((e, t) => {
  const n = eo(gn, e.__scopeTooltip), o = fi(gn, e.__scopeTooltip), r = T.useRef(null), s = Pe(t, r), [a, i] = T.useState(null), { trigger: l, onClose: c } = n, u = r.current, { onPointerInTransitChange: d } = o, f = T.useCallback(() => {
    ...
    (g, h) => {
      const b = g.currentTarget, v = { x: g.clientX, y: g.clientY }, N = av(v, b.getBoundingClientRect()), y = lv(v, N), E = cv(h.getBoundingClientRect()), x = dv([...y, ...E]);
      i(x), d(!0);
    },
    [d]
  );
  return T.useEffect(() => () => f(), [f]), T.useEffect(() => {
    ...
    if (a) {
      const g = (h) => {
        const b = h.target, v = { x: h.clientX, y: h.clientY }, N = l?.contains(b) || u?.contains(b), y = !uv(v, a);
        N ? f() : y && (f(), c());
      };
      return document.addEventListener("pointermove", g), () => document.removeEventListener("pointermove", g);
    }
  }, [l, u, a, c, f]), /* @__PURE__ */ F(du, { ...e, ref: s });
}), [rv, sv] = yr(Kn, { isInside: !1 }), iv = /* @__PURE__ */ rf("TooltipContent"), du = T.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: o,
      ...
      qs,
      {
        ...
        children: /* @__PURE__ */ Nm(
          Zl,
          {
            ...
            children: [
              /* @__PURE__ */ F(iv, { children: o }),
              /* @__PURE__ */ F(rv, { scope: n, isInside: !0, children: /* @__PURE__ */ F(Zb, { id: l.contentId, role: "tooltip", children: r || o }) })
            ]
          }
        )
      }
...
function dv(e) {
  const t = e.slice();
  return t.sort((n, o) => n.x < o.x ? -1 : n.x > o.x ? 1 : n.y < o.y ? -1 : n.y > o.y ? 1 : 0), mv(t);
}
function mv(e) {
...
var fv = iu, pv = au, hv = lu, gv = cu, bv = uu, vv = fu;
function Nv({
  delayDuration: e = 0,
  ...t
}) {
...
function ys({
  ...
  return /* @__PURE__ */ m(Nv, { children: /* @__PURE__ */ m(pv, { "data-slot": "tooltip", ...e }, void 0, !1, {
    fileName: "/home/ubuntu/paragon/client/src/components/ui/tooltip.tsx",
    lineNumber: 24,
    columnNumber: 7
  }, this) }, void 0, !1, {
...
const ye = ({ onClick: e, isActive: t, disabled: n, children: o, tooltip: r }) => {
  ...
  lineNumber: 132,
  columnNumber: 3
}, void 0), yv = vn(function({ editor: t, onCopyMarkdown: n, onOpenLinkPopover: o, className: r = "", autoReorderChecklist: s = !1, aiEnabled: a = !1, onAISparklesClick: i }) {
...
function xv({ editor: e, isOpen: t, onClose: n, focusTrigger: o = 0, initialSearchQuery: r, editorMode: s = "wysiwyg", rawMarkdown: a = "", onRawMarkdownChange: i, onMatchesChange: l }) {
  const c = s === "markdown", [u, d] = Y(""), [f, p] = Y(""), [g, h] = Y(!1), [b, v] = Y(!1), [N, y] = Y(!1), [E, x] = Y(!1), [w, M] = Y([]), [k, C] = Y(0), [S, D] = Y(null), [A, R] = Y(!1), L = j(!1), _ = j(null), O = j(null), U = j(!1);
  q(() => {
    t && r && r.trim() && d(r);
  }, [t, r, o]);
  const I = H(() => {
...
const wv = typeof navigator < "u" && /Mac|iPod|iPhone|iPad/.test(navigator.platform), ut = wv ? "⌘" : "Ctrl", kv = ({ editor: e }) => {
  const [t, n] = Y(!1), [o, r] = Y(0), [s, a] = Y(0), [i, l] = Y(""), [c, u] = Y(""), [d, f] = Y(!1), [p, g] = Y(!1);
  q(() => {
    if (!e) return;
    const M = () => {
      const C = e.storage.selectAllOccurrences;
      C ? (n(C.isActive), r(C.ranges.length), a(C.allMatches.length), l(C.searchTerm), u(C.typedBuffer), f(C.isTypingReplace), g(C.isIncremental)) : (n(!1), r(0), a(0));
    }, k = () => {
      M();
    };
...
function Av(e) {
  return Dv(), new Ie({
    ...
    state: {
      ...
      apply(t, n, o, r) {
        return !t.docChanged && Io ? Io.map(t.mapping, t.doc) : (Io = Pv(r.doc, e), Io);
      }
    },
    props: {
      decorations(t) {
    ...
    if (o.type.name === "tableCell" || o.type.name === "tableHeader") {
      const s = Ye.widget(r + 1, (a) => {
        ...
        return l.style.cssText = "width:18px;height:18px;display:flex;align-items:center;justify-content:center;background:" + u + ";border:1px solid " + d + ";border-radius:4px;cursor:pointer;opacity:0;transition:opacity 0.15s ease,background-color 0.15s ease,transform 0.1s ease;color:" + f + ";pointer-events:auto;padding:0;", l.addEventListener("mouseenter", () => {
          ...
          t.chain().focus().setTextSelection(r + 1).run(), Iv(g, t, r, h);
        }), i.appendChild(l), i;
      }, { side: -1, key: "menu-" + r });
      n.push(s);
    }
...
function Iv(e, t, n, o) {
  ...
  const p = document.documentElement.classList.contains("dark"), g = p ? "#1f1f1f" : "#ffffff", h = p ? "#3a3a3a" : "#e5e5e5", b = p ? "#e5e5e5" : "#333333";
  s.style.cssText = "position:fixed;top:" + d + "px;left:" + f + "px;z-index:99999;display:flex;flex-direction:column;gap:2px;min-width:170px;max-width:220px;width:auto;padding:6px;background:" + g + ";border:1px solid " + h + ";border-radius:8px;box-shadow:0 8px 24px rgba(0,0,0,0.15),0 2px 6px rgba(0,0,0,0.1);color:" + b + ";font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,sans-serif;pointer-events:auto;";
  ...
  const y = [
    ...
    { label: "divider" },
    { label: "Copy Table", icon: "copy", action: () => Rv(t) }
  ], E = {
...
}), Ov = Pm.extend({}), Bn = new Re("tableSorting");
let Bt = null, _n = null;
function _v(e) {
...
function Bv(e, t, n, o) {
  ...
  return s.style.cssText = "display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;padding:0;font-size:10px;color:" + (e ? i : l) + ";background:transparent;border:none;border-radius:3px;cursor:pointer;user-select:none;transition:all 0.15s ease;opacity:" + (e ? "1" : "0.5") + ";pointer-events:auto;vertical-align:middle;", s.addEventListener("mouseenter", () => {
    ...
    u.preventDefault(), u.stopPropagation(), Wv(o, t, n);
  ...
  return new Ie({
    ...
    state: {
      ...
      apply(t, n, o, r) {
        ...
        return !t.docChanged && !s?.updated && _n ? _n.map(t.mapping, t.doc) : (_n = Fv(r.doc, e), _n);
      }
    },
    props: {
      decorations(t) {
        ...
        if (a.type.name === "tableRow") {
          ...
          a.forEach((u, d) => {
            if (u.type.name === "tableHeader") {
              ...
              const h = Bt?.tablePos === s && Bt?.columnIndex === l ? Bt.direction : null, b = l, v = s, N = Ye.widget(p, () => Bv(h, v, b, t), { side: 1, key: "sort-" + s + "-" + b });
              n.push(N);
            }
            c += u.nodeSize, l++;
          });
      ...
      new Ie({
        ...
        props: {
          handleTextInput(n, o, r, s) {
            ...
            if (!u) return !1;
            const d = u[2] === "x", f = i.start() + (u.index || 0), p = o, g = a.tr;
            g.delete(f, p);
            ...
            if (g.wrap(b, v), f > 1) {
              ...
              N && N.type === t && $m(g.doc, f - 1) && g.join(f - 1);
            }
    ...
    if (l && l.type.name === "paragraph") {
      const c = s + 1 + l.nodeSize - 1, u = Ye.widget(
        ...
        () => {
          ...
          return g.className = `collapsible-list-chevron ${i ? "collapsed" : "expanded"}`, g.setAttribute("data-list-item-id", a), g.setAttribute("contenteditable", "false"), g.setAttribute("tabindex", "-1"), g.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>', g.title = i ? "Click to expand" : "Click to collapse", g.addEventListener("click", (h) => {
            h.preventDefault(), h.stopPropagation();
            const b = g.classList.contains("collapsed");
            g.classList.remove("collapsed", "expanded"), g.classList.add(b ? "expanded" : "collapsed"), g.title = b ? "Click to collapse" : "Click to expand", t.collapsedItems.has(a) ? t.collapsedItems.delete(a) : t.collapsedItems.add(a), cn && cn.dispatch(
...
function Zv({ node: e, updateAttributes: t, extension: n }) {
  ...
  q(() => {
    ...
    const b = new IntersectionObserver(
      (v) => {
        for (const N of v)
          N.isIntersecting && (a(!0), b.unobserve(h));
      },
      {
        ...
        /* @__PURE__ */ m(
          "select",
          {
            ...
            children: [
              ...
              p.map((h) => /* @__PURE__ */ m("option", { value: h, children: h.charAt(0).toUpperCase() + h.slice(1) }, h, !1, {
                fileName: "/home/ubuntu/paragon/client/src/components/editor/extensions/CodeBlockWithFeatures.tsx",
                lineNumber: 267,
                columnNumber: 15
              }, this))
...
function Jv({ node: e, updateAttributes: t, editor: n }) {
  const [o, r] = Y(!1), [s, a] = Y(!1), [i, l] = Y(null), c = j(null), u = j(null), d = e.attrs.type || "info", f = Oo[d] || Oo.info, p = f.icon, g = H(() => {
    if (u.current) {
...
function Ht(e, t) {
  try {
    const o = (oN[e] ||= new Intl.DateTimeFormat("en-US", {
      timeZone: e,
...
function pu(e) {
  ...
  const f = Ht(e.timeZone, e), p = f > 0 ? Math.floor(f) : Math.ceil(f), h = -(/* @__PURE__ */ new Date(+e)).getTimezoneOffset() - p, b = p !== n, v = h - l;
  if (b && v) {
...
class Ae extends tt {
  ...
  toTimeString() {
    ...
    return `${t} GMT${n}${o}${r} (${nN(this.timeZone, this)})`;
  }
  toLocaleString(t, n) {
...
const hu = 6048e5, iN = 864e5, Ma = Symbol.for("constructDateFrom");
function xe(e, t) {
...
function Ln(e) {
  return (t, n = {}) => {
    ...
    if (!s)
      return null;
    const a = s[0], i = o && e.parsePatterns[o] || e.parsePatterns[e.defaultParseWidth], l = Array.isArray(i) ? BN(i, (d) => d.test(a)) : (
...
const FN = /^(\d+)(th|st|nd|rd)?/i, zN = /\d+/i, UN = {
  narrow: /^(b|a)/i,
...
function Tu(e, t) {
  const n = he(e, t?.in), o = +bn(n, t) - +t0(n, t);
  return Math.round(o / hu) + 1;
}
function pe(e, t) {
...
function c0(e, t, n) {
  const o = u0(e, t, n);
  if (console.warn(o), i0.includes(e)) throw new RangeError(o);
}
function u0(e, t, n) {
...
const d0 = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g, m0 = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g, f0 = /^'([^]*?)'?$/, p0 = /''/g, h0 = /[a-zA-Z]/;
function g0(e, t, n) {
  ...
  return l.map((u) => {
    ...
    const d = u.value;
    (!n?.useAdditionalWeekYearTokens && l0(d) || !n?.useAdditionalDayOfYearTokens && a0(d)) && c0(d, t, String(e));
    const f = Aa[d[0]];
...
function M0(e, t) {
  ...
  return t.getMonth(e) === t.getMonth(s) ? La : S0;
}
function Mu(e, t) {
...
class He {
   ...
   */
  constructor(t, n) {
    this.Date = Date, this.today = () => this.overrides?.today ? this.overrides.today() : this.options.timeZone ? Ae.tz(this.options.timeZone) : new this.Date(), this.newDate = (o, r, s) => this.overrides?.newDate ? this.overrides.newDate(o, r, s) : this.options.timeZone ? new Ae(o, r, s, this.options.timeZone) : new Date(o, r, s), this.addDays = (o, r) => this.overrides?.addDays ? this.overrides.addDays(o, r) : gu(o, r), this.addMonths = (o, r) => this.overrides?.addMonths ? this.overrides.addMonths(o, r) : bu(o, r), this.addWeeks = (o, r) => this.overrides?.addWeeks ? this.overrides.addWeeks(o, r) : cN(o, r), this.addYears = (o, r) => this.overrides?.addYears ? this.overrides.addYears(o, r) : uN(o, r), this.differenceInCalendarDays = (o, r) => this.overrides?.differenceInCalendarDays ? this.overrides.differenceInCalendarDays(o, r) : Nu(o, r), this.differenceInCalendarMonths = (o, r) => this.overrides?.differenceInCalendarMonths ? this.overrides.differenceInCalendarMonths(o, r) : hN(o, r), this.eachMonthOfInterval = (o) => this.overrides?.eachMonthOfInterval ? this.overrides.eachMonthOfInterval(o) : bN(o), this.eachYearOfInterval = (o) => {
      const r = this.overrides?.eachYearOfInterval ? this.overrides.eachYearOfInterval(o) : yN(o), s = new Set(r.map((i) => this.getYear(i)));
      if (s.size === r.length)
        return r;
      const a = [];
      return s.forEach((i) => {
    ...
    }, this.endOfBroadcastWeek = (o) => this.overrides?.endOfBroadcastWeek ? this.overrides.endOfBroadcastWeek(o) : D0(o, this), this.endOfISOWeek = (o) => this.overrides?.endOfISOWeek ? this.overrides.endOfISOWeek(o) : xN(o), this.endOfMonth = (o) => this.overrides?.endOfMonth ? this.overrides.endOfMonth(o) : gN(o), this.endOfWeek = (o, r) => this.overrides?.endOfWeek ? this.overrides.endOfWeek(o, r) : ku(o, this.options), this.endOfYear = (o) => this.overrides?.endOfYear ? this.overrides.endOfYear(o) : NN(o), this.format = (o, r, s) => {
      const a = this.overrides?.format ? this.overrides.format(o, r, this.options) : g0(o, r, this.options);
      return this.options.numerals && this.options.numerals !== "latn" ? this.replaceDigits(a) : a;
    }, this.getISOWeek = (o) => this.overrides?.getISOWeek ? this.overrides.getISOWeek(o) : Cu(o), this.getMonth = (o, r) => this.overrides?.getMonth ? this.overrides.getMonth(o, this.options) : N0(o, this.options), this.getYear = (o, r) => this.overrides?.getYear ? this.overrides.getYear(o, this.options) : y0(o, this.options), this.getWeek = (o, r) => this.overrides?.getWeek ? this.overrides.getWeek(o, this.options) : Tu(o, this.options), this.isAfter = (o, r) => this.overrides?.isAfter ? this.overrides.isAfter(o, r) : x0(o, r), this.isBefore = (o, r) => this.overrides?.isBefore ? this.overrides.isBefore(o, r) : w0(o, r), this.isDate = (o) => this.overrides?.isDate ? this.overrides.isDate(o) : yu(o), this.isSameDay = (o, r) => this.overrides?.isSameDay ? this.overrides.isSameDay(o, r) : fN(o, r), this.isSameMonth = (o, r) => this.overrides?.isSameMonth ? this.overrides.isSameMonth(o, r) : k0(o, r), this.isSameYear = (o, r) => this.overrides?.isSameYear ? this.overrides.isSameYear(o, r) : C0(o, r), this.max = (o) => this.overrides?.max ? this.overrides.max(o) : dN(o), this.min = (o) => this.overrides?.min ? this.overrides.min(o) : mN(o), this.setMonth = (o, r) => this.overrides?.setMonth ? this.overrides.setMonth(o, r) : E0(o, r), this.setYear = (o, r) => this.overrides?.setYear ? this.overrides.setYear(o, r) : T0(o, r), this.startOfBroadcastWeek = (o, r) => this.overrides?.startOfBroadcastWeek ? this.overrides.startOfBroadcastWeek(o, this) : Mu(o, this), this.startOfDay = (o) => this.overrides?.startOfDay ? this.overrides.startOfDay(o) : qn(o), this.startOfISOWeek = (o) => this.overrides?.startOfISOWeek ? this.overrides.startOfISOWeek(o) : Gn(o), this.startOfMonth = (o) => this.overrides?.startOfMonth ? this.overrides.startOfMonth(o) : vN(o), this.startOfWeek = (o, r) => this.overrides?.startOfWeek ? this.overrides.startOfWeek(o, this.options) : bn(o, this.options), this.startOfYear = (o) => this.overrides?.startOfYear ? this.overrides.startOfYear(o) : wu(o), this.options = { locale: gi, ...t }, this.overrides = n;
  }
  /**
...
function sy(e, t, n, o, r) {
  const { disabled: s, hidden: a, modifiers: i, showOutsideDays: l, broadcastCalendar: c, today: u } = t, { isSameDay: d, isSameMonth: f, startOfMonth: p, isBefore: g, endOfMonth: h, isAfter: b } = r, v = n && p(n), N = o && h(o), y = {
    [ge.focused]: [],
    [ge.outside]: [],
    [ge.disabled]: [],
    [ge.hidden]: [],
  ...
  for (const x of e) {
    const { date: w, displayMonth: M } = x, k = !!(M && !f(w, M)), C = !!(v && g(w, v)), S = !!(N && b(w, N)), D = !!(s && ft(w, s, r)), A = !!(a && ft(w, a, r)) || C || S || // Broadcast calendar will show outside days as default
...
const hy = $u, gy = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  formatCaption: _u,
  formatDay: uy,
...
const Ry = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  labelPrevious: My,
  labelWeekNumber: Ay,
  labelWeekNumberHeader: Py,
  labelWeekday: Dy,
  labelYearDropdown: Iy
}, Symbol.toStringTag, { value: "Module" })), oo = (e) => e instanceof HTMLElement ? e : null, Jr = (e) => [
  ...e.querySelectorAll("[data-animated-month]") ?? []
], Ly = (e) => oo(e.querySelector("[data-animated-month]")), es = (e) => oo(e.querySelector("[data-animated-caption]")), ts = (e) => oo(e.querySelector("[data-animated-weeks]")), Oy = (e) => oo(e.querySelector("[data-animated-nav]")), _y = (e) => oo(e.querySelector("[data-animated-weekdays]"));
function $y(e, t, { classNames: n, months: o, focused: r, dateLib: s }) {
  ...
  sr(() => {
    ...
    if (h instanceof HTMLElement ? (Jr(h).forEach((y) => {
...
function Wy(e, t, n, o) {
  const r = e[0], s = e[e.length - 1], { ISOWeek: a, fixedWeeks: i, broadcastCalendar: l } = n ?? {}, { addDays: c, differenceInCalendarDays: u, differenceInCalendarMonths: d, endOfBroadcastWeek: f, endOfISOWeek: p, endOfMonth: g, endOfWeek: h, isAfter: b, startOfBroadcastWeek: v, startOfISOWeek: N, startOfWeek: y } = o, E = l ? v(r, o) : a ? N(r) : y(r), x = l ? f(s) : a ? p(g(s)) : h(g(s)), w = u(x, E), M = d(s, r) + 1, k = [];
  for (let D = 0; D <= w; D++) {
    const A = c(E, D);
    if (t && b(A, t))
      break;
...
function Fy(e, t, n, o) {
  const { addDays: r, endOfBroadcastWeek: s, endOfISOWeek: a, endOfMonth: i, endOfWeek: l, getISOWeek: c, getWeek: u, startOfBroadcastWeek: d, startOfISOWeek: f, startOfWeek: p } = o, g = e.reduce((h, b) => {
    ...
    const x = y.reduce((M, k) => {
      ...
      return S ? S.days.push(D) : M.push(new P0(C, [D])), M;
    }, []), w = new A0(b, x);
    return h.push(w), h;
  }, []);
...
function Vy(e, t) {
  const [n, o] = zy(e, t), { startOfMonth: r, endOfMonth: s } = t, a = Oa(e, n, o, t), [i, l] = wr(
    a,
  ...
  const c = Hy(i, o, e, t), u = Wy(c, e.endMonth ? s(e.endMonth) : void 0, e, t), d = Fy(c, u, e, t), f = jy(d), p = By(d), g = Yy(i, n, e, t), h = Uy(i, o, e, t), { disableNavigation: b, onMonthChange: v } = e, N = (w) => f.some((M) => M.days.some((k) => k.isEqualTo(w))), y = (w) => {
    if (b)
      return;
    let M = r(w);
...
function Gy(e, t, n, o, r, s, a) {
  const { ISOWeek: i, broadcastCalendar: l } = s, { addDays: c, addMonths: u, addWeeks: d, addYears: f, endOfBroadcastWeek: p, endOfISOWeek: g, endOfWeek: h, max: b, min: v, startOfBroadcastWeek: N, startOfISOWeek: y, startOfWeek: E } = a;
  let w = {
    day: c,
    week: d,
    month: u,
...
function Hu(e, t, n, o, r, s, a, i = 0) {
  if (i > 365)
    return;
  const l = Gy(e, t, n.date, o, r, s, a), c = !!(s.disabled && ft(l, s.disabled, a)), u = !!(s.hidden && ft(l, s.hidden, a)), d = l, f = new Du(l, d, a);
  return !c && !u ? f : Hu(e, t, f, o, r, s, a, i + 1);
}
function qy(e, t, n, o, r) {
  const { autoFocus: s } = e, [a, i] = Y(), l = Ky(t.days, n, o || (() => !1), a), [c, u] = Y(s ? l : void 0);
  return {
    ...
    moveFocus: (h, b) => {
      if (!c)
        return;
      const v = Hu(h, b, c, t.navStart, t.navEnd, e, r);
      v && (e.disableNavigation && !t.days.some((y) => y.isEqualTo(v)) || (t.goToDay(v), u(v)));
    }
  };
}
function Xy(e, t) {
  const { selected: n, required: o, onSelect: r } = e, [s, a] = wr(n, r ? n : void 0), i = r ? n : s, { isSameDay: l } = t, c = (p) => i?.some((g) => l(g, p)) ?? !1, { min: u, max: d } = e;
  return {
    selected: i,
    select: (p, g, h) => {
      let b = [...i ?? []];
...
function Zy(e, t, n = 0, o = 0, r = !1, s = it) {
...
function Jy(e, t, n = it) {
  const o = Array.isArray(t) ? t : [t];
  if (o.filter((i) => typeof i != "function").some((i) => typeof i == "boolean" ? i : n.isDate(i) ? mt(e, i, !1, n) : Ou(i, n) ? i.some((l) => mt(e, l, !1, n)) : bi(i) ? i.from && i.to ? $a(e, { from: i.from, to: i.to }, n) : !1 : Lu(i) ? Qy(e, i.dayOfWeek, n) : Pu(i) ? n.isAfter(i.before, i.after) ? $a(e, {
...
function ex(e, t) {
  ...
  return {
    selected: c,
    select: (f, p, g) => {
      const { min: h, max: b } = e, v = f ? Zy(f, c, h, b, s, t) : void 0;
      return o && n && v?.from && v.to && Jy({ from: v.from, to: v.to }, n, t) && (v.from = f, v.to = void 0), a || l(v), a?.(v, f, p, g), v;
    },
...
function nx(e, t) {
  const n = tx(e, t), o = Xy(e, t), r = ex(e, t);
  switch (e.mode) {
    case "single":
      return n;
    case "multiple":
...
function ox(e) {
  ...
  const { components: n, formatters: o, labels: r, dateLib: s, locale: a, classNames: i } = zt(() => {
    ...
    return {
      ...
      components: ay(t.components),
      formatters: by(t.formatters),
      labels: { ...Ry, ...t.labels },
      locale: oe,
    ...
    t.labels,
    t.classNames
  ]), { captionLayout: l, mode: c, navLayout: u, numberOfMonths: d = 1, onDayBlur: f, onDayClick: p, onDayFocus: g, onDayKeyDown: h, onDayMouseEnter: b, onDayMouseLeave: v, onNextClick: N, onPrevClick: y, showWeekNumber: E, styles: x } = t, { formatCaption: w, formatDay: M, formatMonthDropdown: k, formatWeekNumber: C, formatWeekNumberHeader: S, formatWeekdayName: D, formatYearDropdown: A } = o, R = Vy(t, s), { days: L, months: _, navStart: O, navEnd: U, previousMonth: I, nextMonth: P, goToMonth: W } = R, K = sy(L, t, O, U, s), { isSelected: V, select: G, selected: Q } = nx(t, s) ?? {}, { blur: B, focused: $, isFocusTarget: z, moveFocus: Z, setFocused: ce } = qy(t, R, K, V ?? (() => !1), s), { labelDayButton: ue, labelGridcell: ve, labelGrid: Ee, labelMonthDropdown: Fe, labelNav: yt, labelPrevious: Mn, labelNext: Dn, labelWeekday: ro, labelWeekNumber: so, labelWeekNumberHeader: io, labelYearDropdown: ao } = r, lo = zt(() => yy(s, t.ISOWeek), [s, t.ISOWeek]), Rt = c !== void 0 || p !== void 0, Kt = H(() => {
    I && (W(I), y?.(I));
  }, [I, W, y]), Gt = H(() => {
    P && (W(P), N?.(P));
  }, [W, P, N]), co = H((oe, fe) => (ne) => {
  ...
  }), [i, t.className, t.style, x]), An = ly(t), fo = j(null);
  $y(fo, !!t.animate, {
    classNames: i,
    months: _,
    focused: $,
      ...
      X.createElement(
        ...
        _.map((oe, fe) => X.createElement(
          ...
          X.createElement(n.MonthCaption, { "data-animated-caption": t.animate ? "true" : void 0, className: i[te.MonthCaption], style: x?.[te.MonthCaption], calendarMonth: oe, displayIndex: fe }, l?.startsWith("dropdown") ? X.createElement(
            ...
            (() => {
              const ne = l === "dropdown" || l === "dropdown-months" ? X.createElement(n.MonthsDropdown, { key: "month", className: i[te.MonthsDropdown], "aria-label": Fe(), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: Mr(oe.date), options: vy(oe.date, O, U, o, s), style: x?.[te.Dropdown], value: s.getMonth(oe.date) }) : X.createElement("span", { key: "month" }, k(oe.date, s)), me = l === "dropdown" || l === "dropdown-years" ? X.createElement(n.YearsDropdown, { key: "year", className: i[te.YearsDropdown], "aria-label": ao(s.options), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: mo(oe.date), options: xy(O, U, o, s, !!t.reverseYears), style: x?.[te.Dropdown], value: s.getYear(oe.date) }) : X.createElement("span", { key: "year" }, A(oe.date, s));
          ...
          X.createElement(
            ...
            X.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: i[te.Weeks], style: x?.[te.Weeks] }, oe.weeks.map((ne) => X.createElement(
              ...
              ne.days.map((me) => {
                ...
                const po = Ny(de, x, t.modifiersStyles), Pn = iy(de, i, t.modifiersClassNames), qt = !Rt && !de.hidden ? ve(Te, de, s.options, s) : void 0;
                return (
  ...
  return /* @__PURE__ */ m(
    ox,
    {
      ...
      components: {
        ...
        Chevron: ({ className: c, orientation: u, ...d }) => u === "left" ? /* @__PURE__ */ m(Gd, { className: re("size-4", c), ...d }, void 0, !1, {
          fileName: "/home/ubuntu/paragon/client/src/components/ui/calendar.tsx",
          lineNumber: 139,
          columnNumber: 15
          ...
          this
        ) : /* @__PURE__ */ m(Xd, { className: re("size-4", c), ...d }, void 0, !1, {
          fileName: "/home/ubuntu/paragon/client/src/components/ui/calendar.tsx",
          lineNumber: 153,
          columnNumber: 13
        }, this),
...
const mx = new Re("datePillPaste"), fx = lr.create({
  name: "datePill",
  group: "inline",
  inline: !0,
  atom: !0,
          ...
          handlePaste(t, n) {
            ...
            for (; (b = h.exec(r)) !== null; ) {
              ...
              if (x) {
                ...
                w && p.push(f.text(w)), p.push(e.create({ date: x })), g = b.index + b[0].length;
              }
            }
            const v = r.slice(g);
...
function px({ node: e, selected: t, editor: n, getPos: o, deleteNode: r }) {
...
const hx = new Re("tagPillPaste"), gx = lr.create({
  name: "tagPill",
  group: "inline",
  inline: !0,
  atom: !0,
...
`) ? 1 : 0, w = r.slice(g, b.index + x);
                w && p.push(f.text(w)), p.push(e.create({ tag: y })), g = b.index + E.length;
              }
            }
            const v = r.slice(g);
            if (v && p.push(f.text(v)), p.length === 0) return !1;
...
}, Nx = ["info", "note", "prompt", "resources", "todo", "summary"];
function yx(e) {
...
function wx(e, t) {
  const { alt: n, align: o, width: r } = xx(e), s = {
    left: "margin-right: auto;",
    center: "margin-left: auto; margin-right: auto;",
    right: "margin-left: auto;"
...
function Wa(e) {
  ...
  for (const s of o) {
    const a = s.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
    a ? r.push(wx(a[1], a[2])) : r.push(`<p>${er(s.trim())}</p>`);
  }
  return r.join("");
}
function Uu(e) {
...
`), t = t.replace(/\*\*([^*]+)\*\*/g, "<strong>$1</strong>"), t = t.replace(/__([^_]+)__/g, "<strong>$1</strong>"), t = t.replace(new RegExp("(?<!\\*)\\*([^*]+)\\*(?!\\*)", "g"), "<em>$1</em>"), t = t.replace(new RegExp("(?<!_)_([^_]+)_(?!_)", "g"), "<em>$1</em>"), t = t.replace(/~~([^~]+)~~/g, "<s>$1</s>"), t = t.replace(new RegExp("(?<!`)==((?:(?!==)[^\\n])+)==(?!`)", "g"), "<mark>$1</mark>"), t = t.replace(/!\[([^\]]*)\]\(([^)]+)\)/g, (d, f, p) => {
    ...
    return `<img src="${p.trim()}" alt="${h}" data-align="${b}"${N}>`;
...
function ns(e, t, n) {
  ...
  return e.descendants((c, u) => {
    if (c.type.name === "heading" && n.levels.includes(c.attrs.level)) {
      ...
      const g = Ye.widget(u + c.nodeSize - 1, () => {
      ...
      new Ie({
        ...
        state: {
          ...
          apply(n, o, r, s) {
            ...
            return a || n.docChanged ? (n.docChanged && !a && Sx(r.doc, s.doc, e, t.levels), {
...
}), Dx = /\[([^\]]+)\]\(([^)]+)\)$/, Ax = /^(https?:\/\/|www\.)[^\s]+$/i, Px = Ze.create({
...
}), Ix = ["info", "note", "prompt", "resources", "todo"], Rx = Ze.create({
          ...
          handleKeyDown(t, n) {
            ...
            for (const u of Ix)
              if (c === `\`\`\`${u}`) {
                ...
                if (p && g) {
                  const h = g.create(), b = p.create({ type: u }, Gm.from(h));
                  d.insert(f, b);
...
}), _o = new Re("searchHighlight"), Lx = Ze.create({
              ...
              r.doc.descendants((g, h) => {
                if (g.isText && g.text) {
                  ...
                  for (; (b = p.exec(g.text)) !== null; ) {
                    const v = h + b.index, N = h + b.index + b[0].length, y = f === l;
                    d.push(
                      Ye.inline(v, N, {
      ...
      new Ie({
        ...
        props: {
          handleKeyDown(e, t) {
            ...
            const { state: n, dispatch: o } = e, r = _x(n);
            if (!r)
...
const Bx = /* @__PURE__ */ new Set([
  ...
  "codeBlock",
  "blockquote"
]), Fx = "tableRow", zx = /* @__PURE__ */ new Set(["tableCell", "tableHeader"]);
function Ux(e, t, n) {
  const o = e.resolve(t);
...
function Zx(e, t, n) {
  ...
  a(Ux(e, r, s)), Xx(e, t) && (a(Yx(e, r, s)), a(jx(e, r, s))), a(Kx(e, r, s)), a(Vx(e, r, s));
  const i = Gx(e);
  if (i.length > 0) {
    const l = qx(i, r, s);
    for (const c of l)
  ...
  addKeyboardShortcuts() {
    return {
      ...
      "Mod-a": ({ editor: e }) => {
        ...
        if (t.expansionDepth > 0 && r === t.lastExpandedFrom && s === t.lastExpandedTo || (t.expansionDepth = 0), o instanceof wm || r === 0 && s === n.content.size)
          return !0;
        const i = Zx(n, r, s);
        let l = null;
        for (const c of i)
...
}), Jx = /#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})\b/g;
function ew(e) {
  let t = e.replace("#", "");
...
const tw = new Re("hexColorDecoration");
function ju(e, t, n) {
  const o = [];
  return e.nodesBetween(t, n, (r, s) => {
    ...
    const a = r.text || "";
    let i;
    const l = new RegExp(Jx.source, "g");
    for (; (i = l.exec(a)) !== null; ) {
          ...
          handleKeyDown(t, n) {
            ...
            if ((n.metaKey || n.ctrlKey) && n.key === "z" && !n.shiftKey) {
              if (n.preventDefault(), e.isTypingReplace && e.undoStack.length > 0) {
                ...
                return e.typedBuffer = r, r === "" && (e.isTypingReplace = !1), qm(t.state, t.dispatch), setTimeout(() => {
                  const s = Tt(t);
            ...
            if ((n.metaKey || n.ctrlKey) && (n.key === "z" && n.shiftKey || n.key === "y")) {
              if (n.preventDefault(), e.redoStack.length > 0) {
                ...
                return e.typedBuffer = r, e.isTypingReplace = !0, Xm(t.state, t.dispatch), setTimeout(() => {
                  const s = Tt(t);
                  e.ranges = s, s.length === 0 && ke(e);
                }, 10), !0;
              }
...
async function dw(e, t, n) {
  return new Promise((o, r) => {
    ...
    a.onload = (i) => {
      ...
      const d = e.type === "image/png" || e.type === "image/gif", f = d ? "image/png" : "image/jpeg", p = d ? void 0 : n, g = c.toDataURL(f, p), h = lw(g, e.name);
...
async function za(e, t, n) {
  ...
  try {
    ...
    try {
      ...
      return console.warn("Image upload failed, removing placeholder:", p), mw(t, r, e.name), n.onUploadError?.(`Upload failed: ${p instanceof Error ? p.message : "Unknown error"}`), n.onUploadComplete?.(), !1;
    }
  } catch (r) {
...
function pw({
  ...
  return zt(() => {
      ...
      Zm.extend({
        addInputRules() {
          ...
          return [
            new Oe({
              find: /^(?:---|—-|___\s|\*\*\*\s)$/,
              handler: ({ state: h, range: b }) => {
                const { tr: v } = h, N = b.from, y = b.to;
                v.delete(N, y);
                const E = v.doc.resolve(N), x = g.create(), w = E.before(E.depth), M = E.after(E.depth);
                v.replaceWith(w, M, x);
                ...
                if (k < v.doc.content.size) {
                  ...
                  const S = h.schema.nodes.paragraph.create();
    ...
    ), s.codeBlocks || p.push(Qv), s.callouts || p.push(eN, Rx), i && !s.collapsibleHeadings && !u && p.push(
      Mx.configure({
        levels: r
      })
    ), s.images || p.push(
    ...
    ), a && p.push(Qx), c && !u && p.push(ow), s.markdownPaste || p.push(
      Ex.configure({
        enableMarkdownPaste: !0
      })
    ), p;
...
` : ""
  ...
  n.use(t), n.addRule("highlight", {
    ...
    filter: "img",
    replacement: (l, c) => {
      const u = c, d = u.getAttribute("src") || "", p = (u.getAttribute("alt") || "").replace(/\s*\|\s*(?:left|center|right)?\s*(?:\|\s*\d+)?\s*$/, "").trim(), g = u.getAttribute("width"), h = g ? parseInt(g, 10) : null, b = u.getAttribute("data-align") || "left", v = [p], N = b !== "left", y = h && h > 0;
      return (N || y) && v.push(N ? b : "left"), y && v.push(String(h)), `![${v.join(" | ")}](${d})`;
    }
    ...
    replacement: (l, c) => {
      ...
      if (!u) return l;
      const d = u.getAttribute("src") || "", p = (u.getAttribute("alt") || "").replace(/\s*\|\s*(?:left|center|right)?\s*(?:\|\s*\d+)?\s*$/, "").trim(), g = u.getAttribute("width"), h = g ? parseInt(g, 10) : null, b = u.getAttribute("data-align") || "left", v = [p], N = b !== "left", y = h && h > 0;
      (N || y) && v.push(N ? b : "left"), y && v.push(String(h));
...
`
  ...
  function a(l, c, u = 0) {
    ...
    p.forEach((h, b) => {
      const v = h.getAttribute("data-type") === "taskItem", N = h.getAttribute("data-checked") === "true", y = s(h);
      v ? c.push(`${d}- [${N ? "x" : " "}] ${y}`) : f === "OL" ? c.push(`${d}${g + b}. ${y}`) : c.push(`${d}- ${y}`);
  ...
  return n.addRule("table", {
    ...
    replacement: function(l, c) {
      ...
      let p = !1;
      d.forEach((h, b) => {
        const v = Array.from(h.querySelectorAll("th, td")), N = v.map((y) => i(y));
...
function bw() {
  const e = j(null);
  return e.current || (e.current = gw()), e.current;
}
function vw(e) {
  const {
    extensions: t,
          ...
          if (d.querySelectorAll("img").length === 0)
            ...
            if (g.forEach((b) => {
              if (b.nodeType === Node.ELEMENT_NODE && b.tagName === "IMG") {
                if (h.length > 0) {
                  const x = n.createElement("p");
                  h.forEach((w) => x.appendChild(w.cloneNode(!0))), x.textContent?.trim() && c.push(x), h.length = 0;
                }
...
function Ya(e) {
  if (/<img\s/i.test(e)) {
    const t = /(<img\s[^>]*\/?>)/gi;
    return e.split(t).filter((o) => o.trim()).map((o) => /^<img\s/i.test(o) ? kw(o) : o.trim() ? `<p>${or(o.trim())}</p>` : "").join("");
  }
  if (/^!\[/.test(e)) {
    const t = e.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
    if (t)
...
function Sw(e, t, n = {}) {
  ...
  return u.forEach((f) => {
    ...
    let b = "", v = "left", N = null;
    h.length === 1 ? b = h[0] : h.length === 2 ? (b = h[0], /^\d+$/.test(h[1]) ? N = h[1] : ["left", "center", "right"].includes(h[1]) ? v = h[1] : b = p) : h.length === 3 ? (b = h[0], ["left", "center", "right"].includes(h[1]) && (v = h[1]), /^\d+$/.test(h[2]) && (N = h[2])) : b = p;
  ...
  )), c = c.split(/(```[\s\S]*?```|`[^`\n]+`)/g).map((f, p) => p % 2 === 1 ? f : f.replace(/\[\[([^\[\]]+)\]\]/g, (g, h) => `<span data-wiki-link data-page-name="${h.trim()}" class="wiki-link">${h.trim()}</span>`)).join(""), c;
}
function Mw(e) {
  let t = e;
  return t = t.replace(
  ...
  ), t = Nw(t), t = xw(t), t = ww(t), t = Tw(t), t;
}
function Dw(e, t, n = {}) {
  const o = Sw(e, t, n), r = t(o);
  return Mw(r);
}
function Aw(e, t, n) {
  q(() => {
          ...
          try {
            ...
            if (d) {
              ...
              if (p && g) {
                ...
                h.delete(b, v);
                const y = h.doc.resolve(b).blockRange();
                if (y) {
                  const E = [
                    { type: p, attrs: {} },
                    { type: g, attrs: { checked: f } }
                  ];
                  h.wrap(y, E), e.view.dispatch(h);
                  return;
                }
              }
...
function Lw(e, t = {}) {
  const {
    ...
    const d = u.trim(), f = d.length > 0 ? d.split(/\s+/).filter((N) => N.length > 0).length : 0, p = d.replace(/\s/g, "").length, g = u.length;
    let h = 0, b = 0;
    o && (h = d.length > 0 ? d.split(/\n\s*\n/).filter((N) => N.trim().length > 0).length : 0, b = d.length > 0 ? (d.match(/[.!?]+/g) || []).length : 0);
    const v = Math.max(1, Math.ceil(f / Rw));
    return {
      words: f,
      characters: p,
...
function Ow({ status: e, lastSaved: t, className: n = "" }) {
  const o = (r) => {
    if (!r) return "";
    ...
    "div",
    {
      ...
      children: [
        e === "idle" && t && /* @__PURE__ */ m(Ce, { children: [
          /* @__PURE__ */ m(Zd, { className: "w-3.5 h-3.5 text-muted-foreground" }, void 0, !1, {
        ...
        e === "error" && /* @__PURE__ */ m(Ce, { children: [
          /* @__PURE__ */ m(Qd, { className: "w-3.5 h-3.5 text-red-500" }, void 0, !1, {
            fileName: "/home/ubuntu/paragon/client/src/components/editor/AutoSaveIndicator.tsx",
            lineNumber: 61,
            columnNumber: 11
          }, this),
...
function _w({ onRecover: e, onDismiss: t, className: n = "" }) {
  return /* @__PURE__ */ m(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ m("div", { className: "flex items-center gap-3 min-w-0", children: [
          /* @__PURE__ */ m(Jd, { className: "w-5 h-5 recovery-banner-icon flex-shrink-0" }, void 0, !1, {
...
function $w({
  ...
  const c = j(null), u = j(null), d = j(null), f = j(null), p = 5e3, g = 80, [h, b] = Y(() => {
    const k = $o(e);
    return Wo(e, k, a, i);
  }), v = j(null), N = zt(() => {
    if (e.length <= p) {
...
const Bw = vn(function({
  ...
  const [r, s] = Y(!1), [a, i] = Y({
    ...
    domNodes: 0,
    longFrames: 0
  }), l = j([]), c = j(performance.now()), u = j(0), d = j(0), f = j(0), p = j(0), [g, h] = Y(new Array(60).fill(0)), [b, v] = Y(new Array(60).fill(0));
  q(() => {
    if (!t || !o) return;
    const M = () => {
    ...
    const S = (D) => {
      ...
      if (c.current = D, l.current.push({ time: D, duration: A }), l.current.length > 120 && (l.current = l.current.slice(-120)), A > 16.67 && d.current++, M++, D - k >= 1e3) {
        ...
        }), h((V) => [...V.slice(1), C]), v((V) => [...V.slice(1), L]), d.current = 0;
      }
  ...
  return /* @__PURE__ */ m("div", { className: "perf-profiler-overlay", children: [
    /* @__PURE__ */ m("div", { className: "perf-profiler-header", children: [
      /* @__PURE__ */ m("div", { className: "perf-profiler-title", children: [
        /* @__PURE__ */ m(em, { size: 14 }, void 0, !1, {
          fileName: "/home/ubuntu/paragon/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 241,
          columnNumber: 11
        }, this),
  ...
  render() {
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ m("div", { className: re("flex-1 flex items-center justify-center p-6", this.props.className), children: /* @__PURE__ */ m("div", { className: "flex flex-col items-center max-w-md w-full text-center gap-4", children: [
        /* @__PURE__ */ m("div", { className: "w-12 h-12 rounded-full bg-destructive/10 flex items-center justify-center", children: /* @__PURE__ */ m(tm, { className: "w-6 h-6 text-destructive" }, void 0, !1, {
...
function Fw({ className: e = "", theme: t }) {
  const n = (o) => ({
    height: "1rem",
    width: o,
...
function zw({ editorMode: e, onModeSwitch: t }) {
  return /* @__PURE__ */ m("div", { className: "editor-mode-toggle mr-2 sm:mr-3", children: [
    /* @__PURE__ */ m(
      "button",
      {
        ...
        title: "Visual Editor",
        children: /* @__PURE__ */ m(om, {}, void 0, !1, {
...
const Ue = ({ onMouseDown: e, isActive: t, disabled: n, children: o, title: r }) => /* @__PURE__ */ m(
...
], Uw = vn(function({ editor: t, isH1: n, isH2: o, isH3: r, isH4: s, isH5: a, executeCommand: i }) {
  const [l, c] = Y(!1), u = j(null), d = n ? "h1" : o ? "h2" : r ? "h3" : s ? "h4" : a ? "h5" : "paragraph", f = Ga.find((g) => g.value === d)?.shortLabel || "P";
  q(() => {
    if (!l) return;
    const g = (h) => {
...
}), Yw = vn(function({ editor: t, className: n = "", suppressWhenLinkPopoverOpen: o = !1, aiEnabled: r = !1, onAISparklesClick: s }) {
  const a = j(null), i = tl({
    editor: t,
    selector: ({ editor: C }) => ({
  ...
  }), [l, c] = Y(!1), [u, d] = Y(""), [f, p] = Y(!1), [g, h] = Y({ top: 0, left: 0 }), b = j(null), v = j(null), N = j(null), y = H(() => {
    if (u) {
      let C = u.trim();
    ...
    const C = () => {
      if (!t.isDestroyed)
        try {
          ...
          let Z = U.top - W - 10 - Q;
          Z < K && (Z = I.bottom + 10 - Q), f ? h({ top: Math.max(K, Z), left: $ }) : (N.current && clearTimeout(N.current), N.current = setTimeout(() => {
            h({ top: Math.max(K, Z), left: $ }), p(!0);
          }, 50));
        } catch (S) {
      ...
      children: [
        ...
        /* @__PURE__ */ m(
          Ue,
          {
            ...
            title: "Code Block",
            children: /* @__PURE__ */ m(rm, { size: M }, void 0, !1, {
              fileName: "/home/ubuntu/paragon/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 568,
              columnNumber: 9
            }, this)
...
function jw({ editor: e, isOpen: t, onClose: n }) {
  ...
  q(() => {
    if (t) {
      ...
      r(g);
      try {
        const { view: h } = e, { from: b } = h.state.selection, v = h.coordsAtPos(b), N = v.bottom + 8, y = Math.max(16, Math.min(v.left, window.innerWidth - 420));
        l({ top: N, left: y });
      } catch {
...
function Vw({ editor: e, onEditLink: t }) {
  const [n, o] = Y({
    isVisible: !1,
    url: "",
  ...
  const h = n.url.length > 40 ? n.url.substring(0, 40) + "..." : n.url, v = (e.view.dom.closest(".markdown-editor-container") || e.view.dom.closest("[data-theme]"))?.getAttribute("data-theme") || "", N = /* @__PURE__ */ m(
    "div",
    {
      ref: r,
        ...
        /* @__PURE__ */ m(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ m("span", { className: "link-hover-tooltip-url", children: h || "No URL" }, void 0, !1, {
                fileName: "/home/ubuntu/paragon/client/src/components/editor/LinkHoverTooltip.tsx",
                lineNumber: 248,
                columnNumber: 11
              }, this)
        ...
        /* @__PURE__ */ m("div", { className: "link-hover-tooltip-actions", children: [
          ...
          /* @__PURE__ */ m(
            "button",
            {
              ...
              title: "Remove link",
              children: /* @__PURE__ */ m(am, { size: 14 }, void 0, !1, {
                fileName: "/home/ubuntu/paragon/client/src/components/editor/LinkHoverTooltip.tsx",
                lineNumber: 277,
                columnNumber: 13
              }, this)
...
], Gw = 32, qw = 8, Xw = 320, Zw = 210, Bo = 12;
function qa(e) {
  try {
...
function Qw({ editor: e }) {
  const [t, n] = Y(!1), [o, r] = Y(""), [s, a] = Y(0), [i, l] = Y(null), [c, u] = Y(!1), [d, f] = Y({ top: 0, left: 0 }), [p, g] = Y("below"), h = j(null), b = j(-1), v = j(!1);
  q(() => {
    v.current = t;
  }, [t]);
  const N = Kw.filter((C) => {
  ...
  sr(() => {
    ...
    let O;
    if (L >= y ? O = "below" : _ >= y ? O = "above" : O = L >= _ ? "below" : "above", g(O), h.current) {
      const U = Math.max(
        Bo,
        Math.min(D, R - Zw - Bo)
      ), I = O === "below" ? S + 4 : C - y - 4;
...
`)) {
    ...
    if (!t) return;
    const C = (S) => {
      h.current && !h.current.contains(S.target) && x();
    };
    ...
    const C = h.current.querySelector(".slash-item.is-selected");
...
const Jw = 340, e1 = 36, t1 = 8, n1 = 240, Ho = 8;
function Xa(e) {
  try {
    const t = window.getSelection();
    if (t && t.rangeCount > 0) {
...
function o1({ editor: e, onSearch: t, onCreateItem: n }) {
  const [o, r] = Y(!1), [s, a] = Y(""), [i, l] = Y([]), [c, u] = Y(0), [d, f] = Y(null), [p, g] = Y("below"), [h, b] = Y(!1), v = j(!1), N = j(null), y = j(-1), E = j(null);
  q(() => {
    v.current = o;
  }, [o]);
  const x = H(() => {
...
`) || _.includes("]]")) {
  ...
  if (sr(() => {
    ...
    let I;
    if (O >= k ? I = "below" : U >= k ? I = "above" : I = O >= U ? "below" : "above", g(I), N.current) {
      const P = Math.max(
        Ho,
        Math.min(R, _ - Jw - Ho)
      ), W = I === "below" ? A + 4 : D - k - 4;
...
function s1({ containerRef: e, enabled: t = !0 }) {
  ...
  return q(() => {
    ...
    /* @__PURE__ */ m("div", { className: "image-drop-zone-icon", children: /* @__PURE__ */ m(fm, { className: "w-12 h-12" }, void 0, !1, {
...
function a1({ actions: e, scope: t, onAction: n, onClose: o, position: r }) {
  ...
  return /* @__PURE__ */ m(Nt, { onMouseDown: (b) => b.preventDefault(), children: h }, void 0, !1, {
    fileName: "/home/ubuntu/paragon/client/src/components/editor/ai/AIDropdownMenu.tsx",
    lineNumber: 197,
    columnNumber: 5
  }, this);
...
function l1({
  ...
  }, [t, u]), p = e.status === "streaming" || e.status === "complete" ? e.result : "", g = e.status === "streaming" || e.status === "complete" ? e.actionLabel : "", h = e.status === "streaming", b = e.status === "complete", v = e.status === "error", N = H(() => {
          ...
          children: [
            /* @__PURE__ */ m("div", { className: "flex items-center justify-between px-3 py-2 border-b border-border bg-secondary/30", children: [
              /* @__PURE__ */ m("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
                h && /* @__PURE__ */ m(ml, { size: 12, className: "animate-spin" }, void 0, !1, {
...
function c1({
  ...
  return /* @__PURE__ */ m(Ce, { children: [
    !n.images && !n.dragAndDrop && /* @__PURE__ */ m(s1, { containerRef: o, enabled: r }, void 0, !1, {
    ...
    !n.slashCommands && /* @__PURE__ */ m(Qw, { editor: e, disabledFeatures: n }, void 0, !1, {
      fileName: "/home/ubuntu/paragon/client/src/components/editor/WYSIWYGOverlays.tsx",
      lineNumber: 150,
      columnNumber: 9
    }, this),
    !n.wikiLinks && w && /* @__PURE__ */ m(o1, { editor: e, onSearch: w }, void 0, !1, {
      fileName: "/home/ubuntu/paragon/client/src/components/editor/WYSIWYGOverlays.tsx",
      lineNumber: 155,
      columnNumber: 9
    }, this),
    ...
    !t && /* @__PURE__ */ m(Vw, { editor: e, onEditLink: x }, void 0, !1, {
      fileName: "/home/ubuntu/paragon/client/src/components/editor/WYSIWYGOverlays.tsx",
      lineNumber: 167,
      columnNumber: 9
    }, this),
...
function m1(e) {
  const [t, n] = Pd(d1, { status: "idle" }), o = j(null), r = H(async (i, l, c, u, d) => {
    if (e) {
      n({
...
const Ja = vn(function({
  ...
  q(() => {
    const $ = (Z) => {
      ...
      L.current && (L.current = !1, document.body.style.cursor = "", document.body.style.userSelect = "", D((Z) => (p1(Z), Z)));
    };
  ...
  return /* @__PURE__ */ m(Ce, { children: [
    b && /* @__PURE__ */ m(
      "button",
      {
        ...
        children: w ? /* @__PURE__ */ m(gm, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/paragon/client/src/components/editor/TableOfContents.tsx",
          lineNumber: 393,
          columnNumber: 24
        }, this) : /* @__PURE__ */ m(bm, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/paragon/client/src/components/editor/TableOfContents.tsx",
          lineNumber: 393,
          columnNumber: 56
        }, this)
  ...
  const [me] = Y(() => b1()), [Te, de] = Y(C), [po, Pn] = Y(""), qt = j(C), wt = j(""), at = j(null), [Ju, yi] = Y(0), ho = !!(xt && xt.length > 0 && oe), { state: ze, executeAction: go, abort: ed, reset: kt } = m1(oe), [td, Pr] = Y(null), [nd, od] = Y({ selectionTop: 0, selectionBottom: 0, selectionCenterX: 0 }), rd = j(oe);
  rd.current = oe;
  const xi = j(fe);
  xi.current = fe;
  ...
  }), { editor: le, turndownService: Ii } = vw({
    extensions: md,
    content: t,
    editable: a,
    autofocus: i,
...
` + De).run(), kt();
  ...
  if (!le)
    return /* @__PURE__ */ m(Fw, { className: l, theme: d }, void 0, !1, {
  ...
  return /* @__PURE__ */ m("div", { className: `markdown-editor-container ${f === "neutral" ? "color-theme-neutral" : ""} ${l}`, "data-theme": d, children: [
    ...
    c && /* @__PURE__ */ m("div", { className: "flex items-center bg-card/50 editor-toolbar-wrapper", children: [
      Q ? Q(le, Oi) : Oi,
      k && /* @__PURE__ */ m(zw, { editorMode: Te, onModeSwitch: Lr }, void 0, !1, {
        fileName: "/home/ubuntu/paragon/client/src/components/editor/MarkdownEditor.tsx",
        lineNumber: 890,
        columnNumber: 13
      }, this)
    ...
    /* @__PURE__ */ m(Cv, { editor: le }, void 0, !1, {
      fileName: "/home/ubuntu/paragon/client/src/components/editor/MarkdownEditor.tsx",
      lineNumber: 911,
      columnNumber: 7
    }, this),
      ...
      /* @__PURE__ */ m(
        Hw,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ m(u1, { scrollContainerRef: at }, void 0, !1, {
              fileName: "/home/ubuntu/paragon/client/src/components/editor/MarkdownEditor.tsx",
              lineNumber: 1007,
              columnNumber: 7
            }, this)
    ...
    /* @__PURE__ */ m(Bw, { visible: Er, onClose: Tr, editor: le }, void 0, !1, {
      fileName: "/home/ubuntu/paragon/client/src/components/editor/MarkdownEditor.tsx",
      lineNumber: 1044,
      columnNumber: 7
    }, this)
...
function bk({ node: e, updateAttributes: t }) {
...
export {
  Ow as AutoSaveIndicator,
  fk as Callout,
  Rx as CalloutInputRule,
  bk as CodeBlockComponent,
  Mx as CollapsibleHeading,
  qv as CollapsibleList,
  fx as DatePill,
  hk as EditorThemeProvider,
  yv as EditorToolbar,
  xv as FindReplace,
  Yw as FloatingToolbar,
  s1 as ImageDropZone,
  fw as ImageUpload,
  mk as MarkdownEditor,
  Px as MarkdownLinkInputRule,
  Ex as MarkdownPasteSafe,
  Uv as MixedBulletList,
  Kv as MixedListItem,
  Yv as MixedOrderedList,
  Vv as MixedTaskItem,
  jv as MixedTaskList,
  _w as RecoveryBanner,
  tN as ResizableImage,
  Lx as SearchHighlight,
  Cv as SelectAllActionBar,
  sw as SelectAllOccurrences,
  Qw as SlashCommands,
  $x as TabIndent,
  ...
  vx as WikiLinkSafe,
  x1 as applyTheme,
  pk as createCustomTheme,
  Zu as darkTheme,
  Ni as getDateVariant,
  rn as isValidTag,
  v1 as lightTheme,
  Xv as loadLanguageIfNeeded,
  be as lowlight,
  y1 as nordTheme,
  Fn as normalizeTag,
