...
import { Extension as ut, Node as Ro, mergeAttributes as Yn, InputRule as Qe, Mark as Sc } from "@tiptap/core";
  ...
  return new je({
    ...
    state: {
      ...
      apply(t, n, r, o) {
        ...
        return !t.docChanged && !s?.updated && fr ? fr.map(t.mapping, t.doc) : (fr = Em(o.doc, e), fr);
      }
    },
    props: {
      decorations(t) {
    ...
    return {
      toggleTaskList: () => ({ editor: e, commands: t, state: n, tr: r, dispatch: o, chain: s, can: i }) => {
        ...
        if (M) {
          ...
          return C >= 0 && Ta(r, C, u, m, y, { checked: !1 }), o(r), !0;
        }
...
Ne.register("javascript", Ca);
Ne.register("js", Ca);
Ne.register("jsx", Ca);
Ne.register("typescript", Ma);
Ne.register("ts", Ma);
Ne.register("tsx", Ma);
Ne.register("python", zc);
Ne.register("py", zc);
Ne.register("xml", Sa);
Ne.register("html", Sa);
Ne.register("svg", Sa);
...
async function _m(e) {
  ...
  try {
    ...
    for (const s of o)
      if (s.includes(e))
        for (const i of s)
          i !== e && !Ne.registered(i) && (Ne.register(i, r), Xr.add(i));
    return !0;
  } catch (n) {
...
function $m({ node: e, updateAttributes: t, extension: n }) {
  ...
  return /* @__PURE__ */ A(zn, { className: "code-block-wrapper", ref: l, children: [
...
const ot = ({ onMouseDown: e, isActive: t, disabled: n, children: r, title: o }) => /* @__PURE__ */ f(
  ...
  return /* @__PURE__ */ f(Wt, { onMouseDown: C, children: k });
}), Zr = {
  ...
  prompt: { icon: Rc, label: "Prompt", color: "var(--callout-prompt)", borderColor: "var(--callout-prompt-border)" },
...
function Um({ node: e, updateAttributes: t, editor: n }) {
  ...
  return /* @__PURE__ */ A(zn, { className: `callout callout-${u}${s ? " callout-collapsed" : ""}`, "data-callout": "", "data-type": u, children: [
    /* @__PURE__ */ A(
      "div",
      {
    ...
    return ({ node: t, editor: n, getPos: r }) => {
      ...
      u.addEventListener("click", (L) => {
        if (L.preventDefault(), L.stopPropagation(), T)
          ...
          U.bottom + 4 + ge > j && ($ = U.top - ge - 4 - te), z + Z < 8 && (z = 8 - Z), z + X + Z > ee - 8 && (z = ee - X - 8 - Z), m.style.top = `${$}px`, m.style.left = `${z}px`, m.style.display = "flex", T = !0, k();
        }
      });
      const E = (L) => {
...
function Bn(e, t) {
  const n = Er(), r = t?.weekStartsOn ?? t?.locale?.options?.weekStartsOn ?? n.weekStartsOn ?? n.locale?.options?.weekStartsOn ?? 0, o = Ce(e, t?.in), s = o.getDay(), i = (s < r ? 7 : 0) + s - r;
...
function Zc(e, t) {
  const n = Er(), r = t?.weekStartsOn ?? t?.locale?.options?.weekStartsOn ?? n.weekStartsOn ?? n.locale?.options?.weekStartsOn ?? 0, o = Ce(e, t?.in), s = o.getDay(), i = (s < r ? -7 : 0) + 6 - (s - r);
...
const Ap = /^(\d+)(th|st|nd|rd)?/i, Lp = /\d+/i, Pp = {
  narrow: /^(b|a)/i,
...
function Jc(e, t) {
  const n = Ce(e, t?.in), r = n.getFullYear(), o = Er(), s = t?.firstWeekContainsDate ?? t?.locale?.options?.firstWeekContainsDate ?? o.firstWeekContainsDate ?? o.locale?.options?.firstWeekContainsDate ?? 1, i = Oe(t?.in || e, 0);
...
function jp(e, t) {
  const n = Er(), r = t?.firstWeekContainsDate ?? t?.locale?.options?.firstWeekContainsDate ?? n.firstWeekContainsDate ?? n.locale?.options?.firstWeekContainsDate ?? 1, o = Jc(e, t), s = Oe(t?.in || e, 0);
...
function ah(e, t, n) {
  const r = Er(), o = n?.locale ?? r.locale ?? Ea, s = n?.firstWeekContainsDate ?? n?.locale?.options?.firstWeekContainsDate ?? r.firstWeekContainsDate ?? r.locale?.options?.firstWeekContainsDate ?? 1, i = n?.weekStartsOn ?? n?.locale?.options?.weekStartsOn ?? r.weekStartsOn ?? r.locale?.options?.weekStartsOn ?? 0, a = Ce(e, n?.in);
  if (!op(a))
...
function qh(e, t, n, r, o) {
  ...
  for (const x of e) {
    const { date: C, displayMonth: D } = x, k = !!(D && !m(C, D)), T = !!(b && h(C, b)), E = !!(v && y(C, v)), N = !!(s && Pt(C, s, o)), R = !!(i && Pt(C, i, o)) || T || E || // Broadcast calendar will show outside days as default
    ...
    k && w.outside.push(x), N && w.disabled.push(x), R && w.hidden.push(x), I && w.today.push(x), a && Object.keys(a).forEach((O) => {
      const H = a?.[O];
      H && Pt(C, H, o) && (M[O] ? M[O].push(x) : M[O] = [x]);
    });
  }
  return (x) => {
    const C = {
...
function Xh(e, t, n = {}) {
  return Object.entries(e).filter(([, o]) => o === !0).reduce((o, [s]) => (n[s] ? o.push(n[s]) : t[De[s]] ? o.push(t[De[s]]) : t[ct[s]] && o.push(t[ct[s]]), o), [t[oe.Day]]);
}
function Zh(e) {
  return {
    ...Gh,
...
], Mg = (e) => Nr(e.querySelector("[data-animated-month]")), gs = (e) => Nr(e.querySelector("[data-animated-caption]")), ys = (e) => Nr(e.querySelector("[data-animated-weeks]")), Sg = (e) => Nr(e.querySelector("[data-animated-nav]")), Tg = (e) => Nr(e.querySelector("[data-animated-weekdays]"));
function Eg(e, t, { classNames: n, months: r, focused: o, dateLib: s }) {
...
function Ag(e, t, n, r) {
  const { addDays: o, endOfBroadcastWeek: s, endOfISOWeek: i, endOfMonth: a, endOfWeek: c, getISOWeek: l, getWeek: d, startOfBroadcastWeek: u, startOfISOWeek: m, startOfWeek: p } = r, h = e.reduce((g, y) => {
    ...
    const x = w.reduce((D, k) => {
      const T = n.ISOWeek ? l(k) : d(k), E = D.find((R) => R.weekNumber === T), N = new rl(k, y, r);
      return E ? E.days.push(N) : D.push(new xh(T, [N])), D;
    }, []), C = new wh(y, x);
    return g.push(C), g;
  }, []);
...
function _g(e, t) {
  const [n, r] = Lg(e, t), { startOfMonth: o, endOfMonth: s } = t, i = Ri(e, n, r, t), [a, c] = Oo(
    i,
  ...
  const l = Rg(a, r, e, t), d = Dg(l, e.endMonth ? s(e.endMonth) : void 0, e, t), u = Ag(l, d, e, t), m = Og(u), p = Ng(u), h = Ig(a, n, e, t), g = Pg(a, r, e, t), { disableNavigation: y, onMonthChange: b } = e, v = (C) => m.some((D) => D.days.some((k) => k.isEqualTo(C))), w = (C) => {
    if (y)
      return;
    let D = o(C);
...
function $g(e, t, n, r) {
  ...
  for (const i of e) {
    const a = t(i);
    Ai(a) && (a[De.focused] && s < pt.FocusedModifier ? (o = i, s = pt.FocusedModifier) : r?.isEqualTo(i) && s < pt.LastFocused ? (o = i, s = pt.LastFocused) : n(i.date) && s < pt.Selected ? (o = i, s = pt.Selected) : a[De.today] && s < pt.Today && (o = i, s = pt.Today));
  }
  return o || (o = e.find((i) => Ai(t(i)))), o;
}
...
function pl(e, t, n, r, o, s, i, a = 0) {
  if (a > 365)
    return;
  const c = Hg(e, t, n.date, r, o, s, i), l = !!(s.disabled && Pt(c, s.disabled, i)), d = !!(s.hidden && Pt(c, s.hidden, i)), u = c, m = new rl(c, u, i);
...
function Ug(e, t, n = wt) {
  ...
  }, n) : Pt(e.from, a, n) || Pt(e.to, a, n) : al(a) || il(a) ? Pt(e.from, a, n) || Pt(e.to, a, n) : !1))
    return !0;
...
function Vg(e) {
  ...
  const { components: n, formatters: r, labels: o, dateLib: s, locale: i, classNames: a } = An(() => {
    const le = { ...Ea, ...t.locale };
    return {
      dateLib: new nt({
        locale: le,
    ...
    t.labels,
    t.classNames
  ]), { captionLayout: c, mode: l, navLayout: d, numberOfMonths: u = 1, onDayBlur: m, onDayClick: p, onDayFocus: h, onDayKeyDown: g, onDayMouseEnter: y, onDayMouseLeave: b, onNextClick: v, onPrevClick: w, showWeekNumber: M, styles: x } = t, { formatCaption: C, formatDay: D, formatMonthDropdown: k, formatWeekNumber: T, formatWeekNumberHeader: E, formatWeekdayName: N, formatYearDropdown: R } = r, I = _g(t, s), { days: O, months: H, navStart: B, navEnd: q, previousMonth: P, nextMonth: L, goToMonth: U } = I, X = qh(O, t, B, q, s), { isSelected: G, select: Z, selected: te } = Kg(t, s) ?? {}, { blur: $, focused: z, isFocusTarget: j, moveFocus: ee, setFocused: ge } = Wg(t, I, X, G ?? (() => !1), s), { labelDayButton: ye, labelGridcell: Re, labelGrid: We, labelMonthDropdown: rt, labelNav: zt, labelPrevious: er, labelNext: tr, labelWeekday: Or, labelWeekNumber: _r, labelWeekNumberHeader: $r, labelYearDropdown: Hr } = o, vn = An(() => dg(s, t.ISOWeek), [s, t.ISOWeek]), nr = l !== void 0 || p !== void 0, bn = Y(() => {
    P && (U(P), w?.(P));
  }, [P, U, w]), wn = Y(() => {
    L && (U(L), v?.(L));
  }, [U, L, v]), Wr = Y((le, Me) => (ae) => {
  ...
  return J.createElement(
    ...
    J.createElement(
      ...
      J.createElement(
        ...
        !t.hideNavigation && !d && J.createElement(n.Nav, { "data-animated-nav": t.animate ? "true" : void 0, className: a[oe.Nav], style: x?.[oe.Nav], "aria-label": zt(), onPreviousClick: bn, onNextClick: wn, previousMonth: P, nextMonth: L }),
        H.map((le, Me) => J.createElement(
          ...
          d === "around" && !t.hideNavigation && Me === 0 && J.createElement(
            ...
            { type: "button", className: a[oe.PreviousMonthButton], tabIndex: P ? void 0 : -1, "aria-disabled": P ? void 0 : !0, "aria-label": er(P), onClick: bn, "data-animated-button": t.animate ? "true" : void 0 },
            J.createElement(n.Chevron, { disabled: P ? void 0 : !0, className: a[oe.Chevron], orientation: t.dir === "rtl" ? "right" : "left" })
          ),
          J.createElement(n.MonthCaption, { "data-animated-caption": t.animate ? "true" : void 0, className: a[oe.MonthCaption], style: x?.[oe.MonthCaption], calendarMonth: le, displayIndex: Me }, c?.startsWith("dropdown") ? J.createElement(
            ...
            J.createElement(n.CaptionLabel, { className: a[oe.CaptionLabel], role: "status", "aria-live": "polite" }, C(le.date, s.options, s))
          )),
          ...
          Me === u - 1 && d === "after" && !t.hideNavigation && J.createElement(n.Nav, { "data-animated-nav": t.animate ? "true" : void 0, className: a[oe.Nav], style: x?.[oe.Nav], "aria-label": zt(), onPreviousClick: bn, onNextClick: wn, previousMonth: P, nextMonth: L }),
          J.createElement(
            n.MonthGrid,
            ...
            !t.hideWeekdays && J.createElement(
              ...
              M && J.createElement(n.WeekNumberHeader, { "aria-label": $r(s.options), className: a[oe.WeekNumberHeader], style: x?.[oe.WeekNumberHeader], scope: "col" }, E()),
            ...
            J.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: a[oe.Weeks], style: x?.[oe.Weeks] }, le.weeks.map((ae) => J.createElement(
              ...
              ae.days.map((be) => {
                ...
                if (ve[De.focused] = !ve.hidden && !!z?.isEqualTo(be), ve[ct.selected] = G?.(Ve) || ve.selected, Da(te)) {
...
const Ra = "-", Gg = (e) => {
  ...
  if (Pi.test(e)) {
    const t = Pi.exec(e)[1], n = t?.substring(0, t.indexOf(":"));
    if (n)
      return "arbitrary.." + n;
  }
}, Xg = (e) => {
...
const _e = (e) => {
  ...
  dy.test(e) && !uy.test(e)
), xl = () => !1, gy = (e) => fy.test(e), yy = (e) => my.test(e), vy = (e) => !ne(e) && !re(e), by = (e) => qn(e, Ml, xl), ne = (e) => bl.test(e), an = (e) => qn(e, Sl, hy), bs = (e) => qn(e, My, pe), Oi = (e) => qn(e, kl, xl), wy = (e) => qn(e, Cl, yy), Qr = (e) => qn(e, Tl, gy), re = (e) => wl.test(e), ur = (e) => Xn(e, Sl), xy = (e) => Xn(e, Sy), _i = (e) => Xn(e, kl), ky = (e) => Xn(e, Ml), Cy = (e) => Xn(e, Cl), Jr = (e) => Xn(e, Tl, !0), qn = (e, t, n) => {
  const r = bl.exec(e);
  return r ? r[1] ? t(r[1]) : n(r[2]) : !1;
}, Xn = (e, t, n = !1) => {
  const r = wl.exec(e);
  return r ? r[1] ? t(r[1]) : n : !1;
}, kl = (e) => e === "position" || e === "percentage", Cl = (e) => e === "image" || e === "url", Ml = (e) => e === "length" || e === "size" || e === "bg-size", Sl = (e) => e === "length", My = (e) => e === "number", Sy = (e) => e === "family-name", Tl = (e) => e === "shadow", Ty = () => {
  const e = _e("color"), t = _e("font"), n = _e("text"), r = _e("font-weight"), o = _e("tracking"), s = _e("leading"), i = _e("breakpoint"), a = _e("container"), c = _e("spacing"), l = _e("radius"), d = _e("shadow"), u = _e("inset-shadow"), m = _e("text-shadow"), p = _e("drop-shadow"), h = _e("blur"), g = _e("perspective"), y = _e("aspect"), b = _e("ease"), v = _e("animate"), w = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], M = () => [
    ...
    // Deprecated since Tailwind CSS v4.1.0, see https://github.com/tailwindlabs/tailwindcss/pull/17378
    "left-bottom"
  ], x = () => [...M(), re, ne], C = () => ["auto", "hidden", "clip", "visible", "scroll"], D = () => ["auto", "contain", "none"], k = () => [re, ne, c], T = () => [Mn, "full", "auto", ...k()], E = () => [Gt, "none", "subgrid", re, ne], N = () => ["auto", {
    span: ["full", Gt, re, ne]
  }, Gt, re, ne], R = () => [Gt, "auto", re, ne], I = () => ["auto", "min", "max", "fr", re, ne], O = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], H = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], B = () => ["auto", ...k()], q = () => [Mn, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...k()], P = () => [e, re, ne], L = () => [...M(), _i, Oi, {
    position: [re, ne]
  }], U = () => ["no-repeat", {
    ...
    re,
    ne
  ], ge = () => ["none", pe, re, ne], ye = () => ["none", pe, re, ne], Re = () => [pe, re, ne], We = () => [Mn, "full", ...k()];
  return {
    cacheSize: 500,
    theme: {
...
function xr(e) {
  const t = /* @__PURE__ */ Ny(e), n = S.forwardRef((r, o) => {
    const { children: s, ...i } = r, a = S.Children.toArray(s), c = a.find(Ay);
    if (c) {
...
function Ay(e) {
  return S.isValidElement(e) && typeof e.type == "function" && "__radixId" in e.type && e.type.__radixId === El;
}
function Ly(e, t) {
  const n = { ...t };
  for (const r in t) {
...
const Hi = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, Wi = gl, Iy = (e, t) => (n) => {
  var r;
...
function Zt({
  ...
  return /* @__PURE__ */ f(
    ...
    {
      "data-slot": "button",
      className: ue(Ks({ variant: t, size: n, className: e })),
      ...o
    }
  );
}
function Oy({
  ...
  return /* @__PURE__ */ f(
    Vg,
    {
      ...
      classNames: {
        root: ue("w-fit", c.root),
        months: ue(
          "flex gap-4 flex-col md:flex-row relative",
          c.months
        ),
        month: ue("flex flex-col w-full gap-4", c.month),
        nav: ue(
        ...
        weekdays: ue("flex", c.weekdays),
        weekday: ue(
          "text-muted-foreground rounded-md flex-1 font-normal text-[0.8rem] select-none",
          c.weekday
        ),
        week: ue("flex w-full mt-2", c.week),
        ...
        range_middle: ue("rounded-none", c.range_middle),
        range_end: ue("rounded-r-md bg-accent", c.range_end),
        today: ue(
      ...
      components: {
        ...
        Chevron: ({ className: l, orientation: d, ...u }) => d === "left" ? /* @__PURE__ */ f(Mf, { className: ue("size-4", l), ...u }) : d === "right" ? /* @__PURE__ */ f(
          Sf,
          {
            className: ue("size-4", l),
            ...u
          }
        ) : /* @__PURE__ */ f(Tf, { className: ue("size-4", l), ...u }),
        DayButton: _y,
...
function zy(e, t, n) {
  ...
  const v = lm(y);
  In = { container: y, root: v, pillDate: t };
  const w = () => {
    po();
  }, M = (x) => {
    const C = Dl.get(t);
...
function By({ node: e, updateAttributes: t, selected: n }) {
  const r = V(null), o = e.attrs.date || On(), s = Nl(o), i = Aa(o), a = Y(() => {
    if (!r.current) return "";
  ...
  }, []), /* @__PURE__ */ f(zn, { as: "span", className: "inline", children: /* @__PURE__ */ A(
    "span",
    {
      ref: r,
...
const Uy = new Ke("datePillPaste"), Yy = Ro.create({
  name: "datePill",
  group: "inline",
  inline: !0,
  atom: !0,
  ...
  renderHTML({ node: e, HTMLAttributes: t }) {
    const n = e.attrs.date, r = Nl(n), o = Aa(n);
    return [
      "span",
      Yn(this.options.HTMLAttributes, t, {
        "data-type": "date-pill",
...
function jy({ node: e, selected: t, editor: n, getPos: r, deleteNode: o }) {
  ...
  const p = Y((v) => {
    ...
    if (it.delete(a), M && it.delete(M), !M || !Rn(M))
      o();
    else if (M !== a) {
      const x = r();
  ...
  return l ? /* @__PURE__ */ f(zn, { as: "span", className: "inline", children: /* @__PURE__ */ A(
    "span",
    {
      ref: s,
...
const Ky = new Ke("tagPillPaste"), Vy = Ro.create({
  name: "tagPill",
  group: "inline",
  inline: !0,
  atom: !0,
...
const Gy = [
  ...
  {
    title: "Note Callout",
    icon: /* @__PURE__ */ f(Ac, { size: 16, className: "text-purple-400" }),
    command: (e) => e.chain().focus().toggleCallout({ type: "note" }).run(),
    keywords: ["memo", "remember"]
  },
  {
    title: "Prompt Callout",
    icon: /* @__PURE__ */ f(Rc, { size: 16, className: "text-amber-400" }),
...
function Jy({ editor: e }) {
  ...
  Ao(() => {
    if (!t || !a) return;
    const { top: T, bottom: E, left: N } = a, R = window.innerHeight, I = window.innerWidth, O = R - E - eo, H = T - eo;
    let B;
...
`) || H.includes("]]")) {
  ...
  if (Ao(() => {
    if (!r || !u) return;
    const { top: N, bottom: R, left: I } = u, O = window.innerHeight, H = window.innerWidth, B = O - R - to, q = N - to;
    let P;
...
function Ll(e) {
  ...
  const d = e + "CollectionItemSlot", u = "data-radix-collection-item", m = /* @__PURE__ */ xr(d), p = J.forwardRef(
    (g, y) => {
      const { scope: b, children: v, ...w } = g, M = J.useRef(null), x = Ye(y, M), C = s(d, b);
      return J.useEffect(() => (C.itemMap.set(M, { ref: M, ...w }), () => void C.itemMap.delete(M))), /* @__PURE__ */ f(m, { [u]: "", ref: x, children: v });
    }
  );
  p.displayName = d;
  function h(g) {
...
var fv = "DismissableLayer", Vs = "dismissableLayer.update", mv = "dismissableLayer.pointerDownOutside", pv = "dismissableLayer.focusOutside", Fi, Il = S.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: a,
      ...c
    } = e, l = S.useContext(Il), [d, u] = S.useState(null), m = d?.ownerDocument ?? globalThis?.document, [, p] = S.useState({}), h = Ye(t, (D) => u(D)), g = Array.from(l.layers), [y] = [...l.layersWithOutsidePointerEventsDisabled].slice(-1), b = g.indexOf(y), v = d ? g.indexOf(d) : -1, w = l.layersWithOutsidePointerEventsDisabled.size > 0, M = v >= b, x = yv((D) => {
    ...
    return uv((D) => {
      ...
      Fe.div,
      {
        ...
        onFocusCapture: me(e.onFocusCapture, C.onFocusCapture),
        onBlurCapture: me(e.onBlurCapture, C.onBlurCapture),
...
var hv = "DismissableLayerBranch", gv = S.forwardRef((e, t) => {
  const n = S.useContext(Il), r = S.useRef(null), o = Ye(t, r);
  return S.useEffect(() => {
    const s = r.current;
    if (s)
  ...
  S.useEffect(() => {
    ...
    if (a) {
      ...
      if (!a.contains(g)) {
        ...
        a.addEventListener(xs, l), a.dispatchEvent(b), b.defaultPrevented || (xv(Tv($l(a)), { select: !0 }), document.activeElement === g && Xt(a));
      }
      return () => {
...
var Ev = S[" useId ".trim().toString()] || (() => {
}), Dv = 0;
function bo(e) {
  const [t, n] = S.useState(Ev());
  return Jt(() => {
    n((r) => r ?? String(Dv++));
  }, [e]), e || (t ? `radix-${t}` : "");
}
...
const Bv = (e) => ({
  ...
  async fn(t) {
    ...
    const u = Hl(d), m = {
      x: n,
      y: r
    }, p = _a(o), h = Oa(p), g = await i.getDimensions(l), y = p === "y", b = y ? "top" : "left", v = y ? "bottom" : "right", w = y ? "clientHeight" : "clientWidth", M = s.reference[h] + s.reference[p] - m[p] - s.floating[h], x = m[p] - s.reference[p], C = await (i.getOffsetParent == null ? void 0 : i.getOffsetParent(l));
    let D = C ? C[w] : 0;
    (!D || !await (i.isElement == null ? void 0 : i.isElement(C))) && (D = a.floating[w] || s.floating[h]);
    const k = M / 2 - x / 2, T = D / 2 - g[h] / 2 - 1, E = en(u[b], T), N = en(u[v], T), R = E, I = D - g[h] - N, O = D / 2 - g[h] / 2 + k, H = Gs(R, O, I), B = !c.arrow && Qn(o) != null && O !== H && s.reference[h] / 2 - (O < R ? E : N) - g[h] / 2 < 0, q = B ? O < R ? O - R : O - I : 0;
    return {
      [p]: m[p] + q,
      data: {
        [p]: H,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const b = Ht(o), v = yt(a), w = Ht(a) === a, M = await (c.isRTL == null ? void 0 : c.isRTL(l.floating)), x = m || (w || !g ? [xo(a)] : Iv(a)), C = h !== "none";
      !m && C && x.push(...Hv(a, g, h, M));
      const D = [a, ...x], k = await kr(t, y), T = [];
      ...
      if (E = [...E, {
        ...
        E.every((P) => yt(P.placement) === v ? P.overflows[0] > 0 : !0)))
          return {
            data: {
              index: O,
              overflows: E
...
const jv = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: n,
        y: r
      }, d = await kr(t, c), u = yt(Ht(o)), m = Ia(u);
      let p = l[m], h = l[u];
      if (s) {
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (l) {
        var b, v;
        const w = m === "y" ? "width" : "height", M = Wl.has(Ht(o)), x = s.reference[u] - s.floating[w] + (M && ((b = i.offset) == null ? void 0 : b[u]) || 0) + (M ? 0 : y.crossAxis), C = s.reference[u] + s.reference[w] + (M ? 0 : ((v = i.offset) == null ? void 0 : v[u]) || 0) - (M ? y.crossAxis : 0);
        h < x ? h = x : h > C && (h = C);
      }
      return {
        [m]: p,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      const v = g - d.top - d.bottom, w = h - d.left - d.right, M = en(g - d[y], v), x = en(h - d[b], w), C = !t.middlewareData.shift;
      let D = M, k = x;
...
function Bl(e) {
  const t = tn(e);
  return Fn(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : bt(t) && Rr(t) ? t : Bl(t);
}
function Cr(e, t, n) {
  var r;
  ...
  if (s) {
    const a = Xs(i);
    return t.concat(i, i.visualViewport || [], Rr(o) ? o : [], a && n ? Cr(a) : []);
  }
...
function ab(e) {
  ...
  const d = vt(0), u = bt(r);
  if ((u || !u && !s) && ((Jn(r) !== "body" || Rr(i)) && (c = zo(r)), bt(r))) {
    const p = pn(r);
...
function fb(e, t) {
  ...
  for (; lt(i) && !Fn(i); ) {
    const a = dt(i), c = $a(i);
    !c && a.position === "fixed" && (o = null), (s ? !c && !o : !c && a.position === "static" && !!o && db.has(o.position) || Rr(i) && !c && jl(e, i)) ? r = r.filter((d) => d !== i) : o = a, i = tn(i);
  }
  return t.set(e, r), r;
}
function mb(e) {
...
const xb = jv, kb = Kv, Cb = Fv, Mb = Gv, Sb = Uv, oc = Bv, Tb = Vv, Eb = (e, t, n) => {
...
function Rb(e) {
  ...
  const [h, g] = S.useState(null), [y, b] = S.useState(null), v = S.useCallback((P) => {
  ...
  }, []), M = s || h, x = i || y, C = S.useRef(null), D = S.useRef(null), k = S.useRef(d), T = c != null, E = Ms(c), N = Ms(o), R = Ms(l), I = S.useCallback(() => {
    ...
    N.current && (P.platform = N.current), Eb(C.current, D.current, P).then((L) => {
      const U = {
        ...L,
      ...
      O.current && !Co(k.current, U) && (k.current = U, Bc.flushSync(() => {
        u(U);
      }));
    });
  }, [m, t, n, N, R]);
...
var Ba = "PopperContent", [Ub, Yb] = Xl(Ba), td = S.forwardRef(
  (e, t) => {
    const {
      ...
      onPlaced: h,
      ...g
    } = e, y = Zl(Ba, n), [b, v] = S.useState(null), w = Ye(t, (j) => v(j)), [M, x] = S.useState(null), C = Bb(M), D = C?.width ?? 0, k = C?.height ?? 0, T = r + (s !== "center" ? "-" + s : ""), E = typeof d == "number" ? d : { top: 0, right: 0, bottom: 0, left: 0, ...d }, N = Array.isArray(l) ? l : [l], R = N.length > 0, I = {
      padding: E,
      boundary: N.filter(Kb),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: R
    }, { refs: O, floatingStyles: H, placement: B, isPositioned: q, middlewareData: P } = Rb({
      ...
      middleware: [
        Lb({ mainAxis: o + k, alignmentAxis: i }),
        c && Pb({
          mainAxis: !0,
          crossAxis: !1,
          limiter: u === "partial" ? Ib() : void 0,
          ...I
        }),
        c && Ob({ ...I }),
        _b({
        ...
        Vb({ arrowWidth: D, arrowHeight: k }),
        m && $b({ strategy: "referenceHidden", ...I })
      ]
    }), [L, U] = od(B), X = _t(h);
    Jt(() => {
      q && X?.();
...
var Ss = "rovingFocusGroup.onEntryFocus", Qb = { bubbles: !1, cancelable: !0 }, Ar = "RovingFocusGroup", [Zs, ld, Jb] = Ll(Ar), [ew, dd] = Zn(
  Ar,
  [Jb]
), [tw, nw] = ew(Ar), ud = S.forwardRef(
...
var rw = S.forwardRef((e, t) => {
  const {
    ...
    ...u
  } = e, m = S.useRef(null), p = Ye(t, m), h = Pl(s), [g, y] = La({
    prop: i,
    defaultProp: a ?? null,
    onChange: c,
    caller: Ar
  }), [b, v] = S.useState(!1), w = _t(l), M = ld(n), x = S.useRef(!1), [C, D] = S.useState(0);
  return S.useEffect(() => {
    const k = m.current;
    if (k)
      return k.addEventListener(Ss, w), () => k.removeEventListener(Ss, w);
  }, [w]), /* @__PURE__ */ f(
    tw,
    {
      scope: n,
...
}, Sn = /* @__PURE__ */ new WeakMap(), oo = /* @__PURE__ */ new WeakMap(), so = {}, Ts = 0, hd = function(e) {
...
var vd = kw(), Ds = function() {
  ...
  return S.createElement(
    ...
    i ? S.cloneElement(S.Children.only(a), ht(ht({}, D), { ref: C })) : S.createElement(v, ht({}, D, { className: c, ref: C }), a)
  );
});
Uo.defaultProps = {
  enabled: !0,
...
var Dw = function() {
  ...
  if (e === void 0 && (e = "margin"), typeof window > "u")
    return Rw;
  var t = Aw(e), n = document.documentElement.clientWidth, r = window.innerWidth;
  return {
    left: t[0],
    top: t[1],
    right: t[2],
...
}, Pw = bd(), Hn = "data-scroll-locked", Iw = function(e, t, n, r) {
...
`);
  ...
  return S.createElement(Pw, { styles: Iw(s, !t, o, n ? "" : "!important") });
}, Qs = !1;
if (typeof window < "u")
  try {
...
var Tn = Qs ? { passive: !1 } : !1, $w = function(e) {
...
function Vw(e) {
  ...
  var a = S.useCallback(function(g, y) {
    ...
    var b = io(g), v = n.current, w = "deltaX" in g ? g.deltaX : v[0] - b[0], M = "deltaY" in g ? g.deltaY : v[1] - b[1], x, C = g.target, D = Math.abs(w) > Math.abs(M) ? "h" : "v";
    if ("touches" in g && D === "h" && C.type === "range")
      return !1;
    var k = cc(D, C);
    if (!k)
      return !0;
    if (k ? x = D : (x = D === "v" ? "h" : "v", k = cc(D, C)), !k)
      return !1;
    if (!r.current && "changedTouches" in g && (w || M) && (r.current = x), !x)
      return !0;
    var T = r.current || x;
    return Uw(T, y, g, T === "h" ? w : M);
...
var Js = ["Enter", " "], Xw = ["ArrowDown", "PageUp", "Home"], Md = ["ArrowUp", "PageDown", "End"], Zw = [...Xw, ...Md], Qw = {
  ...
  Fo,
  dd
]), Yo = Fo(), Td = dd(), [n0, yn] = gn(Lr), [r0, Pr] = gn(Lr), Ed = (e) => {
  const { __scopeMenu: t, open: n = !1, children: r, dir: o, onOpenChange: s, modal: i = !0 } = e, a = Yo(t), [c, l] = S.useState(null), d = S.useRef(!1), u = _t(s), m = Pl(o);
  return S.useEffect(() => {
    const p = () => {
...
Nd.displayName = Ya;
var at = "MenuContent", [a0, ja] = gn(at), Rd = S.forwardRef(
  (e, t) => {
    const n = Dd(at, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, s = yn(at, e.__scopeMenu), i = Pr(at, e.__scopeMenu);
  ...
  (e, t) => {
    const {
      ...
      ...g
    } = e, y = yn(at, n), b = Pr(at, n), v = Yo(n), w = Td(n), M = e0(n), [x, C] = S.useState(null), D = S.useRef(null), k = Ye(t, D, y.onContentChange), T = S.useRef(0), E = S.useRef(""), N = S.useRef(0), R = S.useRef(null), I = S.useRef("right"), O = S.useRef(0), H = h ? Cd : S.Fragment, B = h ? { as: l0, allowPinchZoom: !0 } : void 0, q = (L) => {
      const U = E.current + L, X = M().filter((j) => !j.disabled), G = document.activeElement, Z = X.find((j) => j.ref.current === G)?.textValue, te = X.map((j) => j.textValue), $ = x0(te, U, Z), z = X.find((j) => j.textValue === $)?.ref.current;
      (function j(ee) {
        E.current = ee, window.clearTimeout(T.current), ee !== "" && (T.current = window.setTimeout(() => j(""), 1e3));
      })(U), z && setTimeout(() => z.focus());
    };
    S.useEffect(() => () => window.clearTimeout(T.current), []), bv();
    const P = S.useCallback((L) => I.current === R.current?.side && C0(L, R.current?.area), []);
    return /* @__PURE__ */ f(
      a0,
      {
        scope: n,
...
Va.displayName = d0;
var u0 = "MenuLabel", Ad = S.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
...
var Mo = "MenuItem", uc = "menu.itemSelect", jo = S.forwardRef(
  (e, t) => {
    const { disabled: n = !1, onSelect: r, ...o } = e, s = S.useRef(null), i = Pr(Mo, e.__scopeMenu), a = ja(Mo, e.__scopeMenu), c = Ye(t, s), l = S.useRef(!1), d = () => {
      const u = s.current;
      if (!n && u) {
        const m = new CustomEvent(uc, { bubbles: !0, cancelable: !0 });
        u.addEventListener(uc, (p) => r?.(p), { once: !0 }), Al(u, m), m.defaultPrevented ? l.current = !1 : i.onClose();
      }
    };
    return /* @__PURE__ */ f(
      Ld,
...
var Ld = S.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, disabled: r = !1, textValue: o, ...s } = e, i = ja(Mo, n), a = Td(n), c = S.useRef(null), l = Ye(t, c), [d, u] = S.useState(!1), [m, p] = S.useState("");
    return S.useEffect(() => {
      const h = c.current;
...
), f0 = "MenuCheckboxItem", Pd = S.forwardRef(
  (e, t) => {
...
Pd.displayName = f0;
var Id = "MenuRadioGroup", [m0, p0] = gn(
  Id,
...
Bd.displayName = y0;
var v0 = "MenuSub", [aC, Fd] = gn(v0), pr = "MenuSubTrigger", Ud = S.forwardRef(
  (e, t) => {
    const n = yn(pr, e.__scopeMenu), r = Pr(pr, e.__scopeMenu), o = Fd(pr, e.__scopeMenu), s = ja(pr, e.__scopeMenu), i = S.useRef(null), { pointerGraceTimerRef: a, onPointerGraceIntentChange: c } = s, l = { __scopeMenu: e.__scopeMenu }, d = S.useCallback(() => {
...
var Yd = "MenuSubContent", jd = S.forwardRef(
  (e, t) => {
    const n = Dd(at, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, s = yn(at, e.__scopeMenu), i = Pr(at, e.__scopeMenu), a = Fd(Yd, e.__scopeMenu), c = S.useRef(null), l = Ye(t, c);
...
var M0 = Ed, S0 = Ua, T0 = Nd, E0 = Rd, D0 = Va, N0 = Ad, R0 = jo, A0 = Pd, L0 = Od, P0 = $d, I0 = Wd, O0 = zd, _0 = Bd, $0 = Ud, H0 = jd, Ko = "DropdownMenu", [W0] = Zn(
  Ko,
  [Sd]
...
ou.displayName = ru;
var Tr = "Tooltip", [bx, Ir] = Vo(Tr), su = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: r,
    ...
    delayDuration: a
  } = e, c = Xa(Tr, e.__scopeTooltip), l = Go(t), [d, u] = S.useState(null), m = bo(), p = S.useRef(0), h = i ?? c.disableHoverableContent, g = a ?? c.delayDuration, y = S.useRef(!1), [b, v] = La({
    prop: r,
    defaultProp: o ?? !1,
    onChange: (D) => {
...
var ta = "TooltipTrigger", au = S.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...r } = e, o = Ir(ta, n), s = Xa(ta, n), i = Go(n), a = S.useRef(null), c = Ye(t, a, o.onTriggerChange), l = S.useRef(!1), d = S.useRef(!1), u = S.useCallback(() => l.current = !1, []);
...
var Za = "TooltipPortal", [wx, xx] = Vo(Za, {
  ...
  const { __scopeTooltip: t, forceMount: n, children: r, container: o } = e, s = Ir(Za, t);
...
var Un = "TooltipContent", cu = S.forwardRef(
  (e, t) => {
    const n = xx(Un, e.__scopeTooltip), { forceMount: r = n.forceMount, side: o = "top", ...s } = e, i = Ir(Un, e.__scopeTooltip);
  ...
  const n = Ir(Un, e.__scopeTooltip), r = Xa(Un, e.__scopeTooltip), o = S.useRef(null), s = Ye(t, o), [i, a] = S.useState(null), { trigger: c, onClose: l } = n, d = o.current, { onPointerInTransitChange: u } = r, m = S.useCallback(() => {
    a(null), u(!1);
  }, [u]), p = S.useCallback(
    (h, g) => {
      const y = h.currentTarget, b = { x: h.clientX, y: h.clientY }, v = Tx(b, y.getBoundingClientRect()), w = Ex(b, v), M = Dx(g.getBoundingClientRect()), x = Rx([...w, ...M]);
      a(x), u(!0);
    },
    [u]
  );
...
}), [Cx, Mx] = Vo(Tr, { isInside: !1 }), Sx = /* @__PURE__ */ Ry("TooltipContent"), lu = S.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: r,
      ...
      ...a
    } = e, c = Ir(Un, n), l = Go(n), { onClose: d } = c;
...
var Lx = ou, Px = su, Ix = au, Ox = iu, _x = cu, $x = uu;
function Hx({
  delayDuration: e = 0,
  ...t
}) {
...
function na({
  ...
  return /* @__PURE__ */ f(Hx, { children: /* @__PURE__ */ f(Px, { "data-slot": "tooltip", ...e }) });
}
function ra({
  ...e
}) {
  return /* @__PURE__ */ f(Ix, { "data-slot": "tooltip-trigger", ...e });
}
function oa({
  className: e,
  sideOffset: t = 0,
  ...
  return /* @__PURE__ */ f(Ox, { children: /* @__PURE__ */ A(
    _x,
    {
...
const Ie = ({ onClick: e, isActive: t, disabled: n, children: r, tooltip: o }) => {
  ...
  return o ? /* @__PURE__ */ A(na, { children: [
  ...
  return /* @__PURE__ */ A("div", { className: `flex items-center gap-0.5 px-2 py-1.5 border-b border-border/30 bg-muted/30 overflow-x-auto scrollbar-hide editor-toolbar ${o}`, children: [
    ...
    n && /* @__PURE__ */ A(na, { children: [
      /* @__PURE__ */ f(ra, { asChild: !0, children: /* @__PURE__ */ A(
        Zt,
        {
          variant: "ghost",
          size: "sm",
...
`).length;
  ...
  const L = Y(() => {
    ...
    if (l && a) {
      const z = [...C].sort((ee, ge) => ge.from - ee.from);
      let j = i;
      z.forEach((ee) => {
...
const Bx = typeof navigator < "u" && /Mac|iPod|iPhone|iPad/.test(navigator.platform), Rt = Bx ? "⌘" : "Ctrl", Fx = ({ editor: e }) => {
...
function Jx(e) {
  return e.length < 3 ? !1 : !!(At.header.test(e) || At.bold.test(e) || At.list.test(e) || At.taskList.test(e) || At.codeBlock.test(e) || At.callout.test(e) || At.highlight.test(e) || At.link.test(e) || At.table.test(e));
}
function ek(e) {
...
function fc(e) {
  if (!/!\[[^\]]*\]\([^)]+\)/.test(e)) return `<p>${To(e)}</p>`;
  const n = /(!\[[^\]]*\]\([^)]+\))/g, r = e.split(n).filter((s) => s.trim()), o = [];
  for (const s of r) {
    const i = s.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
    i ? o.push(tk(i[1], i[2])) : o.push(`<p>${To(s.trim())}</p>`);
  }
  return o.join("");
}
function fu(e) {
...
function mu(e) {
  ...
  const t = (o, s) => {
    ...
    for (i += d; a < e.length && e[a].depth >= s; ) {
      const m = e[a];
      if (m.depth === s) {
        if (l ? i += `<li data-type="taskItem" data-checked="${m.checked || !1}"><p>${To(m.text)}</p>` : i += `<li><p>${To(m.text)}</p>`, a + 1 < e.length && e[a + 1].depth > s) {
...
function Rk(e, t, n) {
  ...
  i(kk(e, o, s)), Nk(e, t) && (i(Ck(e, o, s)), i(Mk(e, o, s))), i(Tk(e, o, s)), i(Sk(e, o, s));
  const a = Ek(e);
  if (a.length > 0) {
    const c = Dk(a, o, s);
    for (const l of c)
...
const Ik = new Ke("hexColorDecoration");
function pu(e, t, n) {
  const r = [];
  ...
  Q(() => {
    ...
    const E = (N) => {
      ...
      if (l.current = N, c.current.push({ time: N, duration: R }), c.current.length > 120 && (c.current = c.current.slice(-120)), R > 16.67 && u.current++, D++, N - k >= 1e3) {
        T = D, D = 0, k = N;
        const I = c.current.slice(-60), O = I.length > 0 ? I.reduce((G, Z) => G + Z.duration, 0) / I.length : 0, H = I.length > 0 ? Math.max(...I.map((G) => G.duration)) : 0, B = performance.memory, q = B ? B.usedJSHeapSize / (1024 * 1024) : 0, P = B ? B.jsHeapSizeLimit / (1024 * 1024) : 0, L = document.querySelectorAll("*").length, U = bc - m.current, X = sa - p.current;
...
const kc = jn(function({
  ...
  const L = Y((z) => {
    ...
    if (g)
      return g(z, j, () => L(z));
    const ge = (z.level - s) * 14, ye = l && z.children && z.children.length > 0, Re = k.has(z.id);
    return /* @__PURE__ */ f(
      "div",
      {
    ...
    const ge = M === ee.id, ye = k.has(ee.id), Re = ee.children && ee.children.length > 0;
  ...
  return /* @__PURE__ */ A(He, { children: [
    y && /* @__PURE__ */ f(
      "button",
      {
        ...
        children: C ? /* @__PURE__ */ f(tm, { size: 16 }) : /* @__PURE__ */ f(nm, { size: 16 })
      }
    ),
    /* @__PURE__ */ A(
      "div",
...
function l1() {
  !Do && !It && (Do = bu().then((e) => (It = e, e)));
}
function d1() {
  return l1(), {
    turndown(e) {
      return It ? It.turndown(e) : (console.warn("[Paragon] TurndownService not yet loaded, returning empty markdown"), "");
    },
    isReady() {
      return It !== null;
    },
    async ready() {
      It || (Do ? await Do : await bu());
    }
  };
}
function u1() {
...
const m1 = () => {
  ...
  const [ae] = K(() => m1()), [be, Ve] = K(k), [ve, or] = K(""), qe = V(k), kt = V(""), Ct = V(null), [sr, Qa] = K(0), Ur = !!(ft && ft.length > 0 && xn), { state: Ze, executeAction: Yr, abort: ku, reset: Bt } = t1(xn), [ts, ns] = K(null), [Cu, Mu] = K({ selectionTop: 0, selectionBottom: 0, selectionCenterX: 0 }), Su = V(xn);
  Su.current = xn;
  const Ja = V(le);
  Ja.current = le;
  const [Tu, Eu] = K([]), [Du, Nu] = K(0), Ru = Y((W, F) => {
    Eu(W), Nu(F);
  }, []), rs = V(v), os = V(w), ss = V(M), as = V(x), is = V(C), ei = V(q), cs = V(P), ls = V(L);
  rs.current = v, os.current = w, ss.current = M, as.current = x, is.current = C, ei.current = q, cs.current = P, ls.current = L;
  const ti = 2e3, [Mt, Au] = K(() => rr === "lightweight" ? !0 : rr === "full" ? !1 : t && typeof t == "string" ? Math.ceil(t.length / 80) > ti : !1), ds = V(0), ni = V(Mt);
  ni.current = Mt;
  const Lu = An(() => {
    const W = [
      Vu.configure({
    ...
    ), zr && W.push(Ak), Jo && !Mt && W.push(_k), $.markdownPaste || W.push(
      ok.configure({
        enableMarkdownPaste: !0
      })
    ), W;
  ...
  const _ = ju({
    ...
    onSelectionUpdate: ({ editor: W }) => {
      if (I) {
        const { from: F, to: he, empty: fe } = W.state.selection;
        I({ from: F, to: he, empty: fe });
      }
    }
  });
  Q(() => () => {
  ...
  const [ri, jr] = K(!1), [kn, Kr] = K(null), [Pu, Iu] = K(!1), Ou = X !== void 0 ? X : Pu, Ft = Y((W) => {
    Iu(W), G?.(W);
  }, [G]), [_u, fs] = K(0), [$u, Hu] = K(""), Tt = jx(_, {
    storageKey: p,
    debounceMs: h,
    enabled: m,
    onSave: (W) => {
  ...
  const oi = V(!1);
  Q(() => {
    if (!oi.current && k === "markdown" && _ && !_.isDestroyed && Ut) {
    ...
    if (_) {
      if (W === "markdown" && qe.current === "wysiwyg") {
        ...
        he.forEach((ie) => {
          ...
          fe = fe.replace(se, (we, de) => {
            const Te = F.parse(de.trim(), { async: !1 });
        ...
        }), fe = fe.replace(/!\[([^\]]*)\]\(([^)]+)\)/g, (ie, se, we) => {
          const de = se.split("|").map((Et) => Et.trim());
          let Te = "", ze = "left", Le = null;
          de.length === 1 ? Te = de[0] : de.length === 2 ? (Te = de[0], /^\d+$/.test(de[1]) ? Le = de[1] : ["left", "center", "right"].includes(de[1]) ? ze = de[1] : Te = se) : de.length === 3 ? (Te = de[0], ["left", "center", "right"].includes(de[1]) && (ze = de[1]), /^\d+$/.test(de[2]) && (Le = de[2])) : Te = se;
          const Ee = Le ? ` width="${Le}" style="width: ${Le}px"` : "", jt = ` data-align="${ze}"`;
          return `<img src="${we.trim()}" alt="${Te}"${jt}${Ee} />`;
        }), fe = fe.replace(new RegExp("(?<!`)==((?:(?!==)[^\\n])+)==(?!`)", "g"), "<mark>$1</mark>"), fe = fe.replace(/@([^@\n]+)@/g, (ie, se) => {
          const we = ln(se);
          if (we) {
            const de = Aa(we);
            return `<span data-type="date-pill" data-date="${we}" class="date-pill ${de}"><span class="date-icon">📅</span><span class="date-text">${se.trim()}</span></span>`;
          }
          return ie;
        }), Br && !$.tagPills && (fe = fe.replace(new RegExp("(?:^|(?<=\\s))#([a-zA-Z][a-zA-Z0-9_-]*|[a-zA-Z0-9_-]*[a-zA-Z][a-zA-Z0-9_-]*)(?=\\s|$|[.,;:!?)\\]])", "gm"), (ie, se) => {
          const we = vr(se);
          return Rn(we) ? `<span data-type="tag-pill" data-tag="${we}" class="tag-pill"><span class="tag-icon">#</span><span class="tag-text">${we}</span></span>` : ie;
        })), fe = fe.split(/(```[\s\S]*?```|`[^`\n]+`)/g).map((ie, se) => se % 2 === 1 ? ie : ie.replace(/\[\[([^\[\]]+)\]\]/g, (we, de) => `<span data-wiki-link data-page-name="${de.trim()}" class="wiki-link">${de.trim()}</span>`)).join("");
        let Ae = F.parse(fe, { async: !1 });
        Ae = f1(Ae), Ae = Ae.replace(/(<table>[\s\S]*<\/table>)\s*<!--\s*header-column\s*-->/gi, (ie, se) => se.replace(/(<tbody>[\s\S]*?<\/tbody>)/gi, (we) => we.replace(/<tr>([\s\S]*?)<\/tr>/gi, (de, Te) => `<tr>${Te.replace(/^([\s\S]*?)<td>([\s\S]*?)<\/td>/i, "$1<th>$2</th>")}</tr>`)));
        const ce = (ie) => {
          let se = ie;
          ...
          if (/<img\s/i.test(ie)) {
            const se = /(<img\s[^>]*\/?>)/gi;
            return ie.split(se).filter((de) => de.trim()).map((de) => /^<img\s/i.test(de) ? Se(de) : de.trim() ? `<p>${ce(de.trim())}</p>` : "").join("");
          }
          if (/^!\[/.test(ie)) {
            const se = ie.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
            if (se)
          ...
          const se = ie.match(/^( *)/), we = se ? se[1].length : 0, de = Math.floor(we / 2), Te = ie.trimStart(), ze = Te.match(/^-\s*\[(x| )\]\s*(.*)$/);
          if (ze)
            return { type: "task", depth: de, text: ze[2].trim(), checked: ze[1] === "x" };
          const Le = Te.match(/^-\s+(.+)$/);
          if (Le)
            return { type: "ul", depth: de, text: Le[1].trim() };
          const Ee = Te.match(/^(\d+)\.\s+(.+)$/);
          return Ee ? { type: "ol", depth: de, text: Ee[2].trim(), index: parseInt(Ee[1], 10) } : null;
        }, Vr = (ie) => {
          if (ie.length === 0) return "";
          const se = (Te, ze) => {
            let Le = "", Ee = Te;
            const jt = ie[Ee]?.type || "ul", Et = jt === "task", Kt = Et ? '<ul data-type="taskList">' : `<${jt === "ol" ? "ol" : "ul"}>`, cr = Et ? "</ul>" : `</${jt === "ol" ? "ol" : "ul"}>`;
            for (Le += Kt; Ee < ie.length && ie[Ee].depth >= ze; ) {
              const Dt = ie[Ee];
              if (Dt.depth === ze) {
                if (Et ? Le += `<li data-type="taskItem" data-checked="${Dt.checked || !1}"><p>${ce(Dt.text)}</p>` : Le += `<li><p>${ce(Dt.text)}</p>`, Ee + 1 < ie.length && ie[Ee + 1].depth > ze) {
                  const sn = se(Ee + 1, ie[Ee + 1].depth);
                  Le += sn.html, Ee = sn.nextIdx;
                } else
                  Ee++;
                Le += "</li>";
              } else
            ...
            return Le += cr, { html: Le, nextIdx: Ee };
        ...
        Ae = Ae.replace(
          ...
          (ie, se, we, de) => {
            ...
            let Ee = we.trim();
            Ee = Ee.replace(/^<p>([\s\S]*)<\/p>$/i, "$1").trim();
            const jt = Ee.split(/<br\s*\/?>/i).filter((Dt) => Dt.trim());
            if (jt.length <= 1 && !Le)
              return Te ? `${se}${Yt(Ee)}${de}` : ie;
            const Et = [];
            let Kt = [];
            const cr = () => {
              Kt.length !== 0 && (Et.push(Vr(Kt)), Kt = []);
            };
            for (const Dt of jt) {
              const sn = ir(Dt);
              if (sn) {
                ...
                cr(), Et.push(Yt(Dt.trim()));
            }
            return cr(), `${se}${Et.join("")}${de}`;
          }
        ), queueMicrotask(() => {
          _.isDestroyed || _.commands.setContent(Ae);
        });
      }
      Ve(W), qe.current = W, T?.(W);
    }
  }, [_, Ut, T]), si = Y((W) => {
    ...
    getTableOfContents: () => {
      ...
      return _.state.doc.descendants((F, he) => {
        if (F.type.name === "heading") {
          const fe = F.attrs.level, ke = F.textContent.trim();
          ke && W.push({ id: `toc-heading-${he}`, text: ke, level: fe, pos: he });
        }
      }), W;
    },
      ...
      if (!(!_ || _.isDestroyed))
        try {
          ...
          if (he instanceof HTMLElement) {
            const fe = _.view.dom.closest(".editor-content-wrapper");
            if (fe) {
              const ke = fe.getBoundingClientRect(), ce = he.getBoundingClientRect().top - ke.top + fe.scrollTop;
              fe.scrollTo({ top: ce - 20, behavior: "smooth" });
            } else
      ...
      if (!(!(F.metaKey || F.ctrlKey) && he !== " ")) {
        ...
        if (!ae && (F.metaKey || F.ctrlKey) && F.key === "f") {
          if (F.preventDefault(), _) {
            const { state: ke } = _, { from: Ae, to: ce } = ke.selection;
            if (Ae !== ce) {
              const Se = ke.doc.textBetween(Ae, ce, " ");
              Se.trim() && Hu(Se.trim());
            }
          }
          Ft(!0), fs((ke) => ke + 1);
        ...
        if (F.key === " ")
          try {
            const { state: ke } = _, { selection: Ae } = ke, { $from: ce } = Ae, Se = ce.nodeBefore?.textContent || "";
            if (Se === "#####") {
            ...
            if (Yt) {
              ...
              if (Vr && ie) {
                const se = ke.tr, we = ce.pos - Se.length, de = ce.pos;
                se.delete(we, de);
  ...
  const ai = Y((W, F) => {
    ...
    let he = { top: 0, left: 0 };
    if (F) {
      const fe = F.getBoundingClientRect();
      he = { top: fe.bottom + 4, left: fe.left };
    } else {
      const { from: fe, to: ke } = _.state.selection, Ae = _.view.coordsAtPos(fe), ce = _.view.coordsAtPos(ke);
      he = { top: ce.bottom + 8, left: (Ae.left + ce.left) / 2 };
    }
    ...
    if (!he) return;
    const { from: fe, to: ke } = _.state.selection, Ae = fe !== ke ? _.state.doc.textBetween(fe, ke, `
`) : "", ce = he.scope === "document" || !Ae ? _.getText() : Ae, Se = _.view.coordsAtPos(fe), Yt = _.view.coordsAtPos(ke);
    Mu({
      selectionTop: Se.top,
      selectionBottom: Yt.bottom,
      selectionCenterX: (Se.left + Yt.right) / 2
    }), ns(null), Yr(W, he.label, ce, { from: fe, to: ke }, F);
  }, [_, ft, Yr]), zu = Y(() => {
...
` + F).run(), Bt();
    ...
    if (!(Ze.status !== "complete" && Ze.status !== "error"))
      if (Ze.status === "complete") {
        const { action: W, actionLabel: F, inputText: he, selectionRange: fe } = Ze;
        Bt(), Yr(W, F, he, fe);
      } else
        Bt();
  }, [Ze, Bt, Yr]);
  ...
  ), ci = /* @__PURE__ */ A("div", { className: "editor-footer", children: [
    m && /* @__PURE__ */ f(
      Gx,
      {
        status: Tt.status,
  ...
  return /* @__PURE__ */ A("div", { className: `markdown-editor-container ${c}`, "data-theme": u, children: [
    m && g && Tt.hasRecoverableContent && /* @__PURE__ */ f(
      qx,
      {
        onRecover: () => {
          Tt.recover();
    ...
    /* @__PURE__ */ A("div", { className: `editor-main-area ${Re ? "editor-with-toc" : ""}`, children: [
      ...
      /* @__PURE__ */ A(
        Qk,
        {
          ...
          onError: es,
          children: [
            /* @__PURE__ */ f("div", { className: "editor-content-wrapper", ref: Ct, style: Uu, children: be === "wysiwyg" ? /* @__PURE__ */ A(He, { children: [
...
function fC({ node: e, updateAttributes: t }) {
  ...
  return /* @__PURE__ */ A(zn, { className: "code-block-wrapper", children: [
    /* @__PURE__ */ A("div", { className: "code-block-controls", contentEditable: !1, children: [
      /* @__PURE__ */ A("div", { className: "code-block-language-wrapper", children: [
        /* @__PURE__ */ f(
          "select",
