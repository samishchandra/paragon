...
import { ReactNodeViewRenderer as mr, NodeViewWrapper as vn, NodeViewContent as Bs, useEditorState as ml, useEditor as Fd, EditorContent as zd } from "@tiptap/react";
import * as T from "react";
import X, { useState as U, useRef as j, useEffect as K, useCallback as H, useLayoutEffect as fr, memo as vt, useImperativeHandle as Ud, createContext as fl, useContext as hl, useMemo as Dt, Component as Yd, useReducer as jd, lazy as Vd, forwardRef as Kd, Suspense as Ki } from "react";
import Gd from "@tiptap/extension-code-block-lowlight";
import { createLowlight as qd } from "lowlight";
import { ChevronDown as Pt, Check as Kt, Copy as Gt, Image as Ws, X as ht, Link2 as Hs, Type as hr, Undo as Xd, Redo as Zd, Bold as Fs, Italic as zs, Underline as Us, Strikethrough as Ys, Code as pl, Highlighter as gl, Link as js, List as Vs, ListOrdered as Ks, CheckSquare as Gs, Quote as qs, Code2 as bl, IndentIncrease as Qd, IndentDecrease as Jd, Table as ps, Minus as vl, Info as Jo, BookOpen as Xs, PenLine as em, Library as tm, ListTodo as Zs, Columns as Gi, Trash2 as un, Rows as qi, ToggleLeft as Xi, ArrowUpDown as nm, Sparkles as pr, Search as om, ChevronUp as rm, MousePointerClick as sm, CaseSensitive as im, WholeWord as am, Regex as lm, Replace as gs, ReplaceAll as cm, Plus as Qs, ClipboardList as um, MessageSquareText as wl, StickyNote as Nl, ChevronRight as yl, ChevronLeftIcon as dm, ChevronRightIcon as mm, ChevronDownIcon as fm, Calendar as kl, Hash as Zi, Cloud as hm, Loader2 as xl, CloudOff as pm, AlertCircle as gm, RotateCcw as Js, Activity as bm, Maximize2 as Cl, Minimize2 as Tl, AlertTriangle as vm, CheckCircle2 as wm, Eye as Nm, FileText as ei, FileCode as ym, ExternalLink as km, Pencil as xm, Unlink as Cm, Heading1 as Tm, Heading2 as Em, Heading3 as Sm, Heading4 as Mm, Heading5 as Dm, ImagePlus as Am, MessageSquare as El, RefreshCw as Pm, SpellCheck as Im, PanelRightClose as Rm, PanelRightOpen as Lm } from "lucide-react";
import { Plugin as Ce, PluginKey as Te, TextSelection as Ve, NodeSelection as Om, AllSelection as _m } from "@tiptap/pm/state";
import ti from "highlight.js/lib/languages/javascript";
import ni from "highlight.js/lib/languages/typescript";
import Sl from "highlight.js/lib/languages/python";
import oi from "highlight.js/lib/languages/xml";
import $m from "highlight.js/lib/languages/css";
import Bm from "highlight.js/lib/languages/json";
import gr from "highlight.js/lib/languages/bash";
import { jsx as z, Fragment as Wm, jsxs as Hm } from "react/jsx-runtime";
import * as Ml from "react-dom";
import Fm, { createPortal as zm } from "react-dom";
import { Fragment as Dl, Slice as jr, DOMSerializer as Um } from "@tiptap/pm/model";
import Ym from "@tiptap/starter-kit";
import jm from "@tiptap/extension-placeholder";
import Vm from "@tiptap/extension-text-align";
import Km from "@tiptap/extension-highlight";
import Gm from "@tiptap/extension-link";
import { Table as qm } from "@tiptap/extension-table";
import Xm from "@tiptap/extension-table-row";
import Zm from "@tiptap/extension-table-cell";
import Qm from "@tiptap/extension-table-header";
import { Extension as Ue, Node as br, mergeAttributes as kn, InputRule as _e, Mark as Al } from "@tiptap/core";
import { DecorationSet as je, Decoration as Ze } from "@tiptap/pm/view";
import Jm from "@tiptap/extension-bullet-list";
import ef from "@tiptap/extension-ordered-list";
import tf from "@tiptap/extension-list-item";
import nf from "@tiptap/extension-task-list";
import of from "@tiptap/extension-task-item";
import { findWrapping as Qi, canJoin as rf } from "@tiptap/pm/transform";
import sf from "@tiptap/extension-underline";
import af from "@tiptap/extension-subscript";
import lf from "@tiptap/extension-superscript";
import cf from "@tiptap/extension-typography";
import uf from "@tiptap/extension-image";
import { createRoot as df } from "react-dom/client";
import { liftListItem as Ji, sinkListItem as ea } from "@tiptap/pm/schema-list";
import { undo as mf, redo as ff } from "@tiptap/pm/history";
import hf from "@tiptap/extension-horizontal-rule";
import pf from "@tiptap/extension-code";
import gf from "@tiptap/extension-bold";
import bf from "@tiptap/extension-italic";
import vf from "@tiptap/extension-strike";
const be = qd();
...
function Nf({ node: e, updateAttributes: t, extension: n }) {
...
function Pl({ isOpen: e, onClose: t, onInsert: n, position: o }) {
    ...
    if (n)
      return () => {
        for (let r = 0; r < o.length; r++) {
          const s = o[r];
          typeof s == "function" ? s() : ta(e[r], null);
        }
      };
  };
}
...
}, xf = T[" useInsertionEffect ".trim().toString()] || It;
function si({
  prop: e,
  defaultProp: t,
  onChange: n = () => {
...
// @__NO_SIDE_EFFECTS__
function Vn(e) {
  const t = /* @__PURE__ */ Sf(e), n = T.forwardRef((o, r) => {
    const { children: s, ...a } = o, i = T.Children.toArray(s), l = i.find(Df);
    if (l) {
...
var Ef = /* @__PURE__ */ Vn("Slot");
// @__NO_SIDE_EFFECTS__
function Sf(e) {
  const t = T.forwardRef((n, o) => {
    const { children: r, ...s } = n;
    if (T.isValidElement(r)) {
      const a = Pf(r), i = Af(s, r.props);
...
// @__NO_SIDE_EFFECTS__
function Mf(e) {
  const t = ({ children: n }) => /* @__PURE__ */ z(Wm, { children: n });
...
var Rf = T.createContext(void 0);
function Ol(e) {
  const t = T.useContext(Rf);
  return e || t || "ltr";
}
function pt(e) {
  const t = T.useRef(e);
...
var Of = "DismissableLayer", vs = "dismissableLayer.update", _f = "dismissableLayer.pointerDownOutside", $f = "dismissableLayer.focusOutside", na, _l = T.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: i,
      ...l
    } = e, c = T.useContext(_l), [u, d] = T.useState(null), f = u?.ownerDocument ?? globalThis?.document, [, h] = T.useState({}), g = Ie(t, (S) => d(S)), p = Array.from(c.layers), [b] = [...c.layersWithOutsidePointerEventsDisabled].slice(-1), w = p.indexOf(b), v = u ? p.indexOf(u) : -1, y = c.layersWithOutsidePointerEventsDisabled.size > 0, E = v >= w, N = Hf((S) => {
    ...
    return Lf((S) => {
      ...
      if (u)
        return n && (c.layersWithOutsidePointerEventsDisabled.size === 0 && (na = f.body.style.pointerEvents, f.body.style.pointerEvents = "none"), c.layersWithOutsidePointerEventsDisabled.add(u)), c.layers.add(u), oa(), () => {
          n && c.layersWithOutsidePointerEventsDisabled.size === 1 && (f.body.style.pointerEvents = na);
        };
    }, [u, f, n, c]), T.useEffect(() => () => {
...
ii.displayName = Of;
var Bf = "DismissableLayerBranch", Wf = T.forwardRef((e, t) => {
  const n = T.useContext(_l), o = T.useRef(null), r = Ie(t, o);
  return T.useEffect(() => {
    const s = o.current;
    if (s)
...
function Ff(e, t = globalThis?.document) {
  ...
  return T.useEffect(() => {
    const r = (s) => {
      s.target && !o.current && $l($f, n, { originalEvent: s }, {
        discrete: !1
      });
    };
...
function zf() {
  T.useEffect(() => {
    ...
    return document.body.insertAdjacentElement("afterbegin", e[0] ?? ra()), document.body.insertAdjacentElement("beforeend", e[1] ?? ra()), Vr++, () => {
...
var Kr = "focusScope.autoFocusOnMount", Gr = "focusScope.autoFocusOnUnmount", sa = { bubbles: !1, cancelable: !0 }, Uf = "FocusScope", Bl = T.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: o = !1,
    onMountAutoFocus: r,
  ...
  T.useEffect(() => {
    ...
    if (i) {
      ...
      if (!i.contains(p)) {
        const w = new CustomEvent(Kr, sa);
        i.addEventListener(Kr, c), i.dispatchEvent(w), w.defaultPrevented || (Yf(qf(Wl(i)), { select: !0 }), document.activeElement === p && Mt(i));
      }
      return () => {
        i.removeEventListener(Kr, c), setTimeout(() => {
          const w = new CustomEvent(Gr, sa);
          i.addEventListener(Gr, u), i.dispatchEvent(w), w.defaultPrevented || Mt(p ?? document.body, { select: !0 }), i.removeEventListener(Gr, u), aa.remove(h);
        }, 0);
      };
    }
  }, [i, c, u, h]);
  const g = T.useCallback(
    (p) => {
      ...
      if (b && w) {
        const v = p.currentTarget, [y, E] = jf(v);
...
function jf(e) {
  const t = Wl(e), n = ia(t, e), o = ia(t.reverse(), e);
  return [n, o];
}
function Wl(e) {
...
function ia(e, t) {
  for (const n of e)
    if (!Vf(n, { upTo: t })) return n;
}
function Vf(e, { upTo: t }) {
...
function Gf() {
  ...
  return {
    add(t) {
      const n = e[0];
      t !== n && n?.pause(), e = la(e, t), e.unshift(t);
    },
    remove(t) {
      e = la(e, t), e[0]?.resume();
    }
...
var Xf = T[" useId ".trim().toString()] || (() => {
}), Zf = 0;
function er(e) {
  const [t, n] = T.useState(Xf());
  return It(() => {
    n((o) => o ?? String(Zf++));
  }, [e]), e || (t ? `radix-${t}` : "");
}
const Qf = ["top", "right", "bottom", "left"], Rt = Math.min, He = Math.max, tr = Math.round, Po = Math.floor, rt = (e) => ({
  x: e,
  y: e
}), Jf = {
  left: "right",
...
const th = /* @__PURE__ */ new Set(["top", "bottom"]);
function nt(e) {
  return th.has(bt(e)) ? "y" : "x";
}
function ci(e) {
  return ai(nt(e));
}
...
const ca = ["left", "right"], ua = ["right", "left"], rh = ["top", "bottom"], sh = ["bottom", "top"];
function ih(e, t, n) {
  switch (e) {
    case "top":
    case "bottom":
      return n ? t ? ua : ca : t ? ca : ua;
    case "left":
    case "right":
      return t ? rh : sh;
    default:
...
async function Kn(e, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: h = 0
  } = gt(t, e), g = Hl(h), b = i[f ? d === "floating" ? "reference" : "floating" : d], w = or(await s.getClippingRect({
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const w = bt(r), v = nt(i), y = bt(i) === i, E = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), N = f || (y || !p ? [nr(i)] : oh(i)), C = g !== "none";
      !f && C && N.push(...ah(i, p, g, E));
...
async function fh(e, t) {
  const {
    ...
    platform: o,
    elements: r
  } = e, s = await (o.isRTL == null ? void 0 : o.isRTL(r.floating)), a = bt(n), i = Cn(n), l = nt(n) === "y", c = Fl.has(a) ? -1 : 1, u = s && l ? -1 : 1, d = gt(t, e);
  let {
    mainAxis: f,
    crossAxis: h,
    alignmentAxis: g
...
const hh = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (c) {
        var w, v;
        const y = f === "y" ? "width" : "height", E = Fl.has(bt(r)), N = s.reference[d] - s.floating[y] + (E && ((w = a.offset) == null ? void 0 : w[d]) || 0) + (E ? 0 : b.crossAxis), C = s.reference[d] + s.reference[y] + (E ? 0 : ((v = a.offset) == null ? void 0 : v[d]) || 0) - (E ? b.crossAxis : 0);
        g < N ? g = N : g > C && (g = C);
      }
      return {
        [f]: h,
...
function eo(e) {
  ...
  return /auto|scroll|overlay|hidden|clip/.test(t + o + n) && !vh.has(r);
}
const wh = /* @__PURE__ */ new Set(["table", "td", "th"]);
function Nh(e) {
  return wh.has(Tn(e));
}
...
const kh = ["transform", "translate", "scale", "rotate", "perspective"], xh = ["transform", "translate", "scale", "rotate", "perspective", "filter"], Ch = ["paint", "layout", "strict", "content"];
function ui(e) {
  const t = di(), n = Qe(e) ? Je(e) : e;
  return kh.some((o) => n[o] ? n[o] !== "none" : !1) || (n.containerType ? n.containerType !== "normal" : !1) || !t && (n.backdropFilter ? n.backdropFilter !== "none" : !1) || !t && (n.filter ? n.filter !== "none" : !1) || xh.some((o) => (n.willChange || "").includes(o)) || Ch.some((o) => (n.contain || "").includes(o));
}
function Th(e) {
  let t = Lt(e);
  for (; st(t) && !wn(t); ) {
...
function Ul(e) {
  const t = Lt(e);
  return wn(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : st(t) && eo(t) ? t : Ul(t);
}
function Gn(e, t, n) {
  var o;
  t === void 0 && (t = []), n === void 0 && (n = !0);
  const r = Ul(e), s = r === ((o = e.ownerDocument) == null ? void 0 : o.body), a = Fe(r);
  if (s) {
    const i = ys(a);
...
const Sh = /* @__PURE__ */ rt(0);
function jl(e) {
  const t = Fe(e);
  return !di() || !t.visualViewport ? Sh : {
...
const Rh = /* @__PURE__ */ new Set(["absolute", "fixed"]);
function Lh(e, t) {
...
function Kl(e, t) {
  const n = Lt(e);
  return n === t || !Qe(n) || wn(n) ? !1 : Je(n).position === "fixed" || Kl(n, t);
}
function Oh(e, t) {
  const n = t.get(e);
  if (n)
  ...
  for (; Qe(a) && !wn(a); ) {
    const i = Je(a), l = ui(a);
    !l && i.position === "fixed" && (r = null), (s ? !l && !r : !l && i.position === "static" && !!r && Rh.has(r.position) || eo(a) && !l && Kl(e, a)) ? o = o.filter((u) => u !== a) : r = i, a = Lt(a);
  }
  return t.set(e, o), o;
}
function _h(e) {
  ...
  const a = [...n === "clippingAncestors" ? Nr(t) ? [] : Oh(t, this._c) : [].concat(n), o], i = a[0], l = a.reduce((c, u) => {
    const d = ga(t, u, r);
...
function Bh(e, t, n) {
  ...
  s && !o && r && c();
  const u = r && !o && !s ? Vl(r, i) : rt(0), d = a.left + i.scrollLeft - l.x - u.x, f = a.top + i.scrollTop - l.y - u.y;
  return {
    x: d,
    y: f,
    width: a.width,
...
function Gl(e, t) {
  ...
  for (; o && Nh(o) && qr(o); )
    o = ba(o, t);
  return o && wn(o) && qr(o) && !ui(o) ? n : o || Th(e) || n;
}
const Wh = async function(e) {
...
function zh(e, t) {
  ...
  function a(i, l) {
    ...
    function N(C) {
      ...
      S === 1 && !ql(c, e.getBoundingClientRect()) && a(), E = !1;
    }
    try {
...
function Uh(e, t, n, o) {
  ...
  function b() {
    const w = Vt(e);
    p && !ql(p, w) && n(), p = w, g = requestAnimationFrame(b);
  }
  return n(), () => {
    var w;
    u.forEach((v) => {
...
const Yh = hh, jh = ph, Vh = dh, Kh = bh, Gh = mh, va = uh, qh = gh, Xh = (e, t, n) => {
...
var Zh = typeof document < "u", Qh = function() {
}, Go = Zh ? fr : Qh;
function rr(e, t) {
  if (e === t)
    return !0;
...
function Jh(e) {
  ...
  const [g, p] = T.useState(null), [b, w] = T.useState(null), v = T.useCallback((I) => {
    ...
    M.current && (I.platform = M.current), Xh(C.current, S.current, I).then((P) => {
      const $ = {
        ...P,
      ...
      L.current && !rr(k.current, $) && (k.current = $, Ml.flushSync(() => {
        d($);
      }));
    });
  }, [f, t, n, M, A]);
  ...
  const _ = T.useMemo(() => ({
    ...
    if (!W.floating)
      return I;
    const P = wa(W.floating, u.x), $ = wa(W.floating, u.y);
    return i ? {
      ...I,
...
const ep = (e) => {
  ...
  return {
    ...
    fn(n) {
      ...
      return o && t(o) ? o.current != null ? va({
        element: o.current,
        padding: r
      }).fn(n) : {} : o ? va({
        element: o,
...
var lp = "Arrow", Zl = T.forwardRef((e, t) => {
...
var fi = "Popper", [Ql, xr] = xn(fi), [dp, Jl] = Ql(fi), ec = (e) => {
  const { __scopePopper: t, children: n } = e, [o, r] = T.useState(null);
  return /* @__PURE__ */ z(dp, { scope: t, anchor: o, onAnchorChange: r, children: n });
};
ec.displayName = fi;
var tc = "PopperAnchor", nc = T.forwardRef(
  (e, t) => {
    const { __scopePopper: n, virtualRef: o, ...r } = e, s = Jl(tc, n), a = T.useRef(null), i = Ie(t, a), l = T.useRef(null);
    return T.useEffect(() => {
      const c = l.current;
...
nc.displayName = tc;
var hi = "PopperContent", [mp, fp] = Ql(hi), oc = T.forwardRef(
  (e, t) => {
    const {
      __scopePopper: n,
      side: o = "bottom",
      ...
      onPlaced: g,
      ...p
    } = e, b = Jl(hi, n), [w, v] = T.useState(null), y = Ie(t, (O) => v(O)), [E, N] = T.useState(null), C = up(E), S = C?.width ?? 0, k = C?.height ?? 0, D = o + (s !== "center" ? "-" + s : ""), x = typeof u == "number" ? u : { top: 0, right: 0, bottom: 0, left: 0, ...u }, M = Array.isArray(c) ? c : [c], A = M.length > 0, R = {
      padding: x,
      boundary: M.filter(pp),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: A
    }, { refs: L, floatingStyles: _, placement: W, isPositioned: V, middlewareData: I } = Jh({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: D,
      whileElementsMounted: (...O) => Uh(...O, {
      ...
      middleware: [
        tp({ mainAxis: r + k, alignmentAxis: a }),
        l && np({
          mainAxis: !0,
          crossAxis: !1,
        ...
        E && ap({ element: E, padding: i }),
        gp({ arrowWidth: S, arrowHeight: k }),
        f && ip({ strategy: "referenceHidden", ...R })
      ]
    }), [P, $] = ic(W), q = pt(g);
    It(() => {
      V && q?.();
...
oc.displayName = hi;
var rc = "PopperArrow", hp = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, sc = T.forwardRef(function(t, n) {
  const { __scopePopper: o, ...r } = t, s = fp(rc, o), a = hp[s.placedSide];
  return (
...
var gp = (e) => ({
  ...
  options: e,
  fn(t) {
    const { placement: n, rects: o, middlewareData: r } = t, a = r.arrow?.centerOffset !== 0, i = a ? 0 : e.arrowWidth, l = a ? 0 : e.arrowHeight, [c, u] = ic(n), d = { start: "0%", center: "50%", end: "100%" }[u], f = (r.arrow?.x ?? 0) + i / 2, h = (r.arrow?.y ?? 0) + l / 2;
    let g = "", p = "";
...
var ac = ec, lc = nc, cc = oc, uc = sc, bp = "Portal", pi = T.forwardRef((e, t) => {
...
var qt = (e) => {
  const { present: t, children: n } = e, o = wp(t), r = typeof n == "function" ? n({ present: o.isPresent }) : T.Children.only(n), s = Ie(o.ref, Np(r));
  return typeof n == "function" || o.isPresent ? T.cloneElement(r, { ref: s }) : null;
};
qt.displayName = "Presence";
function wp(e) {
  const [t, n] = T.useState(), o = T.useRef(null), r = T.useRef(e), s = T.useRef("none"), a = e ? "mounted" : "unmounted", [i, l] = vp(a, {
    mounted: {
      UNMOUNT: "unmounted",
...
var Zr = "rovingFocusGroup.onEntryFocus", yp = { bubbles: !1, cancelable: !0 }, to = "RovingFocusGroup", [ks, dc, kp] = Ll(to), [xp, mc] = xn(
  to,
  [kp]
), [Cp, Tp] = xp(to), fc = T.forwardRef(
  (e, t) => /* @__PURE__ */ z(ks.Provider, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ z(ks.Slot, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ z(Ep, { ...e, ref: t }) }) })
);
fc.displayName = to;
var Ep = T.forwardRef((e, t) => {
  const {
    ...
    ...d
  } = e, f = T.useRef(null), h = Ie(t, f), g = Ol(s), [p, b] = si({
    prop: a,
    defaultProp: i ?? null,
    onChange: l,
    caller: to
  }), [w, v] = T.useState(!1), y = pt(c), E = dc(n), N = T.useRef(!1), [C, S] = T.useState(0);
  return T.useEffect(() => {
    const k = f.current;
    if (k)
...
}), hc = "RovingFocusGroupItem", pc = T.forwardRef(
  (e, t) => {
    const {
      __scopeRovingFocusGroup: n,
      focusable: o = !0,
      ...
      children: a,
      ...i
    } = e, l = er(), c = s || l, u = Tp(hc, n), d = u.currentTabStopId === c, f = dc(n), { onFocusableItemAdd: h, onFocusableItemRemove: g, currentTabStopId: p } = u;
    return T.useEffect(() => {
      if (o)
        return h(), () => g();
    }, [o, h, g]), /* @__PURE__ */ z(
        ...
        children: /* @__PURE__ */ z(
          Ae.span,
          {
            ...
            onKeyDown: ae(e.onKeyDown, (b) => {
              ...
              const w = Dp(b, u.orientation, u.dir);
              if (w !== void 0) {
...
var Pp = fc, Ip = pc, Rp = function(e) {
  if (typeof document > "u")
    return null;
  var t = Array.isArray(e) ? e[0] : e;
  return t.ownerDocument.body;
}, tn = /* @__PURE__ */ new WeakMap(), Ro = /* @__PURE__ */ new WeakMap(), Lo = {}, Qr = 0, bc = function(e) {
  ...
  var o = Array.from(Array.isArray(e) ? e : [e]), r = Rp(e);
  return r ? (o.push.apply(o, Array.from(r.querySelectorAll("[aria-live], script"))), Op(o, r, n, "aria-hidden")) : function() {
    return null;
  };
}, tt = function() {
...
var qo = "right-scroll-bar-position", Xo = "width-before-scroll-bar", Bp = "with-scroll-bars-hidden", Wp = "--removed-body-scroll-bar-size";
function Jr(e, t) {
...
var Fp = typeof window < "u" ? T.useLayoutEffect : T.useEffect, Na = /* @__PURE__ */ new WeakMap();
function zp(e, t) {
  var n = Hp(null, function(o) {
...
var Nc = jp(), es = function() {
}, Cr = T.forwardRef(function(e, t) {
  var n = T.useRef(null), o = T.useState({
    onScrollCapture: es,
    onWheelCapture: es,
    onTouchMoveCapture: es
  }), r = o[0], s = o[1], a = e.forwardProps, i = e.children, l = e.className, c = e.removeScrollBar, u = e.enabled, d = e.shards, f = e.sideCar, h = e.noRelative, g = e.noIsolation, p = e.inert, b = e.allowPinchZoom, w = e.as, v = w === void 0 ? "div" : w, y = e.gapMode, E = vc(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), N = f, C = zp([n, t]), S = tt(tt({}, E), r);
  return T.createElement(
    T.Fragment,
    null,
    u && T.createElement(N, { sideCar: Nc, removeScrollBar: c, shards: d, noRelative: h, noIsolation: g, inert: p, setCallbacks: s, allowPinchZoom: !!b, lockRef: n, gapMode: y }),
...
var Zp = function() {
  ...
  if (e === void 0 && (e = "margin"), typeof window > "u")
    return Jp;
  var t = eg(e), n = document.documentElement.clientWidth, o = window.innerWidth;
  return {
    left: t[0],
    top: t[1],
    right: t[2],
...
}, ng = yc(), mn = "data-scroll-locked", og = function(e, t, n, o) {
...
`);
  ...
  return T.createElement(ng, { styles: og(s, !t, r, n ? "" : "!important") });
}, xs = !1;
if (typeof window < "u")
  try {
...
var nn = xs ? { passive: !1 } : !1, ig = function(e) {
  ...
  return (
    ...
    !(n.overflowY === n.overflowX && !ig(e) && n[t] === "visible")
  );
}, ag = function(e) {
  ...
  return e === "v" ? cg(t) : ug(t);
}, dg = function(e, t) {
  return e === "h" && t === "rtl" ? -1 : 1;
}, mg = function(e, t, n, o, r) {
  var s = dg(e, window.getComputedStyle(t).direction), a = s * o, i = n.target, l = t.contains(i), c = !1, u = a > 0, d = 0, f = 0;
  do {
    if (!i)
      break;
    var h = Cc(e, i), g = h[0], p = h[1], b = h[2], w = p - b - s * g;
    (g || w) && xc(e, i) && (d += w, f += g);
    var v = i.parentNode;
...
function gg(e) {
  var t = T.useRef([]), n = T.useRef([0, 0]), o = T.useRef(), r = T.useState(pg++)[0], s = T.useState(yc)[0], a = T.useRef(e);
  T.useEffect(function() {
    a.current = e;
  }, [e]), T.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(r));
      var p = $p([e.lockRef.current], (e.shards || []).map(Ca), !0).filter(Boolean);
  ...
  var i = T.useCallback(function(p, b) {
    ...
    if (!k)
      return !0;
    if (k ? N = S : (N = S === "v" ? "h" : "v", k = ka(S, C)), !k)
      return !1;
    if (!o.current && "changedTouches" in p && (y || E) && (o.current = N), !N)
      return !0;
    var D = o.current || N;
    return mg(D, b, p, D === "h" ? y : E);
  }, []), l = T.useCallback(function(p) {
    var b = p;
    if (!(!on.length || on[on.length - 1] !== s)) {
      var w = "deltaY" in b ? xa(b) : _o(b), v = t.current.filter(function(N) {
        return N.name === b.type && (N.target === b.target || b.target === N.shadowParent) && fg(N.delta, w);
      })[0];
      if (v && v.should) {
      ...
      if (!v) {
        var y = (a.current.shards || []).map(Ca).filter(Boolean).filter(function(N) {
    ...
    var y = { name: p, delta: b, target: w, should: v, shadowParent: bg(w) };
    ...
    c(p.type, xa(p), p.target, i(p, e.lockRef.current));
  ...
  return T.createElement(
    T.Fragment,
    null,
    g ? T.createElement(s, { styles: hg(r) }) : null,
    h ? T.createElement(sg, { noRelative: e.noRelative, gapMode: e.gapMode }) : null
  );
}
function bg(e) {
...
var Tc = T.forwardRef(function(e, t) {
  return T.createElement(Cr, tt({}, e, { ref: t, sideCar: vg }));
});
Tc.classNames = Cr.classNames;
var Cs = ["Enter", " "], wg = ["ArrowDown", "PageUp", "Home"], Ec = ["ArrowUp", "PageDown", "End"], Ng = [...wg, ...Ec], yg = {
  ltr: [...Cs, "ArrowRight"],
  rtl: [...Cs, "ArrowLeft"]
}, kg = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, no = "Menu", [qn, xg, Cg] = Ll(no), [Xt, Sc] = xn(no, [
  Cg,
  xr,
  mc
]), Tr = xr(), Mc = mc(), [Tg, Zt] = Xt(no), [Eg, oo] = Xt(no), Dc = (e) => {
  const { __scopeMenu: t, open: n = !1, children: o, dir: r, onOpenChange: s, modal: a = !0 } = e, i = Tr(t), [l, c] = T.useState(null), u = T.useRef(!1), d = pt(s), f = Ol(r);
  return T.useEffect(() => {
    const h = () => {
  ...
  }, []), /* @__PURE__ */ z(ac, { ...i, children: /* @__PURE__ */ z(
    Tg,
    {
      scope: t,
      open: n,
...
Dc.displayName = no;
var Sg = "MenuAnchor", gi = T.forwardRef(
  (e, t) => {
...
gi.displayName = Sg;
var bi = "MenuPortal", [Mg, Ac] = Xt(bi, {
  forceMount: void 0
}), Pc = (e) => {
  const { __scopeMenu: t, forceMount: n, children: o, container: r } = e, s = Zt(bi, t);
  return /* @__PURE__ */ z(Mg, { scope: t, forceMount: n, children: /* @__PURE__ */ z(qt, { present: n || s.open, children: /* @__PURE__ */ z(pi, { asChild: !0, container: r, children: o }) }) });
};
Pc.displayName = bi;
var Ke = "MenuContent", [Dg, vi] = Xt(Ke), Ic = T.forwardRef(
  (e, t) => {
    const n = Ac(Ke, e.__scopeMenu), { forceMount: o = n.forceMount, ...r } = e, s = Zt(Ke, e.__scopeMenu), a = oo(Ke, e.__scopeMenu);
    return /* @__PURE__ */ z(qn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ z(qt, { present: o || s.open, children: /* @__PURE__ */ z(qn.Slot, { scope: e.__scopeMenu, children: a.modal ? /* @__PURE__ */ z(Ag, { ...r, ref: t }) : /* @__PURE__ */ z(Pg, { ...r, ref: t }) }) }) });
  }
), Ag = T.forwardRef(
  (e, t) => {
...
}), Ig = /* @__PURE__ */ Vn("MenuContent.ScrollLock"), wi = T.forwardRef(
  (e, t) => {
    const {
      __scopeMenu: n,
      loop: o = !1,
      ...
      ...p
    } = e, b = Zt(Ke, n), w = oo(Ke, n), v = Tr(n), y = Mc(n), E = xg(n), [N, C] = T.useState(null), S = T.useRef(null), k = Ie(t, S, b.onContentChange), D = T.useRef(0), x = T.useRef(""), M = T.useRef(0), A = T.useRef(null), R = T.useRef("right"), L = T.useRef(0), _ = g ? Tc : T.Fragment, W = g ? { as: Ig, allowPinchZoom: !0 } : void 0, V = (P) => {
      const $ = x.current + P, q = E().filter((O) => !O.disabled), F = document.activeElement, Y = q.find((O) => O.ref.current === F)?.textValue, G = q.map((O) => O.textValue), B = Yg(G, $, Y), J = q.find((O) => O.textValue === B)?.ref.current;
      (function O(ee) {
    ...
    const I = T.useCallback((P) => R.current === A.current?.side && Vg(P, A.current?.area), []);
    return /* @__PURE__ */ z(
      Dg,
      {
        scope: n,
                    ...
                    children: /* @__PURE__ */ z(
                      cc,
                      {
                        ...
                        onKeyDown: ae(p.onKeyDown, (P) => {
                          ...
                          const G = S.current;
                          if (P.target !== G || !Ng.includes(P.key)) return;
                          P.preventDefault();
                          const J = E().filter((O) => !O.disabled).map((O) => O.ref.current);
                          Ec.includes(P.key) && J.reverse(), zg(J);
                        }),
...
Ic.displayName = Ke;
var Rg = "MenuGroup", Ni = T.forwardRef(
  (e, t) => {
...
Ni.displayName = Rg;
var Lg = "MenuLabel", Rc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e;
...
Rc.displayName = Lg;
var sr = "MenuItem", Ta = "menu.itemSelect", Er = T.forwardRef(
  (e, t) => {
    const { disabled: n = !1, onSelect: o, ...r } = e, s = T.useRef(null), a = oo(sr, e.__scopeMenu), i = vi(sr, e.__scopeMenu), l = Ie(t, s), c = T.useRef(!1), u = () => {
      const d = s.current;
      if (!n && d) {
        const f = new CustomEvent(Ta, { bubbles: !0, cancelable: !0 });
        d.addEventListener(Ta, (h) => o?.(h), { once: !0 }), Rl(d, f), f.defaultPrevented ? c.current = !1 : a.onClose();
      }
    };
    return /* @__PURE__ */ z(
      Lc,
...
var Lc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, disabled: o = !1, textValue: r, ...s } = e, a = vi(sr, n), i = Mc(n), l = T.useRef(null), c = Ie(t, l), [u, d] = T.useState(!1), [f, h] = T.useState("");
    return T.useEffect(() => {
      const g = l.current;
      ...
      qn.ItemSlot,
      {
        ...
        disabled: o,
        textValue: r ?? f,
        children: /* @__PURE__ */ z(Ip, { asChild: !0, ...i, focusable: !o, children: /* @__PURE__ */ z(
          Ae.div,
          {
            role: "menuitem",
...
), Og = "MenuCheckboxItem", Oc = T.forwardRef(
  (e, t) => {
    const { checked: n = !1, onCheckedChange: o, ...r } = e;
    return /* @__PURE__ */ z(Hc, { scope: e.__scopeMenu, checked: n, children: /* @__PURE__ */ z(
      Er,
      {
...
var _c = "MenuRadioGroup", [_g, $g] = Xt(
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ z(_g, { scope: e.__scopeMenu, value: n, onValueChange: s, children: /* @__PURE__ */ z(Ni, { ...r, ref: t }) });
  }
);
$c.displayName = _c;
var Bc = "MenuRadioItem", Wc = T.forwardRef(
  (e, t) => {
    const { value: n, ...o } = e, r = $g(Bc, e.__scopeMenu), s = n === r.value;
    return /* @__PURE__ */ z(Hc, { scope: e.__scopeMenu, checked: s, children: /* @__PURE__ */ z(
      Er,
      {
        role: "menuitemradio",
        "aria-checked": s,
...
Wc.displayName = Bc;
var yi = "MenuItemIndicator", [Hc, Bg] = Xt(
  yi,
  { checked: !1 }
), Fc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, forceMount: o, ...r } = e, s = Bg(yi, n);
    return /* @__PURE__ */ z(
      qt,
      {
...
Fc.displayName = yi;
var Wg = "MenuSeparator", zc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e;
    return /* @__PURE__ */ z(
      Ae.div,
...
zc.displayName = Wg;
var Hg = "MenuArrow", Uc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e, r = Tr(n);
...
Uc.displayName = Hg;
var Fg = "MenuSub", [V1, Yc] = Xt(Fg), Bn = "MenuSubTrigger", jc = T.forwardRef(
  (e, t) => {
    const n = Zt(Bn, e.__scopeMenu), o = oo(Bn, e.__scopeMenu), r = Yc(Bn, e.__scopeMenu), s = vi(Bn, e.__scopeMenu), a = T.useRef(null), { pointerGraceTimerRef: i, onPointerGraceIntentChange: l } = s, c = { __scopeMenu: e.__scopeMenu }, u = T.useCallback(() => {
    ...
    return T.useEffect(() => u, [u]), T.useEffect(() => {
      ...
      Lc,
      {
        ...
        onKeyDown: ae(e.onKeyDown, (d) => {
          ...
          e.disabled || f && d.key === " " || yg[o.dir].includes(d.key) && (n.onOpenChange(!0), n.content?.focus(), d.preventDefault());
        })
      }
    ) });
  }
...
jc.displayName = Bn;
var Vc = "MenuSubContent", Kc = T.forwardRef(
  (e, t) => {
    const n = Ac(Ke, e.__scopeMenu), { forceMount: o = n.forceMount, ...r } = e, s = Zt(Ke, e.__scopeMenu), a = oo(Ke, e.__scopeMenu), i = Yc(Vc, e.__scopeMenu), l = T.useRef(null), c = Ie(t, l);
    return /* @__PURE__ */ z(qn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ z(qt, { present: o || s.open, children: /* @__PURE__ */ z(qn.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ z(
      wi,
      {
        ...
        onKeyDown: ae(e.onKeyDown, (u) => {
          const d = u.currentTarget.contains(u.target), f = kg[a.dir].includes(u.key);
...
var Kg = Dc, Gg = gi, qg = Pc, Xg = Ic, Zg = Ni, Qg = Rc, Jg = Er, eb = Oc, tb = $c, nb = Wc, ob = Fc, rb = zc, sb = Uc, ib = jc, ab = Kc, Sr = "DropdownMenu", [lb] = xn(
  Sr,
  [Sc]
), Le = Sc(), [cb, qc] = lb(Sr), Xc = (e) => {
  const {
  ...
  return /* @__PURE__ */ z(
    cb,
    {
      ...
      modal: i,
      children: /* @__PURE__ */ z(Kg, { ...l, open: u, onOpenChange: d, dir: o, modal: i, children: n })
    }
  );
};
Xc.displayName = Sr;
var Zc = "DropdownMenuTrigger", Qc = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, disabled: o = !1, ...r } = e, s = qc(Zc, n), a = Le(n);
    return /* @__PURE__ */ z(Gg, { asChild: !0, ...a, children: /* @__PURE__ */ z(
      Ae.button,
      {
        type: "button",
        id: s.triggerId,
...
Qc.displayName = Zc;
var ub = "DropdownMenuPortal", Jc = (e) => {
  const { __scopeDropdownMenu: t, ...n } = e, o = Le(t);
  return /* @__PURE__ */ z(qg, { ...o, ...n });
};
Jc.displayName = ub;
var eu = "DropdownMenuContent", tu = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = qc(eu, n), s = Le(n), a = T.useRef(!1);
    return /* @__PURE__ */ z(
      Xg,
      {
        id: r.contentId,
...
tu.displayName = eu;
var db = "DropdownMenuGroup", mb = T.forwardRef(
  (e, t) => {
...
mb.displayName = db;
var fb = "DropdownMenuLabel", hb = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
...
hb.displayName = fb;
var pb = "DropdownMenuItem", nu = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
...
nu.displayName = pb;
var gb = "DropdownMenuCheckboxItem", bb = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
  return /* @__PURE__ */ z(eb, { ...r, ...o, ref: t });
});
bb.displayName = gb;
var vb = "DropdownMenuRadioGroup", wb = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
  return /* @__PURE__ */ z(tb, { ...r, ...o, ref: t });
});
wb.displayName = vb;
var Nb = "DropdownMenuRadioItem", yb = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
  return /* @__PURE__ */ z(nb, { ...r, ...o, ref: t });
});
yb.displayName = Nb;
var kb = "DropdownMenuItemIndicator", xb = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
  return /* @__PURE__ */ z(ob, { ...r, ...o, ref: t });
});
xb.displayName = kb;
var Cb = "DropdownMenuSeparator", ou = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
  return /* @__PURE__ */ z(rb, { ...r, ...o, ref: t });
});
ou.displayName = Cb;
var Tb = "DropdownMenuArrow", Eb = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
...
Eb.displayName = Tb;
var Sb = "DropdownMenuSubTrigger", Mb = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
  return /* @__PURE__ */ z(ib, { ...r, ...o, ref: t });
});
Mb.displayName = Sb;
var Db = "DropdownMenuSubContent", Ab = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Le(n);
  return /* @__PURE__ */ z(
    ab,
    {
...
Ab.displayName = Db;
var Pb = Xc, Ib = Qc, Rb = Jc, Lb = tu, Ob = nu, _b = ou;
function ru(e) {
  var t, n, o = "";
  if (typeof e == "string" || typeof e == "number") o += e;
  else if (typeof e == "object") if (Array.isArray(e)) {
    var r = e.length;
    for (t = 0; t < r; t++) e[t] && (n = ru(e[t])) && (o && (o += " "), o += n);
  } else for (n in e) e[n] && (o && (o += " "), o += n);
  return o;
}
function su() {
  for (var e, t, n = 0, o = "", r = arguments.length; n < r; n++) (e = arguments[n]) && (t = ru(e)) && (o && (o += " "), o += t);
  return o;
}
const xi = "-", $b = (e) => {
  const t = Wb(e), {
  ...
  return {
    getClassGroupId: (a) => {
      const i = a.split(xi);
      return i[0] === "" && i.length !== 1 && i.shift(), iu(i, t) || Bb(a);
    },
  ...
  const n = e[0], o = t.nextPart.get(n), r = o ? iu(e.slice(1), o) : void 0;
  if (r)
    return r;
  ...
  let o = (r) => {
    ...
    const u = s.length === 0 ? r : r.substring(l), d = Yb(u), f = d !== u, h = c && c > l ? c - l : void 0;
    return {
      modifiers: s,
  ...
  return o;
}, Yb = (e) => e.endsWith(Es) ? e.substring(0, e.length - 1) : e.startsWith(Es) ? e.substring(1) : e, jb = (e) => {
...
function Xb(e, ...t) {
  ...
  function a(l) {
    ...
    return n = Vb(c), o = n.cache.get, r = n.cache.set, s = i, i(l);
  }
  function i(l) {
    const c = o(l);
    if (c)
...
const Se = (e) => {
...
}, lu = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, cu = /^\((?:(\w[\w-]*):)?(.+)\)$/i, Zb = /^\d+\/\d+$/, Qb = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, Jb = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, ev = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, tv = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, nv = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, rn = (e) => Zb.test(e), ce = (e) => !!e && !Number.isNaN(Number(e)), Tt = (e) => !!e && Number.isInteger(Number(e)), ns = (e) => e.endsWith("%") && ce(e.slice(0, -1)), lt = (e) => Qb.test(e), ov = () => !0, rv = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  Jb.test(e) && !ev.test(e)
), uu = () => !1, sv = (e) => tv.test(e), iv = (e) => nv.test(e), av = (e) => !Z(e) && !Q(e), lv = (e) => En(e, fu, uu), Z = (e) => lu.test(e), Ht = (e) => En(e, hu, rv), os = (e) => En(e, fv, ce), Ma = (e) => En(e, du, uu), cv = (e) => En(e, mu, iv), $o = (e) => En(e, pu, sv), Q = (e) => cu.test(e), Ln = (e) => Sn(e, hu), uv = (e) => Sn(e, hv), Da = (e) => Sn(e, du), dv = (e) => Sn(e, fu), mv = (e) => Sn(e, mu), Bo = (e) => Sn(e, pu, !0), En = (e, t, n) => {
  const o = lu.exec(e);
  return o ? o[1] ? t(o[1]) : n(o[2]) : !1;
}, Sn = (e, t, n = !1) => {
  const o = cu.exec(e);
  return o ? o[1] ? t(o[1]) : n : !1;
}, du = (e) => e === "position" || e === "percentage", mu = (e) => e === "image" || e === "url", fu = (e) => e === "length" || e === "size" || e === "bg-size", hu = (e) => e === "length", fv = (e) => e === "number", hv = (e) => e === "family-name", pu = (e) => e === "shadow", pv = () => {
  const e = Se("color"), t = Se("font"), n = Se("text"), o = Se("font-weight"), r = Se("tracking"), s = Se("leading"), a = Se("breakpoint"), i = Se("container"), l = Se("spacing"), c = Se("radius"), u = Se("shadow"), d = Se("inset-shadow"), f = Se("text-shadow"), h = Se("drop-shadow"), g = Se("blur"), p = Se("perspective"), b = Se("aspect"), w = Se("ease"), v = Se("animate"), y = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], E = () => [
    ...
    span: ["full", Tt, Q, Z]
  }, Tt, Q, Z], A = () => [Tt, "auto", Q, Z], R = () => ["auto", "min", "max", "fr", Q, Z], L = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], _ = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], W = () => ["auto", ...k()], V = () => [rn, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...k()], I = () => [e, Q, Z], P = () => [...E(), Da, Ma, {
    position: [Q, Z]
  }], $ = () => ["no-repeat", {
    repeat: ["", "x", "y", "space", "round"]
  }], q = () => ["auto", "cover", "contain", dv, lv, {
    size: [Q, Z]
  }], F = () => [ns, Ln, Ht], Y = () => [
    ...
    Q,
    Z
  ], G = () => ["", ce, Ln, Ht], B = () => ["solid", "dashed", "dotted", "double"], J = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], O = () => [ce, ns, Da, Ma], ee = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    g,
...
function rs({
  ...
  return /* @__PURE__ */ m(Pb, { "data-slot": "dropdown-menu", ...e }, void 0, !1, {
...
function is({
  ...
  return /* @__PURE__ */ m(Rb, { children: /* @__PURE__ */ m(
    Lb,
    {
...
const Aa = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, Pa = su, bv = (e, t) => (n) => {
  var o;
  if (t?.variants == null) return Pa(e, n?.class, n?.className);
  ...
  return Pa(e, a, l, n?.class, n?.className);
}, Ms = bv(
...
var vv = Object.freeze({
  ...
  whiteSpace: "nowrap",
  wordWrap: "normal"
}), wv = "VisuallyHidden", gu = T.forwardRef(
  (e, t) => /* @__PURE__ */ z(
    Ae.span,
    {
      ...e,
...
gu.displayName = wv;
var Nv = gu, [Mr] = xn("Tooltip", [
  xr
]), Dr = xr(), bu = "TooltipProvider", yv = 700, Ds = "tooltip.open", [kv, Ci] = Mr(bu), vu = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = yv,
...
vu.displayName = bu;
var Zn = "Tooltip", [xv, ro] = Mr(Zn), wu = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: o,
  ...
  }, []), /* @__PURE__ */ z(ac, { ...c, children: /* @__PURE__ */ z(
    xv,
    {
      scope: t,
      contentId: f,
...
var As = "TooltipTrigger", Nu = T.forwardRef(
  (e, t) => {
    ...
    return T.useEffect(() => () => document.removeEventListener("pointerup", d), [d]), /* @__PURE__ */ z(lc, { asChild: !0, ...a, children: /* @__PURE__ */ z(
      Ae.button,
      {
...
Nu.displayName = As;
var Ti = "TooltipPortal", [Cv, Tv] = Mr(Ti, {
  forceMount: void 0
}), yu = (e) => {
  const { __scopeTooltip: t, forceMount: n, children: o, container: r } = e, s = ro(Ti, t);
  return /* @__PURE__ */ z(Cv, { scope: t, forceMount: n, children: /* @__PURE__ */ z(qt, { present: n || s.open, children: /* @__PURE__ */ z(pi, { asChild: !0, container: r, children: o }) }) });
};
yu.displayName = Ti;
var Nn = "TooltipContent", ku = T.forwardRef(
  (e, t) => {
    const n = Tv(Nn, e.__scopeTooltip), { forceMount: o = n.forceMount, side: r = "top", ...s } = e, a = ro(Nn, e.__scopeTooltip);
    return /* @__PURE__ */ z(qt, { present: o || a.open, children: a.disableHoverableContent ? /* @__PURE__ */ z(xu, { side: r, ...s, ref: t }) : /* @__PURE__ */ z(Ev, { side: r, ...s, ref: t }) });
  }
), Ev = T.forwardRef((e, t) => {
  const n = ro(Nn, e.__scopeTooltip), o = Ci(Nn, e.__scopeTooltip), r = T.useRef(null), s = Ie(t, r), [a, i] = T.useState(null), { trigger: l, onClose: c } = n, u = r.current, { onPointerInTransitChange: d } = o, f = T.useCallback(() => {
    ...
    (g, p) => {
      const b = g.currentTarget, w = { x: g.clientX, y: g.clientY }, v = Av(w, b.getBoundingClientRect()), y = Pv(w, v), E = Iv(p.getBoundingClientRect()), N = Lv([...y, ...E]);
      i(N), d(!0);
    },
    [d]
  );
  return T.useEffect(() => () => f(), [f]), T.useEffect(() => {
    ...
    if (a) {
      const g = (p) => {
        const b = p.target, w = { x: p.clientX, y: p.clientY }, v = l?.contains(b) || u?.contains(b), y = !Rv(w, a);
        v ? f() : y && (f(), c());
      };
      return document.addEventListener("pointermove", g), () => document.removeEventListener("pointermove", g);
    }
  }, [l, u, a, c, f]), /* @__PURE__ */ z(xu, { ...e, ref: s });
}), [Sv, Mv] = Mr(Zn, { isInside: !1 }), Dv = /* @__PURE__ */ Mf("TooltipContent"), xu = T.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: o,
      ...
      ii,
      {
        ...
        children: /* @__PURE__ */ Hm(
          cc,
          {
            ...
            children: [
              /* @__PURE__ */ z(Dv, { children: o }),
              /* @__PURE__ */ z(Sv, { scope: n, isInside: !0, children: /* @__PURE__ */ z(Nv, { id: l.contentId, role: "tooltip", children: r || o }) })
            ]
          }
        )
      }
...
ku.displayName = Nn;
var Cu = "TooltipArrow", Tu = T.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...o } = e, r = Dr(n);
    return Mv(
      Cu,
      n
    ).isInside ? null : /* @__PURE__ */ z(uc, { ...r, ...o, ref: t });
  }
);
Tu.displayName = Cu;
function Av(e, t) {
...
function Lv(e) {
  const t = e.slice();
  return t.sort((n, o) => n.x < o.x ? -1 : n.x > o.x ? 1 : n.y < o.y ? -1 : n.y > o.y ? 1 : 0), Ov(t);
}
function Ov(e) {
...
var _v = vu, $v = wu, Bv = Nu, Wv = yu, Hv = ku, Fv = Tu;
function zv({
  delayDuration: e = 0,
  ...t
}) {
...
function Ps({
  ...
  return /* @__PURE__ */ m(zv, { children: /* @__PURE__ */ m($v, { "data-slot": "tooltip", ...e }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/tooltip.tsx",
    lineNumber: 24,
    columnNumber: 7
  }, this) }, void 0, !1, {
...
function Is({
  ...
  return /* @__PURE__ */ m(Bv, { "data-slot": "tooltip-trigger", ...e }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/tooltip.tsx",
    lineNumber: 32,
    columnNumber: 10
  }, this);
...
function Rs({
  ...
  return /* @__PURE__ */ m(Wv, { children: /* @__PURE__ */ m(
    Hv,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ m(Fv, { className: "bg-foreground fill-foreground z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/tooltip.tsx",
          lineNumber: 53,
          columnNumber: 9
        }, this)
...
const ke = ({ onClick: e, isActive: t, disabled: n, children: o, tooltip: r }) => {
  ...
  lineNumber: 137,
  columnNumber: 3
}, void 0), Uv = vt(function({ editor: t, onCopyMarkdown: n, onOpenLinkPopover: o, className: r = "", autoReorderChecklist: s = !1, aiEnabled: a = !1, onAISparklesClick: i }) {
  const l = j(null), [c, u] = U(!1), [d, f] = U(void 0), h = ml({
    editor: t,
    selector: ({ editor: C }) => ({
      canUndo: C.can().undo(),
      canRedo: C.can().redo(),
    ...
    /* @__PURE__ */ m(rs, { children: [
      ...
      /* @__PURE__ */ m(is, { align: "start", children: [
        ...
        /* @__PURE__ */ m(ye, { onClick: () => w("prompt"), children: [
          /* @__PURE__ */ m(em, { size: 16, className: "mr-2", style: { color: "#B244B3" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 646,
            columnNumber: 13
          }, this),
        ...
        /* @__PURE__ */ m(ye, { onClick: () => w("resources"), children: [
          /* @__PURE__ */ m(tm, { size: 16, className: "mr-2", style: { color: "#63B148" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 649,
            columnNumber: 13
          }, this),
      ...
      /* @__PURE__ */ m(is, { align: "start", className: "w-56", children: [
        ...
        /* @__PURE__ */ m(
          ye,
          {
            ...
            children: [
              /* @__PURE__ */ m(Xi, { size: 16, className: "mr-2" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 713,
                columnNumber: 15
              }, this),
      ...
      children: [
        /* @__PURE__ */ m("div", { className: "find-replace-row", children: [
          /* @__PURE__ */ m("div", { className: "find-replace-input-wrapper", children: [
            /* @__PURE__ */ m(om, { size: 14, className: "find-replace-icon" }, void 0, !1, {
        ...
        E && /* @__PURE__ */ m("div", { className: "find-replace-row", children: [
          ...
          /* @__PURE__ */ m(
            "button",
            {
              ...
              title: "Replace all",
              children: [
                /* @__PURE__ */ m(cm, { size: 14 }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
                  lineNumber: 505,
                  columnNumber: 13
                }, this),
...
const jv = typeof navigator < "u" && /Mac|iPod|iPhone|iPad/.test(navigator.platform), ct = jv ? "⌘" : "Ctrl", Vv = ({ editor: e }) => {
...
function Jv(e, t, n) {
  ...
  const p = [
    ...
    { label: "divider" },
    { label: "Copy Table", icon: "copy", action: () => ew(t) }
  ], b = {
...
}), nw = Qm.extend({}), Un = new Te("tableSorting");
let Ut = null, Wn = null;
function ow(e) {
...
function sw(e, t, n) {
  ...
  if (c.length < 2) {
    Ia(n, a), r.dispatch(o.tr.setMeta(Un, { updated: !0 }));
    return;
  }
  const u = c.map((g) => {
    let p = "", b = 0;
  ...
  u.sort((g, p) => rw(g.sortValue, p.sortValue, a));
...
function iw(e, t, n, o) {
  ...
  return s.style.cssText = "display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;padding:0;font-size:10px;color:" + (e ? i : l) + ";background:transparent;border:none;border-radius:3px;cursor:pointer;user-select:none;transition:all 0.15s ease;opacity:" + (e ? "1" : "0.5") + ";pointer-events:auto;vertical-align:middle;", s.addEventListener("mouseenter", () => {
    ...
    u.preventDefault(), u.stopPropagation(), sw(o, t, n);
  ...
  return new Ce({
    ...
    state: {
      ...
      apply(t, n, o, r) {
        ...
        return !t.docChanged && !s?.updated && Wn ? Wn.map(t.mapping, t.doc) : (Wn = lw(r.doc, e), Wn);
      }
    },
    props: {
      decorations(t) {
        ...
        if (a.type.name === "tableRow") {
          ...
          a.forEach((u, d) => {
            if (u.type.name === "tableHeader") {
              ...
              const p = Ut?.tablePos === s && Ut?.columnIndex === l ? Ut.direction : null, b = l, w = s, v = Ze.widget(h, () => iw(p, w, b, t), { side: 1, key: "sort-" + s + "-" + b });
              n.push(v);
            }
            c += u.nodeSize, l++;
          });
        ...
        props: {
          handleTextInput(n, o, r, s) {
            ...
            if (g.wrap(b, w), f > 1) {
              ...
              v && v.type === t && rf(g.doc, f - 1) && g.join(f - 1);
            }
      ...
      new Ce({
        ...
        state: {
          ...
          apply(n, o, r, s) {
            ...
            } : n.docChanged ? gw(r.doc, s.doc, t.listItemTypes) ? {
              collapsedItems: new Set(e.collapsedItems),
              decorations: Ho(s.doc, e, t),
              docVersion: o.docVersion + 1
            } : {
...
const Fo = {
  ...
  note: { icon: Nl, label: "Note", color: "var(--callout-note)", borderColor: "var(--callout-note-border)" },
  prompt: { icon: wl, label: "Prompt", color: "var(--callout-prompt)", borderColor: "var(--callout-prompt-border)" },
  ...
  summary: { icon: um, label: "Summary", color: "var(--callout-summary)", borderColor: "var(--callout-summary-border)" }
};
function vw({ node: e, updateAttributes: t, editor: n }) {
        ...
        children: [
          ...
          /* @__PURE__ */ m(
            "div",
            {
              ...
              children: s ? /* @__PURE__ */ m(yl, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CalloutWithMenu.tsx",
                lineNumber: 138,
                columnNumber: 24
      ...
      new Ce({
        ...
        props: {
          handleDOMEvents: {
            copy(e, t) {
              const { state: n } = e;
              if (!(n.selection instanceof Om)) return !1;
...
function Yt(e, t) {
  try {
    const o = (kw[e] ||= new Intl.DateTimeFormat("en-US", {
      timeZone: e,
      timeZoneName: "longOffset"
    }).format)(t).split("GMT")[1];
    return o in Hn ? Hn[o] : Oa(o, o.split(":"));
  } catch {
    if (e in Hn) return Hn[e];
    const n = e?.match(xw);
    return n ? Oa(e, n.slice(1)) : NaN;
  }
}
const xw = /([+-]\d\d):?(\d\d)?/;
function Oa(e, t) {
...
class ot extends Date {
  //#region static
  constructor(...t) {
    super(), t.length > 1 && typeof t[t.length - 1] == "string" && (this.timeZone = t.pop()), this.internal = /* @__PURE__ */ new Date(), isNaN(Yt(this.timeZone, this)) ? this.setTime(NaN) : t.length ? typeof t[0] == "number" && (t.length === 1 || t.length === 2 && typeof t[1] != "number") ? this.setTime(t[0]) : typeof t[0] == "string" ? this.setTime(+new Date(t[0])) : t[0] instanceof Date ? this.setTime(+t[0]) : (this.setTime(+new Date(...t)), Eu(this), Os(this)) : this.setTime(Date.now());
  }
  static tz(t, ...n) {
...
class Pe extends ot {
  ...
  toTimeString() {
    ...
    return `${t} GMT${n}${o}${r} (${yw(this.timeZone, this)})`;
  }
  toLocaleString(t, n) {
...
const Su = 6048e5, Tw = 864e5, $a = Symbol.for("constructDateFrom");
function xe(e, t) {
...
function Pu(e, t, n) {
  const [o, r] = Mn(
    ...
    e,
    t
  ), s = Jn(o), a = Jn(r), i = +s - Ba(s), l = +a - Ba(a);
  return Math.round((i - l) / Tw);
}
function Sw(e, t) {
  const n = Au(e, t), o = xe(e, 0);
...
function Rw(e) {
  return !(!Iu(e) && typeof e != "number" || isNaN(+pe(e)));
}
function Lw(e, t, n) {
  const [o, r] = Mn(
    n?.in,
...
function _n(e) {
  return (t, n = {}) => {
    ...
    if (!s)
      return null;
    const a = s[0], i = o && e.parsePatterns[o] || e.parsePatterns[e.defaultParseWidth], l = Array.isArray(i) ? rN(i, (d) => d.test(a)) : (
...
const iN = /^(\d+)(th|st|nd|rd)?/i, aN = /\d+/i, lN = {
  narrow: /^(b|a)/i,
...
function _u(e, t) {
  const n = pe(e, t?.in), o = +Qn(n) - +Sw(n);
  return Math.round(o / Su) + 1;
}
function $u(e, t) {
...
function NN(e, t) {
  const n = so(), o = t?.firstWeekContainsDate ?? t?.locale?.options?.firstWeekContainsDate ?? n.firstWeekContainsDate ?? n.locale?.options?.firstWeekContainsDate ?? 1, r = $u(e, t), s = xe(t?.in || e, 0);
  return s.setFullYear(r, 0, o), s.setHours(0, 0, 0, 0), yn(s, t);
}
function Bu(e, t) {
  const n = pe(e, t?.in), o = +yn(n, t) - +NN(n, t);
  return Math.round(o / Su) + 1;
}
function he(e, t) {
...
const za = (e, t) => {
  ...
  return s.replace("{{date}}", za(o, t)).replace("{{time}}", Wu(r, t));
}, kN = {
  p: Wu,
  P: yN
}, xN = /^D+$/, CN = /^Y+$/, TN = ["D", "DD", "YY", "YYYY"];
function EN(e) {
  return xN.test(e);
}
function SN(e) {
...
function MN(e, t, n) {
  const o = DN(e, t, n);
  if (console.warn(o), TN.includes(e)) throw new RangeError(o);
}
function DN(e, t, n) {
...
const AN = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g, PN = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g, IN = /^'([^]*?)'?$/, RN = /''/g, LN = /[a-zA-Z]/;
function ON(e, t, n) {
  ...
  return l.map((u) => {
    ...
    const d = u.value;
    (!n?.useAdditionalWeekYearTokens && SN(d) || !n?.useAdditionalDayOfYearTokens && EN(d)) && MN(d, t, String(e));
    const f = Wa[d[0]];
...
const Ua = 5, VN = 4;
function KN(e, t) {
  const n = t.startOfMonth(e), o = n.getDay() > 0 ? n.getDay() : 7, r = t.addDays(e, -o + 1), s = t.addDays(r, Ua * 7 - 1);
  return t.getMonth(e) === t.getMonth(s) ? Ua : VN;
}
function Hu(e, t) {
...
class ze {
   ...
   */
  constructor(t, n) {
    this.Date = Date, this.today = () => this.overrides?.today ? this.overrides.today() : this.options.timeZone ? Pe.tz(this.options.timeZone) : new this.Date(), this.newDate = (o, r, s) => this.overrides?.newDate ? this.overrides.newDate(o, r, s) : this.options.timeZone ? new Pe(o, r, s, this.options.timeZone) : new Date(o, r, s), this.addDays = (o, r) => this.overrides?.addDays ? this.overrides.addDays(o, r) : Mu(o, r), this.addMonths = (o, r) => this.overrides?.addMonths ? this.overrides.addMonths(o, r) : Du(o, r), this.addWeeks = (o, r) => this.overrides?.addWeeks ? this.overrides.addWeeks(o, r) : Mw(o, r), this.addYears = (o, r) => this.overrides?.addYears ? this.overrides.addYears(o, r) : Dw(o, r), this.differenceInCalendarDays = (o, r) => this.overrides?.differenceInCalendarDays ? this.overrides.differenceInCalendarDays(o, r) : Pu(o, r), this.differenceInCalendarMonths = (o, r) => this.overrides?.differenceInCalendarMonths ? this.overrides.differenceInCalendarMonths(o, r) : Lw(o, r), this.eachMonthOfInterval = (o) => this.overrides?.eachMonthOfInterval ? this.overrides.eachMonthOfInterval(o) : _w(o), this.eachYearOfInterval = (o) => {
      const r = this.overrides?.eachYearOfInterval ? this.overrides.eachYearOfInterval(o) : Ww(o), s = new Set(r.map((i) => this.getYear(i)));
      if (s.size === r.length)
        return r;
      const a = [];
      return s.forEach((i) => {
    ...
    }, this.endOfBroadcastWeek = (o) => this.overrides?.endOfBroadcastWeek ? this.overrides.endOfBroadcastWeek(o) : GN(o, this), this.endOfISOWeek = (o) => this.overrides?.endOfISOWeek ? this.overrides.endOfISOWeek(o) : Hw(o), this.endOfMonth = (o) => this.overrides?.endOfMonth ? this.overrides.endOfMonth(o) : Ow(o), this.endOfWeek = (o, r) => this.overrides?.endOfWeek ? this.overrides.endOfWeek(o, r) : Ou(o, this.options), this.endOfYear = (o) => this.overrides?.endOfYear ? this.overrides.endOfYear(o) : Bw(o), this.format = (o, r, s) => {
      const a = this.overrides?.format ? this.overrides.format(o, r, this.options) : ON(o, r, this.options);
      return this.options.numerals && this.options.numerals !== "latn" ? this.replaceDigits(a) : a;
    }, this.getISOWeek = (o) => this.overrides?.getISOWeek ? this.overrides.getISOWeek(o) : _u(o), this.getMonth = (o, r) => this.overrides?.getMonth ? this.overrides.getMonth(o, this.options) : BN(o, this.options), this.getYear = (o, r) => this.overrides?.getYear ? this.overrides.getYear(o, this.options) : WN(o, this.options), this.getWeek = (o, r) => this.overrides?.getWeek ? this.overrides.getWeek(o, this.options) : Bu(o, this.options), this.isAfter = (o, r) => this.overrides?.isAfter ? this.overrides.isAfter(o, r) : HN(o, r), this.isBefore = (o, r) => this.overrides?.isBefore ? this.overrides.isBefore(o, r) : FN(o, r), this.isDate = (o) => this.overrides?.isDate ? this.overrides.isDate(o) : Iu(o), this.isSameDay = (o, r) => this.overrides?.isSameDay ? this.overrides.isSameDay(o, r) : Iw(o, r), this.isSameMonth = (o, r) => this.overrides?.isSameMonth ? this.overrides.isSameMonth(o, r) : zN(o, r), this.isSameYear = (o, r) => this.overrides?.isSameYear ? this.overrides.isSameYear(o, r) : UN(o, r), this.max = (o) => this.overrides?.max ? this.overrides.max(o) : Aw(o), this.min = (o) => this.overrides?.min ? this.overrides.min(o) : Pw(o), this.setMonth = (o, r) => this.overrides?.setMonth ? this.overrides.setMonth(o, r) : YN(o, r), this.setYear = (o, r) => this.overrides?.setYear ? this.overrides.setYear(o, r) : jN(o, r), this.startOfBroadcastWeek = (o, r) => this.overrides?.startOfBroadcastWeek ? this.overrides.startOfBroadcastWeek(o, this) : Hu(o, this), this.startOfDay = (o) => this.overrides?.startOfDay ? this.overrides.startOfDay(o) : Jn(o), this.startOfISOWeek = (o) => this.overrides?.startOfISOWeek ? this.overrides.startOfISOWeek(o) : Qn(o), this.startOfMonth = (o) => this.overrides?.startOfMonth ? this.overrides.startOfMonth(o) : $w(o), this.startOfWeek = (o, r) => this.overrides?.startOfWeek ? this.overrides.startOfWeek(o, this.options) : yn(o, this.options), this.startOfYear = (o) => this.overrides?.startOfYear ? this.overrides.startOfYear(o) : Lu(o), this.options = { locale: Si, ...t }, this.overrides = n;
  }
  /**
...
function mt(e, t, n = at) {
  ...
  return o.some((i) => {
    ...
    return Yu(i) ? s(e, i.after) > 0 : ju(i) ? s(i.before, e) > 0 : typeof i == "function" ? i(e) : !1;
  });
}
...
const Ly = qu, Oy = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  formatCaption: Gu,
  formatDay: Dy,
  formatMonthCaption: My,
  formatMonthDropdown: Ay,
  formatWeekNumber: Iy,
  formatWeekNumberHeader: Ry,
  formatWeekdayName: Py,
  formatYearCaption: Ly,
...
const Qy = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  labelPrevious: Ky,
  labelWeekNumber: qy,
  labelWeekNumberHeader: Xy,
  labelWeekday: Gy,
  labelYearDropdown: Zy
}, Symbol.toStringTag, { value: "Module" })), ao = (e) => e instanceof HTMLElement ? e : null, cs = (e) => [
  ...e.querySelectorAll("[data-animated-month]") ?? []
], Jy = (e) => ao(e.querySelector("[data-animated-month]")), us = (e) => ao(e.querySelector("[data-animated-caption]")), ds = (e) => ao(e.querySelector("[data-animated-weeks]")), e0 = (e) => ao(e.querySelector("[data-animated-nav]")), t0 = (e) => ao(e.querySelector("[data-animated-weekdays]"));
function n0(e, t, { classNames: n, months: o, focused: r, dateLib: s }) {
...
function i0(e, t, n, o) {
  const { addDays: r, endOfBroadcastWeek: s, endOfISOWeek: a, endOfMonth: i, endOfWeek: l, getISOWeek: c, getWeek: u, startOfBroadcastWeek: d, startOfISOWeek: f, startOfWeek: h } = o, g = e.reduce((p, b) => {
    ...
    const N = y.reduce((S, k) => {
      const D = n.ISOWeek ? c(k) : u(k), x = S.find((A) => A.weekNumber === D), M = new Fu(k, b, o);
      return x ? x.days.push(M) : S.push(new XN(D, [M])), S;
    }, []), C = new qN(b, N);
    return p.push(C), p;
  }, []);
...
function d0(e, t) {
  const [n, o] = a0(e, t), { startOfMonth: r, endOfMonth: s } = t, a = Ya(e, n, o, t), [i, l] = Ar(
    a,
  ...
  const c = s0(i, o, e, t), u = o0(c, e.endMonth ? s(e.endMonth) : void 0, e, t), d = i0(c, u, e, t), f = u0(d), h = r0(d), g = c0(i, n, e, t), p = l0(i, o, e, t), { disableNavigation: b, onMonthChange: w } = e, v = (C) => f.some((S) => S.days.some((k) => k.isEqualTo(C))), y = (C) => {
    if (b)
      return;
    let S = r(C);
...
function m0(e, t, n, o) {
  ...
  for (const a of e) {
    const i = t(a);
    ja(i) && (i[ge.focused] && s < et.FocusedModifier ? (r = a, s = et.FocusedModifier) : o?.isEqualTo(a) && s < et.LastFocused ? (r = a, s = et.LastFocused) : n(a.date) && s < et.Selected ? (r = a, s = et.Selected) : i[ge.today] && s < et.Today && (r = a, s = et.Today));
  }
  return r || (r = e.find((a) => ja(t(a)))), r;
}
function f0(e, t, n, o, r, s, a) {
...
function Qu(e, t, n, o, r, s, a, i = 0) {
  if (i > 365)
    return;
  const l = f0(e, t, n.date, o, r, s, a), c = !!(s.disabled && mt(l, s.disabled, a)), u = !!(s.hidden && mt(l, s.hidden, a)), d = l, f = new Fu(l, d, a);
  return !c && !u ? f : Qu(e, t, f, o, r, s, a, i + 1);
}
function h0(e, t, n, o, r) {
  const { autoFocus: s } = e, [a, i] = U(), l = m0(t.days, n, o || (() => !1), a), [c, u] = U(s ? l : void 0);
  return {
    ...
    moveFocus: (p, b) => {
      if (!c)
        return;
      const w = Qu(p, b, c, t.navStart, t.navEnd, e, r);
...
function g0(e, t, n = 0, o = 0, r = !1, s = at) {
...
function Va(e, t, n = at) {
  return dt(e, t.from, !1, n) || dt(e, t.to, !1, n) || dt(t, e.from, !1, n) || dt(t, e.to, !1, n);
}
function v0(e, t, n = at) {
  const o = Array.isArray(t) ? t : [t];
  if (o.filter((i) => typeof i != "function").some((i) => typeof i == "boolean" ? i : n.isDate(i) ? dt(e, i, !1, n) : Ku(i, n) ? i.some((l) => dt(e, l, !1, n)) : Mi(i) ? i.from && i.to ? Va(e, { from: i.from, to: i.to }, n) : !1 : Vu(i) ? b0(e, i.dayOfWeek, n) : Uu(i) ? n.isAfter(i.before, i.after) ? Va(e, {
    from: n.addDays(i.after, 1),
    to: n.addDays(i.before, -1)
  }, n) : mt(e.from, i, n) || mt(e.to, i, n) : Yu(i) || ju(i) ? mt(e.from, i, n) || mt(e.to, i, n) : !1))
    return !0;
...
function w0(e, t) {
  ...
  return {
    selected: c,
    select: (f, h, g) => {
      const { min: p, max: b } = e, w = f ? g0(f, c, p, b, s, t) : void 0;
      return o && n && w?.from && w.to && v0({ from: w.from, to: w.to }, n, t) && (w.from = f, w.to = void 0), a || l(w), a?.(w, f, h, g), w;
    },
...
function y0(e, t) {
  const n = N0(e, t), o = p0(e, t), r = w0(e, t);
  switch (e.mode) {
    case "single":
      return n;
    case "multiple":
...
function k0(e) {
  ...
  const { components: n, formatters: o, labels: r, dateLib: s, locale: a, classNames: i } = Dt(() => {
    ...
    return {
      ...
      components: Ey(t.components),
      formatters: _y(t.formatters),
      labels: { ...Qy, ...t.labels },
      locale: le,
    ...
    t.labels,
    t.classNames
  ]), { captionLayout: l, mode: c, navLayout: u, numberOfMonths: d = 1, onDayBlur: f, onDayClick: h, onDayFocus: g, onDayKeyDown: p, onDayMouseEnter: b, onDayMouseLeave: w, onNextClick: v, onPrevClick: y, showWeekNumber: E, styles: N } = t, { formatCaption: C, formatDay: S, formatMonthDropdown: k, formatWeekNumber: D, formatWeekNumberHeader: x, formatWeekdayName: M, formatYearDropdown: A } = o, R = d0(t, s), { days: L, months: _, navStart: W, navEnd: V, previousMonth: I, nextMonth: P, goToMonth: $ } = R, q = Cy(L, t, W, V, s), { isSelected: F, select: Y, selected: G } = y0(t, s) ?? {}, { blur: B, focused: J, isFocusTarget: O, moveFocus: ee, setFocused: ne } = h0(t, R, q, F ?? (() => !1), s), { labelDayButton: de, labelGridcell: Ne, labelGrid: ve, labelMonthDropdown: Oe, labelNav: Nt, labelPrevious: Ot, labelNext: Dn, labelWeekday: An, labelWeekNumber: lo, labelWeekNumberHeader: co, labelYearDropdown: uo } = r, mo = Dt(() => Wy(s, t.ISOWeek), [s, t.ISOWeek]), Pn = c !== void 0 || h !== void 0, yt = H(() => {
    I && ($(I), y?.(I));
  }, [I, $, y]), Qt = H(() => {
    P && ($(P), v?.(P));
  }, [$, P, v]), fo = H((le, me) => (oe) => {
  ...
  }), [i, t.className, t.style, N]), Br = Sy(t), bo = j(null);
  n0(bo, !!t.animate, {
    classNames: i,
    months: _,
    focused: J,
      ...
      X.createElement(
        ...
        _.map((le, me) => X.createElement(
          ...
          X.createElement(n.MonthCaption, { "data-animated-caption": t.animate ? "true" : void 0, className: i[te.MonthCaption], style: N?.[te.MonthCaption], calendarMonth: le, displayIndex: me }, l?.startsWith("dropdown") ? X.createElement(
            ...
            (() => {
              const oe = l === "dropdown" || l === "dropdown-months" ? X.createElement(n.MonthsDropdown, { key: "month", className: i[te.MonthsDropdown], "aria-label": Oe(), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: Or(le.date), options: $y(le.date, W, V, o, s), style: N?.[te.Dropdown], value: s.getMonth(le.date) }) : X.createElement("span", { key: "month" }, k(le.date, s)), fe = l === "dropdown" || l === "dropdown-years" ? X.createElement(n.YearsDropdown, { key: "year", className: i[te.YearsDropdown], "aria-label": uo(s.options), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: _r(le.date), options: Hy(W, V, o, s, !!t.reverseYears), style: N?.[te.Dropdown], value: s.getYear(le.date) }) : X.createElement("span", { key: "year" }, A(le.date, s));
          ...
          X.createElement(
            ...
            X.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: i[te.Weeks], style: N?.[te.Weeks] }, le.weeks.map((oe) => X.createElement(
              ...
              oe.days.map((fe) => {
                ...
                const Jt = By(ue, N, t.modifiersStyles), Wr = Ty(ue, i, t.modifiersClassNames), vo = !Pn && !ue.hidden ? Ne(Re, ue, s.options, s) : void 0;
                return (
  ...
  return /* @__PURE__ */ m(
    k0,
    {
      ...
      components: {
        ...
        Chevron: ({ className: c, orientation: u, ...d }) => u === "left" ? /* @__PURE__ */ m(dm, { className: ie("size-4", c), ...d }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/calendar.tsx",
          lineNumber: 139,
          columnNumber: 15
          ...
          this
        ) : /* @__PURE__ */ m(fm, { className: ie("size-4", c), ...d }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/calendar.tsx",
          lineNumber: 153,
          columnNumber: 13
        }, this),
...
let hn = null;
const Ju = /* @__PURE__ */ new Map(), T0 = /* @__PURE__ */ new Map();
function Qo() {
  if (!hn) return;
  const e = hn;
  hn = null, setTimeout(() => {
...
function D0({ node: e, updateAttributes: t, selected: n }) {
  const o = j(null), r = e.attrs.date || pn(), s = ed(r), a = Ai(r), i = H(() => {
    if (!o.current) return "";
...
const P0 = new Te("datePillPaste"), I0 = br.create({
  name: "datePill",
  group: "inline",
  inline: !0,
  atom: !0,
  ...
  renderHTML({ node: e, HTMLAttributes: t }) {
    const n = e.attrs.date, o = ed(n), r = Ai(n);
    return [
      "span",
      kn(this.options.HTMLAttributes, t, {
        "data-type": "date-pill",
...
function R0({ node: e, selected: t, editor: n, getPos: o, deleteNode: r }) {
...
const L0 = new Te("tagPillPaste"), O0 = br.create({
  name: "tagPill",
  group: "inline",
  inline: !0,
  atom: !0,
...
}, B0 = ["info", "note", "prompt", "resources", "todo", "summary"];
function W0(e) {
...
function F0(e, t) {
  const { alt: n, align: o, width: r } = H0(e), s = {
    left: "margin-right: auto;",
    center: "margin-left: auto; margin-right: auto;",
    right: "margin-left: auto;"
...
function Ka(e) {
  ...
  for (const s of o) {
    const a = s.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
    a ? r.push(F0(a[1], a[2])) : r.push(`<p>${lr(s.trim())}</p>`);
  }
  return r.join("");
}
function td(e) {
        ...
        state: {
          ...
          apply(n, o, r, s) {
            return n.getMeta("collapsibleHeading") ? {
              ...
              docVersion: o.docVersion + 1
            } : n.docChanged ? (V0(r.doc, s.doc, e, t.levels), K0(r.doc, s.doc, t.levels) ? {
              collapsedHeadings: new Set(e.collapsedHeadings),
              decorations: zo(s.doc, e, t),
              docVersion: o.docVersion + 1
            } : {
...
}), q0 = /\[([^\]]+)\]\(([^)]+)\)$/, X0 = /^(https?:\/\/|www\.)[^\s]+$/i, Z0 = Ue.create({
...
}), Q0 = ["info", "note", "prompt", "resources", "todo"], J0 = Ue.create({
          ...
          handleKeyDown(t, n) {
            ...
            for (const u of Q0)
              if (c === `\`\`\`${u}`) {
                ...
                if (h && g) {
                  const p = g.create(), b = h.create({ type: u }, Dl.from(p));
                  d.insert(f, b);
...
}), Uo = new Te("searchHighlight"), ek = Ue.create({
      ...
      new Ce({
        ...
        props: {
          handleKeyDown(e, t) {
            ...
            const { state: n, dispatch: o } = e, r = nk(n);
            if (!r)
...
const sk = /* @__PURE__ */ new Set([
  ...
  "codeBlock",
  "blockquote"
]), ik = "tableRow", ak = /* @__PURE__ */ new Set(["tableCell", "tableHeader"]);
function lk(e, t, n) {
  const o = e.resolve(t);
...
function gk(e, t, n) {
  let o = !1;
  return e.nodesBetween(t, n, (r) => od.has(r.type.name) ? (o = !0, !1) : !0), o;
}
function bk(e, t, n) {
  const o = [];
  let r = t, s = n;
  const a = (l) => l && (l.from < r || l.to > s) ? (o.push(l), r = l.from, s = l.to, !0) : !1;
  a(lk(e, r, s)), pk(e, t) && (a(ck(e, r, s)), a(uk(e, r, s))), a(mk(e, r, s)), a(dk(e, r, s));
  const i = fk(e);
  if (i.length > 0) {
    const l = hk(i, r, s);
    for (const c of l)
      gk(e, c.from, c.to) ? c.from === 0 && c.to === e.content.size ? a({ from: 0, to: e.content.size, useSelectAll: !0 }) : a({ from: c.from, to: c.to, useSelectAll: !0 }) : a({ from: c.from, to: c.to });
  }
  ...
  addKeyboardShortcuts() {
    return {
      ...
      "Mod-a": ({ editor: e }) => {
        ...
        if (t.expansionDepth > 0 && r === t.lastExpandedFrom && s === t.lastExpandedTo || (t.expansionDepth = 0), o instanceof _m || r === 0 && s === n.content.size)
          return !0;
        const i = bk(n, r, s);
        let l = null;
        for (const c of i)
...
}), wk = /#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})\b/g;
function Nk(e) {
  let t = e.replace("#", "");
...
const yk = new Te("hexColorDecoration");
function rd(e, t, n) {
  const o = [];
  return e.nodesBetween(t, n, (r, s) => {
    ...
    const a = r.text || "";
    let i;
    const l = new RegExp(wk.source, "g");
    for (; (i = l.exec(a)) !== null; ) {
          ...
          handleKeyDown(t, n) {
            ...
            if ((n.metaKey || n.ctrlKey) && n.key === "z" && !n.shiftKey) {
              if (n.preventDefault(), e.isTypingReplace && e.undoStack.length > 0) {
                ...
                return e.typedBuffer = r, r === "" && (e.isTypingReplace = !1), mf(t.state, t.dispatch), setTimeout(() => {
                  const s = St(t);
            ...
            if ((n.metaKey || n.ctrlKey) && (n.key === "z" && n.shiftKey || n.key === "y")) {
              if (n.preventDefault(), e.redoStack.length > 0) {
                ...
                return e.typedBuffer = r, e.isTypingReplace = !0, ff(t.state, t.dispatch), setTimeout(() => {
                  const s = St(t);
                  e.ranges = s, s.length === 0 && Me(e);
                }, 10), !0;
              }
...
}), Ek = new Te("linkBoundary"), Sk = Ue.create({
  name: "linkBoundary",
  addProseMirrorPlugins() {
    return [
      new Ce({
...
}), Mk = new Te("smartCopyPaste"), sd = /* @__PURE__ */ new Set(["codeBlock", "callout"]);
function Qa(e) {
  const { state: t } = e, { selection: n } = t, { $from: o, $to: r } = n;
  for (let s = o.depth; s > 0; s--) {
    const a = o.node(s);
    if (!sd.has(a.type.name)) continue;
...
`);
              ...
              const h = f.map((p) => p === "" ? u.create() : u.create(null, c.text(p))), g = Dl.from(h);
              return new jr(g, 0, 0);
            } else {
...
async function Ok(e, t, n) {
  return new Promise((o, r) => {
    ...
    a.onload = (i) => {
      ...
      const d = e.type === "image/png" || e.type === "image/gif", f = d ? "image/png" : "image/jpeg", h = d ? void 0 : n, g = c.toDataURL(f, h), p = Ik(g, e.name);
...
async function Ja(e, t, n) {
  ...
  try {
    ...
    try {
      ...
      return console.warn("Image upload failed, removing placeholder:", h), _k(t, r, e.name), n.onUploadError?.(`Upload failed: ${h instanceof Error ? h.message : "Unknown error"}`), n.onUploadComplete?.(), !1;
    }
  } catch (r) {
...
function Bk({
  ...
  return Dt(() => {
    const g = [
      ...
      gf.configure({ HTMLAttributes: { class: "font-bold" } }).extend({ keepOnSplit: !1 }),
      bf.configure({ HTMLAttributes: { class: "italic" } }).extend({ keepOnSplit: !1 }),
      vf.configure({}).extend({ keepOnSplit: !1 }),
      pf.configure({}).extend({ keepOnSplit: !1 }),
    ...
    ), s.codeBlocks || g.push(yf), s.callouts || g.push(ww, J0), i && !s.collapsibleHeadings && !d && g.push(
      G0.configure({
        levels: r
      })
    ), s.images || g.push(
    ...
    ), a && g.push(vk), u && !d && g.push(xk), s.markdownPaste || g.push(
      Y0.configure({
        enableMarkdownPaste: !0
      })
    ), g;
...
function Uk(e) {
  const {
    ...
    isLightweightRef: k
  } = e, D = n && n.length > zk, x = j(D ? n : null), M = D ? "" : n, A = j(null), R = j(null), L = j(c), _ = j(u), W = j(d), V = j(f), I = j(null);
...
function tl(e) {
  if (/<img\s/i.test(e)) {
    const t = /(<img\s[^>]*\/?>)/gi;
    return e.split(t).filter((o) => o.trim()).map((o) => /^<img\s/i.test(o) ? Gk(o) : o.trim() ? `<p>${dr(o.trim())}</p>` : "").join("");
  }
  if (/^!\[/.test(e)) {
    const t = e.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
    if (t)
...
function Jk(e) {
  ...
  ), t = Yk(t), t = Vk(t), t = Kk(t), t = Zk(t), t = t.replace(
    /(<pre[^>]*>\s*<code[^>]*>)([\s\S]*?)(<\/code>\s*<\/pre>)/g,
    (n, o, r, s) => o + r.replace(/\n+$/, "") + s
  ), t;
}
function ex(e, t, n = {}) {
  const o = Qk(e, t, n), r = t(o);
  return Jk(r);
}
function tx(e, t, n) {
  K(() => {
...
function sx(e, t = {}) {
  const {
    ...
    const w = Math.max(1, Math.ceil(f / rx));
    return {
      words: f,
      characters: h,
    ...
    "div",
    {
      ...
      children: [
        e === "idle" && t && /* @__PURE__ */ m(we, { children: [
          /* @__PURE__ */ m(hm, { className: "w-3.5 h-3.5 text-muted-foreground" }, void 0, !1, {
        ...
        e === "error" && /* @__PURE__ */ m(we, { children: [
          /* @__PURE__ */ m(pm, { className: "w-3.5 h-3.5 text-red-500" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/AutoSaveIndicator.tsx",
            lineNumber: 61,
            columnNumber: 11
          }, this),
...
function ax({ onRecover: e, onDismiss: t, className: n = "" }) {
  return /* @__PURE__ */ m(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ m("div", { className: "flex items-center gap-3 min-w-0", children: [
          /* @__PURE__ */ m(gm, { className: "w-5 h-5 recovery-banner-icon flex-shrink-0" }, void 0, !1, {
...
`);
  ...
  if (!n || n.length === 0) {
    for (let l = 0; l < s.length; l++) {
      ...
      let f = a;
      for (const h of d)
        h.start > f && (r += jt(e.substring(f, h.start))), r += `<span class="${nl(h.type)}">${jt(h.content)}</span>`, f = h.end;
  ...
  K(() => {
    ...
    const x = (M) => {
      ...
      if (c.current = M, l.current.push({ time: M, duration: A }), l.current.length > 120 && (l.current = l.current.slice(-120)), A > 16.67 && d.current++, S++, M - k >= 1e3) {
        D = S, S = 0, k = M;
        const R = l.current.slice(-60), L = R.length > 0 ? R.reduce((F, Y) => F + Y.duration, 0) / R.length : 0, _ = R.length > 0 ? Math.max(...R.map((F) => F.duration)) : 0, W = performance.memory, V = W ? W.usedJSHeapSize / (1024 * 1024) : 0, I = W ? W.jsHeapSizeLimit / (1024 * 1024) : 0, P = document.querySelectorAll("*").length, $ = ol - f.current, q = _s - h.current;
        f.current = ol, h.current = _s, i({
          fps: D,
  ...
  return /* @__PURE__ */ m("div", { className: "perf-profiler-overlay", children: [
    /* @__PURE__ */ m("div", { className: "perf-profiler-header", children: [
      /* @__PURE__ */ m("div", { className: "perf-profiler-title", children: [
        /* @__PURE__ */ m(bm, { size: 14 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 241,
          columnNumber: 11
        }, this),
      ...
      /* @__PURE__ */ m("div", { className: "perf-profiler-actions", children: [
        /* @__PURE__ */ m("button", { onClick: y, title: r ? "Expand" : "Minimize", children: r ? /* @__PURE__ */ m(Cl, { size: 12 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 246,
          columnNumber: 28
        }, this) : /* @__PURE__ */ m(Tl, { size: 12 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 246,
          columnNumber: 54
        }, this) }, void 0, !1, {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ m("div", { className: ie("flex-1 flex items-center justify-center p-6", this.props.className), children: /* @__PURE__ */ m("div", { className: "flex flex-col items-center max-w-md w-full text-center gap-4", children: [
        /* @__PURE__ */ m("div", { className: "w-12 h-12 rounded-full bg-destructive/10 flex items-center justify-center", children: /* @__PURE__ */ m(vm, { className: "w-6 h-6 text-destructive" }, void 0, !1, {
            ...
            "button",
            {
              ...
              children: [
                n ? /* @__PURE__ */ m(Pt, { className: "w-3 h-3" }, void 0, !1, {
                  ...
                  lineNumber: 193,
                  columnNumber: 21
                }, this) : /* @__PURE__ */ m(yl, { className: "w-3 h-3" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                  lineNumber: 195,
                  columnNumber: 21
                }, this),
              ...
              /* @__PURE__ */ m(
                "button",
                {
                  ...
                  children: r ? /* @__PURE__ */ m(we, { children: [
                    /* @__PURE__ */ m(wm, { className: "w-3 h-3 text-green-500" }, void 0, !1, {
                      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                      lineNumber: 210,
                      columnNumber: 29
                    }, this),
...
function mx({ className: e = "", theme: t }) {
  const n = (o) => ({
    height: "1rem",
    width: o,
...
function fx({ editorMode: e, onModeSwitch: t }) {
...
], hx = vt(function({ editor: t, isH1: n, isH2: o, isH3: r, isH4: s, isH5: a, executeCommand: i }) {
  const [l, c] = U(!1), u = j(null), d = n ? "h1" : o ? "h2" : r ? "h3" : s ? "h4" : a ? "h5" : "paragraph", f = rl.find((g) => g.value === d)?.shortLabel || "P";
  K(() => {
    if (!l) return;
    const g = (p) => {
...
}), px = vt(function({ onCopy: t, iconSize: n }) {
...
}), gx = vt(function({ editor: t, className: n = "", suppressWhenLinkPopoverOpen: o = !1, aiEnabled: r = !1, onAISparklesClick: s, onCopySelectionAsMarkdown: a }) {
  const i = j(null), l = ml({
    editor: t,
    selector: ({ editor: x }) => ({
      ...
      children: [
        ...
        /* @__PURE__ */ m(
          Be,
          {
            ...
            title: "Code Block",
            children: /* @__PURE__ */ m(ym, { size: k }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 602,
              columnNumber: 9
            }, this)
        ...
        a && /* @__PURE__ */ m(we, { children: [
          ...
          /* @__PURE__ */ m(px, { onCopy: a, iconSize: k }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
            lineNumber: 609,
            columnNumber: 11
          }, this)
...
function bx({ editor: e, isOpen: t, onClose: n }) {
...
function wx({ editor: e, onEditLink: t }) {
  const [n, o] = U({
    isVisible: !1,
    url: "",
      ...
      children: /* @__PURE__ */ m("div", { className: "link-hover-tooltip-content", children: [
        /* @__PURE__ */ m(
          "button",
          {
            ...
            title: n.url,
            children: [
              /* @__PURE__ */ m(km, { size: 13, className: "link-hover-tooltip-link-icon" }, void 0, !1, {
        ...
        /* @__PURE__ */ m("div", { className: "link-hover-tooltip-actions", children: [
          /* @__PURE__ */ m(
            "button",
            {
              ...
              title: "Edit link",
              children: /* @__PURE__ */ m(xm, { size: 14 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkHoverTooltip.tsx",
                lineNumber: 343,
                columnNumber: 13
              }, this)
          ...
          /* @__PURE__ */ m(
            "button",
            {
              ...
              title: "Remove link",
              children: /* @__PURE__ */ m(Cm, { size: 14 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkHoverTooltip.tsx",
                lineNumber: 361,
                columnNumber: 13
              }, this)
...
const Nx = [
  ...
  {
    title: "Note Callout",
    icon: /* @__PURE__ */ m(Nl, { size: 16, className: "text-purple-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 155,
      columnNumber: 11
    }, void 0),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ m(wl, { size: 16, className: "text-amber-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 161,
      columnNumber: 11
    }, void 0),
...
], yx = 32, kx = 8, xx = 320, Cx = 210, Vo = 12;
function sl(e) {
  try {
...
const Ex = 340, Sx = 36, Mx = 8, Dx = 240, Ko = 8;
function il(e) {
  try {
    const t = window.getSelection();
    if (t && t.rangeCount > 0) {
...
function Ax({ editor: e, onSearch: t, onCreateItem: n }) {
...
function Ix({ containerRef: e, enabled: t = !0 }) {
  ...
  return K(() => {
    ...
    /* @__PURE__ */ m("div", { className: "image-drop-zone-icon", children: /* @__PURE__ */ m(Am, { className: "w-12 h-12" }, void 0, !1, {
...
function Lx({ actions: e, scope: t, onAction: n, onClose: o, position: r }) {
...
function _x({
  ...
  return /* @__PURE__ */ m(we, { children: [
    !n.images && !n.dragAndDrop && /* @__PURE__ */ m(Ix, { containerRef: o, enabled: r }, void 0, !1, {
    ...
    !n.slashCommands && /* @__PURE__ */ m(Tx, { editor: e, disabledFeatures: n }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/WYSIWYGOverlays.tsx",
      lineNumber: 153,
      columnNumber: 9
    }, this),
    !n.wikiLinks && S && /* @__PURE__ */ m(Ax, { editor: e, onSearch: S }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/WYSIWYGOverlays.tsx",
      lineNumber: 158,
      columnNumber: 9
    }, this),
    ...
    /* @__PURE__ */ m(wx, { editor: e, onEditLink: C }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/WYSIWYGOverlays.tsx",
      lineNumber: 169,
      columnNumber: 7
    }, this),
...
function Wx(e) {
  const [t, n] = jd(Bx, { status: "idle" }), o = j(null), r = H(async (i, l, c, u, d) => {
    if (e) {
      n({
...
const al = Vd(
  () => Promise.resolve().then(() => Qx).then((e) => ({ default: e.TableOfContents }))
), Hx = () => {
  ...
  const [ue] = U(() => Hx()), [Jt, Wr] = U(x), [vo, _t] = U(""), kt = j(x), wo = j(""), Rn = j(null), [fd, Pi] = U(0), No = !!(me && me.length > 0 && oe), { state: Ye, executeAction: yo, abort: hd, reset: xt } = Wx(oe), [pd, Hr] = U(null), [gd, bd] = U({ selectionTop: 0, selectionBottom: 0, selectionCenterX: 0 }), vd = j(oe);
  vd.current = oe;
  const Ii = j(fe);
  Ii.current = fe;
  const [wd, Nd] = U([]), [yd, kd] = U(0), xd = H((se, Ee) => {
    Nd(se), kd(Ee);
  ...
  const Fi = 2e3, [Fr, Cd] = U(() => In === "lightweight" ? !0 : In === "full" ? !1 : t && typeof t == "string" ? Math.ceil(t.length / 80) > Fi : !1), Td = j(0), zi = j(Fr);
  zi.current = Fr;
  const [zr, ko] = U(null), Ed = Bk({
    placeholder: a,
    isMobile: ue,
    maxImageSize: y,
    headingLevels: Ne,
  ...
  }), { editor: re, turndownService: xo } = Uk({
    extensions: Ed,
    content: t,
    editable: i,
    autofocus: l,
    ...
    isLightweightRef: zi
  }), [Sd, Co] = U(!1), [Md, Dd] = U(!1), Ad = Y !== void 0 ? Y : Md, $t = H((se) => {
    Dd(se), G?.(se);
  }, [G]), [Pd, To] = U(0), [Id, Rd] = U(""), Bt = qv(re, {
    storageKey: p,
    debounceMs: b,
    enabled: g,
    onSave: (se) => {
...
` + Ee).run(), xt();
    ...
    if (Ge) return;
    const $e = re.state.doc.slice(se, Ee), Ct = Um.fromSchema(re.schema), Wt = document.createElement("div"), en = Ct.serializeFragment($e.content);
    Wt.appendChild(en);
...
`);
  ...
  if (!re)
    return /* @__PURE__ */ m(mx, { className: c, theme: f }, void 0, !1, {
  ...
  return /* @__PURE__ */ m("div", { className: `markdown-editor-container ${h === "neutral" ? "color-theme-neutral" : ""} ${c}`, "data-theme": f, children: [
    ...
    u && /* @__PURE__ */ m("div", { className: "flex items-center bg-card/50 editor-toolbar-wrapper", children: [
      B ? B(re, ji) : ji,
      D && /* @__PURE__ */ m(fx, { editorMode: Jt, onModeSwitch: Ur }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
        lineNumber: 936,
        columnNumber: 13
      }, this)
    ...
    /* @__PURE__ */ m(Kv, { editor: re }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
      lineNumber: 957,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ m("div", { className: `editor-main-area ${Oe ? "editor-with-toc" : ""}`, children: [
      Oe && yt === "left" && /* @__PURE__ */ m(Ki, { fallback: null, children: /* @__PURE__ */ m(
        al,
        {
          editor: re,
          visible: Nt,
      ...
      /* @__PURE__ */ m(
        dx,
        {
          ...
          onError: le,
          children: [
            /* @__PURE__ */ m("div", { className: "editor-content-wrapper", ref: Rn, style: Hd, children: Jt === "wysiwyg" ? /* @__PURE__ */ m(we, { children: [
              /* @__PURE__ */ m(zd, { editor: re, className: "editor-content" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
                lineNumber: 1002,
                columnNumber: 13
              }, this),
            ...
            /* @__PURE__ */ m($x, { scrollContainerRef: Rn }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
              lineNumber: 1056,
              columnNumber: 7
            }, this)
      ...
      Oe && yt === "right" && /* @__PURE__ */ m(Ki, { fallback: null, children: /* @__PURE__ */ m(
        al,
        {
          editor: re,
          visible: Nt,
    ...
    /* @__PURE__ */ m(ux, { visible: Rr, onClose: Lr, editor: re }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
      lineNumber: 1095,
      columnNumber: 7
    }, this)
...
function X1({
  ...
  return /* @__PURE__ */ m(cd.Provider, { value: i, children: e }, void 0, !1, {
...
const ud = "paragon-editor-toc-width", jx = 280, dd = 200, md = 500, $n = 30, cl = 5;
function ul() {
  try {
    const e = localStorage.getItem(ud);
    if (e) {
      const t = parseInt(e, 10);
      if (!isNaN(t) && t >= dd && t <= md)
        return t;
    }
  } catch {
  }
...
const $s = vt(function({
  ...
  }, []), h = t.length * $n, g = Math.max(0, Math.floor(l / $n) - cl), p = Math.min(
    t.length,
    Math.ceil((l + u) / $n) + cl
  ), b = Dt(() => {
    const w = [];
  ...
  K(() => {
    const O = (ne) => {
      if (!L.current) return;
      const de = f === "right" ? _.current - ne.clientX : ne.clientX - _.current, Ne = Math.min(md, Math.max(dd, W.current + de));
      M(Ne);
    }, ee = () => {
      L.current && (L.current = !1, document.body.style.cursor = "", document.body.style.userSelect = "", M((ne) => (Vx(ne), ne)));
    };
  ...
  return /* @__PURE__ */ m(we, { children: [
    b && /* @__PURE__ */ m(
      "button",
      {
        ...
        children: C ? /* @__PURE__ */ m(Rm, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
          lineNumber: 598,
          columnNumber: 24
        }, this) : /* @__PURE__ */ m(Lm, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
          lineNumber: 598,
          columnNumber: 56
        }, this)
...
export {
  ...
  G1 as Callout,
  J0 as CalloutInputRule,
  Q1 as CodeBlockComponent,
  G0 as CollapsibleHeading,
  bw as CollapsibleList,
  I0 as DatePill,
  X1 as EditorThemeProvider,
  Uv as EditorToolbar,
  Yv as FindReplace,
  gx as FloatingToolbar,
  Ix as ImageDropZone,
  $k as ImageUpload,
  K1 as MarkdownEditor,
  Z0 as MarkdownLinkInputRule,
  Y0 as MarkdownPasteSafe,
  uw as MixedBulletList,
  hw as MixedListItem,
  dw as MixedOrderedList,
  fw as MixedTaskItem,
  mw as MixedTaskList,
  ax as RecoveryBanner,
  Nw as ResizableImage,
  ek as SearchHighlight,
  Kv as SelectAllActionBar,
  Tk as SelectAllOccurrences,
  Tx as SlashCommands,
  ok as TabIndent,
  Zx as TableOfContents,
  O0 as TagPill,
  $0 as WikiLinkSafe,
  Yx as applyTheme,
