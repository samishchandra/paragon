...
import { useEditorState as ul, NodeViewWrapper as er, ReactNodeViewRenderer as dl, useEditor as Yd, EditorContent as jd, NodeViewContent as Vd } from "@tiptap/react";
import * as T from "react";
import X, { useState as j, useRef as Y, useEffect as q, useLayoutEffect as mr, memo as yt, useCallback as F, useImperativeHandle as Kd, createContext as ml, useContext as fl, useMemo as St, Component as Gd, useReducer as qd, lazy as Xd, forwardRef as Zd, Suspense as Wi } from "react";
import Qd from "@tiptap/extension-code-block-lowlight";
import { createLowlight as Jd } from "lowlight";
import { Image as _s, X as gt, Link2 as Bs, Type as fr, Copy as wn, Undo as em, Redo as tm, Bold as $s, Italic as Hs, Underline as Ws, Strikethrough as Fs, Code as hl, Highlighter as pl, Link as zs, ChevronDown as eo, List as Us, ListOrdered as Ys, CheckSquare as js, Quote as Vs, FileCode as gl, IndentIncrease as nm, IndentDecrease as om, Table as ps, Minus as bl, Info as gs, BookOpen as vl, PenLine as rm, Library as sm, ListTodo as wl, Columns as Fi, Trash2 as un, Rows as zi, ToggleLeft as Ui, ArrowUpDown as im, Sparkles as hr, Search as am, ChevronUp as lm, MousePointerClick as cm, CaseSensitive as um, WholeWord as dm, Regex as mm, Replace as bs, ReplaceAll as fm, Plus as Ks, ChevronLeftIcon as hm, ChevronRightIcon as pm, ChevronDownIcon as gm, Calendar as yl, Hash as Yi, Cloud as bm, Loader2 as Nl, Check as yn, CloudOff as vm, AlertCircle as wm, RotateCcw as Gs, Activity as ym, Maximize2 as kl, Minimize2 as xl, AlertTriangle as Nm, ChevronRight as km, CheckCircle2 as xm, Eye as Cm, FileText as qs, ExternalLink as Em, Pencil as Tm, Unlink as Sm, Heading1 as Mm, Heading2 as Dm, Heading3 as Am, Heading4 as Pm, Heading5 as Lm, Code2 as Im, StickyNote as Rm, MessageSquareText as Om, ImagePlus as _m, MessageSquare as Cl, RefreshCw as Bm, SpellCheck as $m, PanelRightClose as Hm, PanelRightOpen as Wm } from "lucide-react";
...
import { Fragment as Tl, Slice as Ur, DOMSerializer as Km } from "@tiptap/pm/model";
...
import { Extension as _e, Node as pr, mergeAttributes as Nn, InputRule as Oe, Mark as Sl } from "@tiptap/core";
...
import { findWrapping as ji, canJoin as cf } from "@tiptap/pm/transform";
...
import { liftListItem as Vi, sinkListItem as Ki } from "@tiptap/pm/schema-list";
...
async function xf() {
  if (!Gi)
    return In || (In = (async () => {
      try {
        const e = Object.entries(Ml), t = await Promise.all(
          e.map(async ([n, o]) => {
            const r = await o();
            return [n, r.default];
          })
        ...
        for (const [n, o] of Object.entries(Dl))
          if (!We.registered(n)) {
...
function Lo(e, t, n) {
  const o = document.createElementNS(Xi, "svg");
  ...
  for (const r of e) {
    const s = document.createElementNS(Xi, "path");
...
class Sf {
  ...
  update(t) {
    ...
    return this.node = t, n !== o && (this.labelEl.textContent = this.formatLanguageLabel(o), this.selectEl.value = o, o === "plaintext" ? this.setLanguageReady(!0) : We.registered(o) ? this.setLanguageReady(!0) : this.isVisible && (this.setLanguageReady(!1), qi(o).then((r) => {
    ...
    if (n)
      return () => {
        for (let r = 0; r < o.length; r++) {
          const s = o[r];
          typeof s == "function" ? s() : Qi(e[r], null);
        }
      };
  };
}
...
}, Af = T[" useInsertionEffect ".trim().toString()] || Mt;
function Zs({
  prop: e,
  defaultProp: t,
  onChange: n = () => {
...
function Of(e) {
  ...
  return t.displayName = `${e}.Slottable`, t.__radixId = Ll, t;
}
function _f(e) {
  return T.isValidElement(e) && typeof e.type == "function" && "__radixId" in e.type && e.type.__radixId === Ll;
}
function Bf(e, t) {
  const n = { ...t };
  for (const o in t) {
...
var zf = "DismissableLayer", vs = "dismissableLayer.update", Uf = "dismissableLayer.pointerDownOutside", Yf = "dismissableLayer.focusOutside", Ji, _l = T.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: i,
      ...l
    } = e, c = T.useContext(_l), [u, d] = T.useState(null), f = u?.ownerDocument ?? globalThis?.document, [, h] = T.useState({}), g = Le(t, (S) => d(S)), p = Array.from(c.layers), [b] = [...c.layersWithOutsidePointerEventsDisabled].slice(-1), v = p.indexOf(b), w = u ? p.indexOf(u) : -1, N = c.layersWithOutsidePointerEventsDisabled.size > 0, E = w >= v, y = Kf((S) => {
    ...
    return Ff((S) => {
      ...
      if (u)
        return n && (c.layersWithOutsidePointerEventsDisabled.size === 0 && (Ji = f.body.style.pointerEvents, f.body.style.pointerEvents = "none"), c.layersWithOutsidePointerEventsDisabled.add(u)), c.layers.add(u), ea(), () => {
          n && c.layersWithOutsidePointerEventsDisabled.size === 1 && (f.body.style.pointerEvents = Ji);
        };
    }, [u, f, n, c]), T.useEffect(() => () => {
      u && (c.layers.delete(u), c.layersWithOutsidePointerEventsDisabled.delete(u), ea());
    }, [u, c]), T.useEffect(() => {
      const S = () => h({});
...
var jf = "DismissableLayerBranch", Vf = T.forwardRef((e, t) => {
  const n = T.useContext(_l), o = T.useRef(null), r = Le(t, o);
  return T.useEffect(() => {
    const s = o.current;
    if (s)
...
function Gf(e, t = globalThis?.document) {
  ...
  return T.useEffect(() => {
    const r = (s) => {
      s.target && !o.current && Bl(Yf, n, { originalEvent: s }, {
        discrete: !1
      });
    };
...
function qf() {
  T.useEffect(() => {
    ...
    return document.body.insertAdjacentElement("afterbegin", e[0] ?? ta()), document.body.insertAdjacentElement("beforeend", e[1] ?? ta()), Yr++, () => {
...
var jr = "focusScope.autoFocusOnMount", Vr = "focusScope.autoFocusOnUnmount", na = { bubbles: !1, cancelable: !0 }, Xf = "FocusScope", $l = T.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: o = !1,
    onMountAutoFocus: r,
    ...
    ...a
  } = e, [i, l] = T.useState(null), c = bt(r), u = bt(s), d = T.useRef(null), f = Le(t, (p) => l(p)), h = T.useRef({
    paused: !1,
    pause() {
      this.paused = !0;
    },
  ...
  T.useEffect(() => {
    ...
    if (i) {
      ...
      if (!i.contains(p)) {
        const v = new CustomEvent(jr, na);
        i.addEventListener(jr, c), i.dispatchEvent(v), v.defaultPrevented || (Zf(nh(Hl(i)), { select: !0 }), document.activeElement === p && Tt(i));
      }
      return () => {
        i.removeEventListener(jr, c), setTimeout(() => {
          const v = new CustomEvent(Vr, na);
          i.addEventListener(Vr, u), i.dispatchEvent(v), v.defaultPrevented || Tt(p ?? document.body, { select: !0 }), i.removeEventListener(Vr, u), ra.remove(h);
        }, 0);
      };
    }
  }, [i, c, u, h]);
...
function Qf(e) {
  const t = Hl(e), n = oa(t, e), o = oa(t.reverse(), e);
  return [n, o];
}
function Hl(e) {
...
const sh = ["top", "right", "bottom", "left"], Dt = Math.min, He = Math.max, nr = Math.round, Io = Math.floor, st = (e) => ({
  x: e,
  y: e
}), ih = {
  left: "right",
...
const ia = ["left", "right"], aa = ["right", "left"], dh = ["top", "bottom"], mh = ["bottom", "top"];
function fh(e, t, n) {
  switch (e) {
    case "top":
    case "bottom":
      return n ? t ? aa : ia : t ? ia : aa;
    case "left":
    case "right":
      return t ? dh : mh;
    default:
...
function la(e, t, n) {
  ...
  const s = ot(t), a = ti(t), i = ei(a), l = wt(t), c = s === "y", u = o.x + o.width / 2 - r.width / 2, d = o.y + o.height / 2 - r.height / 2, f = o[i] / 2 - r[i] / 2;
  let h;
  switch (l) {
    case "top":
      h = {
...
async function Kn(e, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: h = 0
  } = vt(t, e), g = Wl(h), b = i[f ? d === "floating" ? "reference" : "floating" : d], v = rr(await s.getClippingRect({
...
const bh = (e) => ({
  ...
  async fn(t) {
    ...
    const d = Wl(u), f = {
      x: n,
      y: o
    }, h = ti(r), g = ei(h), p = await a.getDimensions(c), b = h === "y", v = b ? "top" : "left", w = b ? "bottom" : "right", N = b ? "clientHeight" : "clientWidth", E = s.reference[g] + s.reference[h] - f[h] - s.floating[g], y = f[h] - s.reference[h], C = await (a.getOffsetParent == null ? void 0 : a.getOffsetParent(c));
    let S = C ? C[N] : 0;
    (!S || !await (a.isElement == null ? void 0 : a.isElement(C))) && (S = i.floating[N] || s.floating[g]);
    const k = E / 2 - y / 2, D = S / 2 - p[g] / 2 - 1, x = Dt(d[v], D), M = Dt(d[w], D), A = x, I = S - p[g] - M, R = S / 2 - p[g] / 2 + k, _ = ws(A, R, I), H = !l.arrow && xn(r) != null && R !== _ && s.reference[g] / 2 - (R < A ? x : M) - p[g] / 2 < 0, V = H ? R < A ? R - A : R - I : 0;
    return {
      [h]: f[h] + V,
      data: {
        [h]: _,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const v = wt(r), w = ot(i), N = wt(i) === i, E = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), y = f || (N || !p ? [or(i)] : uh(i)), C = g !== "none";
      !f && C && y.push(...hh(i, p, g, E));
      const S = [i, ...y], k = await Kn(t, b), D = [];
...
async function yh(e, t) {
  const {
    ...
    platform: o,
    elements: r
  } = e, s = await (o.isRTL == null ? void 0 : o.isRTL(r.floating)), a = wt(n), i = xn(n), l = ot(n) === "y", c = Fl.has(a) ? -1 : 1, u = s && l ? -1 : 1, d = vt(t, e);
  let {
    mainAxis: f,
    crossAxis: h,
    alignmentAxis: g
...
const Nh = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: n,
        y: o
      }, u = await Kn(t, l), d = ot(wt(r)), f = Js(d);
      let h = c[f], g = c[d];
      if (s) {
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (c) {
        var v, w;
        const N = f === "y" ? "width" : "height", E = Fl.has(wt(r)), y = s.reference[d] - s.floating[N] + (E && ((v = a.offset) == null ? void 0 : v[d]) || 0) + (E ? 0 : b.crossAxis), C = s.reference[d] + s.reference[N] + (E ? 0 : ((w = a.offset) == null ? void 0 : w[d]) || 0) - (E ? b.crossAxis : 0);
        g < y ? g = y : g > C && (g = C);
      }
      return {
        [f]: h,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      const {
        ...
        ...c
      } = vt(e, t), u = await Kn(t, c), d = wt(r), f = xn(r), h = ot(r) === "y", {
        width: g,
        height: p
      } = s.floating;
      let b, v;
...
function Ul(e) {
  const t = At(e);
  return gn(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : it(t) && to(t) ? t : Ul(t);
}
function Gn(e, t, n) {
  var o;
  ...
  if (s) {
    const i = Ns(a);
    return t.concat(a, a.visualViewport || [], to(r) ? r : [], i && n ? Gn(i) : []);
  }
...
function Yl(e) {
  ...
  const r = it(e), s = r ? e.offsetWidth : n, a = r ? e.offsetHeight : o, i = nr(n) !== s || nr(o) !== a;
  return i && (n = s, o = a), {
    width: n,
    height: o,
    $: i
...
function jt(e, t, n, o) {
  ...
  const r = e.getBoundingClientRect(), s = ri(e);
  let a = st(1);
  t && (o ? Qe(o) && (a = dn(o)) : a = dn(e));
  const i = Oh(s, n, o) ? jl(s) : st(0);
...
function _h(e) {
  ...
  const s = r === "fixed", a = at(o), i = t ? vr(t.floating) : !1;
  if (o === a || i && s)
    return n;
  let l = {
    scrollLeft: 0,
  ...
  const u = st(0), d = it(o);
  if ((d || !d && !s) && ((Cn(o) !== "body" || to(a)) && (l = wr(o)), it(o))) {
    const h = jt(o);
    c = dn(o), u.x = h.x + o.clientLeft, u.y = h.y + o.clientTop;
  }
  const f = a && !d && !s ? Vl(a, l) : st(0);
  return {
    width: n.width * c.x,
    height: n.height * c.y,
...
function $h(e) {
  const t = at(e), n = wr(e), o = e.ownerDocument.body, r = He(t.scrollWidth, t.clientWidth, o.scrollWidth, o.clientWidth), s = He(t.scrollHeight, t.clientHeight, o.scrollHeight, o.clientHeight);
...
const ma = 25;
function Hh(e, t) {
  const n = Fe(e), o = at(e), r = n.visualViewport;
...
function Fh(e, t) {
  const n = jt(e, !0, t === "fixed"), o = n.top + e.clientTop, r = n.left + e.clientLeft, s = it(e) ? dn(e) : st(1), a = e.clientWidth * s.x, i = e.clientHeight * s.y, l = r * s.x, c = o * s.y;
  return {
    width: a,
    height: i,
    x: l,
...
function zh(e, t) {
  ...
  if (n)
    return n;
  let o = Gn(e, [], !1).filter((i) => Qe(i) && Cn(i) !== "body"), r = null;
  const s = Je(e).position === "fixed";
  let a = s ? At(e) : e;
  for (; Qe(a) && !gn(a); ) {
    const i = Je(a), l = ni(a);
    !l && i.position === "fixed" && (r = null), (s ? !l && !r : !l && i.position === "static" && !!r && Wh.has(r.position) || to(a) && !l && Kl(e, a)) ? o = o.filter((u) => u !== a) : r = i, a = At(a);
  }
  return t.set(e, o), o;
}
function Uh(e) {
  ...
  const a = [...n === "clippingAncestors" ? vr(t) ? [] : zh(t, this._c) : [].concat(n), o], i = a[0], l = a.reduce((c, u) => {
    const d = fa(t, u, r);
    return c.top = He(d.top, c.top), c.right = Dt(d.right, c.right), c.bottom = Dt(d.bottom, c.bottom), c.left = He(d.left, c.left), c;
  }, fa(t, i, r));
  return {
...
function jh(e, t, n) {
  ...
  if (o || !o && !s)
    if ((Cn(t) !== "body" || to(r)) && (i = wr(t)), o) {
      const h = jt(t, !0, s, t);
      l.x = h.x + t.clientLeft, l.y = h.y + t.clientTop;
    } else r && c();
  s && !o && r && c();
  const u = r && !o && !s ? Vl(r, i) : st(0), d = a.left + i.scrollLeft - l.x - u.x, f = a.top + i.scrollTop - l.y - u.y;
  return {
    x: d,
    y: f,
    width: a.width,
...
function Gl(e, t) {
  ...
  for (; o && Sh(o) && Kr(o); )
    o = ha(o, t);
  return o && gn(o) && Kr(o) && !ni(o) ? n : o || Lh(e) || n;
}
...
function Xh(e, t, n, o) {
  ...
  function b() {
    const v = jt(e);
    p && !ql(p, v) && n(), p = v, g = requestAnimationFrame(b);
  }
  return n(), () => {
    var v;
    u.forEach((w) => {
...
const Zh = Nh, Qh = kh, Jh = vh, ep = Ch, tp = wh, pa = bh, np = xh, op = (e, t, n) => {
...
function ip(e) {
  ...
  const [g, p] = T.useState(null), [b, v] = T.useState(null), w = T.useCallback((L) => {
    ...
    M.current && (L.platform = M.current), op(C.current, S.current, L).then((P) => {
      ...
      R.current && !sr(k.current, B) && (k.current = B, El.flushSync(() => {
        d(B);
      }));
    });
  }, [f, t, n, M, A]);
  ...
  const _ = T.useMemo(() => ({
    ...
    if (!H.floating)
      return L;
    const P = ga(H.floating, u.x), B = ga(H.floating, u.y);
    return i ? {
      ...L,
...
const ap = (e) => {
  ...
  return {
    ...
    fn(n) {
      ...
      return o && t(o) ? o.current != null ? pa({
        element: o.current,
        padding: r
      }).fn(n) : {} : o ? pa({
        element: o,
...
var pp = "Arrow", Zl = T.forwardRef((e, t) => {
...
var si = "Popper", [Ql, Nr] = kn(si), [vp, Jl] = Ql(si), ec = (e) => {
...
var tc = "PopperAnchor", nc = T.forwardRef(
  (e, t) => {
    const { __scopePopper: n, virtualRef: o, ...r } = e, s = Jl(tc, n), a = T.useRef(null), i = Le(t, a), l = T.useRef(null);
    return T.useEffect(() => {
      const c = l.current;
...
nc.displayName = tc;
var ii = "PopperContent", [wp, yp] = Ql(ii), oc = T.forwardRef(
  (e, t) => {
    const {
      __scopePopper: n,
      side: o = "bottom",
      ...
      onPlaced: g,
      ...p
    } = e, b = Jl(ii, n), [v, w] = T.useState(null), N = Le(t, (O) => w(O)), [E, y] = T.useState(null), C = bp(E), S = C?.width ?? 0, k = C?.height ?? 0, D = o + (s !== "center" ? "-" + s : ""), x = typeof u == "number" ? u : { top: 0, right: 0, bottom: 0, left: 0, ...u }, M = Array.isArray(c) ? c : [c], A = M.length > 0, I = {
      padding: x,
...
oc.displayName = ii;
var rc = "PopperArrow", Np = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, sc = T.forwardRef(function(t, n) {
  const { __scopePopper: o, ...r } = t, s = yp(rc, o), a = Np[s.placedSide];
  return (
...
var ac = ec, lc = nc, cc = oc, uc = sc, Cp = "Portal", ai = T.forwardRef((e, t) => {
...
var qr = "rovingFocusGroup.onEntryFocus", Mp = { bubbles: !1, cancelable: !0 }, no = "RovingFocusGroup", [ks, dc, Dp] = Rl(no), [Ap, mc] = kn(
  no,
  [Dp]
), [Pp, Lp] = Ap(no), fc = T.forwardRef(
...
var Ip = T.forwardRef((e, t) => {
  const {
    ...
    ...d
  } = e, f = T.useRef(null), h = Le(t, f), g = Ol(s), [p, b] = Zs({
    prop: a,
    defaultProp: i ?? null,
    onChange: l,
    caller: no
  }), [v, w] = T.useState(!1), N = bt(c), E = dc(n), y = T.useRef(!1), [C, S] = T.useState(0);
  return T.useEffect(() => {
    const k = f.current;
    if (k)
  ...
  (e, t) => {
    const {
      ...
      children: a,
      ...i
    } = e, l = tr(), c = s || l, u = Lp(hc, n), d = u.currentTabStopId === c, f = dc(n), { onFocusableItemAdd: h, onFocusableItemRemove: g, currentTabStopId: p } = u;
    return T.useEffect(() => {
      if (o)
        return h(), () => g();
    }, [o, h, g]), /* @__PURE__ */ z(
...
var $p = fc, Hp = pc, Wp = function(e) {
  if (typeof document > "u")
    return null;
  var t = Array.isArray(e) ? e[0] : e;
  return t.ownerDocument.body;
}, tn = /* @__PURE__ */ new WeakMap(), Oo = /* @__PURE__ */ new WeakMap(), _o = {}, Xr = 0, bc = function(e) {
    ...
    !d || l.has(d) || Array.prototype.forEach.call(d.children, function(f) {
      if (i.has(f))
        ...
        try {
          ...
          tn.set(f, p), s.set(f, b), a.push(f), p === 1 && g && Oo.set(f, !0), b === 1 && f.setAttribute(n, "true"), g || f.setAttribute(o, "true");
        } catch (v) {
  ...
  return u(t), i.clear(), Xr++, function() {
    a.forEach(function(d) {
      ...
      tn.set(d, f), s.set(d, h), f || (Oo.has(d) || d.removeAttribute(o), Oo.delete(d)), h || d.removeAttribute(n);
    }), Xr--, Xr || (tn = /* @__PURE__ */ new WeakMap(), tn = /* @__PURE__ */ new WeakMap(), Oo = /* @__PURE__ */ new WeakMap(), _o = {});
  };
}, Up = function(e, t, n) {
...
var Gp = typeof window < "u" ? T.useLayoutEffect : T.useEffect, ba = /* @__PURE__ */ new WeakMap();
function qp(e, t) {
...
var yc = Qp(), Qr = function() {
}, kr = T.forwardRef(function(e, t) {
  var n = T.useRef(null), o = T.useState({
    onScrollCapture: Qr,
    onWheelCapture: Qr,
    onTouchMoveCapture: Qr
  }), r = o[0], s = o[1], a = e.forwardProps, i = e.children, l = e.className, c = e.removeScrollBar, u = e.enabled, d = e.shards, f = e.sideCar, h = e.noRelative, g = e.noIsolation, p = e.inert, b = e.allowPinchZoom, v = e.as, w = v === void 0 ? "div" : v, N = e.gapMode, E = vc(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), y = f, C = qp([n, t]), S = nt(nt({}, E), r);
  return T.createElement(
    T.Fragment,
    null,
    u && T.createElement(y, { sideCar: yc, removeScrollBar: c, shards: d, noRelative: h, noIsolation: g, inert: p, setCallbacks: s, allowPinchZoom: !!b, lockRef: n, gapMode: N }),
...
}, cg = Nc(), mn = "data-scroll-locked", ug = function(e, t, n, o) {
...
`);
  ...
  T.useEffect(function() {
    return document.body.setAttribute(mn, (va() + 1).toString()), function() {
      var e = va() - 1;
...
var nn = xs ? { passive: !1 } : !1, fg = function(e) {
  ...
  do {
    if (!i)
      break;
    var h = Cc(e, i), g = h[0], p = h[1], b = h[2], v = p - b - s * g;
    (g || v) && xc(e, i) && (d += v, f += g);
    var w = i.parentNode;
...
function xg(e) {
  var t = T.useRef([]), n = T.useRef([0, 0]), o = T.useRef(), r = T.useState(kg++)[0], s = T.useState(Nc)[0], a = T.useRef(e);
  T.useEffect(function() {
    a.current = e;
  }, [e]), T.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(r));
      var p = Yp([e.lockRef.current], (e.shards || []).map(Na), !0).filter(Boolean);
  ...
  var i = T.useCallback(function(p, b) {
    ...
    if (!(!on.length || on[on.length - 1] !== s)) {
      var v = "deltaY" in b ? ya(b) : $o(b), w = t.current.filter(function(y) {
      ...
      if (!w) {
        var N = (a.current.shards || []).map(Na).filter(Boolean).filter(function(y) {
    ...
    c(p.type, ya(p), p.target, i(p, e.lockRef.current));
...
const Eg = Jp(yc, xg);
var Ec = T.forwardRef(function(e, t) {
  return T.createElement(kr, nt({}, e, { ref: t, sideCar: Eg }));
});
Ec.classNames = kr.classNames;
var Cs = ["Enter", " "], Tg = ["ArrowDown", "PageUp", "Home"], Tc = ["ArrowUp", "PageDown", "End"], Sg = [...Tg, ...Tc], Mg = {
  ltr: [...Cs, "ArrowRight"],
  rtl: [...Cs, "ArrowLeft"]
}, Dg = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, oo = "Menu", [qn, Ag, Pg] = Rl(oo), [Kt, Sc] = kn(oo, [
  Pg,
  Nr,
  mc
]), xr = Nr(), Mc = mc(), [Lg, Gt] = Kt(oo), [Ig, ro] = Kt(oo), Dc = (e) => {
  const { __scopeMenu: t, open: n = !1, children: o, dir: r, onOpenChange: s, modal: a = !0 } = e, i = xr(t), [l, c] = T.useState(null), u = T.useRef(!1), d = bt(s), f = Ol(r);
  return T.useEffect(() => {
    const h = () => {
...
Dc.displayName = oo;
var Rg = "MenuAnchor", li = T.forwardRef(
  (e, t) => {
...
li.displayName = Rg;
var ci = "MenuPortal", [Og, Ac] = Kt(ci, {
  forceMount: void 0
}), Pc = (e) => {
  const { __scopeMenu: t, forceMount: n, children: o, container: r } = e, s = Gt(ci, t);
  return /* @__PURE__ */ z(Og, { scope: t, forceMount: n, children: /* @__PURE__ */ z(Vt, { present: n || s.open, children: /* @__PURE__ */ z(ai, { asChild: !0, container: r, children: o }) }) });
};
Pc.displayName = ci;
var Ke = "MenuContent", [_g, ui] = Kt(Ke), Lc = T.forwardRef(
  (e, t) => {
    const n = Ac(Ke, e.__scopeMenu), { forceMount: o = n.forceMount, ...r } = e, s = Gt(Ke, e.__scopeMenu), a = ro(Ke, e.__scopeMenu);
    return /* @__PURE__ */ z(qn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ z(Vt, { present: o || s.open, children: /* @__PURE__ */ z(qn.Slot, { scope: e.__scopeMenu, children: a.modal ? /* @__PURE__ */ z(Bg, { ...r, ref: t }) : /* @__PURE__ */ z($g, { ...r, ref: t }) }) }) });
  }
), Bg = T.forwardRef(
  (e, t) => {
...
}), Hg = /* @__PURE__ */ Vn("MenuContent.ScrollLock"), di = T.forwardRef(
  (e, t) => {
    const {
      __scopeMenu: n,
      loop: o = !1,
      ...
      ...p
    } = e, b = Gt(Ke, n), v = ro(Ke, n), w = xr(n), N = Mc(n), E = Ag(n), [y, C] = T.useState(null), S = T.useRef(null), k = Le(t, S, b.onContentChange), D = T.useRef(0), x = T.useRef(""), M = T.useRef(0), A = T.useRef(null), I = T.useRef("right"), R = T.useRef(0), _ = g ? Ec : T.Fragment, H = g ? { as: Hg, allowPinchZoom: !0 } : void 0, V = (P) => {
                    ...
                    children: /* @__PURE__ */ z(
                      cc,
                      {
                        ...
                        onKeyDown: le(p.onKeyDown, (P) => {
                          ...
                          Tc.includes(P.key) && J.reverse(), qg(J);
                        }),
...
Lc.displayName = Ke;
var Wg = "MenuGroup", mi = T.forwardRef(
  (e, t) => {
...
mi.displayName = Wg;
var Fg = "MenuLabel", Ic = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e;
...
Ic.displayName = Fg;
var ir = "MenuItem", ka = "menu.itemSelect", Cr = T.forwardRef(
  (e, t) => {
    const { disabled: n = !1, onSelect: o, ...r } = e, s = T.useRef(null), a = ro(ir, e.__scopeMenu), i = ui(ir, e.__scopeMenu), l = Le(t, s), c = T.useRef(!1), u = () => {
      const d = s.current;
      if (!n && d) {
        const f = new CustomEvent(ka, { bubbles: !0, cancelable: !0 });
        d.addEventListener(ka, (h) => o?.(h), { once: !0 }), Il(d, f), f.defaultPrevented ? c.current = !1 : a.onClose();
      }
    };
    return /* @__PURE__ */ z(
      Rc,
...
var Rc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, disabled: o = !1, textValue: r, ...s } = e, a = ui(ir, n), i = Mc(n), l = T.useRef(null), c = Le(t, l), [u, d] = T.useState(!1), [f, h] = T.useState("");
    return T.useEffect(() => {
      const g = l.current;
...
), zg = "MenuCheckboxItem", Oc = T.forwardRef(
  (e, t) => {
...
Oc.displayName = zg;
var _c = "MenuRadioGroup", [Ug, Yg] = Kt(
  _c,
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ z(Ug, { scope: e.__scopeMenu, value: n, onValueChange: s, children: /* @__PURE__ */ z(mi, { ...r, ref: t }) });
  }
);
Bc.displayName = _c;
var $c = "MenuRadioItem", Hc = T.forwardRef(
  (e, t) => {
    const { value: n, ...o } = e, r = Yg($c, e.__scopeMenu), s = n === r.value;
...
Hc.displayName = $c;
var fi = "MenuItemIndicator", [Wc, jg] = Kt(
  fi,
  { checked: !1 }
), Fc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, forceMount: o, ...r } = e, s = jg(fi, n);
    return /* @__PURE__ */ z(
      Vt,
      {
...
Fc.displayName = fi;
var Vg = "MenuSeparator", zc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e;
    return /* @__PURE__ */ z(
      Ae.div,
...
zc.displayName = Vg;
var Kg = "MenuArrow", Uc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e, r = xr(n);
...
Uc.displayName = Kg;
var Gg = "MenuSub", [Q1, Yc] = Kt(Gg), $n = "MenuSubTrigger", jc = T.forwardRef(
  (e, t) => {
    const n = Gt($n, e.__scopeMenu), o = ro($n, e.__scopeMenu), r = Yc($n, e.__scopeMenu), s = ui($n, e.__scopeMenu), a = T.useRef(null), { pointerGraceTimerRef: i, onPointerGraceIntentChange: l } = s, c = { __scopeMenu: e.__scopeMenu }, u = T.useCallback(() => {
    ...
    }, [i, l]), /* @__PURE__ */ z(li, { asChild: !0, ...c, children: /* @__PURE__ */ z(
      Rc,
      {
        id: r.triggerId,
        "aria-haspopup": "menu",
...
var Vc = "MenuSubContent", Kc = T.forwardRef(
  (e, t) => {
    const n = Ac(Ke, e.__scopeMenu), { forceMount: o = n.forceMount, ...r } = e, s = Gt(Ke, e.__scopeMenu), a = ro(Ke, e.__scopeMenu), i = Yc(Vc, e.__scopeMenu), l = T.useRef(null), c = Le(t, l);
    return /* @__PURE__ */ z(qn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ z(Vt, { present: o || s.open, children: /* @__PURE__ */ z(qn.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ z(
      di,
      {
        id: i.contentId,
...
var eb = Dc, tb = li, nb = Pc, ob = Lc, rb = mi, sb = Ic, ib = Cr, ab = Oc, lb = Bc, cb = Hc, ub = Fc, db = zc, mb = Uc, fb = jc, hb = Kc, Er = "DropdownMenu", [pb] = kn(
  Er,
  [Sc]
), Re = Sc(), [gb, qc] = pb(Er), Xc = (e) => {
  const {
    ...
    onOpenChange: a,
    modal: i = !0
  } = e, l = Re(t), c = T.useRef(null), [u, d] = Zs({
    prop: r,
    defaultProp: s ?? !1,
    onChange: a,
    caller: Er
...
var Zc = "DropdownMenuTrigger", Qc = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, disabled: o = !1, ...r } = e, s = qc(Zc, n), a = Re(n);
...
Qc.displayName = Zc;
var bb = "DropdownMenuPortal", Jc = (e) => {
...
var eu = "DropdownMenuContent", tu = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = qc(eu, n), s = Re(n), a = T.useRef(!1);
    return /* @__PURE__ */ z(
      ob,
      {
        id: r.contentId,
...
Nb.displayName = yb;
var kb = "DropdownMenuItem", nu = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Re(n);
...
Ab.displayName = Db;
var Pb = "DropdownMenuSeparator", ou = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Re(n);
...
Bb.displayName = _b;
var $b = Xc, Hb = Qc, Wb = Jc, Fb = tu, zb = nu, Ub = ou;
function ru(e) {
  var t, n, o = "";
...
const pi = "-", Yb = (e) => {
  ...
  return {
    getClassGroupId: (a) => {
      const i = a.split(pi);
      return i[0] === "" && i.length !== 1 && i.shift(), iu(i, t) || jb(a);
    },
  ...
  if (xa.test(e)) {
    const t = xa.exec(e)[1], n = t?.substring(0, t.indexOf(":"));
    if (n)
      return "arbitrary.." + n;
  }
}, Vb = (e) => {
...
const Ce = (e) => {
...
}, lu = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, cu = /^\((?:(\w[\w-]*):)?(.+)\)$/i, rv = /^\d+\/\d+$/, sv = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, iv = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, av = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, lv = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, cv = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, rn = (e) => rv.test(e), ce = (e) => !!e && !Number.isNaN(Number(e)), xt = (e) => !!e && Number.isInteger(Number(e)), es = (e) => e.endsWith("%") && ce(e.slice(0, -1)), ut = (e) => sv.test(e), uv = () => !0, dv = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  iv.test(e) && !av.test(e)
), uu = () => !1, mv = (e) => lv.test(e), fv = (e) => cv.test(e), hv = (e) => !Z(e) && !Q(e), pv = (e) => En(e, fu, uu), Z = (e) => lu.test(e), _t = (e) => En(e, hu, dv), ts = (e) => En(e, yv, ce), Ea = (e) => En(e, du, uu), gv = (e) => En(e, mu, fv), Ho = (e) => En(e, pu, mv), Q = (e) => cu.test(e), Rn = (e) => Tn(e, hu), bv = (e) => Tn(e, Nv), Ta = (e) => Tn(e, du), vv = (e) => Tn(e, fu), wv = (e) => Tn(e, mu), Wo = (e) => Tn(e, pu, !0), En = (e, t, n) => {
  const o = lu.exec(e);
  return o ? o[1] ? t(o[1]) : n(o[2]) : !1;
}, Tn = (e, t, n = !1) => {
  const o = cu.exec(e);
  return o ? o[1] ? t(o[1]) : n : !1;
}, du = (e) => e === "position" || e === "percentage", mu = (e) => e === "image" || e === "url", fu = (e) => e === "length" || e === "size" || e === "bg-size", hu = (e) => e === "length", yv = (e) => e === "number", Nv = (e) => e === "family-name", pu = (e) => e === "shadow", kv = () => {
  const e = Ce("color"), t = Ce("font"), n = Ce("text"), o = Ce("font-weight"), r = Ce("tracking"), s = Ce("leading"), a = Ce("breakpoint"), i = Ce("container"), l = Ce("spacing"), c = Ce("radius"), u = Ce("shadow"), d = Ce("inset-shadow"), f = Ce("text-shadow"), h = Ce("drop-shadow"), g = Ce("blur"), p = Ce("perspective"), b = Ce("aspect"), v = Ce("ease"), w = Ce("animate"), N = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], E = () => [
    ...
    span: ["full", xt, Q, Z]
  }, xt, Q, Z], A = () => [xt, "auto", Q, Z], I = () => ["auto", "min", "max", "fr", Q, Z], R = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], _ = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], H = () => ["auto", ...k()], V = () => [rn, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...k()], L = () => [e, Q, Z], P = () => [...E(), Ta, Ea, {
    position: [Q, Z]
  }], B = () => ["no-repeat", {
    ...
    Q,
    Z
  ], K = () => ["", ce, Rn, _t], $ = () => ["solid", "dashed", "dotted", "double"], J = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], O = () => [ce, es, Ta, Ea], ee = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    g,
    Q,
    Z
  ], ne = () => ["none", ce, Q, Z], ue = () => ["none", ce, Q, Z], ye = () => [ce, Q, Z], be = () => [rn, "full", ...k()];
  return {
    cacheSize: 500,
    theme: {
...
const Sa = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, Ma = su, Cv = (e, t) => (n) => {
  var o;
  ...
  return Ma(e, a, l, n?.class, n?.className);
}, Ms = Cv(
...
var Ev = Object.freeze({
  ...
  whiteSpace: "nowrap",
  wordWrap: "normal"
}), Tv = "VisuallyHidden", gu = T.forwardRef(
  (e, t) => /* @__PURE__ */ z(
    Ae.span,
    {
      ...e,
...
gu.displayName = Tv;
var Sv = gu, [Tr] = kn("Tooltip", [
  Nr
]), Sr = Nr(), bu = "TooltipProvider", Mv = 700, Ds = "tooltip.open", [Dv, gi] = Tr(bu), vu = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = Mv,
...
vu.displayName = bu;
var Zn = "Tooltip", [Av, so] = Tr(Zn), wu = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: o,
    ...
    delayDuration: i
  } = e, l = gi(Zn, e.__scopeTooltip), c = Sr(t), [u, d] = T.useState(null), f = tr(), h = T.useRef(0), g = a ?? l.disableHoverableContent, p = i ?? l.delayDuration, b = T.useRef(!1), [v, w] = Zs({
    prop: o,
    defaultProp: r ?? !1,
    onChange: (S) => {
...
wu.displayName = Zn;
var As = "TooltipTrigger", yu = T.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...o } = e, r = so(As, n), s = gi(As, n), a = Sr(n), i = T.useRef(null), l = Le(t, i, r.onTriggerChange), c = T.useRef(!1), u = T.useRef(!1), d = T.useCallback(() => c.current = !1, []);
...
yu.displayName = As;
var bi = "TooltipPortal", [Pv, Lv] = Tr(bi, {
  forceMount: void 0
}), Nu = (e) => {
  const { __scopeTooltip: t, forceMount: n, children: o, container: r } = e, s = so(bi, t);
  return /* @__PURE__ */ z(Pv, { scope: t, forceMount: n, children: /* @__PURE__ */ z(Vt, { present: n || s.open, children: /* @__PURE__ */ z(ai, { asChild: !0, container: r, children: o }) }) });
};
Nu.displayName = bi;
var bn = "TooltipContent", ku = T.forwardRef(
  (e, t) => {
    const n = Lv(bn, e.__scopeTooltip), { forceMount: o = n.forceMount, side: r = "top", ...s } = e, a = so(bn, e.__scopeTooltip);
    return /* @__PURE__ */ z(Vt, { present: o || a.open, children: a.disableHoverableContent ? /* @__PURE__ */ z(xu, { side: r, ...s, ref: t }) : /* @__PURE__ */ z(Iv, { side: r, ...s, ref: t }) });
  }
), Iv = T.forwardRef((e, t) => {
  const n = so(bn, e.__scopeTooltip), o = gi(bn, e.__scopeTooltip), r = T.useRef(null), s = Le(t, r), [a, i] = T.useState(null), { trigger: l, onClose: c } = n, u = r.current, { onPointerInTransitChange: d } = o, f = T.useCallback(() => {
    i(null), d(!1);
  }, [d]), h = T.useCallback(
    (g, p) => {
...
}), [Rv, Ov] = Tr(Zn, { isInside: !1 }), _v = /* @__PURE__ */ Of("TooltipContent"), xu = T.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: o,
      ...
      ...i
    } = e, l = so(bn, n), c = Sr(n), { onClose: u } = l;
...
ku.displayName = bn;
var Cu = "TooltipArrow", Eu = T.forwardRef(
  (e, t) => {
...
var Uv = vu, Yv = wu, jv = yu, Vv = Nu, Kv = ku, Gv = Eu;
function qv({
  delayDuration: e = 0,
  ...t
}) {
...
const ve = ({ onClick: e, isActive: t, disabled: n, children: o, tooltip: r }) => {
  const s = /* @__PURE__ */ m(
    "button",
    {
      onMouseDown: (a) => {
  ...
  return r ? /* @__PURE__ */ m(Tu, { children: [
    /* @__PURE__ */ m(Su, { asChild: !0, children: s }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
      lineNumber: 125,
      columnNumber: 9
    }, void 0),
    /* @__PURE__ */ m(Mu, { side: "bottom", className: "text-xs", children: r }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
      lineNumber: 126,
      columnNumber: 9
    }, void 0)
...
}, Bt = () => /* @__PURE__ */ m("div", { className: "w-px h-5 bg-border mx-0.5 shrink-0" }, void 0, !1, {
  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
  lineNumber: 137,
  columnNumber: 3
  ...
  const l = Y(null), [c, u] = j(!1), [d, f] = j(void 0), h = ul({
    editor: t,
    selector: ({ editor: C }) => ({
      canUndo: C.can().undo(),
      canRedo: C.can().redo(),
  ...
  return /* @__PURE__ */ m("div", { className: `flex items-center gap-0.5 px-2 py-1.5 border-b border-border/30 bg-muted/30 overflow-x-auto scrollbar-hide editor-toolbar ${r}`, children: [
      ...
      /* @__PURE__ */ m(os, { asChild: !0, children: /* @__PURE__ */ m(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ m(eo, { size: 12, strokeWidth: 2.5, className: "flex-shrink-0" }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
              lineNumber: 483,
              columnNumber: 13
            }, this)
    ...
    /* @__PURE__ */ m(ns, { children: [
      ...
      /* @__PURE__ */ m(rs, { align: "start", children: [
        ...
        /* @__PURE__ */ m(Ne, { onClick: () => v("note"), children: [
          /* @__PURE__ */ m(vl, { size: 16, className: "mr-2", style: { color: "#FF8200" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 655,
            columnNumber: 13
          }, this),
        ...
        /* @__PURE__ */ m(Ne, { onClick: () => v("todo"), children: [
          /* @__PURE__ */ m(wl, { size: 16, className: "mr-2", style: { color: "#4479B3" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 664,
            columnNumber: 13
          }, this),
    ...
    a && /* @__PURE__ */ m(we, { children: [
      ...
      /* @__PURE__ */ m(Tu, { children: [
        /* @__PURE__ */ m(Su, { asChild: !0, children: /* @__PURE__ */ m(
          "button",
          {
            ref: l,
            onClick: () => {
        ...
        /* @__PURE__ */ m(Mu, { side: "bottom", className: "text-xs", children: "AI Writing Assistant" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
          lineNumber: 786,
          columnNumber: 13
        }, this)
        ...
        /* @__PURE__ */ m("div", { className: "find-replace-row", children: [
          ...
          /* @__PURE__ */ m(
            "button",
            {
              ...
              children: /* @__PURE__ */ m(eo, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
                lineNumber: 418,
                columnNumber: 11
              }, this)
    ...
    /* @__PURE__ */ m("div", { className: "select-all-action-bar-inner", children: [
      ...
      h && o < s && /* @__PURE__ */ m(we, { children: [
        /* @__PURE__ */ m(
          "button",
          {
            ...
            children: /* @__PURE__ */ m(Ks, { size: 14 }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
              lineNumber: 164,
              columnNumber: 15
            }, void 0)
      ...
      /* @__PURE__ */ m(
        "button",
        {
          ...
          children: /* @__PURE__ */ m($s, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
            lineNumber: 183,
            columnNumber: 11
          }, void 0)
...
}), cw = nf.extend({}), Un = new De("tableSorting");
let Ft = null, Hn = null;
function uw(e) {
...
function mw(e, t, n) {
  ...
  const a = Ft?.tablePos === t && Ft?.columnIndex === n && Ft?.direction === "asc" ? "desc" : "asc";
  Ft = { tablePos: t, columnIndex: n, direction: a }, Hn = null;
  const i = [];
  s.forEach((g) => {
  ...
  if (c.length < 2) {
    Da(n, a), r.dispatch(o.tr.setMeta(Un, { updated: !0 }));
    return;
  }
  const u = c.map((g) => {
    let p = "", b = 0;
  ...
  return new Me({
    ...
    state: {
      ...
      apply(t, n, o, r) {
        ...
        return !t.docChanged && !s?.updated && Hn ? Hn.map(t.mapping, t.doc) : (Hn = pw(r.doc, e), Hn);
      }
    },
    props: {
      decorations(t) {
        ...
        if (a.type.name === "tableRow") {
          ...
          a.forEach((u, d) => {
            if (u.type.name === "tableHeader") {
              ...
              const p = Ft?.tablePos === s && Ft?.columnIndex === l ? Ft.direction : null, b = l, v = s, w = Ze.widget(h, () => fw(p, v, b, t), { side: 1, key: "sort-" + s + "-" + b });
              n.push(w);
            }
            c += u.nodeSize, l++;
          });
    ...
    return {
      toggleTaskList: () => ({ editor: e, commands: t, state: n, tr: o, dispatch: r, chain: s, can: a }) => {
        ...
        if (E) {
          ...
          return C >= 0 && vi(o, C, d, f, b, { checked: !1 }), r(o), !0;
        }
    ...
    return {
      ...
      collapseAllListItems: () => ({ editor: e, tr: t }) => {
        ...
        return t.doc.descendants((r, s) => {
          this.options.listItemTypes.includes(r.type.name) && lr(r) && n.collapsedItems.add(Ps(r, s));
...
class Lw {
  ...
  toggleCollapse() {
    this.collapsed = !this.collapsed, this.collapsed ? (this.dom.classList.add("callout-collapsed"), this.contentWrapper.classList.add("callout-content-hidden"), this.headerEl.title = "Click to expand") : (this.dom.classList.remove("callout-collapsed"), this.contentWrapper.classList.remove("callout-content-hidden"), this.headerEl.title = "Click to collapse"), this.collapseIndicator.innerHTML = "", this.collapseIndicator.appendChild(
      this.collapsed ? $t(Aw, 16) : $t(as, 16)
    );
  }
  // ── Dropdown Portal ──
  toggleDropdown() {
...
function zt(e, t) {
  try {
    ...
    return o in Wn ? Wn[o] : La(o, o.split(":"));
  } catch {
...
class rt extends Date {
  //#region static
  constructor(...t) {
    super(), t.length > 1 && typeof t[t.length - 1] == "string" && (this.timeZone = t.pop()), this.internal = /* @__PURE__ */ new Date(), isNaN(zt(this.timeZone, this)) ? this.setTime(NaN) : t.length ? typeof t[0] == "number" && (t.length === 1 || t.length === 2 && typeof t[1] != "number") ? this.setTime(t[0]) : typeof t[0] == "string" ? this.setTime(+new Date(t[0])) : t[0] instanceof Date ? this.setTime(+t[0]) : (this.setTime(+new Date(...t)), Du(this), Ls(this)) : this.setTime(Date.now());
  }
  static tz(t, ...n) {
...
function $w(e) {
  Date.prototype.setFullYear.call(e, e.internal.getUTCFullYear(), e.internal.getUTCMonth(), e.internal.getUTCDate()), Date.prototype.setHours.call(e, e.internal.getUTCHours(), e.internal.getUTCMinutes(), e.internal.getUTCSeconds(), e.internal.getUTCMilliseconds()), Du(e);
}
function Du(e) {
  const t = zt(e.timeZone, e), n = t > 0 ? Math.floor(t) : Math.ceil(t), o = /* @__PURE__ */ new Date(+e);
  ...
  c.setUTCSeconds(0);
  const u = r > 0 ? c.getSeconds() : (c.getSeconds() - 60) % 60, d = Math.round(-(zt(e.timeZone, e) * 60)) % 60;
  ...
  const f = zt(e.timeZone, e), h = f > 0 ? Math.floor(f) : Math.ceil(f), p = -(/* @__PURE__ */ new Date(+e)).getTimezoneOffset() - h, b = h !== n, v = p - l;
  if (b && v) {
    Date.prototype.setUTCMinutes.call(e, Date.prototype.getUTCMinutes.call(e) + v);
    const w = zt(e.timeZone, e), N = w > 0 ? Math.floor(w) : Math.ceil(w), E = h - N;
...
const Au = 6048e5, Hw = 864e5, Ra = Symbol.for("constructDateFrom");
function ke(e, t) {
...
function vn(e, t) {
  const n = io(), o = t?.weekStartsOn ?? t?.locale?.options?.weekStartsOn ?? n.weekStartsOn ?? n.locale?.options?.weekStartsOn ?? 0, r = he(e, t?.in), s = r.getDay(), a = (s < o ? 7 : 0) + s - o;
...
function Ru(e, t, n) {
  const [o, r] = Sn(
    ...
    e,
    t
  ), s = Jn(o), a = Jn(r), i = +s - Oa(s), l = +a - Oa(a);
  return Math.round((i - l) / Hw);
}
function Fw(e, t) {
  const n = Iu(e, t), o = ke(e, 0);
...
function Kw(e) {
  return !(!Ou(e) && typeof e != "number" || isNaN(+he(e)));
}
function Gw(e, t, n) {
  const [o, r] = Sn(
    n?.in,
...
function $u(e, t) {
  const n = io(), o = t?.weekStartsOn ?? t?.locale?.options?.weekStartsOn ?? n.weekStartsOn ?? n.locale?.options?.weekStartsOn ?? 0, r = he(e, t?.in), s = r.getDay(), a = (s < o ? -7 : 0) + 6 - (s - o);
...
function Hu(e, t) {
  const n = he(e, t?.in), o = +Qn(n) - +Fw(n);
  return Math.round(o / Au) + 1;
}
function Wu(e, t) {
  const n = he(e, t?.in), o = n.getFullYear(), r = io(), s = t?.firstWeekContainsDate ?? t?.locale?.options?.firstWeekContainsDate ?? r.firstWeekContainsDate ?? r.locale?.options?.firstWeekContainsDate ?? 1, a = ke(t?.in || e, 0);
...
function Ry(e, t) {
  const n = io(), o = t?.firstWeekContainsDate ?? t?.locale?.options?.firstWeekContainsDate ?? n.firstWeekContainsDate ?? n.locale?.options?.firstWeekContainsDate ?? 1, r = Wu(e, t), s = ke(t?.in || e, 0);
...
const Ha = (e, t) => {
  ...
  return s.replace("{{date}}", Ha(o, t)).replace("{{time}}", zu(r, t));
}, _y = {
  p: zu,
  P: Oy
...
function qy(e, t, n) {
  const o = io(), r = n?.locale ?? o.locale ?? wi, s = n?.firstWeekContainsDate ?? n?.locale?.options?.firstWeekContainsDate ?? o.firstWeekContainsDate ?? o.locale?.options?.firstWeekContainsDate ?? 1, a = n?.weekStartsOn ?? n?.locale?.options?.weekStartsOn ?? o.weekStartsOn ?? o.locale?.options?.weekStartsOn ?? 0, i = he(e, n?.in);
  if (!Kw(i))
...
function a0(e, t) {
  ...
  return t.getMonth(e) === t.getMonth(s) ? Wa : i0;
}
function Uu(e, t) {
...
class ze {
   ...
   */
  constructor(t, n) {
    this.Date = Date, this.today = () => this.overrides?.today ? this.overrides.today() : this.options.timeZone ? Pe.tz(this.options.timeZone) : new this.Date(), this.newDate = (o, r, s) => this.overrides?.newDate ? this.overrides.newDate(o, r, s) : this.options.timeZone ? new Pe(o, r, s, this.options.timeZone) : new Date(o, r, s), this.addDays = (o, r) => this.overrides?.addDays ? this.overrides.addDays(o, r) : Pu(o, r), this.addMonths = (o, r) => this.overrides?.addMonths ? this.overrides.addMonths(o, r) : Lu(o, r), this.addWeeks = (o, r) => this.overrides?.addWeeks ? this.overrides.addWeeks(o, r) : zw(o, r), this.addYears = (o, r) => this.overrides?.addYears ? this.overrides.addYears(o, r) : Uw(o, r), this.differenceInCalendarDays = (o, r) => this.overrides?.differenceInCalendarDays ? this.overrides.differenceInCalendarDays(o, r) : Ru(o, r), this.differenceInCalendarMonths = (o, r) => this.overrides?.differenceInCalendarMonths ? this.overrides.differenceInCalendarMonths(o, r) : Gw(o, r), this.eachMonthOfInterval = (o) => this.overrides?.eachMonthOfInterval ? this.overrides.eachMonthOfInterval(o) : Xw(o), this.eachYearOfInterval = (o) => {
    ...
    }, this.endOfBroadcastWeek = (o) => this.overrides?.endOfBroadcastWeek ? this.overrides.endOfBroadcastWeek(o) : l0(o, this), this.endOfISOWeek = (o) => this.overrides?.endOfISOWeek ? this.overrides.endOfISOWeek(o) : ey(o), this.endOfMonth = (o) => this.overrides?.endOfMonth ? this.overrides.endOfMonth(o) : qw(o), this.endOfWeek = (o, r) => this.overrides?.endOfWeek ? this.overrides.endOfWeek(o, r) : $u(o, this.options), this.endOfYear = (o) => this.overrides?.endOfYear ? this.overrides.endOfYear(o) : Qw(o), this.format = (o, r, s) => {
      const a = this.overrides?.format ? this.overrides.format(o, r, this.options) : qy(o, r, this.options);
      return this.options.numerals && this.options.numerals !== "latn" ? this.replaceDigits(a) : a;
    }, this.getISOWeek = (o) => this.overrides?.getISOWeek ? this.overrides.getISOWeek(o) : Hu(o), this.getMonth = (o, r) => this.overrides?.getMonth ? this.overrides.getMonth(o, this.options) : Qy(o, this.options), this.getYear = (o, r) => this.overrides?.getYear ? this.overrides.getYear(o, this.options) : Jy(o, this.options), this.getWeek = (o, r) => this.overrides?.getWeek ? this.overrides.getWeek(o, this.options) : Fu(o, this.options), this.isAfter = (o, r) => this.overrides?.isAfter ? this.overrides.isAfter(o, r) : e0(o, r), this.isBefore = (o, r) => this.overrides?.isBefore ? this.overrides.isBefore(o, r) : t0(o, r), this.isDate = (o) => this.overrides?.isDate ? this.overrides.isDate(o) : Ou(o), this.isSameDay = (o, r) => this.overrides?.isSameDay ? this.overrides.isSameDay(o, r) : Vw(o, r), this.isSameMonth = (o, r) => this.overrides?.isSameMonth ? this.overrides.isSameMonth(o, r) : n0(o, r), this.isSameYear = (o, r) => this.overrides?.isSameYear ? this.overrides.isSameYear(o, r) : o0(o, r), this.max = (o) => this.overrides?.max ? this.overrides.max(o) : Yw(o), this.min = (o) => this.overrides?.min ? this.overrides.min(o) : jw(o), this.setMonth = (o, r) => this.overrides?.setMonth ? this.overrides.setMonth(o, r) : r0(o, r), this.setYear = (o, r) => this.overrides?.setYear ? this.overrides.setYear(o, r) : s0(o, r), this.startOfBroadcastWeek = (o, r) => this.overrides?.startOfBroadcastWeek ? this.overrides.startOfBroadcastWeek(o, this) : Uu(o, this), this.startOfDay = (o) => this.overrides?.startOfDay ? this.overrides.startOfDay(o) : Jn(o), this.startOfISOWeek = (o) => this.overrides?.startOfISOWeek ? this.overrides.startOfISOWeek(o) : Qn(o), this.startOfMonth = (o) => this.overrides?.startOfMonth ? this.overrides.startOfMonth(o) : Zw(o), this.startOfWeek = (o, r) => this.overrides?.startOfWeek ? this.overrides.startOfWeek(o, this.options) : vn(o, this.options), this.startOfYear = (o) => this.overrides?.startOfYear ? this.overrides.startOfYear(o) : Bu(o), this.options = { locale: wi, ...t }, this.overrides = n;
  }
  /**
...
function C0(e) {
  const { onPreviousClick: t, onNextClick: n, previousMonth: o, nextMonth: r, ...s } = e, { components: a, classNames: i, labels: { labelPrevious: l, labelNext: c } } = ao(), u = F((f) => {
    r && n?.(f);
  }, [r, n]), d = F((f) => {
    o && t?.(f);
  }, [o, t]);
...
function ht(e, t, n = lt) {
  ...
  return o.some((i) => {
    ...
    return Ku(i) ? s(e, i.after) > 0 : Gu(i) ? s(i.before, e) > 0 : typeof i == "function" ? i(e) : !1;
  });
}
function $0(e, t, n, o, r) {
  ...
  for (const y of e) {
    const { date: C, displayMonth: S } = y, k = !!(S && !f(C, S)), D = !!(v && g(C, v)), x = !!(w && b(C, w)), M = !!(s && ht(C, s, r)), A = !!(a && ht(C, a, r)) || D || x || // Broadcast calendar will show outside days as default
    ...
    k && N.outside.push(y), M && N.disabled.push(y), A && N.hidden.push(y), I && N.today.push(y), i && Object.keys(i).forEach((R) => {
      const _ = i?.[R];
      _ && ht(C, _, r) && (E[R] ? E[R].push(y) : E[R] = [y]);
    });
  }
  return (y) => {
    const C = {
...
const G0 = Qu, q0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  formatCaption: Zu,
  formatDay: U0,
...
}, Symbol.toStringTag, { value: "Module" })), lo = (e) => e instanceof HTMLElement ? e : null, cs = (e) => [
  ...e.querySelectorAll("[data-animated-month]") ?? []
], fN = (e) => lo(e.querySelector("[data-animated-month]")), us = (e) => lo(e.querySelector("[data-animated-caption]")), ds = (e) => lo(e.querySelector("[data-animated-weeks]")), hN = (e) => lo(e.querySelector("[data-animated-nav]")), pN = (e) => lo(e.querySelector("[data-animated-weekdays]"));
...
function yN(e, t, n, o) {
  const { addDays: r, endOfBroadcastWeek: s, endOfISOWeek: a, endOfMonth: i, endOfWeek: l, getISOWeek: c, getWeek: u, startOfBroadcastWeek: d, startOfISOWeek: f, startOfWeek: h } = o, g = e.reduce((p, b) => {
    ...
    const y = N.reduce((S, k) => {
      const D = n.ISOWeek ? c(k) : u(k), x = S.find((A) => A.weekNumber === D), M = new Yu(k, b, o);
...
function EN(e, t) {
  const [n, o] = NN(e, t), { startOfMonth: r, endOfMonth: s } = t, a = Fa(e, n, o, t), [i, l] = Mr(
    a,
...
function TN(e, t, n, o) {
  ...
  for (const a of e) {
    const i = t(a);
    za(i) && (i[ge.focused] && s < tt.FocusedModifier ? (r = a, s = tt.FocusedModifier) : o?.isEqualTo(a) && s < tt.LastFocused ? (r = a, s = tt.LastFocused) : n(a.date) && s < tt.Selected ? (r = a, s = tt.Selected) : i[ge.today] && s < tt.Today && (r = a, s = tt.Today));
  }
  return r || (r = e.find((a) => za(t(a)))), r;
}
...
function td(e, t, n, o, r, s, a, i = 0) {
  if (i > 365)
    return;
  const l = SN(e, t, n.date, o, r, s, a), c = !!(s.disabled && ht(l, s.disabled, a)), u = !!(s.hidden && ht(l, s.hidden, a)), d = l, f = new Yu(l, d, a);
  return !c && !u ? f : td(e, t, f, o, r, s, a, i + 1);
}
function MN(e, t, n, o, r) {
  ...
  return {
    ...
    moveFocus: (p, b) => {
      if (!c)
        return;
      const v = td(p, b, c, t.navStart, t.navEnd, e, r);
...
function AN(e, t, n = 0, o = 0, r = !1, s = lt) {
...
function Ua(e, t, n = lt) {
  return ft(e, t.from, !1, n) || ft(e, t.to, !1, n) || ft(t, e.from, !1, n) || ft(t, e.to, !1, n);
}
function LN(e, t, n = lt) {
  const o = Array.isArray(t) ? t : [t];
  if (o.filter((i) => typeof i != "function").some((i) => typeof i == "boolean" ? i : n.isDate(i) ? ft(e, i, !1, n) : Xu(i, n) ? i.some((l) => ft(e, l, !1, n)) : yi(i) ? i.from && i.to ? Ua(e, { from: i.from, to: i.to }, n) : !1 : qu(i) ? PN(e, i.dayOfWeek, n) : Vu(i) ? n.isAfter(i.before, i.after) ? Ua(e, {
    from: n.addDays(i.after, 1),
    to: n.addDays(i.before, -1)
  }, n) : ht(e.from, i, n) || ht(e.to, i, n) : Ku(i) || Gu(i) ? ht(e.from, i, n) || ht(e.to, i, n) : !1))
    return !0;
...
function _N(e) {
  ...
  const { components: n, formatters: o, labels: r, dateLib: s, locale: a, classNames: i } = St(() => {
    ...
    t.labels,
    t.classNames
  ]), { captionLayout: l, mode: c, navLayout: u, numberOfMonths: d = 1, onDayBlur: f, onDayClick: h, onDayFocus: g, onDayKeyDown: p, onDayMouseEnter: b, onDayMouseLeave: v, onNextClick: w, onPrevClick: N, showWeekNumber: E, styles: y } = t, { formatCaption: C, formatDay: S, formatMonthDropdown: k, formatWeekNumber: D, formatWeekNumberHeader: x, formatWeekdayName: M, formatYearDropdown: A } = o, I = EN(t, s), { days: R, months: _, navStart: H, navEnd: V, previousMonth: L, nextMonth: P, goToMonth: B } = I, G = $0(R, t, H, V, s), { isSelected: W, select: U, selected: K } = ON(t, s) ?? {}, { blur: $, focused: J, isFocusTarget: O, moveFocus: ee, setFocused: ne } = MN(t, I, G, W ?? (() => !1), s), { labelDayButton: ue, labelGridcell: ye, labelGrid: be, labelMonthDropdown: Ue, labelNav: ct, labelPrevious: Lt, labelNext: Mn, labelWeekday: Dn, labelWeekNumber: co, labelWeekNumberHeader: uo, labelYearDropdown: mo } = r, fo = St(() => J0(s, t.ISOWeek), [s, t.ISOWeek]), An = c !== void 0 || h !== void 0, qt = F(() => {
    L && (B(L), N?.(L));
  }, [L, B, N]), Nt = F(() => {
    P && (B(P), w?.(P));
  }, [B, P, w]), ho = F((ie, pe) => (oe) => {
    oe.preventDefault(), oe.stopPropagation(), ne(ie), U?.(ie.date, pe, oe), h?.(ie.date, pe, oe);
  }, [U, h, ne]), po = F((ie, pe) => (oe) => {
  ...
  return X.createElement(
    ...
    X.createElement(
      n.Root,
      { rootRef: t.animate ? wo : void 0, className: Rr, style: vo, dir: t.dir, id: t.id, lang: t.lang, nonce: t.nonce, title: t.title, role: t.role, "aria-label": t["aria-label"], "aria-labelledby": t["aria-labelledby"], ...Or },
      X.createElement(
        n.Months,
        { className: i[te.Months], style: y?.[te.Months] },
        !t.hideNavigation && !u && X.createElement(n.Nav, { "data-animated-nav": t.animate ? "true" : void 0, className: i[te.Nav], style: y?.[te.Nav], "aria-label": ct(), onPreviousClick: qt, onNextClick: Nt, previousMonth: L, nextMonth: P }),
        _.map((ie, pe) => X.createElement(
          ...
          u === "around" && !t.hideNavigation && pe === 0 && X.createElement(
            ...
            { type: "button", className: i[te.PreviousMonthButton], tabIndex: L ? void 0 : -1, "aria-disabled": L ? void 0 : !0, "aria-label": Lt(L), onClick: qt, "data-animated-button": t.animate ? "true" : void 0 },
          ...
          X.createElement(n.MonthCaption, { "data-animated-caption": t.animate ? "true" : void 0, className: i[te.MonthCaption], style: y?.[te.MonthCaption], calendarMonth: ie, displayIndex: pe }, l?.startsWith("dropdown") ? X.createElement(
            ...
            (() => {
              const oe = l === "dropdown" || l === "dropdown-months" ? X.createElement(n.MonthsDropdown, { key: "month", className: i[te.MonthsDropdown], "aria-label": Ue(), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: Lr(ie.date), options: Z0(ie.date, H, V, o, s), style: y?.[te.Dropdown], value: s.getMonth(ie.date) }) : X.createElement("span", { key: "month" }, k(ie.date, s)), me = l === "dropdown" || l === "dropdown-years" ? X.createElement(n.YearsDropdown, { key: "year", className: i[te.YearsDropdown], "aria-label": mo(s.options), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: Ir(ie.date), options: eN(H, V, o, s, !!t.reverseYears), style: y?.[te.Dropdown], value: s.getYear(ie.date) }) : X.createElement("span", { key: "year" }, A(ie.date, s));
          ...
          pe === d - 1 && u === "after" && !t.hideNavigation && X.createElement(n.Nav, { "data-animated-nav": t.animate ? "true" : void 0, className: i[te.Nav], style: y?.[te.Nav], "aria-label": ct(), onPreviousClick: qt, onNextClick: Nt, previousMonth: L, nextMonth: P }),
          X.createElement(
            n.MonthGrid,
            ...
            !t.hideWeekdays && X.createElement(
              ...
              E && X.createElement(n.WeekNumberHeader, { "aria-label": uo(s.options), className: i[te.WeekNumberHeader], style: y?.[te.WeekNumberHeader], scope: "col" }, x()),
              fo.map((oe) => X.createElement(n.Weekday, { "aria-label": Dn(oe, s.options, s), className: i[te.Weekday], key: String(oe), style: y?.[te.Weekday], scope: "col" }, M(oe, s.options, s)))
            ),
            X.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: i[te.Weeks], style: y?.[te.Weeks] }, ie.weeks.map((oe) => X.createElement(
              ...
              X.createElement(n.WeekNumber, { week: oe, style: y?.[te.WeekNumber], "aria-label": co(oe.weekNumber, {
                locale: a
              }), className: i[te.WeekNumber], scope: "row", role: "rowheader" }, D(oe.weekNumber, s)),
              oe.days.map((me) => {
                const { date: Te } = me, de = G(me);
                if (de[ge.focused] = !de.hidden && !!J?.isEqualTo(me), de[Xe.selected] = W?.(Te) || de.selected, yi(K)) {
                  const { from: Qt, to: It } = K;
                  de[Xe.range_start] = !!(Qt && It && s.isSameDay(Te, Qt)), de[Xe.range_end] = !!(Qt && It && s.isSameDay(Te, It)), de[Xe.range_middle] = ft(K, Te, !0, s);
                }
                const Xt = Q0(de, y, t.modifiersStyles), Zt = H0(de, i, t.modifiersClassNames), Br = !An && !de.hidden ? ye(Te, de, s.options, s) : void 0;
                return (
                  // biome-ignore lint/a11y/useSemanticElements: react component
                  X.createElement(n.Day, { key: `${s.format(Te, "yyyy-MM-dd")}_${s.format(me.displayMonth, "yyyy-MM")}`, day: me, modifiers: de, className: Zt.join(" "), style: Xt, role: "gridcell", "aria-selected": de.selected || void 0, "aria-label": Br, "data-day": s.format(Te, "yyyy-MM-dd"), "data-month": me.outside ? s.format(Te, "yyyy-MM") : void 0, "data-selected": de.selected || void 0, "data-disabled": de.disabled || void 0, "data-hidden": de.hidden || void 0, "data-outside": me.outside || void 0, "data-focused": de.focused || void 0, "data-today": de.today || void 0 }, !de.hidden && An ? X.createElement(n.DayButton, { className: i[te.DayButton], style: y?.[te.DayButton], type: "button", day: me, modifiers: de, disabled: de.disabled || void 0, tabIndex: O(me) ? 0 : -1, "aria-label": ue(Te, de, s.options, s), onClick: ho(me, de), onBlur: go(me, de), onFocus: po(me, de), onKeyDown: bo(me, de), onMouseEnter: Ar(me, de), onMouseLeave: Pr(me, de) }, S(Te, s.options, s)) : !de.hidden && S(me.date, s.options, s))
                );
              })
            )))
          )
...
let fn = null;
const nd = /* @__PURE__ */ new Map(), HN = /* @__PURE__ */ new Map();
function Jo() {
  if (!fn) return;
  const e = fn;
  fn = null, setTimeout(() => {
...
function UN({ node: e, updateAttributes: t, selected: n }) {
  const o = Y(null), r = e.attrs.date || hn(), s = od(r), a = ki(r), i = F(() => {
    if (!o.current) return "";
...
const jN = new De("datePillPaste"), VN = pr.create({
  ...
  renderHTML({ node: e, HTMLAttributes: t }) {
    const n = e.attrs.date, o = od(n), r = ki(n);
    return [
      "span",
      Nn(this.options.HTMLAttributes, t, {
        "data-type": "date-pill",
...
function KN({ node: e, selected: t, editor: n, getPos: o, deleteNode: r }) {
  ...
  return c ? /* @__PURE__ */ m(er, { as: "span", className: "inline", children: /* @__PURE__ */ m(
    "span",
    {
      ...
      "data-tag": i,
      children: [
        /* @__PURE__ */ m(Yi, { size: 14, className: "tag-icon", strokeWidth: 2.5 }, void 0, !1, {
...
function Is(e, t) {
  ...
  return e.descendants((r, s) => {
    if (r.type.name === "heading" && t.includes(r.attrs.level)) {
      ...
      o.set(l, c + 1), n.set(s, id(a, i, c));
    }
  }), n;
}
function Uo(e, t, n, o) {
  const r = [], s = Is(e, n.levels), a = [];
  e.descendants((u, d) => {
    ...
    return {
      toggleHeadingCollapse: (e) => ({ editor: t, tr: n }) => {
        ...
        if (!r || r.type.name !== "heading")
          return !1;
        const a = Is(n.doc, this.options.levels).get(e);
      ...
      collapseAllHeadings: () => ({ editor: e, tr: t }) => {
        const n = this.storage;
        return Is(t.doc, this.options.levels).forEach((r) => {
        ...
        state: {
          init(o, r) {
            return {
              ...
              docVersion: 0,
              headingFingerprint: Ka(r.doc, t.levels)
            };
          },
          apply(o, r, s, a) {
            if (o.getMeta("collapsibleHeading"))
              return {
                ...
                docVersion: r.docVersion + 1,
                headingFingerprint: Ka(a.doc, t.levels)
              };
            if (o.docChanged) {
...
}), ak = /\[([^\]]+)\]\(([^)]+)\)$/, lk = /^(https?:\/\/|www\.)[^\s]+$/i, ck = _e.create({
...
}), Yo = new De("searchHighlight"), dk = _e.create({
            ...
            if (n.key === "Enter") {
              ...
              for (const c of hk)
                if (i === `\`\`\`${c}`) {
                  ...
                  if (f && h) {
                    const g = h.create(), p = f.create({ type: c }, Tl.from(g));
                    u.insert(d, p);
...
function Dk(e, t, n) {
  let o = !1;
  return e.nodesBetween(t, n, (r) => ad.has(r.type.name) ? (o = !0, !1) : !0), o;
}
function Ak(e, t, n) {
  const o = [];
  let r = t, s = n;
  ...
  addCommands() {
    return {
      ...
      selectAllOccurrences: (e) => ({ editor: t, tr: n, dispatch: o }) => {
        ...
        if (!r) return !1;
        const l = qa(t.state.doc, r, s, a, i);
...
}), Hk = new De("linkBoundary"), Wk = _e.create({
  name: "linkBoundary",
  addProseMirrorPlugins() {
    return [
      new Me({
...
}), Fk = new De("smartCopyPaste"), cd = /* @__PURE__ */ new Set(["codeBlock", "callout"]);
function Xa(e) {
  const { state: t } = e, { selection: n } = t, { $from: o, $to: r } = n;
  for (let s = o.depth; s > 0; s--) {
    const a = o.node(s);
    if (!cd.has(a.type.name)) continue;
...
`);
              ...
              const h = f.map((p) => p === "" ? u.create() : u.create(null, c.text(p))), g = Tl.from(h);
              return new Ur(g, 0, 0);
            } else {
    ...
    "div",
    {
      ...
      children: [
        ...
        e === "saving" && /* @__PURE__ */ m(we, { children: [
          /* @__PURE__ */ m(Nl, { className: "w-3.5 h-3.5 text-cyan-500 animate-spin" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/AutoSaveIndicator.tsx",
            lineNumber: 47,
            columnNumber: 11
          }, this),
        ...
        /* @__PURE__ */ m("div", { className: "flex items-center gap-3 flex-shrink-0", children: [
          /* @__PURE__ */ m(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ m(Gs, { className: "w-4 h-4" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/RecoveryBanner.tsx",
                  lineNumber: 33,
                  columnNumber: 11
                }, this),
...
`);
  ...
  if (!n || n.length === 0) {
    for (let l = 0; l < s.length; l++) {
      ...
      let f = a;
      for (const h of d)
        h.start > f && (r += Ut(e.substring(f, h.start))), r += `<span class="${el(h.type)}">${Ut(h.content)}</span>`, f = h.end;
      f < u && (r += Ut(e.substring(f, u))), l < s.length - 1 && (r += `
`), a = u + 1;
    }
    return r;
  }
  ...
  for (let l = 0; l < s.length; l++) {
    ...
    let f = a;
    for (const h of d)
      h.start > f && (r += fs(e, f, h.start, null, i)), r += fs(e, h.start, h.end, el(h.type), i), f = h.end;
  ...
  for (; a < n; ) {
    ...
    if (i) {
      ...
      for (; a < n && r.get(a)?.matchIdx === i.matchIdx; )
        a++;
      const c = Ut(e.substring(l, a)), u = i.isCurrent ? "search-highlight search-highlight-current" : "search-highlight";
      o ? s += `<span class="${o}"><mark class="${u}">${c}</mark></span>` : s += `<mark class="${u}">${c}</mark>`;
    } else {
      const l = a;
      for (; a < n && !r.has(a); )
        a++;
      const c = Ut(e.substring(l, a));
  ...
  return /* @__PURE__ */ m("div", { ref: d, className: `syntax-highlighted-editor ${s}`, children: [
    /* @__PURE__ */ m(
      "div",
      {
        ...
        dangerouslySetInnerHTML: { __html: N || `<span class="md-placeholder">${Ut(n)}</span>` },
        "aria-hidden": "true"
      },
      void 0,
      !1,
  ...
  q(() => {
    ...
    const x = (M) => {
      ...
      if (c.current = M, l.current.push({ time: M, duration: A }), l.current.length > 120 && (l.current = l.current.slice(-120)), A > 16.67 && d.current++, S++, M - k >= 1e3) {
        D = S, S = 0, k = M;
        const I = l.current.slice(-60), R = I.length > 0 ? I.reduce((W, U) => W + U.duration, 0) / I.length : 0, _ = I.length > 0 ? Math.max(...I.map((W) => W.duration)) : 0, H = performance.memory, V = H ? H.usedJSHeapSize / (1024 * 1024) : 0, L = H ? H.jsHeapSizeLimit / (1024 * 1024) : 0, P = document.querySelectorAll("*").length, B = tl - f.current, G = Rs - h.current;
        f.current = tl, h.current = Rs, i({
          fps: D,
          ...
          renderCount: B,
          transactionCount: G,
          lastTransactionTime: Math.round(dd * 100) / 100,
          domNodes: P,
  ...
  return /* @__PURE__ */ m("div", { className: "perf-profiler-overlay", children: [
    /* @__PURE__ */ m("div", { className: "perf-profiler-header", children: [
      ...
      /* @__PURE__ */ m("div", { className: "perf-profiler-actions", children: [
        /* @__PURE__ */ m("button", { onClick: N, title: r ? "Expand" : "Minimize", children: r ? /* @__PURE__ */ m(kl, { size: 12 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 246,
          columnNumber: 28
        }, this) : /* @__PURE__ */ m(xl, { size: 12 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 246,
          columnNumber: 54
        }, this) }, void 0, !1, {
        ...
        t && /* @__PURE__ */ m("div", { className: "w-full max-w-xs", children: [
          /* @__PURE__ */ m(
            "button",
            {
              ...
              children: [
                n ? /* @__PURE__ */ m(eo, { className: "w-3 h-3" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                  lineNumber: 193,
                  columnNumber: 21
...
const Be = ({ onMouseDown: e, isActive: t, disabled: n, children: o, title: r }) => /* @__PURE__ */ m(
...
], Sx = yt(function({ editor: t, isH1: n, isH2: o, isH3: r, isH4: s, isH5: a, executeCommand: i }) {
  const [l, c] = j(!1), u = Y(null), d = n ? "h1" : o ? "h2" : r ? "h3" : s ? "h4" : a ? "h5" : "paragraph", f = nl.find((g) => g.value === d)?.shortLabel || "P";
  q(() => {
    if (!l) return;
    const g = (p) => {
    ...
    /* @__PURE__ */ m(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ m(eo, { size: 12, strokeWidth: 2.5, className: `flex-shrink-0 transition-transform duration-150 ${l ? "rotate-180" : ""}` }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
            lineNumber: 149,
            columnNumber: 9
          }, this)
...
}), Mx = yt(function({ onCopy: t, iconSize: n }) {
...
}), Dx = yt(function({ editor: t, className: n = "", suppressWhenLinkPopoverOpen: o = !1, aiEnabled: r = !1, onAISparklesClick: s, onCopySelectionAsMarkdown: a }) {
  const i = Y(null), l = ul({
    editor: t,
    selector: ({ editor: x }) => ({
      ...
      children: [
        /* @__PURE__ */ m(
          Be,
          {
            ...
            isActive: l?.isBold,
            title: "Bold (Ctrl+B)",
            children: /* @__PURE__ */ m($s, { size: k }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 511,
              columnNumber: 9
            }, this)
  ...
  return /* @__PURE__ */ m(Pt, { onMouseDown: S, children: D }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
    lineNumber: 642,
    columnNumber: 5
  }, this);
...
function Ax({ editor: e, isOpen: t, onClose: n }) {
  ...
  return /* @__PURE__ */ m(Pt, { children: h }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkPopover.tsx",
    lineNumber: 161,
    columnNumber: 10
  }, this);
...
function Lx({ editor: e, onEditLink: t }) {
  ...
  return /* @__PURE__ */ m(Pt, { children: E }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkHoverTooltip.tsx",
    lineNumber: 385,
    columnNumber: 10
  }, this);
...
const Ix = [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ m(vl, { size: 16, className: "text-green-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 167,
      columnNumber: 11
    }, void 0),
...
`)) {
    ...
    this
  ) : !t || w.length === 0 ? null : /* @__PURE__ */ m(Pt, { children: /* @__PURE__ */ m(
    "div",
    {
      ref: p,
      ...
      children: [
        ...
        D && /* @__PURE__ */ m(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ m("span", { className: "wikilink-icon", children: /* @__PURE__ */ m(Ks, { size: 14 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/WikiLinkAutocomplete.tsx",
                lineNumber: 401,
                columnNumber: 13
              }, this) }, void 0, !1, {
...
function Yx({
  ...
  return /* @__PURE__ */ m(Pt, { children: p }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
    lineNumber: 213,
    columnNumber: 10
  }, this);
...
function Kx({ actions: e, scope: t, onAction: n, onClose: o, position: r }) {
        ...
        `,
          children: [
            /* @__PURE__ */ m("div", { className: "px-2 py-1.5", children: /* @__PURE__ */ m("div", { className: "flex items-center gap-2 bg-secondary/50 rounded-md px-2.5 py-1.5 border border-border/50", children: [
              /* @__PURE__ */ m(Cl, { size: 14, className: "text-muted-foreground shrink-0" }, void 0, !1, {
  ...
  return /* @__PURE__ */ m(Pt, { onMouseDown: (b) => b.preventDefault(), children: p }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIDropdownMenu.tsx",
    lineNumber: 197,
    columnNumber: 5
  }, this);
...
function Gx({
          ...
          children: [
            /* @__PURE__ */ m("div", { className: "flex items-center justify-between px-3 py-2 border-b border-border bg-secondary/30", children: [
              /* @__PURE__ */ m("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
                p && /* @__PURE__ */ m(Nl, { size: 12, className: "animate-spin" }, void 0, !1, {
  ...
  return /* @__PURE__ */ m(Pt, { onMouseDown: (y) => y.preventDefault(), children: E }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
    lineNumber: 260,
    columnNumber: 5
  }, this);
...
const sl = Xd(
  ...
  tocMinLevel: co = 1,
  tocMaxLevel: uo = 4,
  tocShowLevelIndicators: mo = !1,
  tocHighlightActive: fo = !0,
  tocTreeView: An = !1,
  tocWidth: qt = "240px",
  tocPosition: Nt = "right",
  tocScrollOffset: ho = 20,
  onTocItemClick: po,
  renderTocItem: go,
  tocShowToggleButton: bo = !0,
  // Raw markdown editor
  autoClosePairs: Ar = !0,
  ...
  enableTagAutoDetect: vo = !1,
  enableHexColorHighlight: Or = !1,
  enableCollapsibleHeadings: wo = !1,
  ...
  const [Xt] = j(() => Jx()), [Zt, Br] = j(M), [Qt, It] = j(""), yo = Y(M), No = Y(""), Pn = Y(null), [bd, xi] = j(0), ko = !!(oe && oe.length > 0 && me), { state: Ye, executeAction: xo, abort: vd, reset: kt } = Qx(me), [wd, $r] = j(null), [yd, Nd] = j({ selectionTop: 0, selectionBottom: 0, selectionCenterX: 0 }), kd = Y(me);
  kd.current = me;
  const Ci = Y(Te);
  Ci.current = Te;
  const [xd, Cd] = j([]), [Ed, Td] = j(0), Sd = F((se, xe) => {
    Cd(se), Td(xe);
  }, []), Ei = Y(y), Ti = Y(C), Si = Y(S), Mi = Y(k), Di = Y(D), Ai = Y(B), Pi = Y(G), Li = Y(W);
  Ei.current = y, Ti.current = C, Si.current = S, Mi.current = k, Di.current = D, Ai.current = B, Pi.current = G, Li.current = W;
  const Ii = 2e3, [Hr, Md] = j(() => ie === "lightweight" ? !0 : ie === "full" ? !1 : t && typeof t == "string" ? Math.ceil(t.length / 80) > Ii : !1), Dd = Y(0), Ri = Y(Hr);
  Ri.current = Hr;
  const [Wr, Co] = j(null), Ad = Zk({
    placeholder: a,
    isMobile: Xt,
    maxImageSize: E,
    headingLevels: be,
    ...
    enableCollapsibleHeadings: wo,
    enableCollapsibleLists: _r,
    enableTagAutoDetect: vo,
    enableHexColorHighlight: Or,
    isLightweight: Hr,
    setImageEditState: Co,
    callbackRefs: {
      onImageUploadStart: Ei,
      onImageUploadComplete: Ti,
      onImageUploadError: Si,
      onImageUpload: Mi,
      resolveImageSrc: Di,
      onWikiLinkClick: Ai,
      validateWikiLink: Pi
    }
  }), { editor: re, turndownService: Eo } = nx({
    extensions: Ad,
    content: t,
    editable: i,
    autofocus: l,
    ...
    isLightweightRef: Ri
  }), [Pd, To] = j(!1), [Ld, Id] = j(!1), Rd = K !== void 0 ? K : Ld, Rt = F((se) => {
    Id(se), $?.(se);
  }, [$]), [Od, So] = j(0), [_d, Bd] = j(""), Ot = nw(re, {
    storageKey: b,
    debounceMs: v,
    enabled: p,
    onSave: (se) => {
  ...
  const $d = St(() => ({
    openLinkPopover: () => To(!0),
    openFindReplace: (se) => {
      se && Bd(se), Rt(!0), So((xe) => xe + 1);
    },
  ...
  const _i = F((se, xe) => {
    ...
    if (xe) {
      ...
      Ge = { top: Ie.bottom + 4, left: Ie.left };
    } else {
      const { from: Ie, to: et } = re.state.selection, Jt = re.view.coordsAtPos(Ie), en = re.view.coordsAtPos(et);
    ...
    if (!Ge) return;
    const { from: Ie, to: et } = re.state.selection, Jt = Ie !== et ? re.state.doc.textBetween(Ie, et, `
`) : "", en = Ge.scope === "document" || !Jt ? re.getText() : Jt, Do = re.view.coordsAtPos(Ie), Ln = re.view.coordsAtPos(et);
    Nd({
      selectionTop: Do.top,
      selectionBottom: Ln.bottom,
      selectionCenterX: (Do.left + Ln.right) / 2
    }), $r(null), xo(se, Ge.label, en, { from: Ie, to: et }, xe);
  }, [re, oe, xo]), Wd = F(() => {
    if (!re || Ye.status !== "complete") return;
    const { selectionRange: se, result: xe } = Ye;
    re.chain().focus().setTextSelection(se).deleteSelection().insertContent(xe).run(), kt();
  }, [re, Ye, kt]), Fd = F(() => {
    if (!re || Ye.status !== "complete") return;
    const { selectionRange: se, result: xe } = Ye;
...
` + xe).run(), kt();
    ...
    if (!(Ye.status !== "complete" && Ye.status !== "error"))
      if (Ye.status === "complete") {
        const { action: se, actionLabel: xe, inputText: Ge, selectionRange: Ie } = Ye;
        kt(), xo(se, xe, Ge, Ie);
      } else
        kt();
  }, [Ye, kt, xo]), Bi = F(() => {
    ...
    let Ie, et;
    if (Ge)
      Ie = re.getHTML(), et = re.getText();
    else {
      const en = re.state.doc.slice(se, xe), Do = Km.fromSchema(re.schema), Ln = document.createElement("div"), zr = Do.serializeFragment(en.content);
      Ln.appendChild(zr), Ie = Ln.innerHTML, et = re.state.doc.textBetween(se, xe, `
`);
    }
    const Jt = zn(Eo.turndown(Ie));
  ...
  const $i = /* @__PURE__ */ m(
    Xv,
    {
      ...
      aiEnabled: ko || !!Te,
      onAISparklesClick: (se) => _i("document", se)
    },
    void 0,
    !1,
    {
    ...
    this
  ), Hi = /* @__PURE__ */ m("div", { className: "editor-footer", children: [
    p && /* @__PURE__ */ m(
      wx,
      {
        status: Ot.status,
  ...
  return /* @__PURE__ */ m("div", { className: `markdown-editor-container ${g === "neutral" ? "color-theme-neutral" : ""} ${c}`, "data-theme": h, children: [
    p && w && Ot.hasRecoverableContent && /* @__PURE__ */ m(
      yx,
      {
        onRecover: () => {
          Ot.recover();
    ...
    !Xt && /* @__PURE__ */ m(
      Zv,
      {
        ...
        onClose: () => Rt(!1),
        focusTrigger: Od,
        initialSearchQuery: _d,
        editorMode: Zt,
        rawMarkdown: Qt,
        onRawMarkdownChange: Oi,
        onMatchesChange: Sd
      },
      void 0,
      !1,
    ...
    /* @__PURE__ */ m("div", { className: `editor-main-area ${ct ? "editor-with-toc" : ""}`, children: [
      ct && Nt === "left" && /* @__PURE__ */ m(Wi, { fallback: null, children: /* @__PURE__ */ m(
        sl,
        {
          editor: re,
          visible: Lt,
      ...
      /* @__PURE__ */ m(
        Cx,
        {
          ...
          onRetry: () => xi((se) => se + 1),
          onClearContent: () => {
            re && re.commands.clearContent(), n?.(""), o?.(""), r?.(""), xi((se) => se + 1);
          },
          onError: pe,
          children: [
            /* @__PURE__ */ m("div", { className: "editor-content-wrapper", ref: Pn, style: Ud, children: Zt === "wysiwyg" ? /* @__PURE__ */ m(we, { children: [
              ...
              /* @__PURE__ */ m(
                qx,
                {
                  ...
                  aiEnabled: ko,
                  onAISetupRequired: Te,
                  onAISparklesClick: (se) => _i("selection", se),
                  ...
                  onLinkPopoverClose: () => To(!1),
                  onEditLink: () => To(!0),
                  onWikiLinkSearch: Li.current,
                  imageEditState: Wr,
                  onImageSave: (se, xe) => {
                  ...
                  onImageDelete: () => {
                    re.chain().focus().setNodeSelection(Wr.pos).deleteSelection().run(), Co(null);
                  },
                  onImageEditClose: () => Co(null)
                },
                void 0,
                !1,
                {
      ...
      ct && Nt === "right" && /* @__PURE__ */ m(Wi, { fallback: null, children: /* @__PURE__ */ m(
        sl,
        {
          editor: re,
          visible: Lt,
    ...
    d && (O ? O(
      { words: Mo.words, characters: Mo.characters },
      Ot.status,
      Hi
    ) : Hi),
...
function nC({
  ...
  const [o, r] = j(t), s = Fn[o] || Fn.dark, a = F((l) => {
    Fn[l] && r(l);
  }, []);
  q(() => {
  ...
  return /* @__PURE__ */ m(fd.Provider, { value: i, children: e }, void 0, !1, {
  ...
  return /* @__PURE__ */ m(er, { className: "code-block-wrapper", children: [
    /* @__PURE__ */ m("div", { className: "code-block-controls", contentEditable: !1, children: [
      /* @__PURE__ */ m("div", { className: "code-block-language-wrapper", children: [
        ...
        /* @__PURE__ */ m(eo, { size: 12, className: "code-block-language-chevron" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/CodeBlockComponent.tsx",
          lineNumber: 69,
          columnNumber: 11
        }, this)
...
const hd = "paragon-editor-toc-width", r1 = 280, pd = 200, gd = 500, Bn = 30, al = 5;
function ll() {
  try {
    const e = localStorage.getItem(hd);
    if (e) {
      const t = parseInt(e, 10);
      if (!isNaN(t) && t >= pd && t <= gd)
        return t;
    }
  } catch {
  }
...
const Os = yt(function({
  ...
  }, []), h = t.length * Bn, g = Math.max(0, Math.floor(l / Bn) - al), p = Math.min(
    t.length,
    Math.ceil((l + u) / Bn) + al
  ), b = St(() => {
    const v = [];
  ...
  return t.length < 30 ? /* @__PURE__ */ m(we, { children: t.map((v) => /* @__PURE__ */ m(
    Os,
    {
      item: v,
      isActive: n === v.id,
  ...
  q(() => {
    const O = (ne) => {
      if (!R.current) return;
      const ue = f === "right" ? _.current - ne.clientX : ne.clientX - _.current, ye = Math.min(gd, Math.max(pd, H.current + ue));
      M(ye);
    }, ee = () => {
  ...
  q(() => {
    ...
    const ee = () => {
      ...
      for (let Ue = w.length - 1; Ue >= 0; Ue--) {
        const ct = w[Ue], Lt = cl(t, ct.pos);
        if (Lt && Lt.getBoundingClientRect().top - ye.top <= h + 10) {
          be = ct.id;
          break;
        }
      }
  ...
  const B = F((O) => {
    ...
    const ne = E === O.id, ue = O.children && O.children.length > 0, ye = k.has(O.id);
...
export {
  ...
  md as darkTheme,
  ki as getDateVariant,
  cn as isValidTag,
  e1 as lightTheme,
  xf as loadCoreLanguages,
  qi as loadLanguageIfNeeded,
  We as lowlight,
  n1 as nordTheme,
  jn as normalizeTag,
