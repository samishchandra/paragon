...
import { useEditorState as dl, NodeViewWrapper as Jr, ReactNodeViewRenderer as ul, useEditor as Yu, EditorContent as ju, NodeViewContent as Vu } from "@tiptap/react";
import * as T from "react";
import X, { useState as j, useRef as Y, useEffect as q, useLayoutEffect as fo, memo as wt, useCallback as F, useImperativeHandle as Ku, createContext as fl, useContext as pl, useMemo as St, Component as Gu, useReducer as qu, lazy as Xu, forwardRef as Zu, Suspense as Wa } from "react";
import Qu from "@tiptap/extension-code-block-lowlight";
import { createLowlight as Ju } from "lowlight";
import { Image as _s, X as gt, Link2 as $s, Type as po, Copy as bn, Undo as ef, Redo as tf, Bold as Hs, Italic as Bs, Underline as Ws, Strikethrough as zs, Code as hl, Highlighter as ml, Link as Fs, ChevronDown as er, List as Us, ListOrdered as Ys, CheckSquare as js, Quote as Vs, FileCode as gl, IndentIncrease as nf, IndentDecrease as rf, Table as ms, Minus as yl, Info as gs, BookOpen as vl, PenLine as of, Library as sf, ListTodo as bl, Columns as za, Trash2 as dn, Rows as Fa, ToggleLeft as Ua, ArrowUpDown as af, Sparkles as ho, Search as lf, ChevronUp as cf, MousePointerClick as df, CaseSensitive as uf, WholeWord as ff, Regex as pf, Replace as ys, ReplaceAll as hf, Plus as Ks, ChevronLeftIcon as mf, ChevronRightIcon as gf, ChevronDownIcon as yf, Calendar as wl, Hash as Ya, Cloud as vf, Loader2 as xl, Check as wn, CloudOff as bf, AlertCircle as wf, RotateCcw as Gs, Activity as xf, Maximize2 as kl, Minimize2 as Cl, AlertTriangle as kf, ChevronRight as Cf, CheckCircle2 as Ef, Eye as Mf, FileText as qs, ExternalLink as Tf, Pencil as Sf, Unlink as Df, Heading1 as Nf, Heading2 as Lf, Heading3 as Af, Heading4 as If, Heading5 as Rf, Code2 as Pf, StickyNote as Of, MessageSquareText as _f, ImagePlus as $f, MessageSquare as El, RefreshCw as Hf, SpellCheck as Bf, PanelRightClose as Wf, PanelRightOpen as zf } from "lucide-react";
import * as Ml from "react-dom";
import Ff, { createPortal as Uf } from "react-dom";
import { TextSelection as Ve, Plugin as De, PluginKey as Ne, NodeSelection as Yf, AllSelection as jf } from "@tiptap/pm/state";
import { Fragment as Tl, Slice as Uo, DOMSerializer as Vf } from "@tiptap/pm/model";
...
import { Extension as _e, Node as mo, mergeAttributes as xn, InputRule as Oe, Mark as Sl } from "@tiptap/core";
...
import { findWrapping as ja, canJoin as ip } from "@tiptap/pm/transform";
...
}, Nr = /* @__PURE__ */ new Set(), Lr = /* @__PURE__ */ new Set();
let Ga = !1, Rn = null;
async function xp() {
  if (!Ga)
    return Rn || (Rn = (async () => {
      try {
        ...
        for (const [n, r] of Object.entries(Nl))
          if (!We.registered(n)) {
...
async function qa(e) {
  ...
  if (Nr.has(e))
    return new Promise((n) => {
      const r = () => {
        Lr.has(e) ? n(!0) : Nr.has(e) ? setTimeout(r, 50) : n(!1);
      };
      setTimeout(r, 50);
    });
  Nr.add(e);
...
function Ar(e, t, n) {
  const r = document.createElementNS(Xa, "svg");
  ...
  for (const o of e) {
    const s = document.createElementNS(Xa, "path");
...
class Mp {
  ...
  update(t) {
    ...
    return this.node = t, n !== r && (this.labelEl.textContent = this.formatLanguageLabel(r), this.selectEl.value = r, r === "plaintext" ? this.setLanguageReady(!0) : We.registered(r) ? this.setLanguageReady(!0) : this.isVisible && (this.setLanguageReady(!1), qa(r).then((o) => {
      ...
      children: [
        /* @__PURE__ */ I("div", { className: "image-url-dialog-header", children: [
          /* @__PURE__ */ I("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ h(_s, { size: 16, className: "text-primary" }),
...
}, Dp = T[" useInsertionEffect ".trim().toString()] || Dt;
function Zs({
  prop: e,
  defaultProp: t,
  onChange: n = () => {
...
var Wp = "DismissableLayer", vs = "dismissableLayer.update", zp = "dismissableLayer.pointerDownOutside", Fp = "dismissableLayer.focusOutside", Ja, _l = T.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: a,
      ...l
    } = e, c = T.useContext(_l), [d, u] = T.useState(null), f = d?.ownerDocument ?? globalThis?.document, [, p] = T.useState({}), g = Ie(t, (S) => u(S)), m = Array.from(c.layers), [y] = [...c.layersWithOutsidePointerEventsDisabled].slice(-1), v = m.indexOf(y), b = d ? m.indexOf(d) : -1, x = c.layersWithOutsidePointerEventsDisabled.size > 0, M = b >= v, w = jp((S) => {
    ...
    return Bp((S) => {
      ...
      if (d)
        return n && (c.layersWithOutsidePointerEventsDisabled.size === 0 && (Ja = f.body.style.pointerEvents, f.body.style.pointerEvents = "none"), c.layersWithOutsidePointerEventsDisabled.add(d)), c.layers.add(d), ei(), () => {
          n && c.layersWithOutsidePointerEventsDisabled.size === 1 && (f.body.style.pointerEvents = Ja);
        };
    }, [d, f, n, c]), T.useEffect(() => () => {
      d && (c.layers.delete(d), c.layersWithOutsidePointerEventsDisabled.delete(d), ei());
    }, [d, c]), T.useEffect(() => {
      const S = () => p({});
...
var Up = "DismissableLayerBranch", Yp = T.forwardRef((e, t) => {
  const n = T.useContext(_l), r = T.useRef(null), o = Ie(t, r);
  return T.useEffect(() => {
    const s = r.current;
    if (s)
...
function Vp(e, t = globalThis?.document) {
  ...
  return T.useEffect(() => {
    const o = (s) => {
      s.target && !r.current && $l(Fp, n, { originalEvent: s }, {
        discrete: !1
      });
    };
...
function Kp() {
  T.useEffect(() => {
    ...
    return document.body.insertAdjacentElement("afterbegin", e[0] ?? ti()), document.body.insertAdjacentElement("beforeend", e[1] ?? ti()), Yo++, () => {
...
var jo = "focusScope.autoFocusOnMount", Vo = "focusScope.autoFocusOnUnmount", ni = { bubbles: !1, cancelable: !0 }, Gp = "FocusScope", Hl = T.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: o,
    ...
    ...i
  } = e, [a, l] = T.useState(null), c = yt(o), d = yt(s), u = T.useRef(null), f = Ie(t, (m) => l(m)), p = T.useRef({
    paused: !1,
    pause() {
      this.paused = !0;
    },
  ...
  T.useEffect(() => {
    ...
    if (a) {
      ...
      if (!a.contains(m)) {
        const v = new CustomEvent(jo, ni);
        a.addEventListener(jo, c), a.dispatchEvent(v), v.defaultPrevented || (qp(eh(Bl(a)), { select: !0 }), document.activeElement === m && Tt(a));
      }
      return () => {
        a.removeEventListener(jo, c), setTimeout(() => {
          const v = new CustomEvent(Vo, ni);
          a.addEventListener(Vo, d), a.dispatchEvent(v), v.defaultPrevented || Tt(m ?? document.body, { select: !0 }), a.removeEventListener(Vo, d), oi.remove(p);
        }, 0);
      };
    }
  }, [a, c, d, p]);
...
function Xp(e) {
  const t = Bl(e), n = ri(t, e), r = ri(t.reverse(), e);
  return [n, r];
}
function Bl(e) {
...
const rh = ["top", "right", "bottom", "left"], Nt = Math.min, Be = Math.max, to = Math.round, Ir = Math.floor, st = (e) => ({
  x: e,
  y: e
}), oh = {
  left: "right",
...
const ai = ["left", "right"], ii = ["right", "left"], ch = ["top", "bottom"], dh = ["bottom", "top"];
function uh(e, t, n) {
  switch (e) {
    case "top":
    case "bottom":
...
function li(e, t, n) {
  ...
  const s = rt(t), i = ta(t), a = ea(i), l = bt(t), c = s === "y", d = r.x + r.width / 2 - o.width / 2, u = r.y + r.height / 2 - o.height / 2, f = r[a] / 2 - o[a] / 2;
  let p;
  switch (l) {
    case "top":
      p = {
...
async function Kn(e, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: p = 0
  } = vt(t, e), g = Wl(p), y = a[f ? u === "floating" ? "reference" : "floating" : u], v = ro(await s.getClippingRect({
...
const mh = (e) => ({
  ...
  async fn(t) {
    ...
    const u = Wl(d), f = {
      x: n,
      y: r
    }, p = ta(o), g = ea(p), m = await i.getDimensions(c), y = p === "y", v = y ? "top" : "left", b = y ? "bottom" : "right", x = y ? "clientHeight" : "clientWidth", M = s.reference[g] + s.reference[p] - f[p] - s.floating[g], w = f[p] - s.reference[p], E = await (i.getOffsetParent == null ? void 0 : i.getOffsetParent(c));
    let S = E ? E[x] : 0;
    (!S || !await (i.isElement == null ? void 0 : i.isElement(E))) && (S = a.floating[x] || s.floating[g]);
    const k = M / 2 - w / 2, N = S / 2 - m[g] / 2 - 1, C = Nt(u[v], N), D = Nt(u[b], N), L = C, P = S - m[g] - D, O = S / 2 - m[g] / 2 + k, $ = bs(L, O, P), W = !l.arrow && Cn(o) != null && O !== $ && s.reference[g] / 2 - (O < L ? C : D) - m[g] / 2 < 0, V = W ? O < L ? O - L : O - P : 0;
    return {
      [p]: f[p] + V,
      data: {
        [p]: $,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const v = bt(o), b = rt(a), x = bt(a) === a, M = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), w = f || (x || !m ? [no(a)] : lh(a)), E = g !== "none";
...
async function vh(e, t) {
  const {
    ...
    platform: r,
    elements: o
  } = e, s = await (r.isRTL == null ? void 0 : r.isRTL(o.floating)), i = bt(n), a = Cn(n), l = rt(n) === "y", c = zl.has(i) ? -1 : 1, d = s && l ? -1 : 1, u = vt(t, e);
  let {
    mainAxis: f,
    crossAxis: p,
    alignmentAxis: g
...
const bh = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: n,
        y: r
      }, d = await Kn(t, l), u = rt(bt(o)), f = Js(u);
      let p = c[f], g = c[u];
      if (s) {
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (c) {
        var v, b;
        const x = f === "y" ? "width" : "height", M = zl.has(bt(o)), w = s.reference[u] - s.floating[x] + (M && ((v = i.offset) == null ? void 0 : v[u]) || 0) + (M ? 0 : y.crossAxis), E = s.reference[u] + s.reference[x] + (M ? 0 : ((b = i.offset) == null ? void 0 : b[u]) || 0) - (M ? y.crossAxis : 0);
        g < w ? g = w : g > E && (g = E);
      }
      return {
        [f]: p,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      const {
        ...
        ...c
      } = vt(e, t), d = await Kn(t, c), u = bt(o), f = Cn(o), p = rt(o) === "y", {
        width: g,
        height: m
      } = s.floating;
      let y, v;
      ...
      if ((n = t.middlewareData.shift) != null && n.enabled.x && (k = x), (r = t.middlewareData.shift) != null && r.enabled.y && (S = b), E && !f) {
        const C = Be(d.left, 0), D = Be(d.right, 0), L = Be(d.top, 0), P = Be(d.bottom, 0);
        p ? k = g - 2 * (C !== 0 || D !== 0 ? C + D : Be(d.left, d.right)) : S = m - 2 * (L !== 0 || P !== 0 ? L + P : Be(d.top, d.bottom));
      }
      await l({
        ...t,
        availableWidth: k,
...
function Ul(e) {
  const t = Lt(e);
  return gn(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : at(t) && tr(t) ? t : Ul(t);
}
function Gn(e, t, n) {
  var r;
  t === void 0 && (t = []), n === void 0 && (n = !0);
  const o = Ul(e), s = o === ((r = e.ownerDocument) == null ? void 0 : r.body), i = ze(o);
  if (s) {
    const a = xs(i);
...
function Yl(e) {
  ...
  const o = at(e), s = o ? e.offsetWidth : n, i = o ? e.offsetHeight : r, a = to(n) !== s || to(r) !== i;
  return a && (n = s, r = i), {
    width: n,
    height: r,
    $: a
...
function Ph(e) {
  ...
  const d = st(0), u = at(r);
  if ((u || !u && !s) && ((En(r) !== "body" || tr(i)) && (l = bo(r)), at(r))) {
    const p = jt(r);
    c = un(r), d.x = p.x + r.clientLeft, d.y = p.y + r.clientTop;
  }
  const f = i && !u && !s ? Vl(i, l) : st(0);
  return {
    width: n.width * c.x,
    height: n.height * c.y,
...
function Bh(e, t) {
  const n = jt(e, !0, t === "fixed"), r = n.top + e.clientTop, o = n.left + e.clientLeft, s = at(e) ? un(e) : st(1), i = e.clientWidth * s.x, a = e.clientHeight * s.y, l = o * s.x, c = r * s.y;
  return {
    width: i,
    height: a,
    x: l,
...
function Kl(e, t) {
  const n = Lt(e);
  return n === t || !Qe(n) || gn(n) ? !1 : Je(n).position === "fixed" || Kl(n, t);
}
function Wh(e, t) {
  const n = t.get(e);
  if (n)
  ...
  for (; Qe(i) && !gn(i); ) {
    const a = Je(i), l = na(i);
    !l && a.position === "fixed" && (o = null), (s ? !l && !o : !l && a.position === "static" && !!o && Hh.has(o.position) || tr(i) && !l && Kl(e, i)) ? r = r.filter((d) => d !== i) : o = a, i = Lt(i);
  }
  return t.set(e, r), r;
}
function zh(e) {
...
function Uh(e, t, n) {
  ...
  if (r || !r && !s)
    if ((En(t) !== "body" || tr(o)) && (a = bo(t)), r) {
      const p = jt(t, !0, s, t);
      l.x = p.x + t.clientLeft, l.y = p.y + t.clientTop;
    } else o && c();
  s && !r && o && c();
  const d = o && !r && !s ? Vl(o, a) : st(0), u = i.left + a.scrollLeft - l.x - d.x, f = i.top + a.scrollTop - l.y - d.y;
  return {
    x: u,
    y: f,
    width: i.width,
...
function Gl(e, t) {
  ...
  for (; r && Mh(r) && Ko(r); )
    r = hi(r, t);
  return r && gn(r) && Ko(r) && !na(r) ? n : r || Lh(e) || n;
}
const Yh = async function(e) {
  const t = this.getOffsetParent || Gl, n = this.getDimensions, r = await n(e.floating);
  return {
...
const qh = bh, Xh = wh, Zh = gh, Qh = kh, Jh = yh, mi = mh, em = xh, tm = (e, t, n) => {
...
function om(e) {
  ...
  const [g, m] = T.useState(null), [y, v] = T.useState(null), b = T.useCallback((R) => {
  ...
  }, []), M = s || g, w = i || y, E = T.useRef(null), S = T.useRef(null), k = T.useRef(d), N = l != null, C = Go(l), D = Go(o), L = Go(c), P = T.useCallback(() => {
    ...
    D.current && (R.platform = D.current), tm(E.current, S.current, R).then((A) => {
      const H = {
        ...A,
      ...
      O.current && !oo(k.current, H) && (k.current = H, Ml.flushSync(() => {
        u(H);
      }));
    });
  }, [f, t, n, D, L]);
  ...
  const $ = T.useMemo(() => ({
    ...
    if (!W.floating)
      return R;
    const A = gi(W.floating, d.x), H = gi(W.floating, d.y);
    return a ? {
      ...R,
...
var pm = "Arrow", Zl = T.forwardRef((e, t) => {
...
var sa = "Popper", [Ql, xo] = kn(sa), [gm, Jl] = Ql(sa), ec = (e) => {
...
var tc = "PopperAnchor", nc = T.forwardRef(
  (e, t) => {
    const { __scopePopper: n, virtualRef: r, ...o } = e, s = Jl(tc, n), i = T.useRef(null), a = Ie(t, i), l = T.useRef(null);
    return T.useEffect(() => {
      const c = l.current;
...
nc.displayName = tc;
var aa = "PopperContent", [ym, vm] = Ql(aa), rc = T.forwardRef(
  (e, t) => {
    const {
      __scopePopper: n,
      side: r = "bottom",
      ...
      onPlaced: g,
      ...m
    } = e, y = Jl(aa, n), [v, b] = T.useState(null), x = Ie(t, (_) => b(_)), [M, w] = T.useState(null), E = mm(M), S = E?.width ?? 0, k = E?.height ?? 0, N = r + (s !== "center" ? "-" + s : ""), C = typeof d == "number" ? d : { top: 0, right: 0, bottom: 0, left: 0, ...d }, D = Array.isArray(c) ? c : [c], L = D.length > 0, P = {
      padding: C,
      ...
      middleware: [
        ...
        dm({
          ...
          apply: ({ elements: _, rects: ee, availableWidth: ne, availableHeight: de }) => {
            const { width: we, height: ve } = ee.reference, Ue = _.floating.style;
            Ue.setProperty("--radix-popper-available-width", `${ne}px`), Ue.setProperty("--radix-popper-available-height", `${de}px`), Ue.setProperty("--radix-popper-anchor-width", `${we}px`), Ue.setProperty("--radix-popper-anchor-height", `${ve}px`);
          }
        }),
...
rc.displayName = aa;
var oc = "PopperArrow", bm = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, sc = T.forwardRef(function(t, n) {
  const { __scopePopper: r, ...o } = t, s = vm(oc, r), i = bm[s.placedSide];
  return (
...
var xm = (e) => ({
  ...
  options: e,
  fn(t) {
    const { placement: n, rects: r, middlewareData: o } = t, i = o.arrow?.centerOffset !== 0, a = i ? 0 : e.arrowWidth, l = i ? 0 : e.arrowHeight, [c, d] = ac(n), u = { start: "0%", center: "50%", end: "100%" }[d], f = (o.arrow?.x ?? 0) + a / 2, p = (o.arrow?.y ?? 0) + l / 2;
    let g = "", m = "";
...
var ic = ec, lc = nc, cc = rc, dc = sc, km = "Portal", ia = T.forwardRef((e, t) => {
...
var qo = "rovingFocusGroup.onEntryFocus", Tm = { bubbles: !1, cancelable: !0 }, nr = "RovingFocusGroup", [ks, uc, Sm] = Pl(nr), [Dm, fc] = kn(
  nr,
  [Sm]
), [Nm, Lm] = Dm(nr), pc = T.forwardRef(
...
var Am = T.forwardRef((e, t) => {
  const {
    ...
    ...u
  } = e, f = T.useRef(null), p = Ie(t, f), g = Ol(s), [m, y] = Zs({
    prop: i,
    defaultProp: a ?? null,
    onChange: l,
    caller: nr
  }), [v, b] = T.useState(!1), x = yt(c), M = uc(n), w = T.useRef(!1), [E, S] = T.useState(0);
  return T.useEffect(() => {
    const k = f.current;
    if (k)
...
}), hc = "RovingFocusGroupItem", mc = T.forwardRef(
  (e, t) => {
    const {
      __scopeRovingFocusGroup: n,
      focusable: r = !0,
      ...
      children: i,
      ...a
    } = e, l = eo(), c = s || l, d = Lm(hc, n), u = d.currentTabStopId === c, f = uc(n), { onFocusableItemAdd: p, onFocusableItemRemove: g, currentTabStopId: m } = d;
    return T.useEffect(() => {
      if (r)
        return p(), () => g();
    }, [r, p, g]), /* @__PURE__ */ h(
...
var _m = pc, $m = mc, Hm = function(e) {
  if (typeof document > "u")
    return null;
  var t = Array.isArray(e) ? e[0] : e;
  return t.ownerDocument.body;
}, tn = /* @__PURE__ */ new WeakMap(), Pr = /* @__PURE__ */ new WeakMap(), Or = {}, Xo = 0, yc = function(e) {
    ...
    !u || l.has(u) || Array.prototype.forEach.call(u.children, function(f) {
      if (a.has(f))
        ...
        try {
          ...
          tn.set(f, m), s.set(f, y), i.push(f), m === 1 && g && Pr.set(f, !0), y === 1 && f.setAttribute(n, "true"), g || f.setAttribute(r, "true");
        } catch (v) {
  ...
  return d(t), a.clear(), Xo++, function() {
    i.forEach(function(u) {
      ...
      tn.set(u, f), s.set(u, p), f || (Pr.has(u) || u.removeAttribute(r), Pr.delete(u)), p || u.removeAttribute(n);
    }), Xo--, Xo || (tn = /* @__PURE__ */ new WeakMap(), tn = /* @__PURE__ */ new WeakMap(), Pr = /* @__PURE__ */ new WeakMap(), Or = {});
  };
}, zm = function(e, t, n) {
...
var Vm = typeof window < "u" ? T.useLayoutEffect : T.useEffect, yi = /* @__PURE__ */ new WeakMap();
function Km(e, t) {
...
var wc = Xm(), Qo = function() {
}, ko = T.forwardRef(function(e, t) {
  var n = T.useRef(null), r = T.useState({
    onScrollCapture: Qo,
    onWheelCapture: Qo,
    onTouchMoveCapture: Qo
  }), o = r[0], s = r[1], i = e.forwardProps, a = e.children, l = e.className, c = e.removeScrollBar, d = e.enabled, u = e.shards, f = e.sideCar, p = e.noRelative, g = e.noIsolation, m = e.inert, y = e.allowPinchZoom, v = e.as, b = v === void 0 ? "div" : v, x = e.gapMode, M = vc(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), w = f, E = Km([n, t]), S = nt(nt({}, M), o);
  return T.createElement(
    T.Fragment,
    null,
    d && T.createElement(w, { sideCar: wc, removeScrollBar: c, shards: u, noRelative: p, noIsolation: g, inert: m, setCallbacks: s, allowPinchZoom: !!y, lockRef: n, gapMode: x }),
...
}, ig = xc(), fn = "data-scroll-locked", lg = function(e, t, n, r) {
...
`);
  ...
  T.useEffect(function() {
    return document.body.setAttribute(fn, (vi() + 1).toString()), function() {
      var e = vi() - 1;
...
var nn = Cs ? { passive: !1 } : !1, ug = function(e) {
  ...
  do {
    if (!a)
      break;
    var p = Ec(e, a), g = p[0], m = p[1], y = p[2], v = m - y - s * g;
    (g || v) && Cc(e, a) && (u += v, f += g);
    var b = a.parentNode;
...
function xg(e) {
  var t = T.useRef([]), n = T.useRef([0, 0]), r = T.useRef(), o = T.useState(wg++)[0], s = T.useState(xc)[0], i = T.useRef(e);
  T.useEffect(function() {
    i.current = e;
  }, [e]), T.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(o));
      var m = Fm([e.lockRef.current], (e.shards || []).map(xi), !0).filter(Boolean);
  ...
  var a = T.useCallback(function(m, y) {
    ...
    if (!(!rn.length || rn[rn.length - 1] !== s)) {
      var v = "deltaY" in y ? wi(y) : $r(y), b = t.current.filter(function(w) {
      ...
      if (!b) {
        var x = (i.current.shards || []).map(xi).filter(Boolean).filter(function(w) {
    ...
    c(m.type, wi(m), m.target, a(m, e.lockRef.current));
...
const Cg = Zm(wc, xg);
var Mc = T.forwardRef(function(e, t) {
  return T.createElement(ko, nt({}, e, { ref: t, sideCar: Cg }));
});
Mc.classNames = ko.classNames;
var Es = ["Enter", " "], Eg = ["ArrowDown", "PageUp", "Home"], Tc = ["ArrowUp", "PageDown", "End"], Mg = [...Eg, ...Tc], Tg = {
  ltr: [...Es, "ArrowRight"],
  rtl: [...Es, "ArrowLeft"]
}, Sg = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, rr = "Menu", [qn, Dg, Ng] = Pl(rr), [Kt, Sc] = kn(rr, [
  Ng,
  xo,
  fc
]), Co = xo(), Dc = fc(), [Lg, Gt] = Kt(rr), [Ag, or] = Kt(rr), Nc = (e) => {
  const { __scopeMenu: t, open: n = !1, children: r, dir: o, onOpenChange: s, modal: i = !0 } = e, a = Co(t), [l, c] = T.useState(null), d = T.useRef(!1), u = yt(s), f = Ol(o);
  return T.useEffect(() => {
    const p = () => {
  ...
  }, []), /* @__PURE__ */ h(ic, { ...a, children: /* @__PURE__ */ h(
    Lg,
    {
      scope: t,
      open: n,
...
Nc.displayName = rr;
var Ig = "MenuAnchor", la = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e, o = Co(n);
    return /* @__PURE__ */ h(lc, { ...o, ...r, ref: t });
  }
);
la.displayName = Ig;
var ca = "MenuPortal", [Rg, Lc] = Kt(ca, {
  forceMount: void 0
}), Ac = (e) => {
  const { __scopeMenu: t, forceMount: n, children: r, container: o } = e, s = Gt(ca, t);
  return /* @__PURE__ */ h(Rg, { scope: t, forceMount: n, children: /* @__PURE__ */ h(Vt, { present: n || s.open, children: /* @__PURE__ */ h(ia, { asChild: !0, container: o, children: r }) }) });
};
Ac.displayName = ca;
var Ke = "MenuContent", [Pg, da] = Kt(Ke), Ic = T.forwardRef(
  (e, t) => {
    const n = Lc(Ke, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, s = Gt(Ke, e.__scopeMenu), i = or(Ke, e.__scopeMenu);
...
}), $g = /* @__PURE__ */ Vn("MenuContent.ScrollLock"), ua = T.forwardRef(
  (e, t) => {
    const {
      __scopeMenu: n,
      loop: r = !1,
      ...
      ...m
    } = e, y = Gt(Ke, n), v = or(Ke, n), b = Co(n), x = Dc(n), M = Dg(n), [w, E] = T.useState(null), S = T.useRef(null), k = Ie(t, S, y.onContentChange), N = T.useRef(0), C = T.useRef(""), D = T.useRef(0), L = T.useRef(null), P = T.useRef("right"), O = T.useRef(0), $ = g ? Mc : T.Fragment, W = g ? { as: $g, allowPinchZoom: !0 } : void 0, V = (A) => {
                    ...
                    children: /* @__PURE__ */ h(
                      cc,
                      {
                        ...
                        onKeyDown: le(m.onKeyDown, (A) => {
                          ...
                          Tc.includes(A.key) && J.reverse(), Kg(J);
                        }),
...
Ic.displayName = Ke;
var Hg = "MenuGroup", fa = T.forwardRef(
  (e, t) => {
...
fa.displayName = Hg;
var Bg = "MenuLabel", Rc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
...
Rc.displayName = Bg;
var so = "MenuItem", ki = "menu.itemSelect", Eo = T.forwardRef(
  (e, t) => {
    const { disabled: n = !1, onSelect: r, ...o } = e, s = T.useRef(null), i = or(so, e.__scopeMenu), a = da(so, e.__scopeMenu), l = Ie(t, s), c = T.useRef(!1), d = () => {
      const u = s.current;
      if (!n && u) {
        const f = new CustomEvent(ki, { bubbles: !0, cancelable: !0 });
        u.addEventListener(ki, (p) => r?.(p), { once: !0 }), Rl(u, f), f.defaultPrevented ? c.current = !1 : i.onClose();
      }
    };
    return /* @__PURE__ */ h(
      Pc,
...
var Pc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, disabled: r = !1, textValue: o, ...s } = e, i = da(so, n), a = Dc(n), l = T.useRef(null), c = Ie(t, l), [d, u] = T.useState(!1), [f, p] = T.useState("");
    return T.useEffect(() => {
      const g = l.current;
...
), Wg = "MenuCheckboxItem", Oc = T.forwardRef(
  (e, t) => {
    const { checked: n = !1, onCheckedChange: r, ...o } = e;
    return /* @__PURE__ */ h(Wc, { scope: e.__scopeMenu, checked: n, children: /* @__PURE__ */ h(
      Eo,
      {
...
Oc.displayName = Wg;
var _c = "MenuRadioGroup", [zg, Fg] = Kt(
  _c,
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ h(zg, { scope: e.__scopeMenu, value: n, onValueChange: s, children: /* @__PURE__ */ h(fa, { ...o, ref: t }) });
  }
);
$c.displayName = _c;
var Hc = "MenuRadioItem", Bc = T.forwardRef(
  (e, t) => {
    const { value: n, ...r } = e, o = Fg(Hc, e.__scopeMenu), s = n === o.value;
    return /* @__PURE__ */ h(Wc, { scope: e.__scopeMenu, checked: s, children: /* @__PURE__ */ h(
      Eo,
      {
        role: "menuitemradio",
        "aria-checked": s,
...
Bc.displayName = Hc;
var pa = "MenuItemIndicator", [Wc, Ug] = Kt(
  pa,
  { checked: !1 }
), zc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, forceMount: r, ...o } = e, s = Ug(pa, n);
    return /* @__PURE__ */ h(
      Vt,
      {
...
zc.displayName = pa;
var Yg = "MenuSeparator", Fc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
    return /* @__PURE__ */ h(
      Le.div,
...
Fc.displayName = Yg;
var jg = "MenuArrow", Uc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e, o = Co(n);
...
Uc.displayName = jg;
var Vg = "MenuSub", [q1, Yc] = Kt(Vg), Hn = "MenuSubTrigger", jc = T.forwardRef(
  (e, t) => {
    const n = Gt(Hn, e.__scopeMenu), r = or(Hn, e.__scopeMenu), o = Yc(Hn, e.__scopeMenu), s = da(Hn, e.__scopeMenu), i = T.useRef(null), { pointerGraceTimerRef: a, onPointerGraceIntentChange: l } = s, c = { __scopeMenu: e.__scopeMenu }, d = T.useCallback(() => {
    ...
    }, [a, l]), /* @__PURE__ */ h(la, { asChild: !0, ...c, children: /* @__PURE__ */ h(
      Pc,
      {
        id: o.triggerId,
        "aria-haspopup": "menu",
...
var Vc = "MenuSubContent", Kc = T.forwardRef(
  (e, t) => {
    const n = Lc(Ke, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, s = Gt(Ke, e.__scopeMenu), i = or(Ke, e.__scopeMenu), a = Yc(Vc, e.__scopeMenu), l = T.useRef(null), c = Ie(t, l);
...
var Qg = Nc, Jg = la, ey = Ac, ty = Ic, ny = fa, ry = Rc, oy = Eo, sy = Oc, ay = $c, iy = Bc, ly = zc, cy = Fc, dy = Uc, uy = jc, fy = Kc, Mo = "DropdownMenu", [py] = kn(
  Mo,
  [Sc]
), Pe = Sc(), [hy, qc] = py(Mo), Xc = (e) => {
  const {
    ...
    onOpenChange: i,
    modal: a = !0
  } = e, l = Pe(t), c = T.useRef(null), [d, u] = Zs({
    prop: o,
    defaultProp: s ?? !1,
    onChange: i,
    caller: Mo
...
var Zc = "DropdownMenuTrigger", Qc = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, disabled: r = !1, ...o } = e, s = qc(Zc, n), i = Pe(n);
...
Qc.displayName = Zc;
var my = "DropdownMenuPortal", Jc = (e) => {
  const { __scopeDropdownMenu: t, ...n } = e, r = Pe(t);
  return /* @__PURE__ */ h(ey, { ...r, ...n });
};
Jc.displayName = my;
var ed = "DropdownMenuContent", td = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = qc(ed, n), s = Pe(n), i = T.useRef(!1);
    return /* @__PURE__ */ h(
      ty,
      {
        id: o.contentId,
...
by.displayName = vy;
var wy = "DropdownMenuItem", nd = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
...
Dy.displayName = Sy;
var Ny = "DropdownMenuSeparator", rd = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
...
Oy.displayName = Py;
var _y = Xc, $y = Qc, Hy = Jc, By = td, Wy = nd, zy = rd;
function od(e) {
  var t, n, r = "";
  if (typeof e == "string" || typeof e == "number") r += e;
  else if (typeof e == "object") if (Array.isArray(e)) {
    var o = e.length;
    for (t = 0; t < o; t++) e[t] && (n = od(e[t])) && (r && (r += " "), r += n);
  } else for (n in e) e[n] && (r && (r += " "), r += n);
  return r;
}
function sd() {
  for (var e, t, n = 0, r = "", o = arguments.length; n < o; n++) (e = arguments[n]) && (t = od(e)) && (r && (r += " "), r += t);
  return r;
}
const ma = "-", Fy = (e) => {
  const t = Yy(e), {
  ...
  return {
    getClassGroupId: (i) => {
      const a = i.split(ma);
      return a[0] === "" && a.length !== 1 && a.shift(), ad(a, t) || Uy(i);
    },
  ...
  const n = e[0], r = t.nextPart.get(n), o = r ? ad(e.slice(1), r) : void 0;
  if (o)
    return o;
  ...
  if (Ci.test(e)) {
    const t = Ci.exec(e)[1], n = t?.substring(0, t.indexOf(":"));
    if (n)
      return "arbitrary.." + n;
  }
}, Yy = (e) => {
...
const Ee = (e) => {
...
}, ld = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, cd = /^\((?:(\w[\w-]*):)?(.+)\)$/i, nv = /^\d+\/\d+$/, rv = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, ov = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, sv = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, av = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, iv = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, on = (e) => nv.test(e), ce = (e) => !!e && !Number.isNaN(Number(e)), Ct = (e) => !!e && Number.isInteger(Number(e)), es = (e) => e.endsWith("%") && ce(e.slice(0, -1)), dt = (e) => rv.test(e), lv = () => !0, cv = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  ov.test(e) && !sv.test(e)
), dd = () => !1, dv = (e) => av.test(e), uv = (e) => iv.test(e), fv = (e) => !Z(e) && !Q(e), pv = (e) => Mn(e, pd, dd), Z = (e) => ld.test(e), _t = (e) => Mn(e, hd, cv), ts = (e) => Mn(e, vv, ce), Mi = (e) => Mn(e, ud, dd), hv = (e) => Mn(e, fd, uv), Hr = (e) => Mn(e, md, dv), Q = (e) => cd.test(e), Pn = (e) => Tn(e, hd), mv = (e) => Tn(e, bv), Ti = (e) => Tn(e, ud), gv = (e) => Tn(e, pd), yv = (e) => Tn(e, fd), Br = (e) => Tn(e, md, !0), Mn = (e, t, n) => {
  const r = ld.exec(e);
  return r ? r[1] ? t(r[1]) : n(r[2]) : !1;
}, Tn = (e, t, n = !1) => {
  const r = cd.exec(e);
  return r ? r[1] ? t(r[1]) : n : !1;
}, ud = (e) => e === "position" || e === "percentage", fd = (e) => e === "image" || e === "url", pd = (e) => e === "length" || e === "size" || e === "bg-size", hd = (e) => e === "length", vv = (e) => e === "number", bv = (e) => e === "family-name", md = (e) => e === "shadow", wv = () => {
  const e = Ee("color"), t = Ee("font"), n = Ee("text"), r = Ee("font-weight"), o = Ee("tracking"), s = Ee("leading"), i = Ee("breakpoint"), a = Ee("container"), l = Ee("spacing"), c = Ee("radius"), d = Ee("shadow"), u = Ee("inset-shadow"), f = Ee("text-shadow"), p = Ee("drop-shadow"), g = Ee("blur"), m = Ee("perspective"), y = Ee("aspect"), v = Ee("ease"), b = Ee("animate"), x = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], M = () => [
    ...
    span: ["full", Ct, Q, Z]
  }, Ct, Q, Z], L = () => [Ct, "auto", Q, Z], P = () => ["auto", "min", "max", "fr", Q, Z], O = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], $ = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], W = () => ["auto", ...k()], V = () => [on, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...k()], R = () => [e, Q, Z], A = () => [...M(), Ti, Mi, {
    position: [Q, Z]
  }], H = () => ["no-repeat", {
    ...
    Q,
    Z
  ], K = () => ["", ce, Pn, _t], B = () => ["solid", "dashed", "dotted", "double"], J = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], _ = () => [ce, es, Ti, Mi], ee = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    g,
    Q,
    Z
  ], ne = () => ["none", ce, Q, Z], de = () => ["none", ce, Q, Z], we = () => [ce, Q, Z], ve = () => [on, "full", ...k()];
  return {
    cacheSize: 500,
    theme: {
    ...
    classGroups: {
       ...
       */
      "text-decoration-thickness": [{
        decoration: [ce, "from-font", "auto", Q, _t]
      }],
      /**
...
const Si = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, Di = sd, kv = (e, t) => (n) => {
  var r;
...
var Cv = Object.freeze({
  ...
  whiteSpace: "nowrap",
  wordWrap: "normal"
}), Ev = "VisuallyHidden", gd = T.forwardRef(
  (e, t) => /* @__PURE__ */ h(
    Le.span,
    {
      ...e,
...
gd.displayName = Ev;
var Mv = gd, [To] = kn("Tooltip", [
  xo
]), So = xo(), yd = "TooltipProvider", Tv = 700, Ns = "tooltip.open", [Sv, ga] = To(yd), vd = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = Tv,
...
vd.displayName = yd;
var Zn = "Tooltip", [Dv, sr] = To(Zn), bd = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: r,
    ...
    delayDuration: a
  } = e, l = ga(Zn, e.__scopeTooltip), c = So(t), [d, u] = T.useState(null), f = eo(), p = T.useRef(0), g = i ?? l.disableHoverableContent, m = a ?? l.delayDuration, y = T.useRef(!1), [v, b] = Zs({
    prop: r,
    defaultProp: o ?? !1,
    onChange: (S) => {
      S ? (l.onOpen(), document.dispatchEvent(new CustomEvent(Ns))) : l.onClose(), s?.(S);
    },
    caller: Zn
  ...
  }, []), /* @__PURE__ */ h(ic, { ...c, children: /* @__PURE__ */ h(
    Dv,
    {
      scope: t,
      contentId: f,
...
bd.displayName = Zn;
var Ls = "TooltipTrigger", wd = T.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...r } = e, o = sr(Ls, n), s = ga(Ls, n), i = So(n), a = T.useRef(null), l = Ie(t, a, o.onTriggerChange), c = T.useRef(!1), d = T.useRef(!1), u = T.useCallback(() => c.current = !1, []);
    return T.useEffect(() => () => document.removeEventListener("pointerup", u), [u]), /* @__PURE__ */ h(lc, { asChild: !0, ...i, children: /* @__PURE__ */ h(
      Le.button,
      {
...
wd.displayName = Ls;
var ya = "TooltipPortal", [Nv, Lv] = To(ya, {
  forceMount: void 0
}), xd = (e) => {
  const { __scopeTooltip: t, forceMount: n, children: r, container: o } = e, s = sr(ya, t);
  return /* @__PURE__ */ h(Nv, { scope: t, forceMount: n, children: /* @__PURE__ */ h(Vt, { present: n || s.open, children: /* @__PURE__ */ h(ia, { asChild: !0, container: o, children: r }) }) });
};
xd.displayName = ya;
var yn = "TooltipContent", kd = T.forwardRef(
  (e, t) => {
    const n = Lv(yn, e.__scopeTooltip), { forceMount: r = n.forceMount, side: o = "top", ...s } = e, i = sr(yn, e.__scopeTooltip);
    return /* @__PURE__ */ h(Vt, { present: r || i.open, children: i.disableHoverableContent ? /* @__PURE__ */ h(Cd, { side: o, ...s, ref: t }) : /* @__PURE__ */ h(Av, { side: o, ...s, ref: t }) });
  }
), Av = T.forwardRef((e, t) => {
  const n = sr(yn, e.__scopeTooltip), r = ga(yn, e.__scopeTooltip), o = T.useRef(null), s = Ie(t, o), [i, a] = T.useState(null), { trigger: l, onClose: c } = n, d = o.current, { onPointerInTransitChange: u } = r, f = T.useCallback(() => {
    a(null), u(!1);
  }, [u]), p = T.useCallback(
    (g, m) => {
  ...
  }, [l, d, i, c, f]), /* @__PURE__ */ h(Cd, { ...e, ref: s });
}), [Iv, Rv] = To(Zn, { isInside: !1 }), Pv = /* @__PURE__ */ Rp("TooltipContent"), Cd = T.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: r,
      ...
      ...a
    } = e, l = sr(yn, n), c = So(n), { onClose: d } = l;
    return T.useEffect(() => (document.addEventListener(Ns, d), () => document.removeEventListener(Ns, d)), [d]), T.useEffect(() => {
      if (l.trigger) {
        const u = (f) => {
...
kd.displayName = yn;
var Ed = "TooltipArrow", Md = T.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...r } = e, o = So(n);
    return Rv(
      Ed,
      n
    ).isInside ? null : /* @__PURE__ */ h(dc, { ...o, ...r, ref: t });
  }
);
Md.displayName = Ed;
function Ov(e, t) {
...
var zv = vd, Fv = bd, Uv = wd, Yv = xd, jv = kd, Vv = Md;
function Kv({
  delayDuration: e = 0,
  ...t
}) {
...
const be = ({ onClick: e, isActive: t, disabled: n, children: r, tooltip: o }) => {
  ...
  return o ? /* @__PURE__ */ I(Td, { children: [
    /* @__PURE__ */ h(Sd, { asChild: !0, children: s }),
    /* @__PURE__ */ h(Dd, { side: "bottom", className: "text-xs", children: o })
  ] }) : s;
}, $t = () => /* @__PURE__ */ h("div", { className: "w-px h-5 bg-border mx-0.5 shrink-0" }), Gv = wt(function({ editor: t, onCopyMarkdown: n, onOpenLinkPopover: r, className: o = "", autoReorderChecklist: s = !1, aiEnabled: i = !1, onAISparklesClick: a }) {
  const l = Y(null), [c, d] = j(!1), [u, f] = j(void 0), p = dl({
    editor: t,
    selector: ({ editor: E }) => ({
      canUndo: E.can().undo(),
      canRedo: E.can().redo(),
  ...
  return /* @__PURE__ */ I("div", { className: `flex items-center gap-0.5 px-2 py-1.5 border-b border-border/30 bg-muted/30 overflow-x-auto scrollbar-hide editor-toolbar ${o}`, children: [
    ...
    /* @__PURE__ */ h(
      be,
      {
        ...
        children: /* @__PURE__ */ h(hl, { size: 16 })
      }
    ),
    /* @__PURE__ */ h(
      be,
    ...
    /* @__PURE__ */ h(
      be,
      {
        ...
        children: /* @__PURE__ */ h(_s, { size: 16 })
      }
    ),
    /* @__PURE__ */ h(
      be,
    ...
    /* @__PURE__ */ I(ns, { children: [
      ...
      /* @__PURE__ */ I(os, { align: "start", children: [
        ...
        /* @__PURE__ */ I(xe, { onClick: () => v("note"), children: [
          /* @__PURE__ */ h(vl, { size: 16, className: "mr-2", style: { color: "#FF8200" } }),
          " Note"
        ] }),
        ...
        /* @__PURE__ */ I(xe, { onClick: () => v("todo"), children: [
          /* @__PURE__ */ h(bl, { size: 16, className: "mr-2", style: { color: "#4479B3" } }),
          " Todo"
        ] })
      ] })
    ] }),
      ...
      /* @__PURE__ */ I(os, { align: "start", className: "w-56", children: [
        /* @__PURE__ */ I(
          xe,
          {
            ...
            children: [
              /* @__PURE__ */ h(za, { size: 16, className: "mr-2" }),
              " Add Column Before"
            ]
          }
        ),
    ...
    i && /* @__PURE__ */ I(ye, { children: [
      ...
      /* @__PURE__ */ I(Td, { children: [
        /* @__PURE__ */ h(Sd, { asChild: !0, children: /* @__PURE__ */ h(
          "button",
          {
            ref: l,
            onClick: () => {
        ...
        /* @__PURE__ */ h(Dd, { side: "bottom", className: "text-xs", children: "AI Writing Assistant" })
      ] })
    ] }),
    ...
    /* @__PURE__ */ I("div", { className: "select-all-action-bar-inner", children: [
      ...
      p && r < s && /* @__PURE__ */ I(ye, { children: [
        /* @__PURE__ */ h(
          "button",
          {
            ...
            children: /* @__PURE__ */ h(Ks, { size: 14 })
          }
        ),
        /* @__PURE__ */ h(
          "button",
      ...
      /* @__PURE__ */ h(
        "button",
        {
          ...
          children: /* @__PURE__ */ h(Hs, { size: 14 })
        }
      ),
      /* @__PURE__ */ h(
        "button",
...
function db(e, t, n) {
  ...
  zt = { tablePos: t, columnIndex: n, direction: i }, Bn = null;
  const a = [];
  s.forEach((g) => {
  ...
  if (c.length < 2) {
    Ni(n, i), o.dispatch(r.tr.setMeta(Un, { updated: !0 }));
    return;
  }
  const d = c.map((g) => {
    let m = "", y = 0;
  ...
  return new De({
    ...
    state: {
      ...
      apply(t, n, r, o) {
        ...
        return !t.docChanged && !s?.updated && Bn ? Bn.map(t.mapping, t.doc) : (Bn = pb(o.doc, e), Bn);
      }
    },
    props: {
      decorations(t) {
        ...
        if (i.type.name === "tableRow") {
          ...
          i.forEach((d, u) => {
            if (d.type.name === "tableHeader") {
              ...
              const m = zt?.tablePos === s && zt?.columnIndex === l ? zt.direction : null, y = l, v = s, b = Ze.widget(p, () => ub(m, v, y, t), { side: 1, key: "sort-" + s + "-" + y });
              n.push(b);
            }
            c += d.nodeSize, l++;
          });
    ...
    return {
      toggleTaskList: () => ({ editor: e, commands: t, state: n, tr: r, dispatch: o, chain: s, can: i }) => {
        ...
        if (M) {
          ...
          return E >= 0 && va(r, E, u, f, y, { checked: !1 }), o(r), !0;
        }
...
function zr(e, t, n, r) {
  ...
  return e.descendants((s, i) => {
    if (!n.listItemTypes.includes(s.type.name) || !io(s))
      return !0;
    const a = As(s, i), l = t.collapsedItems.has(a);
    o.push(
    ...
    return {
      ...
      collapseAllListItems: () => ({ editor: e, tr: t }) => {
        ...
        return t.doc.descendants((o, s) => {
          this.options.listItemTypes.includes(o.type.name) && io(o) && n.collapsedItems.add(As(o, s));
...
function Ht(e, t, n) {
  const r = document.createElementNS(Ai, "svg");
  r.setAttribute("width", String(t)), r.setAttribute("height", String(t)), r.setAttribute("viewBox", "0 0 24 24"), r.setAttribute("fill", "none"), r.setAttribute("stroke", "currentColor"), r.setAttribute("stroke-width", "2"), r.setAttribute("stroke-linecap", "round"), r.setAttribute("stroke-linejoin", "round"), n && r.setAttribute("class", n);
  for (const o of e) {
    const s = document.createElementNS(Ai, o.tag);
...
class Lb {
  ...
  toggleCollapse() {
    this.collapsed = !this.collapsed, this.collapsed ? (this.dom.classList.add("callout-collapsed"), this.contentWrapper.classList.add("callout-content-hidden"), this.headerEl.title = "Click to expand") : (this.dom.classList.remove("callout-collapsed"), this.contentWrapper.classList.remove("callout-content-hidden"), this.headerEl.title = "Click to collapse"), this.collapseIndicator.innerHTML = "", this.collapseIndicator.appendChild(
      this.collapsed ? Ht(Db, 16) : Ht(is, 16)
    );
  }
  // ── Dropdown Portal ──
  toggleDropdown() {
...
function Ft(e, t) {
  try {
    ...
    return r in Wn ? Wn[r] : Ii(r, r.split(":"));
  } catch {
...
class ot extends Date {
  //#region static
  constructor(...t) {
    super(), t.length > 1 && typeof t[t.length - 1] == "string" && (this.timeZone = t.pop()), this.internal = /* @__PURE__ */ new Date(), isNaN(Ft(this.timeZone, this)) ? this.setTime(NaN) : t.length ? typeof t[0] == "number" && (t.length === 1 || t.length === 2 && typeof t[1] != "number") ? this.setTime(t[0]) : typeof t[0] == "string" ? this.setTime(+new Date(t[0])) : t[0] instanceof Date ? this.setTime(+t[0]) : (this.setTime(+new Date(...t)), Nd(this), Is(this)) : this.setTime(Date.now());
  }
  static tz(t, ...n) {
...
function Nd(e) {
  ...
  c.setUTCSeconds(0);
  const d = o > 0 ? c.getSeconds() : (c.getSeconds() - 60) % 60, u = Math.round(-(Ft(e.timeZone, e) * 60)) % 60;
  ...
  const f = Ft(e.timeZone, e), p = f > 0 ? Math.floor(f) : Math.ceil(f), m = -(/* @__PURE__ */ new Date(+e)).getTimezoneOffset() - p, y = p !== n, v = m - l;
  if (y && v) {
    Date.prototype.setUTCMinutes.call(e, Date.prototype.getUTCMinutes.call(e) + v);
    const b = Ft(e.timeZone, e), x = b > 0 ? Math.floor(b) : Math.ceil(b), M = p - x;
...
const Ld = 6048e5, $b = 864e5, Pi = Symbol.for("constructDateFrom");
function ke(e, t) {
...
function Pd(e, t, n) {
  const [r, o] = Sn(
    ...
    e,
    t
  ), s = Jn(r), i = Jn(o), a = +s - Oi(s), l = +i - Oi(i);
...
const Bi = (e, t) => {
  ...
  return s.replace("{{date}}", Bi(r, t)).replace("{{time}}", Fd(o, t));
}, Pw = {
  p: Fd,
  P: Rw
...
function Kw(e, t, n) {
  const r = ar(), o = n?.locale ?? r.locale ?? ba, s = n?.firstWeekContainsDate ?? n?.locale?.options?.firstWeekContainsDate ?? r.firstWeekContainsDate ?? r.locale?.options?.firstWeekContainsDate ?? 1, i = n?.weekStartsOn ?? n?.locale?.options?.weekStartsOn ?? r.weekStartsOn ?? r.locale?.options?.weekStartsOn ?? 0, a = he(e, n?.in);
  if (!jb(a))
...
function s0(e, t) {
  ...
  return t.getMonth(e) === t.getMonth(s) ? Wi : o0;
}
function Ud(e, t) {
...
function _0(e, t, n, r, o) {
  ...
  for (const w of e) {
    const { date: E, displayMonth: S } = w, k = !!(S && !f(E, S)), N = !!(v && g(E, v)), C = !!(b && y(E, b)), D = !!(s && ht(E, s, o)), L = !!(i && ht(E, i, o)) || N || C || // Broadcast calendar will show outside days as default
...
}, Symbol.toStringTag, { value: "Module" })), lr = (e) => e instanceof HTMLElement ? e : null, cs = (e) => [
  ...e.querySelectorAll("[data-animated-month]") ?? []
], ux = (e) => lr(e.querySelector("[data-animated-month]")), ds = (e) => lr(e.querySelector("[data-animated-caption]")), us = (e) => lr(e.querySelector("[data-animated-weeks]")), fx = (e) => lr(e.querySelector("[data-animated-nav]")), px = (e) => lr(e.querySelector("[data-animated-weekdays]"));
  ...
  fo(() => {
    ...
    if (v?.every((b) => b instanceof HTMLElement) && y && y.every((b) => b instanceof HTMLElement)) {
      ...
      b && (b.style.zIndex = "1"), v.forEach((x, M) => {
        ...
        const D = us(w);
        D && D.classList.add(u ? n[He.weeks_before_exit] : n[He.weeks_after_exit]), x.insertBefore(w, x.firstChild);
      });
    }
  });
}
...
function vx(e, t, n, r) {
  const { addDays: o, endOfBroadcastWeek: s, endOfISOWeek: i, endOfMonth: a, endOfWeek: l, getISOWeek: c, getWeek: d, startOfBroadcastWeek: u, startOfISOWeek: f, startOfWeek: p } = r, g = e.reduce((m, y) => {
    ...
    const w = x.reduce((S, k) => {
      const N = n.ISOWeek ? c(k) : d(k), C = S.find((L) => L.weekNumber === N), D = new Yd(k, y, r);
...
function Cx(e, t) {
  const [n, r] = bx(e, t), { startOfMonth: o, endOfMonth: s } = t, i = zi(e, n, r, t), [a, l] = Do(
    i,
...
function Ex(e, t, n, r) {
  ...
  for (const i of e) {
    const a = t(i);
    Fi(a) && (a[ge.focused] && s < tt.FocusedModifier ? (o = i, s = tt.FocusedModifier) : r?.isEqualTo(i) && s < tt.LastFocused ? (o = i, s = tt.LastFocused) : n(i.date) && s < tt.Selected ? (o = i, s = tt.Selected) : a[ge.today] && s < tt.Today && (o = i, s = tt.Today));
  }
  return o || (o = e.find((i) => Fi(t(i)))), o;
}
...
function tu(e, t, n, r, o, s, i, a = 0) {
  if (a > 365)
    return;
  const l = Mx(e, t, n.date, r, o, s, i), c = !!(s.disabled && ht(l, s.disabled, i)), d = !!(s.hidden && ht(l, s.hidden, i)), u = l, f = new Yd(l, u, i);
...
function Dx(e, t, n = 0, r = 0, o = !1, s = lt) {
...
function Ui(e, t, n = lt) {
  return pt(e, t.from, !1, n) || pt(e, t.to, !1, n) || pt(t, e.from, !1, n) || pt(t, e.to, !1, n);
}
function Lx(e, t, n = lt) {
  const r = Array.isArray(t) ? t : [t];
  if (r.filter((a) => typeof a != "function").some((a) => typeof a == "boolean" ? a : n.isDate(a) ? pt(e, a, !1, n) : Xd(a, n) ? a.some((l) => pt(e, l, !1, n)) : wa(a) ? a.from && a.to ? Ui(e, { from: a.from, to: a.to }, n) : !1 : qd(a) ? Nx(e, a.dayOfWeek, n) : Vd(a) ? n.isAfter(a.before, a.after) ? Ui(e, {
    from: n.addDays(a.after, 1),
    to: n.addDays(a.before, -1)
  }, n) : ht(e.from, a, n) || ht(e.to, a, n) : Kd(a) || Gd(a) ? ht(e.from, a, n) || ht(e.to, a, n) : !1))
    return !0;
...
function Px(e) {
  ...
  return X.createElement(
    ...
    X.createElement(
      n.Root,
      { rootRef: t.animate ? vr : void 0, className: Po, style: yr, dir: t.dir, id: t.id, lang: t.lang, nonce: t.nonce, title: t.title, role: t.role, "aria-label": t["aria-label"], "aria-labelledby": t["aria-labelledby"], ...Oo },
      X.createElement(
        n.Months,
        { className: a[te.Months], style: w?.[te.Months] },
        !t.hideNavigation && !d && X.createElement(n.Nav, { "data-animated-nav": t.animate ? "true" : void 0, className: a[te.Nav], style: w?.[te.Nav], "aria-label": ct(), onPreviousClick: qt, onNextClick: xt, previousMonth: R, nextMonth: A }),
        $.map((ae, me) => X.createElement(
          ...
          d === "around" && !t.hideNavigation && me === 0 && X.createElement(
            ...
            { type: "button", className: a[te.PreviousMonthButton], tabIndex: R ? void 0 : -1, "aria-disabled": R ? void 0 : !0, "aria-label": It(R), onClick: qt, "data-animated-button": t.animate ? "true" : void 0 },
          ...
          d === "around" && !t.hideNavigation && me === u - 1 && X.createElement(
            n.NextMonthButton,
            { type: "button", className: a[te.NextMonthButton], tabIndex: A ? void 0 : -1, "aria-disabled": A ? void 0 : !0, "aria-label": Dn(A), onClick: xt, "data-animated-button": t.animate ? "true" : void 0 },
            X.createElement(n.Chevron, { disabled: A ? void 0 : !0, className: a[te.Chevron], orientation: t.dir === "rtl" ? "left" : "right" })
          ),
          me === u - 1 && d === "after" && !t.hideNavigation && X.createElement(n.Nav, { "data-animated-nav": t.animate ? "true" : void 0, className: a[te.Nav], style: w?.[te.Nav], "aria-label": ct(), onPreviousClick: qt, onNextClick: xt, previousMonth: R, nextMonth: A }),
          X.createElement(
            n.MonthGrid,
            ...
            X.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: a[te.Weeks], style: w?.[te.Weeks] }, ae.weeks.map((re) => X.createElement(
              ...
              re.days.map((fe) => {
                ...
                if (ue[ge.focused] = !ue.hidden && !!J?.isEqualTo(fe), ue[Xe.selected] = z?.(Te) || ue.selected, wa(K)) {
                  const { from: Qt, to: Rt } = K;
                  ue[Xe.range_start] = !!(Qt && Rt && s.isSameDay(Te, Qt)), ue[Xe.range_end] = !!(Qt && Rt && s.isSameDay(Te, Rt)), ue[Xe.range_middle] = pt(K, Te, !0, s);
                }
                const Xt = X0(ue, w, t.modifiersStyles), Zt = $0(ue, a, t.modifiersClassNames), $o = !Ln && !ue.hidden ? we(Te, ue, s.options, s) : void 0;
                return (
                  // biome-ignore lint/a11y/useSemanticElements: react component
                  X.createElement(n.Day, { key: `${s.format(Te, "yyyy-MM-dd")}_${s.format(fe.displayMonth, "yyyy-MM")}`, day: fe, modifiers: ue, className: Zt.join(" "), style: Xt, role: "gridcell", "aria-selected": ue.selected || void 0, "aria-label": $o, "data-day": s.format(Te, "yyyy-MM-dd"), "data-month": fe.outside ? s.format(Te, "yyyy-MM") : void 0, "data-selected": ue.selected || void 0, "data-disabled": ue.disabled || void 0, "data-hidden": ue.hidden || void 0, "data-outside": fe.outside || void 0, "data-focused": ue.focused || void 0, "data-today": ue.today || void 0 }, !ue.hidden && Ln ? X.createElement(n.DayButton, { className: a[te.DayButton], style: w?.[te.DayButton], type: "button", day: fe, modifiers: ue, disabled: ue.disabled || void 0, tabIndex: _(fe) ? 0 : -1, "aria-label": de(Te, ue, s.options, s), onClick: pr(fe, ue), onBlur: mr(fe, ue), onFocus: hr(fe, ue), onKeyDown: gr(fe, ue), onMouseEnter: Lo(fe, ue), onMouseLeave: Ao(fe, ue) }, S(Te, s.options, s)) : !ue.hidden && S(fe.date, s.options, s))
                );
              })
            )))
          )
...
function zx({ node: e, updateAttributes: t, selected: n }) {
  const r = Y(null), o = e.attrs.date || hn(), s = ru(o), i = ka(o), a = F(() => {
    if (!r.current) return "";
  ...
  return q(() => (nu.set(o, (l) => {
    ...
    "span",
    {
      ...
      "data-date": o,
      children: [
        /* @__PURE__ */ h(wl, { size: 14, className: "date-icon" }),
...
const Ux = new Ne("datePillPaste"), Yx = mo.create({
  name: "datePill",
  group: "inline",
  inline: !0,
  atom: !0,
  ...
  renderHTML({ node: e, HTMLAttributes: t }) {
    const n = e.attrs.date, r = ru(n), o = ka(n);
    return [
      "span",
      xn(this.options.HTMLAttributes, t, {
        "data-type": "date-pill",
...
function jx({ node: e, selected: t, editor: n, getPos: r, deleteNode: o }) {
  ...
  return c ? /* @__PURE__ */ h(Jr, { as: "span", className: "inline", children: /* @__PURE__ */ I(
    "span",
    {
      ...
      "data-tag": a,
      children: [
        /* @__PURE__ */ h(Ya, { size: 14, className: "tag-icon", strokeWidth: 2.5 }),
        /* @__PURE__ */ h(
          "input",
          {
            ref: i,
...
const Vx = new Ne("tagPillPaste"), Kx = mo.create({
  name: "tagPill",
  group: "inline",
  inline: !0,
  atom: !0,
    ...
    return {
      toggleHeadingCollapse: (e) => ({ editor: t, tr: n }) => {
        ...
        if (!o || o.type.name !== "heading")
          return !1;
        const i = Rs(n.doc, this.options.levels).get(e);
      ...
      collapseAllHeadings: () => ({ editor: e, tr: t }) => {
        const n = this.storage;
        return Rs(t.doc, this.options.levels).forEach((o) => {
        ...
        state: {
          init(r, o) {
            return {
              ...
              docVersion: 0,
              headingFingerprint: Ki(o.doc, t.levels)
            };
          },
          apply(r, o, s, i) {
            if (r.getMeta("collapsibleHeading"))
              return {
                ...
                docVersion: o.docVersion + 1,
                headingFingerprint: Ki(i.doc, t.levels)
              };
            if (r.docChanged) {
...
}), Ur = new Ne("searchHighlight"), ck = _e.create({
            ...
            if (n.key === "Enter") {
              ...
              for (const c of fk)
                if (a === `\`\`\`${c}`) {
                  ...
                  if (f && p) {
                    const g = p.create(), m = f.create({ type: c }, Tl.from(g));
                    d.insert(u, m);
...
`);
              ...
              const p = f.map((m) => m === "" ? d.create() : d.create(null, c.text(m))), g = Tl.from(p);
              return new Uo(g, 0, 0);
            } else {
            ...
            new Oe({
              ...
              handler: ({ state: y, range: v }) => {
                ...
                if (N < b.doc.content.size) {
                  ...
                  C.nodeAfter && C.nodeAfter.isTextblock ? b.setSelection(Ve.create(b.doc, N + 1)) : C.nodeAfter && b.setSelection(Ve.near(b.doc.resolve(N)));
                } else {
                  const D = y.schema.nodes.paragraph.create();
                  b.insert(N, D), b.setSelection(Ve.create(b.doc, N + 1));
                }
                b.scrollIntoView();
              }
            })
...
function eC(e) {
  const {
    ...
    isLightweightRef: k
  } = e, N = n && n.length > Jk, C = Y(N ? n : null), D = N ? "" : n, L = Y(null), P = Y(null), O = Y(c), $ = Y(d), W = Y(u), V = Y(f), R = Y(null);
    ...
    "div",
    {
      ...
      children: [
        ...
        e === "saving" && /* @__PURE__ */ I(ye, { children: [
          /* @__PURE__ */ h(xl, { className: "w-3.5 h-3.5 text-cyan-500 animate-spin" }),
        ...
        /* @__PURE__ */ I("div", { className: "flex items-center gap-3 flex-shrink-0", children: [
          /* @__PURE__ */ I(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ h(Gs, { className: "w-4 h-4" }),
                "Recover"
              ]
            }
          ),
...
`);
  ...
  if (!n || n.length === 0) {
    for (let l = 0; l < s.length; l++) {
      ...
      let f = i;
      for (const p of u)
        p.start > f && (o += Ut(e.substring(f, p.start))), o += `<span class="${el(p.type)}">${Ut(p.content)}</span>`, f = p.end;
      f < d && (o += Ut(e.substring(f, d))), l < s.length - 1 && (o += `
`), i = d + 1;
    }
    return o;
  }
  ...
  for (let l = 0; l < s.length; l++) {
    ...
    let f = i;
    for (const p of u)
      p.start > f && (o += ps(e, f, p.start, null, a)), o += ps(e, p.start, p.end, el(p.type), a), f = p.end;
  ...
  for (; i < n; ) {
    ...
    if (a) {
      ...
      for (; i < n && o.get(i)?.matchIdx === a.matchIdx; )
        i++;
      const c = Ut(e.substring(l, i)), d = a.isCurrent ? "search-highlight search-highlight-current" : "search-highlight";
      r ? s += `<span class="${r}"><mark class="${d}">${c}</mark></span>` : s += `<mark class="${d}">${c}</mark>`;
    } else {
      const l = i;
      for (; i < n && !o.has(i); )
        i++;
      const c = Ut(e.substring(l, i));
  ...
  q(() => {
    ...
    const C = (D) => {
      ...
      if (c.current = D, l.current.push({ time: D, duration: L }), l.current.length > 120 && (l.current = l.current.slice(-120)), L > 16.67 && u.current++, S++, D - k >= 1e3) {
        N = S, S = 0, k = D;
        const P = l.current.slice(-60), O = P.length > 0 ? P.reduce((z, U) => z + U.duration, 0) / P.length : 0, $ = P.length > 0 ? Math.max(...P.map((z) => z.duration)) : 0, W = performance.memory, V = W ? W.usedJSHeapSize / (1024 * 1024) : 0, R = W ? W.jsHeapSizeLimit / (1024 * 1024) : 0, A = document.querySelectorAll("*").length, H = tl - f.current, G = Ps - p.current;
        f.current = tl, p.current = Ps, a({
          fps: N,
  ...
  return /* @__PURE__ */ I("div", { className: "perf-profiler-overlay", children: [
    /* @__PURE__ */ I("div", { className: "perf-profiler-header", children: [
      ...
      /* @__PURE__ */ I("div", { className: "perf-profiler-actions", children: [
        /* @__PURE__ */ h("button", { onClick: x, title: o ? "Expand" : "Minimize", children: o ? /* @__PURE__ */ h(kl, { size: 12 }) : /* @__PURE__ */ h(Cl, { size: 12 }) }),
        /* @__PURE__ */ h("button", { onClick: b, title: "Close profiler", children: /* @__PURE__ */ h(gt, { size: 12 }) })
      ] })
    ] }),
        ...
        t && /* @__PURE__ */ I("div", { className: "w-full max-w-xs", children: [
          /* @__PURE__ */ I(
            "button",
            {
              ...
              children: [
                n ? /* @__PURE__ */ h(er, { className: "w-3 h-3" }) : /* @__PURE__ */ h(Cf, { className: "w-3 h-3" }),
                "Error details"
              ]
            }
          ),
...
), hs = () => /* @__PURE__ */ h("div", { className: "w-px h-5 bg-border mx-0.5 flex-shrink-0" }), nl = [
...
], MC = wt(function({ editor: t, isH1: n, isH2: r, isH3: o, isH4: s, isH5: i, executeCommand: a }) {
  const [l, c] = j(!1), d = Y(null), u = n ? "h1" : r ? "h2" : o ? "h3" : s ? "h4" : i ? "h5" : "paragraph", f = nl.find((g) => g.value === u)?.shortLabel || "P";
  q(() => {
    if (!l) return;
    const g = (m) => {
...
}), TC = wt(function({ onCopy: t, iconSize: n }) {
...
}), SC = wt(function({ editor: t, className: n = "", suppressWhenLinkPopoverOpen: r = !1, aiEnabled: o = !1, onAISparklesClick: s, onCopySelectionAsMarkdown: i }) {
  const a = Y(null), l = dl({
    editor: t,
    selector: ({ editor: C }) => ({
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ I("form", { onSubmit: c, className: "link-popover-form", children: [
        /* @__PURE__ */ I("div", { className: "link-popover-input-wrapper", children: [
          /* @__PURE__ */ h($s, { className: "link-popover-icon", size: 16 }),
          /* @__PURE__ */ h(
            "input",
            {
              ref: s,
...
const AC = [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ h(vl, { size: 16, className: "text-green-400" }),
    command: (e) => e.chain().focus().toggleCallout({ type: "resources" }).run(),
    keywords: ["links", "reference", "reading"]
  },
  {
    title: "To-Do Callout",
    icon: /* @__PURE__ */ h(bl, { size: 16, className: "text-cyan-400" }),
  ...
  {
    title: "Wiki Link",
    icon: /* @__PURE__ */ h($s, { size: 16, className: "text-cyan-400" }),
    command: (e) => {
...
function _C({ editor: e }) {
  ...
  fo(() => {
    if (!t || !a) return;
    const { top: N, bottom: C, left: D } = a, L = window.innerHeight, P = window.innerWidth, O = L - C - Vr, $ = N - Vr;
    let W;
...
`) || $.includes("]]")) {
  ...
  if (fo(() => {
    if (!r || !u) return;
    const { top: D, bottom: L, left: P } = u, O = window.innerHeight, $ = window.innerWidth, W = O - L - Kr, V = D - Kr;
    let R;
      ...
      children: [
        ...
        N && /* @__PURE__ */ I(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ h("span", { className: "wikilink-icon", children: /* @__PURE__ */ h(Ks, { size: 14 }) }),
        ...
        /* @__PURE__ */ I("div", { className: "image-edit-popover-content", children: [
          /* @__PURE__ */ I("div", { className: "image-edit-popover-field", children: [
            /* @__PURE__ */ I("label", { className: "image-edit-popover-label", children: [
              /* @__PURE__ */ h(Fs, { className: "w-3.5 h-3.5" }),
        ...
        `,
          children: [
            /* @__PURE__ */ h("div", { className: "px-2 py-1.5", children: /* @__PURE__ */ I("div", { className: "flex items-center gap-2 bg-secondary/50 rounded-md px-2.5 py-1.5 border border-border/50", children: [
              /* @__PURE__ */ h(El, { size: 14, className: "text-muted-foreground shrink-0" }),
              /* @__PURE__ */ h(
                "input",
                {
                  ref: d,
          ...
          children: [
            /* @__PURE__ */ I("div", { className: "flex items-center justify-between px-3 py-2 border-b border-border bg-secondary/30", children: [
              /* @__PURE__ */ I("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
                m && /* @__PURE__ */ h(xl, { size: 12, className: "animate-spin" }),
...
const sl = Xu(
  ...
  const [Xt] = j(() => ZC()), [Zt, $o] = j(D), [Qt, Rt] = j(""), br = Y(D), wr = Y(""), An = Y(null), [yu, Ca] = j(0), xr = !!(re && re.length > 0 && fe), { state: Ye, executeAction: kr, abort: vu, reset: kt } = XC(fe), [bu, Ho] = j(null), [wu, xu] = j({ selectionTop: 0, selectionBottom: 0, selectionCenterX: 0 }), ku = Y(fe);
  ku.current = fe;
  const Ea = Y(Te);
  Ea.current = Te;
  const [Cu, Eu] = j([]), [Mu, Tu] = j(0), Su = F((se, Ce) => {
    Eu(se), Tu(Ce);
  }, []), Ma = Y(w), Ta = Y(E), Sa = Y(S), Da = Y(k), Na = Y(N), La = Y(H), Aa = Y(G), Ia = Y(z);
  Ma.current = w, Ta.current = E, Sa.current = S, Da.current = k, Na.current = N, La.current = H, Aa.current = G, Ia.current = z;
  const Ra = 2e3, [Bo, Du] = j(() => ae === "lightweight" ? !0 : ae === "full" ? !1 : t && typeof t == "string" ? Math.ceil(t.length / 80) > Ra : !1), Nu = Y(0), Pa = Y(Bo);
  Pa.current = Bo;
  const [Wo, Cr] = j(null), Lu = qk({
    placeholder: i,
    isMobile: Xt,
    maxImageSize: M,
    headingLevels: ve,
    ...
    callbackRefs: {
      onImageUploadStart: Ma,
      onImageUploadComplete: Ta,
    ...
    isLightweightRef: Pa
  }), [Au, Mr] = j(!1), [Iu, Ru] = j(!1), Pu = K !== void 0 ? K : Iu, Pt = F((se) => {
    Ru(se), B?.(se);
  }, [B]), [Ou, Tr] = j(0), [_u, $u] = j(""), Ot = eb(oe, {
    storageKey: y,
    debounceMs: v,
    enabled: m,
    onSave: (se) => {
  ...
  const _a = F((se, Ce) => {
    ...
    if (Ce) {
      ...
      Ge = { top: Re.bottom + 4, left: Re.left };
    } else {
      const { from: Re, to: et } = oe.state.selection, Jt = oe.view.coordsAtPos(Re), en = oe.view.coordsAtPos(et);
      Ge = { top: en.bottom + 8, left: (Jt.left + en.left) / 2 };
    }
    ...
    if (!Ge) return;
    const { from: Re, to: et } = oe.state.selection, Jt = Re !== et ? oe.state.doc.textBetween(Re, et, `
`) : "", en = Ge.scope === "document" || !Jt ? oe.getText() : Jt, Dr = oe.view.coordsAtPos(Re), In = oe.view.coordsAtPos(et);
    xu({
      selectionTop: Dr.top,
      selectionBottom: In.bottom,
      selectionCenterX: (Dr.left + In.right) / 2
    }), Ho(null), kr(se, Ge.label, en, { from: Re, to: et }, Ce);
  }, [oe, re, kr]), Wu = F(() => {
...
` + Ce).run(), kt();
    ...
    if (!(Ye.status !== "complete" && Ye.status !== "error"))
      if (Ye.status === "complete") {
        const { action: se, actionLabel: Ce, inputText: Ge, selectionRange: Re } = Ye;
        kt(), kr(se, Ce, Ge, Re);
      } else
        kt();
  }, [Ye, kt, kr]), $a = F(() => {
    ...
    if (Ge)
      ...
      const en = oe.state.doc.slice(se, Ce), Dr = Vf.fromSchema(oe.schema), In = document.createElement("div"), Fo = Dr.serializeFragment(en.content);
      In.appendChild(Fo), Re = In.innerHTML, et = oe.state.doc.textBetween(se, Ce, `
`);
    }
    const Jt = Fn(Er.turndown(Re));
    navigator.clipboard.writeText(Jt).catch(() => {
  ...
  const Ha = /* @__PURE__ */ h(
    Gv,
    {
      ...
      aiEnabled: xr || !!Te,
      onAISparklesClick: (se) => _a("document", se)
    }
  ...
  return /* @__PURE__ */ I("div", { className: `markdown-editor-container ${g === "neutral" ? "color-theme-neutral" : ""} ${c}`, "data-theme": p, children: [
    m && b && Ot.hasRecoverableContent && /* @__PURE__ */ h(
      vC,
      {
        onRecover: () => {
          Ot.recover();
    ...
    !Xt && /* @__PURE__ */ h(
      qv,
      {
        ...
        editorMode: Zt,
        rawMarkdown: Qt,
        onRawMarkdownChange: Oa,
        onMatchesChange: Su
      }
    ),
    /* @__PURE__ */ h(Qv, { editor: oe }),
    /* @__PURE__ */ I("div", { className: `editor-main-area ${ct ? "editor-with-toc" : ""}`, children: [
      ct && xt === "left" && /* @__PURE__ */ h(Wa, { fallback: null, children: /* @__PURE__ */ h(
        sl,
        {
          editor: oe,
          visible: It,
      ...
      /* @__PURE__ */ I(
        kC,
        {
          ...
          onRetry: () => Ca((se) => se + 1),
          onClearContent: () => {
            oe && oe.commands.clearContent(), n?.(""), r?.(""), o?.(""), Ca((se) => se + 1);
          },
          onError: me,
          children: [
            /* @__PURE__ */ h("div", { className: "editor-content-wrapper", ref: An, style: Uu, children: Zt === "wysiwyg" ? /* @__PURE__ */ I(ye, { children: [
              ...
              /* @__PURE__ */ h(
                KC,
                {
                  ...
                  aiEnabled: xr,
                  onAISetupRequired: Te,
                  onAISparklesClick: (se) => _a("selection", se),
                  onCopySelectionAsMarkdown: $a,
                  aiDropdown: bu,
                  aiActions: re,
                  onAIActionSelect: Bu,
                  ...
                  onImageDelete: () => {
                    oe.chain().focus().setNodeSelection(Wo.pos).deleteSelection().run(), Cr(null);
                  },
      ...
      ct && xt === "right" && /* @__PURE__ */ h(Wa, { fallback: null, children: /* @__PURE__ */ h(
        sl,
        {
          editor: oe,
          visible: It,
...
function J1({
  ...
  const [r, o] = j(t), s = zn[r] || zn.dark, i = F((l) => {
    zn[l] && o(l);
  }, []);
  q(() => {
      ...
      /* @__PURE__ */ I("div", { className: "code-block-language-wrapper", children: [
        /* @__PURE__ */ h(
          "select",
          {
            ...
            children: al.map(({ value: i, label: a }) => /* @__PURE__ */ h("option", { value: i, children: a }, i))
          }
        ),
...
const hu = "paragon-editor-toc-width", n1 = 280, mu = 200, gu = 500, $n = 30, il = 5;
function ll() {
  try {
...
const Os = wt(function({
  ...
  }, []), p = t.length * $n, g = Math.max(0, Math.floor(l / $n) - il), m = Math.min(
    t.length,
    Math.ceil((l + d) / $n) + il
  ), y = St(() => {
    const v = [];
  ...
  q(() => {
    const _ = (ne) => {
      if (!O.current) return;
      const de = f === "right" ? $.current - ne.clientX : ne.clientX - $.current, we = Math.min(gu, Math.max(mu, W.current + de));
      D(we);
    }, ee = () => {
  ...
  const H = F((_) => {
    ...
    const ne = M === _.id, de = _.children && _.children.length > 0, we = k.has(_.id);
    return /* @__PURE__ */ I("div", { children: [
      ...
      de && !we && /* @__PURE__ */ h("div", { className: "toc-children", children: _.children.map((ve) => U(ve, ee + 1)) })
    ] }, _.id);
