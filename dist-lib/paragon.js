...
import { ReactNodeViewRenderer as io, NodeViewWrapper as vn, NodeViewContent as Os, useEditorState as ic, useEditor as _d, EditorContent as $d } from "@tiptap/react";
import * as T from "react";
import X, { useState as U, useRef as V, useEffect as G, useCallback as B, useLayoutEffect as co, memo as jt, useImperativeHandle as Hd, createContext as cc, useContext as lc, useMemo as Ut, Component as Wd, useReducer as zd, forwardRef as Bd } from "react";
import Fd from "@tiptap/extension-code-block-lowlight";
import { createLowlight as Ud } from "lowlight";
import { ChevronDown as Nt, Check as Vt, Copy as Kt, Image as _s, X as pt, Link2 as $s, Type as lo, Undo as Yd, Redo as jd, Bold as Hs, Italic as Ws, Underline as zs, Strikethrough as Bs, Code as uc, Highlighter as dc, Link as Fs, List as Us, ListOrdered as Ys, CheckSquare as js, Quote as Vs, Code2 as fc, IndentIncrease as Vd, IndentDecrease as Kd, Table as ms, Minus as mc, Info as Kr, BookOpen as Ks, PenLine as Gd, Library as qd, ListTodo as Gs, Columns as Ya, Trash2 as un, Rows as ja, ToggleLeft as Va, ArrowUpDown as Xd, Sparkles as uo, Search as Zd, ChevronUp as Qd, MousePointerClick as Jd, CaseSensitive as ef, WholeWord as tf, Regex as nf, Replace as ps, ReplaceAll as rf, Plus as qs, ClipboardList as of, MessageSquareText as pc, StickyNote as hc, ChevronRight as gc, ChevronLeftIcon as sf, ChevronRightIcon as af, ChevronDownIcon as cf, Calendar as yc, Hash as Ka, Cloud as lf, Loader2 as vc, CloudOff as uf, AlertCircle as df, RotateCcw as Xs, Activity as ff, Maximize2 as bc, Minimize2 as wc, AlertTriangle as mf, CheckCircle2 as pf, Eye as hf, FileText as Zs, FileCode as gf, ExternalLink as yf, Pencil as vf, Unlink as bf, Heading1 as wf, Heading2 as xf, Heading3 as kf, Heading4 as Cf, Heading5 as Mf, ImagePlus as Tf, MessageSquare as xc, RefreshCw as Sf, SpellCheck as Ef, PanelRightClose as Df, PanelRightOpen as Nf } from "lucide-react";
import { Plugin as Ce, PluginKey as Me, TextSelection as Ve, NodeSelection as Af, AllSelection as Lf } from "@tiptap/pm/state";
...
import If from "highlight.js/lib/languages/css";
...
import { Fragment as Mc, Slice as Uo, DOMSerializer as _f } from "@tiptap/pm/model";
...
import { Extension as Fe, Node as mo, mergeAttributes as kn, InputRule as Oe, Mark as Tc } from "@tiptap/core";
...
import { findWrapping as Ga, canJoin as Zf } from "@tiptap/pm/transform";
import Qf from "@tiptap/extension-underline";
import Jf from "@tiptap/extension-subscript";
import em from "@tiptap/extension-superscript";
import tm from "@tiptap/extension-typography";
import nm from "@tiptap/extension-image";
import { createRoot as rm } from "react-dom/client";
...
import im from "@tiptap/extension-code";
import cm from "@tiptap/extension-bold";
import lm from "@tiptap/extension-italic";
import um from "@tiptap/extension-strike";
const ve = Ud();
...
function fm({ node: e, updateAttributes: t, extension: n }) {
  ...
  }, [e.textContent]), f = n.options.lowlight?.listLanguages?.() || [], p = Array.from(/* @__PURE__ */ new Set([...f, ...Object.keys(hs)])).sort(), g = u === "plaintext" ? "Plain Text" : u.charAt(0).toUpperCase() + u.slice(1);
...
function Sc({ isOpen: e, onClose: t, onInsert: n, position: r }) {
...
}, hm = T[" useInsertionEffect ".trim().toString()] || At;
function na({
  prop: e,
  defaultProp: t,
  onChange: n = () => {
...
// @__NO_SIDE_EFFECTS__
function Un(e) {
  const t = /* @__PURE__ */ bm(e), n = T.forwardRef((r, o) => {
    const { children: s, ...i } = r, a = T.Children.toArray(s), c = a.find(xm);
    if (c) {
...
var vm = /* @__PURE__ */ Un("Slot");
// @__NO_SIDE_EFFECTS__
function bm(e) {
  const t = T.forwardRef((n, r) => {
    const { children: o, ...s } = n;
    if (T.isValidElement(o)) {
      const i = Cm(o), a = km(s, o.props);
      return o.type !== T.Fragment && (a.ref = r ? po(r, i) : i), T.cloneElement(o, a);
    }
...
function wm(e) {
  ...
  return t.displayName = `${e}.Slottable`, t.__radixId = Ec, t;
}
function xm(e) {
  return T.isValidElement(e) && typeof e.type == "function" && "__radixId" in e.type && e.type.__radixId === Ec;
}
function km(e, t) {
  const n = { ...t };
  for (const r in t) {
...
var Tm = T.createContext(void 0);
function Ac(e) {
  const t = T.useContext(Tm);
  return e || t || "ltr";
}
function ht(e) {
  const t = T.useRef(e);
...
var Em = "DismissableLayer", gs = "dismissableLayer.update", Dm = "dismissableLayer.pointerDownOutside", Nm = "dismissableLayer.focusOutside", Qa, Lc = T.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: a,
      ...c
    } = e, l = T.useContext(Lc), [u, d] = T.useState(null), f = u?.ownerDocument ?? globalThis?.document, [, p] = T.useState({}), g = Re(t, (E) => d(E)), h = Array.from(l.layers), [y] = [...l.layersWithOutsidePointerEventsDisabled].slice(-1), b = h.indexOf(y), v = u ? h.indexOf(u) : -1, x = l.layersWithOutsidePointerEventsDisabled.size > 0, S = v >= b, w = Im((E) => {
...
ra.displayName = Em;
var Am = "DismissableLayerBranch", Lm = T.forwardRef((e, t) => {
  const n = T.useContext(Lc), r = T.useRef(null), o = Re(t, r);
  return T.useEffect(() => {
    const s = r.current;
    if (s)
...
function Rm(e, t = globalThis?.document) {
  ...
  return T.useEffect(() => {
    const o = (s) => {
      s.target && !r.current && Ic(Nm, n, { originalEvent: s }, {
        discrete: !1
      });
    };
...
function Ic(e, t, n, { discrete: r }) {
  const o = n.originalEvent.target, s = new CustomEvent(e, { bubbles: !1, cancelable: !0, detail: n });
  t && o.addEventListener(e, t, { once: !0 }), r ? Dc(o, s) : o.dispatchEvent(s);
}
var Yo = 0;
function Pm() {
  T.useEffect(() => {
    const e = document.querySelectorAll("[data-radix-focus-guard]");
    return document.body.insertAdjacentElement("afterbegin", e[0] ?? ei()), document.body.insertAdjacentElement("beforeend", e[1] ?? ei()), Yo++, () => {
...
var jo = "focusScope.autoFocusOnMount", Vo = "focusScope.autoFocusOnUnmount", ti = { bubbles: !1, cancelable: !0 }, Om = "FocusScope", Rc = T.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: o,
  ...
  T.useEffect(() => {
    ...
    if (a) {
      ...
      if (!a.contains(h)) {
        const b = new CustomEvent(jo, ti);
        a.addEventListener(jo, l), a.dispatchEvent(b), b.defaultPrevented || (_m(Bm(Pc(a)), { select: !0 }), document.activeElement === h && Et(a));
      }
      return () => {
        a.removeEventListener(jo, l), setTimeout(() => {
          const b = new CustomEvent(Vo, ti);
          a.addEventListener(Vo, u), a.dispatchEvent(b), b.defaultPrevented || Et(h ?? document.body, { select: !0 }), a.removeEventListener(Vo, u), ri.remove(p);
        }, 0);
      };
    }
  }, [a, l, u, p]);
  const g = T.useCallback(
    (h) => {
      ...
      if (y && b) {
        const v = h.currentTarget, [x, S] = $m(v);
...
Rc.displayName = Om;
function _m(e, { select: t = !1 } = {}) {
  const n = document.activeElement;
  for (const r of e)
    if (Et(r, { select: t }), document.activeElement !== n) return;
}
function $m(e) {
  const t = Pc(e), n = ni(t, e), r = ni(t.reverse(), e);
  return [n, r];
}
function Pc(e) {
...
function ni(e, t) {
  for (const n of e)
    if (!Hm(n, { upTo: t })) return n;
}
function Hm(e, { upTo: t }) {
...
var Fm = T[" useId ".trim().toString()] || (() => {
}), Um = 0;
function Gr(e) {
  const [t, n] = T.useState(Fm());
  return At(() => {
    n((r) => r ?? String(Um++));
  }, [e]), e || (t ? `radix-${t}` : "");
}
const Ym = ["top", "right", "bottom", "left"], Lt = Math.min, We = Math.max, qr = Math.round, Tr = Math.floor, ot = (e) => ({
  x: e,
  y: e
}), jm = {
  left: "right",
...
const si = ["left", "right"], ai = ["right", "left"], Xm = ["top", "bottom"], Zm = ["bottom", "top"];
function Qm(e, t, n) {
  switch (e) {
    case "top":
    case "bottom":
...
async function Yn(e, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: p = 0
  } = gt(t, e), g = Oc(p), y = a[f ? d === "floating" ? "reference" : "floating" : d], b = Zr(await s.getClippingRect({
...
const np = (e) => ({
  ...
  async fn(t) {
    ...
    const k = S / 2 - w / 2, N = E / 2 - h[g] / 2 - 1, M = Lt(d[b], N), D = Lt(d[v], N), L = M, P = E - h[g] - D, O = E / 2 - h[g] / 2 + k, H = ys(L, O, P), $ = !c.arrow && Mn(o) != null && O !== H && s.reference[g] / 2 - (O < L ? M : D) - h[g] / 2 < 0, K = $ ? O < L ? O - L : O - P : 0;
    return {
      [p]: f[p] + K,
      data: {
        [p]: H,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const b = yt(o), v = nt(a), x = yt(a) === a, S = await (c.isRTL == null ? void 0 : c.isRTL(l.floating)), w = f || (x || !h ? [Xr(a)] : qm(a)), C = g !== "none";
      !f && C && w.push(...Jm(a, h, g, S));
...
async function sp(e, t) {
  const {
    ...
    platform: r,
    elements: o
  } = e, s = await (r.isRTL == null ? void 0 : r.isRTL(o.floating)), i = yt(n), a = Mn(n), c = nt(n) === "y", l = _c.has(i) ? -1 : 1, u = s && c ? -1 : 1, d = gt(t, e);
  let {
    mainAxis: f,
    crossAxis: p,
    alignmentAxis: g
...
const ap = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (l) {
        var b, v;
        const x = f === "y" ? "width" : "height", S = _c.has(yt(o)), w = s.reference[d] - s.floating[x] + (S && ((b = i.offset) == null ? void 0 : b[d]) || 0) + (S ? 0 : y.crossAxis), C = s.reference[d] + s.reference[x] + (S ? 0 : ((v = i.offset) == null ? void 0 : v[d]) || 0) - (S ? y.crossAxis : 0);
        g < w ? g = w : g > C && (g = C);
      }
      return {
        [f]: p,
...
function $c(e) {
  return ho() ? e instanceof Node || e instanceof ze(e).Node : !1;
}
function Qe(e) {
  return ho() ? e instanceof Element || e instanceof ze(e).Element : !1;
}
function st(e) {
  return ho() ? e instanceof HTMLElement || e instanceof ze(e).HTMLElement : !1;
}
function ui(e) {
  return !ho() || typeof ShadowRoot > "u" ? !1 : e instanceof ShadowRoot || e instanceof ze(e).ShadowRoot;
}
...
function Zn(e) {
  ...
  return /auto|scroll|overlay|hidden|clip/.test(t + r + n) && !up.has(o);
}
const dp = /* @__PURE__ */ new Set(["table", "td", "th"]);
function fp(e) {
  return dp.has(Tn(e));
}
...
const pp = ["transform", "translate", "scale", "rotate", "perspective"], hp = ["transform", "translate", "scale", "rotate", "perspective", "filter"], gp = ["paint", "layout", "strict", "content"];
function ia(e) {
  const t = ca(), n = Qe(e) ? Je(e) : e;
  return pp.some((r) => n[r] ? n[r] !== "none" : !1) || (n.containerType ? n.containerType !== "normal" : !1) || !t && (n.backdropFilter ? n.backdropFilter !== "none" : !1) || !t && (n.filter ? n.filter !== "none" : !1) || hp.some((r) => (n.willChange || "").includes(r)) || gp.some((r) => (n.contain || "").includes(r));
}
function yp(e) {
  let t = It(e);
  for (; st(t) && !bn(t); ) {
...
function Hc(e) {
  const t = It(e);
  return bn(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : st(t) && Zn(t) ? t : Hc(t);
}
function jn(e, t, n) {
  var r;
  t === void 0 && (t = []), n === void 0 && (n = !0);
  const o = Hc(e), s = o === ((r = e.ownerDocument) == null ? void 0 : r.body), i = ze(o);
  if (s) {
    const a = bs(i);
...
const bp = /* @__PURE__ */ ot(0);
function zc(e) {
  const t = ze(e);
  return !ca() || !t.visualViewport ? bp : {
...
function Yt(e, t, n, r) {
  ...
  if (s) {
    ...
    for (; h && r && p !== g; ) {
      ...
      c *= y.x, l *= y.y, u *= y.x, d *= y.y, c += x, l += S, g = ze(h), h = bs(g);
    }
  }
  return Zr({
    width: u,
...
function Bc(e, t) {
  const n = e.getBoundingClientRect(), r = n.left + t.scrollLeft - vo(e, n), o = n.top + t.scrollTop;
  return {
    x: r,
    y: o
  };
...
function xp(e) {
  ...
  const s = o === "fixed", i = at(r), a = t ? go(t.floating) : !1;
  if (r === i || a && s)
    return n;
  let c = {
    scrollLeft: 0,
  ...
  const u = ot(0), d = st(r);
  if ((d || !d && !s) && ((Tn(r) !== "body" || Zn(i)) && (c = yo(r)), st(r))) {
    const p = Yt(r);
    l = dn(r), u.x = p.x + r.clientLeft, u.y = p.y + r.clientTop;
  }
  const f = i && !d && !s ? Bc(i, c) : ot(0);
  return {
    width: n.width * l.x,
    height: n.height * l.y,
...
function Cp(e) {
  const t = at(e), n = yo(e), r = e.ownerDocument.body, o = We(t.scrollWidth, t.clientWidth, r.scrollWidth, r.clientWidth), s = We(t.scrollHeight, t.clientHeight, r.scrollHeight, r.clientHeight);
...
function Fc(e, t) {
  const n = It(e);
  return n === t || !Qe(n) || bn(n) ? !1 : Je(n).position === "fixed" || Fc(n, t);
}
function Ep(e, t) {
  const n = t.get(e);
  if (n)
  ...
  for (; Qe(i) && !bn(i); ) {
    const a = Je(i), c = ia(i);
    !c && a.position === "fixed" && (o = null), (s ? !c && !o : !c && a.position === "static" && !!o && Tp.has(o.position) || Zn(i) && !c && Fc(e, i)) ? r = r.filter((u) => u !== i) : o = a, i = It(i);
  }
  return t.set(e, r), r;
}
function Dp(e) {
  ...
  const i = [...n === "clippingAncestors" ? go(t) ? [] : Ep(t, this._c) : [].concat(n), r], a = i[0], c = i.reduce((l, u) => {
    const d = fi(t, u, o);
...
function Ap(e, t, n) {
  ...
  if (r || !r && !s)
    if ((Tn(t) !== "body" || Zn(o)) && (a = yo(t)), r) {
      const p = Yt(t, !0, s, t);
      c.x = p.x + t.clientLeft, c.y = p.y + t.clientTop;
    } else o && l();
  s && !r && o && l();
  const u = o && !r && !s ? Bc(o, a) : ot(0), d = i.left + a.scrollLeft - c.x - u.x, f = i.top + a.scrollTop - c.y - u.y;
  return {
    x: d,
    y: f,
    width: i.width,
...
function Uc(e, t) {
  ...
  for (; r && fp(r) && Ko(r); )
    r = mi(r, t);
  return r && bn(r) && Ko(r) && !ia(r) ? n : r || yp(e) || n;
}
const Lp = async function(e) {
  const t = this.getOffsetParent || Uc, n = this.getDimensions, r = await n(e.floating);
  return {
...
function Pp(e, t) {
  ...
  function i(a, c) {
    ...
    function w(C) {
      ...
      E === 1 && !Yc(l, e.getBoundingClientRect()) && i(), S = !1;
    }
    try {
...
function Op(e, t, n, r) {
  ...
  function y() {
    const b = Yt(e);
    h && !Yc(h, b) && n(), h = b, g = requestAnimationFrame(y);
  }
  return n(), () => {
    var b;
    u.forEach((v) => {
...
const _p = ap, $p = ip, Hp = rp, Wp = lp, zp = op, pi = np, Bp = cp, Fp = (e, t, n) => {
...
var Up = typeof document < "u", Yp = function() {
}, Fr = Up ? co : Yp;
function Qr(e, t) {
  if (e === t)
    return !0;
...
function jp(e) {
  ...
  const [g, h] = T.useState(null), [y, b] = T.useState(null), v = T.useCallback((R) => {
  ...
  }, []), S = s || g, w = i || y, C = T.useRef(null), E = T.useRef(null), k = T.useRef(u), N = c != null, M = Go(c), D = Go(o), L = Go(l), P = T.useCallback(() => {
    ...
    D.current && (R.platform = D.current), Fp(C.current, E.current, R).then((A) => {
      const _ = {
        ...A,
      ...
      O.current && !Qr(k.current, _) && (k.current = _, Cc.flushSync(() => {
        d(_);
      }));
    });
  }, [f, t, n, D, L]);
...
var eh = "Arrow", Vc = T.forwardRef((e, t) => {
...
var ua = "Popper", [Kc, bo] = Cn(ua), [rh, Gc] = Kc(ua), qc = (e) => {
  const { __scopePopper: t, children: n } = e, [r, o] = T.useState(null);
  return /* @__PURE__ */ m(rh, { scope: t, anchor: r, onAnchorChange: o, children: n });
};
qc.displayName = ua;
var Xc = "PopperAnchor", Zc = T.forwardRef(
  (e, t) => {
    const { __scopePopper: n, virtualRef: r, ...o } = e, s = Gc(Xc, n), i = T.useRef(null), a = Re(t, i), c = T.useRef(null);
    return T.useEffect(() => {
      const l = c.current;
...
Zc.displayName = Xc;
var da = "PopperContent", [oh, sh] = Kc(da), Qc = T.forwardRef(
  (e, t) => {
    const {
      __scopePopper: n,
      side: r = "bottom",
      ...
      onPlaced: g,
      ...h
    } = e, y = Gc(da, n), [b, v] = T.useState(null), x = Re(t, (F) => v(F)), [S, w] = T.useState(null), C = nh(S), E = C?.width ?? 0, k = C?.height ?? 0, N = r + (s !== "center" ? "-" + s : ""), M = typeof u == "number" ? u : { top: 0, right: 0, bottom: 0, left: 0, ...u }, D = Array.isArray(l) ? l : [l], L = D.length > 0, P = {
      padding: M,
      boundary: D.filter(ih),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: L
    }, { refs: O, floatingStyles: H, placement: $, isPositioned: K, middlewareData: R } = jp({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: N,
      whileElementsMounted: (...F) => Op(...F, {
      ...
      middleware: [
        Kp({ mainAxis: o + k, alignmentAxis: i }),
        c && Gp({
          mainAxis: !0,
          crossAxis: !1,
        ...
        ch({ arrowWidth: E, arrowHeight: k }),
        f && Qp({ strategy: "referenceHidden", ...P })
      ]
    }), [A, _] = tl($), Y = ht(g);
    At(() => {
      K && Y?.();
...
Qc.displayName = da;
var Jc = "PopperArrow", ah = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, el = T.forwardRef(function(t, n) {
  const { __scopePopper: r, ...o } = t, s = sh(Jc, r), i = ah[s.placedSide];
  return (
...
var ch = (e) => ({
  ...
  options: e,
  fn(t) {
    const { placement: n, rects: r, middlewareData: o } = t, i = o.arrow?.centerOffset !== 0, a = i ? 0 : e.arrowWidth, c = i ? 0 : e.arrowHeight, [l, u] = tl(n), d = { start: "0%", center: "50%", end: "100%" }[u], f = (o.arrow?.x ?? 0) + a / 2, p = (o.arrow?.y ?? 0) + c / 2;
    let g = "", h = "";
...
var nl = qc, rl = Zc, ol = Qc, sl = el, lh = "Portal", fa = T.forwardRef((e, t) => {
  const { container: n, ...r } = e, [o, s] = T.useState(!1);
  At(() => s(!0), []);
  const i = n || o && globalThis?.document?.body;
  return i ? Pf.createPortal(/* @__PURE__ */ m(Le.div, { ...r, ref: t }), i) : null;
});
fa.displayName = lh;
function uh(e, t) {
...
var Gt = (e) => {
  const { present: t, children: n } = e, r = dh(t), o = typeof n == "function" ? n({ present: r.isPresent }) : T.Children.only(n), s = Re(r.ref, fh(o));
  return typeof n == "function" || r.isPresent ? T.cloneElement(o, { ref: s }) : null;
};
Gt.displayName = "Presence";
function dh(e) {
  const [t, n] = T.useState(), r = T.useRef(null), o = T.useRef(e), s = T.useRef("none"), i = e ? "mounted" : "unmounted", [a, c] = uh(i, {
    mounted: {
      UNMOUNT: "unmounted",
...
var qo = "rovingFocusGroup.onEntryFocus", mh = { bubbles: !1, cancelable: !0 }, Qn = "RovingFocusGroup", [ws, al, ph] = Nc(Qn), [hh, il] = Cn(
  Qn,
  [ph]
), [gh, yh] = hh(Qn), cl = T.forwardRef(
  (e, t) => /* @__PURE__ */ m(ws.Provider, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ m(ws.Slot, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ m(vh, { ...e, ref: t }) }) })
);
cl.displayName = Qn;
var vh = T.forwardRef((e, t) => {
  const {
    ...
    ...d
  } = e, f = T.useRef(null), p = Re(t, f), g = Ac(s), [h, y] = na({
    prop: i,
    defaultProp: a ?? null,
    onChange: c,
    caller: Qn
  }), [b, v] = T.useState(!1), x = ht(l), S = al(n), w = T.useRef(!1), [C, E] = T.useState(0);
  return T.useEffect(() => {
    const k = f.current;
    if (k)
...
}), ll = "RovingFocusGroupItem", ul = T.forwardRef(
  (e, t) => {
    const {
      __scopeRovingFocusGroup: n,
      focusable: r = !0,
      ...
      children: i,
      ...a
    } = e, c = Gr(), l = s || c, u = yh(ll, n), d = u.currentTabStopId === l, f = al(n), { onFocusableItemAdd: p, onFocusableItemRemove: g, currentTabStopId: h } = u;
    return T.useEffect(() => {
      if (r)
        return p(), () => g();
    }, [r, p, g]), /* @__PURE__ */ m(
        ...
        children: /* @__PURE__ */ m(
          Le.span,
          {
            ...
            onKeyDown: ie(e.onKeyDown, (y) => {
              ...
              const b = xh(y, u.orientation, u.dir);
              if (b !== void 0) {
...
var Ch = cl, Mh = ul, Th = function(e) {
  if (typeof document > "u")
    return null;
  var t = Array.isArray(e) ? e[0] : e;
  return t.ownerDocument.body;
}, tn = /* @__PURE__ */ new WeakMap(), Er = /* @__PURE__ */ new WeakMap(), Dr = {}, Xo = 0, fl = function(e) {
  ...
  return u(t), a.clear(), Xo++, function() {
    ...
    }), Xo--, Xo || (tn = /* @__PURE__ */ new WeakMap(), tn = /* @__PURE__ */ new WeakMap(), Er = /* @__PURE__ */ new WeakMap(), Dr = {});
  };
}, Dh = function(e, t, n) {
...
var Ur = "right-scroll-bar-position", Yr = "width-before-scroll-bar", Ah = "with-scroll-bars-hidden", Lh = "--removed-body-scroll-bar-size";
function Zo(e, t) {
...
var Rh = typeof window < "u" ? T.useLayoutEffect : T.useEffect, gi = /* @__PURE__ */ new WeakMap();
function Ph(e, t) {
  var n = Ih(null, function(r) {
...
pl.isSideCarExport = !0;
function Hh(e, t) {
  return e.useMedium(t), pl;
}
var hl = $h(), Qo = function() {
}, wo = T.forwardRef(function(e, t) {
  var n = T.useRef(null), r = T.useState({
    onScrollCapture: Qo,
    onWheelCapture: Qo,
    onTouchMoveCapture: Qo
  }), o = r[0], s = r[1], i = e.forwardProps, a = e.children, c = e.className, l = e.removeScrollBar, u = e.enabled, d = e.shards, f = e.sideCar, p = e.noRelative, g = e.noIsolation, h = e.inert, y = e.allowPinchZoom, b = e.as, v = b === void 0 ? "div" : b, x = e.gapMode, S = ml(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), w = f, C = Ph([n, t]), E = tt(tt({}, S), o);
  return T.createElement(
    T.Fragment,
    null,
    u && T.createElement(w, { sideCar: hl, removeScrollBar: l, shards: d, noRelative: p, noIsolation: g, inert: h, setCallbacks: s, allowPinchZoom: !!y, lockRef: n, gapMode: x }),
...
}, Gh = gl(), fn = "data-scroll-locked", qh = function(e, t, n, r) {
...
`);
  ...
  return T.createElement(Gh, { styles: qh(s, !t, o, n ? "" : "!important") });
}, xs = !1;
if (typeof window < "u")
  try {
...
var nn = xs ? { passive: !1 } : !1, Qh = function(e) {
  ...
  return (
    ...
    !(n.overflowY === n.overflowX && !Qh(e) && n[t] === "visible")
  );
}, Jh = function(e) {
  ...
  var s = rg(e, window.getComputedStyle(t).direction), i = s * r, a = n.target, c = t.contains(a), l = !1, u = i > 0, d = 0, f = 0;
  do {
    if (!a)
      break;
    var p = bl(e, a), g = p[0], h = p[1], y = p[2], b = h - y - s * g;
    (g || b) && vl(e, a) && (d += b, f += g);
    var v = a.parentNode;
...
function cg(e) {
  var t = T.useRef([]), n = T.useRef([0, 0]), r = T.useRef(), o = T.useState(ig++)[0], s = T.useState(gl)[0], i = T.useRef(e);
  T.useEffect(function() {
    i.current = e;
  }, [e]), T.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(o));
      var h = Nh([e.lockRef.current], (e.shards || []).map(wi), !0).filter(Boolean);
  ...
  var a = T.useCallback(function(h, y) {
    ...
    var x = { name: h, delta: y, target: b, should: v, shadowParent: lg(b) };
  ...
  return T.createElement(
    T.Fragment,
    null,
    g ? T.createElement(s, { styles: ag(o) }) : null,
    p ? T.createElement(Zh, { noRelative: e.noRelative, gapMode: e.gapMode }) : null
  );
}
function lg(e) {
...
const ug = Hh(hl, cg);
var wl = T.forwardRef(function(e, t) {
  return T.createElement(wo, tt({}, e, { ref: t, sideCar: ug }));
});
wl.classNames = wo.classNames;
var ks = ["Enter", " "], dg = ["ArrowDown", "PageUp", "Home"], xl = ["ArrowUp", "PageDown", "End"], fg = [...dg, ...xl], mg = {
  ltr: [...ks, "ArrowRight"],
  rtl: [...ks, "ArrowLeft"]
}, pg = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, Jn = "Menu", [Vn, hg, gg] = Nc(Jn), [qt, kl] = Cn(Jn, [
  gg,
  bo,
  il
]), xo = bo(), Cl = il(), [yg, Xt] = qt(Jn), [vg, er] = qt(Jn), Ml = (e) => {
  const { __scopeMenu: t, open: n = !1, children: r, dir: o, onOpenChange: s, modal: i = !0 } = e, a = xo(t), [c, l] = T.useState(null), u = T.useRef(!1), d = ht(s), f = Ac(o);
  return T.useEffect(() => {
    const p = () => {
  ...
  }, []), /* @__PURE__ */ m(nl, { ...a, children: /* @__PURE__ */ m(
    yg,
    {
      scope: t,
      open: n,
...
Ml.displayName = Jn;
var bg = "MenuAnchor", ma = T.forwardRef(
  (e, t) => {
...
ma.displayName = bg;
var pa = "MenuPortal", [wg, Tl] = qt(pa, {
  forceMount: void 0
}), Sl = (e) => {
  const { __scopeMenu: t, forceMount: n, children: r, container: o } = e, s = Xt(pa, t);
  return /* @__PURE__ */ m(wg, { scope: t, forceMount: n, children: /* @__PURE__ */ m(Gt, { present: n || s.open, children: /* @__PURE__ */ m(fa, { asChild: !0, container: o, children: r }) }) });
};
Sl.displayName = pa;
var Ke = "MenuContent", [xg, ha] = qt(Ke), El = T.forwardRef(
  (e, t) => {
    const n = Tl(Ke, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, s = Xt(Ke, e.__scopeMenu), i = er(Ke, e.__scopeMenu);
    return /* @__PURE__ */ m(Vn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ m(Gt, { present: r || s.open, children: /* @__PURE__ */ m(Vn.Slot, { scope: e.__scopeMenu, children: i.modal ? /* @__PURE__ */ m(kg, { ...o, ref: t }) : /* @__PURE__ */ m(Cg, { ...o, ref: t }) }) }) });
  }
), kg = T.forwardRef(
  (e, t) => {
...
}), Mg = /* @__PURE__ */ Un("MenuContent.ScrollLock"), ga = T.forwardRef(
  (e, t) => {
    const {
      __scopeMenu: n,
      loop: r = !1,
      ...
      ...h
    } = e, y = Xt(Ke, n), b = er(Ke, n), v = xo(n), x = Cl(n), S = hg(n), [w, C] = T.useState(null), E = T.useRef(null), k = Re(t, E, y.onContentChange), N = T.useRef(0), M = T.useRef(""), D = T.useRef(0), L = T.useRef(null), P = T.useRef("right"), O = T.useRef(0), H = g ? wl : T.Fragment, $ = g ? { as: Mg, allowPinchZoom: !0 } : void 0, K = (A) => {
      const _ = M.current + A, Y = S().filter((F) => !F.disabled), j = document.activeElement, q = Y.find((F) => F.ref.current === j)?.textValue, Z = Y.map((F) => F.textValue), W = _g(Z, _, q), z = Y.find((F) => F.textValue === W)?.ref.current;
      (function F(Q) {
        M.current = Q, window.clearTimeout(N.current), Q !== "" && (N.current = window.setTimeout(() => F(""), 1e3));
      })(_), z && setTimeout(() => z.focus());
    };
    T.useEffect(() => () => window.clearTimeout(N.current), []), Pm();
    const R = T.useCallback((A) => P.current === L.current?.side && Hg(A, L.current?.area), []);
    return /* @__PURE__ */ m(
      xg,
      {
        scope: n,
                    ...
                    children: /* @__PURE__ */ m(
                      ol,
                      {
                        ...
                        onKeyDown: ie(h.onKeyDown, (A) => {
                          ...
                          const Z = E.current;
                          if (A.target !== Z || !fg.includes(A.key)) return;
                          A.preventDefault();
                          const z = S().filter((F) => !F.disabled).map((F) => F.ref.current);
                          xl.includes(A.key) && z.reverse(), Pg(z);
                        }),
...
El.displayName = Ke;
var Tg = "MenuGroup", ya = T.forwardRef(
  (e, t) => {
...
ya.displayName = Tg;
var Sg = "MenuLabel", Dl = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
...
Dl.displayName = Sg;
var Jr = "MenuItem", xi = "menu.itemSelect", ko = T.forwardRef(
  (e, t) => {
    const { disabled: n = !1, onSelect: r, ...o } = e, s = T.useRef(null), i = er(Jr, e.__scopeMenu), a = ha(Jr, e.__scopeMenu), c = Re(t, s), l = T.useRef(!1), u = () => {
      const d = s.current;
      if (!n && d) {
        const f = new CustomEvent(xi, { bubbles: !0, cancelable: !0 });
        d.addEventListener(xi, (p) => r?.(p), { once: !0 }), Dc(d, f), f.defaultPrevented ? l.current = !1 : i.onClose();
      }
    };
    return /* @__PURE__ */ m(
      Nl,
...
var Nl = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, disabled: r = !1, textValue: o, ...s } = e, i = ha(Jr, n), a = Cl(n), c = T.useRef(null), l = Re(t, c), [u, d] = T.useState(!1), [f, p] = T.useState("");
    return T.useEffect(() => {
      const g = c.current;
      ...
      Vn.ItemSlot,
      {
        ...
        disabled: r,
        textValue: o ?? f,
        children: /* @__PURE__ */ m(Mh, { asChild: !0, ...a, focusable: !r, children: /* @__PURE__ */ m(
          Le.div,
          {
            role: "menuitem",
...
), Eg = "MenuCheckboxItem", Al = T.forwardRef(
  (e, t) => {
    const { checked: n = !1, onCheckedChange: r, ...o } = e;
    return /* @__PURE__ */ m(Ol, { scope: e.__scopeMenu, checked: n, children: /* @__PURE__ */ m(
      ko,
      {
...
Al.displayName = Eg;
var Ll = "MenuRadioGroup", [Dg, Ng] = qt(
  Ll,
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ m(Dg, { scope: e.__scopeMenu, value: n, onValueChange: s, children: /* @__PURE__ */ m(ya, { ...o, ref: t }) });
  }
);
Il.displayName = Ll;
var Rl = "MenuRadioItem", Pl = T.forwardRef(
  (e, t) => {
    const { value: n, ...r } = e, o = Ng(Rl, e.__scopeMenu), s = n === o.value;
    return /* @__PURE__ */ m(Ol, { scope: e.__scopeMenu, checked: s, children: /* @__PURE__ */ m(
      ko,
      {
        role: "menuitemradio",
        "aria-checked": s,
...
Pl.displayName = Rl;
var va = "MenuItemIndicator", [Ol, Ag] = qt(
  va,
  { checked: !1 }
), _l = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, forceMount: r, ...o } = e, s = Ag(va, n);
    return /* @__PURE__ */ m(
      Gt,
      {
...
_l.displayName = va;
var Lg = "MenuSeparator", $l = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
    return /* @__PURE__ */ m(
      Le.div,
...
$l.displayName = Lg;
var Ig = "MenuArrow", Hl = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e, o = xo(n);
...
Hl.displayName = Ig;
var Rg = "MenuSub", [R1, Wl] = qt(Rg), _n = "MenuSubTrigger", zl = T.forwardRef(
  (e, t) => {
    const n = Xt(_n, e.__scopeMenu), r = er(_n, e.__scopeMenu), o = Wl(_n, e.__scopeMenu), s = ha(_n, e.__scopeMenu), i = T.useRef(null), { pointerGraceTimerRef: a, onPointerGraceIntentChange: c } = s, l = { __scopeMenu: e.__scopeMenu }, u = T.useCallback(() => {
    ...
    return T.useEffect(() => u, [u]), T.useEffect(() => {
      ...
      Nl,
      {
        ...
        onKeyDown: ie(e.onKeyDown, (d) => {
          ...
          e.disabled || f && d.key === " " || mg[r.dir].includes(d.key) && (n.onOpenChange(!0), n.content?.focus(), d.preventDefault());
        })
      }
    ) });
  }
...
zl.displayName = _n;
var Bl = "MenuSubContent", Fl = T.forwardRef(
  (e, t) => {
    const n = Tl(Ke, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, s = Xt(Ke, e.__scopeMenu), i = er(Ke, e.__scopeMenu), a = Wl(Bl, e.__scopeMenu), c = T.useRef(null), l = Re(t, c);
    return /* @__PURE__ */ m(Vn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ m(Gt, { present: r || s.open, children: /* @__PURE__ */ m(Vn.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ m(
      ga,
      {
        ...
        onKeyDown: ie(e.onKeyDown, (u) => {
          const d = u.currentTarget.contains(u.target), f = pg[i.dir].includes(u.key);
...
var Wg = Ml, zg = ma, Bg = Sl, Fg = El, Ug = ya, Yg = Dl, jg = ko, Vg = Al, Kg = Il, Gg = Pl, qg = _l, Xg = $l, Zg = Hl, Qg = zl, Jg = Fl, Co = "DropdownMenu", [ey] = Cn(
  Co,
  [kl]
), Pe = kl(), [ty, Yl] = ey(Co), jl = (e) => {
  const {
...
jl.displayName = Co;
var Vl = "DropdownMenuTrigger", Kl = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, disabled: r = !1, ...o } = e, s = Yl(Vl, n), i = Pe(n);
    return /* @__PURE__ */ m(zg, { asChild: !0, ...i, children: /* @__PURE__ */ m(
      Le.button,
      {
        type: "button",
        id: s.triggerId,
...
Kl.displayName = Vl;
var ny = "DropdownMenuPortal", Gl = (e) => {
  const { __scopeDropdownMenu: t, ...n } = e, r = Pe(t);
  return /* @__PURE__ */ m(Bg, { ...r, ...n });
};
Gl.displayName = ny;
var ql = "DropdownMenuContent", Xl = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Yl(ql, n), s = Pe(n), i = T.useRef(!1);
    return /* @__PURE__ */ m(
      Fg,
      {
        id: o.contentId,
...
Xl.displayName = ql;
var ry = "DropdownMenuGroup", oy = T.forwardRef(
  (e, t) => {
...
oy.displayName = ry;
var sy = "DropdownMenuLabel", ay = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
...
ay.displayName = sy;
var iy = "DropdownMenuItem", Zl = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
...
Zl.displayName = iy;
var cy = "DropdownMenuCheckboxItem", ly = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(Vg, { ...o, ...r, ref: t });
});
ly.displayName = cy;
var uy = "DropdownMenuRadioGroup", dy = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(Kg, { ...o, ...r, ref: t });
});
dy.displayName = uy;
var fy = "DropdownMenuRadioItem", my = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(Gg, { ...o, ...r, ref: t });
});
my.displayName = fy;
var py = "DropdownMenuItemIndicator", hy = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(qg, { ...o, ...r, ref: t });
});
hy.displayName = py;
var gy = "DropdownMenuSeparator", Ql = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(Xg, { ...o, ...r, ref: t });
});
Ql.displayName = gy;
var yy = "DropdownMenuArrow", vy = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
...
vy.displayName = yy;
var by = "DropdownMenuSubTrigger", wy = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(Qg, { ...o, ...r, ref: t });
});
wy.displayName = by;
var xy = "DropdownMenuSubContent", ky = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(
    Jg,
    {
...
ky.displayName = xy;
var Cy = jl, My = Kl, Ty = Gl, Sy = Xl, Ey = Zl, Dy = Ql;
function Jl(e) {
  var t, n, r = "";
...
const wa = "-", Ny = (e) => {
  ...
  return {
    getClassGroupId: (i) => {
      const a = i.split(wa);
      return a[0] === "" && a.length !== 1 && a.shift(), tu(a, t) || Ay(i);
    },
  ...
  let r = (o) => {
    ...
    const u = s.length === 0 ? o : o.substring(c), d = _y(u), f = d !== u, p = l && l > c ? l - c : void 0;
    return {
      modifiers: s,
  ...
  return r;
}, _y = (e) => e.endsWith(Ms) ? e.substring(0, e.length - 1) : e.startsWith(Ms) ? e.substring(1) : e, $y = (e) => {
  ...
  for (let l = a.length - 1; l >= 0; l -= 1) {
    ...
    const v = s(f).join(":"), x = p ? v + Ms : v, S = x + b;
    if (i.includes(S))
      continue;
    i.push(S);
    const w = o(b, y);
...
function Fy(e, ...t) {
  ...
  function i(c) {
    ...
    return n = Hy(l), r = n.cache.get, o = n.cache.set, s = a, a(c);
  }
  function a(c) {
    const l = r(c);
    if (l)
  ...
  return function() {
    return s(By.apply(null, arguments));
  };
}
const Se = (e) => {
  const t = (n) => n[e] || [];
  return t.isThemeGetter = !0, t;
}, ru = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, ou = /^\((?:(\w[\w-]*):)?(.+)\)$/i, Uy = /^\d+\/\d+$/, Yy = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, jy = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, Vy = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, Ky = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, Gy = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, on = (e) => Uy.test(e), ce = (e) => !!e && !Number.isNaN(Number(e)), Mt = (e) => !!e && Number.isInteger(Number(e)), es = (e) => e.endsWith("%") && ce(e.slice(0, -1)), ct = (e) => Yy.test(e), qy = () => !0, Xy = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  jy.test(e) && !Vy.test(e)
), su = () => !1, Zy = (e) => Ky.test(e), Qy = (e) => Gy.test(e), Jy = (e) => !J(e) && !ee(e), ev = (e) => Sn(e, cu, su), J = (e) => ru.test(e), $t = (e) => Sn(e, lu, Xy), ts = (e) => Sn(e, sv, ce), Mi = (e) => Sn(e, au, su), tv = (e) => Sn(e, iu, Qy), Lr = (e) => Sn(e, uu, Zy), ee = (e) => ou.test(e), Rn = (e) => En(e, lu), nv = (e) => En(e, av), Ti = (e) => En(e, au), rv = (e) => En(e, cu), ov = (e) => En(e, iu), Ir = (e) => En(e, uu, !0), Sn = (e, t, n) => {
  const r = ru.exec(e);
  return r ? r[1] ? t(r[1]) : n(r[2]) : !1;
}, En = (e, t, n = !1) => {
  const r = ou.exec(e);
  return r ? r[1] ? t(r[1]) : n : !1;
}, au = (e) => e === "position" || e === "percentage", iu = (e) => e === "image" || e === "url", cu = (e) => e === "length" || e === "size" || e === "bg-size", lu = (e) => e === "length", sv = (e) => e === "number", av = (e) => e === "family-name", uu = (e) => e === "shadow", iv = () => {
  const e = Se("color"), t = Se("font"), n = Se("text"), r = Se("font-weight"), o = Se("tracking"), s = Se("leading"), i = Se("breakpoint"), a = Se("container"), c = Se("spacing"), l = Se("radius"), u = Se("shadow"), d = Se("inset-shadow"), f = Se("text-shadow"), p = Se("drop-shadow"), g = Se("blur"), h = Se("perspective"), y = Se("aspect"), b = Se("ease"), v = Se("animate"), x = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], S = () => [
    ...
    ee,
    J
  ], Z = () => ["", ce, Rn, $t], W = () => ["solid", "dashed", "dotted", "double"], z = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], F = () => [ce, es, Ti, Mi], Q = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    g,
...
const Si = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, Ei = eu, lv = (e, t) => (n) => {
  var r;
...
function Dt({
  ...
  return /* @__PURE__ */ m(
    ...
    {
      "data-slot": "button",
      className: ae(Ss({ variant: t, size: n, className: e })),
      ...o
    }
  );
}
var uv = Object.freeze({
  ...
  whiteSpace: "nowrap",
  wordWrap: "normal"
}), dv = "VisuallyHidden", du = T.forwardRef(
  (e, t) => /* @__PURE__ */ m(
    Le.span,
    {
      ...e,
...
du.displayName = dv;
var fv = du, [Mo] = Cn("Tooltip", [
  bo
]), To = bo(), fu = "TooltipProvider", mv = 700, Es = "tooltip.open", [pv, xa] = Mo(fu), mu = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = mv,
...
mu.displayName = fu;
var Gn = "Tooltip", [hv, tr] = Mo(Gn), pu = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: r,
    ...
    delayDuration: a
  } = e, c = xa(Gn, e.__scopeTooltip), l = To(t), [u, d] = T.useState(null), f = Gr(), p = T.useRef(0), g = i ?? c.disableHoverableContent, h = a ?? c.delayDuration, y = T.useRef(!1), [b, v] = na({
    prop: r,
    defaultProp: o ?? !1,
    onChange: (E) => {
  ...
  }, []), /* @__PURE__ */ m(nl, { ...l, children: /* @__PURE__ */ m(
    hv,
    {
      scope: t,
      contentId: f,
...
pu.displayName = Gn;
var Ds = "TooltipTrigger", hu = T.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...r } = e, o = tr(Ds, n), s = xa(Ds, n), i = To(n), a = T.useRef(null), c = Re(t, a, o.onTriggerChange), l = T.useRef(!1), u = T.useRef(!1), d = T.useCallback(() => l.current = !1, []);
    return T.useEffect(() => () => document.removeEventListener("pointerup", d), [d]), /* @__PURE__ */ m(rl, { asChild: !0, ...i, children: /* @__PURE__ */ m(
      Le.button,
      {
...
hu.displayName = Ds;
var ka = "TooltipPortal", [gv, yv] = Mo(ka, {
  forceMount: void 0
}), gu = (e) => {
  const { __scopeTooltip: t, forceMount: n, children: r, container: o } = e, s = tr(ka, t);
  return /* @__PURE__ */ m(gv, { scope: t, forceMount: n, children: /* @__PURE__ */ m(Gt, { present: n || s.open, children: /* @__PURE__ */ m(fa, { asChild: !0, container: o, children: r }) }) });
};
gu.displayName = ka;
var wn = "TooltipContent", yu = T.forwardRef(
  (e, t) => {
    const n = yv(wn, e.__scopeTooltip), { forceMount: r = n.forceMount, side: o = "top", ...s } = e, i = tr(wn, e.__scopeTooltip);
    return /* @__PURE__ */ m(Gt, { present: r || i.open, children: i.disableHoverableContent ? /* @__PURE__ */ m(vu, { side: o, ...s, ref: t }) : /* @__PURE__ */ m(vv, { side: o, ...s, ref: t }) });
  }
), vv = T.forwardRef((e, t) => {
  const n = tr(wn, e.__scopeTooltip), r = xa(wn, e.__scopeTooltip), o = T.useRef(null), s = Re(t, o), [i, a] = T.useState(null), { trigger: c, onClose: l } = n, u = o.current, { onPointerInTransitChange: d } = r, f = T.useCallback(() => {
    ...
    (g, h) => {
      const y = g.currentTarget, b = { x: g.clientX, y: g.clientY }, v = kv(b, y.getBoundingClientRect()), x = Cv(b, v), S = Mv(h.getBoundingClientRect()), w = Sv([...x, ...S]);
      a(w), d(!0);
    },
    [d]
  );
  return T.useEffect(() => () => f(), [f]), T.useEffect(() => {
    ...
    if (i) {
      const g = (h) => {
        const y = h.target, b = { x: h.clientX, y: h.clientY }, v = c?.contains(y) || u?.contains(y), x = !Tv(b, i);
        v ? f() : x && (f(), l());
      };
      return document.addEventListener("pointermove", g), () => document.removeEventListener("pointermove", g);
    }
  }, [c, u, i, l, f]), /* @__PURE__ */ m(vu, { ...e, ref: s });
}), [bv, wv] = Mo(Gn, { isInside: !1 }), xv = /* @__PURE__ */ wm("TooltipContent"), vu = T.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: r,
      ...
      ...a
    } = e, c = tr(wn, n), l = To(n), { onClose: u } = c;
    return T.useEffect(() => (document.addEventListener(Es, u), () => document.removeEventListener(Es, u)), [u]), T.useEffect(() => {
      if (c.trigger) {
        const d = (f) => {
      ...
      ra,
      {
        ...
        children: /* @__PURE__ */ I(
          ol,
          {
            ...
            children: [
              /* @__PURE__ */ m(xv, { children: r }),
              /* @__PURE__ */ m(bv, { scope: n, isInside: !0, children: /* @__PURE__ */ m(fv, { id: c.contentId, role: "tooltip", children: o || r }) })
            ]
          }
        )
      }
...
yu.displayName = wn;
var bu = "TooltipArrow", wu = T.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...r } = e, o = To(n);
    return wv(
      bu,
      n
    ).isInside ? null : /* @__PURE__ */ m(sl, { ...o, ...r, ref: t });
  }
);
wu.displayName = bu;
function kv(e, t) {
...
function Sv(e) {
  const t = e.slice();
  return t.sort((n, r) => n.x < r.x ? -1 : n.x > r.x ? 1 : n.y < r.y ? -1 : n.y > r.y ? 1 : 0), Ev(t);
}
function Ev(e) {
...
var Dv = mu, Nv = pu, Av = hu, Lv = gu, Iv = yu, Rv = wu;
function Pv({
  delayDuration: e = 0,
  ...t
}) {
...
function Ns({
  ...
  return /* @__PURE__ */ m(Pv, { children: /* @__PURE__ */ m(Nv, { "data-slot": "tooltip", ...e }) });
}
function As({
  ...e
}) {
  return /* @__PURE__ */ m(Av, { "data-slot": "tooltip-trigger", ...e });
}
function Ls({
  className: e,
  sideOffset: t = 0,
  ...
  return /* @__PURE__ */ m(Lv, { children: /* @__PURE__ */ I(
    Iv,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ m(Rv, { className: "bg-foreground fill-foreground z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" })
      ]
    }
  ) });
}
const xe = ({ onClick: e, isActive: t, disabled: n, children: r, tooltip: o }) => {
...
}, sn = () => /* @__PURE__ */ m("div", { className: "w-px h-5 bg-border mx-0.5 shrink-0" }), Ov = jt(function({ editor: t, onCopyMarkdown: n, onOpenLinkPopover: r, className: o = "", autoReorderChecklist: s = !1, aiEnabled: i = !1, onAISparklesClick: a }) {
  const c = V(null), [l, u] = U(!1), [d, f] = U(void 0), p = ic({
    editor: t,
    selector: ({ editor: C }) => ({
      canUndo: C.can().undo(),
      canRedo: C.can().redo(),
  ...
  return /* @__PURE__ */ I("div", { className: `flex items-center gap-0.5 px-2 py-1.5 border-b border-border/30 bg-muted/30 overflow-x-auto scrollbar-hide editor-toolbar ${o}`, children: [
    ...
    /* @__PURE__ */ I(ns, { children: [
      /* @__PURE__ */ m(rs, { asChild: !0, children: /* @__PURE__ */ I(
        "button",
        {
          className: `
    ...
    /* @__PURE__ */ I(ns, { children: [
      ...
      /* @__PURE__ */ I(os, { align: "start", children: [
        ...
        /* @__PURE__ */ I(we, { onClick: () => b("prompt"), children: [
          /* @__PURE__ */ m(Gd, { size: 16, className: "mr-2", style: { color: "#B244B3" } }),
          " Prompt"
        ] }),
        /* @__PURE__ */ I(we, { onClick: () => b("resources"), children: [
          /* @__PURE__ */ m(qd, { size: 16, className: "mr-2", style: { color: "#63B148" } }),
          " Resources"
        ] }),
...
function _v({ editor: e, isOpen: t, onClose: n, focusTrigger: r = 0, initialSearchQuery: o, editorMode: s = "wysiwyg", rawMarkdown: i = "", onRawMarkdownChange: a, onMatchesChange: c }) {
    ...
    "div",
    {
      ...
      children: [
        ...
        S && /* @__PURE__ */ I("div", { className: "find-replace-row", children: [
          /* @__PURE__ */ I("div", { className: "find-replace-input-wrapper", children: [
            /* @__PURE__ */ m(ps, { size: 14, className: "find-replace-icon" }),
            /* @__PURE__ */ m(
              "input",
              {
                ref: $,
...
const $v = typeof navigator < "u" && /Mac|iPod|iPhone|iPad/.test(navigator.platform), lt = $v ? "⌘" : "Ctrl", Hv = ({ editor: e }) => {
  ...
  return !t || r === 0 ? null : /* @__PURE__ */ I("div", { className: "select-all-action-bar", children: [
    /* @__PURE__ */ I("div", { className: "select-all-action-bar-inner", children: [
      ...
      /* @__PURE__ */ m("div", { className: "select-all-action-bar-preview", children: d ? /* @__PURE__ */ I(be, { children: [
        /* @__PURE__ */ m(lo, { size: 12, className: "select-all-action-bar-preview-icon" }),
      ...
      handleDOMEvents: {
        contextmenu(t, n) {
          ...
          if (o && o.closest(".ProseMirror")) {
            ...
            return e.chain().focus().setTextSelection(s).run(), jv(n, e, s), !0;
          }
          return !1;
        }
      }
...
function jv(e, t, n) {
  ...
  const h = [
    ...
    { label: "divider" },
    { label: "Copy Table", icon: "copy", action: () => Vv(t) }
  ], y = {
...
}), Gv = jf.extend({}), zn = new Me("tableSorting");
let zt = null, $n = null;
function qv(e) {
...
function Zv(e, t, n) {
  ...
  u.sort((g, h) => Xv(g.sortValue, h.sortValue, i));
...
function Qv(e, t, n, r) {
  ...
  return s.style.cssText = "display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;padding:0;font-size:10px;color:" + (e ? a : c) + ";background:transparent;border:none;border-radius:3px;cursor:pointer;user-select:none;transition:all 0.15s ease;opacity:" + (e ? "1" : "0.5") + ";pointer-events:auto;vertical-align:middle;", s.addEventListener("mouseenter", () => {
    ...
    u.preventDefault(), u.stopPropagation(), Zv(r, t, n);
  ...
  return new Ce({
    ...
    state: {
      ...
      apply(t, n, r, o) {
        ...
        return !t.docChanged && !s?.updated && $n ? $n.map(t.mapping, t.doc) : ($n = eb(o.doc, e), $n);
      }
    },
    props: {
      decorations(t) {
        ...
        if (i.type.name === "tableRow") {
          ...
          i.forEach((u, d) => {
            if (u.type.name === "tableHeader") {
              ...
              const h = zt?.tablePos === s && zt?.columnIndex === c ? zt.direction : null, y = c, b = s, v = Ze.widget(p, () => Qv(h, b, y, t), { side: 1, key: "sort-" + s + "-" + y });
              n.push(v);
            }
            l += u.nodeSize, c++;
          });
        ...
        props: {
          handleTextInput(n, r, o, s) {
            ...
            if (g.wrap(y, b), f > 1) {
              ...
              v && v.type === t && Zf(g.doc, f - 1) && g.join(f - 1);
            }
...
function Pr(e, t, n) {
  ...
  return e.descendants((o, s) => {
    if (!n.listItemTypes.includes(o.type.name) || !no(o))
      return !0;
    const i = Is(o, s), a = t.collapsedItems.has(i);
    r.push(
  ...
  addCommands() {
    return {
      toggleListItemCollapse: (e) => ({ editor: t, tr: n }) => {
        ...
        if (!o || !this.options.listItemTypes.includes(o.type.name) || !no(o))
          return !1;
        const s = Is(o, e);
      ...
      collapseAllListItems: () => ({ editor: e, tr: t }) => {
        ...
        return t.doc.descendants((o, s) => {
          this.options.listItemTypes.includes(o.type.name) && no(o) && n.collapsedItems.add(Is(o, s));
      ...
      new Ce({
        ...
        state: {
          ...
          apply(n, r, o, s) {
            return n.getMeta("collapsibleList") ? {
              ...
              decorations: Pr(s.doc, e, t),
              docVersion: r.docVersion + 1
            } : n.docChanged ? cb(o.doc, s.doc, t.listItemTypes) ? {
              collapsedItems: new Set(e.collapsedItems),
              decorations: Pr(s.doc, e, t),
              docVersion: r.docVersion + 1
            } : {
        ...
        props: {
          decorations(n) {
            ...
            return r?.decorations ? r.decorations : Pr(n.doc, e, t);
          }
        }
      })
    ];
...
const Or = {
  ...
  summary: { icon: of, label: "Summary", color: "var(--callout-summary)", borderColor: "var(--callout-summary-border)" }
};
function ub({ node: e, updateAttributes: t, editor: n }) {
  const [r, o] = U(!1), [s, i] = U(!1), [a, c] = U(null), l = V(null), u = V(null), d = e.attrs.type || "info", f = Or[d] || Or.info, p = f.icon, g = B(() => {
    if (u.current) {
        ...
        children: [
          ...
          /* @__PURE__ */ m(
            "div",
            {
              ...
              children: s ? /* @__PURE__ */ m(gc, { size: 16 }) : /* @__PURE__ */ m(Nt, { size: 16 })
            }
          ),
          r && n.isEditable && a && /* @__PURE__ */ m(vt, { children: /* @__PURE__ */ m(
            "div",
            {
              ...
              children: Object.keys(Or).map((v) => {
                const x = Or[v], S = x.icon;
                return /* @__PURE__ */ I(
                  "button",
                  {
...
function Bt(e, t) {
  try {
    ...
    return r in Hn ? Hn[r] : Li(r, r.split(":"));
  } catch {
...
class rt extends Date {
  //#region static
  constructor(...t) {
    super(), t.length > 1 && typeof t[t.length - 1] == "string" && (this.timeZone = t.pop()), this.internal = /* @__PURE__ */ new Date(), isNaN(Bt(this.timeZone, this)) ? this.setTime(NaN) : t.length ? typeof t[0] == "number" && (t.length === 1 || t.length === 2 && typeof t[1] != "number") ? this.setTime(t[0]) : typeof t[0] == "string" ? this.setTime(+new Date(t[0])) : t[0] instanceof Date ? this.setTime(+t[0]) : (this.setTime(+new Date(...t)), xu(this), Rs(this)) : this.setTime(Date.now());
  }
  static tz(t, ...n) {
...
Object.getOwnPropertyNames(Date.prototype).forEach((e) => {
  ...
  rt.prototype[t] && (e.startsWith("get") ? rt.prototype[e] = function() {
    ...
    return Date.prototype[t].apply(this.internal, arguments), gb(this), +this;
...
function gb(e) {
  Date.prototype.setFullYear.call(e, e.internal.getUTCFullYear(), e.internal.getUTCMonth(), e.internal.getUTCDate()), Date.prototype.setHours.call(e, e.internal.getUTCHours(), e.internal.getUTCMinutes(), e.internal.getUTCSeconds(), e.internal.getUTCMilliseconds()), xu(e);
}
function xu(e) {
...
class Ie extends rt {
  ...
  toTimeString() {
    ...
    return `${t} GMT${n}${r}${o} (${mb(this.timeZone, this)})`;
  }
  toLocaleString(t, n) {
...
const ku = 6048e5, yb = 864e5, Ri = Symbol.for("constructDateFrom");
function ke(e, t) {
...
function Su(e, t, n) {
  const [r, o] = Dn(
    ...
    e,
    t
  ), s = Xn(r), i = Xn(o), a = +s - Pi(s), c = +i - Pi(i);
  return Math.round((a - c) / yb);
}
function bb(e, t) {
  const n = Tu(e, t), r = ke(e, 0);
...
function On(e) {
  return (t, n = {}) => {
    ...
    if (!s)
      return null;
    const i = s[0], a = r && e.parsePatterns[r] || e.parsePatterns[e.defaultParseWidth], c = Array.isArray(a) ? Xb(a, (d) => d.test(i)) : (
...
const Qb = /^(\d+)(th|st|nd|rd)?/i, Jb = /\d+/i, ew = {
  narrow: /^(b|a)/i,
...
function fw(e, t) {
  const n = nr(), r = t?.firstWeekContainsDate ?? t?.locale?.options?.firstWeekContainsDate ?? n.firstWeekContainsDate ?? n.locale?.options?.firstWeekContainsDate ?? 1, o = Iu(e, t), s = ke(t?.in || e, 0);
  return s.setFullYear(o, 0, r), s.setHours(0, 0, 0, 0), xn(s, t);
}
function Ru(e, t) {
  const n = he(e, t?.in), r = +xn(n, t) - +fw(n, t);
  return Math.round(r / ku) + 1;
}
function me(e, t) {
...
const Hi = (e, t) => {
  ...
  return s.replace("{{date}}", Hi(r, t)).replace("{{time}}", Pu(o, t));
}, pw = {
  p: Pu,
  P: mw
}, hw = /^D+$/, gw = /^Y+$/, yw = ["D", "DD", "YY", "YYYY"];
function vw(e) {
  return hw.test(e);
}
function bw(e) {
...
const kw = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g, Cw = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g, Mw = /^'([^]*?)'?$/, Tw = /''/g, Sw = /[a-zA-Z]/;
function Ew(e, t, n) {
  ...
  return c.map((u) => {
    ...
    const d = u.value;
    (!n?.useAdditionalWeekYearTokens && bw(d) || !n?.useAdditionalDayOfYearTokens && vw(d)) && ww(d, t, String(e));
    const f = Oi[d[0]];
...
function Ww(e, t) {
  ...
  return t.getMonth(e) === t.getMonth(s) ? Wi : Hw;
}
function Ou(e, t) {
...
class Be {
   ...
   */
  constructor(t, n) {
    this.Date = Date, this.today = () => this.overrides?.today ? this.overrides.today() : this.options.timeZone ? Ie.tz(this.options.timeZone) : new this.Date(), this.newDate = (r, o, s) => this.overrides?.newDate ? this.overrides.newDate(r, o, s) : this.options.timeZone ? new Ie(r, o, s, this.options.timeZone) : new Date(r, o, s), this.addDays = (r, o) => this.overrides?.addDays ? this.overrides.addDays(r, o) : Cu(r, o), this.addMonths = (r, o) => this.overrides?.addMonths ? this.overrides.addMonths(r, o) : Mu(r, o), this.addWeeks = (r, o) => this.overrides?.addWeeks ? this.overrides.addWeeks(r, o) : wb(r, o), this.addYears = (r, o) => this.overrides?.addYears ? this.overrides.addYears(r, o) : xb(r, o), this.differenceInCalendarDays = (r, o) => this.overrides?.differenceInCalendarDays ? this.overrides.differenceInCalendarDays(r, o) : Su(r, o), this.differenceInCalendarMonths = (r, o) => this.overrides?.differenceInCalendarMonths ? this.overrides.differenceInCalendarMonths(r, o) : Sb(r, o), this.eachMonthOfInterval = (r) => this.overrides?.eachMonthOfInterval ? this.overrides.eachMonthOfInterval(r) : Db(r), this.eachYearOfInterval = (r) => {
      const o = this.overrides?.eachYearOfInterval ? this.overrides.eachYearOfInterval(r) : Lb(r), s = new Set(o.map((a) => this.getYear(a)));
      if (s.size === o.length)
        return o;
      const i = [];
      return s.forEach((a) => {
    ...
    }, this.endOfBroadcastWeek = (r) => this.overrides?.endOfBroadcastWeek ? this.overrides.endOfBroadcastWeek(r) : zw(r, this), this.endOfISOWeek = (r) => this.overrides?.endOfISOWeek ? this.overrides.endOfISOWeek(r) : Ib(r), this.endOfMonth = (r) => this.overrides?.endOfMonth ? this.overrides.endOfMonth(r) : Eb(r), this.endOfWeek = (r, o) => this.overrides?.endOfWeek ? this.overrides.endOfWeek(r, o) : Au(r, this.options), this.endOfYear = (r) => this.overrides?.endOfYear ? this.overrides.endOfYear(r) : Ab(r), this.format = (r, o, s) => {
      const i = this.overrides?.format ? this.overrides.format(r, o, this.options) : Ew(r, o, this.options);
      return this.options.numerals && this.options.numerals !== "latn" ? this.replaceDigits(i) : i;
    }, this.getISOWeek = (r) => this.overrides?.getISOWeek ? this.overrides.getISOWeek(r) : Lu(r), this.getMonth = (r, o) => this.overrides?.getMonth ? this.overrides.getMonth(r, this.options) : Aw(r, this.options), this.getYear = (r, o) => this.overrides?.getYear ? this.overrides.getYear(r, this.options) : Lw(r, this.options), this.getWeek = (r, o) => this.overrides?.getWeek ? this.overrides.getWeek(r, this.options) : Ru(r, this.options), this.isAfter = (r, o) => this.overrides?.isAfter ? this.overrides.isAfter(r, o) : Iw(r, o), this.isBefore = (r, o) => this.overrides?.isBefore ? this.overrides.isBefore(r, o) : Rw(r, o), this.isDate = (r) => this.overrides?.isDate ? this.overrides.isDate(r) : Eu(r), this.isSameDay = (r, o) => this.overrides?.isSameDay ? this.overrides.isSameDay(r, o) : Mb(r, o), this.isSameMonth = (r, o) => this.overrides?.isSameMonth ? this.overrides.isSameMonth(r, o) : Pw(r, o), this.isSameYear = (r, o) => this.overrides?.isSameYear ? this.overrides.isSameYear(r, o) : Ow(r, o), this.max = (r) => this.overrides?.max ? this.overrides.max(r) : kb(r), this.min = (r) => this.overrides?.min ? this.overrides.min(r) : Cb(r), this.setMonth = (r, o) => this.overrides?.setMonth ? this.overrides.setMonth(r, o) : _w(r, o), this.setYear = (r, o) => this.overrides?.setYear ? this.overrides.setYear(r, o) : $w(r, o), this.startOfBroadcastWeek = (r, o) => this.overrides?.startOfBroadcastWeek ? this.overrides.startOfBroadcastWeek(r, this) : Ou(r, this), this.startOfDay = (r) => this.overrides?.startOfDay ? this.overrides.startOfDay(r) : Xn(r), this.startOfISOWeek = (r) => this.overrides?.startOfISOWeek ? this.overrides.startOfISOWeek(r) : qn(r), this.startOfMonth = (r) => this.overrides?.startOfMonth ? this.overrides.startOfMonth(r) : Nb(r), this.startOfWeek = (r, o) => this.overrides?.startOfWeek ? this.overrides.startOfWeek(r, this.options) : xn(r, this.options), this.startOfYear = (r) => this.overrides?.startOfYear ? this.overrides.startOfYear(r) : Nu(r), this.options = { locale: Ma, ...t }, this.overrides = n;
  }
  /**
...
function ft(e, t, n = it) {
  ...
  return r.some((a) => {
    ...
    return Wu(a) ? s(e, a.after) > 0 : zu(a) ? s(a.before, e) > 0 : typeof a == "function" ? a(e) : !1;
  });
}
...
const S0 = Yu, E0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  formatCaption: Uu,
  formatDay: x0,
  formatMonthCaption: w0,
  formatMonthDropdown: k0,
  formatWeekNumber: M0,
  formatWeekNumberHeader: T0,
...
const Y0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  labelGrid: Vu,
  labelGridcell: O0,
  labelMonthDropdown: _0,
  labelNav: $0,
  labelNext: H0,
  labelPrevious: W0,
  labelWeekNumber: B0,
  labelWeekNumberHeader: F0,
  labelWeekday: z0,
  labelYearDropdown: U0
}, Symbol.toStringTag, { value: "Module" })), or = (e) => e instanceof HTMLElement ? e : null, is = (e) => [
  ...e.querySelectorAll("[data-animated-month]") ?? []
], j0 = (e) => or(e.querySelector("[data-animated-month]")), cs = (e) => or(e.querySelector("[data-animated-caption]")), ls = (e) => or(e.querySelector("[data-animated-weeks]")), V0 = (e) => or(e.querySelector("[data-animated-nav]")), K0 = (e) => or(e.querySelector("[data-animated-weekdays]"));
function G0(e, t, { classNames: n, months: r, focused: o, dateLib: s }) {
  ...
  co(() => {
    ...
    if (h instanceof HTMLElement ? (is(h).forEach((x) => {
...
function Q0(e, t, n, r) {
  const { addDays: o, endOfBroadcastWeek: s, endOfISOWeek: i, endOfMonth: a, endOfWeek: c, getISOWeek: l, getWeek: u, startOfBroadcastWeek: d, startOfISOWeek: f, startOfWeek: p } = r, g = e.reduce((h, y) => {
    ...
    const w = x.reduce((E, k) => {
      const N = n.ISOWeek ? l(k) : u(k), M = E.find((L) => L.weekNumber === N), D = new _u(k, y, r);
      return M ? M.days.push(D) : E.push(new Fw(N, [D])), E;
    }, []), C = new Bw(y, w);
    return h.push(C), h;
  }, []);
...
function rx(e, t) {
  const [n, r] = J0(e, t), { startOfMonth: o, endOfMonth: s } = t, i = zi(e, n, r, t), [a, c] = So(
    i,
  ...
  const l = Z0(a, r, e, t), u = q0(l, e.endMonth ? s(e.endMonth) : void 0, e, t), d = Q0(l, u, e, t), f = nx(d), p = X0(d), g = tx(a, n, e, t), h = ex(a, r, e, t), { disableNavigation: y, onMonthChange: b } = e, v = (C) => f.some((E) => E.days.some((k) => k.isEqualTo(C))), x = (C) => {
    if (y)
      return;
    let E = o(C);
...
function ox(e, t, n, r) {
  ...
  for (const i of e) {
    const a = t(i);
    Bi(a) && (a[ye.focused] && s < et.FocusedModifier ? (o = i, s = et.FocusedModifier) : r?.isEqualTo(i) && s < et.LastFocused ? (o = i, s = et.LastFocused) : n(i.date) && s < et.Selected ? (o = i, s = et.Selected) : a[ye.today] && s < et.Today && (o = i, s = et.Today));
  }
...
function Ku(e, t, n, r, o, s, i, a = 0) {
  if (a > 365)
    return;
  const c = sx(e, t, n.date, r, o, s, i), l = !!(s.disabled && ft(c, s.disabled, i)), u = !!(s.hidden && ft(c, s.hidden, i)), d = c, f = new _u(c, d, i);
  return !l && !u ? f : Ku(e, t, f, r, o, s, i, a + 1);
}
function ax(e, t, n, r, o) {
  const { autoFocus: s } = e, [i, a] = U(), c = ox(t.days, n, r || (() => !1), i), [l, u] = U(s ? c : void 0);
  return {
    ...
    moveFocus: (h, y) => {
      if (!l)
        return;
      const b = Ku(h, y, l, t.navStart, t.navEnd, e, o);
      b && (e.disableNavigation && !t.days.some((x) => x.isEqualTo(b)) || (t.goToDay(b), u(b)));
    }
  };
}
function ix(e, t) {
  const { selected: n, required: r, onSelect: o } = e, [s, i] = So(n, o ? n : void 0), a = o ? n : s, { isSameDay: c } = t, l = (p) => a?.some((g) => c(g, p)) ?? !1, { min: u, max: d } = e;
  return {
    selected: a,
    select: (p, g, h) => {
      let y = [...a ?? []];
...
function cx(e, t, n = 0, r = 0, o = !1, s = it) {
...
function Fi(e, t, n = it) {
  return dt(e, t.from, !1, n) || dt(e, t.to, !1, n) || dt(t, e.from, !1, n) || dt(t, e.to, !1, n);
}
function ux(e, t, n = it) {
  const r = Array.isArray(t) ? t : [t];
  if (r.filter((a) => typeof a != "function").some((a) => typeof a == "boolean" ? a : n.isDate(a) ? dt(e, a, !1, n) : Fu(a, n) ? a.some((c) => dt(e, c, !1, n)) : Ta(a) ? a.from && a.to ? Fi(e, { from: a.from, to: a.to }, n) : !1 : Bu(a) ? lx(e, a.dayOfWeek, n) : Hu(a) ? n.isAfter(a.before, a.after) ? Fi(e, {
    from: n.addDays(a.after, 1),
    to: n.addDays(a.before, -1)
  }, n) : ft(e.from, a, n) || ft(e.to, a, n) : Wu(a) || zu(a) ? ft(e.from, a, n) || ft(e.to, a, n) : !1))
    return !0;
...
function dx(e, t) {
  ...
  return {
    selected: l,
    select: (f, p, g) => {
      const { min: h, max: y } = e, b = f ? cx(f, l, h, y, s, t) : void 0;
      return r && n && b?.from && b.to && ux({ from: b.from, to: b.to }, n, t) && (b.from = f, b.to = void 0), i || c(b), i?.(b, f, p, g), b;
    },
...
function mx(e, t) {
  const n = fx(e, t), r = ix(e, t), o = dx(e, t);
  switch (e.mode) {
    case "single":
      return n;
    case "multiple":
...
function px(e) {
  ...
  const { components: n, formatters: r, labels: o, dateLib: s, locale: i, classNames: a } = Ut(() => {
    ...
    t.labels,
    t.classNames
  ]), { captionLayout: c, mode: l, navLayout: u, numberOfMonths: d = 1, onDayBlur: f, onDayClick: p, onDayFocus: g, onDayKeyDown: h, onDayMouseEnter: y, onDayMouseLeave: b, onNextClick: v, onPrevClick: x, showWeekNumber: S, styles: w } = t, { formatCaption: C, formatDay: E, formatMonthDropdown: k, formatWeekNumber: N, formatWeekNumberHeader: M, formatWeekdayName: D, formatYearDropdown: L } = r, P = rx(t, s), { days: O, months: H, navStart: $, navEnd: K, previousMonth: R, nextMonth: A, goToMonth: _ } = P, Y = g0(O, t, $, K, s), { isSelected: j, select: q, selected: Z } = mx(t, s) ?? {}, { blur: W, focused: z, isFocusTarget: F, moveFocus: Q, setFocused: le } = ax(t, P, Y, j ?? (() => !1), s), { labelDayButton: de, labelGridcell: ge, labelGrid: De, labelMonthDropdown: Ue, labelNav: bt, labelPrevious: Nn, labelNext: An, labelWeekday: sr, labelWeekNumber: ar, labelWeekNumberHeader: ir, labelYearDropdown: cr } = o, lr = Ut(() => L0(s, t.ISOWeek), [s, t.ISOWeek]), Rt = l !== void 0 || p !== void 0, Zt = B(() => {
    R && (_(R), x?.(R));
  }, [R, _, x]), Qt = B(() => {
    A && (_(A), v?.(A));
  }, [_, A, v]), ur = B((re, fe) => (ne) => {
  ...
  return X.createElement(
    ...
    X.createElement(
      n.Root,
      { rootRef: t.animate ? Jt : void 0, className: Ro, style: Po, dir: t.dir, id: t.id, lang: t.lang, nonce: t.nonce, title: t.title, role: t.role, "aria-label": t["aria-label"], "aria-labelledby": t["aria-labelledby"], ...Oo },
      X.createElement(
        n.Months,
        ...
        H.map((re, fe) => X.createElement(
          ...
          X.createElement(n.MonthCaption, { "data-animated-caption": t.animate ? "true" : void 0, className: a[te.MonthCaption], style: w?.[te.MonthCaption], calendarMonth: re, displayIndex: fe }, c?.startsWith("dropdown") ? X.createElement(
            ...
            (() => {
              const ne = c === "dropdown" || c === "dropdown-months" ? X.createElement(n.MonthsDropdown, { key: "month", className: a[te.MonthsDropdown], "aria-label": Ue(), classNames: a, components: n, disabled: !!t.disableNavigation, onChange: Io(re.date), options: N0(re.date, $, K, r, s), style: w?.[te.Dropdown], value: s.getMonth(re.date) }) : X.createElement("span", { key: "month" }, k(re.date, s)), pe = c === "dropdown" || c === "dropdown-years" ? X.createElement(n.YearsDropdown, { key: "year", className: a[te.YearsDropdown], "aria-label": cr(s.options), classNames: a, components: n, disabled: !!t.disableNavigation, onChange: fr(re.date), options: I0($, K, r, s, !!t.reverseYears), style: w?.[te.Dropdown], value: s.getYear(re.date) }) : X.createElement("span", { key: "year" }, L(re.date, s));
          ...
          X.createElement(
            ...
            X.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: a[te.Weeks], style: w?.[te.Weeks] }, re.weeks.map((ne) => X.createElement(
              ...
              ne.days.map((pe) => {
                ...
                const $o = A0(ue, w, t.modifiersStyles), mr = y0(ue, a, t.modifiersClassNames), Ln = !Rt && !ue.hidden ? ge(Ne, ue, s.options, s) : void 0;
                return (
                  // biome-ignore lint/a11y/useSemanticElements: react component
                  X.createElement(n.Day, { key: `${s.format(Ne, "yyyy-MM-dd")}_${s.format(pe.displayMonth, "yyyy-MM")}`, day: pe, modifiers: ue, className: mr.join(" "), style: $o, role: "gridcell", "aria-selected": ue.selected || void 0, "aria-label": Ln, "data-day": s.format(Ne, "yyyy-MM-dd"), "data-month": pe.outside ? s.format(Ne, "yyyy-MM") : void 0, "data-selected": ue.selected || void 0, "data-disabled": ue.disabled || void 0, "data-hidden": ue.hidden || void 0, "data-outside": pe.outside || void 0, "data-focused": ue.focused || void 0, "data-today": ue.today || void 0 }, !ue.hidden && Rt ? X.createElement(n.DayButton, { className: a[te.DayButton], style: w?.[te.DayButton], type: "button", day: pe, modifiers: ue, disabled: ue.disabled || void 0, tabIndex: F(pe) ? 0 : -1, "aria-label": de(Ne, ue, s.options, s), onClick: ur(pe, ue), onBlur: Do(pe, ue), onFocus: dr(pe, ue), onKeyDown: No(pe, ue), onMouseEnter: Ao(pe, ue), onMouseLeave: Lo(pe, ue) }, E(Ne, s.options, s)) : !ue.hidden && E(pe.date, s.options, s))
                );
              })
            )))
          )
  ...
  return /* @__PURE__ */ m(
    px,
    {
      ...
      components: {
        ...
        Chevron: ({ className: l, orientation: u, ...d }) => u === "left" ? /* @__PURE__ */ m(sf, { className: ae("size-4", l), ...d }) : u === "right" ? /* @__PURE__ */ m(
          af,
          {
...
let pn = null;
const Gu = /* @__PURE__ */ new Map(), yx = /* @__PURE__ */ new Map();
function Vr() {
  if (!pn) return;
  const e = pn;
  pn = null, setTimeout(() => {
...
function xx({ node: e, updateAttributes: t, selected: n }) {
  const r = V(null), o = e.attrs.date || hn(), s = qu(o), i = Ea(o), a = B(() => {
    if (!r.current) return "";
  ...
  return G(() => (Gu.set(o, (c) => {
    ...
    "span",
    {
      ...
      "data-date": o,
      children: [
        /* @__PURE__ */ m(yc, { size: 14, className: "date-icon" }),
...
const Cx = new Me("datePillPaste"), Mx = mo.create({
  name: "datePill",
  group: "inline",
  inline: !0,
  atom: !0,
  ...
  renderHTML({ node: e, HTMLAttributes: t }) {
    const n = e.attrs.date, r = qu(n), o = Ea(n);
    return [
      "span",
      kn(this.options.HTMLAttributes, t, {
        "data-type": "date-pill",
...
function Tx({ node: e, selected: t, editor: n, getPos: r, deleteNode: o }) {
...
const Sx = new Me("tagPillPaste"), Ex = mo.create({
  name: "tagPill",
  group: "inline",
  inline: !0,
  atom: !0,
...
}, Ax = ["info", "note", "prompt", "resources", "todo", "summary"];
function Lx(e) {
...
function Ui(e) {
  ...
  for (const s of r) {
    const i = s.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
    i ? o.push(Rx(i[1], i[2])) : o.push(`<p>${ro(s.trim())}</p>`);
  }
  return o.join("");
}
function Xu(e) {
...
function Hx(e, t, n, r) {
  ...
  const o = oo(t, r), s = new Set(o.values()), i = [];
    ...
    return {
      toggleHeadingCollapse: (e) => ({ editor: t, tr: n }) => {
        ...
        if (!o || o.type.name !== "heading")
          return !1;
        const i = oo(n.doc, this.options.levels).get(e);
      ...
      new Ce({
        ...
        state: {
          ...
          apply(n, r, o, s) {
            return n.getMeta("collapsibleHeading") ? {
              ...
              decorations: _r(s.doc, e, t),
              docVersion: r.docVersion + 1
            } : n.docChanged ? (Hx(o.doc, s.doc, e, t.levels), Wx(o.doc, s.doc, t.levels) ? {
              collapsedHeadings: new Set(e.collapsedHeadings),
              decorations: _r(s.doc, e, t),
              docVersion: r.docVersion + 1
            } : {
        ...
        props: {
          decorations(n) {
            ...
            return r?.decorations ? r.decorations : _r(n.doc, e, t);
          }
        }
      })
    ];
  }
}), Bx = /\[([^\]]+)\]\(([^)]+)\)$/, Fx = /^(https?:\/\/|www\.)[^\s]+$/i, Ux = Fe.create({
...
}), Yx = ["info", "note", "prompt", "resources", "todo"], jx = Fe.create({
          ...
          handleKeyDown(t, n) {
            ...
            for (const u of Yx)
              if (l === `\`\`\`${u}`) {
                ...
                if (p && g) {
                  const h = g.create(), y = p.create({ type: u }, Mc.from(h));
                  d.insert(f, y);
...
}), $r = new Me("searchHighlight"), Vx = Fe.create({
...
const Zx = /* @__PURE__ */ new Set([
  ...
  "codeBlock",
  "blockquote"
]), Qx = "tableRow", Jx = /* @__PURE__ */ new Set(["tableCell", "tableHeader"]);
function ek(e, t, n) {
  const r = e.resolve(t);
...
function ck(e, t, n) {
  let r = !1;
  return e.nodesBetween(t, n, (o) => Qu.has(o.type.name) ? (r = !0, !1) : !0), r;
}
function lk(e, t, n) {
  const r = [];
  let o = t, s = n;
  const i = (c) => c && (c.from < o || c.to > s) ? (r.push(c), o = c.from, s = c.to, !0) : !1;
  i(ek(e, o, s)), ik(e, t) && (i(tk(e, o, s)), i(nk(e, o, s))), i(ok(e, o, s)), i(rk(e, o, s));
  const a = sk(e);
  if (a.length > 0) {
    const c = ak(a, o, s);
    for (const l of c)
      ck(e, l.from, l.to) ? l.from === 0 && l.to === e.content.size ? i({ from: 0, to: e.content.size, useSelectAll: !0 }) : i({ from: l.from, to: l.to, useSelectAll: !0 }) : i({ from: l.from, to: l.to });
  }
...
}), dk = /#(?:[0-9a-fA-F]{3}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})\b/g;
function fk(e) {
  let t = e.replace("#", "");
...
const mk = new Me("hexColorDecoration");
function Ju(e, t, n) {
  const r = [];
  return e.nodesBetween(t, n, (o, s) => {
    ...
    const i = o.text || "";
    let a;
    const c = new RegExp(dk.source, "g");
    for (; (a = c.exec(i)) !== null; ) {
...
}), vk = new Me("linkBoundary"), bk = Fe.create({
  name: "linkBoundary",
  addProseMirrorPlugins() {
    return [
      new Ce({
...
}), wk = new Me("smartCopyPaste"), ed = /* @__PURE__ */ new Set(["codeBlock", "callout"]);
function Gi(e) {
  const { state: t } = e, { selection: n } = t, { $from: r, $to: o } = n;
  for (let s = r.depth; s > 0; s--) {
    const i = r.node(s);
    if (!ed.has(i.type.name)) continue;
      ...
      new Ce({
        ...
        props: {
          ...
          transformCopied(n) {
            ...
            if (!c || !ed.has(c.type.name))
              return n;
            if (r === "codeBlock") {
              const l = e.schema, u = l.nodes.paragraph;
              if (!u) {
                const h = c.content;
                return new Uo(h, Math.max(0, i - 1), Math.max(0, a - 1));
              }
              let d = "";
              c.content.forEach((h) => {
                d += h.text || "";
...
async function Ek(e, t, n) {
  return new Promise((r, o) => {
    ...
    i.onload = (a) => {
      ...
      const d = e.type === "image/png" || e.type === "image/gif", f = d ? "image/png" : "image/jpeg", p = d ? void 0 : n, g = l.toDataURL(f, p), h = Mk(g, e.name);
...
function Ak({
  ...
  return Ut(() => {
    const g = [
      ...
      cm.configure({ HTMLAttributes: { class: "font-bold" } }).extend({ keepOnSplit: !1 }),
      lm.configure({ HTMLAttributes: { class: "italic" } }).extend({ keepOnSplit: !1 }),
      um.configure({}).extend({ keepOnSplit: !1 }),
      im.configure({}).extend({ keepOnSplit: !1 }),
    ...
    ), s.codeBlocks || g.push(mm), s.callouts || g.push(db, jx), a && !s.collapsibleHeadings && !d && g.push(
      zx.configure({
        levels: o
      })
    ), s.images || g.push(
    ...
    ), i && g.push(uk), u && !d && g.push(hk), s.markdownPaste || g.push(
      _x.configure({
        enableMarkdownPaste: !0
      })
    ), g;
...
function Ik() {
  return Lk(), {
    ...
    async ready() {
      mt || (so ? await so : await td());
    }
  };
}
function Rk() {
  const e = V(null);
  return e.current || (e.current = Ik()), e.current;
}
const Pk = 2e3;
function Ok(e) {
  const {
    ...
    isLightweightRef: E
  } = e, k = n && n.length > Pk, N = V(k ? n : null), M = k ? "" : n, D = V(null), L = V(l), P = V(u), O = V(d), H = V(null);
...
function Zi(e) {
  if (/<img\s/i.test(e)) {
    const t = /(<img\s[^>]*\/?>)/gi;
    return e.split(t).filter((r) => r.trim()).map((r) => /^<img\s/i.test(r) ? zk(r) : r.trim() ? `<p>${ao(r.trim())}</p>` : "").join("");
  }
  if (/^!\[/.test(e)) {
    const t = e.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
    if (t)
...
function jk(e) {
  ...
  ), t = _k(t), t = Hk(t), t = Wk(t), t = Uk(t), t = t.replace(
    /(<pre[^>]*>\s*<code[^>]*>)([\s\S]*?)(<\/code>\s*<\/pre>)/g,
    (n, r, o, s) => r + o.replace(/\n+$/, "") + s
  ), t;
}
function Vk(e, t, n = {}) {
  const r = Yk(e, t, n), o = t(r);
  return jk(o);
}
function Kk(e, t, n) {
  G(() => {
...
function Zk(e, t = {}) {
  const {
    ...
    const b = Math.max(1, Math.ceil(f / Xk));
    return {
      words: f,
      characters: p,
    ...
    "div",
    {
      ...
      children: [
        e === "idle" && t && /* @__PURE__ */ I(be, { children: [
          /* @__PURE__ */ m(lf, { className: "w-3.5 h-3.5 text-muted-foreground" }),
        ...
        e === "saving" && /* @__PURE__ */ I(be, { children: [
          /* @__PURE__ */ m(vc, { className: "w-3.5 h-3.5 text-cyan-500 animate-spin" }),
        ...
        e === "error" && /* @__PURE__ */ I(be, { children: [
          /* @__PURE__ */ m(uf, { className: "w-3.5 h-3.5 text-red-500" }),
...
function Jk({ onRecover: e, onDismiss: t, className: n = "" }) {
  return /* @__PURE__ */ I(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ I("div", { className: "flex items-center gap-3 min-w-0", children: [
          /* @__PURE__ */ m(df, { className: "w-5 h-5 recovery-banner-icon flex-shrink-0" }),
...
`);
  ...
  if (!n || n.length === 0) {
    for (let c = 0; c < s.length; c++) {
      ...
      let f = i;
      for (const p of d)
        p.start > f && (o += Ft(e.substring(f, p.start))), o += `<span class="${Qi(p.type)}">${Ft(p.content)}</span>`, f = p.end;
...
`), i = u + 1;
  ...
  for (let c = 0; c < s.length; c++) {
    ...
    f < u && (o += ds(e, f, u, null, a)), c < s.length - 1 && (o += `
`), i = u + 1;
  }
  return o;
}
  ...
  G(() => {
    ...
    const M = (D) => {
      ...
      if (l.current = D, c.current.push({ time: D, duration: L }), c.current.length > 120 && (c.current = c.current.slice(-120)), L > 16.67 && d.current++, E++, D - k >= 1e3) {
        N = E, E = 0, k = D;
        const P = c.current.slice(-60), O = P.length > 0 ? P.reduce((j, q) => j + q.duration, 0) / P.length : 0, H = P.length > 0 ? Math.max(...P.map((j) => j.duration)) : 0, $ = performance.memory, K = $ ? $.usedJSHeapSize / (1024 * 1024) : 0, R = $ ? $.jsHeapSizeLimit / (1024 * 1024) : 0, A = document.querySelectorAll("*").length, _ = Ji - f.current, Y = Ps - p.current;
  ...
  return /* @__PURE__ */ I("div", { className: "perf-profiler-overlay", children: [
    /* @__PURE__ */ I("div", { className: "perf-profiler-header", children: [
      ...
      /* @__PURE__ */ I("div", { className: "perf-profiler-actions", children: [
        /* @__PURE__ */ m("button", { onClick: x, title: o ? "Expand" : "Minimize", children: o ? /* @__PURE__ */ m(bc, { size: 12 }) : /* @__PURE__ */ m(wc, { size: 12 }) }),
  ...
  render() {
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ m("div", { className: ae("flex-1 flex items-center justify-center p-6", this.props.className), children: /* @__PURE__ */ I("div", { className: "flex flex-col items-center max-w-md w-full text-center gap-4", children: [
        /* @__PURE__ */ m("div", { className: "w-12 h-12 rounded-full bg-destructive/10 flex items-center justify-center", children: /* @__PURE__ */ m(mf, { className: "w-6 h-6 text-destructive" }) }),
        ...
        t && /* @__PURE__ */ I("div", { className: "w-full max-w-xs", children: [
          /* @__PURE__ */ I(
            "button",
            {
              ...
              children: [
                n ? /* @__PURE__ */ m(Nt, { className: "w-3 h-3" }) : /* @__PURE__ */ m(gc, { className: "w-3 h-3" }),
                "Error details"
              ]
            }
          ),
              ...
              /* @__PURE__ */ m(
                "button",
                {
                  ...
                  children: o ? /* @__PURE__ */ I(be, { children: [
                    /* @__PURE__ */ m(pf, { className: "w-3 h-3 text-green-500" }),
...
function oC({ className: e = "", theme: t }) {
  const n = (r) => ({
    height: "1rem",
    width: r,
...
function sC({ editorMode: e, onModeSwitch: t }) {
...
), fs = () => /* @__PURE__ */ m("div", { className: "w-px h-5 bg-border mx-0.5 flex-shrink-0" }), ec = [
...
], aC = jt(function({ editor: t, isH1: n, isH2: r, isH3: o, isH4: s, isH5: i, executeCommand: a }) {
  const [c, l] = U(!1), u = V(null), d = n ? "h1" : r ? "h2" : o ? "h3" : s ? "h4" : i ? "h5" : "paragraph", f = ec.find((g) => g.value === d)?.shortLabel || "P";
  G(() => {
    if (!c) return;
    const g = (h) => {
...
}), iC = jt(function({ onCopy: t, iconSize: n }) {
...
}), cC = jt(function({ editor: t, className: n = "", suppressWhenLinkPopoverOpen: r = !1, aiEnabled: o = !1, onAISparklesClick: s, onCopySelectionAsMarkdown: i }) {
  const a = V(null), c = ic({
    editor: t,
    selector: ({ editor: M }) => ({
      ...
      children: [
        ...
        /* @__PURE__ */ m(
          $e,
          {
            ...
            title: "Code Block",
            children: /* @__PURE__ */ m(gf, { size: k })
          }
        ),
        i && /* @__PURE__ */ I(be, { children: [
          /* @__PURE__ */ m(fs, {}),
          /* @__PURE__ */ m(iC, { onCopy: i, iconSize: k })
        ] }),
...
function dC({ editor: e, onEditLink: t }) {
  const [n, r] = U({
    isVisible: !1,
    url: "",
      ...
      children: /* @__PURE__ */ I("div", { className: "link-hover-tooltip-content", children: [
        /* @__PURE__ */ I(
          "button",
          {
            ...
            title: n.url,
            children: [
              /* @__PURE__ */ m(yf, { size: 13, className: "link-hover-tooltip-link-icon" }),
        ...
        /* @__PURE__ */ I("div", { className: "link-hover-tooltip-actions", children: [
          ...
          /* @__PURE__ */ m(
            "button",
            {
              ...
              title: "Remove link",
              children: /* @__PURE__ */ m(bf, { size: 14 })
            }
          )
        ] })
      ] })
...
const fC = [
  ...
  {
    title: "Note Callout",
    icon: /* @__PURE__ */ m(hc, { size: 16, className: "text-purple-400" }),
    command: (e) => e.chain().focus().toggleCallout({ type: "note" }).run(),
    keywords: ["memo", "remember"]
  },
  {
    title: "Prompt Callout",
    icon: /* @__PURE__ */ m(pc, { size: 16, className: "text-amber-400" }),
  ...
  {
    title: "Date",
    icon: /* @__PURE__ */ m(yc, { size: 16, className: "text-cyan-400" }),
...
], mC = 32, pC = 8, hC = 320, gC = 210, zr = 12;
function tc(e) {
  try {
...
const vC = 340, bC = 36, wC = 8, xC = 240, Br = 8;
function nc(e) {
  try {
    const t = window.getSelection();
    if (t && t.rangeCount > 0) {
...
function kC({ editor: e, onSearch: t, onCreateItem: n }) {
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ I("div", { className: "image-edit-popover-content", children: [
          ...
          /* @__PURE__ */ I("div", { className: "image-edit-popover-field", children: [
            /* @__PURE__ */ I("label", { className: "image-edit-popover-label", children: [
              /* @__PURE__ */ m(lo, { className: "w-3.5 h-3.5" }),
...
function MC({ containerRef: e, enabled: t = !0 }) {
  ...
  return G(() => {
    ...
    /* @__PURE__ */ m("div", { className: "image-drop-zone-icon", children: /* @__PURE__ */ m(Tf, { className: "w-12 h-12" }) }),
...
function SC({ actions: e, scope: t, onAction: n, onClose: r, position: o }) {
        ...
        `,
          children: [
            /* @__PURE__ */ m("div", { className: "px-2 py-1.5", children: /* @__PURE__ */ I("div", { className: "flex items-center gap-2 bg-secondary/50 rounded-md px-2.5 py-1.5 border border-border/50", children: [
              /* @__PURE__ */ m(xc, { size: 14, className: "text-muted-foreground shrink-0" }),
              /* @__PURE__ */ m(
                "input",
                {
                  ref: u,
          ...
          children: [
            /* @__PURE__ */ I("div", { className: "flex items-center justify-between px-3 py-2 border-b border-border bg-secondary/30", children: [
              /* @__PURE__ */ I("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
                h && /* @__PURE__ */ m(vc, { size: 12, className: "animate-spin" }),
...
function DC({
  ...
  return /* @__PURE__ */ I(be, { children: [
    !n.images && !n.dragAndDrop && /* @__PURE__ */ m(MC, { containerRef: r, enabled: o }),
    !t && s && /* @__PURE__ */ m(
      cC,
      {
        editor: e,
    ...
    !n.slashCommands && /* @__PURE__ */ m(yC, { editor: e, disabledFeatures: n }),
    !n.wikiLinks && E && /* @__PURE__ */ m(kC, { editor: e, onSearch: E }),
    /* @__PURE__ */ m(
      lC,
      {
        editor: e,
    ...
    /* @__PURE__ */ m(dC, { editor: e, onEditLink: C }),
...
function LC(e) {
  const [t, n] = zd(AC, { status: "idle" }), r = V(null), o = B(async (a, c, l, u, d) => {
    if (e) {
      n({
...
const rd = "paragon-editor-toc-width", IC = 280, od = 200, sd = 500;
function rc() {
  try {
    const e = localStorage.getItem(rd);
    if (e) {
      const t = parseInt(e, 10);
      if (!isNaN(t) && t >= od && t <= sd)
        return t;
    }
  } catch {
  }
...
function RC(e) {
  try {
    localStorage.setItem(rd, String(e));
  } catch {
  }
}
function PC(e, t, n) {
...
const sc = jt(function({
  ...
  G(() => {
    const z = (Q) => {
      if (!O.current) return;
      const le = f === "right" ? H.current - Q.clientX : Q.clientX - H.current, de = Math.min(sd, Math.max(od, $.current + le));
      D(de);
    }, F = () => {
      O.current && (O.current = !1, document.body.style.cursor = "", document.body.style.userSelect = "", D((Q) => (RC(Q), Q)));
    };
  ...
  return /* @__PURE__ */ I(be, { children: [
    y && /* @__PURE__ */ m(
      "button",
      {
        ...
        children: C ? /* @__PURE__ */ m(Df, { size: 16 }) : /* @__PURE__ */ m(Nf, { size: 16 })
      }
    ),
    /* @__PURE__ */ I(
      "div",
  ...
  showPerformanceProfiler: No = !1,
  onPerformanceProfilerClose: Ao,
  ...
  enableHexColorHighlight: Ro = !1,
  enableCollapsibleHeadings: Po = !1,
  enableCollapsibleLists: Oo = !1,
  // Performance mode
  ...
  const [Ne] = U(() => _C()), [ue, $o] = U(N), [mr, Ln] = U(""), wt = V(N), xt = V(""), In = V(null), [cd, Da] = U(0), pr = !!(re && re.length > 0 && fe), { state: Ye, executeAction: hr, abort: ld, reset: kt } = LC(fe), [ud, Ho] = U(null), [dd, fd] = U({ selectionTop: 0, selectionBottom: 0, selectionCenterX: 0 }), md = V(fe);
  md.current = fe;
  const Na = V(ne);
  Na.current = ne;
  const [pd, hd] = U([]), [gd, yd] = U(0), vd = B((se, Te) => {
    hd(se), yd(Te);
  ...
  const Ha = 2e3, [Wo, bd] = U(() => Jt === "lightweight" ? !0 : Jt === "full" ? !1 : t && typeof t == "string" ? Math.ceil(t.length / 80) > Ha : !1), wd = V(0), Wa = V(Wo);
  Wa.current = Wo;
  const [zo, gr] = U(null), xd = Ak({
    placeholder: s,
    isMobile: Ne,
    maxImageSize: v,
    headingLevels: de,
    ...
    enableCollapsibleHeadings: Po,
    enableCollapsibleLists: Oo,
    enableTagAutoDetect: fr,
    enableHexColorHighlight: Ro,
    isLightweight: Wo,
  ...
  }), { editor: oe, turndownService: yr } = Ok({
    extensions: xd,
    content: t,
    editable: i,
    autofocus: a,
    ...
    setRawMarkdown: Ln,
    setIsLightweight: bd,
    lightweightCheckCounterRef: wd,
    isLightweightRef: Wa
  }), [kd, vr] = U(!1), [Cd, Md] = U(!1), Td = j !== void 0 ? j : Cd, Pt = B((se) => {
    Md(se), q?.(se);
  }, [q]), [Sd, br] = U(0), [Ed, Dd] = U(""), Ot = Bv(oe, {
    storageKey: g,
    debounceMs: h,
    enabled: p,
    onSave: (se) => {
...
`) : "", en = Ge.scope === "document" || !_t ? oe.getText() : _t, xr = oe.view.coordsAtPos(_e), kr = oe.view.coordsAtPos(Ct);
    ...
    }), Ho(null), hr(se, Ge.label, en, { from: _e, to: Ct }, Te);
  }, [oe, re, hr]), Ld = B(() => {
...
` + Te).run(), kt();
    ...
    if (Ge) return;
    const _e = oe.state.doc.slice(se, Te), Ct = _f.fromSchema(oe.schema), _t = document.createElement("div"), en = Ct.serializeFragment(_e.content);
    _t.appendChild(en);
    const xr = _t.innerHTML, kr = to(yr.turndown(xr));
    navigator.clipboard.writeText(kr).catch(() => {
      const Fo = oe.state.doc.textBetween(se, Te, `
`);
      navigator.clipboard.writeText(Fo);
    });
  }, [oe, yr]);
  if (!oe)
    return /* @__PURE__ */ m(oC, { className: c, theme: d });
  const Fa = /* @__PURE__ */ m(
    Ov,
    {
      editor: oe,
  ...
  return /* @__PURE__ */ I("div", { className: `markdown-editor-container ${f === "neutral" ? "color-theme-neutral" : ""} ${c}`, "data-theme": d, children: [
    ...
    l && /* @__PURE__ */ I("div", { className: "flex items-center bg-card/50 editor-toolbar-wrapper", children: [
      Z ? Z(oe, Fa) : Fa,
      k && /* @__PURE__ */ m(sC, { editorMode: ue, onModeSwitch: Bo })
    ] }),
    !Ne && /* @__PURE__ */ m(
      _v,
      {
    ...
    /* @__PURE__ */ I("div", { className: `editor-main-area ${De ? "editor-with-toc" : ""}`, children: [
      ...
      /* @__PURE__ */ I(
        rC,
        {
          ...
          onError: _o,
          children: [
            /* @__PURE__ */ m("div", { className: "editor-content-wrapper", ref: In, style: Od, children: ue === "wysiwyg" ? /* @__PURE__ */ I(be, { children: [
              /* @__PURE__ */ m($d, { editor: oe, className: "editor-content" }),
              /* @__PURE__ */ m(
                DC,
                {
                  editor: oe,
                  ...
                  onImageDelete: () => {
                    oe.chain().focus().setNodeSelection(zo.pos).deleteSelection().run(), gr(null);
                  },
            ...
            /* @__PURE__ */ m(NC, { scrollContainerRef: In })
          ]
        }
      ),
    ...
    /* @__PURE__ */ m(nC, { visible: No, onClose: Ao, editor: oe })
  ] });
}), O1 = mo.create({
  name: "callout",
  addOptions() {
...
function W1({ node: e, updateAttributes: t }) {
...
export {
  ...
  O1 as Callout,
  jx as CalloutInputRule,
  W1 as CodeBlockComponent,
  zx as CollapsibleHeading,
  lb as CollapsibleList,
  Mx as DatePill,
  $1 as EditorThemeProvider,
  Ov as EditorToolbar,
  _v as FindReplace,
  cC as FloatingToolbar,
  MC as ImageDropZone,
  Nk as ImageUpload,
  P1 as MarkdownEditor,
  Ux as MarkdownLinkInputRule,
  _x as MarkdownPasteSafe,
  nb as MixedBulletList,
  ab as MixedListItem,
  rb as MixedOrderedList,
  sb as MixedTaskItem,
  ob as MixedTaskList,
  Jk as RecoveryBanner,
  fb as ResizableImage,
  Vx as SearchHighlight,
  Wv as SelectAllActionBar,
  yk as SelectAllOccurrences,
  yC as SlashCommands,
  qx as TabIndent,
  sc as TableOfContents,
  Ex as TagPill,
  Nx as WikiLinkSafe,
  zC as applyTheme,
  _1 as createCustomTheme,
  ad as darkTheme,
  Ea as getDateVariant,
  ln as isValidTag,
  $C as lightTheme,
  dm as loadLanguageIfNeeded,
  ve as lowlight,
  WC as nordTheme,
  Fn as normalizeTag,
