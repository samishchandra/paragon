...
import { ReactNodeViewRenderer as fo, NodeViewWrapper as vn, NodeViewContent as Hs, useEditorState as dc, useEditor as zd, EditorContent as Bd } from "@tiptap/react";
import * as T from "react";
import X, { useState as U, useRef as j, useEffect as K, useCallback as B, useLayoutEffect as mo, memo as vt, useImperativeHandle as Fd, createContext as fc, useContext as mc, useMemo as Nt, Component as Ud, useReducer as Yd, forwardRef as jd } from "react";
import Vd from "@tiptap/extension-code-block-lowlight";
import { createLowlight as Kd } from "lowlight";
import { ChevronDown as Lt, Check as Kt, Copy as Gt, Image as Ws, X as pt, Link2 as zs, Type as po, Undo as Gd, Redo as qd, Bold as Bs, Italic as Fs, Underline as Us, Strikethrough as Ys, Code as pc, Highlighter as hc, Link as js, List as Vs, ListOrdered as Ks, CheckSquare as Gs, Quote as qs, Code2 as gc, IndentIncrease as Xd, IndentDecrease as Zd, Table as hs, Minus as yc, Info as Qr, BookOpen as Xs, PenLine as Qd, Library as Jd, ListTodo as Zs, Columns as Ka, Trash2 as un, Rows as Ga, ToggleLeft as qa, ArrowUpDown as ef, Sparkles as ho, Search as tf, ChevronUp as nf, MousePointerClick as rf, CaseSensitive as of, WholeWord as sf, Regex as af, Replace as gs, ReplaceAll as cf, Plus as Qs, ClipboardList as lf, MessageSquareText as vc, StickyNote as bc, ChevronRight as wc, ChevronLeftIcon as uf, ChevronRightIcon as df, ChevronDownIcon as ff, Calendar as xc, Hash as Xa, Cloud as mf, Loader2 as kc, CloudOff as pf, AlertCircle as hf, RotateCcw as Js, Activity as gf, Maximize2 as Cc, Minimize2 as Mc, AlertTriangle as yf, CheckCircle2 as vf, Eye as bf, FileText as ea, FileCode as wf, ExternalLink as xf, Pencil as kf, Unlink as Cf, Heading1 as Mf, Heading2 as Tf, Heading3 as Sf, Heading4 as Ef, Heading5 as Df, ImagePlus as Nf, MessageSquare as Tc, RefreshCw as Af, SpellCheck as Lf, PanelRightClose as If, PanelRightOpen as Rf } from "lucide-react";
import { Plugin as Me, PluginKey as Te, TextSelection as Ve, NodeSelection as Pf, AllSelection as Of } from "@tiptap/pm/state";
...
import $f from "highlight.js/lib/languages/json";
import go from "highlight.js/lib/languages/bash";
import * as Ec from "react-dom";
import Hf, { createPortal as Wf } from "react-dom";
import { Fragment as Dc, Slice as jo, DOMSerializer as zf } from "@tiptap/pm/model";
...
import { Extension as Ue, Node as yo, mergeAttributes as kn, InputRule as _e, Mark as Nc } from "@tiptap/core";
...
import { findWrapping as Za, canJoin as tm } from "@tiptap/pm/transform";
...
import { liftListItem as Qa, sinkListItem as Ja } from "@tiptap/pm/schema-list";
...
function gm({ node: e, updateAttributes: t, extension: n }) {
...
function Ac({ isOpen: e, onClose: t, onInsert: n, position: r }) {
...
}, bm = T[" useInsertionEffect ".trim().toString()] || It;
function sa({
  prop: e,
  defaultProp: t,
  onChange: n = () => {
...
// @__NO_SIDE_EFFECTS__
function Vn(e) {
  const t = /* @__PURE__ */ Cm(e), n = T.forwardRef((r, o) => {
    const { children: s, ...i } = r, a = T.Children.toArray(s), c = a.find(Tm);
    if (c) {
...
var km = /* @__PURE__ */ Vn("Slot");
// @__NO_SIDE_EFFECTS__
function Cm(e) {
  const t = T.forwardRef((n, r) => {
    const { children: o, ...s } = n;
    if (T.isValidElement(o)) {
      const i = Em(o), a = Sm(s, o.props);
...
function Mm(e) {
  ...
  return t.displayName = `${e}.Slottable`, t.__radixId = Lc, t;
}
function Tm(e) {
  return T.isValidElement(e) && typeof e.type == "function" && "__radixId" in e.type && e.type.__radixId === Lc;
}
function Sm(e, t) {
  const n = { ...t };
  for (const r in t) {
...
var Nm = T.createContext(void 0);
function Pc(e) {
  const t = T.useContext(Nm);
  return e || t || "ltr";
}
function ht(e) {
  const t = T.useRef(e);
...
var Lm = "DismissableLayer", vs = "dismissableLayer.update", Im = "dismissableLayer.pointerDownOutside", Rm = "dismissableLayer.focusOutside", ti, Oc = T.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: a,
      ...c
    } = e, l = T.useContext(Oc), [u, d] = T.useState(null), f = u?.ownerDocument ?? globalThis?.document, [, p] = T.useState({}), g = Ie(t, (E) => d(E)), h = Array.from(l.layers), [y] = [...l.layersWithOutsidePointerEventsDisabled].slice(-1), b = h.indexOf(y), v = u ? h.indexOf(u) : -1, x = l.layersWithOutsidePointerEventsDisabled.size > 0, S = v >= b, w = _m((E) => {
    ...
    return Am((E) => {
      ...
      if (u)
        return n && (l.layersWithOutsidePointerEventsDisabled.size === 0 && (ti = f.body.style.pointerEvents, f.body.style.pointerEvents = "none"), l.layersWithOutsidePointerEventsDisabled.add(u)), l.layers.add(u), ni(), () => {
          n && l.layersWithOutsidePointerEventsDisabled.size === 1 && (f.body.style.pointerEvents = ti);
        };
    }, [u, f, n, l]), T.useEffect(() => () => {
      u && (l.layers.delete(u), l.layersWithOutsidePointerEventsDisabled.delete(u), ni());
    }, [u, l]), T.useEffect(() => {
      const E = () => p({});
...
aa.displayName = Lm;
var Pm = "DismissableLayerBranch", Om = T.forwardRef((e, t) => {
  const n = T.useContext(Oc), r = T.useRef(null), o = Ie(t, r);
  return T.useEffect(() => {
    const s = r.current;
    if (s)
...
function $m(e, t = globalThis?.document) {
  ...
  return T.useEffect(() => {
    const o = (s) => {
      s.target && !r.current && _c(Rm, n, { originalEvent: s }, {
        discrete: !1
      });
    };
...
function Hm() {
  T.useEffect(() => {
    ...
    return document.body.insertAdjacentElement("afterbegin", e[0] ?? ri()), document.body.insertAdjacentElement("beforeend", e[1] ?? ri()), Vo++, () => {
...
var Ko = "focusScope.autoFocusOnMount", Go = "focusScope.autoFocusOnUnmount", oi = { bubbles: !1, cancelable: !0 }, Wm = "FocusScope", $c = T.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: o,
  ...
  T.useEffect(() => {
    ...
    if (a) {
      ...
      if (!a.contains(h)) {
        const b = new CustomEvent(Ko, oi);
        a.addEventListener(Ko, l), a.dispatchEvent(b), b.defaultPrevented || (zm(jm(Hc(a)), { select: !0 }), document.activeElement === h && Dt(a));
      }
      return () => {
        a.removeEventListener(Ko, l), setTimeout(() => {
          const b = new CustomEvent(Go, oi);
          a.addEventListener(Go, u), a.dispatchEvent(b), b.defaultPrevented || Dt(h ?? document.body, { select: !0 }), a.removeEventListener(Go, u), ai.remove(p);
        }, 0);
      };
    }
  }, [a, l, u, p]);
  const g = T.useCallback(
    (h) => {
      ...
      if (y && b) {
        const v = h.currentTarget, [x, S] = Bm(v);
...
function Bm(e) {
  const t = Hc(e), n = si(t, e), r = si(t.reverse(), e);
  return [n, r];
}
function Hc(e) {
...
var Vm = T[" useId ".trim().toString()] || (() => {
}), Km = 0;
function Jr(e) {
  const [t, n] = T.useState(Vm());
  return It(() => {
    n((r) => r ?? String(Km++));
  }, [e]), e || (t ? `radix-${t}` : "");
}
const Gm = ["top", "right", "bottom", "left"], Rt = Math.min, ze = Math.max, eo = Math.round, Ar = Math.floor, ot = (e) => ({
  x: e,
  y: e
}), qm = {
  left: "right",
...
const ci = ["left", "right"], li = ["right", "left"], ep = ["top", "bottom"], tp = ["bottom", "top"];
function np(e, t, n) {
  switch (e) {
    case "top":
    case "bottom":
...
async function Kn(e, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: p = 0
  } = gt(t, e), g = Wc(p), y = a[f ? d === "floating" ? "reference" : "floating" : d], b = no(await s.getClippingRect({
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const b = yt(o), v = nt(a), x = yt(a) === a, S = await (c.isRTL == null ? void 0 : c.isRTL(l.floating)), w = f || (x || !h ? [to(a)] : Jm(a)), M = g !== "none";
      !f && M && w.push(...rp(a, h, g, S));
...
}, zc = /* @__PURE__ */ new Set(["left", "top"]);
async function lp(e, t) {
  const {
    placement: n,
    platform: r,
    elements: o
  } = e, s = await (r.isRTL == null ? void 0 : r.isRTL(o.floating)), i = yt(n), a = Mn(n), c = nt(n) === "y", l = zc.has(i) ? -1 : 1, u = s && c ? -1 : 1, d = gt(t, e);
  let {
    mainAxis: f,
    crossAxis: p,
    alignmentAxis: g
...
const up = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (l) {
        var b, v;
        const x = f === "y" ? "width" : "height", S = zc.has(yt(o)), w = s.reference[d] - s.floating[x] + (S && ((b = i.offset) == null ? void 0 : b[d]) || 0) + (S ? 0 : y.crossAxis), M = s.reference[d] + s.reference[x] + (S ? 0 : ((v = i.offset) == null ? void 0 : v[d]) || 0) - (S ? y.crossAxis : 0);
        g < w ? g = w : g > M && (g = M);
      }
      return {
        [f]: p,
...
const vp = ["transform", "translate", "scale", "rotate", "perspective"], bp = ["transform", "translate", "scale", "rotate", "perspective", "filter"], wp = ["paint", "layout", "strict", "content"];
function ua(e) {
  const t = da(), n = Qe(e) ? Je(e) : e;
  return vp.some((r) => n[r] ? n[r] !== "none" : !1) || (n.containerType ? n.containerType !== "normal" : !1) || !t && (n.backdropFilter ? n.backdropFilter !== "none" : !1) || !t && (n.filter ? n.filter !== "none" : !1) || bp.some((r) => (n.willChange || "").includes(r)) || wp.some((r) => (n.contain || "").includes(r));
}
function xp(e) {
  let t = Pt(e);
  for (; st(t) && !bn(t); ) {
...
const kp = /* @__PURE__ */ new Set(["html", "body", "#document"]);
function bn(e) {
  return kp.has(Tn(e));
}
function Je(e) {
...
function Fc(e) {
  const t = Pt(e);
  return bn(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : st(t) && er(t) ? t : Fc(t);
}
function Gn(e, t, n) {
  var r;
  t === void 0 && (t = []), n === void 0 && (n = !0);
  const o = Fc(e), s = o === ((r = e.ownerDocument) == null ? void 0 : r.body), i = Be(o);
  if (s) {
    const a = xs(i);
...
const Cp = /* @__PURE__ */ ot(0);
function Yc(e) {
  const t = Be(e);
  return !da() || !t.visualViewport ? Cp : {
...
function Vc(e, t) {
  const n = Pt(e);
  return n === t || !Qe(n) || bn(n) ? !1 : Je(n).position === "fixed" || Vc(n, t);
}
function Lp(e, t) {
  const n = t.get(e);
  if (n)
  ...
  for (; Qe(i) && !bn(i); ) {
    const a = Je(i), c = ua(i);
    !c && a.position === "fixed" && (o = null), (s ? !c && !o : !c && a.position === "static" && !!o && Np.has(o.position) || er(i) && !c && Vc(e, i)) ? r = r.filter((u) => u !== i) : o = a, i = Pt(i);
  }
  return t.set(e, r), r;
}
function Ip(e) {
  ...
  const i = [...n === "clippingAncestors" ? wo(t) ? [] : Lp(t, this._c) : [].concat(n), r], a = i[0], c = i.reduce((l, u) => {
    const d = hi(t, u, o);
...
function Pp(e, t, n) {
  ...
  s && !r && o && l();
  const u = o && !r && !s ? jc(o, a) : ot(0), d = i.left + a.scrollLeft - c.x - u.x, f = i.top + a.scrollTop - c.y - u.y;
  return {
    x: d,
    y: f,
    width: i.width,
...
function Kc(e, t) {
  ...
  for (; r && gp(r) && qo(r); )
    r = gi(r, t);
  return r && bn(r) && qo(r) && !ua(r) ? n : r || xp(e) || n;
}
...
function Hp(e, t) {
  ...
  function i(a, c) {
    ...
    function w(M) {
      ...
      E === 1 && !Gc(l, e.getBoundingClientRect()) && i(), S = !1;
    }
    try {
...
function Wp(e, t, n, r) {
  ...
  function y() {
    const b = Vt(e);
    h && !Gc(h, b) && n(), h = b, g = requestAnimationFrame(y);
  }
  return n(), () => {
    var b;
    u.forEach((v) => {
...
const zp = up, Bp = dp, Fp = ip, Up = mp, Yp = cp, yi = ap, jp = fp, Vp = (e, t, n) => {
...
var Kp = typeof document < "u", Gp = function() {
}, Kr = Kp ? mo : Gp;
function ro(e, t) {
  if (e === t)
    return !0;
...
function qp(e) {
  ...
  const [g, h] = T.useState(null), [y, b] = T.useState(null), v = T.useCallback((R) => {
    ...
    D.current && (R.platform = D.current), Vp(M.current, E.current, R).then((L) => {
      const H = {
        ...L,
      ...
      O.current && !ro(k.current, H) && (k.current = H, Ec.flushSync(() => {
        d(H);
      }));
    });
  }, [f, t, n, D, A]);
  ...
  const $ = T.useMemo(() => ({
    ...
    if (!z.floating)
      return R;
    const L = vi(z.floating, u.x), H = vi(z.floating, u.y);
    return a ? {
      ...R,
...
var oh = "Arrow", Xc = T.forwardRef((e, t) => {
...
var ma = "Popper", [Zc, Co] = Cn(ma), [ih, Qc] = Zc(ma), Jc = (e) => {
  const { __scopePopper: t, children: n } = e, [r, o] = T.useState(null);
  return /* @__PURE__ */ m(ih, { scope: t, anchor: r, onAnchorChange: o, children: n });
};
Jc.displayName = ma;
var el = "PopperAnchor", tl = T.forwardRef(
  (e, t) => {
    const { __scopePopper: n, virtualRef: r, ...o } = e, s = Qc(el, n), i = T.useRef(null), a = Ie(t, i), c = T.useRef(null);
    return T.useEffect(() => {
      const l = c.current;
...
tl.displayName = el;
var pa = "PopperContent", [ch, lh] = Zc(pa), nl = T.forwardRef(
  (e, t) => {
    const {
      __scopePopper: n,
      side: r = "bottom",
      ...
      onPlaced: g,
      ...h
    } = e, y = Qc(pa, n), [b, v] = T.useState(null), x = Ie(t, (_) => v(_)), [S, w] = T.useState(null), M = ah(S), E = M?.width ?? 0, k = M?.height ?? 0, N = r + (s !== "center" ? "-" + s : ""), C = typeof u == "number" ? u : { top: 0, right: 0, bottom: 0, left: 0, ...u }, D = Array.isArray(l) ? l : [l], A = D.length > 0, P = {
      padding: C,
      boundary: D.filter(dh),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: A
    }, { refs: O, floatingStyles: $, placement: z, isPositioned: V, middlewareData: R } = qp({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: N,
      whileElementsMounted: (..._) => Wp(..._, {
      ...
      middleware: [
        Zp({ mainAxis: o + k, alignmentAxis: i }),
        c && Qp({
          mainAxis: !0,
          crossAxis: !1,
        ...
        S && rh({ element: S, padding: a }),
        fh({ arrowWidth: E, arrowHeight: k }),
        f && nh({ strategy: "referenceHidden", ...P })
      ]
    }), [L, H] = sl(z), q = ht(g);
    It(() => {
      V && q?.();
...
nl.displayName = pa;
var rl = "PopperArrow", uh = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, ol = T.forwardRef(function(t, n) {
  const { __scopePopper: r, ...o } = t, s = lh(rl, r), i = uh[s.placedSide];
  return (
...
var fh = (e) => ({
  ...
  options: e,
  fn(t) {
    const { placement: n, rects: r, middlewareData: o } = t, i = o.arrow?.centerOffset !== 0, a = i ? 0 : e.arrowWidth, c = i ? 0 : e.arrowHeight, [l, u] = sl(n), d = { start: "0%", center: "50%", end: "100%" }[u], f = (o.arrow?.x ?? 0) + a / 2, p = (o.arrow?.y ?? 0) + c / 2;
    let g = "", h = "";
...
var al = Jc, il = tl, cl = nl, ll = ol, mh = "Portal", ha = T.forwardRef((e, t) => {
...
var qt = (e) => {
  const { present: t, children: n } = e, r = hh(t), o = typeof n == "function" ? n({ present: r.isPresent }) : T.Children.only(n), s = Ie(r.ref, gh(o));
  return typeof n == "function" || r.isPresent ? T.cloneElement(o, { ref: s }) : null;
};
qt.displayName = "Presence";
function hh(e) {
  const [t, n] = T.useState(), r = T.useRef(null), o = T.useRef(e), s = T.useRef("none"), i = e ? "mounted" : "unmounted", [a, c] = ph(i, {
    mounted: {
      UNMOUNT: "unmounted",
...
var Zo = "rovingFocusGroup.onEntryFocus", yh = { bubbles: !1, cancelable: !0 }, tr = "RovingFocusGroup", [ks, ul, vh] = Rc(tr), [bh, dl] = Cn(
  tr,
  [vh]
), [wh, xh] = bh(tr), fl = T.forwardRef(
  (e, t) => /* @__PURE__ */ m(ks.Provider, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ m(ks.Slot, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ m(kh, { ...e, ref: t }) }) })
);
fl.displayName = tr;
var kh = T.forwardRef((e, t) => {
  const {
    ...
    ...d
  } = e, f = T.useRef(null), p = Ie(t, f), g = Pc(s), [h, y] = sa({
    prop: i,
    defaultProp: a ?? null,
    onChange: c,
    caller: tr
  }), [b, v] = T.useState(!1), x = ht(l), S = ul(n), w = T.useRef(!1), [M, E] = T.useState(0);
  return T.useEffect(() => {
    const k = f.current;
    if (k)
...
}), ml = "RovingFocusGroupItem", pl = T.forwardRef(
  (e, t) => {
    const {
      __scopeRovingFocusGroup: n,
      focusable: r = !0,
      ...
      children: i,
      ...a
    } = e, c = Jr(), l = s || c, u = xh(ml, n), d = u.currentTabStopId === l, f = ul(n), { onFocusableItemAdd: p, onFocusableItemRemove: g, currentTabStopId: h } = u;
    return T.useEffect(() => {
      if (r)
        return p(), () => g();
    }, [r, p, g]), /* @__PURE__ */ m(
        ...
        children: /* @__PURE__ */ m(
          Ae.span,
          {
            ...
            onKeyDown: ie(e.onKeyDown, (y) => {
              ...
              const b = Th(y, u.orientation, u.dir);
              if (b !== void 0) {
...
var Eh = fl, Dh = pl, Nh = function(e) {
  if (typeof document > "u")
    return null;
  var t = Array.isArray(e) ? e[0] : e;
  return t.ownerDocument.body;
}, tn = /* @__PURE__ */ new WeakMap(), Ir = /* @__PURE__ */ new WeakMap(), Rr = {}, Qo = 0, gl = function(e) {
...
var Gr = "right-scroll-bar-position", qr = "width-before-scroll-bar", Ph = "with-scroll-bars-hidden", Oh = "--removed-body-scroll-bar-size";
function Jo(e, t) {
...
var $h = typeof window < "u" ? T.useLayoutEffect : T.useEffect, bi = /* @__PURE__ */ new WeakMap();
function Hh(e, t) {
  var n = _h(null, function(r) {
...
var bl = Bh(), es = function() {
}, Mo = T.forwardRef(function(e, t) {
  var n = T.useRef(null), r = T.useState({
    onScrollCapture: es,
    onWheelCapture: es,
    onTouchMoveCapture: es
  }), o = r[0], s = r[1], i = e.forwardProps, a = e.children, c = e.className, l = e.removeScrollBar, u = e.enabled, d = e.shards, f = e.sideCar, p = e.noRelative, g = e.noIsolation, h = e.inert, y = e.allowPinchZoom, b = e.as, v = b === void 0 ? "div" : b, x = e.gapMode, S = yl(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), w = f, M = Hh([n, t]), E = tt(tt({}, S), o);
  return T.createElement(
    T.Fragment,
    null,
    u && T.createElement(w, { sideCar: bl, removeScrollBar: l, shards: d, noRelative: p, noIsolation: g, inert: h, setCallbacks: s, allowPinchZoom: !!y, lockRef: n, gapMode: x }),
...
}, Qh = wl(), fn = "data-scroll-locked", Jh = function(e, t, n, r) {
...
`);
  ...
  return T.createElement(Qh, { styles: Jh(s, !t, o, n ? "" : "!important") });
}, Cs = !1;
if (typeof window < "u")
  try {
...
var nn = Cs ? { passive: !1 } : !1, ng = function(e) {
  ...
  var s = ig(e, window.getComputedStyle(t).direction), i = s * r, a = n.target, c = t.contains(a), l = !1, u = i > 0, d = 0, f = 0;
  do {
    if (!a)
      break;
    var p = Cl(e, a), g = p[0], h = p[1], y = p[2], b = h - y - s * g;
    (g || b) && kl(e, a) && (d += b, f += g);
    var v = a.parentNode;
...
function fg(e) {
  var t = T.useRef([]), n = T.useRef([0, 0]), r = T.useRef(), o = T.useState(dg++)[0], s = T.useState(wl)[0], i = T.useRef(e);
  T.useEffect(function() {
    i.current = e;
  }, [e]), T.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(o));
      var h = Rh([e.lockRef.current], (e.shards || []).map(Ci), !0).filter(Boolean);
  ...
  var a = T.useCallback(function(h, y) {
    ...
    if (!k)
      return !0;
    if (k ? w = E : (w = E === "v" ? "h" : "v", k = xi(E, M)), !k)
      return !1;
    if (!r.current && "changedTouches" in h && (x || S) && (r.current = w), !w)
      return !0;
    var N = r.current || w;
    return cg(N, y, h, N === "h" ? x : S);
  }, []), c = T.useCallback(function(h) {
    var y = h;
    if (!(!rn.length || rn[rn.length - 1] !== s)) {
      var b = "deltaY" in y ? ki(y) : Or(y), v = t.current.filter(function(w) {
        return w.name === y.type && (w.target === y.target || y.target === w.shadowParent) && lg(w.delta, b);
      })[0];
      if (v && v.should) {
    ...
    var x = { name: h, delta: y, target: b, should: v, shadowParent: mg(b) };
    ...
    l(h.type, ki(h), h.target, a(h, e.lockRef.current));
  ...
  return T.createElement(
    T.Fragment,
    null,
    g ? T.createElement(s, { styles: ug(o) }) : null,
    p ? T.createElement(tg, { noRelative: e.noRelative, gapMode: e.gapMode }) : null
  );
}
function mg(e) {
...
var Ml = T.forwardRef(function(e, t) {
  return T.createElement(Mo, tt({}, e, { ref: t, sideCar: pg }));
});
Ml.classNames = Mo.classNames;
var Ms = ["Enter", " "], hg = ["ArrowDown", "PageUp", "Home"], Tl = ["ArrowUp", "PageDown", "End"], gg = [...hg, ...Tl], yg = {
  ltr: [...Ms, "ArrowRight"],
  rtl: [...Ms, "ArrowLeft"]
}, vg = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, nr = "Menu", [qn, bg, wg] = Rc(nr), [Xt, Sl] = Cn(nr, [
  wg,
  Co,
  dl
]), To = Co(), El = dl(), [xg, Zt] = Xt(nr), [kg, rr] = Xt(nr), Dl = (e) => {
  const { __scopeMenu: t, open: n = !1, children: r, dir: o, onOpenChange: s, modal: i = !0 } = e, a = To(t), [c, l] = T.useState(null), u = T.useRef(!1), d = ht(s), f = Pc(o);
  return T.useEffect(() => {
    const p = () => {
  ...
  }, []), /* @__PURE__ */ m(al, { ...a, children: /* @__PURE__ */ m(
    xg,
    {
      scope: t,
      open: n,
...
Dl.displayName = nr;
var Cg = "MenuAnchor", ga = T.forwardRef(
  (e, t) => {
...
ga.displayName = Cg;
var ya = "MenuPortal", [Mg, Nl] = Xt(ya, {
  forceMount: void 0
}), Al = (e) => {
  const { __scopeMenu: t, forceMount: n, children: r, container: o } = e, s = Zt(ya, t);
  return /* @__PURE__ */ m(Mg, { scope: t, forceMount: n, children: /* @__PURE__ */ m(qt, { present: n || s.open, children: /* @__PURE__ */ m(ha, { asChild: !0, container: o, children: r }) }) });
};
Al.displayName = ya;
var Ke = "MenuContent", [Tg, va] = Xt(Ke), Ll = T.forwardRef(
  (e, t) => {
    const n = Nl(Ke, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, s = Zt(Ke, e.__scopeMenu), i = rr(Ke, e.__scopeMenu);
    return /* @__PURE__ */ m(qn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ m(qt, { present: r || s.open, children: /* @__PURE__ */ m(qn.Slot, { scope: e.__scopeMenu, children: i.modal ? /* @__PURE__ */ m(Sg, { ...o, ref: t }) : /* @__PURE__ */ m(Eg, { ...o, ref: t }) }) }) });
  }
), Sg = T.forwardRef(
  (e, t) => {
...
}), Dg = /* @__PURE__ */ Vn("MenuContent.ScrollLock"), ba = T.forwardRef(
  (e, t) => {
    const {
      __scopeMenu: n,
      loop: r = !1,
      ...
      ...h
    } = e, y = Zt(Ke, n), b = rr(Ke, n), v = To(n), x = El(n), S = bg(n), [w, M] = T.useState(null), E = T.useRef(null), k = Ie(t, E, y.onContentChange), N = T.useRef(0), C = T.useRef(""), D = T.useRef(0), A = T.useRef(null), P = T.useRef("right"), O = T.useRef(0), $ = g ? Ml : T.Fragment, z = g ? { as: Dg, allowPinchZoom: !0 } : void 0, V = (L) => {
      const H = C.current + L, q = S().filter((_) => !_.disabled), F = document.activeElement, Y = q.find((_) => _.ref.current === F)?.textValue, G = q.map((_) => _.textValue), W = zg(G, H, Y), J = q.find((_) => _.textValue === W)?.ref.current;
      (function _(ee) {
        C.current = ee, window.clearTimeout(N.current), ee !== "" && (N.current = window.setTimeout(() => _(""), 1e3));
      })(H), J && setTimeout(() => J.focus());
    };
    T.useEffect(() => () => window.clearTimeout(N.current), []), Hm();
    const R = T.useCallback((L) => P.current === A.current?.side && Fg(L, A.current?.area), []);
    return /* @__PURE__ */ m(
      Tg,
      {
        scope: n,
                    ...
                    children: /* @__PURE__ */ m(
                      cl,
                      {
                        ...
                        onKeyDown: ie(h.onKeyDown, (L) => {
                          ...
                          const G = E.current;
                          if (L.target !== G || !gg.includes(L.key)) return;
                          L.preventDefault();
                          const J = S().filter((_) => !_.disabled).map((_) => _.ref.current);
                          Tl.includes(L.key) && J.reverse(), Hg(J);
                        }),
...
Ll.displayName = Ke;
var Ng = "MenuGroup", wa = T.forwardRef(
  (e, t) => {
...
wa.displayName = Ng;
var Ag = "MenuLabel", Il = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
...
Il.displayName = Ag;
var oo = "MenuItem", Mi = "menu.itemSelect", So = T.forwardRef(
  (e, t) => {
    const { disabled: n = !1, onSelect: r, ...o } = e, s = T.useRef(null), i = rr(oo, e.__scopeMenu), a = va(oo, e.__scopeMenu), c = Ie(t, s), l = T.useRef(!1), u = () => {
      ...
      if (!n && d) {
        ...
        d.addEventListener(Mi, (p) => r?.(p), { once: !0 }), Ic(d, f), f.defaultPrevented ? l.current = !1 : i.onClose();
      }
    };
    return /* @__PURE__ */ m(
      Rl,
...
var Rl = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, disabled: r = !1, textValue: o, ...s } = e, i = va(oo, n), a = El(n), c = T.useRef(null), l = Ie(t, c), [u, d] = T.useState(!1), [f, p] = T.useState("");
    return T.useEffect(() => {
      const g = c.current;
      ...
      qn.ItemSlot,
      {
        ...
        disabled: r,
        textValue: o ?? f,
        children: /* @__PURE__ */ m(Dh, { asChild: !0, ...a, focusable: !r, children: /* @__PURE__ */ m(
          Ae.div,
          {
            role: "menuitem",
...
), Lg = "MenuCheckboxItem", Pl = T.forwardRef(
  (e, t) => {
    const { checked: n = !1, onCheckedChange: r, ...o } = e;
    return /* @__PURE__ */ m(Wl, { scope: e.__scopeMenu, checked: n, children: /* @__PURE__ */ m(
      So,
      {
...
Pl.displayName = Lg;
var Ol = "MenuRadioGroup", [Ig, Rg] = Xt(
  Ol,
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ m(Ig, { scope: e.__scopeMenu, value: n, onValueChange: s, children: /* @__PURE__ */ m(wa, { ...o, ref: t }) });
  }
);
_l.displayName = Ol;
var $l = "MenuRadioItem", Hl = T.forwardRef(
  (e, t) => {
    const { value: n, ...r } = e, o = Rg($l, e.__scopeMenu), s = n === o.value;
    return /* @__PURE__ */ m(Wl, { scope: e.__scopeMenu, checked: s, children: /* @__PURE__ */ m(
      So,
      {
        role: "menuitemradio",
        "aria-checked": s,
...
Hl.displayName = $l;
var xa = "MenuItemIndicator", [Wl, Pg] = Xt(
  xa,
  { checked: !1 }
), zl = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, forceMount: r, ...o } = e, s = Pg(xa, n);
    return /* @__PURE__ */ m(
      qt,
      {
...
zl.displayName = xa;
var Og = "MenuSeparator", Bl = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e;
    return /* @__PURE__ */ m(
      Ae.div,
...
Bl.displayName = Og;
var _g = "MenuArrow", Fl = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...r } = e, o = To(n);
    return /* @__PURE__ */ m(ll, { ...o, ...r, ref: t });
  }
);
Fl.displayName = _g;
var $g = "MenuSub", [W1, Ul] = Xt($g), Hn = "MenuSubTrigger", Yl = T.forwardRef(
  (e, t) => {
    const n = Zt(Hn, e.__scopeMenu), r = rr(Hn, e.__scopeMenu), o = Ul(Hn, e.__scopeMenu), s = va(Hn, e.__scopeMenu), i = T.useRef(null), { pointerGraceTimerRef: a, onPointerGraceIntentChange: c } = s, l = { __scopeMenu: e.__scopeMenu }, u = T.useCallback(() => {
    ...
    return T.useEffect(() => u, [u]), T.useEffect(() => {
      ...
      Rl,
      {
        ...
        onKeyDown: ie(e.onKeyDown, (d) => {
          ...
          e.disabled || f && d.key === " " || yg[r.dir].includes(d.key) && (n.onOpenChange(!0), n.content?.focus(), d.preventDefault());
        })
      }
    ) });
  }
...
Yl.displayName = Hn;
var jl = "MenuSubContent", Vl = T.forwardRef(
  (e, t) => {
    const n = Nl(Ke, e.__scopeMenu), { forceMount: r = n.forceMount, ...o } = e, s = Zt(Ke, e.__scopeMenu), i = rr(Ke, e.__scopeMenu), a = Ul(jl, e.__scopeMenu), c = T.useRef(null), l = Ie(t, c);
    return /* @__PURE__ */ m(qn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ m(qt, { present: r || s.open, children: /* @__PURE__ */ m(qn.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ m(
      ba,
      {
        ...
        onKeyDown: ie(e.onKeyDown, (u) => {
          const d = u.currentTarget.contains(u.target), f = vg[i.dir].includes(u.key);
...
var Ug = Dl, Yg = ga, jg = Al, Vg = Ll, Kg = wa, Gg = Il, qg = So, Xg = Pl, Zg = _l, Qg = Hl, Jg = zl, ey = Bl, ty = Fl, ny = Yl, ry = Vl, Eo = "DropdownMenu", [oy] = Cn(
  Eo,
  [Sl]
), Pe = Sl(), [sy, Gl] = oy(Eo), ql = (e) => {
  const {
  ...
  return /* @__PURE__ */ m(
    sy,
    {
      ...
      modal: a,
      children: /* @__PURE__ */ m(Ug, { ...c, open: u, onOpenChange: d, dir: r, modal: a, children: n })
    }
  );
};
ql.displayName = Eo;
var Xl = "DropdownMenuTrigger", Zl = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, disabled: r = !1, ...o } = e, s = Gl(Xl, n), i = Pe(n);
    return /* @__PURE__ */ m(Yg, { asChild: !0, ...i, children: /* @__PURE__ */ m(
      Ae.button,
      {
        type: "button",
        id: s.triggerId,
...
Zl.displayName = Xl;
var ay = "DropdownMenuPortal", Ql = (e) => {
  const { __scopeDropdownMenu: t, ...n } = e, r = Pe(t);
  return /* @__PURE__ */ m(jg, { ...r, ...n });
};
Ql.displayName = ay;
var Jl = "DropdownMenuContent", eu = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Gl(Jl, n), s = Pe(n), i = T.useRef(!1);
    return /* @__PURE__ */ m(
      Vg,
      {
        id: o.contentId,
...
eu.displayName = Jl;
var iy = "DropdownMenuGroup", cy = T.forwardRef(
  (e, t) => {
...
cy.displayName = iy;
var ly = "DropdownMenuLabel", uy = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
...
uy.displayName = ly;
var dy = "DropdownMenuItem", tu = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
...
tu.displayName = dy;
var fy = "DropdownMenuCheckboxItem", my = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(Xg, { ...o, ...r, ref: t });
});
my.displayName = fy;
var py = "DropdownMenuRadioGroup", hy = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(Zg, { ...o, ...r, ref: t });
});
hy.displayName = py;
var gy = "DropdownMenuRadioItem", yy = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(Qg, { ...o, ...r, ref: t });
});
yy.displayName = gy;
var vy = "DropdownMenuItemIndicator", by = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(Jg, { ...o, ...r, ref: t });
});
by.displayName = vy;
var wy = "DropdownMenuSeparator", nu = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(ey, { ...o, ...r, ref: t });
});
nu.displayName = wy;
var xy = "DropdownMenuArrow", ky = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
...
ky.displayName = xy;
var Cy = "DropdownMenuSubTrigger", My = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(ny, { ...o, ...r, ref: t });
});
My.displayName = Cy;
var Ty = "DropdownMenuSubContent", Sy = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...r } = e, o = Pe(n);
  return /* @__PURE__ */ m(
    ry,
    {
...
Sy.displayName = Ty;
var Ey = ql, Dy = Zl, Ny = Ql, Ay = eu, Ly = tu, Iy = nu;
function ru(e) {
  var t, n, r = "";
...
const Ca = "-", Ry = (e) => {
  ...
  return {
    getClassGroupId: (i) => {
      const a = i.split(Ca);
      return a[0] === "" && a.length !== 1 && a.shift(), su(a, t) || Py(i);
    },
  ...
  let r = (o) => {
    ...
    const u = s.length === 0 ? o : o.substring(c), d = zy(u), f = d !== u, p = l && l > c ? l - c : void 0;
    return {
      modifiers: s,
  ...
  return r;
}, zy = (e) => e.endsWith(Ss) ? e.substring(0, e.length - 1) : e.startsWith(Ss) ? e.substring(1) : e, By = (e) => {
...
function Vy(e, ...t) {
  ...
  function i(c) {
    ...
    return n = Fy(l), r = n.cache.get, o = n.cache.set, s = a, a(c);
  }
  function a(c) {
    const l = r(c);
    if (l)
...
const Ee = (e) => {
...
}, iu = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, cu = /^\((?:(\w[\w-]*):)?(.+)\)$/i, Ky = /^\d+\/\d+$/, Gy = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, qy = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, Xy = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, Zy = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, Qy = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, on = (e) => Ky.test(e), le = (e) => !!e && !Number.isNaN(Number(e)), Tt = (e) => !!e && Number.isInteger(Number(e)), ns = (e) => e.endsWith("%") && le(e.slice(0, -1)), ct = (e) => Gy.test(e), Jy = () => !0, ev = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  qy.test(e) && !Xy.test(e)
), lu = () => !1, tv = (e) => Zy.test(e), nv = (e) => Qy.test(e), rv = (e) => !Z(e) && !Q(e), ov = (e) => Sn(e, fu, lu), Z = (e) => iu.test(e), zt = (e) => Sn(e, mu, ev), rs = (e) => Sn(e, lv, le), Ei = (e) => Sn(e, uu, lu), sv = (e) => Sn(e, du, nv), _r = (e) => Sn(e, pu, tv), Q = (e) => cu.test(e), Pn = (e) => En(e, mu), av = (e) => En(e, uv), Di = (e) => En(e, uu), iv = (e) => En(e, fu), cv = (e) => En(e, du), $r = (e) => En(e, pu, !0), Sn = (e, t, n) => {
  const r = iu.exec(e);
  return r ? r[1] ? t(r[1]) : n(r[2]) : !1;
}, En = (e, t, n = !1) => {
  const r = cu.exec(e);
  return r ? r[1] ? t(r[1]) : n : !1;
}, uu = (e) => e === "position" || e === "percentage", du = (e) => e === "image" || e === "url", fu = (e) => e === "length" || e === "size" || e === "bg-size", mu = (e) => e === "length", lv = (e) => e === "number", uv = (e) => e === "family-name", pu = (e) => e === "shadow", dv = () => {
  const e = Ee("color"), t = Ee("font"), n = Ee("text"), r = Ee("font-weight"), o = Ee("tracking"), s = Ee("leading"), i = Ee("breakpoint"), a = Ee("container"), c = Ee("spacing"), l = Ee("radius"), u = Ee("shadow"), d = Ee("inset-shadow"), f = Ee("text-shadow"), p = Ee("drop-shadow"), g = Ee("blur"), h = Ee("perspective"), y = Ee("aspect"), b = Ee("ease"), v = Ee("animate"), x = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], S = () => [
    ...
    span: ["full", Tt, Q, Z]
  }, Tt, Q, Z], A = () => [Tt, "auto", Q, Z], P = () => ["auto", "min", "max", "fr", Q, Z], O = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], $ = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], z = () => ["auto", ...k()], V = () => [on, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...k()], R = () => [e, Q, Z], L = () => [...S(), Di, Ei, {
    position: [Q, Z]
  }], H = () => ["no-repeat", {
    repeat: ["", "x", "y", "space", "round"]
  }], q = () => ["auto", "cover", "contain", iv, ov, {
    size: [Q, Z]
  }], F = () => [ns, Pn, zt], Y = () => [
    ...
    Q,
    Z
  ], G = () => ["", le, Pn, zt], W = () => ["solid", "dashed", "dotted", "double"], J = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], _ = () => [le, ns, Di, Ei], ee = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    g,
...
function os({
  ...
  return /* @__PURE__ */ m(Ey, { "data-slot": "dropdown-menu", ...e });
}
function ss({
  ...e
}) {
...
function as({
  ...
  return /* @__PURE__ */ m(Ny, { children: /* @__PURE__ */ m(
    Ay,
    {
...
const Ni = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, Ai = ou, mv = (e, t) => (n) => {
  var r;
...
var pv = Object.freeze({
  ...
  whiteSpace: "nowrap",
  wordWrap: "normal"
}), hv = "VisuallyHidden", hu = T.forwardRef(
  (e, t) => /* @__PURE__ */ m(
    Ae.span,
    {
      ...e,
...
hu.displayName = hv;
var gv = hu, [Do] = Cn("Tooltip", [
  Co
]), No = Co(), gu = "TooltipProvider", yv = 700, Ns = "tooltip.open", [vv, Ma] = Do(gu), yu = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = yv,
...
yu.displayName = gu;
var Zn = "Tooltip", [bv, or] = Do(Zn), vu = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: r,
  ...
  }, []), /* @__PURE__ */ m(al, { ...l, children: /* @__PURE__ */ m(
    bv,
    {
      scope: t,
      contentId: f,
...
vu.displayName = Zn;
var As = "TooltipTrigger", bu = T.forwardRef(
  (e, t) => {
    ...
    return T.useEffect(() => () => document.removeEventListener("pointerup", d), [d]), /* @__PURE__ */ m(il, { asChild: !0, ...i, children: /* @__PURE__ */ m(
      Ae.button,
      {
...
bu.displayName = As;
var Ta = "TooltipPortal", [wv, xv] = Do(Ta, {
  forceMount: void 0
}), wu = (e) => {
  const { __scopeTooltip: t, forceMount: n, children: r, container: o } = e, s = or(Ta, t);
  return /* @__PURE__ */ m(wv, { scope: t, forceMount: n, children: /* @__PURE__ */ m(qt, { present: n || s.open, children: /* @__PURE__ */ m(ha, { asChild: !0, container: o, children: r }) }) });
};
wu.displayName = Ta;
var wn = "TooltipContent", xu = T.forwardRef(
  (e, t) => {
    const n = xv(wn, e.__scopeTooltip), { forceMount: r = n.forceMount, side: o = "top", ...s } = e, i = or(wn, e.__scopeTooltip);
    return /* @__PURE__ */ m(qt, { present: r || i.open, children: i.disableHoverableContent ? /* @__PURE__ */ m(ku, { side: o, ...s, ref: t }) : /* @__PURE__ */ m(kv, { side: o, ...s, ref: t }) });
  }
), kv = T.forwardRef((e, t) => {
  const n = or(wn, e.__scopeTooltip), r = Ma(wn, e.__scopeTooltip), o = T.useRef(null), s = Ie(t, o), [i, a] = T.useState(null), { trigger: c, onClose: l } = n, u = o.current, { onPointerInTransitChange: d } = r, f = T.useCallback(() => {
    ...
    (g, h) => {
      const y = g.currentTarget, b = { x: g.clientX, y: g.clientY }, v = Sv(b, y.getBoundingClientRect()), x = Ev(b, v), S = Dv(h.getBoundingClientRect()), w = Av([...x, ...S]);
      a(w), d(!0);
    },
    [d]
  );
  return T.useEffect(() => () => f(), [f]), T.useEffect(() => {
    ...
    if (i) {
      const g = (h) => {
        const y = h.target, b = { x: h.clientX, y: h.clientY }, v = c?.contains(y) || u?.contains(y), x = !Nv(b, i);
        v ? f() : x && (f(), l());
      };
      return document.addEventListener("pointermove", g), () => document.removeEventListener("pointermove", g);
    }
  }, [c, u, i, l, f]), /* @__PURE__ */ m(ku, { ...e, ref: s });
}), [Cv, Mv] = Do(Zn, { isInside: !1 }), Tv = /* @__PURE__ */ Mm("TooltipContent"), ku = T.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: r,
      ...
      aa,
      {
        ...
        children: /* @__PURE__ */ I(
          cl,
          {
            ...
            children: [
              /* @__PURE__ */ m(Tv, { children: r }),
              /* @__PURE__ */ m(Cv, { scope: n, isInside: !0, children: /* @__PURE__ */ m(gv, { id: c.contentId, role: "tooltip", children: o || r }) })
            ]
          }
        )
      }
...
xu.displayName = wn;
var Cu = "TooltipArrow", Mu = T.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...r } = e, o = No(n);
    return Mv(
      Cu,
      n
    ).isInside ? null : /* @__PURE__ */ m(ll, { ...o, ...r, ref: t });
  }
);
Mu.displayName = Cu;
function Sv(e, t) {
...
var Iv = yu, Rv = vu, Pv = bu, Ov = wu, _v = xu, $v = Mu;
function Hv({
  delayDuration: e = 0,
  ...t
}) {
...
function Ls({
  ...
  return /* @__PURE__ */ m(Hv, { children: /* @__PURE__ */ m(Rv, { "data-slot": "tooltip", ...e }) });
}
function Is({
  ...e
}) {
...
function Rs({
  ...
  return /* @__PURE__ */ m(Ov, { children: /* @__PURE__ */ I(
    _v,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ m($v, { className: "bg-foreground fill-foreground z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" })
      ]
    }
  ) });
}
...
}, sn = () => /* @__PURE__ */ m("div", { className: "w-px h-5 bg-border mx-0.5 shrink-0" }), Wv = vt(function({ editor: t, onCopyMarkdown: n, onOpenLinkPopover: r, className: o = "", autoReorderChecklist: s = !1, aiEnabled: i = !1, onAISparklesClick: a }) {
  const c = j(null), [l, u] = U(!1), [d, f] = U(void 0), p = dc({
    editor: t,
    selector: ({ editor: M }) => ({
      canUndo: M.can().undo(),
      canRedo: M.can().redo(),
...
function zv({ editor: e, isOpen: t, onClose: n, focusTrigger: r = 0, initialSearchQuery: o, editorMode: s = "wysiwyg", rawMarkdown: i = "", onRawMarkdownChange: a, onMatchesChange: c }) {
...
const Bv = typeof navigator < "u" && /Mac|iPod|iPhone|iPad/.test(navigator.platform), lt = Bv ? "⌘" : "Ctrl", Fv = ({ editor: e }) => {
      ...
      handleDOMEvents: {
        contextmenu(t, n) {
          ...
          if (o && o.closest(".ProseMirror")) {
            ...
            return e.chain().focus().setTextSelection(s).run(), qv(n, e, s), !0;
          }
          return !1;
        }
      }
...
function qv(e, t, n) {
  ...
  const h = [
    ...
    { label: "divider" },
    { label: "Copy Table", icon: "copy", action: () => Xv(t) }
  ], y = {
...
}), Qv = qf.extend({}), Un = new Te("tableSorting");
let Ut = null, Wn = null;
function Jv(e) {
...
function tb(e, t, n) {
  ...
  if (l.length < 2) {
    Li(n, i), o.dispatch(r.tr.setMeta(Un, { updated: !0 }));
    return;
  }
  const u = l.map((g) => {
    let h = "", y = 0;
  ...
  u.sort((g, h) => eb(g.sortValue, h.sortValue, i));
...
function nb(e, t, n, r) {
  ...
  return s.style.cssText = "display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;padding:0;font-size:10px;color:" + (e ? a : c) + ";background:transparent;border:none;border-radius:3px;cursor:pointer;user-select:none;transition:all 0.15s ease;opacity:" + (e ? "1" : "0.5") + ";pointer-events:auto;vertical-align:middle;", s.addEventListener("mouseenter", () => {
    ...
    u.preventDefault(), u.stopPropagation(), tb(r, t, n);
  ...
  return new Me({
    ...
    state: {
      ...
      apply(t, n, r, o) {
        ...
        return !t.docChanged && !s?.updated && Wn ? Wn.map(t.mapping, t.doc) : (Wn = ob(o.doc, e), Wn);
      }
    },
    props: {
      decorations(t) {
        ...
        if (i.type.name === "tableRow") {
          ...
          i.forEach((u, d) => {
            if (u.type.name === "tableHeader") {
              ...
              const h = Ut?.tablePos === s && Ut?.columnIndex === c ? Ut.direction : null, y = c, b = s, v = Ze.widget(p, () => nb(h, b, y, t), { side: 1, key: "sort-" + s + "-" + y });
              n.push(v);
            }
            l += u.nodeSize, c++;
          });
      ...
      new Me({
        ...
        state: {
          ...
          apply(n, r, o, s) {
            ...
            } : n.docChanged ? fb(o.doc, s.doc, t.listItemTypes) ? {
              collapsedItems: new Set(e.collapsedItems),
              decorations: Wr(s.doc, e, t),
              docVersion: r.docVersion + 1
            } : {
...
const zr = {
  ...
  prompt: { icon: vc, label: "Prompt", color: "var(--callout-prompt)", borderColor: "var(--callout-prompt-border)" },
...
function pb({ node: e, updateAttributes: t, editor: n }) {
        ...
        children: [
          ...
          /* @__PURE__ */ m(
            "div",
            {
              ...
              children: s ? /* @__PURE__ */ m(wc, { size: 16 }) : /* @__PURE__ */ m(Lt, { size: 16 })
            }
          ),
      ...
      new Me({
        ...
        props: {
          handleDOMEvents: {
            copy(e, t) {
              const { state: n } = e;
              if (!(n.selection instanceof Pf)) return !1;
...
function Yt(e, t) {
  try {
    const r = (vb[e] ||= new Intl.DateTimeFormat("en-US", {
      timeZone: e,
      timeZoneName: "longOffset"
    }).format)(t).split("GMT")[1];
    return r in zn ? zn[r] : Pi(r, r.split(":"));
  } catch {
...
class Le extends rt {
  ...
  toTimeString() {
    ...
    return `${t} GMT${n}${r}${o} (${yb(this.timeZone, this)})`;
  }
  toLocaleString(t, n) {
...
const Su = 6048e5, xb = 864e5, _i = Symbol.for("constructDateFrom");
function Ce(e, t) {
...
function Au(e, t, n) {
  const [r, o] = Dn(
    ...
    e,
    t
  ), s = Jn(r), i = Jn(o), a = +s - $i(s), c = +i - $i(i);
  return Math.round((a - c) / xb);
}
function Cb(e, t) {
  const n = Nu(e, t), r = Ce(e, 0);
...
function Nb(e) {
  return !(!Lu(e) && typeof e != "number" || isNaN(+he(e)));
}
function Ab(e, t, n) {
  const [r, o] = Dn(
    n?.in,
...
function _n(e) {
  return (t, n = {}) => {
    ...
    if (!s)
      return null;
    const i = s[0], a = r && e.parsePatterns[r] || e.parsePatterns[e.defaultParseWidth], c = Array.isArray(a) ? ew(a, (d) => d.test(i)) : (
...
function gw(e, t) {
  const n = sr(), r = t?.firstWeekContainsDate ?? t?.locale?.options?.firstWeekContainsDate ?? n.firstWeekContainsDate ?? n.locale?.options?.firstWeekContainsDate ?? 1, o = _u(e, t), s = Ce(t?.in || e, 0);
  return s.setFullYear(o, 0, r), s.setHours(0, 0, 0, 0), xn(s, t);
}
function $u(e, t) {
  const n = he(e, t?.in), r = +xn(n, t) - +gw(n, t);
  return Math.round(r / Su) + 1;
}
function pe(e, t) {
...
const Bi = (e, t) => {
  ...
  return s.replace("{{date}}", Bi(r, t)).replace("{{time}}", Hu(o, t));
}, vw = {
  p: Hu,
  P: yw
}, bw = /^D+$/, ww = /^Y+$/, xw = ["D", "DD", "YY", "YYYY"];
function kw(e) {
  return bw.test(e);
}
function Cw(e) {
...
function Mw(e, t, n) {
  const r = Tw(e, t, n);
  if (console.warn(r), xw.includes(e)) throw new RangeError(r);
}
function Tw(e, t, n) {
  const r = e[0] === "Y" ? "years" : "days of the month";
  return `Use \`${e.toLowerCase()}\` instead of \`${e}\` (in \`${t}\`) for formatting ${r} to the input \`${n}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`;
}
const Sw = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g, Ew = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g, Dw = /^'([^]*?)'?$/, Nw = /''/g, Aw = /[a-zA-Z]/;
function Lw(e, t, n) {
  ...
  return c.map((u) => {
    ...
    const d = u.value;
    (!n?.useAdditionalWeekYearTokens && Cw(d) || !n?.useAdditionalDayOfYearTokens && kw(d)) && Mw(d, t, String(e));
    const f = Hi[d[0]];
...
function Uw(e, t) {
  ...
  return t.getMonth(e) === t.getMonth(s) ? Fi : Fw;
}
function Wu(e, t) {
...
class Fe {
   ...
   */
  constructor(t, n) {
    this.Date = Date, this.today = () => this.overrides?.today ? this.overrides.today() : this.options.timeZone ? Le.tz(this.options.timeZone) : new this.Date(), this.newDate = (r, o, s) => this.overrides?.newDate ? this.overrides.newDate(r, o, s) : this.options.timeZone ? new Le(r, o, s, this.options.timeZone) : new Date(r, o, s), this.addDays = (r, o) => this.overrides?.addDays ? this.overrides.addDays(r, o) : Eu(r, o), this.addMonths = (r, o) => this.overrides?.addMonths ? this.overrides.addMonths(r, o) : Du(r, o), this.addWeeks = (r, o) => this.overrides?.addWeeks ? this.overrides.addWeeks(r, o) : Mb(r, o), this.addYears = (r, o) => this.overrides?.addYears ? this.overrides.addYears(r, o) : Tb(r, o), this.differenceInCalendarDays = (r, o) => this.overrides?.differenceInCalendarDays ? this.overrides.differenceInCalendarDays(r, o) : Au(r, o), this.differenceInCalendarMonths = (r, o) => this.overrides?.differenceInCalendarMonths ? this.overrides.differenceInCalendarMonths(r, o) : Ab(r, o), this.eachMonthOfInterval = (r) => this.overrides?.eachMonthOfInterval ? this.overrides.eachMonthOfInterval(r) : Ib(r), this.eachYearOfInterval = (r) => {
      const o = this.overrides?.eachYearOfInterval ? this.overrides.eachYearOfInterval(r) : Ob(r), s = new Set(o.map((a) => this.getYear(a)));
      if (s.size === o.length)
        return o;
      const i = [];
      return s.forEach((a) => {
    ...
    }, this.endOfBroadcastWeek = (r) => this.overrides?.endOfBroadcastWeek ? this.overrides.endOfBroadcastWeek(r) : Yw(r, this), this.endOfISOWeek = (r) => this.overrides?.endOfISOWeek ? this.overrides.endOfISOWeek(r) : _b(r), this.endOfMonth = (r) => this.overrides?.endOfMonth ? this.overrides.endOfMonth(r) : Lb(r), this.endOfWeek = (r, o) => this.overrides?.endOfWeek ? this.overrides.endOfWeek(r, o) : Pu(r, this.options), this.endOfYear = (r) => this.overrides?.endOfYear ? this.overrides.endOfYear(r) : Pb(r), this.format = (r, o, s) => {
      const i = this.overrides?.format ? this.overrides.format(r, o, this.options) : Lw(r, o, this.options);
      return this.options.numerals && this.options.numerals !== "latn" ? this.replaceDigits(i) : i;
    }, this.getISOWeek = (r) => this.overrides?.getISOWeek ? this.overrides.getISOWeek(r) : Ou(r), this.getMonth = (r, o) => this.overrides?.getMonth ? this.overrides.getMonth(r, this.options) : Pw(r, this.options), this.getYear = (r, o) => this.overrides?.getYear ? this.overrides.getYear(r, this.options) : Ow(r, this.options), this.getWeek = (r, o) => this.overrides?.getWeek ? this.overrides.getWeek(r, this.options) : $u(r, this.options), this.isAfter = (r, o) => this.overrides?.isAfter ? this.overrides.isAfter(r, o) : _w(r, o), this.isBefore = (r, o) => this.overrides?.isBefore ? this.overrides.isBefore(r, o) : $w(r, o), this.isDate = (r) => this.overrides?.isDate ? this.overrides.isDate(r) : Lu(r), this.isSameDay = (r, o) => this.overrides?.isSameDay ? this.overrides.isSameDay(r, o) : Db(r, o), this.isSameMonth = (r, o) => this.overrides?.isSameMonth ? this.overrides.isSameMonth(r, o) : Hw(r, o), this.isSameYear = (r, o) => this.overrides?.isSameYear ? this.overrides.isSameYear(r, o) : Ww(r, o), this.max = (r) => this.overrides?.max ? this.overrides.max(r) : Sb(r), this.min = (r) => this.overrides?.min ? this.overrides.min(r) : Eb(r), this.setMonth = (r, o) => this.overrides?.setMonth ? this.overrides.setMonth(r, o) : zw(r, o), this.setYear = (r, o) => this.overrides?.setYear ? this.overrides.setYear(r, o) : Bw(r, o), this.startOfBroadcastWeek = (r, o) => this.overrides?.startOfBroadcastWeek ? this.overrides.startOfBroadcastWeek(r, this) : Wu(r, this), this.startOfDay = (r) => this.overrides?.startOfDay ? this.overrides.startOfDay(r) : Jn(r), this.startOfISOWeek = (r) => this.overrides?.startOfISOWeek ? this.overrides.startOfISOWeek(r) : Qn(r), this.startOfMonth = (r) => this.overrides?.startOfMonth ? this.overrides.startOfMonth(r) : Rb(r), this.startOfWeek = (r, o) => this.overrides?.startOfWeek ? this.overrides.startOfWeek(r, this.options) : xn(r, this.options), this.startOfYear = (r) => this.overrides?.startOfYear ? this.overrides.startOfYear(r) : Ru(r), this.options = { locale: Ea, ...t }, this.overrides = n;
  }
  /**
...
function ft(e, t, n = it) {
  ...
  return r.some((a) => {
    ...
    return Uu(a) ? s(e, a.after) > 0 : Yu(a) ? s(a.before, e) > 0 : typeof a == "function" ? a(e) : !1;
  });
}
...
const A0 = Gu, L0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  formatCaption: Ku,
  formatDay: T0,
  formatMonthCaption: M0,
  formatMonthDropdown: S0,
  formatWeekNumber: D0,
  formatWeekNumberHeader: N0,
  formatWeekdayName: E0,
  formatYearCaption: A0,
...
const G0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  labelGrid: Xu,
  labelGridcell: W0,
  labelMonthDropdown: z0,
  labelNav: B0,
  labelNext: F0,
  labelPrevious: U0,
  labelWeekNumber: j0,
  labelWeekNumberHeader: V0,
  labelWeekday: Y0,
  labelYearDropdown: K0
}, Symbol.toStringTag, { value: "Module" })), ir = (e) => e instanceof HTMLElement ? e : null, ls = (e) => [
  ...e.querySelectorAll("[data-animated-month]") ?? []
], q0 = (e) => ir(e.querySelector("[data-animated-month]")), us = (e) => ir(e.querySelector("[data-animated-caption]")), ds = (e) => ir(e.querySelector("[data-animated-weeks]")), X0 = (e) => ir(e.querySelector("[data-animated-nav]")), Z0 = (e) => ir(e.querySelector("[data-animated-weekdays]"));
function Q0(e, t, { classNames: n, months: r, focused: o, dateLib: s }) {
...
function nx(e, t, n, r) {
  const { addDays: o, endOfBroadcastWeek: s, endOfISOWeek: i, endOfMonth: a, endOfWeek: c, getISOWeek: l, getWeek: u, startOfBroadcastWeek: d, startOfISOWeek: f, startOfWeek: p } = r, g = e.reduce((h, y) => {
    ...
    const w = x.reduce((E, k) => {
      const N = n.ISOWeek ? l(k) : u(k), C = E.find((A) => A.weekNumber === N), D = new zu(k, y, r);
      return C ? C.days.push(D) : E.push(new Vw(N, [D])), E;
    }, []), M = new jw(y, w);
    return h.push(M), h;
  }, []);
...
function ix(e, t) {
  const [n, r] = rx(e, t), { startOfMonth: o, endOfMonth: s } = t, i = Ui(e, n, r, t), [a, c] = Ao(
    i,
  ...
  const l = tx(a, r, e, t), u = J0(l, e.endMonth ? s(e.endMonth) : void 0, e, t), d = nx(l, u, e, t), f = ax(d), p = ex(d), g = sx(a, n, e, t), h = ox(a, r, e, t), { disableNavigation: y, onMonthChange: b } = e, v = (M) => f.some((E) => E.days.some((k) => k.isEqualTo(M))), x = (M) => {
    if (y)
      return;
    let E = o(M);
...
function Zu(e, t, n, r, o, s, i, a = 0) {
  if (a > 365)
    return;
  const c = lx(e, t, n.date, r, o, s, i), l = !!(s.disabled && ft(c, s.disabled, i)), u = !!(s.hidden && ft(c, s.hidden, i)), d = c, f = new zu(c, d, i);
  return !l && !u ? f : Zu(e, t, f, r, o, s, i, a + 1);
}
function ux(e, t, n, r, o) {
  const { autoFocus: s } = e, [i, a] = U(), c = cx(t.days, n, r || (() => !1), i), [l, u] = U(s ? c : void 0);
  return {
    ...
    moveFocus: (h, y) => {
      if (!l)
        return;
      const b = Zu(h, y, l, t.navStart, t.navEnd, e, o);
...
function fx(e, t, n = 0, r = 0, o = !1, s = it) {
...
function px(e, t, n = it) {
  const r = Array.isArray(t) ? t : [t];
  if (r.filter((a) => typeof a != "function").some((a) => typeof a == "boolean" ? a : n.isDate(a) ? dt(e, a, !1, n) : Vu(a, n) ? a.some((c) => dt(e, c, !1, n)) : Da(a) ? a.from && a.to ? ji(e, { from: a.from, to: a.to }, n) : !1 : ju(a) ? mx(e, a.dayOfWeek, n) : Fu(a) ? n.isAfter(a.before, a.after) ? ji(e, {
    from: n.addDays(a.after, 1),
    to: n.addDays(a.before, -1)
  }, n) : ft(e.from, a, n) || ft(e.to, a, n) : Uu(a) || Yu(a) ? ft(e.from, a, n) || ft(e.to, a, n) : !1))
    return !0;
...
function hx(e, t) {
  ...
  return {
    selected: l,
    select: (f, p, g) => {
      const { min: h, max: y } = e, b = f ? fx(f, l, h, y, s, t) : void 0;
      return r && n && b?.from && b.to && px({ from: b.from, to: b.to }, n, t) && (b.from = f, b.to = void 0), i || c(b), i?.(b, f, p, g), b;
    },
...
function yx(e, t) {
  const n = gx(e, t), r = dx(e, t), o = hx(e, t);
  switch (e.mode) {
    case "single":
      return n;
    case "multiple":
...
function vx(e) {
  ...
  const { components: n, formatters: r, labels: o, dateLib: s, locale: i, classNames: a } = Nt(() => {
    ...
    t.labels,
    t.classNames
  ]), { captionLayout: c, mode: l, navLayout: u, numberOfMonths: d = 1, onDayBlur: f, onDayClick: p, onDayFocus: g, onDayKeyDown: h, onDayMouseEnter: y, onDayMouseLeave: b, onNextClick: v, onPrevClick: x, showWeekNumber: S, styles: w } = t, { formatCaption: M, formatDay: E, formatMonthDropdown: k, formatWeekNumber: N, formatWeekNumberHeader: C, formatWeekdayName: D, formatYearDropdown: A } = r, P = ix(t, s), { days: O, months: $, navStart: z, navEnd: V, previousMonth: R, nextMonth: L, goToMonth: H } = P, q = w0(O, t, z, V, s), { isSelected: F, select: Y, selected: G } = yx(t, s) ?? {}, { blur: W, focused: J, isFocusTarget: _, moveFocus: ee, setFocused: ne } = ux(t, P, q, F ?? (() => !1), s), { labelDayButton: de, labelGridcell: we, labelGrid: be, labelMonthDropdown: Oe, labelNav: wt, labelPrevious: Ot, labelNext: Nn, labelWeekday: An, labelWeekNumber: cr, labelWeekNumberHeader: lr, labelYearDropdown: ur } = o, dr = Nt(() => O0(s, t.ISOWeek), [s, t.ISOWeek]), Ln = l !== void 0 || p !== void 0, xt = B(() => {
    R && (H(R), x?.(R));
  }, [R, H, x]), Qt = B(() => {
    L && (H(L), v?.(L));
  }, [H, L, v]), fr = B((ce, fe) => (re) => {
  ...
  }), [a, t.className, t.style, w]), Ho = C0(t), gr = j(null);
  Q0(gr, !!t.animate, {
    classNames: a,
    months: $,
    focused: J,
          ...
          X.createElement(
            ...
            X.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: a[te.Weeks], style: w?.[te.Weeks] }, ce.weeks.map((re) => X.createElement(
              ...
              re.days.map((me) => {
                ...
                const Jt = P0(ue, w, t.modifiersStyles), Wo = x0(ue, a, t.modifiersClassNames), yr = !Ln && !ue.hidden ? we(Re, ue, s.options, s) : void 0;
                return (
  ...
  return /* @__PURE__ */ m(
    vx,
    {
      ...
      components: {
        ...
        Chevron: ({ className: l, orientation: u, ...d }) => u === "left" ? /* @__PURE__ */ m(uf, { className: ae("size-4", l), ...d }) : u === "right" ? /* @__PURE__ */ m(
          df,
          {
            className: ae("size-4", l),
            ...d
          }
        ) : /* @__PURE__ */ m(ff, { className: ae("size-4", l), ...d }),
        DayButton: wx,
...
let pn = null;
const Qu = /* @__PURE__ */ new Map(), xx = /* @__PURE__ */ new Map();
function Zr() {
  if (!pn) return;
  const e = pn;
  pn = null, setTimeout(() => {
...
function Tx({ node: e, updateAttributes: t, selected: n }) {
  const r = j(null), o = e.attrs.date || hn(), s = Ju(o), i = Aa(o), a = B(() => {
    if (!r.current) return "";
  ...
  return K(() => (Qu.set(o, (c) => {
    ...
    "span",
    {
      ...
      "data-date": o,
      children: [
        /* @__PURE__ */ m(xc, { size: 14, className: "date-icon" }),
...
const Ex = new Te("datePillPaste"), Dx = yo.create({
  name: "datePill",
  group: "inline",
  inline: !0,
  atom: !0,
  ...
  renderHTML({ node: e, HTMLAttributes: t }) {
    const n = e.attrs.date, r = Ju(n), o = Aa(n);
    return [
      "span",
      kn(this.options.HTMLAttributes, t, {
        "data-type": "date-pill",
...
function Nx({ node: e, selected: t, editor: n, getPos: r, deleteNode: o }) {
  ...
  return l ? /* @__PURE__ */ m(vn, { as: "span", className: "inline", children: /* @__PURE__ */ I(
    "span",
    {
      ...
      "data-tag": a,
      children: [
        /* @__PURE__ */ m(Xa, { size: 14, className: "tag-icon", strokeWidth: 2.5 }),
        /* @__PURE__ */ m(
          "input",
          {
            ref: i,
...
const Ax = new Te("tagPillPaste"), Lx = yo.create({
  name: "tagPill",
  group: "inline",
  inline: !0,
  atom: !0,
...
function $x(e, t) {
  const { alt: n, align: r, width: o } = _x(e), s = {
    left: "margin-right: auto;",
    center: "margin-left: auto; margin-right: auto;",
    right: "margin-left: auto;"
...
function Vi(e) {
  ...
  for (const s of r) {
    const i = s.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
    i ? o.push($x(i[1], i[2])) : o.push(`<p>${io(s.trim())}</p>`);
  }
  return o.join("");
}
function ed(e) {
        ...
        state: {
          ...
          apply(n, r, o, s) {
            return n.getMeta("collapsibleHeading") ? {
              ...
              docVersion: r.docVersion + 1
            } : n.docChanged ? (Fx(o.doc, s.doc, e, t.levels), Ux(o.doc, s.doc, t.levels) ? {
              collapsedHeadings: new Set(e.collapsedHeadings),
              decorations: Br(s.doc, e, t),
              docVersion: r.docVersion + 1
            } : {
...
}), jx = /\[([^\]]+)\]\(([^)]+)\)$/, Vx = /^(https?:\/\/|www\.)[^\s]+$/i, Kx = Ue.create({
...
}), Gx = ["info", "note", "prompt", "resources", "todo"], qx = Ue.create({
          ...
          handleKeyDown(t, n) {
            ...
            for (const u of Gx)
              if (l === `\`\`\`${u}`) {
                ...
                if (p && g) {
                  const h = g.create(), y = p.create({ type: u }, Dc.from(h));
                  d.insert(f, y);
...
}), Fr = new Te("searchHighlight"), Xx = Ue.create({
...
function fk(e, t, n) {
  let r = !1;
  return e.nodesBetween(t, n, (o) => nd.has(o.type.name) ? (r = !0, !1) : !0), r;
}
function mk(e, t, n) {
  const r = [];
  let o = t, s = n;
  ...
  addKeyboardShortcuts() {
    return {
      ...
      "Mod-a": ({ editor: e }) => {
        ...
        if (t.expansionDepth > 0 && o === t.lastExpandedFrom && s === t.lastExpandedTo || (t.expansionDepth = 0), r instanceof Of || o === 0 && s === n.content.size)
          return !0;
        const a = mk(n, o, s);
        let c = null;
        for (const l of a)
  ...
  addCommands() {
    return {
      ...
      selectAllOccurrences: (e) => ({ editor: t, tr: n, dispatch: r }) => {
        ...
        if (!o) return !1;
        const c = Xi(t.state.doc, o, s, i, a);
...
}), kk = new Te("linkBoundary"), Ck = Ue.create({
  name: "linkBoundary",
  addProseMirrorPlugins() {
    return [
      new Me({
...
}), Mk = new Te("smartCopyPaste"), od = /* @__PURE__ */ new Set(["codeBlock", "callout"]);
function Zi(e) {
  const { state: t } = e, { selection: n } = t, { $from: r, $to: o } = n;
  for (let s = r.depth; s > 0; s--) {
    const i = r.node(s);
    if (!od.has(i.type.name)) continue;
...
`);
              ...
              const p = f.map((h) => h === "" ? u.create() : u.create(null, l.text(h))), g = Dc.from(p);
              return new jo(g, 0, 0);
            } else {
...
function Pk({
  ...
  return Nt(() => {
    ...
    ), s.codeBlocks || g.push(ym), s.callouts || g.push(hb, qx), a && !s.collapsibleHeadings && !d && g.push(
      Yx.configure({
        levels: o
      })
    ), s.images || g.push(
    ...
    "div",
    {
      ...
      children: [
        ...
        e === "saving" && /* @__PURE__ */ I(ve, { children: [
          /* @__PURE__ */ m(kc, { className: "w-3.5 h-3.5 text-cyan-500 animate-spin" }),
...
`);
  ...
  if (!n || n.length === 0) {
    for (let c = 0; c < s.length; c++) {
      ...
      let f = i;
      for (const p of d)
        p.start > f && (o += jt(e.substring(f, p.start))), o += `<span class="${tc(p.type)}">${jt(p.content)}</span>`, f = p.end;
...
`), i = u + 1;
  ...
  for (let c = 0; c < s.length; c++) {
    ...
    let f = i;
    for (const p of d)
      p.start > f && (o += ms(e, f, p.start, null, a)), o += ms(e, p.start, p.end, tc(p.type), a), f = p.end;
  ...
  K(() => {
    ...
    const C = (D) => {
      ...
      if (l.current = D, c.current.push({ time: D, duration: A }), c.current.length > 120 && (c.current = c.current.slice(-120)), A > 16.67 && d.current++, E++, D - k >= 1e3) {
        N = E, E = 0, k = D;
        const P = c.current.slice(-60), O = P.length > 0 ? P.reduce((F, Y) => F + Y.duration, 0) / P.length : 0, $ = P.length > 0 ? Math.max(...P.map((F) => F.duration)) : 0, z = performance.memory, V = z ? z.usedJSHeapSize / (1024 * 1024) : 0, R = z ? z.jsHeapSizeLimit / (1024 * 1024) : 0, L = document.querySelectorAll("*").length, H = nc - f.current, q = _s - p.current;
        f.current = nc, p.current = _s, a({
          fps: N,
  ...
  return /* @__PURE__ */ I("div", { className: "perf-profiler-overlay", children: [
    /* @__PURE__ */ I("div", { className: "perf-profiler-header", children: [
      ...
      /* @__PURE__ */ I("div", { className: "perf-profiler-actions", children: [
        /* @__PURE__ */ m("button", { onClick: x, title: o ? "Expand" : "Minimize", children: o ? /* @__PURE__ */ m(Cc, { size: 12 }) : /* @__PURE__ */ m(Mc, { size: 12 }) }),
        ...
        t && /* @__PURE__ */ I("div", { className: "w-full max-w-xs", children: [
          /* @__PURE__ */ I(
            "button",
            {
              ...
              children: [
                n ? /* @__PURE__ */ m(Lt, { className: "w-3 h-3" }) : /* @__PURE__ */ m(wc, { className: "w-3 h-3" }),
                "Error details"
              ]
            }
          ),
...
), ps = () => /* @__PURE__ */ m("div", { className: "w-px h-5 bg-border mx-0.5 flex-shrink-0" }), rc = [
...
], uC = vt(function({ editor: t, isH1: n, isH2: r, isH3: o, isH4: s, isH5: i, executeCommand: a }) {
  const [c, l] = U(!1), u = j(null), d = n ? "h1" : r ? "h2" : o ? "h3" : s ? "h4" : i ? "h5" : "paragraph", f = rc.find((g) => g.value === d)?.shortLabel || "P";
  K(() => {
    if (!c) return;
    const g = (h) => {
...
}), dC = vt(function({ onCopy: t, iconSize: n }) {
...
}), fC = vt(function({ editor: t, className: n = "", suppressWhenLinkPopoverOpen: r = !1, aiEnabled: o = !1, onAISparklesClick: s, onCopySelectionAsMarkdown: i }) {
  const a = j(null), c = dc({
    editor: t,
    selector: ({ editor: C }) => ({
...
const gC = [
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ m(vc, { size: 16, className: "text-amber-400" }),
  ...
  {
    title: "Date",
    icon: /* @__PURE__ */ m(xc, { size: 16, className: "text-cyan-400" }),
        ...
        `,
          children: [
            /* @__PURE__ */ m("div", { className: "px-2 py-1.5", children: /* @__PURE__ */ I("div", { className: "flex items-center gap-2 bg-secondary/50 rounded-md px-2.5 py-1.5 border border-border/50", children: [
              /* @__PURE__ */ m(Tc, { size: 14, className: "text-muted-foreground shrink-0" }),
              /* @__PURE__ */ m(
                "input",
                {
                  ref: u,
          ...
          children: [
            /* @__PURE__ */ I("div", { className: "flex items-center justify-between px-3 py-2 border-b border-border bg-secondary/30", children: [
              /* @__PURE__ */ I("div", { className: "flex items-center gap-2 text-xs text-muted-foreground", children: [
                h && /* @__PURE__ */ m(kc, { size: 12, className: "animate-spin" }),
...
function OC(e) {
  const [t, n] = Yd(PC, { status: "idle" }), r = j(null), o = B(async (a, c, l, u, d) => {
    if (e) {
      n({
...
const id = "paragon-editor-toc-width", _C = 280, cd = 200, ld = 500, $n = 30, ac = 5;
function ic() {
  try {
    const e = localStorage.getItem(id);
    if (e) {
      const t = parseInt(e, 10);
      if (!isNaN(t) && t >= cd && t <= ld)
        return t;
    }
  } catch {
  }
...
function $C(e) {
  try {
    localStorage.setItem(id, String(e));
  } catch {
  }
}
function HC(e, t, n) {
...
const $s = vt(function({
  ...
  }, []), p = t.length * $n, g = Math.max(0, Math.floor(c / $n) - ac), h = Math.min(
    t.length,
    Math.ceil((c + u) / $n) + ac
  ), y = Nt(() => {
    const b = [];
  ...
  K(() => {
    const _ = (ne) => {
      if (!O.current) return;
      const de = f === "right" ? $.current - ne.clientX : ne.clientX - $.current, we = Math.min(ld, Math.max(cd, z.current + de));
      D(we);
    }, ee = () => {
      O.current && (O.current = !1, document.body.style.cursor = "", document.body.style.userSelect = "", D((ne) => ($C(ne), ne)));
    };
  ...
  const [ue] = U(() => FC()), [Jt, Wo] = U(C), [yr, _t] = U(""), kt = j(C), vr = j(""), Rn = j(null), [fd, La] = U(0), br = !!(fe && fe.length > 0 && re), { state: Ye, executeAction: wr, abort: md, reset: Ct } = OC(re), [pd, zo] = U(null), [hd, gd] = U({ selectionTop: 0, selectionBottom: 0, selectionCenterX: 0 }), yd = j(re);
  yd.current = re;
  const Ia = j(me);
  Ia.current = me;
  const [vd, bd] = U([]), [wd, xd] = U(0), kd = B((se, Se) => {
    bd(se), xd(Se);
  ...
  const Ba = 2e3, [Bo, Cd] = U(() => In === "lightweight" ? !0 : In === "full" ? !1 : t && typeof t == "string" ? Math.ceil(t.length / 80) > Ba : !1), Md = j(0), Fa = j(Bo);
  Fa.current = Bo;
  const [Fo, xr] = U(null), Td = Pk({
    placeholder: i,
    isMobile: ue,
    maxImageSize: x,
    headingLevels: we,
    ...
    isLightweightRef: Fa
  }), [Sd, Cr] = U(!1), [Ed, Dd] = U(!1), Nd = Y !== void 0 ? Y : Ed, $t = B((se) => {
    Dd(se), G?.(se);
  }, [G]), [Ad, Mr] = U(0), [Ld, Id] = U(""), Ht = jv(oe, {
    storageKey: h,
    debounceMs: y,
    enabled: g,
    onSave: (se) => {
...
` + Se).run(), Ct();
    ...
    if (Ge) return;
    const $e = oe.state.doc.slice(se, Se), Mt = zf.fromSchema(oe.schema), Wt = document.createElement("div"), en = Mt.serializeFragment($e.content);
    Wt.appendChild(en);
...
`);
  ...
  if (!oe)
    return /* @__PURE__ */ m(cC, { className: l, theme: f });
  const ja = /* @__PURE__ */ m(
    Wv,
    {
      editor: oe,
  ...
  return /* @__PURE__ */ I("div", { className: `markdown-editor-container ${p === "neutral" ? "color-theme-neutral" : ""} ${l}`, "data-theme": f, children: [
    ...
    u && /* @__PURE__ */ I("div", { className: "flex items-center bg-card/50 editor-toolbar-wrapper", children: [
      W ? W(oe, ja) : ja,
      N && /* @__PURE__ */ m(lC, { editorMode: Jt, onModeSwitch: Uo })
    ] }),
    !ue && /* @__PURE__ */ m(
      zv,
      {
    ...
    /* @__PURE__ */ I("div", { className: `editor-main-area ${Oe ? "editor-with-toc" : ""}`, children: [
      ...
      /* @__PURE__ */ I(
        iC,
        {
          ...
          onError: ce,
          children: [
            /* @__PURE__ */ m("div", { className: "editor-content-wrapper", ref: Rn, style: Wd, children: Jt === "wysiwyg" ? /* @__PURE__ */ I(ve, { children: [
              /* @__PURE__ */ m(Bd, { editor: oe, className: "editor-content" }),
              /* @__PURE__ */ m(
                IC,
                {
                  editor: oe,
            ...
            /* @__PURE__ */ m(RC, { scrollContainerRef: Rn })
          ]
        }
      ),
      Oe && xt === "right" && /* @__PURE__ */ m(
        lc,
        {
          editor: oe,
          visible: wt,
    ...
    /* @__PURE__ */ m(aC, { visible: Ro, onClose: Po, editor: oe })
  ] });
}), B1 = yo.create({
  name: "callout",
  addOptions() {
...
function U1({
  ...
  return /* @__PURE__ */ m(dd.Provider, { value: a, children: e });
}
function Y1() {
  const e = mc(dd);
  if (!e)
...
function j1({ node: e, updateAttributes: t }) {
      ...
      /* @__PURE__ */ I("div", { className: "code-block-language-wrapper", children: [
        /* @__PURE__ */ m(
          "select",
          {
            ...
            className: "code-block-language-select",
            children: uc.map(({ value: i, label: a }) => /* @__PURE__ */ m("option", { value: i, children: a }, i))
          }
        ),
        /* @__PURE__ */ m(Lt, { size: 12, className: "code-block-language-chevron" })
      ] }),
...
export {
  ...
  j1 as CodeBlockComponent,
  Yx as CollapsibleHeading,
  mb as CollapsibleList,
  Dx as DatePill,
  U1 as EditorThemeProvider,
  Wv as EditorToolbar,
  zv as FindReplace,
  ...
  ab as MixedBulletList,
  ub as MixedListItem,
  ib as MixedOrderedList,
  lb as MixedTaskItem,
  cb as MixedTaskList,
  rC as RecoveryBanner,
  gb as ResizableImage,
  Xx as SearchHighlight,
  Uv as SelectAllActionBar,
  xk as SelectAllOccurrences,
  xC as SlashCommands,
  Jx as TabIndent,
  lc as TableOfContents,
  Lx as TagPill,
  Rx as WikiLinkSafe,
  VC as applyTheme,
