...
import { useEditorState as dl, NodeViewWrapper as er, ReactNodeViewRenderer as ml, useEditor as zd, EditorContent as Ud, NodeViewContent as Yd } from "@tiptap/react";
import * as T from "react";
import X, { useState as j, useRef as Y, useEffect as q, useLayoutEffect as fr, memo as wt, useCallback as F, useImperativeHandle as jd, createContext as fl, useContext as hl, useMemo as St, Component as Vd, useReducer as Kd, lazy as Gd, forwardRef as qd, Suspense as Fi } from "react";
import Xd from "@tiptap/extension-code-block-lowlight";
import { createLowlight as Zd } from "lowlight";
import { Image as $s, X as pt, Link2 as Hs, Type as hr, Undo as Qd, Redo as Jd, Bold as Ws, Italic as Fs, Underline as zs, Strikethrough as Us, Code as pl, Highlighter as gl, Link as Ys, ChevronDown as Jn, List as js, ListOrdered as Vs, CheckSquare as Ks, Quote as Gs, Code2 as bl, IndentIncrease as em, IndentDecrease as tm, Table as ps, Minus as vl, Info as gs, BookOpen as wl, PenLine as nm, Library as om, ListTodo as yl, Columns as zi, Trash2 as un, Rows as Ui, ToggleLeft as Yi, ArrowUpDown as rm, Sparkles as pr, Copy as wn, Search as sm, ChevronUp as im, MousePointerClick as am, CaseSensitive as lm, WholeWord as cm, Regex as um, Replace as bs, ReplaceAll as dm, Plus as qs, ChevronLeftIcon as mm, ChevronRightIcon as fm, ChevronDownIcon as hm, Calendar as Nl, Hash as ji, Cloud as pm, Loader2 as kl, Check as yn, CloudOff as gm, AlertCircle as bm, RotateCcw as Xs, Activity as vm, Maximize2 as xl, Minimize2 as Cl, AlertTriangle as wm, ChevronRight as ym, CheckCircle2 as Nm, Eye as km, FileText as Zs, FileCode as xm, ExternalLink as Cm, Pencil as Em, Unlink as Tm, Heading1 as Sm, Heading2 as Mm, Heading3 as Dm, Heading4 as Am, Heading5 as Pm, StickyNote as Lm, MessageSquareText as Im, ImagePlus as Rm, MessageSquare as El, RefreshCw as Om, SpellCheck as _m, PanelRightClose as Bm, PanelRightOpen as $m } from "lucide-react";
import { jsx as z, Fragment as Hm, jsxs as Wm } from "react/jsx-runtime";
import * as Tl from "react-dom";
import Fm, { createPortal as zm } from "react-dom";
import { TextSelection as Ve, Plugin as Me, PluginKey as De, NodeSelection as Um, AllSelection as Ym } from "@tiptap/pm/state";
import { Fragment as Sl, Slice as Yr, DOMSerializer as jm } from "@tiptap/pm/model";
import Vm from "@tiptap/starter-kit";
import Km from "@tiptap/extension-placeholder";
import Gm from "@tiptap/extension-text-align";
import qm from "@tiptap/extension-highlight";
import Xm from "@tiptap/extension-link";
import { Table as Zm } from "@tiptap/extension-table";
import Qm from "@tiptap/extension-table-row";
import Jm from "@tiptap/extension-table-cell";
import ef from "@tiptap/extension-table-header";
import { Extension as Oe, Node as gr, mergeAttributes as Nn, InputRule as Re, Mark as Ml } from "@tiptap/core";
import { DecorationSet as je, Decoration as Ze } from "@tiptap/pm/view";
import tf from "@tiptap/extension-bullet-list";
import nf from "@tiptap/extension-ordered-list";
import of from "@tiptap/extension-list-item";
import rf from "@tiptap/extension-task-list";
import sf from "@tiptap/extension-task-item";
import { findWrapping as Vi, canJoin as af } from "@tiptap/pm/transform";
import lf from "@tiptap/extension-underline";
import cf from "@tiptap/extension-subscript";
import uf from "@tiptap/extension-superscript";
import df from "@tiptap/extension-typography";
import mf from "@tiptap/extension-image";
import { createRoot as ff } from "react-dom/client";
import { liftListItem as Ki, sinkListItem as Gi } from "@tiptap/pm/schema-list";
import { undo as hf, redo as pf } from "@tiptap/pm/history";
import gf from "@tiptap/extension-horizontal-rule";
import bf from "@tiptap/extension-code";
import vf from "@tiptap/extension-bold";
import wf from "@tiptap/extension-italic";
import yf from "@tiptap/extension-strike";
const We = Zd(), Dl = {
...
async function Nf() {
  if (!qi)
    return Ln || (Ln = (async () => {
      try {
        const e = Object.entries(Dl), t = await Promise.all(
          e.map(async ([n, o]) => {
            const r = await o();
            return [n, r.default];
          })
        ...
        for (const [n, o] of Object.entries(Al))
          if (!We.registered(n)) {
...
async function Xi(e) {
  ...
  if (Dl[e] || Al[e])
    return await Nf(), We.registered(e);
  const t = Pl[e];
  if (!t) return !1;
...
], kf = ["M20 6 9 17l-5-5"], xf = ["m6 9 6 6 6-6"];
function Cf() {
...
class Ef {
  constructor(t, n, o) {
    ...
    this.dom = document.createElement("div"), this.dom.className = "code-block-wrapper", this.dom.setAttribute("data-node-view-wrapper", "");
    const s = document.createElement("div");
    s.className = "code-block-controls", s.contentEditable = "false";
  ...
  update(t) {
    ...
    return this.node = t, n !== o && (this.labelEl.textContent = this.formatLanguageLabel(o), this.selectEl.value = o, o === "plaintext" ? this.setLanguageReady(!0) : We.registered(o) ? this.setLanguageReady(!0) : this.isVisible && (this.setLanguageReady(!1), Xi(o).then((r) => {
...
const Tf = Xd.configure({
  ...
  addNodeView() {
    return ({ node: e, view: t, getPos: n }) => new Ef(e, t, n);
  },
  addKeyboardShortcuts() {
    return {
      ...this.parent?.() ?? {},
      "Mod-Alt-c": () => Qs(this.editor)
    };
  },
...
function Ll({ isOpen: e, onClose: t, onInsert: n, position: o }) {
...
}, Mf = T[" useInsertionEffect ".trim().toString()] || Dt;
function Js({
  prop: e,
  defaultProp: t,
  onChange: n = () => {
...
// @__NO_SIDE_EFFECTS__
function jn(e) {
  const t = /* @__PURE__ */ Lf(e), n = T.forwardRef((o, r) => {
...
var Pf = /* @__PURE__ */ jn("Slot");
// @__NO_SIDE_EFFECTS__
function Lf(e) {
  const t = T.forwardRef((n, o) => {
    const { children: r, ...s } = n;
    if (T.isValidElement(r)) {
      const a = _f(r), i = Of(s, r.props);
...
// @__NO_SIDE_EFFECTS__
function If(e) {
  const t = ({ children: n }) => /* @__PURE__ */ z(Hm, { children: n });
  return t.displayName = `${e}.Slottable`, t.__radixId = Il, t;
}
function Rf(e) {
  return T.isValidElement(e) && typeof e.type == "function" && "__radixId" in e.type && e.type.__radixId === Il;
}
function Of(e, t) {
  const n = { ...t };
  for (const o in t) {
...
var $f = T.createContext(void 0);
function _l(e) {
  const t = T.useContext($f);
  return e || t || "ltr";
}
function gt(e) {
  const t = T.useRef(e);
...
var Wf = "DismissableLayer", vs = "dismissableLayer.update", Ff = "dismissableLayer.pointerDownOutside", zf = "dismissableLayer.focusOutside", ea, Bl = T.createContext({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: i,
      ...l
    } = e, c = T.useContext(Bl), [u, d] = T.useState(null), f = u?.ownerDocument ?? globalThis?.document, [, h] = T.useState({}), g = Le(t, (S) => d(S)), p = Array.from(c.layers), [b] = [...c.layersWithOutsidePointerEventsDisabled].slice(-1), v = p.indexOf(b), w = u ? p.indexOf(u) : -1, N = c.layersWithOutsidePointerEventsDisabled.size > 0, E = w >= v, y = jf((S) => {
...
ei.displayName = Wf;
var Uf = "DismissableLayerBranch", Yf = T.forwardRef((e, t) => {
...
Yf.displayName = Uf;
function jf(e, t = globalThis?.document) {
...
function Vf(e, t = globalThis?.document) {
  ...
  return T.useEffect(() => {
    const r = (s) => {
      s.target && !o.current && $l(zf, n, { originalEvent: s }, {
        discrete: !1
      });
    };
...
function $l(e, t, n, { discrete: o }) {
  const r = n.originalEvent.target, s = new CustomEvent(e, { bubbles: !1, cancelable: !0, detail: n });
  t && r.addEventListener(e, t, { once: !0 }), o ? Rl(r, s) : r.dispatchEvent(s);
}
var jr = 0;
function Kf() {
  T.useEffect(() => {
...
var Vr = "focusScope.autoFocusOnMount", Kr = "focusScope.autoFocusOnUnmount", oa = { bubbles: !1, cancelable: !0 }, Gf = "FocusScope", Hl = T.forwardRef((e, t) => {
  const {
    loop: n = !1,
    trapped: o = !1,
    onMountAutoFocus: r,
  ...
  T.useEffect(() => {
    ...
    if (i) {
      ...
      if (!i.contains(p)) {
        ...
        i.addEventListener(Vr, c), i.dispatchEvent(v), v.defaultPrevented || (qf(eh(Wl(i)), { select: !0 }), document.activeElement === p && Tt(i));
      }
      return () => {
  ...
  const g = T.useCallback(
    (p) => {
      ...
      if (b && v) {
        const w = p.currentTarget, [N, E] = Xf(w);
...
function Xf(e) {
  const t = Wl(e), n = ra(t, e), o = ra(t.reverse(), e);
  return [n, o];
}
function Wl(e) {
...
const oh = ["top", "right", "bottom", "left"], At = Math.min, He = Math.max, nr = Math.round, Io = Math.floor, rt = (e) => ({
  x: e,
  y: e
}), rh = {
  left: "right",
...
const ih = /* @__PURE__ */ new Set(["top", "bottom"]);
function nt(e) {
  return ih.has(vt(e)) ? "y" : "x";
}
function oi(e) {
  return ti(nt(e));
}
...
const aa = ["left", "right"], la = ["right", "left"], ch = ["top", "bottom"], uh = ["bottom", "top"];
function dh(e, t, n) {
  switch (e) {
    case "top":
    case "bottom":
...
function ca(e, t, n) {
  ...
  const s = nt(t), a = oi(t), i = ni(a), l = vt(t), c = s === "y", u = o.x + o.width / 2 - r.width / 2, d = o.y + o.height / 2 - r.height / 2, f = o[i] / 2 - r[i] / 2;
  let h;
  switch (l) {
    case "top":
      h = {
...
async function Vn(e, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: h = 0
  } = bt(t, e), g = Fl(h), b = i[f ? d === "floating" ? "reference" : "floating" : d], v = rr(await s.getClippingRect({
...
const ph = (e) => ({
  ...
  async fn(t) {
    ...
    const d = Fl(u), f = {
      x: n,
      y: o
    }, h = oi(r), g = ni(h), p = await a.getDimensions(c), b = h === "y", v = b ? "top" : "left", w = b ? "bottom" : "right", N = b ? "clientHeight" : "clientWidth", E = s.reference[g] + s.reference[h] - f[h] - s.floating[g], y = f[h] - s.reference[h], C = await (a.getOffsetParent == null ? void 0 : a.getOffsetParent(c));
    let S = C ? C[N] : 0;
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const v = vt(r), w = nt(i), N = vt(i) === i, E = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), y = f || (N || !p ? [or(i)] : lh(i)), C = g !== "none";
      !f && C && y.push(...mh(i, p, g, E));
...
async function vh(e, t) {
  const {
    ...
    platform: o,
    elements: r
  } = e, s = await (o.isRTL == null ? void 0 : o.isRTL(r.floating)), a = vt(n), i = xn(n), l = nt(n) === "y", c = zl.has(a) ? -1 : 1, u = s && l ? -1 : 1, d = bt(t, e);
  let {
    mainAxis: f,
    crossAxis: h,
    alignmentAxis: g
...
const wh = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: n,
        y: o
      }, u = await Vn(t, l), d = nt(vt(r)), f = ti(d);
      let h = c[f], g = c[d];
      if (s) {
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      if (c) {
        var v, w;
        const N = f === "y" ? "width" : "height", E = zl.has(vt(r)), y = s.reference[d] - s.floating[N] + (E && ((v = a.offset) == null ? void 0 : v[d]) || 0) + (E ? 0 : b.crossAxis), C = s.reference[d] + s.reference[N] + (E ? 0 : ((w = a.offset) == null ? void 0 : w[d]) || 0) - (E ? b.crossAxis : 0);
        g < y ? g = y : g > C && (g = C);
      }
      return {
        [f]: h,
...
function Ul(e) {
  return vr() ? e instanceof Node || e instanceof Fe(e).Node : !1;
}
function Qe(e) {
  return vr() ? e instanceof Element || e instanceof Fe(e).Element : !1;
}
function st(e) {
  return vr() ? e instanceof HTMLElement || e instanceof Fe(e).HTMLElement : !1;
}
function ma(e) {
  return !vr() || typeof ShadowRoot > "u" ? !1 : e instanceof ShadowRoot || e instanceof Fe(e).ShadowRoot;
}
...
function eo(e) {
  ...
  return /auto|scroll|overlay|hidden|clip/.test(t + o + n) && !xh.has(r);
}
...
const Sh = ["transform", "translate", "scale", "rotate", "perspective"], Mh = ["transform", "translate", "scale", "rotate", "perspective", "filter"], Dh = ["paint", "layout", "strict", "content"];
function ri(e) {
  const t = si(), n = Qe(e) ? Je(e) : e;
  return Sh.some((o) => n[o] ? n[o] !== "none" : !1) || (n.containerType ? n.containerType !== "normal" : !1) || !t && (n.backdropFilter ? n.backdropFilter !== "none" : !1) || !t && (n.filter ? n.filter !== "none" : !1) || Mh.some((o) => (n.willChange || "").includes(o)) || Dh.some((o) => (n.contain || "").includes(o));
}
function Ah(e) {
  let t = Pt(e);
  for (; st(t) && !gn(t); ) {
...
function Yl(e) {
  const t = Pt(e);
  return gn(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : st(t) && eo(t) ? t : Yl(t);
}
function Kn(e, t, n) {
  var o;
  t === void 0 && (t = []), n === void 0 && (n = !0);
  const r = Yl(e), s = r === ((o = e.ownerDocument) == null ? void 0 : o.body), a = Fe(r);
  if (s) {
    const i = Ns(a);
...
const Lh = /* @__PURE__ */ rt(0);
function Vl(e) {
  const t = Fe(e);
  return !si() || !t.visualViewport ? Lh : {
...
function jt(e, t, n, o) {
  ...
  const r = e.getBoundingClientRect(), s = ii(e);
  let a = rt(1);
  t && (o ? Qe(o) && (a = dn(o)) : a = dn(e));
  const i = Ih(s, n, o) ? Vl(s) : rt(0);
...
function Rh(e) {
  ...
  const s = r === "fixed", a = it(o), i = t ? wr(t.floating) : !1;
  if (o === a || i && s)
    return n;
  let l = {
    scrollLeft: 0,
...
const $h = /* @__PURE__ */ new Set(["absolute", "fixed"]);
function Hh(e, t) {
...
function Gl(e, t) {
  const n = Pt(e);
  return n === t || !Qe(n) || gn(n) ? !1 : Je(n).position === "fixed" || Gl(n, t);
}
function Wh(e, t) {
  const n = t.get(e);
  if (n)
  ...
  for (; Qe(a) && !gn(a); ) {
    const i = Je(a), l = ri(a);
    !l && i.position === "fixed" && (r = null), (s ? !l && !r : !l && i.position === "static" && !!r && $h.has(r.position) || eo(a) && !l && Gl(e, a)) ? o = o.filter((u) => u !== a) : r = i, a = Pt(a);
  }
  return t.set(e, o), o;
}
function Fh(e) {
  ...
  const a = [...n === "clippingAncestors" ? wr(t) ? [] : Wh(t, this._c) : [].concat(n), o], i = a[0], l = a.reduce((c, u) => {
    const d = ha(t, u, r);
...
function Uh(e, t, n) {
  ...
  s && !o && r && c();
  const u = r && !o && !s ? Kl(r, i) : rt(0), d = a.left + i.scrollLeft - l.x - u.x, f = a.top + i.scrollTop - l.y - u.y;
  return {
    x: d,
    y: f,
    width: a.width,
...
function ql(e, t) {
  ...
  for (; o && Eh(o) && Gr(o); )
    o = pa(o, t);
  return o && gn(o) && Gr(o) && !ri(o) ? n : o || Ah(e) || n;
}
const Yh = async function(e) {
  const t = this.getOffsetParent || ql, n = this.getDimensions, o = await n(e.floating);
  return {
...
function Kh(e, t) {
  ...
  function a(i, l) {
    ...
    function y(C) {
      ...
      S === 1 && !Xl(c, e.getBoundingClientRect()) && a(), E = !1;
    }
    try {
...
function Gh(e, t, n, o) {
  ...
  const {
    ...
    animationFrame: l = !1
  } = o, c = ii(e), u = r || s ? [...c ? Kn(c) : [], ...Kn(t)] : [];
  u.forEach((v) => {
    r && v.addEventListener("scroll", n, {
      passive: !0
    }), s && v.addEventListener("resize", n);
  });
  const d = c && i ? Kh(c, n) : null;
  let f = -1, h = null;
  ...
  function b() {
    const v = jt(e);
    p && !Xl(p, v) && n(), p = v, g = requestAnimationFrame(b);
  }
  return n(), () => {
    var v;
    u.forEach((w) => {
...
const qh = wh, Xh = yh, Zh = gh, Qh = kh, Jh = bh, ga = ph, ep = Nh, tp = (e, t, n) => {
...
var np = typeof document < "u", op = function() {
}, qo = np ? fr : op;
function sr(e, t) {
  if (e === t)
    return !0;
...
function rp(e) {
  ...
  const [g, p] = T.useState(null), [b, v] = T.useState(null), w = T.useCallback((L) => {
    ...
    M.current && (L.platform = M.current), tp(C.current, S.current, L).then((P) => {
      const B = {
        ...P,
      ...
      R.current && !sr(k.current, B) && (k.current = B, Tl.flushSync(() => {
        d(B);
      }));
    });
  }, [f, t, n, M, A]);
  ...
  const _ = T.useMemo(() => ({
    ...
    if (!H.floating)
      return L;
    const P = ba(H.floating, u.x), B = ba(H.floating, u.y);
    return i ? {
      ...L,
...
var fp = "Arrow", Ql = T.forwardRef((e, t) => {
...
var ai = "Popper", [Jl, kr] = kn(ai), [gp, ec] = Jl(ai), tc = (e) => {
  const { __scopePopper: t, children: n } = e, [o, r] = T.useState(null);
  return /* @__PURE__ */ z(gp, { scope: t, anchor: o, onAnchorChange: r, children: n });
};
tc.displayName = ai;
var nc = "PopperAnchor", oc = T.forwardRef(
  (e, t) => {
    const { __scopePopper: n, virtualRef: o, ...r } = e, s = ec(nc, n), a = T.useRef(null), i = Le(t, a), l = T.useRef(null);
    return T.useEffect(() => {
      const c = l.current;
...
oc.displayName = nc;
var li = "PopperContent", [bp, vp] = Jl(li), rc = T.forwardRef(
  (e, t) => {
    const {
      __scopePopper: n,
      side: o = "bottom",
      ...
      onPlaced: g,
      ...p
    } = e, b = ec(li, n), [v, w] = T.useState(null), N = Le(t, (O) => w(O)), [E, y] = T.useState(null), C = pp(E), S = C?.width ?? 0, k = C?.height ?? 0, D = o + (s !== "center" ? "-" + s : ""), x = typeof u == "number" ? u : { top: 0, right: 0, bottom: 0, left: 0, ...u }, M = Array.isArray(c) ? c : [c], A = M.length > 0, I = {
      padding: x,
      boundary: M.filter(yp),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: A
    }, { refs: R, floatingStyles: _, placement: H, isPositioned: V, middlewareData: L } = rp({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: D,
      whileElementsMounted: (...O) => Gh(...O, {
      ...
      middleware: [
        ip({ mainAxis: r + k, alignmentAxis: a }),
        l && ap({
          mainAxis: !0,
          crossAxis: !1,
        ...
        E && mp({ element: E, padding: i }),
        Np({ arrowWidth: S, arrowHeight: k }),
        f && dp({ strategy: "referenceHidden", ...I })
      ]
    }), [P, B] = ac(H), G = gt(g);
    Dt(() => {
      V && G?.();
...
rc.displayName = li;
var sc = "PopperArrow", wp = {
  top: "bottom",
  right: "left",
  bottom: "top",
  left: "right"
}, ic = T.forwardRef(function(t, n) {
  const { __scopePopper: o, ...r } = t, s = vp(sc, o), a = wp[s.placedSide];
  return (
...
var Np = (e) => ({
  ...
  options: e,
  fn(t) {
    const { placement: n, rects: o, middlewareData: r } = t, a = r.arrow?.centerOffset !== 0, i = a ? 0 : e.arrowWidth, l = a ? 0 : e.arrowHeight, [c, u] = ac(n), d = { start: "0%", center: "50%", end: "100%" }[u], f = (r.arrow?.x ?? 0) + i / 2, h = (r.arrow?.y ?? 0) + l / 2;
    let g = "", p = "";
...
var lc = tc, cc = oc, uc = rc, dc = ic, kp = "Portal", ci = T.forwardRef((e, t) => {
  const { container: n, ...o } = e, [r, s] = T.useState(!1);
  Dt(() => s(!0), []);
  const a = n || r && globalThis?.document?.body;
  return a ? Fm.createPortal(/* @__PURE__ */ z(Ae.div, { ...o, ref: t }), a) : null;
});
ci.displayName = kp;
function xp(e, t) {
...
var Vt = (e) => {
  const { present: t, children: n } = e, o = Cp(t), r = typeof n == "function" ? n({ present: o.isPresent }) : T.Children.only(n), s = Le(o.ref, Ep(r));
  return typeof n == "function" || o.isPresent ? T.cloneElement(r, { ref: s }) : null;
};
Vt.displayName = "Presence";
function Cp(e) {
  const [t, n] = T.useState(), o = T.useRef(null), r = T.useRef(e), s = T.useRef("none"), a = e ? "mounted" : "unmounted", [i, l] = xp(a, {
    mounted: {
      UNMOUNT: "unmounted",
...
var Xr = "rovingFocusGroup.onEntryFocus", Tp = { bubbles: !1, cancelable: !0 }, to = "RovingFocusGroup", [ks, mc, Sp] = Ol(to), [Mp, fc] = kn(
  to,
  [Sp]
), [Dp, Ap] = Mp(to), hc = T.forwardRef(
  (e, t) => /* @__PURE__ */ z(ks.Provider, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ z(ks.Slot, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ z(Pp, { ...e, ref: t }) }) })
);
hc.displayName = to;
var Pp = T.forwardRef((e, t) => {
  const {
    ...
    ...d
  } = e, f = T.useRef(null), h = Le(t, f), g = _l(s), [p, b] = Js({
    prop: a,
    defaultProp: i ?? null,
    onChange: l,
    caller: to
  }), [v, w] = T.useState(!1), N = gt(c), E = mc(n), y = T.useRef(!1), [C, S] = T.useState(0);
  return T.useEffect(() => {
    const k = f.current;
    if (k)
...
}), pc = "RovingFocusGroupItem", gc = T.forwardRef(
  (e, t) => {
    const {
      __scopeRovingFocusGroup: n,
      focusable: o = !0,
      ...
      children: a,
      ...i
    } = e, l = tr(), c = s || l, u = Ap(pc, n), d = u.currentTabStopId === c, f = mc(n), { onFocusableItemAdd: h, onFocusableItemRemove: g, currentTabStopId: p } = u;
    return T.useEffect(() => {
      if (o)
        return h(), () => g();
    }, [o, h, g]), /* @__PURE__ */ z(
        ...
        children: /* @__PURE__ */ z(
          Ae.span,
          {
            ...
            onKeyDown: le(e.onKeyDown, (b) => {
              ...
              const v = Rp(b, u.orientation, u.dir);
              if (v !== void 0) {
...
var _p = hc, Bp = gc, $p = function(e) {
  if (typeof document > "u")
    return null;
  var t = Array.isArray(e) ? e[0] : e;
  return t.ownerDocument.body;
}, en = /* @__PURE__ */ new WeakMap(), Oo = /* @__PURE__ */ new WeakMap(), _o = {}, Zr = 0, vc = function(e) {
  return e && (e.host || vc(e.parentNode));
}, Hp = function(e, t) {
  ...
  return u(t), i.clear(), Zr++, function() {
    ...
    }), Zr--, Zr || (en = /* @__PURE__ */ new WeakMap(), en = /* @__PURE__ */ new WeakMap(), Oo = /* @__PURE__ */ new WeakMap(), _o = {});
  };
}, Fp = function(e, t, n) {
  n === void 0 && (n = "data-aria-hidden");
  var o = Array.from(Array.isArray(e) ? e : [e]), r = $p(e);
  return r ? (o.push.apply(o, Array.from(r.querySelectorAll("[aria-live], script"))), Wp(o, r, n, "aria-hidden")) : function() {
    return null;
  };
}, tt = function() {
...
var Xo = "right-scroll-bar-position", Zo = "width-before-scroll-bar", Up = "with-scroll-bars-hidden", Yp = "--removed-body-scroll-bar-size";
function Qr(e, t) {
...
var Vp = typeof window < "u" ? T.useLayoutEffect : T.useEffect, va = /* @__PURE__ */ new WeakMap();
function Kp(e, t) {
  var n = jp(null, function(o) {
...
var Nc = Xp(), Jr = function() {
}, xr = T.forwardRef(function(e, t) {
  var n = T.useRef(null), o = T.useState({
    onScrollCapture: Jr,
    onWheelCapture: Jr,
    onTouchMoveCapture: Jr
  }), r = o[0], s = o[1], a = e.forwardProps, i = e.children, l = e.className, c = e.removeScrollBar, u = e.enabled, d = e.shards, f = e.sideCar, h = e.noRelative, g = e.noIsolation, p = e.inert, b = e.allowPinchZoom, v = e.as, w = v === void 0 ? "div" : v, N = e.gapMode, E = wc(e, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noRelative", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), y = f, C = Kp([n, t]), S = tt(tt({}, E), r);
  return T.createElement(
    T.Fragment,
    null,
    u && T.createElement(y, { sideCar: Nc, removeScrollBar: c, shards: d, noRelative: h, noIsolation: g, inert: p, setCallbacks: s, allowPinchZoom: !!b, lockRef: n, gapMode: N }),
...
var ng = function() {
  ...
  if (e === void 0 && (e = "margin"), typeof window > "u")
    return rg;
  var t = sg(e), n = document.documentElement.clientWidth, o = window.innerWidth;
  return {
    left: t[0],
    top: t[1],
    right: t[2],
...
}, ag = kc(), mn = "data-scroll-locked", lg = function(e, t, n, o) {
...
`);
  ...
  return T.createElement(ag, { styles: lg(s, !t, r, n ? "" : "!important") });
}, xs = !1;
if (typeof window < "u")
  try {
...
var tn = xs ? { passive: !1 } : !1, dg = function(e) {
  ...
  return xc(e, "overflowY");
}, fg = function(e) {
  return xc(e, "overflowX");
}, ya = function(e, t) {
  ...
  return e === "v" ? mg(t) : fg(t);
}, Ec = function(e, t) {
  return e === "v" ? hg(t) : pg(t);
}, gg = function(e, t) {
  return e === "h" && t === "rtl" ? -1 : 1;
}, bg = function(e, t, n, o, r) {
  var s = gg(e, window.getComputedStyle(t).direction), a = s * o, i = n.target, l = t.contains(i), c = !1, u = a > 0, d = 0, f = 0;
  do {
    if (!i)
      break;
    var h = Ec(e, i), g = h[0], p = h[1], b = h[2], v = p - b - s * g;
    (g || v) && Cc(e, i) && (d += v, f += g);
    var w = i.parentNode;
...
function Ng(e) {
  var t = T.useRef([]), n = T.useRef([0, 0]), o = T.useRef(), r = T.useState(yg++)[0], s = T.useState(kc)[0], a = T.useRef(e);
  T.useEffect(function() {
    a.current = e;
  }, [e]), T.useEffect(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(r));
      var p = zp([e.lockRef.current], (e.shards || []).map(ka), !0).filter(Boolean);
  ...
  var i = T.useCallback(function(p, b) {
    ...
    if (!o.current && "changedTouches" in p && (N || E) && (o.current = y), !y)
      return !0;
    var D = o.current || y;
    return bg(D, b, p, D === "h" ? N : E);
  }, []), l = T.useCallback(function(p) {
    var b = p;
    if (!(!nn.length || nn[nn.length - 1] !== s)) {
      var v = "deltaY" in b ? Na(b) : $o(b), w = t.current.filter(function(y) {
        return y.name === b.type && (y.target === b.target || b.target === y.shadowParent) && vg(y.delta, v);
      })[0];
      if (w && w.should) {
    ...
    var N = { name: p, delta: b, target: v, should: w, shadowParent: kg(v) };
  ...
  return T.createElement(
    T.Fragment,
    null,
    g ? T.createElement(s, { styles: wg(r) }) : null,
    h ? T.createElement(ug, { noRelative: e.noRelative, gapMode: e.gapMode }) : null
  );
}
function kg(e) {
...
const xg = Zp(Nc, Ng);
var Tc = T.forwardRef(function(e, t) {
  return T.createElement(xr, tt({}, e, { ref: t, sideCar: xg }));
});
Tc.classNames = xr.classNames;
var Cs = ["Enter", " "], Cg = ["ArrowDown", "PageUp", "Home"], Sc = ["ArrowUp", "PageDown", "End"], Eg = [...Cg, ...Sc], Tg = {
  ltr: [...Cs, "ArrowRight"],
  rtl: [...Cs, "ArrowLeft"]
}, Sg = {
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, no = "Menu", [Gn, Mg, Dg] = Ol(no), [Kt, Mc] = kn(no, [
  Dg,
  kr,
  fc
]), Cr = kr(), Dc = fc(), [Ag, Gt] = Kt(no), [Pg, oo] = Kt(no), Ac = (e) => {
  const { __scopeMenu: t, open: n = !1, children: o, dir: r, onOpenChange: s, modal: a = !0 } = e, i = Cr(t), [l, c] = T.useState(null), u = T.useRef(!1), d = gt(s), f = _l(r);
  return T.useEffect(() => {
    const h = () => {
  ...
  }, []), /* @__PURE__ */ z(lc, { ...i, children: /* @__PURE__ */ z(
    Ag,
    {
      scope: t,
      open: n,
...
Ac.displayName = no;
var Lg = "MenuAnchor", ui = T.forwardRef(
  (e, t) => {
...
ui.displayName = Lg;
var di = "MenuPortal", [Ig, Pc] = Kt(di, {
  forceMount: void 0
}), Lc = (e) => {
  const { __scopeMenu: t, forceMount: n, children: o, container: r } = e, s = Gt(di, t);
  return /* @__PURE__ */ z(Ig, { scope: t, forceMount: n, children: /* @__PURE__ */ z(Vt, { present: n || s.open, children: /* @__PURE__ */ z(ci, { asChild: !0, container: r, children: o }) }) });
};
Lc.displayName = di;
var Ke = "MenuContent", [Rg, mi] = Kt(Ke), Ic = T.forwardRef(
  (e, t) => {
    const n = Pc(Ke, e.__scopeMenu), { forceMount: o = n.forceMount, ...r } = e, s = Gt(Ke, e.__scopeMenu), a = oo(Ke, e.__scopeMenu);
    return /* @__PURE__ */ z(Gn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ z(Vt, { present: o || s.open, children: /* @__PURE__ */ z(Gn.Slot, { scope: e.__scopeMenu, children: a.modal ? /* @__PURE__ */ z(Og, { ...r, ref: t }) : /* @__PURE__ */ z(_g, { ...r, ref: t }) }) }) });
  }
), Og = T.forwardRef(
  (e, t) => {
...
}), Bg = /* @__PURE__ */ jn("MenuContent.ScrollLock"), fi = T.forwardRef(
  (e, t) => {
    const {
      __scopeMenu: n,
      loop: o = !1,
      ...
      ...p
    } = e, b = Gt(Ke, n), v = oo(Ke, n), w = Cr(n), N = Dc(n), E = Mg(n), [y, C] = T.useState(null), S = T.useRef(null), k = Le(t, S, b.onContentChange), D = T.useRef(0), x = T.useRef(""), M = T.useRef(0), A = T.useRef(null), I = T.useRef("right"), R = T.useRef(0), _ = g ? Tc : T.Fragment, H = g ? { as: Bg, allowPinchZoom: !0 } : void 0, V = (P) => {
      const B = x.current + P, G = E().filter((O) => !O.disabled), W = document.activeElement, U = G.find((O) => O.ref.current === W)?.textValue, K = G.map((O) => O.textValue), $ = qg(K, B, U), J = G.find((O) => O.textValue === $)?.ref.current;
      (function O(ee) {
        x.current = ee, window.clearTimeout(D.current), ee !== "" && (D.current = window.setTimeout(() => O(""), 1e3));
      })(B), J && setTimeout(() => J.focus());
    };
    T.useEffect(() => () => window.clearTimeout(D.current), []), Kf();
    const L = T.useCallback((P) => I.current === A.current?.side && Zg(P, A.current?.area), []);
    return /* @__PURE__ */ z(
      Rg,
      {
        scope: n,
                    ...
                    children: /* @__PURE__ */ z(
                      uc,
                      {
                        ...
                        onKeyDown: le(p.onKeyDown, (P) => {
                          ...
                          const K = S.current;
                          if (P.target !== K || !Eg.includes(P.key)) return;
                          P.preventDefault();
                          const J = E().filter((O) => !O.disabled).map((O) => O.ref.current);
                          Sc.includes(P.key) && J.reverse(), Kg(J);
                        }),
...
Ic.displayName = Ke;
var $g = "MenuGroup", hi = T.forwardRef(
  (e, t) => {
...
hi.displayName = $g;
var Hg = "MenuLabel", Rc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e;
...
Rc.displayName = Hg;
var ir = "MenuItem", xa = "menu.itemSelect", Er = T.forwardRef(
  (e, t) => {
    const { disabled: n = !1, onSelect: o, ...r } = e, s = T.useRef(null), a = oo(ir, e.__scopeMenu), i = mi(ir, e.__scopeMenu), l = Le(t, s), c = T.useRef(!1), u = () => {
      const d = s.current;
      if (!n && d) {
        const f = new CustomEvent(xa, { bubbles: !0, cancelable: !0 });
        d.addEventListener(xa, (h) => o?.(h), { once: !0 }), Rl(d, f), f.defaultPrevented ? c.current = !1 : a.onClose();
      }
    };
    return /* @__PURE__ */ z(
      Oc,
...
var Oc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, disabled: o = !1, textValue: r, ...s } = e, a = mi(ir, n), i = Dc(n), l = T.useRef(null), c = Le(t, l), [u, d] = T.useState(!1), [f, h] = T.useState("");
    return T.useEffect(() => {
      const g = l.current;
      ...
      Gn.ItemSlot,
      {
        ...
        disabled: o,
        textValue: r ?? f,
        children: /* @__PURE__ */ z(Bp, { asChild: !0, ...i, focusable: !o, children: /* @__PURE__ */ z(
          Ae.div,
          {
            role: "menuitem",
...
), Wg = "MenuCheckboxItem", _c = T.forwardRef(
  (e, t) => {
    const { checked: n = !1, onCheckedChange: o, ...r } = e;
    return /* @__PURE__ */ z(Fc, { scope: e.__scopeMenu, checked: n, children: /* @__PURE__ */ z(
      Er,
      {
...
_c.displayName = Wg;
var Bc = "MenuRadioGroup", [Fg, zg] = Kt(
  Bc,
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ z(Fg, { scope: e.__scopeMenu, value: n, onValueChange: s, children: /* @__PURE__ */ z(hi, { ...r, ref: t }) });
  }
);
$c.displayName = Bc;
var Hc = "MenuRadioItem", Wc = T.forwardRef(
  (e, t) => {
    const { value: n, ...o } = e, r = zg(Hc, e.__scopeMenu), s = n === r.value;
    return /* @__PURE__ */ z(Fc, { scope: e.__scopeMenu, checked: s, children: /* @__PURE__ */ z(
      Er,
      {
        role: "menuitemradio",
        "aria-checked": s,
...
Wc.displayName = Hc;
var pi = "MenuItemIndicator", [Fc, Ug] = Kt(
  pi,
  { checked: !1 }
), zc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, forceMount: o, ...r } = e, s = Ug(pi, n);
    return /* @__PURE__ */ z(
      Vt,
      {
...
zc.displayName = pi;
var Yg = "MenuSeparator", Uc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e;
    return /* @__PURE__ */ z(
      Ae.div,
...
Uc.displayName = Yg;
var jg = "MenuArrow", Yc = T.forwardRef(
  (e, t) => {
    const { __scopeMenu: n, ...o } = e, r = Cr(n);
    return /* @__PURE__ */ z(dc, { ...r, ...o, ref: t });
  }
);
Yc.displayName = jg;
var Vg = "MenuSub", [J1, jc] = Kt(Vg), Bn = "MenuSubTrigger", Vc = T.forwardRef(
  (e, t) => {
    const n = Gt(Bn, e.__scopeMenu), o = oo(Bn, e.__scopeMenu), r = jc(Bn, e.__scopeMenu), s = mi(Bn, e.__scopeMenu), a = T.useRef(null), { pointerGraceTimerRef: i, onPointerGraceIntentChange: l } = s, c = { __scopeMenu: e.__scopeMenu }, u = T.useCallback(() => {
    ...
    }, [i, l]), /* @__PURE__ */ z(ui, { asChild: !0, ...c, children: /* @__PURE__ */ z(
      Oc,
      {
        id: r.triggerId,
        "aria-haspopup": "menu",
        ...
        onKeyDown: le(e.onKeyDown, (d) => {
          ...
          e.disabled || f && d.key === " " || Tg[o.dir].includes(d.key) && (n.onOpenChange(!0), n.content?.focus(), d.preventDefault());
        })
      }
    ) });
  }
...
Vc.displayName = Bn;
var Kc = "MenuSubContent", Gc = T.forwardRef(
  (e, t) => {
    const n = Pc(Ke, e.__scopeMenu), { forceMount: o = n.forceMount, ...r } = e, s = Gt(Ke, e.__scopeMenu), a = oo(Ke, e.__scopeMenu), i = jc(Kc, e.__scopeMenu), l = T.useRef(null), c = Le(t, l);
    return /* @__PURE__ */ z(Gn.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ z(Vt, { present: o || s.open, children: /* @__PURE__ */ z(Gn.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ z(
      fi,
      {
        ...
        onKeyDown: le(e.onKeyDown, (u) => {
          const d = u.currentTarget.contains(u.target), f = Sg[a.dir].includes(u.key);
...
var Qg = Ac, Jg = ui, eb = Lc, tb = Ic, nb = hi, ob = Rc, rb = Er, sb = _c, ib = $c, ab = Wc, lb = zc, cb = Uc, ub = Yc, db = Vc, mb = Gc, Tr = "DropdownMenu", [fb] = kn(
  Tr,
  [Mc]
), Ie = Mc(), [hb, Xc] = fb(Tr), Zc = (e) => {
  const {
    ...
    onOpenChange: a,
    modal: i = !0
  } = e, l = Ie(t), c = T.useRef(null), [u, d] = Js({
    prop: r,
    defaultProp: s ?? !1,
    onChange: a,
    caller: Tr
  ...
  return /* @__PURE__ */ z(
    hb,
    {
      ...
      modal: i,
      children: /* @__PURE__ */ z(Qg, { ...l, open: u, onOpenChange: d, dir: o, modal: i, children: n })
    }
  );
};
Zc.displayName = Tr;
var Qc = "DropdownMenuTrigger", Jc = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, disabled: o = !1, ...r } = e, s = Xc(Qc, n), a = Ie(n);
...
Jc.displayName = Qc;
var pb = "DropdownMenuPortal", eu = (e) => {
  const { __scopeDropdownMenu: t, ...n } = e, o = Ie(t);
  return /* @__PURE__ */ z(eb, { ...o, ...n });
};
eu.displayName = pb;
var tu = "DropdownMenuContent", nu = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Xc(tu, n), s = Ie(n), a = T.useRef(!1);
    return /* @__PURE__ */ z(
      tb,
      {
        id: r.contentId,
...
nu.displayName = tu;
var gb = "DropdownMenuGroup", bb = T.forwardRef(
  (e, t) => {
...
bb.displayName = gb;
var vb = "DropdownMenuLabel", wb = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Ie(n);
...
wb.displayName = vb;
var yb = "DropdownMenuItem", ou = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Ie(n);
...
ou.displayName = yb;
var Nb = "DropdownMenuCheckboxItem", kb = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ie(n);
  return /* @__PURE__ */ z(sb, { ...r, ...o, ref: t });
});
kb.displayName = Nb;
var xb = "DropdownMenuRadioGroup", Cb = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ie(n);
  return /* @__PURE__ */ z(ib, { ...r, ...o, ref: t });
});
Cb.displayName = xb;
var Eb = "DropdownMenuRadioItem", Tb = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ie(n);
  return /* @__PURE__ */ z(ab, { ...r, ...o, ref: t });
});
Tb.displayName = Eb;
var Sb = "DropdownMenuItemIndicator", Mb = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ie(n);
  return /* @__PURE__ */ z(lb, { ...r, ...o, ref: t });
});
Mb.displayName = Sb;
var Db = "DropdownMenuSeparator", ru = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ie(n);
  return /* @__PURE__ */ z(cb, { ...r, ...o, ref: t });
});
ru.displayName = Db;
var Ab = "DropdownMenuArrow", Pb = T.forwardRef(
  (e, t) => {
    const { __scopeDropdownMenu: n, ...o } = e, r = Ie(n);
...
Pb.displayName = Ab;
var Lb = "DropdownMenuSubTrigger", Ib = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ie(n);
  return /* @__PURE__ */ z(db, { ...r, ...o, ref: t });
});
Ib.displayName = Lb;
var Rb = "DropdownMenuSubContent", Ob = T.forwardRef((e, t) => {
  const { __scopeDropdownMenu: n, ...o } = e, r = Ie(n);
  return /* @__PURE__ */ z(
    mb,
    {
...
Ob.displayName = Rb;
var _b = Zc, Bb = Jc, $b = eu, Hb = nu, Wb = ou, Fb = ru;
function su(e) {
  var t, n, o = "";
  if (typeof e == "string" || typeof e == "number") o += e;
  else if (typeof e == "object") if (Array.isArray(e)) {
    var r = e.length;
    for (t = 0; t < r; t++) e[t] && (n = su(e[t])) && (o && (o += " "), o += n);
  } else for (n in e) e[n] && (o && (o += " "), o += n);
  return o;
}
function iu() {
  for (var e, t, n = 0, o = "", r = arguments.length; n < r; n++) (e = arguments[n]) && (t = su(e)) && (o && (o += " "), o += t);
  return o;
}
const bi = "-", zb = (e) => {
  const t = Yb(e), {
  ...
  return {
    getClassGroupId: (a) => {
      const i = a.split(bi);
      return i[0] === "" && i.length !== 1 && i.shift(), au(i, t) || Ub(a);
    },
  ...
  const n = e[0], o = t.nextPart.get(n), r = o ? au(e.slice(1), o) : void 0;
  if (r)
    return r;
  ...
  let n = e;
  return t.split(bi).forEach((o) => {
    n.nextPart.has(o) || n.nextPart.set(o, {
      nextPart: /* @__PURE__ */ new Map(),
      validators: []
    }), n = n.nextPart.get(o);
  }), n;
}, jb = (e) => e.isThemeGetter, Vb = (e) => {
  if (e < 1)
    return {
      get: () => {
      },
  ...
  let o = (r) => {
    ...
    const u = s.length === 0 ? r : r.substring(l), d = qb(u), f = d !== u, h = c && c > l ? c - l : void 0;
    return {
      modifiers: s,
  ...
  return o;
}, qb = (e) => e.endsWith(Ts) ? e.substring(0, e.length - 1) : e.startsWith(Ts) ? e.substring(1) : e, Xb = (e) => {
...
function tv(e, ...t) {
  ...
  function a(l) {
    ...
    return n = Zb(c), o = n.cache.get, r = n.cache.set, s = i, i(l);
  }
  function i(l) {
    const c = o(l);
    if (c)
...
const Ce = (e) => {
...
}, cu = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, uu = /^\((?:(\w[\w-]*):)?(.+)\)$/i, nv = /^\d+\/\d+$/, ov = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, rv = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, sv = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, iv = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, av = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, on = (e) => nv.test(e), ce = (e) => !!e && !Number.isNaN(Number(e)), xt = (e) => !!e && Number.isInteger(Number(e)), ts = (e) => e.endsWith("%") && ce(e.slice(0, -1)), ct = (e) => ov.test(e), lv = () => !0, cv = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  rv.test(e) && !sv.test(e)
), du = () => !1, uv = (e) => iv.test(e), dv = (e) => av.test(e), mv = (e) => !Z(e) && !Q(e), fv = (e) => En(e, hu, du), Z = (e) => cu.test(e), $t = (e) => En(e, pu, cv), ns = (e) => En(e, vv, ce), Ta = (e) => En(e, mu, du), hv = (e) => En(e, fu, dv), Ho = (e) => En(e, gu, uv), Q = (e) => uu.test(e), In = (e) => Tn(e, pu), pv = (e) => Tn(e, wv), Sa = (e) => Tn(e, mu), gv = (e) => Tn(e, hu), bv = (e) => Tn(e, fu), Wo = (e) => Tn(e, gu, !0), En = (e, t, n) => {
  const o = cu.exec(e);
  return o ? o[1] ? t(o[1]) : n(o[2]) : !1;
}, Tn = (e, t, n = !1) => {
  const o = uu.exec(e);
  return o ? o[1] ? t(o[1]) : n : !1;
}, mu = (e) => e === "position" || e === "percentage", fu = (e) => e === "image" || e === "url", hu = (e) => e === "length" || e === "size" || e === "bg-size", pu = (e) => e === "length", vv = (e) => e === "number", wv = (e) => e === "family-name", gu = (e) => e === "shadow", yv = () => {
  const e = Ce("color"), t = Ce("font"), n = Ce("text"), o = Ce("font-weight"), r = Ce("tracking"), s = Ce("leading"), a = Ce("breakpoint"), i = Ce("container"), l = Ce("spacing"), c = Ce("radius"), u = Ce("shadow"), d = Ce("inset-shadow"), f = Ce("text-shadow"), h = Ce("drop-shadow"), g = Ce("blur"), p = Ce("perspective"), b = Ce("aspect"), v = Ce("ease"), w = Ce("animate"), N = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], E = () => [
    ...
    span: ["full", xt, Q, Z]
  }, xt, Q, Z], A = () => [xt, "auto", Q, Z], I = () => ["auto", "min", "max", "fr", Q, Z], R = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], _ = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], H = () => ["auto", ...k()], V = () => [on, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...k()], L = () => [e, Q, Z], P = () => [...E(), Sa, Ta, {
    position: [Q, Z]
  }], B = () => ["no-repeat", {
    repeat: ["", "x", "y", "space", "round"]
  }], G = () => ["auto", "cover", "contain", gv, fv, {
    size: [Q, Z]
  }], W = () => [ts, In, $t], U = () => [
    ...
    Q,
    Z
  ], K = () => ["", ce, In, $t], $ = () => ["solid", "dashed", "dotted", "double"], J = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], O = () => [ce, ts, Sa, Ta], ee = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    g,
...
function os({
  ...
  return /* @__PURE__ */ m(_b, { "data-slot": "dropdown-menu", ...e }, void 0, !1, {
...
function ss({
  ...
  return /* @__PURE__ */ m($b, { children: /* @__PURE__ */ m(
    Hb,
    {
...
const Ma = (e) => typeof e == "boolean" ? `${e}` : e === 0 ? "0" : e, Da = iu, kv = (e, t) => (n) => {
  var o;
...
var xv = Object.freeze({
  ...
  whiteSpace: "nowrap",
  wordWrap: "normal"
}), Cv = "VisuallyHidden", bu = T.forwardRef(
  (e, t) => /* @__PURE__ */ z(
    Ae.span,
    {
      ...e,
...
bu.displayName = Cv;
var Ev = bu, [Sr] = kn("Tooltip", [
  kr
]), Mr = kr(), vu = "TooltipProvider", Tv = 700, Ds = "tooltip.open", [Sv, vi] = Sr(vu), wu = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = Tv,
...
wu.displayName = vu;
var Xn = "Tooltip", [Mv, ro] = Sr(Xn), yu = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: o,
    ...
    delayDuration: i
  } = e, l = vi(Xn, e.__scopeTooltip), c = Mr(t), [u, d] = T.useState(null), f = tr(), h = T.useRef(0), g = a ?? l.disableHoverableContent, p = i ?? l.delayDuration, b = T.useRef(!1), [v, w] = Js({
    prop: o,
    defaultProp: r ?? !1,
    onChange: (S) => {
  ...
  }, []), /* @__PURE__ */ z(lc, { ...c, children: /* @__PURE__ */ z(
    Mv,
    {
      scope: t,
      contentId: f,
...
yu.displayName = Xn;
var As = "TooltipTrigger", Nu = T.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...o } = e, r = ro(As, n), s = vi(As, n), a = Mr(n), i = T.useRef(null), l = Le(t, i, r.onTriggerChange), c = T.useRef(!1), u = T.useRef(!1), d = T.useCallback(() => c.current = !1, []);
    return T.useEffect(() => () => document.removeEventListener("pointerup", d), [d]), /* @__PURE__ */ z(cc, { asChild: !0, ...a, children: /* @__PURE__ */ z(
      Ae.button,
      {
...
Nu.displayName = As;
var wi = "TooltipPortal", [Dv, Av] = Sr(wi, {
  forceMount: void 0
}), ku = (e) => {
  const { __scopeTooltip: t, forceMount: n, children: o, container: r } = e, s = ro(wi, t);
  return /* @__PURE__ */ z(Dv, { scope: t, forceMount: n, children: /* @__PURE__ */ z(Vt, { present: n || s.open, children: /* @__PURE__ */ z(ci, { asChild: !0, container: r, children: o }) }) });
};
ku.displayName = wi;
var bn = "TooltipContent", xu = T.forwardRef(
  (e, t) => {
    const n = Av(bn, e.__scopeTooltip), { forceMount: o = n.forceMount, side: r = "top", ...s } = e, a = ro(bn, e.__scopeTooltip);
    return /* @__PURE__ */ z(Vt, { present: o || a.open, children: a.disableHoverableContent ? /* @__PURE__ */ z(Cu, { side: r, ...s, ref: t }) : /* @__PURE__ */ z(Pv, { side: r, ...s, ref: t }) });
  }
), Pv = T.forwardRef((e, t) => {
  const n = ro(bn, e.__scopeTooltip), o = vi(bn, e.__scopeTooltip), r = T.useRef(null), s = Le(t, r), [a, i] = T.useState(null), { trigger: l, onClose: c } = n, u = r.current, { onPointerInTransitChange: d } = o, f = T.useCallback(() => {
    i(null), d(!1);
  }, [d]), h = T.useCallback(
    (g, p) => {
      const b = g.currentTarget, v = { x: g.clientX, y: g.clientY }, w = Ov(v, b.getBoundingClientRect()), N = _v(v, w), E = Bv(p.getBoundingClientRect()), y = Hv([...N, ...E]);
      i(y), d(!0);
    },
    [d]
  );
  return T.useEffect(() => () => f(), [f]), T.useEffect(() => {
    ...
    if (a) {
      const g = (p) => {
        const b = p.target, v = { x: p.clientX, y: p.clientY }, w = l?.contains(b) || u?.contains(b), N = !$v(v, a);
        w ? f() : N && (f(), c());
      };
      return document.addEventListener("pointermove", g), () => document.removeEventListener("pointermove", g);
    }
  }, [l, u, a, c, f]), /* @__PURE__ */ z(Cu, { ...e, ref: s });
}), [Lv, Iv] = Sr(Xn, { isInside: !1 }), Rv = /* @__PURE__ */ If("TooltipContent"), Cu = T.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: o,
      ...
      ...i
    } = e, l = ro(bn, n), c = Mr(n), { onClose: u } = l;
      ...
      ei,
      {
        ...
        children: /* @__PURE__ */ Wm(
          uc,
          {
            ...
            children: [
              /* @__PURE__ */ z(Rv, { children: o }),
              /* @__PURE__ */ z(Lv, { scope: n, isInside: !0, children: /* @__PURE__ */ z(Ev, { id: l.contentId, role: "tooltip", children: r || o }) })
            ]
          }
        )
      }
...
xu.displayName = bn;
var Eu = "TooltipArrow", Tu = T.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...o } = e, r = Mr(n);
    return Iv(
      Eu,
      n
    ).isInside ? null : /* @__PURE__ */ z(dc, { ...r, ...o, ref: t });
  }
);
Tu.displayName = Eu;
function Ov(e, t) {
...
function Hv(e) {
  const t = e.slice();
  return t.sort((n, o) => n.x < o.x ? -1 : n.x > o.x ? 1 : n.y < o.y ? -1 : n.y > o.y ? 1 : 0), Wv(t);
}
function Wv(e) {
...
var Fv = wu, zv = yu, Uv = Nu, Yv = ku, jv = xu, Vv = Tu;
function Kv({
  delayDuration: e = 0,
  ...t
}) {
...
function Ps({
  ...
  return /* @__PURE__ */ m(Kv, { children: /* @__PURE__ */ m(zv, { "data-slot": "tooltip", ...e }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/tooltip.tsx",
    lineNumber: 24,
    columnNumber: 7
  }, this) }, void 0, !1, {
...
function Ls({
  ...
  return /* @__PURE__ */ m(Uv, { "data-slot": "tooltip-trigger", ...e }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/tooltip.tsx",
    lineNumber: 32,
    columnNumber: 10
  }, this);
...
function Is({
  ...
  return /* @__PURE__ */ m(Yv, { children: /* @__PURE__ */ m(
    jv,
    {
      ...
      children: [
        n,
        /* @__PURE__ */ m(Vv, { className: "bg-foreground fill-foreground z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/tooltip.tsx",
          lineNumber: 53,
          columnNumber: 9
        }, this)
...
const Ne = ({ onClick: e, isActive: t, disabled: n, children: o, tooltip: r }) => {
  ...
  lineNumber: 137,
  columnNumber: 3
}, void 0), Gv = wt(function({ editor: t, onCopyMarkdown: n, onOpenLinkPopover: o, className: r = "", autoReorderChecklist: s = !1, aiEnabled: a = !1, onAISparklesClick: i }) {
  const l = Y(null), [c, u] = j(!1), [d, f] = j(void 0), h = dl({
    editor: t,
    selector: ({ editor: C }) => ({
      canUndo: C.can().undo(),
      canRedo: C.can().redo(),
    ...
    /* @__PURE__ */ m(os, { children: [
      ...
      /* @__PURE__ */ m(ss, { align: "start", children: [
        ...
        /* @__PURE__ */ m(ye, { onClick: () => v("note"), children: [
          /* @__PURE__ */ m(wl, { size: 16, className: "mr-2", style: { color: "#FF8200" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 643,
            columnNumber: 13
          }, this),
        ...
        /* @__PURE__ */ m(ye, { onClick: () => v("prompt"), children: [
          /* @__PURE__ */ m(nm, { size: 16, className: "mr-2", style: { color: "#B244B3" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 646,
            columnNumber: 13
          }, this),
        ...
        /* @__PURE__ */ m(ye, { onClick: () => v("resources"), children: [
          /* @__PURE__ */ m(om, { size: 16, className: "mr-2", style: { color: "#63B148" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 649,
            columnNumber: 13
          }, this),
        ...
        /* @__PURE__ */ m(ye, { onClick: () => v("todo"), children: [
          /* @__PURE__ */ m(yl, { size: 16, className: "mr-2", style: { color: "#4479B3" } }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
            lineNumber: 652,
            columnNumber: 13
          }, this),
...
function qv({ editor: e, isOpen: t, onClose: n, focusTrigger: o = 0, initialSearchQuery: r, editorMode: s = "wysiwyg", rawMarkdown: a = "", onRawMarkdownChange: i, onMatchesChange: l }) {
      ...
      children: [
        /* @__PURE__ */ m("div", { className: "find-replace-row", children: [
          /* @__PURE__ */ m("div", { className: "find-replace-input-wrapper", children: [
            /* @__PURE__ */ m(sm, { size: 14, className: "find-replace-icon" }, void 0, !1, {
          ...
          /* @__PURE__ */ m(
            "button",
            {
              ...
              children: /* @__PURE__ */ m(am, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
                lineNumber: 428,
                columnNumber: 11
              }, this)
...
const Xv = typeof navigator < "u" && /Mac|iPod|iPhone|iPad/.test(navigator.platform), ut = Xv ? "⌘" : "Ctrl", Zv = ({ editor: e }) => {
      ...
      handleDOMEvents: {
        contextmenu(t, n) {
          ...
          if (r && r.closest(".ProseMirror")) {
            ...
            return e.chain().focus().setTextSelection(s).run(), rw(n, e, s), !0;
          }
          return !1;
        }
      }
...
function rw(e, t, n) {
  ...
  const p = [
    ...
    { label: "divider" },
    { label: "Copy Table", icon: "copy", action: () => sw(t) }
  ], b = {
...
}), aw = ef.extend({}), zn = new De("tableSorting");
let zt = null, $n = null;
function lw(e) {
...
function uw(e, t, n) {
  ...
  if (c.length < 2) {
    Aa(n, a), r.dispatch(o.tr.setMeta(zn, { updated: !0 }));
    return;
  }
  const u = c.map((g) => {
    let p = "", b = 0;
  ...
  u.sort((g, p) => cw(g.sortValue, p.sortValue, a));
...
function dw(e, t, n, o) {
  ...
  return s.style.cssText = "display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;padding:0;font-size:10px;color:" + (e ? i : l) + ";background:transparent;border:none;border-radius:3px;cursor:pointer;user-select:none;transition:all 0.15s ease;opacity:" + (e ? "1" : "0.5") + ";pointer-events:auto;vertical-align:middle;", s.addEventListener("mouseenter", () => {
    ...
    u.preventDefault(), u.stopPropagation(), uw(o, t, n);
  ...
  return new Me({
    ...
    state: {
      ...
      apply(t, n, o, r) {
        ...
        return !t.docChanged && !s?.updated && $n ? $n.map(t.mapping, t.doc) : ($n = fw(r.doc, e), $n);
      }
    },
    props: {
      decorations(t) {
        ...
        if (a.type.name === "tableRow") {
          ...
          a.forEach((u, d) => {
            if (u.type.name === "tableHeader") {
              ...
              const p = zt?.tablePos === s && zt?.columnIndex === l ? zt.direction : null, b = l, v = s, w = Ze.widget(h, () => dw(p, v, b, t), { side: 1, key: "sort-" + s + "-" + b });
              n.push(w);
            }
            c += u.nodeSize, l++;
          });
      ...
      new Me({
        ...
        state: {
          ...
          apply(o, r, s, a) {
            ...
            } : o.docChanged ? Nw(s.doc, a.doc, t.listItemTypes) ? {
              collapsedItems: new Set(e.collapsedItems),
              decorations: zo(a.doc, e, t, n),
              docVersion: r.docVersion + 1
            } : {
...
const xw = [
  ...
  info: { iconElements: xw, label: "Info", color: "var(--callout-info)", borderColor: "var(--callout-info-border)" },
  note: { iconElements: Cw, label: "Note", color: "var(--callout-note)", borderColor: "var(--callout-note-border)" },
  prompt: { iconElements: Ew, label: "Prompt", color: "var(--callout-prompt)", borderColor: "var(--callout-prompt-border)" },
  resources: { iconElements: Tw, label: "Resources", color: "var(--callout-resources)", borderColor: "var(--callout-resources-border)" },
  todo: { iconElements: Sw, label: "Todo", color: "var(--callout-todo)", borderColor: "var(--callout-todo-border)" },
  summary: { iconElements: Mw, label: "Summary", color: "var(--callout-summary)", borderColor: "var(--callout-summary-border)" }
}, Aw = Object.keys(ln);
class Pw {
  constructor(t, n, o) {
  ...
  toggleCollapse() {
    this.collapsed = !this.collapsed, this.collapsed ? (this.dom.classList.add("callout-collapsed"), this.contentWrapper.classList.add("callout-content-hidden"), this.headerEl.title = "Click to expand") : (this.dom.classList.remove("callout-collapsed"), this.contentWrapper.classList.remove("callout-content-hidden"), this.headerEl.title = "Click to collapse"), this.collapseIndicator.innerHTML = "", this.collapseIndicator.appendChild(
      this.collapsed ? Ht(Dw, 16) : Ht(as, 16)
    );
  }
  // ── Dropdown Portal ──
  toggleDropdown() {
...
const Lw = gr.create({
  ...
  addNodeView() {
    return ({ node: e, view: t, getPos: n }) => new Pw(e, t, n);
  },
  addCommands() {
    return {
      ...
      new Me({
        ...
        props: {
          handleDOMEvents: {
            copy(e, t) {
              const { state: n } = e;
              if (!(n.selection instanceof Um)) return !1;
...
function Ut(e, t) {
  try {
    const o = (Ow[e] ||= new Intl.DateTimeFormat("en-US", {
      timeZone: e,
...
Object.getOwnPropertyNames(Date.prototype).forEach((e) => {
  ...
  ot.prototype[t] && (e.startsWith("get") ? ot.prototype[e] = function() {
    ...
    return Date.prototype[t].apply(this.internal, arguments), Bw(this), +this;
...
class Pe extends ot {
  ...
  toTimeString() {
    ...
    return `${t} GMT${n}${o}${r} (${Rw(this.timeZone, this)})`;
  }
  toLocaleString(t, n) {
...
const Mu = 6048e5, $w = 864e5, _a = Symbol.for("constructDateFrom");
function ke(e, t) {
...
function Lu(e, t, n) {
  ...
  return Math.round((i - l) / $w);
}
function Ww(e, t) {
  const n = Pu(e, t), o = ke(e, 0);
...
function On(e) {
  return (t, n = {}) => {
    ...
    if (!s)
      return null;
    const a = s[0], i = o && e.parsePatterns[o] || e.parsePatterns[e.defaultParseWidth], l = Array.isArray(i) ? by(i, (d) => d.test(a)) : (
...
const wy = /^(\d+)(th|st|nd|rd)?/i, yy = /\d+/i, Ny = {
  narrow: /^(b|a)/i,
...
function Bu(e, t) {
  const n = he(e, t?.in), o = +Zn(n) - +Ww(n);
  return Math.round(o / Mu) + 1;
}
function $u(e, t) {
...
function Iy(e, t) {
  const n = so(), o = t?.firstWeekContainsDate ?? t?.locale?.options?.firstWeekContainsDate ?? n.firstWeekContainsDate ?? n.locale?.options?.firstWeekContainsDate ?? 1, r = $u(e, t), s = ke(t?.in || e, 0);
  return s.setFullYear(r, 0, o), s.setHours(0, 0, 0, 0), vn(s, t);
}
function Hu(e, t) {
  const n = he(e, t?.in), o = +vn(n, t) - +Iy(n, t);
  return Math.round(o / Mu) + 1;
}
function fe(e, t) {
...
const Fa = (e, t) => {
  ...
  return s.replace("{{date}}", Fa(o, t)).replace("{{time}}", Wu(r, t));
}, Oy = {
  p: Wu,
  P: Ry
}, _y = /^D+$/, By = /^Y+$/, $y = ["D", "DD", "YY", "YYYY"];
function Hy(e) {
  return _y.test(e);
}
function Wy(e) {
...
function Fy(e, t, n) {
  const o = zy(e, t, n);
  if (console.warn(o), $y.includes(e)) throw new RangeError(o);
}
function zy(e, t, n) {
...
const Uy = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g, Yy = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g, jy = /^'([^]*?)'?$/, Vy = /''/g, Ky = /[a-zA-Z]/;
function Gy(e, t, n) {
  const o = so(), r = n?.locale ?? o.locale ?? Ni, s = n?.firstWeekContainsDate ?? n?.locale?.options?.firstWeekContainsDate ?? o.firstWeekContainsDate ?? o.locale?.options?.firstWeekContainsDate ?? 1, a = n?.weekStartsOn ?? n?.locale?.options?.weekStartsOn ?? o.weekStartsOn ?? o.locale?.options?.weekStartsOn ?? 0, i = he(e, n?.in);
  if (!Vw(i))
    throw new RangeError("Invalid time value");
  let l = t.match(Yy).map((u) => {
    const d = u[0];
    if (d === "p" || d === "P") {
      const f = Oy[d];
  ...
  return l.map((u) => {
    ...
    const d = u.value;
    (!n?.useAdditionalWeekYearTokens && Wy(d) || !n?.useAdditionalDayOfYearTokens && Hy(d)) && Fy(d, t, String(e));
    const f = $a[d[0]];
...
function i0(e, t) {
  ...
  return t.getMonth(e) === t.getMonth(s) ? za : s0;
}
function Fu(e, t) {
...
class ze {
   ...
   */
  constructor(t, n) {
    this.Date = Date, this.today = () => this.overrides?.today ? this.overrides.today() : this.options.timeZone ? Pe.tz(this.options.timeZone) : new this.Date(), this.newDate = (o, r, s) => this.overrides?.newDate ? this.overrides.newDate(o, r, s) : this.options.timeZone ? new Pe(o, r, s, this.options.timeZone) : new Date(o, r, s), this.addDays = (o, r) => this.overrides?.addDays ? this.overrides.addDays(o, r) : Du(o, r), this.addMonths = (o, r) => this.overrides?.addMonths ? this.overrides.addMonths(o, r) : Au(o, r), this.addWeeks = (o, r) => this.overrides?.addWeeks ? this.overrides.addWeeks(o, r) : Fw(o, r), this.addYears = (o, r) => this.overrides?.addYears ? this.overrides.addYears(o, r) : zw(o, r), this.differenceInCalendarDays = (o, r) => this.overrides?.differenceInCalendarDays ? this.overrides.differenceInCalendarDays(o, r) : Lu(o, r), this.differenceInCalendarMonths = (o, r) => this.overrides?.differenceInCalendarMonths ? this.overrides.differenceInCalendarMonths(o, r) : Kw(o, r), this.eachMonthOfInterval = (o) => this.overrides?.eachMonthOfInterval ? this.overrides.eachMonthOfInterval(o) : qw(o), this.eachYearOfInterval = (o) => {
      const r = this.overrides?.eachYearOfInterval ? this.overrides.eachYearOfInterval(o) : Qw(o), s = new Set(r.map((i) => this.getYear(i)));
      if (s.size === r.length)
        return r;
      const a = [];
      return s.forEach((i) => {
    ...
    }, this.endOfBroadcastWeek = (o) => this.overrides?.endOfBroadcastWeek ? this.overrides.endOfBroadcastWeek(o) : a0(o, this), this.endOfISOWeek = (o) => this.overrides?.endOfISOWeek ? this.overrides.endOfISOWeek(o) : Jw(o), this.endOfMonth = (o) => this.overrides?.endOfMonth ? this.overrides.endOfMonth(o) : Gw(o), this.endOfWeek = (o, r) => this.overrides?.endOfWeek ? this.overrides.endOfWeek(o, r) : _u(o, this.options), this.endOfYear = (o) => this.overrides?.endOfYear ? this.overrides.endOfYear(o) : Zw(o), this.format = (o, r, s) => {
      const a = this.overrides?.format ? this.overrides.format(o, r, this.options) : Gy(o, r, this.options);
      return this.options.numerals && this.options.numerals !== "latn" ? this.replaceDigits(a) : a;
    }, this.getISOWeek = (o) => this.overrides?.getISOWeek ? this.overrides.getISOWeek(o) : Bu(o), this.getMonth = (o, r) => this.overrides?.getMonth ? this.overrides.getMonth(o, this.options) : Zy(o, this.options), this.getYear = (o, r) => this.overrides?.getYear ? this.overrides.getYear(o, this.options) : Qy(o, this.options), this.getWeek = (o, r) => this.overrides?.getWeek ? this.overrides.getWeek(o, this.options) : Hu(o, this.options), this.isAfter = (o, r) => this.overrides?.isAfter ? this.overrides.isAfter(o, r) : Jy(o, r), this.isBefore = (o, r) => this.overrides?.isBefore ? this.overrides.isBefore(o, r) : e0(o, r), this.isDate = (o) => this.overrides?.isDate ? this.overrides.isDate(o) : Iu(o), this.isSameDay = (o, r) => this.overrides?.isSameDay ? this.overrides.isSameDay(o, r) : jw(o, r), this.isSameMonth = (o, r) => this.overrides?.isSameMonth ? this.overrides.isSameMonth(o, r) : t0(o, r), this.isSameYear = (o, r) => this.overrides?.isSameYear ? this.overrides.isSameYear(o, r) : n0(o, r), this.max = (o) => this.overrides?.max ? this.overrides.max(o) : Uw(o), this.min = (o) => this.overrides?.min ? this.overrides.min(o) : Yw(o), this.setMonth = (o, r) => this.overrides?.setMonth ? this.overrides.setMonth(o, r) : o0(o, r), this.setYear = (o, r) => this.overrides?.setYear ? this.overrides.setYear(o, r) : r0(o, r), this.startOfBroadcastWeek = (o, r) => this.overrides?.startOfBroadcastWeek ? this.overrides.startOfBroadcastWeek(o, this) : Fu(o, this), this.startOfDay = (o) => this.overrides?.startOfDay ? this.overrides.startOfDay(o) : Qn(o), this.startOfISOWeek = (o) => this.overrides?.startOfISOWeek ? this.overrides.startOfISOWeek(o) : Zn(o), this.startOfMonth = (o) => this.overrides?.startOfMonth ? this.overrides.startOfMonth(o) : Xw(o), this.startOfWeek = (o, r) => this.overrides?.startOfWeek ? this.overrides.startOfWeek(o, this.options) : vn(o, this.options), this.startOfYear = (o) => this.overrides?.startOfYear ? this.overrides.startOfYear(o) : Ou(o), this.options = { locale: Ni, ...t }, this.overrides = n;
  }
  /**
...
function ft(e, t, n = at) {
  ...
  return o.some((i) => {
    ...
    return ju(i) ? s(e, i.after) > 0 : Vu(i) ? s(i.before, e) > 0 : typeof i == "function" ? i(e) : !1;
  });
}
function B0(e, t, n, o, r) {
...
const K0 = Xu, G0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  formatCaption: qu,
  formatDay: z0,
  ...
  formatWeekNumber: j0,
  formatWeekNumberHeader: V0,
  formatWeekdayName: Y0,
  formatYearCaption: K0,
...
const dN = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  labelWeekday: aN,
  labelYearDropdown: uN
}, Symbol.toStringTag, { value: "Module" })), ao = (e) => e instanceof HTMLElement ? e : null, cs = (e) => [
  ...e.querySelectorAll("[data-animated-month]") ?? []
], mN = (e) => ao(e.querySelector("[data-animated-month]")), us = (e) => ao(e.querySelector("[data-animated-caption]")), ds = (e) => ao(e.querySelector("[data-animated-weeks]")), fN = (e) => ao(e.querySelector("[data-animated-nav]")), hN = (e) => ao(e.querySelector("[data-animated-weekdays]"));
function pN(e, t, { classNames: n, months: o, focused: r, dateLib: s }) {
...
function wN(e, t, n, o) {
  const { addDays: r, endOfBroadcastWeek: s, endOfISOWeek: a, endOfMonth: i, endOfWeek: l, getISOWeek: c, getWeek: u, startOfBroadcastWeek: d, startOfISOWeek: f, startOfWeek: h } = o, g = e.reduce((p, b) => {
    ...
    const y = N.reduce((S, k) => {
      const D = n.ISOWeek ? c(k) : u(k), x = S.find((A) => A.weekNumber === D), M = new zu(k, b, o);
      return x ? x.days.push(M) : S.push(new c0(D, [M])), S;
    }, []), C = new l0(b, y);
    return p.push(C), p;
  }, []);
...
function CN(e, t) {
  const [n, o] = yN(e, t), { startOfMonth: r, endOfMonth: s } = t, a = Ua(e, n, o, t), [i, l] = Dr(
    a,
  ...
  const c = vN(i, o, e, t), u = gN(c, e.endMonth ? s(e.endMonth) : void 0, e, t), d = wN(c, u, e, t), f = xN(d), h = bN(d), g = kN(i, n, e, t), p = NN(i, o, e, t), { disableNavigation: b, onMonthChange: v } = e, w = (C) => f.some((S) => S.days.some((k) => k.isEqualTo(C))), N = (C) => {
    if (b)
      return;
    let S = r(C);
...
function Ju(e, t, n, o, r, s, a, i = 0) {
  if (i > 365)
    return;
  const l = TN(e, t, n.date, o, r, s, a), c = !!(s.disabled && ft(l, s.disabled, a)), u = !!(s.hidden && ft(l, s.hidden, a)), d = l, f = new zu(l, d, a);
  return !c && !u ? f : Ju(e, t, f, o, r, s, a, i + 1);
}
function SN(e, t, n, o, r) {
  const { autoFocus: s } = e, [a, i] = j(), l = EN(t.days, n, o || (() => !1), a), [c, u] = j(s ? l : void 0);
  return {
    ...
    moveFocus: (p, b) => {
      if (!c)
        return;
      const v = Ju(p, b, c, t.navStart, t.navEnd, e, r);
...
function DN(e, t, n = 0, o = 0, r = !1, s = at) {
...
function PN(e, t, n = at) {
  const o = Array.isArray(t) ? t : [t];
  if (o.filter((i) => typeof i != "function").some((i) => typeof i == "boolean" ? i : n.isDate(i) ? mt(e, i, !1, n) : Gu(i, n) ? i.some((l) => mt(e, l, !1, n)) : ki(i) ? i.from && i.to ? ja(e, { from: i.from, to: i.to }, n) : !1 : Ku(i) ? AN(e, i.dayOfWeek, n) : Yu(i) ? n.isAfter(i.before, i.after) ? ja(e, {
    from: n.addDays(i.after, 1),
    to: n.addDays(i.before, -1)
  }, n) : ft(e.from, i, n) || ft(e.to, i, n) : ju(i) || Vu(i) ? ft(e.from, i, n) || ft(e.to, i, n) : !1))
    return !0;
...
function LN(e, t) {
  ...
  return {
    selected: c,
    select: (f, h, g) => {
      const { min: p, max: b } = e, v = f ? DN(f, c, p, b, s, t) : void 0;
      return o && n && v?.from && v.to && PN({ from: v.from, to: v.to }, n, t) && (v.from = f, v.to = void 0), a || l(v), a?.(v, f, h, g), v;
    },
...
function RN(e, t) {
  const n = IN(e, t), o = MN(e, t), r = LN(e, t);
  switch (e.mode) {
    case "single":
      return n;
    case "multiple":
...
function ON(e) {
  ...
  const { components: n, formatters: o, labels: r, dateLib: s, locale: a, classNames: i } = St(() => {
    ...
    t.labels,
    t.classNames
  ]), { captionLayout: l, mode: c, navLayout: u, numberOfMonths: d = 1, onDayBlur: f, onDayClick: h, onDayFocus: g, onDayKeyDown: p, onDayMouseEnter: b, onDayMouseLeave: v, onNextClick: w, onPrevClick: N, showWeekNumber: E, styles: y } = t, { formatCaption: C, formatDay: S, formatMonthDropdown: k, formatWeekNumber: D, formatWeekNumberHeader: x, formatWeekdayName: M, formatYearDropdown: A } = o, I = CN(t, s), { days: R, months: _, navStart: H, navEnd: V, previousMonth: L, nextMonth: P, goToMonth: B } = I, G = B0(R, t, H, V, s), { isSelected: W, select: U, selected: K } = RN(t, s) ?? {}, { blur: $, focused: J, isFocusTarget: O, moveFocus: ee, setFocused: ne } = SN(t, I, G, W ?? (() => !1), s), { labelDayButton: ue, labelGridcell: we, labelGrid: be, labelMonthDropdown: Ue, labelNav: lt, labelPrevious: It, labelNext: Mn, labelWeekday: Dn, labelWeekNumber: lo, labelWeekNumberHeader: co, labelYearDropdown: uo } = r, mo = St(() => Q0(s, t.ISOWeek), [s, t.ISOWeek]), An = c !== void 0 || h !== void 0, qt = F(() => {
    L && (B(L), N?.(L));
  }, [L, B, N]), yt = F(() => {
    P && (B(P), w?.(P));
  }, [B, P, w]), fo = F((ie, pe) => (oe) => {
  ...
  return X.createElement(
    ...
    X.createElement(
      n.Root,
      { rootRef: t.animate ? vo : void 0, className: Or, style: bo, dir: t.dir, id: t.id, lang: t.lang, nonce: t.nonce, title: t.title, role: t.role, "aria-label": t["aria-label"], "aria-labelledby": t["aria-labelledby"], ..._r },
      X.createElement(
        n.Months,
        ...
        _.map((ie, pe) => X.createElement(
          ...
          X.createElement(n.MonthCaption, { "data-animated-caption": t.animate ? "true" : void 0, className: i[te.MonthCaption], style: y?.[te.MonthCaption], calendarMonth: ie, displayIndex: pe }, l?.startsWith("dropdown") ? X.createElement(
            ...
            (() => {
              const oe = l === "dropdown" || l === "dropdown-months" ? X.createElement(n.MonthsDropdown, { key: "month", className: i[te.MonthsDropdown], "aria-label": Ue(), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: Ir(ie.date), options: X0(ie.date, H, V, o, s), style: y?.[te.Dropdown], value: s.getMonth(ie.date) }) : X.createElement("span", { key: "month" }, k(ie.date, s)), me = l === "dropdown" || l === "dropdown-years" ? X.createElement(n.YearsDropdown, { key: "year", className: i[te.YearsDropdown], "aria-label": uo(s.options), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: Rr(ie.date), options: J0(H, V, o, s, !!t.reverseYears), style: y?.[te.Dropdown], value: s.getYear(ie.date) }) : X.createElement("span", { key: "year" }, A(ie.date, s));
          ...
          X.createElement(
            ...
            X.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: i[te.Weeks], style: y?.[te.Weeks] }, ie.weeks.map((oe) => X.createElement(
              ...
              oe.days.map((me) => {
                ...
                const Xt = Z0(de, y, t.modifiersStyles), Zt = $0(de, i, t.modifiersClassNames), $r = !An && !de.hidden ? we(Te, de, s.options, s) : void 0;
                return (
                  // biome-ignore lint/a11y/useSemanticElements: react component
                  X.createElement(n.Day, { key: `${s.format(Te, "yyyy-MM-dd")}_${s.format(me.displayMonth, "yyyy-MM")}`, day: me, modifiers: de, className: Zt.join(" "), style: Xt, role: "gridcell", "aria-selected": de.selected || void 0, "aria-label": $r, "data-day": s.format(Te, "yyyy-MM-dd"), "data-month": me.outside ? s.format(Te, "yyyy-MM") : void 0, "data-selected": de.selected || void 0, "data-disabled": de.disabled || void 0, "data-hidden": de.hidden || void 0, "data-outside": me.outside || void 0, "data-focused": de.focused || void 0, "data-today": de.today || void 0 }, !de.hidden && An ? X.createElement(n.DayButton, { className: i[te.DayButton], style: y?.[te.DayButton], type: "button", day: me, modifiers: de, disabled: de.disabled || void 0, tabIndex: O(me) ? 0 : -1, "aria-label": ue(Te, de, s.options, s), onClick: fo(me, de), onBlur: po(me, de), onFocus: ho(me, de), onKeyDown: go(me, de), onMouseEnter: Pr(me, de), onMouseLeave: Lr(me, de) }, S(Te, s.options, s)) : !de.hidden && S(me.date, s.options, s))
                );
              })
            )))
          )
  ...
  return /* @__PURE__ */ m(
    ON,
    {
      ...
      components: {
        ...
        Chevron: ({ className: c, orientation: u, ...d }) => u === "left" ? /* @__PURE__ */ m(mm, { className: ae("size-4", c), ...d }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/calendar.tsx",
          lineNumber: 139,
          columnNumber: 15
          ...
          this
        ) : /* @__PURE__ */ m(hm, { className: ae("size-4", c), ...d }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/calendar.tsx",
          lineNumber: 153,
          columnNumber: 13
        }, this),
...
let fn = null;
const ed = /* @__PURE__ */ new Map(), $N = /* @__PURE__ */ new Map();
function Jo() {
  if (!fn) return;
  const e = fn;
  fn = null, setTimeout(() => {
...
function zN({ node: e, updateAttributes: t, selected: n }) {
  const o = Y(null), r = e.attrs.date || hn(), s = td(r), a = Ci(r), i = F(() => {
    if (!o.current) return "";
  ...
  return q(() => (ed.set(r, (l) => {
    ...
    "span",
    {
      ...
      "data-date": r,
      children: [
        /* @__PURE__ */ m(Nl, { size: 14, className: "date-icon" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/DatePillComponent.tsx",
          lineNumber: 410,
          columnNumber: 9
        }, this),
...
const YN = new De("datePillPaste"), jN = gr.create({
  name: "datePill",
  group: "inline",
  inline: !0,
  atom: !0,
  ...
  renderHTML({ node: e, HTMLAttributes: t }) {
    const n = e.attrs.date, o = td(n), r = Ci(n);
    return [
      "span",
      Nn(this.options.HTMLAttributes, t, {
        "data-type": "date-pill",
...
function VN({ node: e, selected: t, editor: n, getPos: o, deleteNode: r }) {
...
const KN = new De("tagPillPaste"), GN = gr.create({
  name: "tagPill",
  group: "inline",
  inline: !0,
  atom: !0,
...
}, ZN = ["info", "note", "prompt", "resources", "todo", "summary"];
function QN(e) {
...
function ek(e, t) {
  const { alt: n, align: o, width: r } = JN(e), s = {
    left: "margin-right: auto;",
    center: "margin-left: auto; margin-right: auto;",
    right: "margin-left: auto;"
...
function Va(e) {
  ...
  for (const s of o) {
    const a = s.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
    a ? r.push(ek(a[1], a[2])) : r.push(`<p>${cr(s.trim())}</p>`);
  }
  return r.join("");
}
function nd(e) {
...
function ur(e, t) {
  ...
  return e.descendants((r, s) => {
    if (r.type.name === "heading" && t.includes(r.attrs.level)) {
      ...
      o.set(l, c + 1), n.set(s, rk(a, i, c));
    }
  }), n;
}
function Uo(e, t, n, o) {
  const r = [], s = ur(e, n.levels), a = [];
  e.descendants((u, d) => {
...
function sk(e, t, n, o) {
  ...
  const r = ur(t, o), s = new Set(r.values()), a = [];
...
const ak = Oe.create({
    ...
    return {
      toggleHeadingCollapse: (e) => ({ editor: t, tr: n }) => {
        ...
        if (!r || r.type.name !== "heading")
          return !1;
        const a = ur(n.doc, this.options.levels).get(e);
      ...
      collapseAllHeadings: () => ({ editor: e, tr: t }) => {
        const n = this.storage;
        return ur(t.doc, this.options.levels).forEach((r) => {
        ...
        state: {
          ...
          apply(o, r, s, a) {
            return o.getMeta("collapsibleHeading") ? {
              ...
              docVersion: r.docVersion + 1
            } : o.docChanged ? (sk(s.doc, a.doc, e, t.levels), ik(s.doc, a.doc, t.levels) ? {
              collapsedHeadings: new Set(e.collapsedHeadings),
              decorations: Uo(a.doc, e, t, n),
              docVersion: r.docVersion + 1
            } : {
...
}), lk = /\[([^\]]+)\]\(([^)]+)\)$/, ck = /^(https?:\/\/|www\.)[^\s]+$/i, uk = Oe.create({
...
}), Yo = new De("searchHighlight"), mk = Oe.create({
  ...
  name: "tabIndent"
  // No plugins — logic moved to InputDispatcher
}), hk = new De("inputDispatcher"), pk = ["info", "note", "prompt", "resources", "todo"];
function gk(e) {
        ...
        props: {
          ...
          handleTextInput(t, n, o, r) {
            ...
            if (p.wrap(v, w), h > 1) {
              ...
              N && N.type === d && af(p.doc, h - 1) && p.join(h - 1);
            }
          ...
          handleKeyDown(t, n) {
            if (n.key === "Tab") {
              const { state: o, dispatch: r } = t, s = gk(o);
              if (!s)
                return n.preventDefault(), !0;
              n.preventDefault();
            ...
            if (n.key === "Enter") {
              ...
              for (const c of pk)
                if (i === `\`\`\`${c}`) {
                  ...
                  if (f && h) {
                    const g = h.create(), p = f.create({ type: c }, Sl.from(g));
                    u.insert(d, p);
...
const wk = /* @__PURE__ */ new Set([
  ...
  "codeBlock",
  "blockquote"
]), yk = "tableRow", Nk = /* @__PURE__ */ new Set(["tableCell", "tableHeader"]);
function kk(e, t, n) {
  const o = e.resolve(t);
...
function Ak(e, t, n) {
  let o = !1;
  return e.nodesBetween(t, n, (r) => rd.has(r.type.name) ? (o = !0, !1) : !0), o;
}
function Pk(e, t, n) {
  const o = [];
  let r = t, s = n;
  const a = (l) => l && (l.from < r || l.to > s) ? (o.push(l), r = l.from, s = l.to, !0) : !1;
  a(kk(e, r, s)), Dk(e, t) && (a(xk(e, r, s)), a(Ck(e, r, s))), a(Tk(e, r, s)), a(Ek(e, r, s));
  const i = Sk(e);
  if (i.length > 0) {
    const l = Mk(i, r, s);
    for (const c of l)
      Ak(e, c.from, c.to) ? c.from === 0 && c.to === e.content.size ? a({ from: 0, to: e.content.size, useSelectAll: !0 }) : a({ from: c.from, to: c.to, useSelectAll: !0 }) : a({ from: c.from, to: c.to });
  }
  ...
  addKeyboardShortcuts() {
    return {
      ...
      "Mod-a": ({ editor: e }) => {
        ...
        if (t.expansionDepth > 0 && r === t.lastExpandedFrom && s === t.lastExpandedTo || (t.expansionDepth = 0), o instanceof Ym || r === 0 && s === n.content.size)
          return !0;
        const i = Pk(n, r, s);
        let l = null;
        for (const c of i)
...
const Ok = new De("hexColorDecoration");
function sd(e, t, n) {
  const o = [];
          ...
          handleKeyDown(t, n) {
            ...
            if ((n.metaKey || n.ctrlKey) && n.key === "z" && !n.shiftKey) {
              if (n.preventDefault(), e.isTypingReplace && e.undoStack.length > 0) {
                ...
                return e.typedBuffer = r, r === "" && (e.isTypingReplace = !1), hf(t.state, t.dispatch), setTimeout(() => {
                  const s = Et(t);
            ...
            if ((n.metaKey || n.ctrlKey) && (n.key === "z" && n.shiftKey || n.key === "y")) {
              if (n.preventDefault(), e.redoStack.length > 0) {
                ...
                return e.typedBuffer = r, e.isTypingReplace = !0, pf(t.state, t.dispatch), setTimeout(() => {
                  const s = Et(t);
                  e.ranges = s, s.length === 0 && Ee(e);
                }, 10), !0;
              }
...
}), Wk = new De("linkBoundary"), Fk = Oe.create({
  name: "linkBoundary",
  addProseMirrorPlugins() {
    return [
      new Me({
...
}), zk = new De("smartCopyPaste"), id = /* @__PURE__ */ new Set(["codeBlock", "callout"]);
function Za(e) {
  const { state: t } = e, { selection: n } = t, { $from: o, $to: r } = n;
  for (let s = o.depth; s > 0; s--) {
    const a = o.node(s);
    if (!id.has(a.type.name)) continue;
...
`);
              ...
              const h = f.map((p) => p === "" ? u.create() : u.create(null, c.text(p))), g = Sl.from(h);
              return new Yr(g, 0, 0);
            } else {
...
async function qk(e, t, n) {
  return new Promise((o, r) => {
    ...
    a.onload = (i) => {
      ...
      const d = e.type === "image/png" || e.type === "image/gif", f = d ? "image/png" : "image/jpeg", h = d ? void 0 : n, g = c.toDataURL(f, h), p = Vk(g, e.name);
...
async function Qa(e, t, n) {
  ...
  try {
    ...
    try {
      ...
      return console.warn("Image upload failed, removing placeholder:", h), Xk(t, r, e.name), n.onUploadError?.(`Upload failed: ${h instanceof Error ? h.message : "Unknown error"}`), n.onUploadComplete?.(), !1;
    }
  } catch (r) {
...
function Qk({
  ...
  return St(() => {
    const g = [
      ...
      vf.configure({ HTMLAttributes: { class: "font-bold" } }).extend({ keepOnSplit: !1 }),
      wf.configure({ HTMLAttributes: { class: "italic" } }).extend({ keepOnSplit: !1 }),
      yf.configure({}).extend({ keepOnSplit: !1 }),
      bf.configure({}).extend({ keepOnSplit: !1 }),
    ...
    ), s.codeBlocks || g.push(Tf), s.callouts || g.push(Lw, dk), i && !s.collapsibleHeadings && !d && g.push(
      ak.configure({
        levels: r
      })
    ), s.images || g.push(
    ...
    ), a && g.push(Lk), u && !d && g.push(Bk), s.markdownPaste || g.push(
      ok.configure({
        enableMarkdownPaste: !0
      })
    ), g;
...
function ex() {
  return Jk(), {
    ...
    async ready() {
      ht || (dr ? await dr : await ad());
    }
  };
}
function tx() {
  const e = Y(null);
  return e.current || (e.current = ex()), e.current;
}
const nx = 2e3;
function ox(e) {
  const {
    ...
    isLightweightRef: k
  } = e, D = n && n.length > nx, x = Y(D ? n : null), M = D ? "" : n, A = Y(null), I = Y(null), R = Y(c), _ = Y(u), H = Y(d), V = Y(f), L = Y(null);
...
function el(e) {
  if (/<img\s/i.test(e)) {
    const t = /(<img\s[^>]*\/?>)/gi;
    return e.split(t).filter((o) => o.trim()).map((o) => /^<img\s/i.test(o) ? lx(o) : o.trim() ? `<p>${mr(o.trim())}</p>` : "").join("");
  }
  if (/^!\[/.test(e)) {
    const t = e.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
    if (t)
...
function fx(e) {
  ...
  ), t = rx(t), t = ix(t), t = ax(t), t = dx(t), t = t.replace(
    /(<pre[^>]*>\s*<code[^>]*>)([\s\S]*?)(<\/code>\s*<\/pre>)/g,
    (n, o, r, s) => o + r.replace(/\n+$/, "") + s
  ), t;
}
function hx(e, t, n = {}) {
  const o = mx(e, t, n), r = t(o);
  return fx(r);
}
function px(e, t, n) {
  q(() => {
...
function wx(e, t = {}) {
  const {
    ...
    const v = Math.max(1, Math.ceil(f / vx));
    return {
      words: f,
      characters: h,
...
function yx({ status: e, lastSaved: t, className: n = "" }) {
  const o = (r) => {
    if (!r) return "";
    ...
    "div",
    {
      ...
      children: [
        e === "idle" && t && /* @__PURE__ */ m(ve, { children: [
          /* @__PURE__ */ m(pm, { className: "w-3.5 h-3.5 text-muted-foreground" }, void 0, !1, {
        ...
        e === "error" && /* @__PURE__ */ m(ve, { children: [
          /* @__PURE__ */ m(gm, { className: "w-3.5 h-3.5 text-red-500" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/AutoSaveIndicator.tsx",
            lineNumber: 61,
            columnNumber: 11
          }, this),
...
function Nx({ onRecover: e, onDismiss: t, className: n = "" }) {
  return /* @__PURE__ */ m(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ m("div", { className: "flex items-center gap-3 min-w-0", children: [
          /* @__PURE__ */ m(bm, { className: "w-5 h-5 recovery-banner-icon flex-shrink-0" }, void 0, !1, {
...
`);
  ...
  if (!n || n.length === 0) {
    for (let l = 0; l < s.length; l++) {
      ...
      let f = a;
      for (const h of d)
        h.start > f && (r += Yt(e.substring(f, h.start))), r += `<span class="${tl(h.type)}">${Yt(h.content)}</span>`, f = h.end;
  ...
  q(() => {
    ...
    const x = (M) => {
      ...
      if (c.current = M, l.current.push({ time: M, duration: A }), l.current.length > 120 && (l.current = l.current.slice(-120)), A > 16.67 && d.current++, S++, M - k >= 1e3) {
        D = S, S = 0, k = M;
        const I = l.current.slice(-60), R = I.length > 0 ? I.reduce((W, U) => W + U.duration, 0) / I.length : 0, _ = I.length > 0 ? Math.max(...I.map((W) => W.duration)) : 0, H = performance.memory, V = H ? H.usedJSHeapSize / (1024 * 1024) : 0, L = H ? H.jsHeapSizeLimit / (1024 * 1024) : 0, P = document.querySelectorAll("*").length, B = nl - f.current, G = _s - h.current;
        f.current = nl, h.current = _s, i({
          ...
          renderCount: B,
          transactionCount: G,
          lastTransactionTime: Math.round(ld * 100) / 100,
          domNodes: P,
  ...
  return /* @__PURE__ */ m("div", { className: "perf-profiler-overlay", children: [
    /* @__PURE__ */ m("div", { className: "perf-profiler-header", children: [
      /* @__PURE__ */ m("div", { className: "perf-profiler-title", children: [
        /* @__PURE__ */ m(vm, { size: 14 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 241,
          columnNumber: 11
        }, this),
      ...
      /* @__PURE__ */ m("div", { className: "perf-profiler-actions", children: [
        /* @__PURE__ */ m("button", { onClick: N, title: r ? "Expand" : "Minimize", children: r ? /* @__PURE__ */ m(xl, { size: 12 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 246,
          columnNumber: 28
  ...
  render() {
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ m("div", { className: ae("flex-1 flex items-center justify-center p-6", this.props.className), children: /* @__PURE__ */ m("div", { className: "flex flex-col items-center max-w-md w-full text-center gap-4", children: [
        /* @__PURE__ */ m("div", { className: "w-12 h-12 rounded-full bg-destructive/10 flex items-center justify-center", children: /* @__PURE__ */ m(wm, { className: "w-6 h-6 text-destructive" }, void 0, !1, {
            ...
            "button",
            {
              ...
              children: [
                n ? /* @__PURE__ */ m(Jn, { className: "w-3 h-3" }, void 0, !1, {
                  ...
                  lineNumber: 193,
                  columnNumber: 21
                }, this) : /* @__PURE__ */ m(ym, { className: "w-3 h-3" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                  lineNumber: 195,
                  columnNumber: 21
                }, this),
              ...
              /* @__PURE__ */ m(
                "button",
                {
                  ...
                  children: r ? /* @__PURE__ */ m(ve, { children: [
                    /* @__PURE__ */ m(Nm, { className: "w-3 h-3 text-green-500" }, void 0, !1, {
                      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                      lineNumber: 210,
                      columnNumber: 29
                    }, this),
...
function Tx({ className: e = "", theme: t }) {
  const n = (o) => ({
    height: "1rem",
    width: o,
...
function Sx({ editorMode: e, onModeSwitch: t }) {
  return /* @__PURE__ */ m("div", { className: "editor-mode-toggle mr-2 sm:mr-3", children: [
    /* @__PURE__ */ m(
      "button",
      {
        ...
        title: "Visual Editor",
        children: /* @__PURE__ */ m(km, {}, void 0, !1, {
...
], Mx = wt(function({ editor: t, isH1: n, isH2: o, isH3: r, isH4: s, isH5: a, executeCommand: i }) {
...
}), Dx = wt(function({ onCopy: t, iconSize: n }) {
...
}), Ax = wt(function({ editor: t, className: n = "", suppressWhenLinkPopoverOpen: o = !1, aiEnabled: r = !1, onAISparklesClick: s, onCopySelectionAsMarkdown: a }) {
  const i = Y(null), l = dl({
    editor: t,
    selector: ({ editor: x }) => ({
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ m(
          Be,
          {
            onMouseDown: (x) => C(x, () => Qs(t)),
            isActive: l?.isCodeBlock,
            title: "Code Block",
            children: /* @__PURE__ */ m(xm, { size: k }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
              lineNumber: 602,
              columnNumber: 9
            }, this)
        ...
        a && /* @__PURE__ */ m(ve, { children: [
          ...
          /* @__PURE__ */ m(Dx, { onCopy: a, iconSize: k }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
            lineNumber: 609,
            columnNumber: 11
          }, this)
...
function Ix({ editor: e, onEditLink: t }) {
  const [n, o] = j({
    isVisible: !1,
    url: "",
    ...
    if (!(!e || e.isDestroyed)) {
      ...
      try {
        const C = y.getAttribute("href") || "", S = y.getBoundingClientRect(), k = S.bottom + 8, D = Math.max(16, Math.min(S.left, window.innerWidth - 340));
        a.current = y, o({
          isVisible: !0,
          url: C,
      ...
      children: /* @__PURE__ */ m("div", { className: "link-hover-tooltip-content", children: [
        /* @__PURE__ */ m(
          "button",
          {
            ...
            title: n.url,
            children: [
              /* @__PURE__ */ m(Cm, { size: 13, className: "link-hover-tooltip-link-icon" }, void 0, !1, {
        ...
        /* @__PURE__ */ m("div", { className: "link-hover-tooltip-actions", children: [
          /* @__PURE__ */ m(
            "button",
            {
              ...
              title: "Edit link",
              children: /* @__PURE__ */ m(Em, { size: 14 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkHoverTooltip.tsx",
                lineNumber: 343,
                columnNumber: 13
              }, this)
...
const Rx = [
  ...
  {
    title: "Divider",
    icon: /* @__PURE__ */ m(vl, { size: 16 }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 143,
      columnNumber: 11
    }, void 0),
  ...
  {
    title: "Note Callout",
    icon: /* @__PURE__ */ m(Lm, { size: 16, className: "text-purple-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 155,
      columnNumber: 11
    }, void 0),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ m(Im, { size: 16, className: "text-amber-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 161,
      columnNumber: 11
    }, void 0),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ m(wl, { size: 16, className: "text-green-400" }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SlashCommands.tsx",
      lineNumber: 167,
      columnNumber: 11
    }, void 0),
...
const Wx = 340, Fx = 36, zx = 8, Ux = 240, Go = 8;
function sl(e) {
  try {
    const t = window.getSelection();
    if (t && t.rangeCount > 0) {
...
function Yx({ editor: e, onSearch: t, onCreateItem: n }) {
        ...
        /* @__PURE__ */ m("div", { className: "image-edit-popover-content", children: [
          /* @__PURE__ */ m("div", { className: "image-edit-popover-field", children: [
            /* @__PURE__ */ m("label", { className: "image-edit-popover-label", children: [
              /* @__PURE__ */ m(Ys, { className: "w-3.5 h-3.5" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
                lineNumber: 155,
                columnNumber: 13
              }, this),
...
function Vx({ containerRef: e, enabled: t = !0 }) {
  ...
  return q(() => {
    ...
    /* @__PURE__ */ m("div", { className: "image-drop-zone-icon", children: /* @__PURE__ */ m(Rm, { className: "w-12 h-12" }, void 0, !1, {
...
function Gx({ actions: e, scope: t, onAction: n, onClose: o, position: r }) {
        ...
        `,
          children: [
            /* @__PURE__ */ m("div", { className: "px-2 py-1.5", children: /* @__PURE__ */ m("div", { className: "flex items-center gap-2 bg-secondary/50 rounded-md px-2.5 py-1.5 border border-border/50", children: [
              /* @__PURE__ */ m(El, { size: 14, className: "text-muted-foreground shrink-0" }, void 0, !1, {
...
function Xx({
  ...
  return /* @__PURE__ */ m(ve, { children: [
    !n.images && !n.dragAndDrop && /* @__PURE__ */ m(Vx, { containerRef: o, enabled: r }, void 0, !1, {
    ...
    !n.slashCommands && /* @__PURE__ */ m(Hx, { editor: e, disabledFeatures: n }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/WYSIWYGOverlays.tsx",
      lineNumber: 153,
      columnNumber: 9
    }, this),
    !n.wikiLinks && S && /* @__PURE__ */ m(Yx, { editor: e, onSearch: S }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/WYSIWYGOverlays.tsx",
      lineNumber: 158,
      columnNumber: 9
    }, this),
    ...
    /* @__PURE__ */ m(Ix, { editor: e, onEditLink: C }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/WYSIWYGOverlays.tsx",
      lineNumber: 169,
      columnNumber: 7
    }, this),
...
function Jx(e) {
  const [t, n] = Kd(Qx, { status: "idle" }), o = Y(null), r = F(async (i, l, c, u, d) => {
    if (e) {
      n({
...
const il = Gd(
  () => Promise.resolve().then(() => m1).then((e) => ({ default: e.TableOfContents }))
), e1 = () => {
  ...
  const [Xt] = j(() => e1()), [Zt, $r] = j(M), [Qt, Rt] = j(""), wo = Y(M), yo = Y(""), Pn = Y(null), [hd, Ei] = j(0), No = !!(oe && oe.length > 0 && me), { state: Ye, executeAction: ko, abort: pd, reset: Nt } = Jx(me), [gd, Hr] = j(null), [bd, vd] = j({ selectionTop: 0, selectionBottom: 0, selectionCenterX: 0 }), wd = Y(me);
  wd.current = me;
  const Ti = Y(Te);
  Ti.current = Te;
  const [yd, Nd] = j([]), [kd, xd] = j(0), Cd = F((se, xe) => {
    Nd(se), xd(xe);
  }, []), Si = Y(y), Mi = Y(C), Di = Y(S), Ai = Y(k), Pi = Y(D), Li = Y(B), Ii = Y(G), Ri = Y(W);
  Si.current = y, Mi.current = C, Di.current = S, Ai.current = k, Pi.current = D, Li.current = B, Ii.current = G, Ri.current = W;
  const Oi = 2e3, [Wr, Ed] = j(() => ie === "lightweight" ? !0 : ie === "full" ? !1 : t && typeof t == "string" ? Math.ceil(t.length / 80) > Oi : !1), Td = Y(0), _i = Y(Wr);
  _i.current = Wr;
  const [Fr, xo] = j(null), Sd = Qk({
    placeholder: a,
    isMobile: Xt,
    maxImageSize: E,
    headingLevels: be,
    ...
    enableCollapsibleLists: Br,
    enableTagAutoDetect: bo,
    enableHexColorHighlight: _r,
    isLightweight: Wr,
    setImageEditState: xo,
    callbackRefs: {
      onImageUploadStart: Si,
      onImageUploadComplete: Mi,
      onImageUploadError: Di,
      onImageUpload: Ai,
      resolveImageSrc: Pi,
      onWikiLinkClick: Li,
      validateWikiLink: Ii
    }
  }), { editor: re, turndownService: Co } = ox({
    extensions: Sd,
    content: t,
    editable: i,
    autofocus: l,
    ...
    isLightweightRef: _i
  }), [Md, Eo] = j(!1), [Dd, Ad] = j(!1), Pd = K !== void 0 ? K : Dd, Ot = F((se) => {
    Ad(se), $?.(se);
  }, [$]), [Ld, To] = j(0), [Id, Rd] = j(""), _t = ew(re, {
    storageKey: b,
    debounceMs: v,
    enabled: p,
    onSave: (se) => {
...
`) : "", Jt = Ge.scope === "document" || !Bt ? re.getText() : Bt, Mo = re.view.coordsAtPos(_e), Do = re.view.coordsAtPos(kt);
    ...
    }), Hr(null), ko(se, Ge.label, Jt, { from: _e, to: kt }, xe);
  }, [re, oe, ko]), Bd = F(() => {
...
` + xe).run(), Nt();
    ...
    if (Ge) return;
    const _e = re.state.doc.slice(se, xe), kt = jm.fromSchema(re.schema), Bt = document.createElement("div"), Jt = kt.serializeFragment(_e.content);
    Bt.appendChild(Jt);
...
`);
  ...
  if (!re)
    return /* @__PURE__ */ m(Tx, { className: c, theme: h }, void 0, !1, {
  ...
  return /* @__PURE__ */ m("div", { className: `markdown-editor-container ${g === "neutral" ? "color-theme-neutral" : ""} ${c}`, "data-theme": h, children: [
    ...
    u && /* @__PURE__ */ m("div", { className: "flex items-center bg-card/50 editor-toolbar-wrapper", children: [
      J ? J(re, Hi) : Hi,
      x && /* @__PURE__ */ m(Sx, { editorMode: Zt, onModeSwitch: zr }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
        lineNumber: 940,
        columnNumber: 13
      }, this)
    ...
    /* @__PURE__ */ m(Qv, { editor: re }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
      lineNumber: 961,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ m("div", { className: `editor-main-area ${lt ? "editor-with-toc" : ""}`, children: [
      lt && yt === "left" && /* @__PURE__ */ m(Fi, { fallback: null, children: /* @__PURE__ */ m(
        il,
        {
          editor: re,
          visible: It,
      ...
      /* @__PURE__ */ m(
        Ex,
        {
          ...
          onError: pe,
          children: [
            /* @__PURE__ */ m("div", { className: "editor-content-wrapper", ref: Pn, style: Fd, children: Zt === "wysiwyg" ? /* @__PURE__ */ m(ve, { children: [
              /* @__PURE__ */ m(Ud, { editor: re, className: "editor-content" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
                lineNumber: 1006,
                columnNumber: 13
              }, this),
              /* @__PURE__ */ m(
                Xx,
                {
                  ...
                  onImageDelete: () => {
                    re.chain().focus().setNodeSelection(Fr.pos).deleteSelection().run(), xo(null);
                  },
            ...
            /* @__PURE__ */ m(Zx, { scrollContainerRef: Pn }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
              lineNumber: 1060,
              columnNumber: 7
            }, this)
      ...
      lt && yt === "right" && /* @__PURE__ */ m(Fi, { fallback: null, children: /* @__PURE__ */ m(
        il,
        {
          editor: re,
          visible: It,
    ...
    /* @__PURE__ */ m(Cx, { visible: Lr, onClose: Ir, editor: re }, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
      lineNumber: 1099,
      columnNumber: 7
    }, this)
...
function oC({
  ...
  return /* @__PURE__ */ m(ud.Provider, { value: i, children: e }, void 0, !1, {
...
function sC({ node: e, updateAttributes: t }) {
  const [n, o] = j(!1), r = e.attrs.language || "plaintext";
  al.find((a) => a.value === r)?.label;
  const s = F(() => {
  ...
  return /* @__PURE__ */ m(er, { className: "code-block-wrapper", children: [
      ...
      /* @__PURE__ */ m("div", { className: "code-block-language-wrapper", children: [
        /* @__PURE__ */ m(
          "select",
          {
            ...
            children: al.map(({ value: a, label: i }) => /* @__PURE__ */ m("option", { value: a, children: i }, a, !1, {
    ...
    /* @__PURE__ */ m("pre", { className: "code-block-pre", children: /* @__PURE__ */ m("code", { children: /* @__PURE__ */ m(Yd, {}, void 0, !1, {
      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/CodeBlockComponent.tsx",
      lineNumber: 83,
      columnNumber: 11
    }, this) }, void 0, !1, {
...
const dd = "paragon-editor-toc-width", s1 = 280, md = 200, fd = 500, _n = 30, ll = 5;
function cl() {
  try {
    const e = localStorage.getItem(dd);
    if (e) {
      const t = parseInt(e, 10);
      if (!isNaN(t) && t >= md && t <= fd)
        return t;
    }
  } catch {
  }
...
function i1(e) {
  try {
    localStorage.setItem(dd, String(e));
  } catch {
  }
}
function a1(e, t, n) {
...
const Bs = wt(function({
  ...
  }, []), h = t.length * _n, g = Math.max(0, Math.floor(l / _n) - ll), p = Math.min(
    t.length,
    Math.ceil((l + u) / _n) + ll
  ), b = St(() => {
    const v = [];
  ...
  q(() => {
    const O = (ne) => {
      if (!R.current) return;
      const ue = f === "right" ? _.current - ne.clientX : ne.clientX - _.current, we = Math.min(fd, Math.max(md, H.current + ue));
      M(we);
    }, ee = () => {
      R.current && (R.current = !1, document.body.style.cursor = "", document.body.style.userSelect = "", M((ne) => (i1(ne), ne)));
    };
  ...
  return /* @__PURE__ */ m(ve, { children: [
    b && /* @__PURE__ */ m(
      "button",
      {
        ...
        children: C ? /* @__PURE__ */ m(Bm, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
          lineNumber: 598,
          columnNumber: 24
        }, this) : /* @__PURE__ */ m($m, { size: 16 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
          lineNumber: 598,
          columnNumber: 56
        }, this)
...
export {
  yx as AutoSaveIndicator,
  tC as Callout,
  dk as CalloutInputRule,
  sC as CodeBlockComponent,
  ak as CollapsibleHeading,
  kw as CollapsibleList,
  jN as DatePill,
  oC as EditorThemeProvider,
  Gv as EditorToolbar,
  qv as FindReplace,
  Ax as FloatingToolbar,
  Vx as ImageDropZone,
  Zk as ImageUpload,
  eC as MarkdownEditor,
  uk as MarkdownLinkInputRule,
  ok as MarkdownPasteSafe,
  pw as MixedBulletList,
  ww as MixedListItem,
  gw as MixedOrderedList,
  vw as MixedTaskItem,
  bw as MixedTaskList,
  Nx as RecoveryBanner,
  Iw as ResizableImage,
  ...
  XN as WikiLinkSafe,
  r1 as applyTheme,
  nC as createCustomTheme,
  cd as darkTheme,
  Ci as getDateVariant,
  cn as isValidTag,
  t1 as lightTheme,
  Nf as loadCoreLanguages,
