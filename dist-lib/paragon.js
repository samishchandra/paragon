...
import { ReactNodeViewRenderer as Dr, NodeViewWrapper as zn, NodeViewContent as ii, useEditorState as Cl, useEditor as jd, EditorContent as Kd } from "@tiptap/react";
...
import { Plugin as je, PluginKey as Ke, TextSelection as wt, AllSelection as nm } from "@tiptap/pm/state";
import { DecorationSet as Ze, Decoration as st } from "@tiptap/pm/view";
import { Extension as mt, Node as Ar, mergeAttributes as Kn, InputRule as Xe, Mark as El } from "@tiptap/core";
  ...
  N.forEach((D) => {
    if (D.label === "divider") {
      ...
      A.innerHTML = '<span style="display:flex;align-items:center;justify-content:center;width:16px;height:16px;flex-shrink:0;color:' + $ + ';">' + L + '</span><span style="flex:1;white-space:nowrap;">' + D.label + "</span>", A.addEventListener("mouseenter", () => {
        ...
        F.preventDefault(), F.stopPropagation(), D.action && D.action(), s.remove();
      }), s.appendChild(A);
    }
...
}), xf = tm.extend({}), vo = new Ke("tableSorting");
let mn = null, ho = null;
function Cf(e) {
...
function Tf(e, t, n) {
  ...
  const a = mn?.tablePos === t && mn?.columnIndex === n && mn?.direction === "asc" ? "desc" : "asc";
  mn = { tablePos: t, columnIndex: n, direction: a }, ho = null;
  const i = [];
  s.forEach((p) => {
  ...
  if (c.length < 2) {
    ba(n, a), r.dispatch(o.tr.setMeta(vo, { updated: !0 }));
    return;
  }
  const u = c.map((p) => {
    let g = "", b = 0;
  ...
  if (d.some((p, g) => p !== f[g])) {
    ...
    b.replaceWith(t, t + s.nodeSize, g), b.setMeta(vo, { updated: !0 }), r.dispatch(b);
  } else
    r.dispatch(o.tr.setMeta(vo, { updated: !0 }));
  ba(n, a);
}
function ba(e, t) {
...
function Sf(e) {
  return new je({
    ...
    state: {
      ...
      apply(t, n, o, r) {
        const s = t.getMeta(vo);
        return !t.docChanged && !s?.updated && ho ? ho.map(t.mapping, t.doc) : (ho = Df(r.doc, e), ho);
      }
    },
    props: {
      decorations(t) {
        ...
        if (a.type.name === "tableRow") {
          ...
          a.forEach((u, d) => {
            if (u.type.name === "tableHeader") {
              ...
              const g = mn?.tablePos === s && mn?.columnIndex === l ? mn.direction : null, b = l, w = s, v = st.widget(h, () => Mf(g, w, b, t), { side: 1, key: "sort-" + s + "-" + b });
              n.push(v);
            }
            c += u.nodeSize, l++;
          });
    ...
    return {
      ...
      Enter: () => {
        ...
        if (o.pos - l <= 1) {
          ...
          f.insert(d, g);
          const b = d + 1;
          return f.setSelection(wt.create(f.doc, b)), f.scrollIntoView(), t.view.dispatch(f), !0;
        }
        return t.commands.splitListItem(this.name);
      }
    };
      ...
      const c = s + 1 + l.nodeSize - 1, u = st.widget(
        ...
        () => {
          ...
          return p.className = `collapsible-list-chevron ${i ? "collapsed" : "expanded"}`, p.setAttribute("data-list-item-id", a), p.setAttribute("contenteditable", "false"), p.setAttribute("tabindex", "-1"), p.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>', p.title = i ? "Click to expand" : "Click to collapse", p.addEventListener("click", (g) => {
            ...
            p.classList.remove("collapsed", "expanded"), p.classList.add(b ? "expanded" : "collapsed"), p.title = b ? "Click to collapse" : "Click to expand", t.collapsedItems.has(a) ? t.collapsedItems.delete(a) : t.collapsedItems.add(a), On && On.dispatch(
              On.state.tr.setMeta("collapsibleList", { toggled: a })
            );
          }), h.appendChild(p), h;
        },
...
function Hf({ node: e, updateAttributes: t, extension: n }) {
  ...
  return /* @__PURE__ */ m(zn, { className: "code-block-wrapper", ref: c, children: [
    /* @__PURE__ */ m("div", { className: "code-block-controls", contentEditable: !1, children: [
      /* @__PURE__ */ m("div", { className: "code-block-language-wrapper", children: [
        ...
        /* @__PURE__ */ m(en, { size: 12, className: "code-block-language-chevron" }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CodeBlockWithFeatures.tsx",
          lineNumber: 273,
          columnNumber: 11
        }, this)
      ...
      /* @__PURE__ */ m(
        "button",
        {
          ...
          children: o ? /* @__PURE__ */ m(Gn, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CodeBlockWithFeatures.tsx",
            lineNumber: 281,
            columnNumber: 21
          }, this) : /* @__PURE__ */ m(qn, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CodeBlockWithFeatures.tsx",
            lineNumber: 281,
            columnNumber: 43
          }, this)
...
function Ff({ editor: e, isOpen: t, onClose: n }) {
  ...
  return /* @__PURE__ */ m(Ft, { children: h }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkPopover.tsx",
    lineNumber: 161,
    columnNumber: 10
  }, this);
...
function zf({ editor: e, onEditLink: t }) {
        ...
        /* @__PURE__ */ m("div", { className: "link-hover-tooltip-actions", children: [
          ...
          /* @__PURE__ */ m(
            "button",
            {
              ...
              className: "link-hover-tooltip-btn",
              title: "Copy link",
              children: c ? /* @__PURE__ */ m(Gn, { size: 14, style: { color: "var(--primary)" } }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkHoverTooltip.tsx",
                lineNumber: 268,
                columnNumber: 23
              }, this) : /* @__PURE__ */ m(qn, { size: 14 }, void 0, !1, {
  ...
  return /* @__PURE__ */ m(Ft, { children: v }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/LinkHoverTooltip.tsx",
    lineNumber: 285,
    columnNumber: 10
  }, this);
...
const rt = ({ onMouseDown: e, isActive: t, disabled: n, children: o, title: r }) => /* @__PURE__ */ m(
...
], Uf = Vn(function({ editor: t, isH1: n, isH2: o, isH3: r, isH4: s, isH5: a, executeCommand: i }) {
    ...
    /* @__PURE__ */ m(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ m(en, { size: 12, strokeWidth: 2.5, className: `flex-shrink-0 transition-transform duration-150 ${l ? "rotate-180" : ""}` }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
            lineNumber: 144,
            columnNumber: 9
          }, this)
...
}), Yf = Vn(function({ editor: t, className: n = "", suppressWhenLinkPopoverOpen: o = !1, aiEnabled: r = !1, onAISparklesClick: s }) {
  const a = V(null), i = Cl({
    editor: t,
    selector: ({ editor: T }) => ({
  ...
  Q(() => {
    ...
    const T = () => {
      if (!t.isDestroyed)
        try {
          const { selection: M } = t.state, { empty: D, from: A, to: I } = M, F = ("node" in M && M.node ? M.node : null)?.type?.name === "resizableImage";
          if (D || F || t.isActive("codeBlock")) {
          ...
          let Z = 0, te = 0;
          if (b.current) {
            const be = b.current.closest('[data-slot="dialog-content"]');
            if (be) {
              const ve = be.getBoundingClientRect();
              Z = ve.left, te = ve.top;
            }
          }
  ...
  return /* @__PURE__ */ m(Ft, { onMouseDown: k, children: x }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FloatingToolbar.tsx",
    lineNumber: 578,
    columnNumber: 5
  }, this);
...
function jf({ node: e, updateAttributes: t, editor: n }) {
  ...
  return /* @__PURE__ */ m(zn, { className: `callout callout-${d}${s ? " callout-collapsed" : ""}`, "data-callout": "", "data-type": d, children: [
    /* @__PURE__ */ m(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ m(
            "button",
            {
              ...
              children: [
                ...
                n.isEditable && /* @__PURE__ */ m(en, { size: 12, className: "callout-type-chevron" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CalloutWithMenu.tsx",
                  lineNumber: 128,
                  columnNumber: 33
                }, this)
          ...
          /* @__PURE__ */ m(
            "div",
            {
              ...
              children: s ? /* @__PURE__ */ m(Rl, { size: 16 }, void 0, !1, {
                ...
                lineNumber: 134,
                columnNumber: 24
              }, this) : /* @__PURE__ */ m(en, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/extensions/CalloutWithMenu.tsx",
                lineNumber: 134,
                columnNumber: 53
              }, this)
          ...
          o && n.isEditable && i && /* @__PURE__ */ m(Ft, { children: /* @__PURE__ */ m(
            "div",
            {
              ref: c,
    ...
    return ({ node: t, editor: n, getPos: o }) => {
      ...
      d.addEventListener("click", (P) => {
        if (P.preventDefault(), P.stopPropagation(), T)
          ...
          const j = window.innerHeight, ee = window.innerWidth, be = 200;
          z.bottom + 4 + be > j && (_ = z.top - be - 4 - te), H + Z < 8 && (H = 8 - Z), H + X + Z > ee - 8 && (H = ee - X - 8 - Z), f.style.top = `${_}px`, f.style.left = `${H}px`, f.style.display = "flex", T = !0, x();
        }
      });
      const M = (P) => {
      ...
      return u.addEventListener("mousedown", F), {
        dom: s,
        ...
        destroy: () => {
          u.removeEventListener("mousedown", F), D.removeEventListener("click", I), document.removeEventListener("click", M), f.remove();
        }
      };
    };
  }
...
function fn(e, t) {
  try {
    ...
    return o in po ? po[o] : ya(o, o.split(":"));
  } catch {
    if (e in po) return po[e];
    const n = e?.match(Xf);
...
function zs(e) {
  e.internal.setTime(+e), e.internal.setUTCSeconds(e.internal.getUTCSeconds() - Math.round(-fn(e.timeZone, e) * 60));
}
function Zf(e) {
...
function zl(e) {
  const t = fn(e.timeZone, e), n = t > 0 ? Math.floor(t) : Math.ceil(t), o = /* @__PURE__ */ new Date(+e);
  ...
  c.setUTCSeconds(0);
  const u = r > 0 ? c.getSeconds() : (c.getSeconds() - 60) % 60, d = Math.round(-(fn(e.timeZone, e) * 60)) % 60;
  ...
  const f = fn(e.timeZone, e), h = f > 0 ? Math.floor(f) : Math.ceil(f), g = -(/* @__PURE__ */ new Date(+e)).getTimezoneOffset() - h, b = h !== n, w = g - l;
  if (b && w) {
    Date.prototype.setUTCMinutes.call(e, Date.prototype.getUTCMinutes.call(e) + w);
    const v = fn(e.timeZone, e), N = v > 0 ? Math.floor(v) : Math.ceil(v), C = h - N;
...
function Un(e, t) {
  const n = Do(), o = t?.weekStartsOn ?? t?.locale?.options?.weekStartsOn ?? n.weekStartsOn ?? n.locale?.options?.weekStartsOn ?? 0, r = Ee(e, t?.in), s = r.getDay(), a = (s < o ? 7 : 0) + s - o;
...
function Kl(e, t) {
  const n = Ee(e, t?.in), o = n.getFullYear(), r = Oe(n, 0);
  r.setFullYear(o + 1, 0, 4), r.setHours(0, 0, 0, 0);
  const s = yo(r), a = Oe(n, 0);
...
function Vl(e, t, n) {
  const [o, r] = Xn(
    ...
    e,
    t
  ), s = ko(o), a = ko(r), i = +s - Ca(s), l = +a - Ca(a);
  return Math.round((i - l) / Qf);
}
function eh(e, t) {
  const n = Kl(e, t), o = Oe(e, 0);
  return o.setFullYear(n, 0, 4), o.setHours(0, 0, 0, 0), yo(o);
}
function th(e, t, n) {
  return Yl(e, t * 7, n);
}
...
function ih(e) {
  return !(!Gl(e) && typeof e != "number" || isNaN(+Ee(e)));
}
function ah(e, t, n) {
  const [o, r] = Xn(
    n?.in,
...
function dh(e, t) {
  const n = Ee(e, t?.in), o = n.getFullYear();
...
function Zl(e, t) {
  const n = Do(), o = t?.weekStartsOn ?? t?.locale?.options?.weekStartsOn ?? n.weekStartsOn ?? n.locale?.options?.weekStartsOn ?? 0, r = Ee(e, t?.in), s = r.getDay(), a = (s < o ? -7 : 0) + 6 - (s - o);
...
function Ql(e, t) {
  const n = Ee(e, t?.in), o = +yo(n) - +eh(n);
  return Math.round(o / Ul) + 1;
}
function Jl(e, t) {
  const n = Ee(e, t?.in), o = n.getFullYear(), r = Do(), s = t?.firstWeekContainsDate ?? t?.locale?.options?.firstWeekContainsDate ?? r.firstWeekContainsDate ?? r.locale?.options?.firstWeekContainsDate ?? 1, a = Oe(t?.in || e, 0);
  a.setFullYear(o + 1, 0, s), a.setHours(0, 0, 0, 0);
  const i = Un(a, t), l = Oe(t?.in || e, 0);
  l.setFullYear(o, 0, s), l.setHours(0, 0, 0, 0);
  const c = Un(l, t);
  return +n >= +i ? o + 1 : +n >= +c ? o : o - 1;
}
function Vh(e, t) {
  const n = Do(), o = t?.firstWeekContainsDate ?? t?.locale?.options?.firstWeekContainsDate ?? n.firstWeekContainsDate ?? n.locale?.options?.firstWeekContainsDate ?? 1, r = Jl(e, t), s = Oe(t?.in || e, 0);
  return s.setFullYear(r, 0, o), s.setHours(0, 0, 0, 0), Un(s, t);
}
function ec(e, t) {
  const n = Ee(e, t?.in), o = +Un(n, t) - +Vh(n, t);
  return Math.round(o / Ul) + 1;
}
function xe(e, t) {
...
const qt = {
  ...
  y(e, t) {
    ...
    return xe(t === "yy" ? o % 100 : o, t.length);
  },
  // Month
  M(e, t) {
    const n = e.getMonth();
  ...
  w: function(e, t, n, o) {
    const r = ec(e, o);
    return t === "wo" ? n.ordinalNumber(r, { unit: "week" }) : xe(r, t.length);
  },
  // ISO week of year
  I: function(e, t, n) {
    const o = Ql(e);
    return t === "Io" ? n.ordinalNumber(o, { unit: "week" }) : xe(o, t.length);
  },
  // Day of the month
  d: function(e, t, n) {
  ...
  D: function(e, t, n) {
    const o = Kh(e);
    return t === "Do" ? n.ordinalNumber(o, { unit: "dayOfYear" }) : xe(o, t.length);
  },
  // Day of week
  E: function(e, t, n) {
    const o = e.getDay();
  ...
  b: function(e, t, n) {
    const o = e.getHours();
    let r;
    switch (o === 12 ? r = En.noon : o === 0 ? r = En.midnight : r = o / 12 >= 1 ? "pm" : "am", t) {
      case "b":
      case "bb":
        return n.dayPeriod(r, {
          width: "abbreviated",
  ...
  B: function(e, t, n) {
    const o = e.getHours();
    let r;
    switch (o >= 17 ? r = En.evening : o >= 12 ? r = En.afternoon : o >= 4 ? r = En.morning : r = En.night, t) {
      case "B":
      case "BB":
      case "BBB":
        return n.dayPeriod(r, {
  ...
  K: function(e, t, n) {
    ...
    return t === "Ko" ? n.ordinalNumber(o, { unit: "hour" }) : xe(o, t.length);
  },
  // Hour [1-24]
  k: function(e, t, n) {
    let o = e.getHours();
    return o === 0 && (o = 24), t === "ko" ? n.ordinalNumber(o, { unit: "hour" }) : xe(o, t.length);
  },
  // Minute
  m: function(e, t, n) {
...
function Ta(e, t = "") {
  ...
  return s === 0 ? n + String(r) : n + String(r) + t + xe(s, 2);
}
function Ma(e, t) {
  return e % 60 === 0 ? (e > 0 ? "-" : "+") + xe(Math.abs(e) / 60, 2) : un(e, t);
}
function un(e, t = "") {
  const n = e > 0 ? "-" : "+", o = Math.abs(e), r = xe(Math.trunc(o / 60), 2), s = xe(o % 60, 2);
  return n + r + t + s;
}
const Sa = (e, t) => {
  switch (e) {
...
function lp(e, t, n) {
  const o = Do(), r = n?.locale ?? o.locale ?? Mi, s = n?.firstWeekContainsDate ?? n?.locale?.options?.firstWeekContainsDate ?? o.firstWeekContainsDate ?? o.locale?.options?.firstWeekContainsDate ?? 1, a = n?.weekStartsOn ?? n?.locale?.options?.weekStartsOn ?? o.weekStartsOn ?? o.locale?.options?.weekStartsOn ?? 0, i = Ee(e, n?.in);
  if (!ih(i))
...
function up(e, t) {
  const n = Ee(e, t?.in), o = n.getFullYear(), r = n.getMonth(), s = Oe(n, 0);
...
function bp(e, t, n) {
  const o = Ee(e, n?.in), r = o.getFullYear(), s = o.getDate(), a = Oe(e, 0);
...
function Dp(e) {
  const { options: t, className: n, components: o, classNames: r, ...s } = e, a = [r[se.Dropdown], n].join(" "), i = t?.find(({ value: l }) => l === s.value);
  return J.createElement(
    "span",
    { "data-disabled": s.disabled, className: r[se.DropdownRoot] },
    ...
    J.createElement(
      "span",
      { className: r[se.CaptionLabel], "aria-hidden": !0 },
      i?.label,
      J.createElement(o.Chevron, { orientation: "down", size: 18, className: r[se.Chevron] })
    )
  );
}
function Ap(e) {
...
function _p(e) {
  const { components: t } = Ao();
  return J.createElement(t.Dropdown, { ...e });
}
function $p(e) {
  const { onPreviousClick: t, onNextClick: n, previousMonth: o, nextMonth: r, ...s } = e, { components: a, classNames: i, labels: { labelPrevious: l, labelNext: c } } = Ao(), u = U((f) => {
    r && n?.(f);
  }, [r, n]), d = U((f) => {
    o && t?.(f);
  }, [o, t]);
  return J.createElement(
    ...
    J.createElement(
      ...
      { type: "button", className: i[se.PreviousMonthButton], tabIndex: o ? void 0 : -1, "aria-disabled": o ? void 0 : !0, "aria-label": l(o), onClick: d },
      J.createElement(a.Chevron, { disabled: o ? void 0 : !0, className: i[se.Chevron], orientation: "left" })
    ),
    J.createElement(
      a.NextMonthButton,
      { type: "button", className: i[se.NextMonthButton], tabIndex: r ? void 0 : -1, "aria-disabled": r ? void 0 : !0, "aria-label": c(r), onClick: u },
      J.createElement(a.Chevron, { disabled: r ? void 0 : !0, orientation: "right", className: i[se.Chevron] })
    )
  );
}
function Bp(e) {
...
function Zp(e, t, n, o, r) {
  ...
  for (const y of e) {
    const { date: k, displayMonth: S } = y, x = !!(S && !f(k, S)), T = !!(w && p(k, w)), M = !!(v && b(k, v)), D = !!(s && Ot(k, s, r)), A = !!(a && Ot(k, a, r)) || T || M || // Broadcast calendar will show outside days as default
...
function Qp(e, t, n = {}) {
  return Object.entries(e).filter(([, r]) => r === !0).reduce((r, [s]) => (n[s] ? r.push(n[s]) : t[De[s]] ? r.push(t[De[s]]) : t[ct[s]] && r.push(t[ct[s]]), r), [t[se.Day]]);
}
function Jp(e) {
  return {
    ...Xp,
...
}, Symbol.toStringTag, { value: "Module" })), Po = (e) => e instanceof HTMLElement ? e : null, ps = (e) => [
  ...e.querySelectorAll("[data-animated-month]") ?? []
], Tg = (e) => Po(e.querySelector("[data-animated-month]")), gs = (e) => Po(e.querySelector("[data-animated-caption]")), bs = (e) => Po(e.querySelector("[data-animated-weeks]")), Mg = (e) => Po(e.querySelector("[data-animated-nav]")), Sg = (e) => Po(e.querySelector("[data-animated-weekdays]"));
...
function Hg(e, t, n, o) {
  ...
  for (const a of e) {
    const i = t(a);
    Pa(i) && (i[De.focused] && s < pt.FocusedModifier ? (r = a, s = pt.FocusedModifier) : o?.isEqualTo(a) && s < pt.LastFocused ? (r = a, s = pt.LastFocused) : n(a.date) && s < pt.Selected ? (r = a, s = pt.Selected) : i[De.today] && s < pt.Today && (r = a, s = pt.Today));
  }
...
function hc(e, t, n, o, r, s, a, i = 0) {
  if (i > 365)
    return;
  const l = Wg(e, t, n.date, o, r, s, a), c = !!(s.disabled && Ot(l, s.disabled, a)), u = !!(s.hidden && Ot(l, s.hidden, a)), d = l, f = new oc(l, d, a);
...
function Ug(e, t, n = 0, o = 0, r = !1, s = kt) {
...
function Ra(e, t, n = kt) {
  return Lt(e, t.from, !1, n) || Lt(e, t.to, !1, n) || Lt(t, e.from, !1, n) || Lt(t, e.to, !1, n);
}
function jg(e, t, n = kt) {
  const o = Array.isArray(t) ? t : [t];
  if (o.filter((i) => typeof i != "function").some((i) => typeof i == "boolean" ? i : n.isDate(i) ? Lt(e, i, !1, n) : cc(i, n) ? i.some((l) => Lt(e, l, !1, n)) : Si(i) ? i.from && i.to ? Ra(e, { from: i.from, to: i.to }, n) : !1 : lc(i) ? Yg(e, i.dayOfWeek, n) : sc(i) ? n.isAfter(i.before, i.after) ? Ra(e, {
    from: n.addDays(i.after, 1),
    to: n.addDays(i.before, -1)
  }, n) : Ot(e.from, i, n) || Ot(e.to, i, n) : ic(i) || ac(i) ? Ot(e.from, i, n) || Ot(e.to, i, n) : !1))
    return !0;
...
function qg(e) {
  ...
  const { components: n, formatters: o, labels: r, dateLib: s, locale: a, classNames: i } = In(() => {
    ...
    t.labels,
    t.classNames
  ]), { captionLayout: l, mode: c, navLayout: u, numberOfMonths: d = 1, onDayBlur: f, onDayClick: h, onDayFocus: p, onDayKeyDown: g, onDayMouseEnter: b, onDayMouseLeave: w, onNextClick: v, onPrevClick: N, showWeekNumber: C, styles: y } = t, { formatCaption: k, formatDay: S, formatMonthDropdown: x, formatWeekNumber: T, formatWeekNumberHeader: M, formatWeekdayName: D, formatYearDropdown: A } = o, I = Bg(t, s), { days: L, months: $, navStart: F, navEnd: q, previousMonth: R, nextMonth: P, goToMonth: z } = I, X = Zp(L, t, F, q, s), { isSelected: G, select: Z, selected: te } = Gg(t, s) ?? {}, { blur: _, focused: H, isFocusTarget: j, moveFocus: ee, setFocused: be } = Fg(t, I, X, G ?? (() => !1), s), { labelDayButton: ve, labelGridcell: Pe, labelGrid: He, labelMonthDropdown: ot, labelNav: zt, labelPrevious: no, labelNext: oo, labelWeekday: $o, labelWeekNumber: Bo, labelWeekNumberHeader: Ho, labelYearDropdown: Wo } = r, wn = In(() => mg(s, t.ISOWeek), [s, t.ISOWeek]), ro = c !== void 0 || h !== void 0, Nn = U(() => {
    R && (z(R), N?.(R));
  }, [R, z, N]), yn = U(() => {
    P && (z(P), v?.(P));
  }, [z, P, v]), Fo = U((ue, Te) => (ae) => {
    ae.preventDefault(), ae.stopPropagation(), be(ue), Z?.(ue.date, Te, ae), h?.(ue.date, Te, ae);
  }, [Z, h, be]), qr = U((ue, Te) => (ae) => {
    be(ue), p?.(ue.date, Te, ae);
  }, [p, be]), Xr = U((ue, Te) => (ae) => {
    _(), f?.(ue.date, Te, ae);
  }, [_, f]), Zr = U((ue, Te) => (ae) => {
    const Ne = {
    ...
    if (Ne[ae.key]) {
      ...
      const [Ve, we] = Ne[ae.key];
      ee(Ve, we);
    }
    g?.(ue.date, Te, ae);
  }, [ee, g, t.dir]), Qr = U((ue, Te) => (ae) => {
    b?.(ue.date, Te, ae);
  }, [b]), zo = U((ue, Te) => (ae) => {
    w?.(ue.date, Te, ae);
  }, [w]), Uo = U((ue) => (Te) => {
    const ae = Number(Te.target.value), Ne = s.setMonth(s.startOfMonth(ue), ae);
    z(Ne);
  }, [s, z]), Jr = U((ue) => (Te) => {
    const ae = Number(Te.target.value), Ne = s.setYear(s.startOfMonth(ue), ae);
    z(Ne);
  }, [s, z]), { className: Yo, style: so } = In(() => ({
    className: [i[se.Root], t.className].filter(Boolean).join(" "),
    style: { ...y?.[se.Root], ...t.style }
  }), [i, t.className, t.style, y]), es = eg(t), ft = V(null);
  Dg(ft, !!t.animate, {
    classNames: i,
    months: $,
    focused: H,
  ...
  return J.createElement(
    ...
    J.createElement(
      n.Root,
      { rootRef: t.animate ? ft : void 0, className: Yo, style: so, dir: t.dir, id: t.id, lang: t.lang, nonce: t.nonce, title: t.title, role: t.role, "aria-label": t["aria-label"], "aria-labelledby": t["aria-labelledby"], ...es },
      J.createElement(
        n.Months,
        { className: i[se.Months], style: y?.[se.Months] },
        !t.hideNavigation && !u && J.createElement(n.Nav, { "data-animated-nav": t.animate ? "true" : void 0, className: i[se.Nav], style: y?.[se.Nav], "aria-label": zt(), onPreviousClick: Nn, onNextClick: yn, previousMonth: R, nextMonth: P }),
        $.map((ue, Te) => J.createElement(
          n.Month,
          {
          ...
          u === "around" && !t.hideNavigation && Te === 0 && J.createElement(
            n.PreviousMonthButton,
            { type: "button", className: i[se.PreviousMonthButton], tabIndex: R ? void 0 : -1, "aria-disabled": R ? void 0 : !0, "aria-label": no(R), onClick: Nn, "data-animated-button": t.animate ? "true" : void 0 },
            J.createElement(n.Chevron, { disabled: R ? void 0 : !0, className: i[se.Chevron], orientation: t.dir === "rtl" ? "right" : "left" })
          ),
          J.createElement(n.MonthCaption, { "data-animated-caption": t.animate ? "true" : void 0, className: i[se.MonthCaption], style: y?.[se.MonthCaption], calendarMonth: ue, displayIndex: Te }, l?.startsWith("dropdown") ? J.createElement(
            n.DropdownNav,
            { className: i[se.Dropdowns], style: y?.[se.Dropdowns] },
            (() => {
              const ae = l === "dropdown" || l === "dropdown-months" ? J.createElement(n.MonthsDropdown, { key: "month", className: i[se.MonthsDropdown], "aria-label": ot(), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: Uo(ue.date), options: ug(ue.date, F, q, o, s), style: y?.[se.Dropdown], value: s.getMonth(ue.date) }) : J.createElement("span", { key: "month" }, x(ue.date, s)), Ne = l === "dropdown" || l === "dropdown-years" ? J.createElement(n.YearsDropdown, { key: "year", className: i[se.YearsDropdown], "aria-label": Wo(s.options), classNames: i, components: n, disabled: !!t.disableNavigation, onChange: Jr(ue.date), options: fg(F, q, o, s, !!t.reverseYears), style: y?.[se.Dropdown], value: s.getYear(ue.date) }) : J.createElement("span", { key: "year" }, A(ue.date, s));
              return s.getMonthYearOrder() === "year-first" ? [Ne, ae] : [ae, Ne];
            })(),
            J.createElement("span", { role: "status", "aria-live": "polite", style: {
              ...
              whiteSpace: "nowrap",
              wordWrap: "normal"
            } }, k(ue.date, s.options, s))
          ) : (
            // biome-ignore lint/a11y/useSemanticElements: breaking change
            J.createElement(n.CaptionLabel, { className: i[se.CaptionLabel], role: "status", "aria-live": "polite" }, k(ue.date, s.options, s))
          )),
          u === "around" && !t.hideNavigation && Te === d - 1 && J.createElement(
            n.NextMonthButton,
            { type: "button", className: i[se.NextMonthButton], tabIndex: P ? void 0 : -1, "aria-disabled": P ? void 0 : !0, "aria-label": oo(P), onClick: yn, "data-animated-button": t.animate ? "true" : void 0 },
            J.createElement(n.Chevron, { disabled: P ? void 0 : !0, className: i[se.Chevron], orientation: t.dir === "rtl" ? "left" : "right" })
          ),
          Te === d - 1 && u === "after" && !t.hideNavigation && J.createElement(n.Nav, { "data-animated-nav": t.animate ? "true" : void 0, className: i[se.Nav], style: y?.[se.Nav], "aria-label": zt(), onPreviousClick: Nn, onNextClick: yn, previousMonth: R, nextMonth: P }),
          J.createElement(
            n.MonthGrid,
            { role: "grid", "aria-multiselectable": c === "multiple" || c === "range", "aria-label": He(ue.date, s.options, s) || void 0, className: i[se.MonthGrid], style: y?.[se.MonthGrid] },
            !t.hideWeekdays && J.createElement(
              n.Weekdays,
              { "data-animated-weekdays": t.animate ? "true" : void 0, className: i[se.Weekdays], style: y?.[se.Weekdays] },
              C && J.createElement(n.WeekNumberHeader, { "aria-label": Ho(s.options), className: i[se.WeekNumberHeader], style: y?.[se.WeekNumberHeader], scope: "col" }, M()),
              wn.map((ae) => J.createElement(n.Weekday, { "aria-label": $o(ae, s.options, s), className: i[se.Weekday], key: String(ae), style: y?.[se.Weekday], scope: "col" }, D(ae, s.options, s)))
            ),
            J.createElement(n.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: i[se.Weeks], style: y?.[se.Weeks] }, ue.weeks.map((ae) => J.createElement(
              n.Week,
              { className: i[se.Week], key: ae.weekNumber, style: y?.[se.Week], week: ae },
              C && // biome-ignore lint/a11y/useSemanticElements: react component
              J.createElement(n.WeekNumber, { week: ae, style: y?.[se.WeekNumber], "aria-label": Bo(ae.weekNumber, {
                locale: a
              }), className: i[se.WeekNumber], scope: "row", role: "rowheader" }, T(ae.weekNumber, s)),
              ae.days.map((Ne) => {
                const { date: Ve } = Ne, we = X(Ne);
                if (we[De.focused] = !we.hidden && !!H?.isEqualTo(Ne), we[ct.selected] = G?.(Ve) || we.selected, Si(te)) {
                  const { from: Et, to: ao } = te;
                  we[ct.range_start] = !!(Et && ao && s.isSameDay(Ve, Et)), we[ct.range_end] = !!(Et && ao && s.isSameDay(Ve, ao)), we[ct.range_middle] = Lt(te, Ve, !0, s);
                }
                const io = dg(we, y, t.modifiersStyles), qe = Qp(we, i, t.modifiersClassNames), Ct = !ro && !we.hidden ? Pe(Ve, we, s.options, s) : void 0;
                return (
                  // biome-ignore lint/a11y/useSemanticElements: react component
                  J.createElement(n.Day, { key: `${s.format(Ve, "yyyy-MM-dd")}_${s.format(Ne.displayMonth, "yyyy-MM")}`, day: Ne, modifiers: we, className: qe.join(" "), style: io, role: "gridcell", "aria-selected": we.selected || void 0, "aria-label": Ct, "data-day": s.format(Ve, "yyyy-MM-dd"), "data-month": Ne.outside ? s.format(Ve, "yyyy-MM") : void 0, "data-selected": we.selected || void 0, "data-disabled": we.disabled || void 0, "data-hidden": we.hidden || void 0, "data-outside": Ne.outside || void 0, "data-focused": we.focused || void 0, "data-today": we.today || void 0 }, !we.hidden && ro ? J.createElement(n.DayButton, { className: i[se.DayButton], style: y?.[se.DayButton], type: "button", day: Ne, modifiers: we, disabled: we.disabled || void 0, tabIndex: j(Ne) ? 0 : -1, "aria-label": ve(Ve, we, s.options, s), onClick: Fo(Ne, we), onBlur: Xr(Ne, we), onFocus: qr(Ne, we), onKeyDown: Zr(Ne, we), onMouseEnter: Qr(Ne, we), onMouseLeave: zo(Ne, we) }, S(Ve, s.options, s)) : !we.hidden && S(Ne.date, s.options, s))
                );
              })
            )))
          )
      ...
      J.createElement(n.Footer, { className: i[se.Footer], style: y?.[se.Footer], role: "status", "aria-live": "polite" }, t.footer)
    )
  );
}
function pc(e) {
...
const _e = (e) => {
...
}, wc = /^\[(?:(\w[\w-]*):)?(.+)\]$/i, Nc = /^\((?:(\w[\w-]*):)?(.+)\)$/i, ub = /^\d+\/\d+$/, db = /^(\d+(\.\d+)?)?(xs|sm|md|lg|xl)$/, mb = /\d+(%|px|r?em|[sdl]?v([hwib]|min|max)|pt|pc|in|cm|mm|cap|ch|ex|r?lh|cq(w|h|i|b|min|max))|\b(calc|min|max|clamp)\(.+\)|^0$/, fb = /^(rgba?|hsla?|hwb|(ok)?(lab|lch)|color-mix)\(.+\)$/, hb = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/, pb = /^(url|image|image-set|cross-fade|element|(repeating-)?(linear|radial|conic)-gradient)\(.+\)$/, Tn = (e) => ub.test(e), ge = (e) => !!e && !Number.isNaN(Number(e)), Xt = (e) => !!e && Number.isInteger(Number(e)), vs = (e) => e.endsWith("%") && ge(e.slice(0, -1)), Pt = (e) => db.test(e), gb = () => !0, bb = (e) => (
  // `colorFunctionRegex` check is necessary because color functions can have percentages in them which which would be incorrectly classified as lengths.
  // For example, `hsl(0 0% 0%)` would be classified as a length without this check.
  // I could also use lookbehind assertion in `lengthUnitRegex` but that isn't supported widely enough.
  mb.test(e) && !fb.test(e)
), yc = () => !1, vb = (e) => hb.test(e), wb = (e) => pb.test(e), Nb = (e) => !ne(e) && !oe(e), yb = (e) => Zn(e, Cc, yc), ne = (e) => wc.test(e), cn = (e) => Zn(e, Ec, bb), ws = (e) => Zn(e, Tb, ge), Oa = (e) => Zn(e, kc, yc), kb = (e) => Zn(e, xc, wb), Jo = (e) => Zn(e, Tc, vb), oe = (e) => Nc.test(e), fo = (e) => Qn(e, Ec), xb = (e) => Qn(e, Mb), _a = (e) => Qn(e, kc), Cb = (e) => Qn(e, Cc), Eb = (e) => Qn(e, xc), er = (e) => Qn(e, Tc, !0), Zn = (e, t, n) => {
  const o = wc.exec(e);
  ...
  const e = _e("color"), t = _e("font"), n = _e("text"), o = _e("font-weight"), r = _e("tracking"), s = _e("leading"), a = _e("breakpoint"), i = _e("container"), l = _e("spacing"), c = _e("radius"), u = _e("shadow"), d = _e("inset-shadow"), f = _e("text-shadow"), h = _e("drop-shadow"), p = _e("blur"), g = _e("perspective"), b = _e("aspect"), w = _e("ease"), v = _e("animate"), N = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], C = () => [
    ...
    // Deprecated since Tailwind CSS v4.1.0, see https://github.com/tailwindlabs/tailwindcss/pull/17378
    "left-bottom"
  ], y = () => [...C(), oe, ne], k = () => ["auto", "hidden", "clip", "visible", "scroll"], S = () => ["auto", "contain", "none"], x = () => [oe, ne, l], T = () => [Tn, "full", "auto", ...x()], M = () => [Xt, "none", "subgrid", oe, ne], D = () => ["auto", {
    span: ["full", Xt, oe, ne]
  }, Xt, oe, ne], A = () => [Xt, "auto", oe, ne], I = () => ["auto", "min", "max", "fr", oe, ne], L = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], $ = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], F = () => ["auto", ...x()], q = () => [Tn, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...x()], R = () => [e, oe, ne], P = () => [...C(), _a, Oa, {
    position: [oe, ne]
  }], z = () => ["no-repeat", {
    ...
    oe,
    ne
  ], te = () => ["", ge, fo, cn], _ = () => ["solid", "dashed", "dotted", "double"], H = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], j = () => [ge, vs, _a, Oa], ee = () => [
    // Deprecated since Tailwind CSS v4.0.0
    "",
    "none",
    p,
    oe,
    ne
  ], be = () => ["none", ge, oe, ne], ve = () => ["none", ge, oe, ne], Pe = () => [ge, oe, ne], He = () => [Tn, "full", ...x()];
  return {
    cacheSize: 500,
    theme: {
    ...
    classGroups: {
       ...
       */
      flex: [{
        flex: [ge, Tn, "auto", "initial", "none", ne]
      }],
      /**
       * Flex Grow
       ...
       */
      order: [{
        order: [Xt, "first", "last", "none", oe, ne]
      }],
      /**
       ...
       */
      "text-decoration-thickness": [{
        decoration: [ge, "from-font", "auto", oe, cn]
      }],
      /**
       ...
       */
      "underline-offset": [{
        "underline-offset": [ge, "auto", oe, ne]
      }],
      /**
       * Text Transform
...
function Jt({
  ...
  return /* @__PURE__ */ m(
    ...
    {
      "data-slot": "button",
      className: he(Ks({ variant: t, size: n, className: e })),
      ...r
    },
    void 0,
    !1,
...
function $b({
  ...
  return /* @__PURE__ */ m(
    qg,
    {
      ...
      classNames: {
        root: he("w-fit", l.root),
        months: he(
          "flex gap-4 flex-col md:flex-row relative",
          l.months
        ),
        month: he("flex flex-col w-full gap-4", l.month),
        nav: he(
        ...
        weekdays: he("flex", l.weekdays),
        weekday: he(
          "text-muted-foreground rounded-md flex-1 font-normal text-[0.8rem] select-none",
          l.weekday
        ),
        week: he("flex w-full mt-2", l.week),
        week_number_header: he(
        ...
        range_middle: he("rounded-none", l.range_middle),
        range_end: he("rounded-r-md bg-accent", l.range_end),
        today: he(
      ...
      components: {
        ...
        Chevron: ({ className: c, orientation: u, ...d }) => u === "left" ? /* @__PURE__ */ m(xm, { className: he("size-4", c), ...d }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/calendar.tsx",
          lineNumber: 139,
          columnNumber: 15
          ...
          this
        ) : /* @__PURE__ */ m(Em, { className: he("size-4", c), ...d }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/ui/calendar.tsx",
          lineNumber: 153,
          columnNumber: 13
        }, this),
...
function Fb({
  ...
  return /* @__PURE__ */ m(
    ...
    {
      ref: s,
      className: he("date-picker-portal", t === "dark" ? "dark" : ""),
      "data-theme": t,
      style: {
        position: "fixed",
        top: n.top,
...
function zb(e, t, n) {
  ...
  const v = cf(b);
  _n = { container: b, root: v, pillDate: t };
  const N = () => {
    hr();
  }, C = (y) => {
    const k = Sc.get(t);
...
function Ub({ node: e, updateAttributes: t, selected: n }) {
  const o = V(null), r = e.attrs.date || $n(), s = Dc(r), a = Pi(r), i = U(() => {
    if (!o.current) return "";
  ...
  return Q(() => (Sc.set(r, (l) => {
    ...
    const c = (u) => {
      ...
      const d = l.getAttribute("data-date") || $n(), f = i();
      zb(l, d, f);
    };
  ...
  }, []), /* @__PURE__ */ m(zn, { as: "span", className: "inline", children: /* @__PURE__ */ m(
    "span",
    {
      ref: o,
...
function dn(e) {
  ...
  if (n === "today") return $n();
  if (n === "tomorrow") return wo(1);
  if (n === "yesterday") return wo(-1);
  if (n === "next monday") {
  ...
  addInputRules() {
    const e = new Xe({
      ...
      handler: ({ range: u, chain: d }) => {
        d().deleteRange(u).insertDatePill($n()).run();
      }
    }), t = new Xe({
      find: /@tomorrow\s$/,
      handler: ({ range: u, chain: d }) => {
        d().deleteRange(u).insertDatePill(wo(1)).run();
      }
    }), n = new Xe({
      find: /@yesterday\s$/,
      handler: ({ range: u, chain: d }) => {
      ...
      handler: ({ range: u, chain: d, match: f }) => {
        ...
        if (p !== void 0) {
          ...
          d().deleteRange(u).insertDatePill(Bn(b)).run();
        }
      }
    }), s = new Xe({
...
function Vb({ node: e, selected: t, editor: n, getPos: o, deleteNode: r }) {
  const s = V(null), a = V(null), i = e.attrs.tag || "", l = V(!1), [c, u] = K(() => lt.has(i)), [d, f] = K(() => lt.get(i)?.value ?? i);
  Q(() => {
    c || f(i);
  }, [i, c]), Q(() => {
    if (c) {
  ...
  const h = U((v) => {
    if (l.current) return;
    l.current = !0;
    const N = v.trim().replace(/^#/, ""), C = No(N);
    if (lt.delete(i), C && lt.delete(C), !C || !Rn(C))
      r();
    else if (C !== i) {
      const y = o();
    ...
    n && !n.isEditable || (lt.set(i, { value: i, focusedAt: Date.now() }), f(i), u(!0), l.current = !1);
  }, [n, i]);
  Q(() => {
    const v = s.current;
    if (!v || c) return;
  ...
  const g = U((v) => {
    v.key === "Enter" ? (v.preventDefault(), h(d)) : v.key === "Escape" && (v.preventDefault(), lt.delete(i), u(!1), l.current = !0, n?.commands.focus());
  }, [h, d, i, n]), b = U(() => {
    const N = lt.get(i)?.focusedAt ?? 0;
    Date.now() - N > 300 && h(d);
  }, [h, d, i]), w = U((v) => {
    f(v.target.value);
  }, []);
  return c ? /* @__PURE__ */ m(zn, { as: "span", className: "inline", children: /* @__PURE__ */ m(
    "span",
    {
      ref: s,
    ...
    lineNumber: 170,
    columnNumber: 7
  }, this) : /* @__PURE__ */ m(zn, { as: "span", className: "inline", children: /* @__PURE__ */ m(
    "span",
    {
      ref: s,
        ...
        /* @__PURE__ */ m("div", { className: "image-url-dialog-header", children: [
          ...
          /* @__PURE__ */ m(
            "button",
            {
              ...
              "aria-label": "Close",
              children: /* @__PURE__ */ m($t, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageURLDialog.tsx",
                lineNumber: 156,
                columnNumber: 11
              }, this)
...
function tv({ editor: e }) {
  ...
  Pr(() => {
    ...
    let F;
    if (L >= N ? F = "below" : $ >= N ? F = "above" : F = L >= $ ? "below" : "above", p(F), g.current) {
      const q = Math.max(
        tr,
        Math.min(D, I - ev - tr)
      ), R = F === "below" ? M + 4 : T - N - 4;
  ...
  const C = U(() => {
    ...
    if (A >= 0 && A <= D)
      ...
      if ($ !== -1) {
        const F = I.pos - (I.parentOffset - $);
        e.chain().focus().deleteRange({ from: F, to: I.pos }).run();
      }
    }
  }, [e]), y = U(() => {
...
`)) {
    ...
    this
  ) : !t || v.length === 0 ? null : /* @__PURE__ */ m(Ft, { children: /* @__PURE__ */ m(
    "div",
    {
      ref: g,
...
function iv({ editor: e, onSearch: t, onCreateItem: n }) {
  ...
  const y = U(() => {
    ...
    try {
      const $ = I.tr.delete(A, L), F = I.schema.marks.wikiLink;
      if (F) {
        const q = F.create({ pageName: D }), R = I.schema.text(D, [q]);
        $.insert(A, R);
        const P = A + D.length;
        $.setSelection(wt.create($.doc, P)), $.removeStoredMark(F);
      } else
        $.insertText(`[[${D}]]`, A);
...
`) || $.includes("]]")) {
  ...
  if (Pr(() => {
    if (!o || !d) return;
    const { top: D, bottom: A, left: I } = d, L = window.innerHeight, $ = window.innerWidth, F = L - A - nr, q = D - nr;
    let R;
    if (F >= x ? R = "below" : q >= x ? R = "above" : R = F >= q ? "below" : "above", p(R), v.current) {
      const P = Math.max(
        nr,
        Math.min(I, $ - nv - nr)
      ), z = R === "below" ? A + 4 : D - x - 4;
  ...
  return /* @__PURE__ */ m(Ft, { children: /* @__PURE__ */ m(
    "div",
    {
      ref: v,
...
var tn = globalThis?.document ? E.useLayoutEffect : () => {
}, lv = E[" useInsertionEffect ".trim().toString()] || tn;
function Ri({
  prop: e,
  defaultProp: t,
  onChange: n = () => {
...
var dv = [
  ...
  const n = /* @__PURE__ */ xo(`Primitive.${t}`), o = E.forwardRef((r, s) => {
...
function Rc(e) {
  const t = e + "CollectionProvider", [n, o] = Jn(t), [r, s] = n(
    t,
  ...
  a.displayName = t;
  const i = e + "CollectionSlot", l = /* @__PURE__ */ xo(i), c = J.forwardRef(
    (g, b) => {
  ...
  c.displayName = i;
  const u = e + "CollectionItemSlot", d = "data-radix-collection-item", f = /* @__PURE__ */ xo(u), h = J.forwardRef(
    (g, b) => {
...
var ys = "focusScope.autoFocusOnMount", ks = "focusScope.autoFocusOnUnmount", ja = { bubbles: !1, cancelable: !0 }, kv = "FocusScope", _c = E.forwardRef((e, t) => {
  const {
    ...
    ...a
  } = e, [i, l] = E.useState(null), c = Bt(r), u = Bt(s), d = E.useRef(null), f = Ye(t, (g) => l(g)), h = E.useRef({
    paused: !1,
    pause() {
      this.paused = !0;
    },
  ...
  E.useEffect(() => {
    if (o) {
      let g = function(N) {
        ...
        const C = N.target;
        i.contains(C) ? d.current = C : Qt(d.current, { select: !0 });
      }, b = function(N) {
        if (h.paused || !i) return;
        const C = N.relatedTarget;
        C !== null && (i.contains(C) || Qt(d.current, { select: !0 }));
      }, w = function(N) {
        if (document.activeElement === document.body)
          for (const y of N)
            y.removedNodes.length > 0 && Qt(i);
      };
    ...
    if (i) {
      ...
      if (!i.contains(g)) {
        ...
        i.addEventListener(ys, c), i.dispatchEvent(w), w.defaultPrevented || (xv(Sv($c(i)), { select: !0 }), document.activeElement === g && Qt(i));
      }
      return () => {
        i.removeEventListener(ys, c), setTimeout(() => {
          const w = new CustomEvent(ks, ja);
          i.addEventListener(ks, u), i.dispatchEvent(w), w.defaultPrevented || Qt(g ?? document.body, { select: !0 }), i.removeEventListener(ks, u), Va.remove(h);
        }, 0);
      };
    }
  }, [i, c, u, h]);
  const p = E.useCallback(
    (g) => {
      ...
      if (b && w) {
        ...
        N && C ? !g.shiftKey && w === C ? (g.preventDefault(), n && Qt(N, { select: !0 })) : g.shiftKey && w === N && (g.preventDefault(), n && Qt(C, { select: !0 })) : w === v && g.preventDefault();
      }
    },
    [n, o, h.paused]
  );
...
function xv(e, { select: t = !1 } = {}) {
  ...
  for (const o of e)
    if (Qt(o, { select: t }), document.activeElement !== n) return;
}
function Cv(e) {
...
const Pv = ["top", "right", "bottom", "left"], nn = Math.min, et = Math.max, Nr = Math.round, or = Math.floor, Nt = (e) => ({
  x: e,
  y: e
}), Rv = {
  left: "right",
...
function Za(e, t, n) {
  ...
  const s = vt(t), a = _i(t), i = Oi(a), l = Wt(t), c = s === "y", u = o.x + o.width / 2 - r.width / 2, d = o.y + o.height / 2 - r.height / 2, f = o[i] / 2 - r[i] / 2;
  let h;
  switch (l) {
    case "top":
      h = {
...
async function Co(e, t) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: h = 0
  } = Ht(t, e), p = Bc(h), b = i[f ? d === "floating" ? "reference" : "floating" : d], w = kr(await s.getClippingRect({
...
const Uv = (e) => ({
  ...
  async fn(t) {
    ...
    const x = C / 2 - y / 2, T = S / 2 - g[p] / 2 - 1, M = nn(d[w], T), D = nn(d[v], T), A = M, I = S - g[p] - D, L = S / 2 - g[p] / 2 + x, $ = Gs(A, L, I), F = !l.arrow && eo(r) != null && L !== $ && s.reference[p] / 2 - (L < A ? M : D) - g[p] / 2 < 0, q = F ? L < A ? L - A : L - I : 0;
    return {
      [h]: f[h] + q,
      data: {
        [h]: $,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      if ((n = s.arrow) != null && n.alignmentOffset)
        return {};
      const w = Wt(r), v = vt(i), N = Wt(i) === i, C = await (l.isRTL == null ? void 0 : l.isRTL(c.floating)), y = f || (N || !g ? [yr(i)] : _v(i)), k = p !== "none";
      !f && k && y.push(...Wv(i, g, p, C));
      const S = [i, ...y], x = await Co(t, b), T = [];
      ...
      if (M = [...M, {
        ...
        if ($ && (!(d === "alignment" ? v !== vt($) : !1) || // We leave the current main axis only if every placement on that axis
        // overflows the main axis.
        M.every((R) => vt(R.placement) === v ? R.overflows[0] > 0 : !0)))
          return {
            data: {
              index: L,
              overflows: M
        ...
        let F = (A = M.filter((q) => q.overflows[0] <= 0).sort((q, R) => q.overflows[1] - R.overflows[1])[0]) == null ? void 0 : A.placement;
        if (!F)
          switch (h) {
            case "bestFit": {
              var I;
...
async function Kv(e, t) {
  const {
    ...
    platform: o,
    elements: r
  } = e, s = await (o.isRTL == null ? void 0 : o.isRTL(r.floating)), a = Wt(n), i = eo(n), l = vt(n) === "y", c = Hc.has(a) ? -1 : 1, u = s && l ? -1 : 1, d = Ht(t, e);
  let {
    mainAxis: f,
    crossAxis: h,
    alignmentAxis: p
...
const Vv = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      const {
        ...
        x: n,
        y: o
      }, u = await Co(t, l), d = vt(Wt(r)), f = Li(d);
      let h = c[f], p = c[d];
      if (s) {
  ...
  return e === void 0 && (e = {}), {
    ...
    fn(t) {
      ...
      let h = u[f], p = u[d];
      const g = Ht(i, t), b = typeof g == "number" ? {
        mainAxis: g,
        crossAxis: 0
      } : {
        mainAxis: 0,
      ...
      if (c) {
        var w, v;
        const N = f === "y" ? "width" : "height", C = Hc.has(Wt(r)), y = s.reference[d] - s.floating[N] + (C && ((w = a.offset) == null ? void 0 : w[d]) || 0) + (C ? 0 : b.crossAxis), k = s.reference[d] + s.reference[N] + (C ? 0 : ((v = a.offset) == null ? void 0 : v[d]) || 0) - (C ? b.crossAxis : 0);
        p < y ? p = y : p > k && (p = k);
      }
      return {
        [f]: h,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      const {
        ...
        ...c
      } = Ht(e, t), u = await Co(t, c), d = Wt(r), f = eo(r), h = vt(r) === "y", {
        width: p,
        height: g
      } = s.floating;
      let b, w;
      d === "top" || d === "bottom" ? (b = d, w = f === (await (a.isRTL == null ? void 0 : a.isRTL(i.floating)) ? "start" : "end") ? "left" : "right") : (w = d, b = f === "end" ? "top" : "bottom");
      const v = g - u.top - u.bottom, N = p - u.left - u.right, C = nn(g - u[b], v), y = nn(p - u[w], N), k = !t.middlewareData.shift;
      let S = C, x = y;
...
function Fc(e) {
  const t = on(e);
  return Yn(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : yt(t) && Ro(t) ? t : Fc(t);
}
function Eo(e, t, n) {
  var o;
  ...
  if (s) {
    const i = Xs(a);
    return t.concat(a, a.visualViewport || [], Ro(r) ? r : [], i && n ? Eo(i) : []);
  }
  return t.concat(r, Eo(r, [], n));
}
function Xs(e) {
...
function zc(e) {
  ...
  const r = yt(e), s = r ? e.offsetWidth : n, a = r ? e.offsetHeight : o, i = Nr(n) !== s || Nr(o) !== a;
  return i && (n = s, o = a), {
    width: n,
    height: o,
    $: i
...
function pn(e, t, n, o) {
  ...
  let a = Nt(1);
  t && (o ? ut(o) && (a = Hn(o)) : a = Hn(e));
  const i = aw(s, n, o) ? Uc(s) : Nt(0);
  let l = (r.left + i.x) / a.x, c = (r.top + i.y) / a.y, u = r.width / a.x, d = r.height / a.y;
  if (s) {
    const f = tt(s), h = o && ut(o) ? tt(o) : o;
    let p = f, g = Xs(p);
    for (; g && o && h !== p; ) {
      const b = Hn(g), w = g.getBoundingClientRect(), v = dt(g), N = w.left + (g.clientLeft + parseFloat(v.paddingLeft)) * b.x, C = w.top + (g.clientTop + parseFloat(v.paddingTop)) * b.y;
...
function lw(e) {
  ...
  const s = r === "fixed", a = xt(o), i = t ? Hr(t.floating) : !1;
  if (o === a || i && s)
    return n;
  let l = {
    scrollLeft: 0,
  ...
  const u = Nt(0), d = yt(o);
  if ((d || !d && !s) && ((to(o) !== "body" || Ro(a)) && (l = Wr(o)), yt(o))) {
    const h = pn(o);
    c = Hn(o), u.x = h.x + o.clientLeft, u.y = h.y + o.clientTop;
  }
  const f = a && !d && !s ? Yc(a, l) : Nt(0);
  return {
    width: n.width * c.x,
    height: n.height * c.y,
...
function uw(e) {
  const t = xt(e), n = Wr(e), o = e.ownerDocument.body, r = et(t.scrollWidth, t.clientWidth, o.scrollWidth, o.clientWidth), s = et(t.scrollHeight, t.clientHeight, o.scrollHeight, o.clientHeight);
  let a = -n.scrollLeft + Fr(e);
  const i = -n.scrollTop;
  return dt(o).direction === "rtl" && (a += et(t.clientWidth, o.clientWidth) - r), {
    width: r,
    height: s,
    x: a,
    y: i
...
const tl = 25;
function dw(e, t) {
  const n = tt(e), o = xt(e), r = n.visualViewport;
...
function fw(e, t) {
  const n = pn(e, !0, t === "fixed"), o = n.top + e.clientTop, r = n.left + e.clientLeft, s = yt(e) ? Hn(e) : Nt(1), a = e.clientWidth * s.x, i = e.clientHeight * s.y, l = r * s.x, c = o * s.y;
  return {
    width: a,
    height: i,
    x: l,
...
function jc(e, t) {
  const n = on(e);
  return n === t || !ut(n) || Yn(n) ? !1 : dt(n).position === "fixed" || jc(n, t);
}
function hw(e, t) {
  const n = t.get(e);
  if (n)
    return n;
  let o = Eo(e, [], !1).filter((i) => ut(i) && to(i) !== "body"), r = null;
  const s = dt(e).position === "fixed";
  let a = s ? on(e) : e;
  for (; ut(a) && !Yn(a); ) {
    const i = dt(a), l = $i(a);
    !l && i.position === "fixed" && (r = null), (s ? !l && !r : !l && i.position === "static" && !!r && mw.has(r.position) || Ro(a) && !l && jc(e, a)) ? o = o.filter((u) => u !== a) : r = i, a = on(a);
  }
  return t.set(e, o), o;
}
function pw(e) {
  ...
  const a = [...n === "clippingAncestors" ? Hr(t) ? [] : hw(t, this._c) : [].concat(n), o], i = a[0], l = a.reduce((c, u) => {
    const d = nl(t, u, r);
    return c.top = et(d.top, c.top), c.right = nn(d.right, c.right), c.bottom = nn(d.bottom, c.bottom), c.left = et(d.left, c.left), c;
  }, nl(t, i, r));
  return {
...
function bw(e, t, n) {
  const o = yt(t), r = xt(t), s = n === "fixed", a = pn(e, !0, s, t);
  let i = {
    scrollLeft: 0,
    scrollTop: 0
  };
  ...
  if (o || !o && !s)
    if ((to(t) !== "body" || Ro(r)) && (i = Wr(t)), o) {
      const h = pn(t, !0, s, t);
      l.x = h.x + t.clientLeft, l.y = h.y + t.clientTop;
    } else r && c();
  s && !o && r && c();
  const u = r && !o && !s ? Yc(r, i) : Nt(0), d = a.left + i.scrollLeft - l.x - u.x, f = a.top + i.scrollTop - l.y - u.y;
  return {
    x: d,
    y: f,
    width: a.width,
...
function Kc(e, t) {
  ...
  for (; o && Jv(o) && xs(o); )
    o = ol(o, t);
  return o && Yn(o) && xs(o) && !$i(o) ? n : o || rw(e) || n;
}
...
function Rw(e) {
  ...
  const $ = E.useMemo(() => ({
    ...
    if (!F.floating)
      return R;
    const P = sl(F.floating, u.x), z = sl(F.floating, u.y);
    return i ? {
      ...R,
...
var Wi = "Popper", [Xc, zr] = Jn(Wi), [Yw, Zc] = Xc(Wi), Qc = (e) => {
...
var Fi = "PopperContent", [jw, Kw] = Xc(Fi), tu = E.forwardRef(
  (e, t) => {
    const {
      ...
      altBoundary: A
    }, { refs: L, floatingStyles: $, placement: F, isPositioned: q, middlewareData: R } = Rw({
      ...
      middleware: [
        ...
        Bw({
          ...I,
          apply: ({ elements: j, rects: ee, availableWidth: be, availableHeight: ve }) => {
            const { width: Pe, height: He } = ee.reference, ot = j.floating.style;
            ot.setProperty("--radix-popper-available-width", `${be}px`), ot.setProperty("--radix-popper-available-height", `${ve}px`), ot.setProperty("--radix-popper-anchor-width", `${Pe}px`), ot.setProperty("--radix-popper-anchor-height", `${He}px`);
          }
        }),
...
var Es = "rovingFocusGroup.onEntryFocus", eN = { bubbles: !1, cancelable: !0 }, Io = "RovingFocusGroup", [Zs, cu, tN] = Rc(Io), [nN, uu] = Jn(
  Io,
  [tN]
), [oN, rN] = nN(Io), du = E.forwardRef(
...
var sN = E.forwardRef((e, t) => {
  const {
    ...
    onChange: l,
    caller: Io
  }), [w, v] = E.useState(!1), N = Bt(c), C = cu(n), y = E.useRef(!1), [k, S] = E.useState(0);
  return E.useEffect(() => {
    const x = f.current;
    if (x)
      ...
      Zs.ItemSlot,
      {
        ...
        children: /* @__PURE__ */ Y(
          ze.span,
          {
            ...
            ...i,
            ref: t,
            onMouseDown: pe(e.onMouseDown, (b) => {
              o ? u.onItemFocus(c) : b.preventDefault();
            }),
            onFocus: pe(e.onFocus, () => u.onItemFocus(c)),
            onKeyDown: pe(e.onKeyDown, (b) => {
...
var uN = du, dN = fu, mN = function(e) {
...
}, Mn = /* @__PURE__ */ new WeakMap(), sr = /* @__PURE__ */ new WeakMap(), ir = {}, Ts = 0, pu = function(e) {
  ...
  var u = function(d) {
    !d || l.has(d) || Array.prototype.forEach.call(d.children, function(f) {
      if (i.has(f))
        ...
        try {
          var h = f.getAttribute(o), p = h !== null && h !== "false", g = (Mn.get(f) || 0) + 1, b = (s.get(f) || 0) + 1;
          Mn.set(f, g), s.set(f, b), a.push(f), g === 1 && p && sr.set(f, !0), b === 1 && f.setAttribute(n, "true"), p || f.setAttribute(o, "true");
        } catch (w) {
  ...
  return u(t), i.clear(), Ts++, function() {
    a.forEach(function(d) {
      var f = Mn.get(d) - 1, h = s.get(d) - 1;
      Mn.set(d, f), s.set(d, h), f || (sr.has(d) || d.removeAttribute(o), sr.delete(d)), h || d.removeAttribute(n);
    }), Ts--, Ts || (Mn = /* @__PURE__ */ new WeakMap(), Mn = /* @__PURE__ */ new WeakMap(), sr = /* @__PURE__ */ new WeakMap(), ir = {});
  };
}, pN = function(e, t, n) {
...
var vu = CN(), Ss = function() {
  ...
  return E.createElement(
    ...
    a ? E.cloneElement(E.Children.only(i), gt(gt({}, S), { ref: k })) : E.createElement(v, gt({}, S, { className: l, ref: k }), i)
  );
});
Ur.defaultProps = {
  enabled: !0,
...
}, ON = wu(), Wn = "data-scroll-locked", _N = function(e, t, n, o) {
...
`);
  ...
  E.useEffect(function() {
    return document.body.setAttribute(Wn, (al() + 1).toString()), function() {
      var e = al() - 1;
...
var Sn = Qs ? { passive: !1 } : !1, HN = function(e) {
...
var xu = E.forwardRef(function(e, t) {
  return E.createElement(Ur, gt({}, e, { ref: t, sideCar: ZN }));
});
...
var Js = ["Enter", " "], QN = ["ArrowDown", "PageUp", "Home"], Cu = ["ArrowUp", "PageDown", "End"], JN = [...QN, ...Cu], e0 = {
  ...
  ltr: ["ArrowLeft"],
  rtl: ["ArrowRight"]
}, Lo = "Menu", [To, n0, o0] = Rc(Lo), [bn, Eu] = Jn(Lo, [
  o0,
  zr,
  uu
]), Yr = zr(), Tu = uu(), [r0, vn] = bn(Lo), [s0, Oo] = bn(Lo), Mu = (e) => {
  const { __scopeMenu: t, open: n = !1, children: o, dir: r, onOpenChange: s, modal: a = !0 } = e, i = Yr(t), [l, c] = E.useState(null), u = E.useRef(!1), d = Bt(s), f = Ic(r);
  return E.useEffect(() => {
    const h = () => {
...
Ui.displayName = i0;
var Yi = "MenuPortal", [a0, Su] = bn(Yi, {
  forceMount: void 0
}), Du = (e) => {
  const { __scopeMenu: t, forceMount: n, children: o, container: r } = e, s = vn(Yi, t);
  return /* @__PURE__ */ Y(a0, { scope: t, forceMount: n, children: /* @__PURE__ */ Y(gn, { present: n || s.open, children: /* @__PURE__ */ Y(zi, { asChild: !0, container: r, children: o }) }) });
};
Du.displayName = Yi;
var it = "MenuContent", [l0, ji] = bn(it), Au = E.forwardRef(
  (e, t) => {
    const n = Su(it, e.__scopeMenu), { forceMount: o = n.forceMount, ...r } = e, s = vn(it, e.__scopeMenu), a = Oo(it, e.__scopeMenu);
    return /* @__PURE__ */ Y(To.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ Y(gn, { present: o || s.open, children: /* @__PURE__ */ Y(To.Slot, { scope: e.__scopeMenu, children: a.modal ? /* @__PURE__ */ Y(c0, { ...r, ref: t }) : /* @__PURE__ */ Y(u0, { ...r, ref: t }) }) }) });
  }
), c0 = E.forwardRef(
  (e, t) => {
    const n = vn(it, e.__scopeMenu), o = E.useRef(null), r = Ye(t, o);
    return E.useEffect(() => {
      const s = o.current;
      if (s) return pN(s);
    }, []), /* @__PURE__ */ Y(
...
}), d0 = /* @__PURE__ */ xo("MenuContent.ScrollLock"), Ki = E.forwardRef(
  (e, t) => {
    const {
      __scopeMenu: n,
      loop: o = !1,
      ...
      ...g
    } = e, b = vn(it, n), w = Oo(it, n), v = Yr(n), N = Tu(n), C = n0(n), [y, k] = E.useState(null), S = E.useRef(null), x = Ye(t, S, b.onContentChange), T = E.useRef(0), M = E.useRef(""), D = E.useRef(0), A = E.useRef(null), I = E.useRef("right"), L = E.useRef(0), $ = p ? xu : E.Fragment, F = p ? { as: d0, allowPinchZoom: !0 } : void 0, q = (P) => {
    ...
    return /* @__PURE__ */ Y(
      l0,
      {
        ...
        children: /* @__PURE__ */ Y($, { ...F, children: /* @__PURE__ */ Y(
          _c,
          {
            asChild: !0,
            trapped: r,
...
var Cr = "MenuItem", dl = "menu.itemSelect", jr = E.forwardRef(
  (e, t) => {
    const { disabled: n = !1, onSelect: o, ...r } = e, s = E.useRef(null), a = Oo(Cr, e.__scopeMenu), i = ji(Cr, e.__scopeMenu), l = Ye(t, s), c = E.useRef(!1), u = () => {
      const d = s.current;
      if (!n && d) {
      ...
      To.ItemSlot,
      {
        ...
        children: /* @__PURE__ */ Y(dN, { asChild: !0, ...i, focusable: !o, children: /* @__PURE__ */ Y(
          ze.div,
          {
            ...
            onPointerLeave: pe(
              e.onPointerLeave,
              Mo((p) => a.onItemLeave(p))
            ),
            onFocus: pe(e.onFocus, () => d(!0)),
            onBlur: pe(e.onBlur, () => d(!1))
          }
        ) })
      }
    );
...
Iu.displayName = h0;
var Lu = "MenuRadioGroup", [p0, g0] = bn(
  Lu,
...
$u.displayName = _u;
var Gi = "MenuItemIndicator", [Bu, b0] = bn(
  Gi,
  { checked: !1 }
), Hu = E.forwardRef(
  (e, t) => {
...
Fu.displayName = w0;
var N0 = "MenuSub", [d1, zu] = bn(N0), go = "MenuSubTrigger", Uu = E.forwardRef(
  (e, t) => {
    const n = vn(go, e.__scopeMenu), o = Oo(go, e.__scopeMenu), r = zu(go, e.__scopeMenu), s = ji(go, e.__scopeMenu), a = E.useRef(null), { pointerGraceTimerRef: i, onPointerGraceIntentChange: l } = s, c = { __scopeMenu: e.__scopeMenu }, u = E.useCallback(() => {
...
var Yu = "MenuSubContent", ju = E.forwardRef(
  (e, t) => {
    const n = Su(it, e.__scopeMenu), { forceMount: o = n.forceMount, ...r } = e, s = vn(it, e.__scopeMenu), a = Oo(it, e.__scopeMenu), i = zu(Yu, e.__scopeMenu), l = E.useRef(null), c = Ye(t, l);
    return /* @__PURE__ */ Y(To.Provider, { scope: e.__scopeMenu, children: /* @__PURE__ */ Y(gn, { present: o || s.open, children: /* @__PURE__ */ Y(To.Slot, { scope: e.__scopeMenu, children: /* @__PURE__ */ Y(
      Ki,
      {
        id: i.contentId,
        ...
        onFocusOutside: pe(e.onFocusOutside, (u) => {
          u.target !== i.trigger && s.onOpenChange(!1);
        }),
        onEscapeKeyDown: pe(e.onEscapeKeyDown, (u) => {
          a.onClose(), u.preventDefault();
        }),
        onKeyDown: pe(e.onKeyDown, (u) => {
...
var T0 = Mu, M0 = Ui, S0 = Du, D0 = Au, A0 = Vi, P0 = Pu, R0 = jr, I0 = Iu, L0 = Ou, O0 = $u, _0 = Hu, $0 = Wu, B0 = Fu, H0 = Uu, W0 = ju, Kr = "DropdownMenu", [F0] = Jn(
  Kr,
  [Eu]
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ Y(M0, { asChild: !0, ...a, children: /* @__PURE__ */ Y(
      ze.button,
      {
        ...
        onPointerDown: pe(e.onPointerDown, (i) => {
  ...
  (e, t) => {
    ...
    return /* @__PURE__ */ Y(
      D0,
      {
        ...
        onInteractOutside: pe(e.onInteractOutside, (i) => {
...
function Is({
  ...
  return /* @__PURE__ */ m(
    py,
    {
      ...
      className: he("bg-border -mx-1 my-1 h-px", e),
      ...t
    },
    void 0,
    !1,
...
rd.displayName = od;
var So = "Tooltip", [yy, _o] = Vr(So), sd = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: o,
    ...
    delayDuration: i
  } = e, l = Xi(So, e.__scopeTooltip), c = Gr(t), [u, d] = E.useState(null), f = wr(), h = E.useRef(0), p = a ?? l.disableHoverableContent, g = i ?? l.delayDuration, b = E.useRef(!1), [w, v] = Ri({
    prop: o,
    defaultProp: r ?? !1,
    onChange: (S) => {
...
var ti = "TooltipTrigger", id = E.forwardRef(
  (e, t) => {
    const { __scopeTooltip: n, ...o } = e, r = _o(ti, n), s = Xi(ti, n), a = Gr(n), i = E.useRef(null), l = Ye(t, i, r.onTriggerChange), c = E.useRef(!1), u = E.useRef(!1), d = E.useCallback(() => c.current = !1, []);
    return E.useEffect(() => () => document.removeEventListener("pointerup", d), [d]), /* @__PURE__ */ Y(iu, { asChild: !0, ...a, children: /* @__PURE__ */ Y(
      ze.button,
      {
        ...
        onBlur: pe(e.onBlur, r.onClose),
        onClick: pe(e.onClick, r.onClose)
      }
    ) });
  }
);
...
var Zi = "TooltipPortal", [ky, xy] = Vr(Zi, {
  ...
  const { __scopeTooltip: t, forceMount: n, children: o, container: r } = e, s = _o(Zi, t);
  return /* @__PURE__ */ Y(ky, { scope: t, forceMount: n, children: /* @__PURE__ */ Y(gn, { present: n || s.open, children: /* @__PURE__ */ Y(zi, { asChild: !0, container: r, children: o }) }) });
};
ad.displayName = Zi;
var jn = "TooltipContent", ld = E.forwardRef(
  (e, t) => {
    const n = xy(jn, e.__scopeTooltip), { forceMount: o = n.forceMount, side: r = "top", ...s } = e, a = _o(jn, e.__scopeTooltip);
    return /* @__PURE__ */ Y(gn, { present: o || a.open, children: a.disableHoverableContent ? /* @__PURE__ */ Y(cd, { side: r, ...s, ref: t }) : /* @__PURE__ */ Y(Cy, { side: r, ...s, ref: t }) });
  }
), Cy = E.forwardRef((e, t) => {
  const n = _o(jn, e.__scopeTooltip), o = Xi(jn, e.__scopeTooltip), r = E.useRef(null), s = Ye(t, r), [a, i] = E.useState(null), { trigger: l, onClose: c } = n, u = r.current, { onPointerInTransitChange: d } = o, f = E.useCallback(() => {
    i(null), d(!1);
  }, [d]), h = E.useCallback(
    (p, g) => {
...
}), [Ey, Ty] = Vr(So, { isInside: !1 }), My = /* @__PURE__ */ Rb("TooltipContent"), cd = E.forwardRef(
  (e, t) => {
    const {
      __scopeTooltip: n,
      children: o,
      ...
      ...i
    } = e, l = _o(jn, n), c = Gr(n), { onClose: u } = l;
...
const Le = ({ onClick: e, isActive: t, disabled: n, children: o, tooltip: r }) => {
  ...
  lineNumber: 132,
  columnNumber: 3
}, void 0), Fy = Vn(function({ editor: t, onCopyMarkdown: n, onOpenLinkPopover: o, className: r = "", autoReorderChecklist: s = !1, aiEnabled: a = !1, onAISparklesClick: i }) {
  const l = V(null), [c, u] = K(!1), [d, f] = K(void 0), h = Cl({
    ...
    v.current.clear(), D.forEach((I, L) => {
      I.querySelectorAll(":scope > li").forEach((F) => {
        const q = F, R = (q.textContent || "").trim().substring(0, 50);
    ...
    T && (k.view.dispatch(x), requestAnimationFrame(() => {
      k.view.dom.querySelectorAll('ul[data-type="taskList"], ul:not([data-type]), ol').forEach((L) => {
        const $ = L.querySelectorAll(":scope > li"), F = /* @__PURE__ */ new Map();
        v.current.forEach((q, R) => {
          const P = R.replace(/^\d+-/, "");
          F.set(P, q);
        }), $.forEach((q) => {
          const R = q, P = (R.textContent || "").trim().substring(0, 50), z = F.get(P);
          if (!z) return;
      ...
      /* @__PURE__ */ m(Ps, { asChild: !0, children: /* @__PURE__ */ m(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ m(en, { size: 12, strokeWidth: 2.5, className: "flex-shrink-0" }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
              lineNumber: 466,
              columnNumber: 13
            }, this)
      ...
      /* @__PURE__ */ m(Rs, { align: "start", className: "w-56", children: [
        ...
        /* @__PURE__ */ m(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ m(Ln, { size: 16, className: "mr-2 text-destructive" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 660,
                columnNumber: 15
              }, this),
        ...
        /* @__PURE__ */ m(
          Ie,
          {
            ...
            children: [
              /* @__PURE__ */ m(Ln, { size: 16, className: "mr-2" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
                lineNumber: 701,
                columnNumber: 15
              }, this),
    ...
    n && /* @__PURE__ */ m(ni, { children: [
      /* @__PURE__ */ m(oi, { asChild: !0, children: /* @__PURE__ */ m(
        Jt,
        {
          ...
          onClick: n,
          children: [
            /* @__PURE__ */ m(qn, { size: 16 }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorToolbar.tsx",
              lineNumber: 767,
              columnNumber: 15
            }, this),
...
function zy({ editor: e, isOpen: t, onClose: n, focusTrigger: o = 0, initialSearchQuery: r, editorMode: s = "wysiwyg", rawMarkdown: a = "", onRawMarkdownChange: i, onMatchesChange: l }) {
  const c = s === "markdown", [u, d] = K(""), [f, h] = K(""), [p, g] = K(!1), [b, w] = K(!1), [v, N] = K(!1), [C, y] = K(!1), [k, S] = K([]), [x, T] = K(0), [M, D] = K(null), [A, I] = K(!1), L = V(!1), $ = V(null), F = V(null), q = V(!1);
  Q(() => {
    t && r && r.trim() && d(r);
  }, [t, r, o]);
  const R = U(() => {
    ...
    if (c) {
      ...
      j.descendants((ee, be) => {
        if (ee.isText && ee.text) {
          let ve;
          for (; (ve = H.exec(ee.text)) !== null; )
            _.push({
              from: be + ve.index,
              to: be + ve.index + ve[0].length,
              text: ve[0]
            });
        }
        return !0;
  ...
  Q(() => {
    ...
    if (k.length > 0 && x < k.length) {
      ...
      if (c) {
        ...
        if (j && q.current) {
          const ee = parseInt(getComputedStyle(j).lineHeight) || 22, ve = a.substring(0, _.from).split(`
`).length;
  ...
  const P = U(() => {
    ...
    if (c && i) {
      const H = [...k].sort((ee, be) => be.from - ee.from);
      let j = a;
      H.forEach((ee) => {
        ...
        /* @__PURE__ */ m("div", { className: "find-replace-row", children: [
          ...
          /* @__PURE__ */ m(
            "button",
            {
              ...
              children: /* @__PURE__ */ m(en, { size: 16 }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/FindReplace.tsx",
                lineNumber: 418,
                columnNumber: 11
              }, this)
...
const Uy = typeof navigator < "u" && /Mac|iPod|iPhone|iPad/.test(navigator.platform), Rt = Uy ? "⌘" : "Ctrl", Yy = ({ editor: e }) => {
    ...
    /* @__PURE__ */ m("div", { className: "select-all-action-bar-inner", children: [
      ...
      h && o < s && /* @__PURE__ */ m(Be, { children: [
        /* @__PURE__ */ m(
          "button",
          {
            ...
            title: `Select next occurrence (${Rt}+D)`,
        ...
        /* @__PURE__ */ m(
          "button",
          {
            ...
            title: `Select all remaining (${Rt}+Shift+L)`,
            children: "All"
          },
          void 0,
          !1,
      ...
      /* @__PURE__ */ m(
        "button",
        {
          ...
          title: `Bold all occurrences (${Rt}+B)`,
      ...
      /* @__PURE__ */ m(
        "button",
        {
          onClick: b,
          className: "select-all-action-bar-btn",
          title: `Italic all occurrences (${Rt}+I)`,
      ...
      /* @__PURE__ */ m(
        "button",
        {
          onClick: w,
          className: "select-all-action-bar-btn",
          title: `Underline all occurrences (${Rt}+U)`,
      ...
      /* @__PURE__ */ m(
        "button",
        {
          ...
          children: /* @__PURE__ */ m(Ln, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
            lineNumber: 216,
            columnNumber: 11
          }, void 0)
      ...
      /* @__PURE__ */ m(
        "button",
        {
          ...
          children: /* @__PURE__ */ m($t, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/SelectAllActionBar.tsx",
            lineNumber: 225,
            columnNumber: 11
          }, void 0)
    ...
    "div",
    {
      ...
      children: [
        ...
        e === "saved" && /* @__PURE__ */ m(Be, { children: [
          /* @__PURE__ */ m(Gn, { className: "w-3.5 h-3.5 text-emerald-500" }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/AutoSaveIndicator.tsx",
            lineNumber: 54,
            columnNumber: 11
          }, this),
        ...
        /* @__PURE__ */ m("div", { className: "flex items-center gap-3 flex-shrink-0", children: [
          ...
          /* @__PURE__ */ m(
            "button",
            {
              ...
              children: /* @__PURE__ */ m($t, { className: "w-5 h-5" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/RecoveryBanner.tsx",
                lineNumber: 43,
                columnNumber: 11
              }, this)
    ...
    if (c.type.name === "heading" && n.levels.includes(c.attrs.level)) {
      ...
      const p = st.widget(u + c.nodeSize - 1, () => {
        ...
        return w.className = `collapsible-heading-chevron ${f ? "collapsed" : "expanded"}`, w.setAttribute("data-heading-id", d), w.setAttribute("data-heading-level", String(c.attrs.level)), w.setAttribute("contenteditable", "false"), w.setAttribute("tabindex", "-1"), w.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>', w.title = f ? "Click to expand" : "Click to collapse", w.addEventListener("click", (v) => {
          ...
          w.classList.remove("collapsed", "expanded"), w.classList.add(N ? "expanded" : "collapsed"), w.title = N ? "Click to collapse" : "Click to expand", t.collapsedHeadings.has(d) ? t.collapsedHeadings.delete(d) : t.collapsedHeadings.add(d), Fn && Fn.dispatch(Fn.state.tr.setMeta("collapsibleHeading", { toggled: d }));
        }), b.appendChild(w), b;
...
}), uk = /\[([^\]]+)\]\(([^)]+)\)$/, dk = /^(https?:\/\/|www\.)[^\s]+$/i, mk = mt.create({
...
}), fk = ["info", "note", "prompt", "resources", "todo"], hk = mt.create({
            ...
            for (const u of fk)
              if (c === `\`\`\`${u}`) {
                ...
                if (h && p) {
                  ...
                  d.setSelection(wt.near(w)), t.dispatch(d);
                }
                return !0;
              }
            return !1;
...
}), ur = new Ke("searchHighlight"), pk = mt.create({
...
function dr(e, t, n) {
  ...
  if (c < r.doc.content.size) {
    ...
    u.nodeAfter && u.nodeAfter.isTextblock ? r.setSelection(wt.create(r.doc, c + 1)) : u.nodeAfter && r.setSelection(wt.near(r.doc.resolve(c)));
  } else {
    const d = o.schema.nodes.paragraph.create();
    r.insert(c, d), r.setSelection(wt.create(r.doc, c + 1));
  }
          ...
          handleDrop(n, o, r, s) {
            ...
            if (l) {
              const c = n.state.tr.setSelection(
                wt.near(n.state.doc.resolve(l.pos))
              );
              n.dispatch(c);
            }
            return i.forEach((c) => {
...
function Xk({
        ...
        /* @__PURE__ */ m("div", { className: "image-edit-popover-header", children: [
          ...
          /* @__PURE__ */ m(
            "button",
            {
              ...
              "aria-label": "Close",
              children: /* @__PURE__ */ m($t, { className: "w-4 h-4" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
                lineNumber: 146,
                columnNumber: 11
              }, this)
        ...
        /* @__PURE__ */ m("div", { className: "image-edit-popover-footer", children: [
          /* @__PURE__ */ m(
            "button",
            {
              ...
              title: "Delete image",
              children: /* @__PURE__ */ m(Ln, { className: "w-4 h-4" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
                lineNumber: 191,
                columnNumber: 11
              }, this)
          ...
          /* @__PURE__ */ m("div", { className: "image-edit-popover-actions", children: [
            ...
            /* @__PURE__ */ m(
              "button",
              {
                ...
                disabled: !a.trim(),
                children: [
                  /* @__PURE__ */ m(Gn, { className: "w-4 h-4" }, void 0, !1, {
                    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
                    lineNumber: 205,
                    columnNumber: 13
                  }, this),
  ...
  return /* @__PURE__ */ m(Ft, { children: g }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ImageEditPopover.tsx",
    lineNumber: 213,
    columnNumber: 10
  }, this);
...
`);
  ...
  if (!n || n.length === 0) {
    for (let l = 0; l < s.length; l++) {
      ...
      let f = a;
      for (const h of d)
        h.start > f && (r += hn(e.substring(f, h.start))), r += `<span class="${vl(h.type)}">${hn(h.content)}</span>`, f = h.end;
      f < u && (r += hn(e.substring(f, u))), l < s.length - 1 && (r += `
`), a = u + 1;
    }
    return r;
  }
  ...
  for (; a < n; ) {
    ...
    if (i) {
      ...
      for (; a < n && r.get(a)?.matchIdx === i.matchIdx; )
        a++;
      const c = hn(e.substring(l, a)), u = i.isCurrent ? "search-highlight search-highlight-current" : "search-highlight";
      o ? s += `<span class="${o}"><mark class="${u}">${c}</mark></span>` : s += `<mark class="${u}">${c}</mark>`;
    } else {
      const l = a;
      for (; a < n && !r.has(a); )
        a++;
      const c = hn(e.substring(l, a));
...
function Zk({
  ...
  Q(() => {
    ...
    const T = (M) => {
      ...
      if (!D) return;
      const { scrollTop: A, scrollHeight: I, clientHeight: L } = D, $ = A <= 0, F = A + L >= I - 1;
      (M.deltaY > 0 && !F || M.deltaY < 0 && !$) && (M.preventDefault(), D.scrollTop += M.deltaY);
    };
  ...
  const k = U((x) => {
    ...
    if (l) {
      ...
      if (x.key === "*" && !x.ctrlKey && !x.metaKey) {
        if (A[M - 1] === "*" && A[M], I) {
          x.preventDefault();
          const F = A.substring(M, D), q = A.substring(0, M) + "*" + F + "*" + A.substring(D);
      ...
      if (x.key === "_" && !x.ctrlKey && !x.metaKey) {
        if (I) {
          x.preventDefault();
          const $ = A.substring(M, D), F = A.substring(0, M) + "_" + $ + "_" + A.substring(D);
          f.current = { start: M + 1, end: D + 1 }, t(F);
          return;
        }
        if (A[M] === "_") {
          x.preventDefault(), f.current = { start: M + 1, end: M + 1 }, t(A.substring(0, M) + A.substring(M));
      ...
      if (x.key === "~" && !x.ctrlKey && !x.metaKey) {
        if (I) {
          x.preventDefault();
          const $ = A.substring(M, D), F = A.substring(0, M) + "~" + $ + "~" + A.substring(D);
          f.current = { start: M + 1, end: D + 1 }, t(F);
          return;
        }
        if (A[M] === "~") {
    ...
    if (x.key === "Tab")
      if (x.preventDefault(), x.shiftKey) {
        const L = A.substring(0, M), $ = A.substring(M, D), F = A.substring(D), R = L.lastIndexOf(`
  ...
  return /* @__PURE__ */ m("div", { ref: d, className: `syntax-highlighted-editor ${s}`, children: [
    /* @__PURE__ */ m(
      "div",
      {
        ...
        dangerouslySetInnerHTML: { __html: N || `<span class="md-placeholder">${hn(n)}</span>` },
        "aria-hidden": "true"
      },
      void 0,
      !1,
...
const Jk = Vn(function({
  ...
  Q(() => {
    ...
    const M = (D) => {
      ...
      if (c.current = D, l.current.push({ time: D, duration: A }), l.current.length > 120 && (l.current = l.current.slice(-120)), A > 16.67 && d.current++, S++, D - x >= 1e3) {
        T = S, S = 0, x = D;
        const I = l.current.slice(-60), L = I.length > 0 ? I.reduce((G, Z) => G + Z.duration, 0) / I.length : 0, $ = I.length > 0 ? Math.max(...I.map((G) => G.duration)) : 0, F = performance.memory, q = F ? F.usedJSHeapSize / (1024 * 1024) : 0, R = F ? F.jsHeapSizeLimit / (1024 * 1024) : 0, P = document.querySelectorAll("*").length, z = wl - f.current, X = si - h.current;
  ...
  const C = (S) => S >= 55 ? "#4ade80" : S >= 30 ? "#fbbf24" : "#f87171", y = (S) => S <= 16.67 ? "#4ade80" : S <= 33.33 ? "#fbbf24" : "#f87171", k = (S, x, T) => {
    const A = S.map((I, L) => {
      const $ = L / (S.length - 1) * 120, F = 24 - Math.min(I, x) / x * 24;
      return `${$},${F}`;
    }).join(" ");
  ...
  return /* @__PURE__ */ m("div", { className: "perf-profiler-overlay", children: [
    /* @__PURE__ */ m("div", { className: "perf-profiler-header", children: [
      ...
      /* @__PURE__ */ m("div", { className: "perf-profiler-actions", children: [
        ...
        /* @__PURE__ */ m("button", { onClick: v, title: "Close profiler", children: /* @__PURE__ */ m($t, { size: 12 }, void 0, !1, {
          fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/PerformanceProfiler.tsx",
          lineNumber: 249,
          columnNumber: 13
        }, this) }, void 0, !1, {
...
`);
  ...
  render() {
    if (this.state.hasError) {
      ...
      return /* @__PURE__ */ m("div", { className: he("flex-1 flex items-center justify-center p-6", this.props.className), children: /* @__PURE__ */ m("div", { className: "flex flex-col items-center max-w-md w-full text-center gap-4", children: [
        ...
        /* @__PURE__ */ m("div", { className: "flex flex-col gap-2 w-full max-w-xs", children: [
          ...
          s && this.props.onClearContent && /* @__PURE__ */ m(
            Jt,
            {
              ...
              children: [
                /* @__PURE__ */ m(Ln, { className: "w-4 h-4" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                  lineNumber: 176,
                  columnNumber: 19
                }, this),
        ...
        t && /* @__PURE__ */ m("div", { className: "w-full max-w-xs", children: [
          /* @__PURE__ */ m(
            "button",
            {
              ...
              children: [
                n ? /* @__PURE__ */ m(en, { className: "w-3 h-3" }, void 0, !1, {
                  fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                  lineNumber: 193,
                  columnNumber: 21
              ...
              /* @__PURE__ */ m(
                "button",
                {
                  ...
                  children: r ? /* @__PURE__ */ m(Be, { children: [
                    ...
                    /* @__PURE__ */ m(qn, { className: "w-3 h-3" }, void 0, !1, {
                      fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/EditorErrorBoundary.tsx",
                      lineNumber: 215,
                      columnNumber: 29
                    }, this),
...
function sx({ actions: e, scope: t, onAction: n, onClose: o, position: r }) {
  ...
  return /* @__PURE__ */ m(Ft, { onMouseDown: (b) => b.preventDefault(), children: g }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIDropdownMenu.tsx",
    lineNumber: 197,
    columnNumber: 5
  }, this);
...
function ix({
            ...
            /* @__PURE__ */ m("div", { className: "flex items-center justify-between px-3 py-2 border-b border-border bg-secondary/30", children: [
              ...
              /* @__PURE__ */ m(
                "button",
                {
                  ...
                  title: "Discard",
                  children: /* @__PURE__ */ m($t, { size: 14, className: "text-muted-foreground" }, void 0, !1, {
                    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
                    lineNumber: 184,
                    columnNumber: 13
                  }, this)
  ...
  return /* @__PURE__ */ m(Ft, { onMouseDown: (y) => y.preventDefault(), children: C }, void 0, !1, {
    fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/ai/AIResultPopover.tsx",
    lineNumber: 260,
    columnNumber: 5
  }, this);
...
const kl = Vn(function({
  ...
  const [v, N] = K([]), [C, y] = K(null), [k, S] = K(n), [x, T] = K(/* @__PURE__ */ new Set()), [M, D] = K(() => {
    ...
    return Nl();
  }), A = V(null), I = V(null), L = V(!1), $ = V(0), F = V(0);
  Q(() => {
    S(n);
  }, [n]);
  const q = U((H) => {
    H.preventDefault(), H.stopPropagation(), L.current = !0, $.current = H.clientX, F.current = M, document.body.style.cursor = "col-resize", document.body.style.userSelect = "none";
  }, [M]);
  Q(() => {
    const H = (ee) => {
      if (!L.current) return;
      const be = f === "right" ? $.current - ee.clientX : ee.clientX - $.current, ve = Math.min(vd, Math.max(bd, F.current + be));
      D(ve);
    }, j = () => {
  ...
  Q(() => {
    ...
    const j = () => {
      ...
      for (let He = v.length - 1; He >= 0; He--) {
        const ot = v[He], zt = yl(t, ot.pos);
        if (zt && zt.getBoundingClientRect().top - ve.top <= h + 10) {
          Pe = ot.id;
          break;
        }
      }
    ...
    return H.addEventListener("scroll", be, { passive: !0 }), j(), () => {
      H.removeEventListener("scroll", be), cancelAnimationFrame(ee);
    };
  }, [t, v, l, k, h, w]);
  const P = U((H) => {
    if (!t || t.isDestroyed) return;
    ...
    if (j) {
      ...
      if (ee) {
        const be = ee.getBoundingClientRect(), Pe = j.getBoundingClientRect().top - be.top + ee.scrollTop;
    ...
    if (g)
      return g(H, j, () => P(H));
    const be = (H.level - s) * 14, ve = c && H.children && H.children.length > 0, Pe = x.has(H.id);
    return /* @__PURE__ */ m(
      "div",
      {
        className: `toc-item ${j ? "toc-item-active" : ""} toc-level-${H.level}`,
        style: { paddingLeft: `${be + 10}px` },
        children: /* @__PURE__ */ m(
          "button",
          {
    ...
    const be = C === ee.id, ve = x.has(ee.id), Pe = ee.children && ee.children.length > 0;
    return /* @__PURE__ */ m("div", { children: [
      G(ee, be, j),
      Pe && !ve && /* @__PURE__ */ m("div", { className: "toc-children", children: Z(ee.children, j + 1) }, void 0, !1, {
        fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/TableOfContents.tsx",
        lineNumber: 364,
        columnNumber: 13
      }, this)
...
`
  ...
  function a(l, c, u = 0) {
    ...
    ), p = f === "OL" ? parseInt(l.getAttribute("start") || "1", 10) : 1;
    h.forEach((g, b) => {
      const w = g.getAttribute("data-type") === "taskItem", v = g.getAttribute("data-checked") === "true", N = s(g);
      w ? c.push(`${d}- [${v ? "x" : " "}] ${N}`) : f === "OL" ? c.push(`${d}${p + b}. ${N}`) : c.push(`${d}- ${N}`);
      const C = Array.from(g.childNodes).filter(
...
const bx = () => {
  ...
  tocMinLevel: no = 1,
  tocMaxLevel: oo = 4,
  tocShowLevelIndicators: $o = !1,
  tocHighlightActive: Bo = !0,
  tocTreeView: Ho = !1,
  tocWidth: Wo = "240px",
  tocPosition: wn = "right",
  tocScrollOffset: ro = 20,
  onTocItemClick: Nn,
  renderTocItem: yn,
  tocShowToggleButton: Fo = !0,
  // Raw markdown editor
  autoClosePairs: qr = !0,
  ...
  // Expand selection
  progressiveSelectAll: zo = !1,
  // Auto-detection toggles
  enableTagAutoDetect: Uo = !1,
  enableHexColorHighlight: Jr = !1,
  enableCollapsibleHeadings: Yo = !1,
  // Performance mode
  performanceMode: so = "auto",
  // Error boundary
  onEditorError: es,
  ...
  const [ae] = K(() => bx()), [Ne, Ve] = K(x), [we, io] = K(""), qe = V(x), Ct = V(""), Et = V(null), [ao, Qi] = K(0), jo = !!(ft && ft.length > 0 && kn), { state: Qe, executeAction: Ko, abort: kd, reset: Ut } = ox(kn), [ts, ns] = K(null), [xd, Cd] = K({ selectionTop: 0, selectionBottom: 0, selectionCenterX: 0 }), Ed = V(kn);
  Ed.current = kn;
  const Ji = V(ue);
  Ji.current = ue;
  const [Td, Md] = K([]), [Sd, Dd] = K(0), Ad = U((B, W) => {
    Md(B), Dd(W);
  ...
  const ta = 2e3, [Tt, Pd] = K(() => so === "lightweight" ? !0 : so === "full" ? !1 : t && typeof t == "string" ? Math.ceil(t.length / 80) > ta : !1), us = V(0), na = V(Tt);
  na.current = Tt;
  const Rd = In(() => {
    const B = [
      Vd.configure({
      ...
      pf.extend({
        addInputRules() {
          ...
          return [
            new Xe({
              find: /^(?:---|—-|___\s|\*\*\*\s)$/,
              handler: ({ state: fe, range: ce }) => {
                const { tr: de } = fe, Ce = ce.from, le = ce.to;
                de.delete(Ce, le);
                const ye = de.doc.resolve(Ce), at = W.create(), Kt = ye.before(ye.depth), Cn = ye.after(ye.depth);
                de.replaceWith(Kt, Cn, at);
                const ie = Kt + at.nodeSize;
                if (ie < de.doc.content.size) {
                  const re = de.doc.resolve(ie);
                  re.nodeAfter && re.nodeAfter.isTextblock ? de.setSelection(wt.create(de.doc, ie + 1)) : re.nodeAfter && de.setSelection(wt.near(de.doc.resolve(ie)));
                } else {
                  const ke = fe.schema.nodes.paragraph.create();
                  de.insert(ie, ke), de.setSelection(wt.create(de.doc, ie + 1));
                }
                de.scrollIntoView();
              }
            })
    ...
    return _.tables || B.push(
    ...
    ), _.codeBlocks || B.push(Wf), _.callouts || B.push(Kf, hk), Yo && !_.collapsibleHeadings && !Tt && B.push(
      ck.configure({
        levels: ve
      })
    ), _.images || B.push(
      Vf.configure({
        ...
        onImageClick: (W) => {
          Go({
            ...
            alt: W.alt,
            pos: W.pos,
            position: { x: W.rect.left + W.rect.width / 2, y: W.rect.bottom }
          });
        },
        resolveImageSrc: as.current ? ((...W) => as.current(...W)) : void 0
      }),
      Gk.configure({
        maxFileSize: w,
        onUploadStart: os.current ? ((...W) => os.current(...W)) : void 0,
        onUploadComplete: rs.current ? ((...W) => rs.current(...W)) : void 0,
        onUploadError: ss.current ? ((...W) => ss.current(...W)) : void 0,
        onImageUpload: is.current ? ((W, fe) => is.current(W, fe)) : void 0
      })
    ), _.datePills || B.push(
      Kb.configure({
        HTMLAttributes: {
      ...
      Jy.configure({
        onWikiLinkClick: (W) => {
          console.log("WikiLink clicked:", W), ea.current?.(W);
        },
        validateLink: (W) => ls.current ? ls.current(W) : !0
      })
    ), zo && B.push(Ik), Jr && !Tt && B.push(Bk), _.markdownPaste || B.push(
      ik.configure({
        enableMarkdownPaste: !0
      })
    ), B;
  }, [s, ae, w, be, ve, _, zo, Yo, Tt]), Mt = V(null), rn = V(n), sn = V(o), ds = V(r), lo = V(null);
  rn.current = n, sn.current = o, ds.current = r;
  const O = jd({
    /**
    ...
    editorProps: {
      ...
      handleClick: (B, W, fe) => {
        if (z) {
          const de = fe.target.closest("a");
          if (de) {
            const Ce = de.getAttribute("href");
            if (Ce && z(Ce, fe) === !1)
              return fe.preventDefault(), !0;
          }
        }
        return !1;
      }
    ...
    onUpdate: ({ editor: B }) => {
      if (so === "auto" && (us.current++, us.current >= 50)) {
        us.current = 0;
        const fe = B.state.doc.content.childCount > ta;
        fe !== na.current && Pd(fe);
      }
      Mt.current && clearTimeout(Mt.current), Mt.current = setTimeout(() => {
        if (B.isDestroyed) return;
        const W = B.getHTML();
        (rn.current || sn.current) && (rn.current?.(W), sn.current?.(W));
      }, 150);
    },
    onFocus: () => {
      D?.();
    ...
    onBlur: () => {
      if (Mt.current && (clearTimeout(Mt.current), Mt.current = null, O && !O.isDestroyed)) {
        const B = O.getHTML();
        if ((rn.current || sn.current) && (rn.current?.(B), sn.current?.(B)), qe.current === "wysiwyg" && lo.current) {
          const W = lo.current.turndown(B);
          Ct.current = W, ds.current?.(W);
        }
      }
      A?.();
    },
    onSelectionUpdate: ({ editor: B }) => {
      if (I) {
        const { from: W, to: fe, empty: ce } = B.state.selection;
        I({ from: W, to: fe, empty: ce });
      }
    }
  });
  Q(() => () => {
  ...
  const [oa, Vo] = K(!1), [xn, Go] = K(null), [Id, Ld] = K(!1), Od = X !== void 0 ? X : Id, Yt = U((B) => {
    Ld(B), G?.(B);
  }, [G]), [_d, ms] = K(0), [$d, Bd] = K(""), St = Vy(O, {
    storageKey: h,
    debounceMs: p,
    enabled: f,
    onSave: (B) => {
  ...
  const ra = V(!1);
  Q(() => {
    if (!ra.current && x === "markdown" && O && !O.isDestroyed && jt) {
      const B = O.getHTML(), W = jt.turndown(B);
      io(W), Ct.current = W, ra.current = !0;
    }
  }, [O, jt, x]);
  const ht = U(async (B) => {
    if (O) {
      if (B === "markdown" && qe.current === "wysiwyg") {
        const W = O.getHTML(), fe = jt.turndown(W);
        io(fe), Ct.current = fe;
      } else if (B === "wysiwyg" && qe.current === "markdown") {
        const { marked: W } = await import("./marked.esm-Tjr8Gfse.js"), fe = ["info", "note", "prompt", "resources", "todo"];
        let ce = Ct.current;
        ce = hx(ce), fe.forEach((ie) => {
          const re = new RegExp(`\`\`\`ad-${ie}\\s*\\n([\\s\\S]*?)\`\`\``, "g");
          ce = ce.replace(re, (ke, me) => {
            const Me = W.parse(me.trim(), { async: !1, breaks: !0 });
            return `<div data-callout="" data-type="${ie}" class="callout callout-${ie}">${Me}</div>`;
          });
        }), fe.forEach((ie) => {
          const re = new RegExp(`\`\`\`${ie}\\s*\\n([\\s\\S]*?)\`\`\``, "g");
          ce = ce.replace(re, (ke, me) => {
            const Me = W.parse(me.trim(), { async: !1, breaks: !0 });
            return `<div data-callout="" data-type="${ie}" class="callout callout-${ie}">${Me}</div>`;
          });
        }), ce = ce.replace(/!\[([^\]]*)\]\(([^)]+)\)/g, (ie, re, ke) => {
          const me = re.split("|").map((Dt) => Dt.trim());
          let Me = "", We = "left", Re = null;
          me.length === 1 ? Me = me[0] : me.length === 2 ? (Me = me[0], /^\d+$/.test(me[1]) ? Re = me[1] : ["left", "center", "right"].includes(me[1]) ? We = me[1] : Me = re) : me.length === 3 ? (Me = me[0], ["left", "center", "right"].includes(me[1]) && (We = me[1]), /^\d+$/.test(me[2]) && (Re = me[2])) : Me = re;
          const Se = Re ? ` width="${Re}" style="width: ${Re}px"` : "", Vt = ` data-align="${We}"`;
          return `<img src="${ke.trim()}" alt="${Me}"${Vt}${Se} />`;
        }), ce = ce.replace(new RegExp("(?<!`)==((?:(?!==)[^\\n])+)==(?!`)", "g"), "<mark>$1</mark>"), ce = ce.replace(/@([^@\n]+)@/g, (ie, re) => {
          const ke = dn(re);
          if (ke) {
            const me = Pi(ke);
            return `<span data-type="date-pill" data-date="${ke}" class="date-pill ${me}"><span class="date-icon">📅</span><span class="date-text">${re.trim()}</span></span>`;
          }
          return ie;
        }), Uo && !_.tagPills && (ce = ce.replace(new RegExp("(?:^|(?<=\\s))#([a-zA-Z][a-zA-Z0-9_-]*|[a-zA-Z0-9_-]*[a-zA-Z][a-zA-Z0-9_-]*)(?=\\s|$|[.,;:!?)\\]])", "gm"), (ie, re) => {
          const ke = No(re);
          return Rn(ke) ? `<span data-type="tag-pill" data-tag="${ke}" class="tag-pill"><span class="tag-icon">#</span><span class="tag-text">${ke}</span></span>` : ie;
        })), ce = ce.split(/(```[\s\S]*?```|`[^`\n]+`)/g).map((ie, re) => re % 2 === 1 ? ie : ie.replace(/\[\[([^\[\]]+)\]\]/g, (ke, me) => `<span data-wiki-link data-page-name="${me.trim()}" class="wiki-link">${me.trim()}</span>`)).join("");
        let Ce = W.parse(ce, { async: !1, breaks: !0 });
        Ce = Ce.replace(
          /(?:<p>\s*\u200B\s*<\/p>\s*)*<!--\s*list-break\s*-->(?:\s*<p>\s*\u200B\s*<\/p>)*/g,
          '<p class="list-separator" data-list-separator="true">​</p>'
        ), Ce = px(Ce), Ce = gx(Ce), Ce = Ce.replace(/(<table>[\s\S]*<\/table>)\s*<!--\s*header-column\s*-->/gi, (ie, re) => re.replace(/(<tbody>[\s\S]*?<\/tbody>)/gi, (ke) => ke.replace(/<tr>([\s\S]*?)<\/tr>/gi, (me, Me) => `<tr>${Me.replace(/^([\s\S]*?)<td>([\s\S]*?)<\/td>/i, "$1<th>$2</th>")}</tr>`)));
        const le = (ie) => {
          let re = ie;
          return re = re.replace(/\*\*(.+?)\*\*/g, "<strong>$1</strong>"), re = re.replace(new RegExp("(?<!\\*)\\*(?!\\*)(.+?)(?<!\\*)\\*(?!\\*)", "g"), "<em>$1</em>"), re = re.replace(/~~(.+?)~~/g, "<s>$1</s>"), re = re.replace(/`([^`]+)`/g, "<code>$1</code>"), re = re.replace(/==(.+?)==/g, "<mark>$1</mark>"), re = re.replace(/\[([^\]]+)\]\(([^)]+)\)/g, '<a href="$2">$1</a>'), re;
        }, ye = (ie) => {
          const re = ie.match(/data-align="([^"]*)"/), ke = re ? re[1] : "left";
          return `<figure class="image-resizer" style="${{
            left: "margin-right: auto;",
            center: "margin-left: auto; margin-right: auto;",
            right: "margin-left: auto;"
          }[ke] || "margin-right: auto;"}">${ie.trim()}</figure>`;
        }, at = (ie) => {
          if (/<img\s/i.test(ie)) {
            const re = /(<img\s[^>]*\/?>)/gi;
            return ie.split(re).filter((me) => me.trim()).map((me) => /^<img\s/i.test(me) ? ye(me) : me.trim() ? `<p>${le(me.trim())}</p>` : "").join("");
          }
          if (/^!\[/.test(ie)) {
            const re = ie.match(/^!\[([^\]]*)\]\(([^)]+)\)$/);
            if (re)
              return `<figure class="image-resizer" style="margin-right: auto;"><img src="${re[2]}" alt="${re[1]}" data-align="left" /></figure>`;
          }
          return `<p>${le(ie)}</p>`;
        }, Kt = (ie) => {
          const re = ie.match(/^( *)/), ke = re ? re[1].length : 0, me = Math.floor(ke / 2), Me = ie.trimStart(), We = Me.match(/^-\s*\[(x| )\]\s*(.*)$/);
          if (We)
            return { type: "task", depth: me, text: We[2].trim(), checked: We[1] === "x" };
          const Re = Me.match(/^-\s+(.+)$/);
          if (Re)
            return { type: "ul", depth: me, text: Re[1].trim() };
          const Se = Me.match(/^(\d+)\.\s+(.+)$/);
          return Se ? { type: "ol", depth: me, text: Se[2].trim(), index: parseInt(Se[1], 10) } : null;
        }, Cn = (ie) => {
          if (ie.length === 0) return "";
          const re = (Me, We) => {
            let Re = "", Se = Me;
            const Vt = ie[Se]?.type || "ul", Dt = Vt === "task", Gt = Dt ? '<ul data-type="taskList">' : `<${Vt === "ol" ? "ol" : "ul"}>`, co = Dt ? "</ul>" : `</${Vt === "ol" ? "ol" : "ul"}>`;
            for (Re += Gt; Se < ie.length && ie[Se].depth >= We; ) {
              const At = ie[Se];
              if (At.depth === We) {
                if (Dt ? Re += `<li data-type="taskItem" data-checked="${At.checked || !1}"><p>${le(At.text)}</p>` : Re += `<li><p>${le(At.text)}</p>`, Se + 1 < ie.length && ie[Se + 1].depth > We) {
                  const ln = re(Se + 1, ie[Se + 1].depth);
                  Re += ln.html, Se = ln.nextIdx;
                } else
                  Se++;
                Re += "</li>";
              } else
            ...
            return Re += co, { html: Re, nextIdx: Se };
          }, ke = Math.min(...ie.map((Me) => Me.depth));
          return re(0, ke).html;
        };
        Ce = Ce.replace(
          /(<t[dh][^>]*>)([\s\S]*?)(<\/t[dh]>)/gi,
          (ie, re, ke, me) => {
            const Me = /<img\s/i.test(ke), We = /<br\s*\/?>/i.test(ke), Re = /(?:^|<br\s*\/?>)\s*(?:- |\d+\. )/i.test(ke);
            if (!Me && !We && !Re) return ie;
            let Se = ke.trim();
            Se = Se.replace(/^<p>([\s\S]*)<\/p>$/i, "$1").trim();
            const Vt = Se.split(/<br\s*\/?>/i).filter((At) => At.trim());
            if (Vt.length <= 1 && !Re)
              return Me ? `${re}${at(Se)}${me}` : ie;
            const Dt = [];
            let Gt = [];
            const co = () => {
              Gt.length !== 0 && (Dt.push(Cn(Gt)), Gt = []);
            };
            for (const At of Vt) {
              const ln = Kt(At);
              if (ln) {
                if (Gt.length > 0) {
                  const Yd = Gt[0].type;
                  ln.depth === 0 && ln.type !== Yd && co();
                }
                Gt.push(ln);
              } else
                co(), Dt.push(at(At.trim()));
            }
            return co(), `${re}${Dt.join("")}${me}`;
          }
        ), queueMicrotask(() => {
          O.isDestroyed || O.commands.setContent(Ce);
        });
      }
      Ve(B), qe.current = B, T?.(B);
    }
  }, [O, jt, T]), sa = U((B) => {
    io(B), Ct.current = B, r?.(B);
  }, [r]), an = qy(O, {
    debounceMs: 500,
    extendedStats: !1,
    enabled: u
  ...
  vm(Te, () => ({
    getEditor: () => O,
    getHTML: () => O?.getHTML() || "",
    getMarkdown: () => O ? jt.turndown(O.getHTML()) : "",
    getText: () => O?.getText() || "",
    setContent: (B) => {
    ...
    insertImage: (B, W = "") => O?.commands.setImage({ src: B, alt: W }),
    insertTable: (B = 3, W = 3) => O?.commands.insertTable({ rows: B, cols: W, withHeaderRow: !0 }),
    insertCodeBlock: (B) => {
    ...
    getSelectedText: () => {
      if (!O) return "";
      const { from: B, to: W } = O.state.selection;
      return O.state.doc.textBetween(B, W, " ");
    },
    ...
    getTableOfContents: () => {
      if (!O) return [];
      const B = [];
      return O.state.doc.descendants((W, fe) => {
        if (W.type.name === "heading") {
          const ce = W.attrs.level, de = W.textContent.trim();
          de && B.push({ id: `toc-heading-${fe}`, text: de, level: ce, pos: fe });
        }
      }), B;
    },
    ...
    scrollToHeading: (B) => {
      if (!(!O || O.isDestroyed))
        try {
          const W = O.state.doc.resolve(B), fe = O.view.nodeDOM(W.before(W.depth + 1));
          if (fe instanceof HTMLElement) {
            const ce = O.view.dom.closest(".editor-content-wrapper");
            if (ce) {
              const de = ce.getBoundingClientRect(), le = fe.getBoundingClientRect().top - de.top + ce.scrollTop;
              ce.scrollTo({ top: le - 20, behavior: "smooth" });
            } else
    ...
    const B = {
       ...
       */
      getRawMarkdown: () => qe.current === "markdown" ? Ct.current : null,
      /**
      ...
      onModeChange: (W) => {
        ...
        return window.addEventListener("paragon-editor-mode-change", fe), () => window.removeEventListener("paragon-editor-mode-change", fe);
      }
    };
    ...
    window.dispatchEvent(new CustomEvent("paragon-editor-mode-change", { detail: { mode: Ne } }));
  }, [Ne]), Q(() => {
    if (!O || O.isDestroyed) return;
    const B = (W) => {
      if (O.isDestroyed) return;
      const fe = W.key;
      if (!(!(W.metaKey || W.ctrlKey) && fe !== " ")) {
        if ((W.metaKey || W.ctrlKey) && W.key === "k") {
          W.preventDefault(), Vo(!0);
          return;
        }
        if (!ae && (W.metaKey || W.ctrlKey) && W.key === "f") {
          if (W.preventDefault(), O) {
            const { state: de } = O, { from: Ce, to: le } = de.selection;
            if (Ce !== le) {
              const ye = de.doc.textBetween(Ce, le, " ");
              ye.trim() && Bd(ye.trim());
            }
          }
          Yt(!0), ms((de) => de + 1);
        ...
        if (!ae && (W.metaKey || W.ctrlKey) && W.key === "h") {
          W.preventDefault(), Yt(!0);
          return;
        }
        if (W.key === " ")
          try {
            const { state: de } = O, { selection: Ce } = de, { $from: le } = Ce, ye = le.nodeBefore?.textContent || "";
            if (ye === "#####") {
              W.preventDefault(), O.chain().focus().deleteRange({ from: le.pos - 5, to: le.pos }).setHeading({ level: 5 }).run();
              return;
            }
            if (ye === "####") {
              W.preventDefault(), O.chain().focus().deleteRange({ from: le.pos - 4, to: le.pos }).setHeading({ level: 4 }).run();
              return;
            }
            if (ye === "###") {
              W.preventDefault(), O.chain().focus().deleteRange({ from: le.pos - 3, to: le.pos }).setHeading({ level: 3 }).run();
              return;
            }
            if (ye === "##") {
              W.preventDefault(), O.chain().focus().deleteRange({ from: le.pos - 2, to: le.pos }).setHeading({ level: 2 }).run();
              return;
            }
            if (ye === "#") {
              W.preventDefault(), O.chain().focus().deleteRange({ from: le.pos - 1, to: le.pos }).setHeading({ level: 1 }).run();
              return;
            }
            if (ye === "-" || ye === "*") {
              W.preventDefault(), O.chain().focus().deleteRange({ from: le.pos - 1, to: le.pos }).toggleBulletList().run();
              return;
            }
            if (/^\d+\.$/.test(ye)) {
              W.preventDefault(), O.chain().focus().deleteRange({ from: le.pos - ye.length, to: le.pos }).toggleOrderedList().run();
              return;
            }
            const at = /^(-\s*)?\[([ x])?\]$/.exec(ye);
            if (at) {
              W.preventDefault();
              const Kt = at[2] === "x", Cn = de.schema.nodes.taskList, ie = de.schema.nodes.taskItem;
              if (Cn && ie) {
                const re = de.tr, ke = le.pos - ye.length, me = le.pos;
                re.delete(ke, me);
                const We = re.doc.resolve(ke).blockRange();
                if (We) {
                  const Re = [
                    { type: Cn, attrs: {} },
                    { type: ie, attrs: { checked: Kt } }
                  ];
                  re.wrap(We, Re), O.view.dispatch(re);
                  return;
                }
              }
              O.chain().focus().deleteRange({ from: le.pos - ye.length, to: le.pos }).toggleTaskList().run();
              return;
            }
            if (ye === ">") {
              W.preventDefault(), O.chain().focus().deleteRange({ from: le.pos - 1, to: le.pos }).toggleBlockquote().run();
              return;
            }
            if (ye === "```") {
              W.preventDefault(), O.chain().focus().deleteRange({ from: le.pos - 3, to: le.pos }).toggleCodeBlock().run();
              return;
            }
            if (ye === "---" || ye === "***") {
              W.preventDefault(), dr(O, le.pos - 3, le.pos);
              return;
            }
            if (ye === "—-") {
              W.preventDefault(), dr(O, le.pos - 2, le.pos);
              return;
            }
            if (ye === "—") {
              W.preventDefault(), dr(O, le.pos - 1, le.pos);
              return;
            }
          } catch (de) {
            console.warn("Space shortcut error:", de);
          }
      }
    };
  ...
  const ia = U((B, W) => {
    ...
    let fe = { top: 0, left: 0 };
    if (W) {
      const ce = W.getBoundingClientRect();
      fe = { top: ce.bottom + 4, left: ce.left };
    } else {
      const { from: ce, to: de } = O.state.selection, Ce = O.view.coordsAtPos(ce), le = O.view.coordsAtPos(de);
      fe = { top: le.bottom + 8, left: (Ce.left + le.left) / 2 };
    }
    ns({ scope: B, position: fe });
  }, [jo, O]), Hd = U((B, W) => {
    if (!O || !ft) return;
    const fe = ft.find((Kt) => Kt.id === B);
    if (!fe) return;
    const { from: ce, to: de } = O.state.selection, Ce = ce !== de ? O.state.doc.textBetween(ce, de, `
`) : "", le = fe.scope === "document" || !Ce ? O.getText() : Ce, ye = O.view.coordsAtPos(ce), at = O.view.coordsAtPos(de);
    Cd({
      selectionTop: ye.top,
      selectionBottom: at.bottom,
      selectionCenterX: (ye.left + at.right) / 2
    }), ns(null), Ko(B, fe.label, le, { from: ce, to: de }, W);
  }, [O, ft, Ko]), Wd = U(() => {
    if (!O || Qe.status !== "complete") return;
    const { selectionRange: B, result: W } = Qe;
    O.chain().focus().setTextSelection(B).deleteSelection().insertContent(W).run(), Ut();
  }, [O, Qe, Ut]), Fd = U(() => {
    if (!O || Qe.status !== "complete") return;
    const { selectionRange: B, result: W } = Qe;
...
` + W).run(), Ut();
    ...
    if (!(Qe.status !== "complete" && Qe.status !== "error"))
      if (Qe.status === "complete") {
        const { action: B, actionLabel: W, inputText: fe, selectionRange: ce } = Qe;
        Ut(), Ko(B, W, fe, ce);
      } else
        Ut();
  }, [Qe, Ut, Ko]);
  ...
  return /* @__PURE__ */ m("div", { className: `markdown-editor-container ${l}`, "data-theme": d, children: [
    f && g && St.hasRecoverableContent && /* @__PURE__ */ m(
      Zy,
      {
        onRecover: () => {
          St.recover();
    ...
    c && /* @__PURE__ */ m("div", { className: "flex items-center bg-card/50 editor-toolbar-wrapper", children: [
      ...
      S && /* @__PURE__ */ m("div", { className: "editor-mode-toggle mr-2 sm:mr-3", children: [
        /* @__PURE__ */ m(
          ...
          {
            onClick: () => ht("wysiwyg"),
            className: `editor-mode-toggle-btn ${Ne === "wysiwyg" ? "active" : ""}`,
            title: "Visual Editor",
        ...
        /* @__PURE__ */ m(
          ...
          {
            onClick: () => ht("markdown"),
            className: `editor-mode-toggle-btn ${Ne === "markdown" ? "active" : ""}`,
            title: "Raw Markdown",
    ...
    /* @__PURE__ */ m("div", { className: `editor-main-area ${Pe ? "editor-with-toc" : ""}`, children: [
      ...
      /* @__PURE__ */ m(
        ex,
        {
          ...
          onError: es,
          children: [
            /* @__PURE__ */ m("div", { className: "editor-content-wrapper", ref: Et, style: Ud, children: Ne === "wysiwyg" ? /* @__PURE__ */ m(Be, { children: [
              /* @__PURE__ */ m(Kd, { editor: O, className: "editor-content" }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
                lineNumber: 2513,
                columnNumber: 13
              }, this),
              !_.images && !_.dragAndDrop && /* @__PURE__ */ m(qk, { containerRef: Et, enabled: a }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
                lineNumber: 2517,
                columnNumber: 15
              }, this),
              !ae && b && /* @__PURE__ */ m(Yf, { editor: O, suppressWhenLinkPopoverOpen: oa, aiEnabled: jo || !!ue, onAISparklesClick: (B) => ia("selection", B) }, void 0, !1, {
                fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
                lineNumber: 2523,
                columnNumber: 50
              }, this),
              ...
              !_.images && xn?.isOpen && /* @__PURE__ */ m(
                Xk,
                {
                  src: xn.src,
                  alt: xn.alt,
                  position: xn.position,
                  onSave: (B, W) => {
                    O.chain().focus().setNodeSelection(xn.pos).updateAttributes("resizableImage", {
                      src: B,
                      alt: W
                    }).run(), Go(null);
                  },
                  onDelete: () => {
                    O.chain().focus().setNodeSelection(xn.pos).deleteSelection().run(), Go(null);
                  },
                  onClose: () => Go(null)
                },
                void 0,
            ...
            /* @__PURE__ */ m(tx, { scrollContainerRef: Et }, void 0, !1, {
              fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/MarkdownEditor.tsx",
              lineNumber: 2610,
              columnNumber: 7
            }, this)
...
function p1({
  ...
  const [o, r] = K(t), s = bo[o] || bo.dark, a = U((l) => {
    bo[l] && r(l);
  }, []);
  Q(() => {
    n?.current && yx(n.current, s);
  }, [s, n]);
  const i = {
    theme: s,
    themeName: o,
    setTheme: a,
    availableThemes: Object.keys(bo)
  };
...
function b1({ node: e, updateAttributes: t }) {
  ...
  return /* @__PURE__ */ m(zn, { className: "code-block-wrapper", children: [
    /* @__PURE__ */ m("div", { className: "code-block-controls", contentEditable: !1, children: [
      /* @__PURE__ */ m("div", { className: "code-block-language-wrapper", children: [
        /* @__PURE__ */ m(
          "select",
      ...
      /* @__PURE__ */ m(
        "button",
        {
          ...
          children: n ? /* @__PURE__ */ m(Gn, { size: 14 }, void 0, !1, {
            fileName: "/home/ubuntu/manus-markdown-editor/client/src/components/editor/CodeBlockComponent.tsx",
            lineNumber: 76,
            columnNumber: 21
          }, this) : /* @__PURE__ */ m(qn, { size: 14 }, void 0, !1, {
