...
import { splitSeparatedLists } from './utils/splitSeparatedLists';
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
  ...
  const handleModeSwitch = useCallback(async (newMode: 'wysiwyg' | 'markdown') => {
    ...
    if (newMode === 'markdown' && editorModeRef.current === 'wysiwyg') {
      ...
      // Post-process: Properly structure images inside list items.
      // marked outputs: <li>text<img .../></li> or <li><img .../></li>
      // TipTap expects: <li><p>text</p><figure class="image-resizer"><img .../></figure></li>
      // This handles both regular bullet lists and task lists.
      html = structureImagesInListItems(html);
      
      // Post-process: Restore header column from <!-- header-column --> marker.
      ...
      html = html.replace(/(<table>[\s\S]*<\/table>)\s*<!--\s*header-column\s*-->/gi, (_fullMatch: string, tableHtml: string) => {
