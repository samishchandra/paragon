      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 mb-4">
            <img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663318957742/akqSHFTWMwaktltN.png" alt="Momentum Notes" className="w-16 h-16" />
          </div>
          <h1 className="text-2xl font-semibold text-foreground tracking-tight">Momentum Notes</h1>
